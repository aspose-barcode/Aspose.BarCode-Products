...
description: Python 바코드 판독기 라이브러리는 1D, 2D 및 Postal을 포함한 다양한 유형의 바코드를 인식하고 생성합니다. Python 애플리케이션에서 API를 사용합니다.
lang: ko/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="파이썬 바코드 라이브러리" h2="모든 Python 애플리케이션에서 1D, 2D 및 우편 바코드를 인식하거나 생성합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-net.svg" pfName="Aspose.BarCode" subTitlepfName="Python via .NET 용" downloadUrl="https://releases.aspose.com/barcode/python-net" >}}
...
<p>NET을 통한 Python용 Aspose.BarCode는 Python 애플리케이션에 통합될 일련의 바코드 생성 및 판독 API입니다. 개발자는 바코드 생성 및 인식 기능을 쉽게 추가할 수 있습니다. Python 바코드 API는 PNG, JPG, GIF, BMP와 같은 다양한 형식으로 바코드 이미지를 생성합니다. 또한 테두리 조작, 색상, 이미지 회전, 해상도 맞춤설정 등과 같은 여러 이미징 기능을 지원합니다.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="플랫폼 독립성" description="NET을 통한 Python용 Aspose.Barcode는 Python 3.6 이상에서 사용할 수 있습니다." >}}
<div class='diagram1 d1-python'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="지원되는 파일 형식" description="Python via .NET용 Aspose.BarCode는 가장 일반적으로 사용되는 이미지 파일 형식과 함께 작동합니다." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                .NET Barcode API 기능을 통한 고급 Python
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/swiss-qr-code/'>스위스 QR 코드</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/manage-barcode-appearance/'>바코드 모양 사용자 지정</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/barcode-text-settings/'>바코드 텍스트 설정 관리</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/generate-1d-barcodes/'>1D 바코드 유형의 특수 매개변수</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/generate-qr-code/'>QR 코드 및 마이크로 QR 코드 생성</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/barcode-reading-presets/'>바코드 판독 품질 옵션 및 사전 설정</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    .NET을 통한 Python용 Aspose.BarCode는 맞춤형 바코드 이미지를 생성하는 풍부한 기능을 제공합니다. 비즈니스 요구에 따라 모든 색상 또는 크기의 바코드를 생성할 수 있습니다. 막대, 배경, 테두리 및 텍스트 캡션의 색상과 위치를 포함한 모든 바코드 요소의 모양을 사용자 정의할 수 있습니다. 입력 텍스트, 위쪽 및/또는 아래쪽 캡션, 패딩 및 테두리를 표시하거나 표시하지 않고 바코드를 생성할 수 있습니다. 바코드 크기는 X-dimension에 따라 자동으로 설정하거나 수동으로 설정할 수 있습니다. 밀리미터, 인치, 포인트 또는 픽셀과 같은 다양한 단위로 정의할 수 있습니다. 필요한 경우 이미지 비율과 해상도를 조정할 수 있습니다. 텍스트 글꼴도 사용자 지정할 수 있습니다.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
            <div class="col-lg-12">
                ...
                <p>
                    API에는 Data Matrix, Aztec 코드, PDF417 등과 같이 가장 널리 사용되는 유형의 2D 바코드를 생성하는 기능이 있습니다. 이러한 유형은 크거나 비표준 입력 값을 인코딩할 수 있습니다. 다음은 QR 코드 생성을 위한 코드입니다.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    바코드 라이브러리는 비즈니스의 특정 요구 사항을 충족하도록 바코드 판독을 최적화하는 다양한 강력한 기능을 제공합니다. 개발자는 인식 엔진의 매개변수를 조정하여 빠른 바코드 스캐닝을 가능하게 하거나 판독 정확도를 향상시킬 수 있습니다. 소스 바코드 이미지의 품질과 매개변수에 따라 라이브러리에서 인식 프로세스를 사용자 정의할 수 있습니다. 여기에는 고품질 바코드 이미지를 빠르게 스캔하거나 손상되거나 저하된 바코드를 쉽게 디코딩하는 데 사용할 수 있는 이러한 매개변수의 여러 사전 설정 구성이 포함되어 있습니다. 또한 가우시안 노이즈, 흰색 반점 및 반전 색상과 같은 다양한 유형의 왜곡에 대해 바코드 판독을 개선할 수 있는 특수 설정이 있습니다. 인식 프로세스를 미세 조정할 수 있는 기능을 통해 API는 광범위한 응용 프로그램 및 시나리오에 대해 가장 효율적인 바코드 판독을 제공하도록 맞춤화할 수 있습니다.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/pdf417/" name="PDF417" description="PDF417 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/qr/" name="QR" description="QR 코드, GS1 QR 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/datamatrix/" name="Data Matrix" description="Data Matrix 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/aztec/" name="Aztec" description="Aztec 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/swiss-qr/" name="Swiss QR" description="Swiss QR 청구서" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/dotcode/" name="DotCode" description="DotCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/hibc/" name="HIBC" description="HIBC (의료 산업 바코드)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/codablock/" name="Codablock-F" description="Codablock-F 및 GS1 Codablock-F 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/databar/" name="GS1 DataBar" description="GS1 DataBar(Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, Truncated) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/itf/" name="ITF" description="인터리브 2-of-5(ITF) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/ean/" name="EAN" description="EAN (국제 문서 번호) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/upc/" name="UPC" description="UPC(범용 제품 코드) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/code128/" name="GS1 Code 128" description="GS1 Code 128 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/code39/" name="Code 39" description="Code 39 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/code16k/" name="Code 16K" description="Code 16K 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/code32/" name="Code 32" description="이탈리아어 Pharmacode(Code 32) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/code93/" name="Code 93" description="Code 93 확장 및 Code 93 표준 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/onecode/" name="USPS OneCode" description="USPS OneCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 of 5) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/isbn/" name="ISBN" description="ISBN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/ismn/" name="ISMN" description="ISMN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/issn/" name="ISSN" description="ISSN 바코드" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/australia-post/" name="Australia Post" description="Australia Post 바코드 및 Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode 및 Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/rm4scc/" name="RM4SCC" description="Royal Mail 4주 고객 코드(RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/postnet/" name="Postnet" description="Postnet 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/royal-mail/" name="Royal Mail" description="Royal Mail 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/singapore-post/" name="Singapore Post" description="Singapore Post 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/python-net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="선적 서류 비치" href="https://docs.aspose.com/barcode/python-net/" >}}
{{< blocks/products/pf/slr-element name="소스 코드" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Python-via-.NET" >}}
{{< blocks/products/pf/slr-element name="API 참조" href="https://docs.aspose.com/barcode/python-net/api-reference/" >}}
...
{{< blocks/products/pf/slr-element name="릴리즈 노트" href="https://docs.aspose.com/barcode/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="왜 Python via .NET용 Aspose.BarCode인가요?" tabId="success-stories" >}}
