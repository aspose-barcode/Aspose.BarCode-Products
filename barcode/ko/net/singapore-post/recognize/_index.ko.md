---
title: .NET을(를) 통해 Singapore Post 바코드 이미지 스캔
weight: 1510
description: .NET Framework, .NET Standard, PHP용 COM Interloop, VBScript, Delphi 또는 C++에서 Singapore Post 바코드 바코드 유형을 스캔하고 디코딩하는 C# 샘플 코드.
lang: ko/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ko/net/singapore-post/recognize/
aliases:
- /ko/net/recognize/singapore-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET로 Singapore Post 바코드 읽기" h2=".NET API용 서버 측 Aspose.BarCode를 사용하여 C#에서 Singapore Post 바코드 읽기" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Singapore Post 바코드 Using .NET" %}}
Singapore Post 바코드을(를) 디코딩하려면 기능이 풍부하고 강력하며 사용하기 쉬운 바코드 라이브러리인 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API를 사용해 보세요. C# 플랫폼용. [NuGet](https://www.nuget.org/packages/aspose.barcode)을 사용하고 **Aspose.BarCode**를 검색하여 패키지를 설치합니다. 또는 패키지 관리자 콘솔에서 다음 명령을 실행합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 Singapore Post 바코드 스캔 단계" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader 클래스의 새 인스턴스를 생성합니다.</li><li>Singapore Post 바코드을 매개변수로 포함하는 소스 이미지 경로를 전달합니다.</li><li>적절한 DecodeType을 다음과 같이 전달합니다. 두 번째 매개변수</li><li>디코딩 결과 반복</li><li>CodeText 속성을 사용하여 바코드 텍스트 가져오기</li></ul>
