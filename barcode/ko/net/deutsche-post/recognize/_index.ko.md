---
title: .NET을(를) 통해 Deutsche Post Identcode 및 Deutsche Post Leitcode 이미지 스캔
weight: 1510
description: .NET Framework, .NET Standard, PHP용 COM Interloop, VBScript, Delphi 또는 C++에서 Deutsche Post Identcode 및 Deutsche Post Leitcode 바코드 유형을 스캔하고 디코딩하는 C# 샘플 코드.
lang: ko/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ko/net/deutsche-post/recognize/
aliases:
- /ko/net/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET로 Deutsche Post 바코드 읽기" h2=".NET API용 서버 측 Aspose.BarCode를 사용하여 C#에서 Deutsche Post Identcode 및 Deutsche Post Leitcode 읽기" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Deutsche Post 바코드 Using .NET" %}}
Deutsche Post 바코드을(를) 디코딩하려면 기능이 풍부하고 강력하며 사용하기 쉬운 바코드 라이브러리인 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API를 사용해 보세요. C# 플랫폼용. [NuGet](https://www.nuget.org/packages/aspose.barcode)을 사용하고 **Aspose.BarCode**를 검색하여 패키지를 설치합니다. 또는 패키지 관리자 콘솔에서 다음 명령을 실행합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 Deutsche Post 바코드 스캔 단계" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader 클래스의 새 인스턴스를 생성합니다.</li><li>Deutsche Post 바코드을 매개변수로 포함하는 소스 이미지 경로를 전달합니다.</li><li>적절한 DecodeType을 다음과 같이 전달합니다. 두 번째 매개변수</li><li>디코딩 결과 반복</li><li>CodeText 속성을 사용하여 바코드 텍스트 가져오기</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/pdf417/recognize/" name="PDF417" description="PDF417 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/qr/recognize/" name="QR" description="QR 코드, GS1 QR 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/datamatrix/recognize/" name="Data Matrix" description="Data Matrix 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/aztec/recognize/" name="Aztec" description="Aztec 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR 청구서" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/dotcode/recognize/" name="DotCode" description="DotCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/hibc/recognize/" name="HIBC" description="HIBC (의료 산업 바코드)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/codablock/recognize/" name="Codablock-F" description="Codablock-F 및 GS1 Codablock-F 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar(Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, Truncated) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/itf/recognize/" name="ITF" description="인터리브 2-of-5(ITF) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/ean/recognize/" name="EAN" description="EAN (국제 문서 번호) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/upc/recognize/" name="UPC" description="UPC(범용 제품 코드) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/code39/recognize/" name="Code 39" description="Code 39 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/code16k/recognize/" name="Code 16K" description="Code 16K 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/code32/recognize/" name="Code 32" description="이탈리아어 Pharmacode(Code 32) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/code93/recognize/" name="Code 93" description="Code 93 확장 및 Code 93 표준 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/onecode/recognize/" name="USPS OneCode" description="USPS OneCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 of 5) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/isbn/recognize/" name="ISBN" description="ISBN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/ismn/recognize/" name="ISMN" description="ISMN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/issn/recognize/" name="ISSN" description="ISSN 바코드" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/australia-post/recognize/" name="Australia Post" description="Australia Post 바코드 및 Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode 및 Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4주 고객 코드(RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/postnet/recognize/" name="Postnet" description="Postnet 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/royal-mail/recognize/" name="Royal Mail" description="Royal Mail 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/singapore-post/recognize/" name="Singapore Post" description="Singapore Post 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
