---
title: .NET을(를) 통해 UPC(범용 제품 코드) 바코드 이미지 생성
description: .NET Framework, .NET Standard, PHP용 COM Interloop, VBScript, Delphi 및 C++에서 UPC(범용 제품 코드) 바코드 생성을 위한 C# 소스 코드.
lang: ko
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ko/net/upc/generate/
aliases:
- /ko/net/generate/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET로 UPC 라벨 생성" h2=".NET API용 서버 측 Aspose.BarCode를 사용하여 C#에서 UPC(범용 제품 코드) 바코드을 생성합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate UPC(범용 제품 코드) 바코드 Using .NET" %}}
UPC(범용 제품 코드) 바코드을(를) 생성하려면 기능이 풍부하고 강력하며 사용하기 쉬운 바코드 라이브러리인 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API를 사용해 보세요. C# 플랫폼용. [NuGet](https://www.nuget.org/packages/aspose.barcode) 패키지 관리자를 열고 **Aspose.BarCode**를 검색하여 패키지를 설치합니다. 패키지 관리자 콘솔에서 다음 명령을 실행할 수도 있습니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 UPC(범용 제품 코드) 바코드을 생성하는 단계" %}}
...
<ul><li>BarcodeGenerator 클래스의 인스턴스 생성</li><li>UPC(범용 제품 코드) 바코드을 매개변수로 전달</li><li>인코딩할 텍스트를 두 번째 매개변수로 설정</li><li> 필요한 경우 바코드 치수 지정</li><li>BarcodeGenerator.Save 메서드를 호출하여 UPC(범용 제품 코드) 바코드 이미지를 얻습니다.</li></ul>
