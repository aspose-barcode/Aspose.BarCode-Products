...
{{< blocks/products/pf/upper-banner h1="바코드 생성기 및 판독기 API" h2="모든 .NET 애플리케이션 내에서 선형, 2D 및 우편 유형의 바코드를 만들고 인식합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" pfName="Aspose.BarCode" subTitlepfName=".NET 용" downloadUrl="https://releases.aspose.com/barcode/net/" >}}
...
<p>Aspose.BarCode for .NET은 모든 각도에서 다양한 이미지 유형의 1D 및 2D 바코드를 생성하고 인식하는 강력한 개발 라이브러리입니다. 개발자는 .NET 애플리케이션에 바코드 생성 및 스캔 기능을 쉽게 추가할 수 있습니다. 이 API를 사용하면 생성된 바코드를 다양한 고품질 이미지 형식으로 내보낼 수 있습니다.</p><p>Aspose.BarCode for .NET을 사용하면 생성된 바코드의 모양과 배경색, 바 색상, 회전 각도, x와 같은 매개변수를 수정할 수 있습니다. -치수, 이미지 품질, 해상도, 캡션, 크기 등. 또한 풍부한 바코드 감지 및 읽기 기능을 제공하며 60개 이상의 바코드 유형을 지원합니다.</p>
{{< /blocks/products/pf/tab-content >}}
...
<div class='diagram1 d1-net'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>PHP, VBScript, 델파이, C++</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            <header>
...
{{< blocks/products/pf/carousel-item h3="지원되는 파일 형식" description=".NET용 Aspose.BarCode는 가장 일반적으로 사용되는 이미지 파일 형식과 함께 작동합니다." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/saving-barcode-image/'>다양한 형식으로 바코드 라벨 저장</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/read-barcodes-with-aspose-barcode-apis/#setting-barcode-recognition-source'>스트림 또는 파일에서 인식</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/qr-and-micro-qr-barcode/#eciencoding-mode'>2D 유형의 문자(비영어) 인코딩 및 디코딩</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/image-formatting-and-display-settings/'>바코드 이미지를 원하는 각도로 회전</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/how-to-read-barcode-from-multi-page-tiff-images/'>다중 페이지 TIFF에서 바코드 스캔</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/barcode-types-and-image-formats/'>선형, 2D 및 우편 기호 지원</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    .NET용 바코드 API를 사용하면 개발자가 바코드 유형, 입력 텍스트, 글꼴 스타일, 배경 및 전경색, 캡션 정렬 및 위치, 기타 속성을 지정하여 생성된 바코드의 모양을 미세 조정할 수 있습니다. 위쪽 및 아래쪽 캡션, 글꼴, 색상 및 정렬에 대한 가시성을 설정하여 캡션을 수정할 수 있습니다.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    바코드 생성기 API를 사용하면 개발자가 필요한 바코드 유형을 지정하고 입력 텍스트(바코드 이미지에 인코딩할 데이터)를 설정하고 배경 및 전경색, 글꼴, 텍스트 위치(숨기기, 위 또는 아래) 및 정렬. QR Code, PDF417, Data Matrix, Aztec Code 등의 2차원 바코드는 1차원 바코드와 동일합니다.
                </p>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/pdf417/" name="PDF417" description="PDF417 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/qr/" name="QR" description="QR 코드, GS1 QR 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/datamatrix/" name="Data Matrix" description="Data Matrix 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/aztec/" name="Aztec" description="Aztec 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/swiss-qr/" name="Swiss QR" description="Swiss QR 청구서" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/dotcode/" name="DotCode" description="DotCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/hibc/" name="HIBC" description="HIBC (의료 산업 바코드)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/codablock/" name="Codablock-F" description="Codablock-F 및 GS1 Codablock-F 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/databar/" name="GS1 DataBar" description="GS1 DataBar(Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, Truncated) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/itf/" name="ITF" description="인터리브 2-of-5(ITF) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/ean/" name="EAN" description="EAN (국제 문서 번호) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/upc/" name="UPC" description="UPC(범용 제품 코드) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/code128/" name="GS1 Code 128" description="GS1 Code 128 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/code39/" name="Code 39" description="Code 39 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/code16k/" name="Code 16K" description="Code 16K 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/code32/" name="Code 32" description="이탈리아어 Pharmacode(Code 32) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/code93/" name="Code 93" description="Code 93 확장 및 Code 93 표준 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/onecode/" name="USPS OneCode" description="USPS OneCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 of 5) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/isbn/" name="ISBN" description="ISBN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/ismn/" name="ISMN" description="ISMN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/issn/" name="ISSN" description="ISSN 바코드" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/australia-post/" name="Australia Post" description="Australia Post 바코드 및 Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode 및 Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/rm4scc/" name="RM4SCC" description="Royal Mail 4주 고객 코드(RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/postnet/" name="Postnet" description="Postnet 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/royal-mail/" name="Royal Mail" description="Royal Mail 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/singapore-post/" name="Singapore Post" description="Singapore Post 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="릴리즈 노트" href="https://docs.aspose.com/barcode/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="왜 .NET용 Aspose.BarCode인가요?" tabId="success-stories" >}}
