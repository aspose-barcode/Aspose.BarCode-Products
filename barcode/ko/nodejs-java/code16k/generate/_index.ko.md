---
title: Node.js via Java을(를) 통해 Code 16K 바코드 이미지 생성
description: JavaScript 애플리케이션에서 Code 16K 바코드 생성을 위한 Node.js 샘플 코드입니다.
lang: ko/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ko/nodejs-java/code16k/generate/
aliases:
- /ko/nodejs-java/generate/code16k/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js via Java로 Code 16K 라벨 생성" h2="Node.js via Java API용 서버 측 Aspose.BarCode를 사용하여 JavaScript에서 Code 16K 바코드을 생성합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Code 16K 바코드 Using Node.js via Java" %}}
Node.js 애플리케이션 내에서 Code 16K 바코드 바코드를 생성하려면 Java 지향 플랫폼용으로 설계된 강력하고 사용자 친화적인 고급 바코드 API인 Java를 통해 Node.js용 Aspose.BarCode를 획득하십시오. NPM에서 Javascript용 [aspose.barcode](https://releases.aspose.com/barcode/nodejs/)를 쉽게 설치할 수 있습니다.
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript에서 Code 16K 바코드을 생성하는 단계" %}}
...
<ul><li>BarCodeGenerator 클래스의 인스턴스 생성</li><li>Code 16K 바코드을 EncodeTypes 매개변수로 설정</li><li>인코딩할 텍스트를 두 번째 매개변수로 정의</li><li>필요한 경우 바코드 크기 및 위치 결정</li><li>BarCodeGenerator.save 메서드를 호출하여 생성된 바코드 이미지 가져오기</li></ul>
