---
title: Node.js via Java을(를) 통해 Swiss Post Parcel 이미지 스캔
weight: 1510
description: JavaScript 애플리케이션에서 Swiss Post Parcel 스캔 및 디코딩을 위한 Node.js 소스 코드입니다.
lang: ko/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ko/nodejs-java/swiss-post-parcel/recognize/
aliases:
- /ko/nodejs-java/recognize/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js via Java로 Swiss Post Parcel 바코드 읽기" h2="Node.js via Java API용 서버 측 Aspose.BarCode를 사용하여 JavaScript에서 Swiss Post Parcel 읽기" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Node.js 애플리케이션 내에서 Swiss Post Parcel을(를) 인식하려면 Java 기반 환경용으로 도입된 강력하고 다목적이며 사용자 친화적인 바코드 라이브러리인 Java를 통해 Node.js용 Aspose.BarCode를 사용하십시오. NPM에서 직접 Javascript용 [aspose.barcode](https://releases.aspose.com/barcode/nodejs/)를 로드할 수 있습니다.
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript에서 Swiss Post Parcel 스캔 단계" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode를 통해 개발자는 몇 줄의 코드로 스트림 또는 이미지에서 Swiss Post Parcel 바코드를 읽을 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Aspose.BarCode.BarCodeReader 클래스의 객체 생성</li><li>Swiss Post Parcel을 매개변수로 포함하는 소스 파일 경로 전달</li><li>DecodeType에서 대상 바코드 유형 설정 두 번째 매개변수로</li><li>감지된 모든 바코드를 반복</li><li>CodeText 속성을 사용하여 결과 바코드 텍스트 가져오기</li></ul>
