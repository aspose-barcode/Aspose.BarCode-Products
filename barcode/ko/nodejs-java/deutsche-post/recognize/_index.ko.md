---
title: Node.js via Java을(를) 통해 Deutsche Post Identcode 및 Deutsche Post Leitcode 이미지 스캔
weight: 1510
description: JavaScript 애플리케이션에서 Deutsche Post Identcode 및 Deutsche Post Leitcode 스캔 및 디코딩을 위한 Node.js 소스 코드입니다.
lang: ko/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ko/nodejs-java/deutsche-post/recognize/
aliases:
- /ko/nodejs-java/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js via Java로 Deutsche Post 바코드 읽기" h2="Node.js via Java API용 서버 측 Aspose.BarCode를 사용하여 JavaScript에서 Deutsche Post Identcode 및 Deutsche Post Leitcode 읽기" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Deutsche Post 바코드 Using Node.js via Java" %}}
Node.js 애플리케이션 내에서 Deutsche Post 바코드을(를) 인식하려면 Java 기반 환경용으로 도입된 강력하고 다목적이며 사용자 친화적인 바코드 라이브러리인 Java를 통해 Node.js용 Aspose.BarCode를 사용하십시오. NPM에서 직접 Javascript용 [aspose.barcode](https://releases.aspose.com/barcode/nodejs/)를 로드할 수 있습니다.
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript에서 Deutsche Post 바코드 스캔 단계" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode를 통해 개발자는 몇 줄의 코드로 스트림 또는 이미지에서 Deutsche Post 바코드 바코드를 읽을 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Aspose.BarCode.BarCodeReader 클래스의 객체 생성</li><li>Deutsche Post 바코드을 매개변수로 포함하는 소스 파일 경로 전달</li><li>DecodeType에서 대상 바코드 유형 설정 두 번째 매개변수로</li><li>감지된 모든 바코드를 반복</li><li>CodeText 속성을 사용하여 결과 바코드 텍스트 가져오기</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/pdf417/recognize/" name="PDF417" description="PDF417 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/qr/recognize/" name="QR" description="QR 코드, GS1 QR 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/aztec/recognize/" name="Aztec" description="Aztec 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR 청구서" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/dotcode/recognize/" name="DotCode" description="DotCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/hibc/recognize/" name="HIBC" description="HIBC (의료 산업 바코드)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/codablock/recognize/" name="Codablock-F" description="Codablock-F 및 GS1 Codablock-F 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar(Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, Truncated) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/itf/recognize/" name="ITF" description="인터리브 2-of-5(ITF) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/ean/recognize/" name="EAN" description="EAN (국제 문서 번호) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/upc/recognize/" name="UPC" description="UPC(범용 제품 코드) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/code39/recognize/" name="Code 39" description="Code 39 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/code16k/recognize/" name="Code 16K" description="Code 16K 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/code32/recognize/" name="Code 32" description="이탈리아어 Pharmacode(Code 32) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/code93/recognize/" name="Code 93" description="Code 93 확장 및 Code 93 표준 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 of 5) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/isbn/recognize/" name="ISBN" description="ISBN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/ismn/recognize/" name="ISMN" description="ISMN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/issn/recognize/" name="ISSN" description="ISSN 바코드" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/australia-post/recognize/" name="Australia Post" description="Australia Post 바코드 및 Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode 및 Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4주 고객 코드(RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/postnet/recognize/" name="Postnet" description="Postnet 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/royal-mail/recognize/" name="Royal Mail" description="Royal Mail 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/singapore-post/recognize/" name="Singapore Post" description="Singapore Post 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/nodejs-java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
