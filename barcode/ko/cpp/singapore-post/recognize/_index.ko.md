---
title: C++을(를) 통해 Singapore Post 바코드 이미지 스캔
weight: 1510
description: Windows 32비트, Windows 64비트 또는 Linux 64비트용 C++ 런타임 환경에서 Singapore Post 바코드을 스캔하고 디코딩하는 C++ 샘플 코드.
lang: ko/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ko/cpp/singapore-post/recognize/
aliases:
- /ko/cpp/recognize/singapore-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C++로 Singapore Post 바코드 읽기" h2="C++ API용 서버 측 Aspose.BarCode를 사용하여 C++에서 Singapore Post 바코드 읽기" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Singapore Post 바코드 Using C++" %}}
Singapore Post 바코드을(를) 스캔하려면 C++ 플랫폼을 위한 풍부한 기능을 갖춘 강력하고 사용하기 쉬운 바코드 라이브러리인 [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API를 사용해 보세요. . 최신 버전을 직접 다운로드할 수 있습니다. [NuGet](https://www.nuget.org/packages/aspose.barcode) 패키지 관리자를 열고 **Aspose.BarCode.Cpp**를 검색한 다음 패키지를 설치하면 됩니다. 또는 패키지 관리자 콘솔에서 다음 명령을 실행할 수 있습니다.
...
<ul><li>Aspose.BarCode.BarCodeReader 클래스의 객체 생성</li><li>Singapore Post 바코드을 매개변수로 포함하는 소스 이미지 경로 지정</li><li>필요한 바코드 유형을 DecodeType을 두 번째 매개변수로</li><li>인식 결과 반복</li><li>CodeText 속성을 사용하여 디코딩된 바코드 텍스트 로드</li></ul>
