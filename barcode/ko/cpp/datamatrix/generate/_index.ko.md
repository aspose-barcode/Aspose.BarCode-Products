---
title: C++을(를) 통해 Data Matrix 코드 이미지 생성
description: Windows 32비트, Windows 64비트 및 Linux 64비트용 C++ 런타임 환경에서 Data Matrix 코드을 생성하는 C++ 코드 예제입니다.
lang: ko/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ko/cpp/datamatrix/generate/
aliases:
- /ko/cpp/generate/datamatrix/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C++로 Data Matrix 라벨 생성" h2="C++ API용 서버 측 Aspose.BarCode를 사용하여 C++에서 Data Matrix 코드을 생성합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Data Matrix" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Data Matrix 코드 Using C++" %}}
Data Matrix 코드을(를) 생성하려면 C++ 플랫폼을 위한 풍부한 기능을 갖춘 강력하고 사용하기 쉬운 바코드 라이브러리인 [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API를 설치하세요. . [NuGet](https://www.nuget.org/packages/aspose.barcode) 패키지 관리자에서 직접 최신 버전을 다운로드합니다. **Aspose.BarCode.Cpp**를 검색한 다음 패키지를 설치합니다. 또는 패키지 관리자 콘솔을 열고 다음 명령을 실행합니다.
...
<ul><li>BarcodeGenerator 클래스의 객체 생성</li><li>Data Matrix 코드을 매개변수로 전달</li><li>인코딩할 입력 텍스트를 두 번째 매개변수로 삽입</li><li>필요한 경우 이미지 크기 정의</li><li>BarcodeGenerator.Save 메서드를 호출하여 Data Matrix 코드 바코드를 다운로드합니다.</li></ul>
