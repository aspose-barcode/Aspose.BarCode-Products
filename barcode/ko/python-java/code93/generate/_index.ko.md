---
title: Python via Java을(를) 통해 Code 93 확장 및 Code 93 표준 바코드 이미지 생성
description: Java Runtime Environment를 사용하여 Code 93 확장 및 Code 93 표준 바코드를 생성하는 Python 샘플 코드입니다.
lang: ko
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ko/python-java/code93/generate/
aliases:
- /ko/python-java/generate/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Python via Java로 Code 93 라벨 생성" h2="Python via Java API용 서버 측 Aspose.BarCode를 사용하여 Python에서 Code 93 확장 및 Code 93 표준 바코드을 생성합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Code 93 바코드 Using Python via Java" %}}
Code 93 바코드 이미지를 만들려면 기능이 풍부하고 강력하며 사용하기 쉬운 [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API를 받으세요. -Python 기반 애플리케이션용 바코드 라이브러리 사용. [Aspose 릴리스](https://releases.aspose.com/barcode/python-java/) 포털에서 직접 최신 버전을 받거나 다음 명령을 사용하여 pip에서 'aspose-barcode'를 설치합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Python에서 Code 93 바코드을 생성하는 단계" %}}
...
<ul><li>BarCodeGenerator 클래스의 새 객체 생성</li><li>원하는 바코드 유형을 EncodeTypes 매개변수로 결정</li><li>입력 텍스트를 두 번째 매개변수로 삽입</li><li> BarCodeGenerator.save 메서드를 호출하여 생성된 Code 93 확장 및 Code 93 표준 바코드 이미지를 가져옵니다.</li></ul>
