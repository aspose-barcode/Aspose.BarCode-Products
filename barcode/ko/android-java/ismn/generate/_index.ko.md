---
title: Android via Java을(를) 통해 ISMN 바코드 이미지 생성
description: Android Runtime Environment에서 ISMN 바코드을(를) 생성하기 위한 Android 소스 코드입니다.
lang: ko/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ko/android-java/ismn/generate/
aliases:
- /ko/android-java/generate/ismn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Android via Java로 ISMN 라벨 생성" h2="Android via Java API용 서버 측 Aspose.BarCode를 사용하여 Java에서 ISMN 바코드을 생성합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate ISMN 바코드 Using Android via Java" %}}
Android 애플리케이션 내에서 ISMN 바코드을 쉽게 생성하려면 Java를 통해 Android용 Aspose.BarCode를 사용해 보십시오. Android 애플리케이션용으로 특별히 설계된 다재다능하고 강력하며 사용자 친화적인 바코드 라이브러리입니다. 다음 구성을 build.gradle에 삽입하여 Maven 기반 프로젝트에서 직접 Java를 통해 Android용 Aspose.BarCode를 쉽게 만들 수 있습니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java에서 ISMN 바코드을 생성하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode를 사용하면 개발자가 몇 줄의 코드로 ISMN 바코드 이미지를 쉽게 만들 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

<ul><li>BarCodeGenerator 클래스의 새 인스턴스 생성</li><li>ISMN 바코드 바코드 유형을 EncodeTypes 매개변수로 전달</li><li>setCodeText 메서드를 사용하여 바코드 텍스트 정의</li><li>generateBarCodeImage() 메서드를 실행하여 ISMN 바코드 바코드 이미지를 저장합니다.</li></ul>
