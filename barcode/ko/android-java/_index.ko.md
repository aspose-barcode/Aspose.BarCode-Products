...
{{< blocks/products/pf/upper-banner h1="바코드 생성 및 인식을 위한 Android API" h2="모든 Android 모바일 앱의 이미지에서 1D, 2D 및 우편 바코드를 만들거나 읽습니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" pfName="Aspose.BarCode" subTitlepfName="Android via Java 용" downloadUrl="https://releases.aspose.com/barcode/androidjava/" >}}
...
<p>Java를 통한 Android용 Aspose.BarCode는 Android 애플리케이션용 바코드 생성 및 판독 API입니다. 다양한 각도에서 이미지의 1D, 2D 및 우편 바코드 스캐닝을 지원합니다. 바코드 생성기 API는 바코드 이미지를 쉽게 생성하고 다양한 형식으로 저장할 수 있습니다. 또한 바코드 테두리, 색상, 회전 각도, 해상도 등을 사용자 지정하는 것과 같은 풍부한 이미징 기능을 제공합니다.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="플랫폼 독립성" description="Android Runtime Environment를 사용할 수 있는 모든 플랫폼에서 API를 사용하세요." >}}
<div class='diagram1 d1-android'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="지원되는 파일 형식" description="Android via Java용 Aspose.BarCode는 가장 일반적으로 사용되는 이미지 파일 형식과 함께 작동합니다." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/qr-code-generation/'>QR 코드에 영어가 아닌 문자 인코딩</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-color-modification/'>바코드 색 구성표 수정</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-appearance-customization/'>바코드 이미지를 원하는 각도로 회전</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/working-with-barcode-types/'>60개 이상의 바코드 생성 및 인식</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/recognition-settings/'>이미지에서 바코드 읽기</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-image-saving/'>다양한 이미지 형식으로 바코드 내보내기</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    Android via Java용 바코드 라이브러리를 사용하면 개발자가 바코드 유형, 인코딩할 데이터, 바코드 크기, 글꼴 스타일 및 색상, 방향 각도를 비롯한 몇 가지 일반적인 바코드 매개변수를 사용자 지정할 수 있습니다. 바코드를 생성하려면 UPC 또는 EAN과 같이 생성할 필수 바코드 유형을 선택해야 합니다. 제품 번호나 URL과 같이 바코드에 저장할 데이터도 입력해야 합니다. 또한 필요한 크기 조정 모드를 설정하고 바코드 요소의 색상, 해상도, 테두리 스타일 및 기타 모양 관련 매개변수를 조정할 수 있습니다. 막대의 너비와 막대 사이의 간격을 수정할 수 있습니다. 이러한 추가 매개변수는 바코드의 가독성과 품질에 영향을 미칠 수 있으므로 매개변수의 목적과 올바르게 조정하는 방법을 이해하는 것이 중요합니다.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    바코드 생성기 API는 필요한 유형을 지정하고 입력 텍스트(바코드로 인코딩할 데이터)를 설정하고 배경 및 전경색, 글꼴 및 텍스트 캡션과 같은 모양 관련 속성을 사용자 지정하여 바코드를 생성할 수 있습니다. PDF417, Data Matrix, Aztec Code, QR Code, Micro QR Code 등의 2차원 바코드는 1D 유형과 동일한 방식으로 생성할 수 있습니다.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    바코드 API를 사용하면 60가지가 넘는 인기 있는 1D 및 2D 유형의 바코드를 감지하고 읽을 수 있습니다. 몇 줄의 코드만 있으면 바코드를 스캔할 수 있으므로 이 기능을 애플리케이션에 쉽게 통합할 수 있습니다. 이 강력한 기능을 사용하면 이미지, 문서 등과 같은 다양한 소스에서 바코드를 스캔하고 읽을 수 있습니다. 이 기능을 사용하여 프로세스를 자동화하고 오류 위험을 줄이며 전반적인 운영 효율성을 높일 수 있습니다. 소매, 물류, 의료 또는 기타 분야를 위한 애플리케이션을 개발해야 하는 경우 이 바코드 API는 바코드 감지 및 읽기 작업을 위한 솔루션을 제공할 수 있습니다.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/pdf417/" name="PDF417" description="PDF417 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/qr/" name="QR" description="QR 코드, GS1 QR 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/datamatrix/" name="Data Matrix" description="Data Matrix 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/aztec/" name="Aztec" description="Aztec 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/swiss-qr/" name="Swiss QR" description="Swiss QR 청구서" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/dotcode/" name="DotCode" description="DotCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/hibc/" name="HIBC" description="HIBC (의료 산업 바코드)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/codablock/" name="Codablock-F" description="Codablock-F 및 GS1 Codablock-F 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/databar/" name="GS1 DataBar" description="GS1 DataBar(Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, Truncated) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/itf/" name="ITF" description="인터리브 2-of-5(ITF) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/ean/" name="EAN" description="EAN (국제 문서 번호) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/upc/" name="UPC" description="UPC(범용 제품 코드) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/code128/" name="GS1 Code 128" description="GS1 Code 128 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/code39/" name="Code 39" description="Code 39 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/code16k/" name="Code 16K" description="Code 16K 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/code32/" name="Code 32" description="이탈리아어 Pharmacode(Code 32) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/code93/" name="Code 93" description="Code 93 확장 및 Code 93 표준 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/onecode/" name="USPS OneCode" description="USPS OneCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 of 5) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/isbn/" name="ISBN" description="ISBN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/ismn/" name="ISMN" description="ISMN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/issn/" name="ISSN" description="ISSN 바코드" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/australia-post/" name="Australia Post" description="Australia Post 바코드 및 Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode 및 Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/rm4scc/" name="RM4SCC" description="Royal Mail 4주 고객 코드(RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/postnet/" name="Postnet" description="Postnet 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/royal-mail/" name="Royal Mail" description="Royal Mail 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/singapore-post/" name="Singapore Post" description="Singapore Post 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="소스 코드" href="https://github.com/aspose-barcode/Android-Library-Usage-Examples" >}}
{{< blocks/products/pf/slr-element name="API 참조" href="https://reference.aspose.com/barcode/androidjava/" >}}
...
{{< blocks/products/pf/slr-element name="릴리즈 노트" href="https://docs.aspose.com/barcode/java/android-via-java-release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="왜 Android via Java용 Aspose.BarCode인가요?" tabId="success-stories" >}}
