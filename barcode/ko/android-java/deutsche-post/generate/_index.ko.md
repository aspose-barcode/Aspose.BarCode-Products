---
title: Android via Java을(를) 통해 Deutsche Post Identcode 및 Deutsche Post Leitcode 이미지 생성
description: Android Runtime Environment에서 Deutsche Post Identcode 및 Deutsche Post Leitcode을(를) 생성하기 위한 Android 소스 코드입니다.
lang: ko
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ko/android-java/deutsche-post/generate/
aliases:
- /ko/android-java/generate/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Android via Java로 Deutsche Post 라벨 생성" h2="Android via Java API용 서버 측 Aspose.BarCode를 사용하여 Java에서 Deutsche Post Identcode 및 Deutsche Post Leitcode을 생성합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Deutsche Post 바코드 Using Android via Java" %}}
Android 애플리케이션 내에서 Deutsche Post 바코드을 쉽게 생성하려면 Java를 통해 Android용 Aspose.BarCode를 사용해 보십시오. Android 애플리케이션용으로 특별히 설계된 다재다능하고 강력하며 사용자 친화적인 바코드 라이브러리입니다. 다음 구성을 build.gradle에 삽입하여 Maven 기반 프로젝트에서 직접 Java를 통해 Android용 Aspose.BarCode를 쉽게 만들 수 있습니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java에서 Deutsche Post 바코드을 생성하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode를 사용하면 개발자가 몇 줄의 코드로 Deutsche Post 바코드 이미지를 쉽게 만들 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

<ul><li>BarCodeGenerator 클래스의 새 인스턴스 생성</li><li>Deutsche Post 바코드 바코드 유형을 EncodeTypes 매개변수로 전달</li><li>setCodeText 메서드를 사용하여 바코드 텍스트 정의</li><li>generateBarCodeImage() 메서드를 실행하여 Deutsche Post Identcode 및 Deutsche Post Leitcode 바코드 이미지를 저장합니다.</li></ul>
...
<ul><li>Microsoft Windows, Linux 또는 Android 런타임 환경과 호환되는 모든 OS</li><li>Android SDK v.30</li><li>Android OS 2.0 이상을 실행하는 Android 시스템</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/pdf417/generate/" name="PDF417" description="PDF417 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/qr/generate/" name="QR" description="QR 코드, GS1 QR 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/datamatrix/generate/" name="Data Matrix" description="Data Matrix 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/aztec/generate/" name="Aztec" description="Aztec 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/swiss-qr/generate/" name="Swiss QR" description="Swiss QR 청구서" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/dotcode/generate/" name="DotCode" description="DotCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/hibc/generate/" name="HIBC" description="HIBC (의료 산업 바코드)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/codablock/generate/" name="Codablock-F" description="Codablock-F 및 GS1 Codablock-F 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/databar/generate/" name="GS1 DataBar" description="GS1 DataBar(Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, Truncated) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/itf/generate/" name="ITF" description="인터리브 2-of-5(ITF) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/ean/generate/" name="EAN" description="EAN (국제 문서 번호) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/upc/generate/" name="UPC" description="UPC(범용 제품 코드) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/code128/generate/" name="GS1 Code 128" description="GS1 Code 128 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/code39/generate/" name="Code 39" description="Code 39 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/code16k/generate/" name="Code 16K" description="Code 16K 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/code32/generate/" name="Code 32" description="이탈리아어 Pharmacode(Code 32) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/code93/generate/" name="Code 93" description="Code 93 확장 및 Code 93 표준 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/onecode/generate/" name="USPS OneCode" description="USPS OneCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/standard2of5/generate/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 of 5) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/isbn/generate/" name="ISBN" description="ISBN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/ismn/generate/" name="ISMN" description="ISMN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/issn/generate/" name="ISSN" description="ISSN 바코드" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/australia-post/generate/" name="Australia Post" description="Australia Post 바코드 및 Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Identcode 및 Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/rm4scc/generate/" name="RM4SCC" description="Royal Mail 4주 고객 코드(RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/postnet/generate/" name="Postnet" description="Postnet 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/royal-mail/generate/" name="Royal Mail" description="Royal Mail 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/singapore-post/generate/" name="Singapore Post" description="Singapore Post 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/android-java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
