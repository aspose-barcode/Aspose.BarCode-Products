---
title: Android via Java을(를) 통해 QR 코드, GS1 QR 코드 이미지 스캔
weight: 1510
description: Android Runtime Environment에서 QR 코드, GS1 QR 코드을(를) 인식하기 위한 Android 샘플 코드입니다.
lang: ko/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ko/android-java/qr/recognize/
aliases:
- /ko/android-java/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Android via Java로 QR 바코드 읽기" h2="Android via Java API용 서버 측 Aspose.BarCode를 사용하여 Java에서 QR 코드, GS1 QR 코드 읽기" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read QR 코드 Using Android via Java" %}}
Java를 통해 Android용 Aspose.BarCode를 사용하여 Android 애플리케이션 내에서 QR 코드을 쉽게 감지하고 읽으십시오. Android 애플리케이션을 위한 풍부하고 확장 가능하며 사용자 친화적인 바코드 API입니다. build.gradle에 다음 구성을 추가하여 Maven 기반 프로젝트에서 직접 Aspose.BarCode for Java를 가져옵니다.
...
<ul><li>BarCodeReader 클래스의 인스턴스 생성</li><li>QR 코드을 포함하는 소스 이미지 경로 결정</li><li>DecodeType의 대상 바코드 유형을 두 번째 매개변수로 정의</li><li>인식 결과 반복</li><li>getCodeText 메서드를 실행하여 디코딩된 텍스트 로드</li></ul>
