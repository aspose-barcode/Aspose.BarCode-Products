---
title: PHP via Java을(를) 통해 Swiss Post Parcel 이미지 생성
description: PHP 기반 애플리케이션에서 Swiss Post Parcel을 생성하기 위한 PHP 소스 코드입니다.
lang: ko/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ko/php-java/swiss-post-parcel/generate/
aliases:
- /ko/php-java/generate/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PHP via Java로 Swiss Post Parcel 라벨 생성" h2="PHP via Java API용 서버 측 Aspose.BarCode를 사용하여 PHP에서 Swiss Post Parcel을 생성합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Java 기반 플랫폼을 위한 효율적이고 확장 가능하며 사용자 친화적인 바코드 API인 Java를 통해 PHP용 Aspose.BarCode를 사용하여 PHP 애플리케이션 내에서 맞춤형 Swiss Post Parcel 바코드를 생성합니다. 바코드 라이브러리를 실행하려면 [Aspose 릴리스](https://releases.aspose.com/barcode/php/) 포털에서 최신 버전을 다운로드하십시오. 그렇지 않으면 Packagist에서 [aspose/barcode](https://packagist.org/packages/aspose/barcode) 패키지를 가져온 다음 작곡가를 사용하여 PHP 프로젝트에 포함합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="PHP에서 Swiss Post Parcel을 생성하는 단계" %}}
...
<ul><li>BarCodeGenerator 클래스의 새 인스턴스 생성</li><li>Swiss Post Parcel 및 기타 관련 바코드 유형을 EncodeTypes 매개변수로 지정</li><li>바코드 텍스트를 두 번째 매개변수로 설정</li><li>필요한 경우 이미지 크기 및 위치 지정</li><li>BarCodeGenerator.save 메서드를 호출하여 필요한 형식의 Swiss Post Parcel 이미지를 얻습니다.</li></ul>
