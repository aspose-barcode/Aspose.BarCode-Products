---
title: PHP via Java을(를) 통해 UPC(범용 제품 코드) 바코드 이미지 스캔
weight: 1510
description: PHP 기반 애플리케이션에서 UPC(범용 제품 코드) 바코드을(를) 읽기 위한 PHP 샘플 코드입니다.
lang: ko
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ko/php-java/upc/recognize/
aliases:
- /ko/php-java/recognize/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PHP via Java로 UPC 바코드 읽기" h2="PHP via Java API용 서버 측 Aspose.BarCode를 사용하여 PHP에서 UPC(범용 제품 코드) 바코드 읽기" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read UPC(범용 제품 코드) 바코드 Using PHP via Java" %}}
Java 기반 플랫폼을 위한 강력하고 풍부하며 사용자 친화적인 바코드 라이브러리인 Java를 통해 PHP용 Aspose.BarCode를 사용하여 PHP 애플리케이션 내에서 UPC(범용 제품 코드) 바코드 바코드를 읽습니다. 바코드 API를 사용하려면 [Aspose 릴리스](https://releases.aspose.com/barcode/php/) 포털에서 최신 버전을 다운로드해야 합니다. Packagist에서 [aspose/barcode](https://packagist.org/packages/aspose/barcode) 패키지를 찾은 다음 작성기를 통해 PHP 프로젝트에 통합할 수도 있습니다.
...
{{% blocks/products/pf/agp/feature-section-col title="PHP에서 UPC(범용 제품 코드) 바코드 스캔 단계" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader 클래스의 객체 생성</li><li>UPC(범용 제품 코드) 바코드을 매개변수로 포함하는 소스 이미지 경로 설정</li><li>DecodeType에서 대상 바코드 유형 지정 두 번째 매개변수로</li><li>판독 결과 반복</li><li>CodeText 속성을 사용하여 바코드 텍스트 가져오기</li></ul>
