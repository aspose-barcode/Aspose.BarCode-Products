---
title: PHP 바코드 생성기 및 스캐너 API - Aspose
weight: 830
url: /ko/php-java/ 
description: 1D, 2D 및 우편을 포함한 다양한 유형의 바코드를 인식하는 PHP 바코드 리더 라이브러리. 핵심 PHP 또는 codeigniter, cakephp 또는 laravel과 같은 프레임워크 내에서 API를 사용합니다.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="PHP 바코드 생성기 및 리더 API" h2="모든 PHP 웹 응용 프로그램의 이미지에서 1D, 2D 및 우편 바코드를 스캔하거나 생성합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="https://downloads.aspose.com/barcode/php" >}}

{{< blocks/products/pf/main-container pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" >}}

{{< blocks/products/pf/i18n/sub-menu logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-php-java.svg" liveDemosLink="" PricingLink="https://purchase.aspose.com/pricing/barcode/php-java" buyLink="https://purchase.aspose.com/buy" docsLink="https://docs.aspose.com/barcode/java/php-via-java-release-notes/" installationsDocsLink="" nugetLink="" nugetPackageName="" mavenRepoLink="https://repository.aspose.com/webapp/#/artifacts/browse/tree/일반적인/repo/com/aspose/aspose-barcode" directDownloadLink="https://downloads.aspose.com/barcode/php" >}}

{{< blocks/products/pf/i18n/tab-content >}}
<p>
 Aspose.BarCode for PHP via Java는 PHP 애플리케이션 및 스크립트용 바코드 생성 및 읽기 API 세트입니다. 개발자는 다양한 각도에서 이미지에서 1D, 2D 및 우편 바코드를 쉽게 읽을 수 있습니다. 바코드 생성기 API는 JPG, PNG, GIF, BMP와 같은 다양한 형식의 바코드 이미지를 생성합니다. 또한 테두리 조작, 색상, 이미지 회전, 해상도 사용자 정의 등과 같은 여러 이미징 기능을 지원합니다.
</p>
...
<div class="diagram1 d1-php-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <!--<header><i class="fa fa-print"> </i>인쇄</header>
...
-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="바코드 안드로이드 라이브러리" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-php-java.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="플랫폼 독립성" description="Java를 통한 PHP용 Aspose.Barcode에는 PHP 5.3(또는 그 이상) 및 JavaBridge가 필요합니다. 이러한 요구 사항이 충족될 수 있는 모든 플랫폼에서 실행할 수 있습니다." >}}
<div class="diagram1 d1-php-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="바코드 생성기 안드로이드" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-php-java.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="지원되는 파일 형식" description="API는 가장 일반적으로 사용되는 이미지 형식으로 작동합니다." >}}
...
<li>WebP</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="안드로이드 바코드 리더 API" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-php-java.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
  ...
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="java"> //바코드 객체 인스턴스화
...
--&gt; <!--<div class="col-lg-12"><!-- <h2 class="h2title">우편 엽서 Symbologies Include:</h2> -->
   <!--<p>우편 엽서 types include:</p>
...
<h2 class="h2title">이미징, Rotation & Sizing</h2>
...
{{< blocks/products/pf/slr-element name="선적 서류 비치" href="https://docs.aspose.com/barcode/java/aspose-barcode-java-for-php/" >}}
{{< blocks/products/pf/slr-element name="소스 코드" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java/tree/master/Plugins/Aspose_Barcode_Java_for_PHP" >}}
{{< blocks/products/pf/slr-element name="API 참조" href="https://apireference.aspose.com/barcode/java" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Java를 통해 PHP용 Aspose.BarCode를 사용해야 하는 이유는 무엇입니까?" tabId="success-stories" >}}
