---
title: JasperReports에서 바코드 생성 및 BMP JPG GIF & PNG로 렌더링
description: JasperReports용 Aspose.BarCode를 사용하여 개발자는 Jasper Reports에서 바코드를 생성하여 BMP JPG GIF 및 PNG 형식으로 추가 렌더링할 수 있습니다.
lang: ko/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="JasperReports에서 바코드 생성 및 내보내기" h2="JasperReports & JasperServer API는 1D, 2D 및 Postal 바코드를 생성, 표시 및 내보내기합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="JasperReports 용" downloadUrl="https://releases.aspose.com/barcode/jasperreports/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.BarCode" subTitlepfName="JasperReports 용" >}}
...
<p>Aspose.BarCode for JasperReports는 응용 프로그램에서 바코드 레이블을 만들고 표시하는 유연한 JasperReports 및 JasperServer 확장입니다. 이러한 바코드 라벨은 널리 사용되는 다양한 이미지 형식으로 렌더링할 수 있습니다.</p>
{{< /blocks/products/pf/tab-content >}}
...
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>선형, 2D 및 우편</li><li>스트림 또는 이미지에서 감지</li><li>바코드 방향 가져오기</li><li>영어가 아닌 문자 디코딩</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                인쇄
            </header>
            <ul><li>바코드 직접 인쇄</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>선형, 2D 및 우편</li><li>스트림 또는 이미지에 저장</li><li>모양 사용자 지정&colon; 크기, 색상, 각도</li><li>영어 이외의 문자 인코딩 </li></ul>
            <header>
                <i class="fa fa-qrcode">
                </i>
                유형
            </header>
            <ul><li>선형</li><li>2D</li><li>우편</li></ul>
        </div>
        <!--/right-->
    </div>
    <!--/row-->
...
{{< blocks/products/pf/carousel-item h3="플랫폼 독립성" description="JasperReports용 Aspose.BarCode는 JasperServer 및 JasperReports와 함께 사용할 수 있습니다." >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="지원되는 파일 형식" description="JasperReports용 Aspose.BarCode는 가장 일반적으로 사용되는 이미지 파일 형식과 함께 작동합니다." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                바코드 내보내기 기능에 대한 고급 JasperReports
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>바코드로 보고서 생성 및 인쇄</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>바코드 기능을 추가하여 애플리케이션 워크플로우 향상</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>추적 가능성을 돕기 위해 파일에 바코드 포함</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/barcode-image-basic-features/'>제어 코드의 크기, 색상 및 코드 텍스트</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/read-barcodes-with-aspose-barcode-apis/'>3D 왜곡 및 회전된 2D 바코드 인식</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/generate-barcode-by-specifying-custom-image-size/'>특정 크기의 바코드 이미지 생성</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    JasperReports용 Aspose.BarCode는 JasperReports의 바코드 작업을 위한 특수 도구 세트를 제공합니다. 개발자는 이 API를 사용하여 기존 보고서에 있는 바코드를 스캔하거나 새 보고서에 추가할 수 있습니다. 이 바코드 라이브러리는 순수하게 Java로 코딩되고 단일 JAR 문서로 제공되며 JasperReports 또는 JasperServer가 설치된 시스템에 쉽게 배포할 수 있습니다. JasperReports 바코드 확장을 설치하려면 JAR 문서를 올바른 폴더 위치에 복사하고 작업을 시작하면 됩니다.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    바코드 생성기 라이브러리를 사용하면 개발자가 바코드 유형을 지정하고 인코딩할 데이터를 입력하고 사용자 지정 모양 관련 속성을 설정하여 바코드를 쉽게 만들 수 있습니다. 여기에는 배경 및 전경색, 글꼴, 크기, 해상도 및 텍스트 캡션과 같은 다양한 옵션이 포함됩니다. API는 동일한 기본 접근 방식을 사용하여 PDF417, Data Matrix, Aztec 코드, QR 코드 및 마이크로 QR 코드를 포함하여 1D 및 2D 바코드를 모두 생성할 수 있습니다. 이는 JasperReports를 포함하여 다양한 애플리케이션을 위한 광범위한 바코드 유형을 생성하기 위한 편리하고 사용자 친화적인 도구입니다.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    JasperReports에 바코드 삽입
                </h2>
                <p>
                    JasperReports를 사용하면 개발자는 데이터베이스, CSV 파일 및 XML 문서와 같은 다양한 소스에 저장된 데이터를 사용하여 보고서를 만들 수 있습니다. Java 응용 프로그램에 쉽게 통합할 수 있는 보고서 디자인, 서식 지정 및 내보내기를 위한 다양한 기능을 제공합니다. JasperReports의 일반적인 용도에는 송장, 영수증, 재무제표 및 기타 유형의 비즈니스 보고서 생성이 포함됩니다. 보고서의 정보 액세스 및 관리를 용이하게 하기 위해 JasperReports에 바코드를 삽입하는 것이 유용할 수 있습니다. 예를 들어 바코드를 사용하여 JasperReport의 정보를 빠르고 정확하게 스캔하고 업데이트할 수 있습니다. 즉, 인보이스의 바코드를 스캔하여 관련 데이터를 검색하고 표시합니다. 이를 통해 정보를 보다 쉽게 ​​추적 및 관리하고 오류 또는 불일치의 위험을 줄일 수 있습니다. 바코드는 보고서의 특정 항목이나 레코드를 표시하는 역할을 할 수도 있습니다.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
    ...
    <div class="barcode-read-lcs-controls">
        ...
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">모든 유형</option>
                <option value="Pdf417 ">PDF417</option>
                <option value="QR ">QR</option>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/pdf417/" name="PDF417" description="PDF417 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/qr/" name="QR" description="QR 코드, GS1 QR 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/datamatrix/" name="Data Matrix" description="Data Matrix 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/aztec/" name="Aztec" description="Aztec 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/swiss-qr/" name="Swiss QR" description="Swiss QR 청구서" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/dotcode/" name="DotCode" description="DotCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/hibc/" name="HIBC" description="HIBC (의료 산업 바코드)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/codablock/" name="Codablock-F" description="Codablock-F 및 GS1 Codablock-F 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/databar/" name="GS1 DataBar" description="GS1 DataBar(Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, Truncated) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/itf/" name="ITF" description="인터리브 2-of-5(ITF) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/ean/" name="EAN" description="EAN (국제 문서 번호) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/upc/" name="UPC" description="UPC(범용 제품 코드) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/code128/" name="GS1 Code 128" description="GS1 Code 128 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/code39/" name="Code 39" description="Code 39 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/code16k/" name="Code 16K" description="Code 16K 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/code32/" name="Code 32" description="이탈리아어 Pharmacode(Code 32) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/code93/" name="Code 93" description="Code 93 확장 및 Code 93 표준 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/onecode/" name="USPS OneCode" description="USPS OneCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 of 5) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/isbn/" name="ISBN" description="ISBN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/ismn/" name="ISMN" description="ISMN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/issn/" name="ISSN" description="ISSN 바코드" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/australia-post/" name="Australia Post" description="Australia Post 바코드 및 Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode 및 Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/rm4scc/" name="RM4SCC" description="Royal Mail 4주 고객 코드(RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/postnet/" name="Postnet" description="Postnet 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/royal-mail/" name="Royal Mail" description="Royal Mail 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/singapore-post/" name="Singapore Post" description="Singapore Post 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/jasperreports/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="사람들이 말하는 것" subTitle="우리의 말을 그대로 받아들이지 마십시오. API에 대한 사용자의 의견을 확인하십시오." caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 나는 내 제품을 개발하고 개선하는 데 수년을 보냈고 Aspose는 내 제품을 훨씬 더 친근하고 유용하게 만들어서 더 시장성 있게 만들 수 있게 해주었습니다. <em>킬 딜러 | KD Solutions, 폴란드</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode는 관리 코드로 작성되었으며 모든 종류의 문서 인식 및 추가 처리를 처리할 수 있는 다양한 바코드 유형을 제공합니다. <em>데니스 알렉산더 페트라스크 | Keil IT, 독일</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="선적 서류 비치" href="https://docs.aspose.com/barcode/jasperreports/" >}}
{{< blocks/products/pf/slr-element name="소스 코드" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="API 참조" href="https://reference.aspose.com/barcode/java/" >}}
{{< blocks/products/pf/slr-element name="튜토리얼 동영상" href="https://www.youtube.com/user/asposevideo" >}}
...
{{< blocks/products/pf/slr-element name="릴리즈 노트" href="https://docs.aspose.com/barcode/jasperreports/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="왜 JasperReports용 Aspose.BarCode인가요?" tabId="success-stories" >}}
{{< blocks/products/pf/slr-element name="고객 목록" href="https://about.aspose.com/customers" >}}
{{< blocks/products/pf/slr-element name="성공 사례" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Aspose.BarCode는 아래에 나열된 기타 널리 사용되는 개발 환경을 위한 개별 바코드 생성 및 인식 API를 제공합니다." >}}
