---
title: JasperReports에서 바코드 생성 및 BMP JPG GIF 및 PNG로 렌더링 
weight: 1900
url: /ko/jasperreports/ 
description: JasperReports용 Aspose.BarCode 사용 - 개발자는 BMP JPG GIF 및 PNG 형식으로 추가로 렌더링할 수 있는 Jasper Reports에서 바코드를 생성할 수 있습니다.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="JasperReports에서 바코드 생성 및 내보내기" h2="선형, 2D 및 우편 바코드를 여러 형식으로 생성, 표시 및 내보내기 위한 JasperReports 및 JasperServer API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/barcode/jasperreports" >}}
...
<p>
 JasperReports용 Aspose.BarCode는 애플리케이션에서 바코드 레이블을 생성하고 표시하기 위한 유연한 JasperReports 및 JasperServer 확장입니다. 이러한 바코드 레이블은 많이 사용되는 이미지 형식으로 렌더링할 수 있습니다.
</p>
...
{{< blocks/products/pf/carousel-item h3="한눈에" description="JasperReports API용 Aspose.BarCode 개요." >}}
<div class="diagram1 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Jasper 보고서 바코드 생성기" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Platform Independence" description="JasperReports용 Aspose.BarCode는 JasperServer 및 JasperReports와 함께 사용할 수 있습니다." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Jasper 보고서에서 바코드 생성" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="JasperReports 바코드 확장은 인기 있는 지원 [이미지 형식](https://docs.aspose.com/barcode/jasperreports/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="바코드 생성 in Jasper Report" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     내부 이미징 및 인식 필터에 대한 시간 초과 지원으로 종료 추가
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     1D, 2D &amp;를 위한 올인원 패키지 우편 바코드
    </h2>
    <p>
     JasperReports용 Aspose.BarCode는 다음을 포함하여 가장 널리 사용되는 선형, 2D 및 우편 바코드 기호를 25개 이상 지원합니다.
    </p>
    <div class="col-lg-6">
     <ul class="unstyled">
      <li>
    ...
    <div class="col-lg-6">
     <ul class="unstyled">
      ...
      <li>
       Supplement Code +2 (EAN 및 UPC 코드의 경우)
      </li>
      <li>
       Supplement Code +5 (EAN 및 UPC 코드의 경우)
      </li>
      <li>
       UPC A
      </li>
    ...
    <div class="col-lg-12">
     ...
     <p>
      JasperReports용 Aspose.BarCode를 사용하면 기호 유형, 텍스트(바코드 이미지로 인코딩될 코드 데이터)와 같은 다양한 옵션과 글꼴, 배경 및 전경색과 같은 모양을 조정하는 속성과 같은 다양한 옵션을 지정하여 바코드를 사용자 지정할 수 있습니다.
     </p>
     <p>
      캡션 글꼴, 배경/전경 색상, 정렬 및 위치(숨기기, 위, 아래) 등과 같은 바코드 캡션을 사용자 정의할 수도 있습니다.
     </p>
    </div>
    <div class="col-lg-12">
     <h2 class="h2title">
     ...
     <p>
      JasperReports용 Aspose.BarCode는 순수하게 Java로 코딩되어 있으며 단일 JAR 문서로 제공되며 JasperReports 또는 JasperServer를 실행하는 시스템에 쉽게 배포됩니다. JasperReports Barcode 확장을 설치하려면 JAR 문서를 올바른 폴더 위치에 복사하기만 하면 됩니다.
     </p>
    </div>
   </div>
  </div>
...
{{< blocks/products/pf/slr-element name="소스 코드" href="https://github.com/aspose-barcode?tab=repositories" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="JasperReports용 Aspose.BarCode를 사용하는 이유는 무엇입니까?" tabId="success-stories" >}}
