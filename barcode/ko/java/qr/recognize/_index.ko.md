---
title: Java을(를) 통해 QR 코드, GS1 QR 코드 이미지 스캔
weight: 1510
description: JSP/JSF 응용 프로그램 및 데스크톱 응용 프로그램용 Java Runtime Environment에서 QR 코드, GS1 QR 코드을 읽고 디코딩하는 Java 소스 코드입니다.
lang: ko
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ko/java/qr/recognize/
aliases:
- /ko/java/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Java로 QR 바코드 읽기" h2="Java API용 서버 측 Aspose.BarCode를 사용하여 Java에서 QR 코드, GS1 QR 코드 읽기" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read QR 코드 Using Java" %}}
QR 코드을(를) 인식하려면 [Aspose.BarCode for Java](https://products.aspose.com/barcode/java/) API, 강력하고 사용하기 쉬운 고급 Java용 바코드 라이브러리- 기반 플랫폼. [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-barcode)에서 최신 버전을 직접 다운로드하여 Maven 기반에 설치합니다. pom.xml에 다음 구성을 포함하여 프로젝트:
...
{{% blocks/products/pf/agp/feature-section-col title="Java에서 QR 코드 스캔 단계" %}}
...
<ul><li>BarCodeReader 클래스의 새 객체 생성</li><li>QR 코드을 포함하는 소스 파일 경로 설정</li><li>필요한 바코드 유형을 DecodeType에 두 번째 매개변수로 전달</li><li>디코딩 결과 반복</li><li>getCodeText 메서드를 사용하여 바코드 텍스트 가져오기</li></ul>
