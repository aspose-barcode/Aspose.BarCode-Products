...
{{< blocks/products/pf/upper-banner h1="자바 바코드 생성 및 인식 API" h2="모든 Java 애플리케이션 내에서 선형, 2D 및 우편 유형의 바코드를 만들고 인식합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" pfName="Aspose.BarCode" subTitlepfName="Java 용" downloadUrl="https://releases.aspose.com/barcode/java/" >}}
...
<p>Aspose.BarCode for Java는 Java 애플리케이션을 위한 바코드 생성 및 인식 기능을 제공하는 강력하고 안정적인 API입니다. 가장 확립된 표준 및 사양을 지원하며 개발자가 모든 각도에서 다양한 이미지 파일의 1D 및 2D 바코드를 읽을 수 있습니다. Aspose.BarCode for Java는 매우 유연한 이미징 옵션을 사용하여 다양한 이미지 형식으로 바코드 이미지를 렌더링합니다. 라이브러리는 60개 이상의 바코드 유형 인코딩 및 디코딩을 지원하고 바코드 이미지를 직접 인쇄할 수 있습니다.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="플랫폼 독립성" description="바코드 라이브러리를 사용하여 JRE 1.6 이상이 설치된 모든 유형의 Java 애플리케이션을 빌드할 수 있습니다." >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="지원되는 파일 형식" description="Java용 Aspose.BarCode는 가장 일반적으로 사용되는 이미지 파일 형식과 함께 작동합니다." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/control-the-appearance-of-code-text/'>코드 텍스트의 모양 관련 속성 조정 및 수정</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-the-barcode-caption/'>캡션 및 글꼴 스타일 관리</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/use-checksum-and-supplement-data-for-barcodes/'>체크섬 및 보충 데이터 지원</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#image-formats'>바코드 이미지를 여러 이미지 형식으로 생성</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/advanced-barcode-recognition-features/'>모든 각도에서 1D 및 2D 유형 판독</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/barcode-regions/'>영역을 지정하여 바코드 스캔</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/generate-barcode-by-specifying-custom-image-size/'>이미지 크기 맞춤설정</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-x-dimension-and-y-dimension/'>2D Type에 대한 X, Y 치수 지원</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#barcode-types'>선형, 2D 및 우편 기호 지원</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    Java용 바코드 API를 사용하면 개발자가 바코드 유형, 입력 텍스트, 글꼴 스타일, 배경 및 전경색, 캡션 정렬 및 위치, 기타 속성을 지정하여 생성된 바코드의 모양을 미세 조정할 수 있습니다. 위쪽 및 아래쪽 캡션, 글꼴, 색상 및 정렬에 대한 가시성을 설정하여 캡션을 수정할 수 있습니다.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    바코드 API를 사용하면 개발자가 응용 프로그램에서 고품질 바코드 이미지를 쉽게 생성할 수 있습니다. QR Code 및 Code 128과 같이 널리 사용되는 바코드 유형은 물론 Aztec Code 및 Data Matrix과 같은 보다 전문화된 유형을 포함하여 광범위한 바코드 유형을 지원합니다. API를 사용하면 개발자가 전경 및 배경 색상, 글꼴 및 캡션 정렬을 포함하여 생성된 바코드의 모양을 사용자 지정할 수 있습니다. 개발자는 API를 사용하여 1차원 바코드를 생성하는 것과 동일한 방식으로 2D 바코드를 쉽게 생성할 수 있습니다.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    바코드 라이브러리를 통해 개발자는 맞춤형 바코드를 생성할 수 있을 뿐만 아니라 생성된 이미지를 PDF 문서에 직접 추가할 수 있습니다. 먼저 지원되는 래스터 형식 중 하나를 사용하여 바코드 이미지를 만든 다음 PDF 파일에 삽입할 수 있습니다. API를 사용하면 이미지 압축 및 품질 손실 없이 바코드를 추가할 수 있습니다. 또한 삽입하기 전에 바코드 매개변수 및 모양을 수정하거나 생성된 이미지를 여러 문서 페이지에 한 번에 추가하는 기능을 제공합니다. Aspose.BarCode API는 바코드 이미지의 고품질 인쇄에 사용할 수 있습니다. 래스터 이미지의 표준 해상도는 96dpi로 이 용도로는 충분하지 않습니다. API를 사용하면 바코드 이미지 해상도를 300dpi 또는 600dpi로 설정하여 고품질 PDF 문서를 인쇄할 수 있습니다.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
                ...
                <p>
                    Java 바코드 라이브러리는 Java 애플리케이션에서 바코드 작업을 위한 강력한 도구입니다. 주요 기능 중 하나는 다양한 이미지 파일 형식에서 바코드를 읽을 수 있는 기능입니다. 바코드 인식을 담당하는 기본 클래스인 BarCodeReader 클래스는 BMP, PNG, TIFF, JPEG 및 GIF를 포함하여 널리 사용되는 많은 이미지 형식을 지원합니다. 이를 통해 바코드 인식 기능을 다양한 애플리케이션에 쉽게 통합할 수 있습니다.
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    이미지 파일에서 바코드를 읽는 것 외에도 바코드 라이브러리를 사용하여 PDF 파일에서 바코드를 스캔할 수 있습니다. 개발자는 여러 페이지의 PDF 문서에서 빠른 바코드 감지를 구현할 수 있습니다. API는 여러 가지 방법을 제공합니다. 권장되는 방법은 문서 페이지를 래스터 이미지로 변환한 다음 바코드 판독 메커니즘을 적용하는 것입니다. 페이지 콘텐츠를 래스터 이미지로 렌더링하는 것이 가장 쉽고 효율적인 방법으로 제안됩니다. 그렇지 않으면 원본 PDF 문서에서 바코드 이미지를 먼저 감지하고 추출할 수 있습니다. 이 방법을 사용하면 원래 해상도로 바코드를 쉽게 읽을 수 있습니다. Aspose.BarCode API를 사용하면 여러 페이지의 PDF 파일을 처리하여 문서에 표시된 모든 바코드를 감지하고 인식할 수 있습니다.
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/pdf417/" name="PDF417" description="PDF417 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/qr/" name="QR" description="QR 코드, GS1 QR 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/datamatrix/" name="Data Matrix" description="Data Matrix 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/aztec/" name="Aztec" description="Aztec 코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/swiss-qr/" name="Swiss QR" description="Swiss QR 청구서" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/dotcode/" name="DotCode" description="DotCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/hibc/" name="HIBC" description="HIBC (의료 산업 바코드)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/codablock/" name="Codablock-F" description="Codablock-F 및 GS1 Codablock-F 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/databar/" name="GS1 DataBar" description="GS1 DataBar(Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, Truncated) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/itf/" name="ITF" description="인터리브 2-of-5(ITF) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/ean/" name="EAN" description="EAN (국제 문서 번호) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/upc/" name="UPC" description="UPC(범용 제품 코드) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/code128/" name="GS1 Code 128" description="GS1 Code 128 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/code39/" name="Code 39" description="Code 39 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/code16k/" name="Code 16K" description="Code 16K 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/code32/" name="Code 32" description="이탈리아어 Pharmacode(Code 32) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/code93/" name="Code 93" description="Code 93 확장 및 Code 93 표준 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/onecode/" name="USPS OneCode" description="USPS OneCode 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 of 5) 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/isbn/" name="ISBN" description="ISBN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/ismn/" name="ISMN" description="ISMN 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/issn/" name="ISSN" description="ISSN 바코드" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/australia-post/" name="Australia Post" description="Australia Post 바코드 및 Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode 및 Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/rm4scc/" name="RM4SCC" description="Royal Mail 4주 고객 코드(RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/postnet/" name="Postnet" description="Postnet 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/royal-mail/" name="Royal Mail" description="Royal Mail 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/singapore-post/" name="Singapore Post" description="Singapore Post 바코드" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ko/java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="선적 서류 비치" href="https://docs.aspose.com/barcode/java/" >}}
...
{{< blocks/products/pf/slr-element name="릴리즈 노트" href="https://docs.aspose.com/barcode/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="왜 Java용 Aspose.BarCode인가요?" tabId="success-stories" >}}
