---
title: Quét hình ảnh Mã QR, Mã GS1 QR qua Node.js via Java
weight: 1510
description: Mã nguồn Node.js để quét và giải mã Mã QR, Mã GS1 QR trong các ứng dụng JavaScript.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/nodejs-java/qr/recognize/
aliases:
- /vi/nodejs-java/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Đọc mã vạch QR bằng Node.js via Java" h2="Đọc Mã QR, Mã GS1 QR trong JavaScript bằng API Aspose.BarCode phía máy chủ cho Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Mã QR Using Node.js via Java" %}}
Để nhận ra Mã QR trong các ứng dụng Node.js, hãy sử dụng Aspose.BarCode cho Node.js thông qua Java, một thư viện mã vạch mạnh mẽ, linh hoạt và thân thiện với người dùng được giới thiệu cho các môi trường dựa trên Java. Bạn có thể tải [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) cho Javascript trực tiếp từ NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để quét Mã QR trong JavaScript" %}}
...
<ul><li>Tạo đối tượng của lớp Aspose.BarCode.BarCodeReader</li><li>Chuyển đường dẫn tệp nguồn chứa Mã QR làm tham số</li><li>Đặt loại mã vạch đích trong DecodeType làm tham số thứ hai</li><li>Lặp qua tất cả các mã vạch được phát hiện</li><li>Tìm nạp văn bản mã vạch kết quả bằng thuộc tính CodeText</li></ul>
