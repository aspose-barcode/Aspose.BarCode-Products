---
title: Tạo hình ảnh mã vạch ISBN qua Node.js via Java
description: Mã mẫu Node.js để tạo mã vạch ISBN trong các ứng dụng JavaScript.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/nodejs-java/isbn/generate/
aliases:
- /vi/nodejs-java/generate/isbn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn ISBN với Node.js via Java" h2="Tạo mã vạch ISBN trong JavaScript bằng API Aspose.BarCode phía máy chủ cho Node.js via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISBN" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate mã vạch ISBN Using Node.js via Java" %}}
Để tạo mã vạch mã vạch ISBN trong các ứng dụng Node.js, hãy mua Aspose.BarCode cho Node.js qua Java, một API mã vạch tiên tiến, hiệu quả và thân thiện với người dùng được thiết kế cho các nền tảng hướng Java. Bạn có thể dễ dàng cài đặt [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) cho Javascript từ NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo mã vạch ISBN trong JavaScript" %}}
...
<ul><li>Tạo một phiên bản của lớp BarCodeGenerator</li><li>Đặt mã vạch ISBN làm tham số EncodeTypes</li><li>Xác định văn bản cần mã hóa làm tham số thứ hai</li><li>Xác định kích thước và vị trí mã vạch nếu cần</li><li>Gọi phương thức BarCodeGenerator.save để lấy hình ảnh mã vạch đã tạo</li></ul>
