---
title: Quét hình ảnh Mã vạch GS1 DataBar (Đa hướng, Đa hướng xếp chồng, Mở rộng, Xếp chồng mở rộng và Cắt bớt) qua .NET
weight: 1510
description: Mã mẫu C# để quét và giải mã loại mã vạch Mã vạch GS1 DataBar (Đa hướng, Đa hướng xếp chồng, Mở rộng, Xếp chồng mở rộng và Cắt bớt) trong .NET Framework, .NET Standard, COM Interloop cho PHP, VBScript, Delphi hoặc C++.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/net/databar/recognize/
aliases:
- /vi/net/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Đọc mã vạch GS1 DataBar bằng .NET" h2="Đọc Mã vạch GS1 DataBar (Đa hướng, Đa hướng xếp chồng, Mở rộng, Xếp chồng mở rộng và Cắt bớt) trong C# bằng API Aspose.BarCode phía máy chủ cho .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để quét Mã vạch GS1 DataBar trong C#" %}}
...
<ul><li>Tạo phiên bản mới của lớp Aspose.BarCode.BarCodeReader</li><li>Chuyển đường dẫn hình ảnh nguồn có chứa Mã vạch GS1 DataBar làm tham số</li><li>Chuyển DecodeType thích hợp làm tham số tham số thứ hai</li><li>Lặp lại các kết quả giải mã</li><li>Nhận văn bản mã vạch bằng thuộc tính CodeText</li></ul>
