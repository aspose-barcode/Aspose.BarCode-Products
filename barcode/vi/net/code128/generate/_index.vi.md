---
title: Tạo hình ảnh mã vạch GS1 Code 128 qua .NET
description: Mã nguồn C# để tạo mã vạch GS1 Code 128 trong .NET Framework, .NET Standard, COM Interloop cho PHP, VBScript, Delphi và C++.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/net/code128/generate/
aliases:
- /vi/net/generate/code128/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn GS1 Code 128 với .NET" h2="Tạo mã vạch GS1 Code 128 trong C# bằng API Aspose.BarCode phía máy chủ cho .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo mã vạch GS1 Code 128 trong C#" %}}
...
<ul><li>Tạo một phiên bản của lớp BarcodeGenerator</li><li>Chuyển mã vạch GS1 Code 128 làm tham số</li><li>Đặt văn bản cần mã hóa làm tham số thứ hai</li><li> Chỉ định kích thước mã vạch nếu được yêu cầu</li><li>Gọi phương thức BarcodeGenerator.Save để lấy hình ảnh mã vạch GS1 Code 128</li></ul>
