---
title: Tạo hình ảnh Mã vạch Postnet qua .NET
description: Mã nguồn C# để tạo Mã vạch Postnet trong .NET Framework, .NET Standard, COM Interloop cho PHP, VBScript, Delphi và C++.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/net/postnet/generate/
aliases:
- /vi/net/generate/postnet/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn Postnet với .NET" h2="Tạo Mã vạch Postnet trong C# bằng API Aspose.BarCode phía máy chủ cho .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Postnet" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo Mã vạch Postnet trong C#" %}}
...
<ul><li>Tạo một phiên bản của lớp BarcodeGenerator</li><li>Chuyển Mã vạch Postnet làm tham số</li><li>Đặt văn bản cần mã hóa làm tham số thứ hai</li><li> Chỉ định kích thước mã vạch nếu được yêu cầu</li><li>Gọi phương thức BarcodeGenerator.Save để lấy hình ảnh Mã vạch Postnet</li></ul>
