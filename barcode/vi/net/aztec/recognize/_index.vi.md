---
title: Quét hình ảnh Mã Aztec qua .NET
weight: 1510
description: Mã mẫu C# để quét và giải mã loại mã vạch Mã Aztec trong .NET Framework, .NET Standard, COM Interloop cho PHP, VBScript, Delphi hoặc C++.
lang: vi
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /vi/net/aztec/recognize/
aliases:
- /vi/net/recognize/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Đọc mã vạch Aztec bằng .NET" h2="Đọc Mã Aztec trong C# bằng API Aspose.BarCode phía máy chủ cho .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để quét Mã Aztec trong C#" %}}
...
<ul><li>Tạo phiên bản mới của lớp Aspose.BarCode.BarCodeReader</li><li>Chuyển đường dẫn hình ảnh nguồn có chứa Mã Aztec làm tham số</li><li>Chuyển DecodeType thích hợp làm tham số tham số thứ hai</li><li>Lặp lại các kết quả giải mã</li><li>Nhận văn bản mã vạch bằng thuộc tính CodeText</li></ul>
