...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo mã vạch Code 93 trong C#" %}}
...
<ul><li>Tạo một phiên bản của lớp BarcodeGenerator</li><li>Chuyển Code 93 Mã vạch tiêu chuẩn và Code 93 làm tham số</li><li>Đặt văn bản cần mã hóa làm tham số thứ hai</li><li> Chỉ định kích thước mã vạch nếu được yêu cầu</li><li>Gọi phương thức BarcodeGenerator.Save để lấy hình ảnh Code 93 Mã vạch tiêu chuẩn và Code 93</li></ul>
