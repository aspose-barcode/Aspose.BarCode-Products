---
title: Tạo hình ảnh Mã vạch UPC (Mã sản phẩm chung) qua .NET
description: Mã nguồn C# để tạo Mã vạch UPC (Mã sản phẩm chung) trong .NET Framework, .NET Standard, COM Interloop cho PHP, VBScript, Delphi và C++.
lang: vi
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /vi/net/upc/generate/
aliases:
- /vi/net/generate/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn UPC với .NET" h2="Tạo Mã vạch UPC (Mã sản phẩm chung) trong C# bằng API Aspose.BarCode phía máy chủ cho .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo Mã vạch UPC (Mã sản phẩm chung) trong C#" %}}
...
<ul><li>Tạo một phiên bản của lớp BarcodeGenerator</li><li>Chuyển Mã vạch UPC (Mã sản phẩm chung) làm tham số</li><li>Đặt văn bản cần mã hóa làm tham số thứ hai</li><li> Chỉ định kích thước mã vạch nếu được yêu cầu</li><li>Gọi phương thức BarcodeGenerator.Save để lấy hình ảnh Mã vạch UPC (Mã sản phẩm chung)</li></ul>
