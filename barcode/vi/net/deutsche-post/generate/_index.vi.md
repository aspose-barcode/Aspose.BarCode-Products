---
title: Tạo hình ảnh Deutsche Post Mã định danh và Deutsche Post Leitcode qua .NET
description: Mã nguồn C# để tạo Deutsche Post Mã định danh và Deutsche Post Leitcode trong .NET Framework, .NET Standard, COM Interloop cho PHP, VBScript, Delphi và C++.
lang: vi
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /vi/net/deutsche-post/generate/
aliases:
- /vi/net/generate/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn Deutsche Post với .NET" h2="Tạo Deutsche Post Mã định danh và Deutsche Post Leitcode trong C# bằng API Aspose.BarCode phía máy chủ cho .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo Mã vạch Deutsche Post trong C#" %}}
...
<ul><li>Tạo một phiên bản của lớp BarcodeGenerator</li><li>Chuyển Deutsche Post Mã định danh và Deutsche Post Leitcode làm tham số</li><li>Đặt văn bản cần mã hóa làm tham số thứ hai</li><li> Chỉ định kích thước mã vạch nếu được yêu cầu</li><li>Gọi phương thức BarcodeGenerator.Save để lấy hình ảnh Deutsche Post Mã định danh và Deutsche Post Leitcode</li></ul>
