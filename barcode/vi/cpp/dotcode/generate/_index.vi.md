---
title: Tạo hình ảnh Mã vạch DotCode qua C++
description: Ví dụ về mã C++ để tạo Mã vạch DotCode trong Môi trường thời gian chạy C++ dành cho Windows 32-bit, Windows 64-bit và Linux 64-bit.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/cpp/dotcode/generate/
aliases:
- /vi/cpp/generate/dotcode/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn DotCode với C++" h2="Tạo Mã vạch DotCode trong C++ bằng API Aspose.BarCode phía máy chủ cho C++ API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DotCode" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Mã vạch DotCode Using C++" %}}
Để tạo Mã vạch DotCode, hãy cài đặt API [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/), một thư viện mã vạch mạnh mẽ và dễ sử dụng với nhiều chức năng dành cho nền tảng C++ . Tải xuống phiên bản mới nhất trực tiếp từ trình quản lý gói [NuGet](https://www.nuget.org/packages/aspose.barcode)&colon; tìm kiếm **Aspose.BarCode.Cpp** rồi cài đặt gói. Ngoài ra, hãy mở bảng điều khiển Trình quản lý gói và chạy lệnh sau:
...
<ul><li>Tạo một đối tượng của lớp BarcodeGenerator</li><li>Chuyển Mã vạch DotCode làm tham số</li><li>Chèn văn bản đầu vào để mã hóa làm tham số thứ hai</li><li>Xác định kích thước hình ảnh nếu được yêu cầu</li><li>Gọi phương thức BarcodeGenerator.Save để tải xuống mã vạch Mã vạch DotCode</li></ul>
