---
title: Tạo hình ảnh Swiss Post Parcel qua C++
description: Ví dụ về mã C++ để tạo Swiss Post Parcel trong Môi trường thời gian chạy C++ dành cho Windows 32-bit, Windows 64-bit và Linux 64-bit.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/cpp/swiss-post-parcel/generate/
aliases:
- /vi/cpp/generate/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn Swiss Post Parcel với C++" h2="Tạo Swiss Post Parcel trong C++ bằng API Aspose.BarCode phía máy chủ cho C++ API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Tạo một đối tượng của lớp BarcodeGenerator</li><li>Chuyển Swiss Post Parcel làm tham số</li><li>Chèn văn bản đầu vào để mã hóa làm tham số thứ hai</li><li>Xác định kích thước hình ảnh nếu được yêu cầu</li><li>Gọi phương thức BarcodeGenerator.Save để tải xuống mã vạch Swiss Post Parcel</li></ul>
