---
title: Tạo hình ảnh Mã vạch EAN (Số bài viết quốc tế) qua C++
description: Ví dụ về mã C++ để tạo Mã vạch EAN (Số bài viết quốc tế) trong Môi trường thời gian chạy C++ dành cho Windows 32-bit, Windows 64-bit và Linux 64-bit.
lang: vi
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /vi/cpp/ean/generate/
aliases:
- /vi/cpp/generate/ean/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn EAN với C++" h2="Tạo Mã vạch EAN (Số bài viết quốc tế) trong C++ bằng API Aspose.BarCode phía máy chủ cho C++ API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Mã vạch EAN (Số bài viết quốc tế) Using C++" %}}
...
<ul><li>Tạo một đối tượng của lớp BarcodeGenerator</li><li>Chuyển Mã vạch EAN (Số bài viết quốc tế) làm tham số</li><li>Chèn văn bản đầu vào để mã hóa làm tham số thứ hai</li><li>Xác định kích thước hình ảnh nếu được yêu cầu</li><li>Gọi phương thức BarcodeGenerator.Save để tải xuống mã vạch Mã vạch EAN (Số bài viết quốc tế)</li></ul>
