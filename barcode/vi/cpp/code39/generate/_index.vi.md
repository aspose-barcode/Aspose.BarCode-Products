...
{{% blocks/products/pf/agp/content h2="How to Generate Mã vạch Code 39 Using C++" %}}
Để tạo Mã vạch Code 39, hãy cài đặt API [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/), một thư viện mã vạch mạnh mẽ và dễ sử dụng với nhiều chức năng dành cho nền tảng C++ . Tải xuống phiên bản mới nhất trực tiếp từ trình quản lý gói [NuGet](https://www.nuget.org/packages/aspose.barcode)&colon; tìm kiếm **Aspose.BarCode.Cpp** rồi cài đặt gói. Ngoài ra, hãy mở bảng điều khiển Trình quản lý gói và chạy lệnh sau:
...
<ul><li>Tạo một đối tượng của lớp BarcodeGenerator</li><li>Chuyển Mã vạch Code 39 làm tham số</li><li>Chèn văn bản đầu vào để mã hóa làm tham số thứ hai</li><li>Xác định kích thước hình ảnh nếu được yêu cầu</li><li>Gọi phương thức BarcodeGenerator.Save để tải xuống mã vạch Mã vạch Code 39</li></ul>
