---
title: Tạo hình ảnh Mã vạch Standard 2 of 5 (Công nghiệp 2 trên 5) qua C++
description: Ví dụ về mã C++ để tạo Mã vạch Standard 2 of 5 (Công nghiệp 2 trên 5) trong Môi trường thời gian chạy C++ dành cho Windows 32-bit, Windows 64-bit và Linux 64-bit.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/cpp/standard2of5/generate/
aliases:
- /vi/cpp/generate/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn Standard 2 of 5 với C++" h2="Tạo Mã vạch Standard 2 of 5 (Công nghiệp 2 trên 5) trong C++ bằng API Aspose.BarCode phía máy chủ cho C++ API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate mã vạch Standard 2 of 5 Using C++" %}}
Để tạo mã vạch Standard 2 of 5, hãy cài đặt API [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/), một thư viện mã vạch mạnh mẽ và dễ sử dụng với nhiều chức năng dành cho nền tảng C++ . Tải xuống phiên bản mới nhất trực tiếp từ trình quản lý gói [NuGet](https://www.nuget.org/packages/aspose.barcode)&colon; tìm kiếm **Aspose.BarCode.Cpp** rồi cài đặt gói. Ngoài ra, hãy mở bảng điều khiển Trình quản lý gói và chạy lệnh sau:
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo mã vạch Standard 2 of 5 trong C++" %}}
...
<ul><li>Tạo một đối tượng của lớp BarcodeGenerator</li><li>Chuyển Mã vạch Standard 2 of 5 (Công nghiệp 2 trên 5) làm tham số</li><li>Chèn văn bản đầu vào để mã hóa làm tham số thứ hai</li><li>Xác định kích thước hình ảnh nếu được yêu cầu</li><li>Gọi phương thức BarcodeGenerator.Save để tải xuống mã vạch Mã vạch Standard 2 of 5 (Công nghiệp 2 trên 5)</li></ul>
