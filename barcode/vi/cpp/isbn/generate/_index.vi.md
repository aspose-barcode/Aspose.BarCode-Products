...
{{% blocks/products/pf/agp/content h2="How to Generate mã vạch ISBN Using C++" %}}
...
<ul><li>Tạo một đối tượng của lớp BarcodeGenerator</li><li>Chuyển mã vạch ISBN làm tham số</li><li>Chèn văn bản đầu vào để mã hóa làm tham số thứ hai</li><li>Xác định kích thước hình ảnh nếu được yêu cầu</li><li>Gọi phương thức BarcodeGenerator.Save để tải xuống mã vạch mã vạch ISBN</li></ul>
