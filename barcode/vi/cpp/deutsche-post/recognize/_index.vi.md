---
title: Quét hình ảnh Deutsche Post Mã định danh và Deutsche Post Leitcode qua C++
weight: 1510
description: Mã mẫu C++ để quét và giải mã Deutsche Post Mã định danh và Deutsche Post Leitcode trong Môi trường thời gian chạy C++ dành cho Windows 32-bit, Windows 64-bit hoặc Linux 64-bit.
lang: vi
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /vi/cpp/deutsche-post/recognize/
aliases:
- /vi/cpp/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Đọc mã vạch Deutsche Post bằng C++" h2="Đọc Deutsche Post Mã định danh và Deutsche Post Leitcode trong C++ bằng API Aspose.BarCode phía máy chủ cho C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Mã vạch Deutsche Post Using C++" %}}
Để quét Mã vạch Deutsche Post, hãy thử API [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/), một thư viện mã vạch mạnh và dễ sử dụng với nhiều chức năng dành cho nền tảng C++ . Bạn có thể trực tiếp tải xuống phiên bản mới nhất của nó&colon; chỉ cần mở trình quản lý gói [NuGet](https://www.nuget.org/packages/aspose.barcode), tìm kiếm **Aspose.BarCode.Cpp** và cài đặt gói. Ngoài ra, bạn có thể chạy lệnh sau từ Bảng điều khiển quản lý gói.
...
<ul><li>Tạo đối tượng của lớp Aspose.BarCode.BarCodeReader</li><li>Chỉ định đường dẫn hình ảnh nguồn chứa Mã vạch Deutsche Post làm tham số</li><li>Chuyển các loại mã vạch bắt buộc vào DecodeType làm tham số thứ hai</li><li>Lặp lại các kết quả nhận dạng</li><li>Tải văn bản mã vạch đã giải mã bằng thuộc tính CodeText</li></ul>
...
<ul><li>Microsoft Windows, Linux hoặc bất kỳ HĐH nào tương thích với Môi trường thời gian chạy C++ dành cho Windows 32-bit, Windows 64-bit và Linux 64-bit.</li><li>Aspose.BarCode for C++ DLL được tham chiếu trong dự án của bạn.</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/pdf417/recognize/" name="PDF417" description="Mã vạch PDF417" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/qr/recognize/" name="QR" description="Mã QR, Mã GS1 QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/datamatrix/recognize/" name="Data Matrix" description="mã Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/aztec/recognize/" name="Aztec" description="Mã Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/swiss-qr/recognize/" name="Swiss QR" description="Hóa đơn Swiss QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/dotcode/recognize/" name="DotCode" description="Mã vạch DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/hibc/recognize/" name="HIBC" description="HIBC (Mã vạch ngành y tế)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/codablock/recognize/" name="Codablock-F" description="Mã vạch Codablock-F và GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/databar/recognize/" name="GS1 DataBar" description="Mã vạch GS1 DataBar (Đa hướng, Đa hướng xếp chồng, Mở rộng, Xếp chồng mở rộng và Cắt bớt)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/itf/recognize/" name="ITF" description="Mã vạch 2/5 (ITF) xen kẽ" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/ean/recognize/" name="EAN" description="Mã vạch EAN (Số bài viết quốc tế)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/upc/recognize/" name="UPC" description="Mã vạch UPC (Mã sản phẩm chung)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/code128/recognize/" name="GS1 Code 128" description="mã vạch GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/code39/recognize/" name="Code 39" description="Mã vạch Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/code16k/recognize/" name="Code 16K" description="Mã vạch Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/code32/recognize/" name="Code 32" description="Mã vạch Dược phẩm Ý (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/code93/recognize/" name="Code 93" description="Code 93 Mã vạch tiêu chuẩn và Code 93" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/onecode/recognize/" name="USPS OneCode" description="Mã vạch USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/standard2of5/recognize/" name="Standard 2 of 5" description="Mã vạch Standard 2 of 5 (Công nghiệp 2 trên 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/isbn/recognize/" name="ISBN" description="mã vạch ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/ismn/recognize/" name="ISMN" description="mã vạch ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/issn/recognize/" name="ISSN" description="mã vạch ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/australia-post/recognize/" name="Australia Post" description="Mã vạch Australia Post và Bưu kiện điện tử Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Mã định danh và Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/rm4scc/recognize/" name="RM4SCC" description="Mã khách hàng 4 bang của Royal Mail (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/postnet/recognize/" name="Postnet" description="Mã vạch Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/royal-mail/recognize/" name="Royal Mail" description="Mã vạch Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/singapore-post/recognize/" name="Singapore Post" description="mã vạch Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/cpp/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
