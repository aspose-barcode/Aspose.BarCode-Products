---
title: Quét hình ảnh Mã vạch Codablock-F và GS1 Codablock-F qua C++
weight: 1510
description: Mã mẫu C++ để quét và giải mã Mã vạch Codablock-F và GS1 Codablock-F trong Môi trường thời gian chạy C++ dành cho Windows 32-bit, Windows 64-bit hoặc Linux 64-bit.
lang: vi
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /vi/cpp/codablock/recognize/
aliases:
- /vi/cpp/recognize/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Đọc mã vạch Codablock-F bằng C++" h2="Đọc Mã vạch Codablock-F và GS1 Codablock-F trong C++ bằng API Aspose.BarCode phía máy chủ cho C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Mã vạch Codablock-F Using C++" %}}
Để quét Mã vạch Codablock-F, hãy thử API [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/), một thư viện mã vạch mạnh và dễ sử dụng với nhiều chức năng dành cho nền tảng C++ . Bạn có thể trực tiếp tải xuống phiên bản mới nhất của nó&colon; chỉ cần mở trình quản lý gói [NuGet](https://www.nuget.org/packages/aspose.barcode), tìm kiếm **Aspose.BarCode.Cpp** và cài đặt gói. Ngoài ra, bạn có thể chạy lệnh sau từ Bảng điều khiển quản lý gói.
...
<ul><li>Tạo đối tượng của lớp Aspose.BarCode.BarCodeReader</li><li>Chỉ định đường dẫn hình ảnh nguồn chứa Mã vạch Codablock-F làm tham số</li><li>Chuyển các loại mã vạch bắt buộc vào DecodeType làm tham số thứ hai</li><li>Lặp lại các kết quả nhận dạng</li><li>Tải văn bản mã vạch đã giải mã bằng thuộc tính CodeText</li></ul>
