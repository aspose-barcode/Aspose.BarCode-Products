---
title: Quét hình ảnh Mã vạch Code 39 qua Android via Java
weight: 1510
description: Mã mẫu Android để nhận dạng Mã vạch Code 39 trong Môi trường thời gian chạy Android.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/android-java/code39/recognize/
aliases:
- /vi/android-java/recognize/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Đọc mã vạch Code 39 bằng Android via Java" h2="Đọc Mã vạch Code 39 trong Java bằng API Aspose.BarCode phía máy chủ cho Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Mã vạch Code 39 Using Android via Java" %}}
Hãy dùng thử Aspose.BarCode dành cho Android qua Java để phát hiện và đọc Mã vạch Code 39 trong các ứng dụng Android một cách dễ dàng. Nó là một API mã vạch phong phú, có thể mở rộng và thân thiện với người dùng dành cho các ứng dụng Android. Nhận Aspose.BarCode cho Java trực tiếp từ một dự án dựa trên Maven bằng cách thêm các cấu hình sau vào build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để quét Mã vạch Code 39 trong Java" %}}
...
<ul><li>Tạo một phiên bản của lớp BarCodeReader</li><li>Xác định đường dẫn hình ảnh nguồn chứa Mã vạch Code 39</li><li>Xác định các loại mã vạch đích trong DecodeType làm tham số thứ hai</li><li>Lặp lại kết quả nhận dạng</li><li>Tải văn bản đã giải mã chạy phương thức getCodeText</li></ul>
