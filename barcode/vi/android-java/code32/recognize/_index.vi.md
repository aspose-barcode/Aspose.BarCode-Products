...
{{% blocks/products/pf/agp/content h2="How to Read Mã vạch Code 32 Using Android via Java" %}}
Hãy dùng thử Aspose.BarCode dành cho Android qua Java để phát hiện và đọc Mã vạch Code 32 trong các ứng dụng Android một cách dễ dàng. Nó là một API mã vạch phong phú, có thể mở rộng và thân thiện với người dùng dành cho các ứng dụng Android. Nhận Aspose.BarCode cho Java trực tiếp từ một dự án dựa trên Maven bằng cách thêm các cấu hình sau vào build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để quét Mã vạch Code 32 trong Java" %}}
...
<ul><li>Tạo một phiên bản của lớp BarCodeReader</li><li>Xác định đường dẫn hình ảnh nguồn chứa Mã vạch Code 32</li><li>Xác định các loại mã vạch đích trong DecodeType làm tham số thứ hai</li><li>Lặp lại kết quả nhận dạng</li><li>Tải văn bản đã giải mã chạy phương thức getCodeText</li></ul>
