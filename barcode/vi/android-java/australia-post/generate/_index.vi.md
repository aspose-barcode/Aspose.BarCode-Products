---
title: Tạo hình ảnh Mã vạch Australia Post và Bưu kiện điện tử Australia Post qua Android via Java
description: Mã nguồn Android để tạo Mã vạch Australia Post và Bưu kiện điện tử Australia Post trong Môi trường thời gian chạy Android.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/android-java/australia-post/generate/
aliases:
- /vi/android-java/generate/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn Australia Post với Android via Java" h2="Tạo Mã vạch Australia Post và Bưu kiện điện tử Australia Post trong Java bằng API Aspose.BarCode phía máy chủ cho Android via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Mã vạch Australia Post Using Android via Java" %}}
Hãy dùng thử Aspose.BarCode dành cho Android qua Java để tạo Mã vạch Australia Post trong các ứng dụng Android một cách dễ dàng. Nó là một thư viện mã vạch linh hoạt, mạnh mẽ và thân thiện với người dùng được thiết kế dành riêng cho các ứng dụng Android. Bạn có thể dễ dàng Aspose.BarCode cho Android thông qua Java trực tiếp từ một dự án dựa trên Maven bằng cách chèn các cấu hình sau vào build.gradle:
...
<ul><li>Tạo phiên bản mới của lớp BarCodeGenerator</li><li>Chuyển loại mã vạch Mã vạch Australia Post làm tham số EncodeTypes</li><li>Xác định văn bản mã vạch bằng phương thức setCodeText</li><li>Khởi chạy phương thức generateBarCodeImage() để lưu hình ảnh mã vạch Mã vạch Australia Post và Bưu kiện điện tử Australia Post</li></ul>
