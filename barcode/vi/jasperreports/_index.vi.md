---
title: Tạo mã vạch trong JasperReports và hiển thị trong BMP JPG GIF & PNG 
weight: 1900
url: /vi/jasperreports/ 
description: Sử dụng Aspose.BarCode cho JasperReports - các nhà phát triển có thể tạo mã vạch trong Báo cáo Jasper có thể được hiển thị thêm ở các định dạng BMP JPG GIF và PNG
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tạo và xuất mã vạch trong JasperReports" h2="JasperReports & JasperServer API để tạo, hiển thị và xuất mã vạch tuyến tính, 2D và mã vạch Bưu điện sang nhiều định dạng." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/barcode/jasperreports" >}}
...
{{< blocks/products/pf/carousel-item h3="Sơ lược" description="Tổng quan về Aspose.BarCode cho API JasperReports." >}}
<div class="diagram1 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Trình tạo mã vạch báo cáo Jasper" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Platform Independence" description="Aspose.BarCode cho JasperReports có thể được sử dụng với JasperServer và JasperReports." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
  ...
  <div class="d1-col d1-right">
   <header style="padding-left: 0px;">
    ...
    JasperReports 2.0 hoặc cao hơn
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Tạo mã vạch trong báo cáo Jasper" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="Phần mở rộng mã vạch JasperReports hỗ trợ phổ biến [định dạng hình ảnh](https://docs.aspose.com/barcode/jasperreports/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Tạo mã vạch in Jasper Report" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/slr-tab tabTitle="Tại sao sử dụng Aspose.BarCode cho JasperReports?" tabId="success-stories" >}}
