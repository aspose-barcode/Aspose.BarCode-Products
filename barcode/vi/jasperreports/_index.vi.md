---
title: Tạo mã vạch trong JasperReports và kết xuất trong BMP JPG GIF & PNG
description: Sử dụng Aspose.BarCode cho JasperReports, nhà phát triển có thể tạo mã vạch trong Báo cáo Jasper để được hiển thị thêm ở định dạng BMP JPG GIF và PNG.
lang: vi/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Tạo và xuất mã vạch trong JasperReports" h2="JasperReports & JasperServer API để Tạo, Hiển thị và Xuất mã vạch 1D, 2D và Bưu điện." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="cho JasperReports" downloadUrl="https://releases.aspose.com/barcode/jasperreports/" >}}
...
<p>Aspose.BarCode for JasperReports là một tiện ích mở rộng JasperReports và JasperServer linh hoạt để tạo và hiển thị nhãn mã vạch trong các ứng dụng của bạn. Các nhãn mã vạch này có thể được hiển thị ở nhiều định dạng hình ảnh phổ biến.</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="trong nháy mắt" description="Tổng quan về khả năng nhận dạng và tạo mã vạch của API." >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>Tuyến tính, 2D & Bưu chính</li><li>Phát hiện từ Luồng hoặc Hình ảnh</li><li>Nhận hướng của mã vạch</li><li>Giải mã các ký tự không phải tiếng Anh</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                in ấn
            </header>
            <ul><li>In mã vạch trực tiếp</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>Tuyến tính, 2D & Bưu chính</li><li>Lưu vào luồng hoặc hình ảnh</li><li>Tùy chỉnh giao diện&colon; Kích thước, màu sắc, góc</li><li>Mã hóa các ký tự không phải tiếng Anh </li></ul>
            <header>
                <i class="fa fa-qrcode">
                </i>
                các loại
            </header>
            <ul><li>Tuyến tính</li><li>2D</li><li>Bưu chính</li></ul>
        </div>
        <!--/right-->
    </div>
    <!--/row-->
...
{{< blocks/products/pf/carousel-item h3="Độc lập nền tảng" description="Aspose.BarCode cho JasperReports có thể được sử dụng với JasperServer và JasperReports." >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Định dạng tệp được hỗ trợ" description="Aspose.BarCode cho JasperReports hoạt động với hầu hết các định dạng tệp hình ảnh được sử dụng phổ biến." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Tạo và in báo cáo với mã vạch</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Tăng quy trình làm việc của ứng dụng bằng cách thêm chức năng mã vạch</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Nhúng mã vạch vào tệp để hỗ trợ truy xuất nguồn gốc</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/barcode-image-basic-features/'>Kiểm soát kích thước, màu sắc và văn bản mã của mã</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/read-barcodes-with-aspose-barcode-apis/'>Nhận dạng mã vạch 2D bị biến dạng và xoay 3D</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/generate-barcode-by-specifying-custom-image-size/'>Tạo hình ảnh mã vạch có kích thước cụ thể</a>
                </p>
            </div>
...
<div class="barcode-read-lcs" style="width: 100%;">
    ...
    <div class="barcode-read-lcs-controls">
        ...
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">Các loại</option>
                <option value="Pdf417 ">PDF417</option>
                <option value="QR ">QR</option>
    ...
    <p class="barcode-read-lcs-disclaimer">* Bằng cách tải tệp của bạn lên hoặc sử dụng dịch vụ, bạn đồng ý với <a href='https://about.aspose.com/legal/terms-of-use' rel='nofollow noreferrer' target='_blank'>Điều khoản của chúng tôi sử dụng</a> và <a href='https://about.aspose.com/legal/privacy-policy' rel='nofollow noreferrer' target='_blank'>Chính sách quyền riêng tư</a>.</p>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/pdf417/" name="PDF417" description="Mã vạch PDF417" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/qr/" name="QR" description="Mã QR, Mã GS1 QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/datamatrix/" name="Data Matrix" description="mã Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/aztec/" name="Aztec" description="Mã Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/swiss-qr/" name="Swiss QR" description="Hóa đơn Swiss QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/dotcode/" name="DotCode" description="Mã vạch DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/hibc/" name="HIBC" description="HIBC (Mã vạch ngành y tế)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/codablock/" name="Codablock-F" description="Mã vạch Codablock-F và GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/databar/" name="GS1 DataBar" description="Mã vạch GS1 DataBar (Đa hướng, Đa hướng xếp chồng, Mở rộng, Xếp chồng mở rộng và Cắt bớt)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/itf/" name="ITF" description="Mã vạch 2/5 (ITF) xen kẽ" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/ean/" name="EAN" description="Mã vạch EAN (Số bài viết quốc tế)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/upc/" name="UPC" description="Mã vạch UPC (Mã sản phẩm chung)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/code128/" name="GS1 Code 128" description="mã vạch GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/code39/" name="Code 39" description="Mã vạch Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/code16k/" name="Code 16K" description="Mã vạch Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/code32/" name="Code 32" description="Mã vạch Dược phẩm Ý (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/code93/" name="Code 93" description="Code 93 Mã vạch tiêu chuẩn và Code 93" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/onecode/" name="USPS OneCode" description="Mã vạch USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/standard2of5/" name="Standard 2 of 5" description="Mã vạch Standard 2 of 5 (Công nghiệp 2 trên 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/isbn/" name="ISBN" description="mã vạch ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/ismn/" name="ISMN" description="mã vạch ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/issn/" name="ISSN" description="mã vạch ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/australia-post/" name="Australia Post" description="Mã vạch Australia Post và Bưu kiện điện tử Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/deutsche-post/" name="Deutsche Post" description="Deutsche Post Mã định danh và Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/rm4scc/" name="RM4SCC" description="Mã khách hàng 4 bang của Royal Mail (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/postnet/" name="Postnet" description="Mã vạch Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/royal-mail/" name="Royal Mail" description="Mã vạch Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/singapore-post/" name="Singapore Post" description="mã vạch Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/jasperreports/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="Mọi người đang nói gì" subTitle="Đừng chỉ nhận lời của chúng tôi cho nó. Xem người dùng nói gì về API." caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 Tôi đã dành nhiều năm để phát triển và nâng cao sản phẩm của mình và Aspose đã cho phép tôi làm cho sản phẩm của mình trở nên thân thiện và hữu ích hơn rất nhiều, do đó dễ bán hơn trên thị trường. <em>Kiel Diller | KD Solutions, Ba Lan</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode thực sự được viết bằng mã được quản lý và cung cấp cho chúng tôi nhiều loại mã vạch để xử lý tất cả các loại nhận dạng tài liệu và xử lý thêm. <em>Dennis Alexander Petrasc | Keil IT, Đức</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Tài liệu" href="https://docs.aspose.com/barcode/jasperreports/" >}}
{{< blocks/products/pf/slr-element name="Mã nguồn" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="Tài liệu tham khảo API" href="https://reference.aspose.com/barcode/java/" >}}
...
{{< blocks/products/pf/slr-element name="Ghi chú phát hành" href="https://docs.aspose.com/barcode/jasperreports/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Tại sao lại sử dụng Aspose.BarCode cho JasperReports?" tabId="success-stories" >}}
{{< blocks/products/pf/slr-element name="danh sách khách hàng" href="https://about.aspose.com/customers" >}}
{{< blocks/products/pf/slr-element name="Câu chuyện thành công" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}
