...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo Mã QR trong PHP" %}}
...
<ul><li>Tạo phiên bản mới của lớp BarCodeGenerator</li><li>Chỉ định Mã QR và các loại mã vạch có liên quan khác làm tham số EncodeTypes</li><li>Đặt văn bản mã vạch làm tham số thứ hai</li><li>Chỉ định kích thước và vị trí của hình ảnh nếu cần</li><li>Gọi phương thức BarCodeGenerator.save để lấy hình ảnh Mã QR, Mã GS1 QR ở định dạng bắt buộc</li></ul>
