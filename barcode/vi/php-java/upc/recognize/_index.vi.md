---
title: Quét hình ảnh Mã vạch UPC (Mã sản phẩm chung) qua PHP via Java
weight: 1510
description: Mã mẫu PHP để đọc Mã vạch UPC (Mã sản phẩm chung) trong các ứng dụng dựa trên PHP.
lang: vi
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /vi/php-java/upc/recognize/
aliases:
- /vi/php-java/recognize/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Đọc mã vạch UPC bằng PHP via Java" h2="Đọc Mã vạch UPC (Mã sản phẩm chung) trong PHP bằng API Aspose.BarCode phía máy chủ cho PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để quét Mã vạch UPC (Mã sản phẩm chung) trong PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode cho phép nhà phát triển đọc mã vạch Mã vạch UPC (Mã sản phẩm chung) từ luồng hoặc hình ảnh với một vài dòng mã

{{% /blocks/products/pf/agp/text %}}

<ul><li>Tạo đối tượng của lớp Aspose.BarCode.BarCodeReader</li><li>Đặt đường dẫn hình ảnh nguồn chứa Mã vạch UPC (Mã sản phẩm chung) làm tham số</li><li>Chỉ định loại mã vạch đích trong DecodeType làm tham số thứ hai</li><li>Lặp lại kết quả đọc</li><li>Lấy văn bản mã vạch bằng thuộc tính CodeText</li></ul>
