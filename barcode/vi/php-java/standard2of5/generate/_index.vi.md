---
title: Tạo hình ảnh Mã vạch Standard 2 of 5 (Công nghiệp 2 trên 5) qua PHP via Java
description: Mã nguồn PHP để tạo Mã vạch Standard 2 of 5 (Công nghiệp 2 trên 5) trong các ứng dụng dựa trên PHP.
lang: vi
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /vi/php-java/standard2of5/generate/
aliases:
- /vi/php-java/generate/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn Standard 2 of 5 với PHP via Java" h2="Tạo Mã vạch Standard 2 of 5 (Công nghiệp 2 trên 5) trong PHP bằng API Aspose.BarCode phía máy chủ cho PHP via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo mã vạch Standard 2 of 5 trong PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode giúp các nhà phát triển dễ dàng tạo hình ảnh mã vạch Standard 2 of 5 với một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Tạo phiên bản mới của lớp BarCodeGenerator</li><li>Chỉ định mã vạch Standard 2 of 5 và các loại mã vạch có liên quan khác làm tham số EncodeTypes</li><li>Đặt văn bản mã vạch làm tham số thứ hai</li><li>Chỉ định kích thước và vị trí của hình ảnh nếu cần</li><li>Gọi phương thức BarCodeGenerator.save để lấy hình ảnh Mã vạch Standard 2 of 5 (Công nghiệp 2 trên 5) ở định dạng bắt buộc</li></ul>
