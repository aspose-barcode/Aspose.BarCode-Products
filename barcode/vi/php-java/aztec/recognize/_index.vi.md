---
title: Quét hình ảnh Mã Aztec qua PHP via Java
weight: 1510
description: Mã mẫu PHP để đọc Mã Aztec trong các ứng dụng dựa trên PHP.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/php-java/aztec/recognize/
aliases:
- /vi/php-java/recognize/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Đọc mã vạch Aztec bằng PHP via Java" h2="Đọc Mã Aztec trong PHP bằng API Aspose.BarCode phía máy chủ cho PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để quét Mã Aztec trong PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode cho phép nhà phát triển đọc mã vạch Mã Aztec từ luồng hoặc hình ảnh với một vài dòng mã

{{% /blocks/products/pf/agp/text %}}

<ul><li>Tạo đối tượng của lớp Aspose.BarCode.BarCodeReader</li><li>Đặt đường dẫn hình ảnh nguồn chứa Mã Aztec làm tham số</li><li>Chỉ định loại mã vạch đích trong DecodeType làm tham số thứ hai</li><li>Lặp lại kết quả đọc</li><li>Lấy văn bản mã vạch bằng thuộc tính CodeText</li></ul>
