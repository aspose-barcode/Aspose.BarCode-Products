---
title: Tạo hình ảnh mã vạch Singapore Post qua Python via Java
description: Mã mẫu Python để tạo mã vạch Singapore Post bằng Môi trường thời gian chạy Java.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/python-java/singapore-post/generate/
aliases:
- /vi/python-java/generate/singapore-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn Singapore Post với Python via Java" h2="Tạo mã vạch Singapore Post trong Python bằng API Aspose.BarCode phía máy chủ cho Python via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo mã vạch Singapore Post trong Python" %}}
...
<ul><li>Tạo đối tượng mới của lớp BarCodeGenerator</li><li>Xác định loại mã vạch mong muốn làm tham số EncodeTypes</li><li>Chèn văn bản đầu vào làm tham số thứ hai</li><li> Gọi phương thức BarCodeGenerator.save để lấy hình ảnh mã vạch Singapore Post đã tạo</li></ul>
