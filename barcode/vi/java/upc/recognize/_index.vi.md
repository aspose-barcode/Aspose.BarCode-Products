---
title: Quét hình ảnh Mã vạch UPC (Mã sản phẩm chung) qua Java
weight: 1510
description: Mã nguồn Java để đọc và giải mã Mã vạch UPC (Mã sản phẩm chung) trong Môi trường thời gian chạy Java dành cho Ứng dụng JSP/JSF và Ứng dụng dành cho máy tính để bàn.
lang: vi
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /vi/java/upc/recognize/
aliases:
- /vi/java/recognize/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Đọc mã vạch UPC bằng Java" h2="Đọc Mã vạch UPC (Mã sản phẩm chung) trong Java bằng API Aspose.BarCode phía máy chủ cho Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Tạo đối tượng mới của lớp BarCodeReader</li><li>Đặt đường dẫn tệp nguồn chứa Mã vạch UPC (Mã sản phẩm chung)</li><li>Chuyển các loại mã vạch bắt buộc cho DecodeType làm tham số thứ hai</li><li>Lặp lại kết quả giải mã</li><li>Nhận văn bản mã vạch bằng phương thức getCodeText</li></ul>
