...
<ul><li>Tạo đối tượng mới của lớp BarCodeGenerator</li><li>Xác định Mã QR và các loại mã vạch bắt buộc khác làm tham số EncodeTypes</li><li>Chỉ định văn bản nhập bằng phương thức setCodeText</li><li>Sử dụng phương thức BarCodeGenerator.save để lưu hình ảnh mã vạch đã tạo</li></ul>
