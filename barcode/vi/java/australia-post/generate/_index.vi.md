---
title: Tạo hình ảnh Mã vạch Australia Post và Bưu kiện điện tử Australia Post qua Java
description: Mã mẫu Java để tạo Mã vạch Australia Post và Bưu kiện điện tử Australia Post trong Môi trường thời gian chạy Java dành cho ứng dụng JSP/JSF và ứng dụng dành cho máy tính để bàn.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/java/australia-post/generate/
aliases:
- /vi/java/generate/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn Australia Post với Java" h2="Tạo Mã vạch Australia Post và Bưu kiện điện tử Australia Post trong Java bằng API Aspose.BarCode phía máy chủ cho Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo Mã vạch Australia Post trong Java" %}}
...
<ul><li>Tạo đối tượng mới của lớp BarCodeGenerator</li><li>Xác định Mã vạch Australia Post và các loại mã vạch bắt buộc khác làm tham số EncodeTypes</li><li>Chỉ định văn bản nhập bằng phương thức setCodeText</li><li>Sử dụng phương thức BarCodeGenerator.save để lưu hình ảnh mã vạch đã tạo</li></ul>
