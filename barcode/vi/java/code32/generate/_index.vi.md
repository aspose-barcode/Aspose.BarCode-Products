...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo Mã vạch Code 32 trong Java" %}}
...
<ul><li>Tạo đối tượng mới của lớp BarCodeGenerator</li><li>Xác định Mã vạch Code 32 và các loại mã vạch bắt buộc khác làm tham số EncodeTypes</li><li>Chỉ định văn bản nhập bằng phương thức setCodeText</li><li>Sử dụng phương thức BarCodeGenerator.save để lưu hình ảnh mã vạch đã tạo</li></ul>
