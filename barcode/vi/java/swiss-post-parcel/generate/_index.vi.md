---
title: Tạo hình ảnh Swiss Post Parcel qua Java
description: Mã mẫu Java để tạo Swiss Post Parcel trong Môi trường thời gian chạy Java dành cho ứng dụng JSP/JSF và ứng dụng dành cho máy tính để bàn.
lang: vi
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /vi/java/swiss-post-parcel/generate/
aliases:
- /vi/java/generate/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn Swiss Post Parcel với Java" h2="Tạo Swiss Post Parcel trong Java bằng API Aspose.BarCode phía máy chủ cho Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo Swiss Post Parcel trong Java" %}}
...
<ul><li>Tạo đối tượng mới của lớp BarCodeGenerator</li><li>Xác định Swiss Post Parcel và các loại mã vạch bắt buộc khác làm tham số EncodeTypes</li><li>Chỉ định văn bản nhập bằng phương thức setCodeText</li><li>Sử dụng phương thức BarCodeGenerator.save để lưu hình ảnh mã vạch đã tạo</li></ul>
