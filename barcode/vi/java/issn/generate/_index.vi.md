---
title: Tạo hình ảnh mã vạch ISSN qua Java
description: Mã mẫu Java để tạo mã vạch ISSN trong Môi trường thời gian chạy Java dành cho ứng dụng JSP/JSF và ứng dụng dành cho máy tính để bàn.
lang: vi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /vi/java/issn/generate/
aliases:
- /vi/java/generate/issn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tạo nhãn ISSN với Java" h2="Tạo mã vạch ISSN trong Java bằng API Aspose.BarCode phía máy chủ cho Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISSN" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo mã vạch ISSN trong Java" %}}
...
<ul><li>Tạo đối tượng mới của lớp BarCodeGenerator</li><li>Xác định mã vạch ISSN và các loại mã vạch bắt buộc khác làm tham số EncodeTypes</li><li>Chỉ định văn bản nhập bằng phương thức setCodeText</li><li>Sử dụng phương thức BarCodeGenerator.save để lưu hình ảnh mã vạch đã tạo</li></ul>
