...
{{< blocks/products/pf/upper-banner h1="API nhận dạng và tạo mã vạch Java" h2="Tạo và nhận dạng mã vạch của các loại tuyến tính, 2D và bưu chính trong bất kỳ ứng dụng Java nào." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" pfName="Aspose.BarCode" subTitlepfName="cho Java" downloadUrl="https://releases.aspose.com/barcode/java/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.BarCode" subTitlepfName="cho Java" >}}
...
<p>Aspose.BarCode cho Java là một API mạnh mẽ và đáng tin cậy cung cấp các tính năng tạo và nhận dạng mã vạch cho các ứng dụng Java. Nó hỗ trợ các tiêu chuẩn và thông số kỹ thuật đã được thiết lập nhất và cho phép các nhà phát triển đọc mã vạch 1D và 2D từ các tệp hình ảnh khác nhau ở mọi góc độ. Aspose.BarCode cho Java hiển thị hình ảnh mã vạch ở nhiều định dạng hình ảnh với các tùy chọn hình ảnh rất linh hoạt. Thư viện hỗ trợ mã hóa và giải mã hơn 60 loại mã vạch và cho phép in trực tiếp hình ảnh mã vạch.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Độc lập nền tảng" description="Bạn có thể sử dụng thư viện mã vạch để xây dựng bất kỳ loại ứng dụng Java nào có cài đặt JRE 1.6 trở lên." >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Định dạng tệp được hỗ trợ" description="Aspose.BarCode cho Java hoạt động với hầu hết các định dạng tệp hình ảnh được sử dụng phổ biến." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/control-the-appearance-of-code-text/'>Điều chỉnh và sửa đổi các thuộc tính liên quan đến giao diện của văn bản mã</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-the-barcode-caption/'>Quản lý chú thích và kiểu phông chữ</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/use-checksum-and-supplement-data-for-barcodes/'>Hỗ trợ cho dữ liệu Tổng kiểm tra & Bổ sung</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#image-formats'>Tạo hình ảnh mã vạch thành nhiều định dạng hình ảnh</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/advanced-barcode-recognition-features/'>Đọc các loại 1D và 2D ở mọi góc độ</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/barcode-regions/'>Quét mã vạch bằng cách chỉ định khu vực</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/generate-barcode-by-specifying-custom-image-size/'>Tùy chỉnh kích thước hình ảnh</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-x-dimension-and-y-dimension/'>Hỗ trợ kích thước X và Y cho loại 2D</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#barcode-types'>Hỗ trợ ký hiệu tuyến tính, 2D và bưu chính</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/pdf417/" name="PDF417" description="Mã vạch PDF417" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/qr/" name="QR" description="Mã QR, Mã GS1 QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/datamatrix/" name="Data Matrix" description="mã Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/aztec/" name="Aztec" description="Mã Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/swiss-qr/" name="Swiss QR" description="Hóa đơn Swiss QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/dotcode/" name="DotCode" description="Mã vạch DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/hibc/" name="HIBC" description="HIBC (Mã vạch ngành y tế)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/codablock/" name="Codablock-F" description="Mã vạch Codablock-F và GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/databar/" name="GS1 DataBar" description="Mã vạch GS1 DataBar (Đa hướng, Đa hướng xếp chồng, Mở rộng, Xếp chồng mở rộng và Cắt bớt)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/itf/" name="ITF" description="Mã vạch 2/5 (ITF) xen kẽ" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/ean/" name="EAN" description="Mã vạch EAN (Số bài viết quốc tế)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/upc/" name="UPC" description="Mã vạch UPC (Mã sản phẩm chung)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/code128/" name="GS1 Code 128" description="mã vạch GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/code39/" name="Code 39" description="Mã vạch Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/code16k/" name="Code 16K" description="Mã vạch Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/code32/" name="Code 32" description="Mã vạch Dược phẩm Ý (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/code93/" name="Code 93" description="Code 93 Mã vạch tiêu chuẩn và Code 93" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/onecode/" name="USPS OneCode" description="Mã vạch USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/standard2of5/" name="Standard 2 of 5" description="Mã vạch Standard 2 of 5 (Công nghiệp 2 trên 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/isbn/" name="ISBN" description="mã vạch ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/ismn/" name="ISMN" description="mã vạch ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/issn/" name="ISSN" description="mã vạch ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/australia-post/" name="Australia Post" description="Mã vạch Australia Post và Bưu kiện điện tử Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Mã định danh và Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/rm4scc/" name="RM4SCC" description="Mã khách hàng 4 bang của Royal Mail (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/postnet/" name="Postnet" description="Mã vạch Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/royal-mail/" name="Royal Mail" description="Mã vạch Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/singapore-post/" name="Singapore Post" description="mã vạch Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/vi/java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Ghi chú phát hành" href="https://docs.aspose.com/barcode/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Tại sao lại sử dụng Aspose.BarCode cho Java?" tabId="success-stories" >}}
