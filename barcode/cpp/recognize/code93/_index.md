---
title: Recognize CODE93 BarCode via C++ 
weight: 410
url: /cpp/recognize/code93/ 
description: Try our On-Premise CODE93 Barcode Reader and Decoder APIs on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Code93Standard Code Reader for C++" h2="Build C++ barcode scanning apps that can detect & read Code93Standard codes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code93Standard" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="TIFF" fileiconsmall4="BMP" fileiconsmall5="Code93Standard" >}}
...
{{% blocks/products/pf/agp/content h2="How to Recognize CODE93 Barcode Using C++" %}}

 In order to read Code 93 Extended, Code 93 Standard barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize Code93Standard via C++" %}}
...
1.  Set path to the image containing Code93Standard barcode with full path as a parameter
1.  Set the relevant DecodeType as second parameter
1.  Loop through each result
1.  Get Code93Standard barcode text using GetCodeText
...
{{% blocks/products/pf/agp/code-block title="Recognize Code93Standard - C++‎" offSpacer="" %}}

```cs
// Create an instance of BarCodeReader, set image and DecodeType type to recognize
System::SharedPtr<BarCodeReader> barCodeReader = System::MakeObject<BarCodeReader>(u"sourceImage.png", DecodeType::Code93Standard);
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode Code93Standard via Online App" sectionDescription="[Recognize Code93Standard](https://products.aspose.app/barcode/recognize/code93) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing Code 93 Extended, Code 93 Standard barcodes, it will be scanned instantly." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get all the recognized CODE93 types." >}}
