...
{{% blocks/products/pf/agp/content h2="How to Recognize AZTEC Barcode Using C++" %}}
 ...
 In order to read AZTEC barcode , weвЂ™ll use
...
{{% blocks/products/pf/agp/code-block title="Recognize Aztec - C++вЂЋ" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="DecodeВ AztecВ via Online App" sectionDescription="[Recognize Aztec](https://products.aspose.app/barcode/recognize/aztec) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
