---
title: Recognize DATABAR BarCode via C++ 
weight: 330
url: /cpp/recognize/databar/ 
description: Try our On-Premise DATABAR Barcode Reader and Decoder APIs on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="DatabarExpanded Code Reader for C++" h2="Build C++ barcode scanning apps that can detect & read DatabarExpanded codes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DatabarExpanded" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="TIFF" fileiconsmall4="BMP" fileiconsmall5="DatabarExpanded" >}}
...
{{% blocks/products/pf/agp/content h2="How to Recognize DATABAR Barcode Using C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize DatabarExpanded via C++" %}}
...
1.  Set path to the image containing DatabarExpanded barcode with full path as a parameter
1.  Set the relevant DecodeType as second parameter
1.  Loop through each result
1.  Get DatabarExpanded barcode text using GetCodeText
...
{{% blocks/products/pf/agp/code-block title="Recognize DatabarExpanded - C++‎" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode DatabarExpanded via Online App" sectionDescription="[Recognize DatabarExpanded](https://products.aspose.app/barcode/recognize/databar) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing GS1 Databar Expanded, GS1 Databar Expanded Stacked, GS1 DataBar Expanded, GS1 Databar OmniDirectional, GS1 DataBar Stacked, GS1 Databar Stacked OmniDirectional, GS1 DataBar Truncated barcodes, it will be scanned instantly." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get all the recognized DATABAR types." >}}
