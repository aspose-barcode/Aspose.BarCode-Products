---
title: Recognize IATA2OF5 BarCode via C++ 
weight: 860
url: /cpp/recognize/iata2of5/ 
description: Try our On-Premise IATA2OF5 Barcode Reader and Decoder APIs on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="IATA2of5 Code Reader for C++" h2="Build C++ barcode scanning apps that can detect & read IATA2of5 codes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="IATA2of5" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="TIFF" fileiconsmall4="BMP" fileiconsmall5="IATA2of5" >}}
...
{{% blocks/products/pf/agp/content h2="How to Recognize IATA2OF5 Barcode Using C++" %}}

 In order to read IATA 2 OF 5 barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize IATA2of5 via C++" %}}
...
1.  Set path to the image containing IATA2of5 barcode with full path as a parameter
1.  Set the relevant DecodeType as second parameter
1.  Loop through each result
1.  Get IATA2of5 barcode text using GetCodeText
...
{{% blocks/products/pf/agp/code-block title="Recognize IATA2of5 - C++‎" offSpacer="" %}}

```cs
// Create an instance of BarCodeReader, set image and DecodeType type to recognize
System::SharedPtr<BarCodeReader> barCodeReader = System::MakeObject<BarCodeReader>(u"sourceImage.png", DecodeType::IATA2of5);
...
barCodeReader->Close(); 
// Use the relevant DecodeType as of here IATA 2 of 5 is used
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode IATA2of5 via Online App" sectionDescription="[Recognize IATA2of5](https://products.aspose.app/barcode/recognize/iata2of5) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing IATA 2 OF 5 barcodes, it will be scanned instantly." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get all the recognized IATA2OF5 types." >}}
