---
title: Recognize ITF BarCode via C++ 
weight: 1060
url: /cpp/recognize/itf/ 
description: Try our On-Premise ITF Barcode Reader and Decoder APIs on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="ITF14 Code Reader for C++" h2="Build C++ barcode scanning apps that can detect & read ITF14 codes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF14" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="TIFF" fileiconsmall4="BMP" fileiconsmall5="ITF14" >}}
...
{{% blocks/products/pf/agp/content h2="How to Recognize ITF Barcode Using C++" %}}

 In order to read ITF-6, ITF-14 barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize ITF14 via C++" %}}
...
1.  Set path to the image containing ITF14 barcode with full path as a parameter
1.  Set the relevant DecodeType as second parameter
1.  Loop through each result
1.  Get ITF14 barcode text using GetCodeText
...
{{% blocks/products/pf/agp/code-block title="Recognize ITF14 - C++‎" offSpacer="" %}}

```cs
// Create an instance of BarCodeReader, set image and DecodeType type to recognize
System::SharedPtr<BarCodeReader> barCodeReader = System::MakeObject<BarCodeReader>(u"sourceImage.png", DecodeType::ITF14);
...
barCodeReader->Close(); 
// Use the relevant DecodeType ITF-6, ITF-14
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode ITF14 via Online App" sectionDescription="[Recognize ITF14](https://products.aspose.app/barcode/recognize/itf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing ITF-6, ITF-14 barcodes, it will be scanned instantly." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get all the recognized ITF types." >}}
