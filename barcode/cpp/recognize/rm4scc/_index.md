---
title: Recognize RM4SCC BarCode via C++ 
weight: 1940
...
{{< blocks/products/pf/upper-banner h1="RM4SCC Code Reader for C++" h2="Build C++ barcode scanning apps that can detect & read RM4SCC codes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="TIFF" fileiconsmall4="BMP" fileiconsmall5="RM4SCC" >}}
...
{{% blocks/products/pf/agp/content h2="How to Recognize RM4SCC Barcode Using C++" %}}

 In order to read ROYALMAIL (RM4SCC) barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize RM4SCC via C++" %}}
...
1.  Set path to the image containing RM4SCC barcode with full path as a parameter
1.  Set the relevant DecodeType as second parameter
1.  Loop through each result
1.  Get RM4SCC barcode text using GetCodeText
...
{{% blocks/products/pf/agp/code-block title="Recognize RM4SCC - C++‎" offSpacer="" %}}

```cs
// Create an instance of BarCodeReader, set image and DecodeType type to recognize
System::SharedPtr<BarCodeReader> barCodeReader = System::MakeObject<BarCodeReader>(u"sourceImage.png", DecodeType::RM4SCC);
...
barCodeReader->Close(); 
// Use the relevant DecodeType as of here Royalmail (RM4SCC) is used
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode RM4SCC via Online App" sectionDescription="[Recognize RM4SCC](https://products.aspose.app/barcode/recognize/rm4scc) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing ROYALMAIL (RM4SCC) barcodes, it will be scanned instantly." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get all the recognized RM4SCC types." >}}
