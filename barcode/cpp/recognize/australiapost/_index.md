---
title: Recognize AUSTRALIAPOST BarCode via C++ 
weight: 1220
url: /cpp/recognize/australiapost/ 
description: Try our On-Premise AUSTRALIAPOST Barcode Reader and Decoder APIs on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="AustraliaPost Code Reader for C++" h2="Build C++ barcode scanning apps that can detect & read AustraliaPost codes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="AustraliaPost" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="TIFF" fileiconsmall4="BMP" fileiconsmall5="AustraliaPost" >}}
...
{{% blocks/products/pf/agp/content h2="How to Recognize AUSTRALIAPOST Barcode Using C++" %}}

 In order to read Australia Post, Australia Poste Parcel barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize AustraliaPost via C++" %}}
...
1.  Set path to the image containing AustraliaPost barcode with full path as a parameter
1.  Set the relevant DecodeType as second parameter
1.  Loop through each result
1.  Get AustraliaPost barcode text using GetCodeText
...
{{% blocks/products/pf/agp/code-block title="Recognize AustraliaPost - C++‎" offSpacer="" %}}

```cs
// Create an instance of BarCodeReader, set image and DecodeType type to recognize
System::SharedPtr<BarCodeReader> barCodeReader = System::MakeObject<BarCodeReader>(u"sourceImage.png", DecodeType::AustraliaPost);
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode AustraliaPost via Online App" sectionDescription="[Recognize AustraliaPost](https://products.aspose.app/barcode/recognize/australiapost) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing Australia Post, Australia Poste Parcel barcodes, it will be scanned instantly." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get all the recognized AUSTRALIAPOST types." >}}
