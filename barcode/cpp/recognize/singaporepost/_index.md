---
title: Recognize SINGAPOREPOST BarCode via C++ 
weight: 1210
url: /cpp/recognize/singaporepost/ 
description: Try our On-Premise SINGAPOREPOST Barcode Reader and Decoder APIs on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="AllSupportedTypes Code Reader for C++" h2="Build C++ barcode scanning apps that can detect & read AllSupportedTypes codes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="AllSupportedTypes" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="TIFF" fileiconsmall4="BMP" fileiconsmall5="AllSupportedTypes" >}}
...
{{% blocks/products/pf/agp/content h2="How to Recognize SINGAPOREPOST Barcode Using C++" %}}

 In order to read SINGAPORE POST barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize AllSupportedTypes via C++" %}}
...
1.  Set path to the image containing AllSupportedTypes barcode with full path as a parameter
1.  Set the relevant DecodeType as second parameter
1.  Loop through each result
1.  Get AllSupportedTypes barcode text using GetCodeText
...
{{% blocks/products/pf/agp/code-block title="Recognize AllSupportedTypes - C++‎" offSpacer="" %}}

```cs
// Create an instance of BarCodeReader, set image and DecodeType type to recognize
System::SharedPtr<BarCodeReader> barCodeReader = System::MakeObject<BarCodeReader>(u"sourceImage.png", DecodeType::AllSupportedTypes);
...
barCodeReader->Close(); 
// Use the relevant DecodeType as of here Singapore Post is used
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode AllSupportedTypes via Online App" sectionDescription="[Recognize AllSupportedTypes](https://products.aspose.app/barcode/recognize/singaporepost) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing SINGAPORE POST barcodes, it will be scanned instantly." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get all the recognized SINGAPOREPOST types." >}}
