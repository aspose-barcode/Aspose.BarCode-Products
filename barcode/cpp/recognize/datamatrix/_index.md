---
title: Recognize DATAMATRIX BarCode via C++ 
weight: 390
url: /cpp/recognize/datamatrix/ 
description: Try our On-Premise DATAMATRIX Barcode Reader and Decoder APIs on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="DataMatrix Code Reader for C++" h2="Build C++ barcode scanning apps that can detect & read DataMatrix codes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DataMatrix" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="TIFF" fileiconsmall4="BMP" fileiconsmall5="DataMatrix" >}}
...
{{% blocks/products/pf/agp/content h2="How to Recognize DATAMATRIX Barcode Using C++" %}}

 In order to read Data Matrix, GS1 Data Matrix barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize DataMatrix via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Recognize DataMatrix - C++‎" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode DataMatrix via Online App" sectionDescription="[Recognize DataMatrix](https://products.aspose.app/barcode/recognize/datamatrix) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing Data Matrix, GS1 Data Matrix barcodes, it will be scanned instantly." >}}
