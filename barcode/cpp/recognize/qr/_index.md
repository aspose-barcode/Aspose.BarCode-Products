---
title: Recognize QR BarCode via C++ 
weight: 980
url: /cpp/recognize/qr/ 
description: Try our On-Premise QR Barcode Reader and Decoder APIs on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="QR Code Reader for C++" h2="Build C++ barcode scanning apps that can detect & read QR codes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="TIFF" fileiconsmall4="BMP" fileiconsmall5="QR" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize QR via C++" %}}
...
1.  Set path to the image containing QR barcode with full path as a parameter
1.  Set the relevant DecodeType as second parameter
1.  Loop through each result
1.  Get QR barcode text using GetCodeText
...
{{% blocks/products/pf/agp/code-block title="Recognize QR - C++‎" offSpacer="" %}}

```cs
// Create an instance of BarCodeReader, set image and DecodeType type to recognize
System::SharedPtr<BarCodeReader> barCodeReader = System::MakeObject<BarCodeReader>(u"sourceImage.png", DecodeType::QR);
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode QR via Online App" sectionDescription="[Recognize QR](https://products.aspose.app/barcode/recognize/qr) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing QR Code, GS1 QR Code barcodes, it will be scanned instantly." >}}
