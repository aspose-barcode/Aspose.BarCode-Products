...
weight: 990
url: /cpp/generate/postnet/ 
description: Try our On-Premise POSTNET Barcode Image Generation API on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Postnet Code via C++" h2="Create POSTNET type barcode in image formats using Aspose.BarCode for C++ APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="TIFF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="BMP" fileiconsmall5="POSTNET" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Postnet Code via C++" %}}
...
System::SharedPtr<BarcodeGenerator> barcodeGenerator = System::MakeObject<BarcodeGenerator>(EncodeTypes::Postnet, u"1234567");
...
{{< blocks/products/pf/agp/demobox sectionTitle="POSTNET Barcode Generation Live Demos" sectionDescription="[Create POSTNET](https://products.aspose.app/barcode/generate/postnet) Barocdes right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just set the POSTNET encoding type, text and image type." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get the generated POSTNET barcode." >}}
