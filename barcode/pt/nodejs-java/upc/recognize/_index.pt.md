---
title: Digitalize Código de barras UPC (código de produto universal) Imagens via Node.js via Java
weight: 1510
description: Código-fonte Node.js para varredura e decodificação de Código de barras UPC (código de produto universal) em aplicativos JavaScript.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/nodejs-java/upc/recognize/
aliases:
- /pt/nodejs-java/recognize/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras UPC com Node.js via Java" h2="Leia Código de barras UPC (código de produto universal) em JavaScript usando a API Aspose.BarCode do lado do servidor para Node.js via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Código de barras UPC (código de produto universal) Using Node.js via Java" %}}
Para reconhecer Código de barras UPC (código de produto universal) em aplicativos Node.js, use Aspose.BarCode para Node.js via Java, uma biblioteca de código de barras robusta, versátil e fácil de usar introduzida para ambientes baseados em Java. Você pode carregar [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) para Javascript diretamente do NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para digitalizar Código de barras UPC (código de produto universal) em JavaScript" %}}
