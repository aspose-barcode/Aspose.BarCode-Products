---
title: Digitalize Code 39 código de barras Imagens via Node.js via Java
weight: 1510
description: Código-fonte Node.js para varredura e decodificação de Code 39 código de barras em aplicativos JavaScript.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/nodejs-java/code39/recognize/
aliases:
- /pt/nodejs-java/recognize/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras Code 39 com Node.js via Java" h2="Leia Code 39 código de barras em JavaScript usando a API Aspose.BarCode do lado do servidor para Node.js via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para digitalizar Code 39 código de barras em JavaScript" %}}
