---
title: Gere Australia Post código de barras e Australia Post eParcel Imagens via Node.js via Java
description: Código de exemplo Node.js para geração de Australia Post código de barras e Australia Post eParcel em aplicativos JavaScript.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/nodejs-java/australia-post/generate/
aliases:
- /pt/nodejs-java/generate/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas Australia Post com Node.js via Java" h2="Crie Australia Post código de barras e Australia Post eParcel em JavaScript usando a API Aspose.BarCode do lado do servidor para Node.js via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Australia Post código de barras Using Node.js via Java" %}}
Para criar códigos de barras Australia Post código de barras em aplicativos Node.js, adquira o Aspose.BarCode para Node.js via Java, uma API de código de barras avançada, potente e fácil de usar projetada para plataformas orientadas a Java. Você pode facilmente instalar [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) para Javascript do NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Australia Post código de barras em JavaScript" %}}
