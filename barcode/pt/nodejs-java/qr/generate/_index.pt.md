...
{{% blocks/products/pf/agp/content h2="How to Generate Código QR Using Node.js via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Código QR em JavaScript" %}}
