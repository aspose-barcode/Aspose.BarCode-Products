---
title: Digitalize Swiss Post Parcel Imagens via Node.js via Java
weight: 1510
description: Código-fonte Node.js para varredura e decodificação de Swiss Post Parcel em aplicativos JavaScript.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/nodejs-java/swiss-post-parcel/recognize/
aliases:
- /pt/nodejs-java/recognize/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras Swiss Post Parcel com Node.js via Java" h2="Leia Swiss Post Parcel em JavaScript usando a API Aspose.BarCode do lado do servidor para Node.js via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para digitalizar Swiss Post Parcel em JavaScript" %}}
