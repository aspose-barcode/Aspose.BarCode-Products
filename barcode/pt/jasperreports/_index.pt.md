...
description: Usando Aspose.BarCode para JasperReports, os desenvolvedores podem gerar códigos de barras em Jasper Reports para serem renderizados posteriormente nos formatos BMP JPG GIF e PNG.
lang: pt
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Gerar e exportar códigos de barras no JasperReports" h2="API JasperReports e JasperServer para gerar, exibir e exportar códigos de barras 1D, 2D e postais." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="para JasperReports" downloadUrl="https://releases.aspose.com/barcode/jasperreports/" >}}
...
<p>Aspose.BarCode para JasperReports é uma extensão JasperReports e JasperServer flexível para criar e exibir etiquetas de código de barras em seus aplicativos. Essas etiquetas de código de barras podem ser renderizadas em muitos formatos de imagem populares.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Independência de plataforma" description="Aspose.BarCode para JasperReports pode ser usado com JasperServer e JasperReports." >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Formatos de arquivo suportados" description="Aspose.BarCode para JasperReports funciona com os formatos de arquivo de imagem mais comumente usados." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Recursos avançados de exportação de JasperReports para código de barras
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Gerar e imprimir relatórios com códigos de barras</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Aumente o fluxo de trabalho do aplicativo adicionando a funcionalidade de código de barras</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Incorpore códigos de barras em arquivos para ajudar na rastreabilidade</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/barcode-image-basic-features/'>Tamanho, cor e texto do código de controle</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/read-barcodes-with-aspose-barcode-apis/'>Reconhecimento de códigos de barras 2D distorcidos e girados em 3D</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/generate-barcode-by-specifying-custom-image-size/'>Crie imagens de código de barras de tamanho específico</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    Aspose.BarCode para JasperReports fornece um conjunto especial de ferramentas para trabalhar com códigos de barras em JasperReports. Usando esta API, os desenvolvedores podem digitalizar códigos de barras colocados em relatórios existentes ou adicioná-los a novos relatórios. Essa biblioteca de código de barras é codificada exclusivamente em Java e é fornecida como um único documento JAR e pode ser facilmente implantada em máquinas com JasperReports ou JasperServer instalado. Para instalar a extensão de código de barras JasperReports, basta copiar o documento JAR para a pasta correta e começar a trabalhar.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    A biblioteca do gerador de código de barras permite que os desenvolvedores criem facilmente códigos de barras especificando o tipo de código de barras, inserindo os dados a serem codificados e definindo propriedades personalizadas relacionadas à aparência. Isso inclui várias opções, como cor de fundo e primeiro plano, fonte, tamanho, resolução e legendas de texto. A API pode gerar códigos de barras 1D e 2D, incluindo PDF417, Data Matrix, Aztec Code, QR Code e Micro QR Code, usando a mesma abordagem básica. Isso o torna uma ferramenta conveniente e fácil de usar para gerar uma ampla variedade de tipos de códigos de barras para vários aplicativos, incluindo JasperReports.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Inserir códigos de barras no JasperReports
                </h2>
                <p>
                    O JasperReports permite que os desenvolvedores criem relatórios usando os dados armazenados em várias fontes, como bancos de dados, arquivos CSV e documentos XML. Ele fornece uma ampla gama de recursos para projetar, formatar e exportar relatórios, que podem ser facilmente integrados a aplicativos Java. Alguns usos comuns do JasperReports incluem geração de faturas, recibos, demonstrações financeiras e outros tipos de relatórios comerciais. Pode ser útil inserir códigos de barras no JasperReports para facilitar o acesso e o gerenciamento das informações nos relatórios. Por exemplo, os códigos de barras podem ser usados ​​para digitalizar e atualizar com rapidez e precisão as informações em um JasperReport, ou seja, digitalizando um código de barras em uma fatura para recuperar e exibir os dados associados. Isso pode facilitar o rastreamento e o gerenciamento de informações e reduzir o risco de erros ou discrepâncias. O código de barras também pode servir para exibir itens ou registros específicos no relatório.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/pdf417/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/qr/" name="QR" description="Código QR, Código GS1 QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/datamatrix/" name="Data Matrix" description="Código Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/aztec/" name="Aztec" description="Código Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/swiss-qr/" name="Swiss QR" description="Swiss QR conta" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/dotcode/" name="DotCode" description="DotCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/hibc/" name="HIBC" description="HIBC (código de barras do setor de saúde)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/codablock/" name="Codablock-F" description="Códigos de barras Codablock-F e GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/databar/" name="GS1 DataBar" description="Código de barras GS1 DataBar (Omnidirecional, Empilhado Omnidirecional, Expandido, Empilhado Expandido e Truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/itf/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/ean/" name="EAN" description="Código de barras EAN (número de artigo internacional)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/upc/" name="UPC" description="Código de barras UPC (código de produto universal)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/code128/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/code39/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/code16k/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/code32/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/code93/" name="Code 93" description="Code 93 Estendido e Code 93 Códigos de barras padrão" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/onecode/" name="USPS OneCode" description="código de barras USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 de 5) código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/isbn/" name="ISBN" description="código de barras ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/ismn/" name="ISMN" description="código de barras ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/issn/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/australia-post/" name="Australia Post" description="Australia Post código de barras e Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode e Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/rm4scc/" name="RM4SCC" description="Royal Mail 4-State Customer Code (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/postnet/" name="Postnet" description="código de barras Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/royal-mail/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/singapore-post/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/jasperreports/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Notas de lançamento" href="https://docs.aspose.com/barcode/jasperreports/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.BarCode para JasperReports?" tabId="success-stories" >}}
