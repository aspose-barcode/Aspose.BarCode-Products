---
title: Gere Código de barras UPC (código de produto universal) Imagens via C++
description: Exemplo de código C++ para gerar Código de barras UPC (código de produto universal) no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits e Linux de 64 bits.
lang: pt
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pt/cpp/upc/generate/
aliases:
- /pt/cpp/generate/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas UPC com C++" h2="Crie Código de barras UPC (código de produto universal) em C++ usando a API Aspose.BarCode do lado do servidor para C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Crie um objeto da classe BarcodeGenerator</li><li>Passe Código de barras UPC (código de produto universal) como parâmetro</li><li>Insira o texto de entrada para codificar como o segundo parâmetro</li><li>Defina as dimensões da imagem, se necessário</li><li>Chame o método BarcodeGenerator.Save para baixar o código de barras Código de barras UPC (código de produto universal)</li></ul>
