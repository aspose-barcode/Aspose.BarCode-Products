---
title: Digitalize Código de barras UPC (código de produto universal) Imagens via C++
weight: 1510
description: Código de amostra C++ para escanear e decodificar Código de barras UPC (código de produto universal) no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits ou Linux de 64 bits.
lang: pt
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pt/cpp/upc/recognize/
aliases:
- /pt/cpp/recognize/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras UPC com C++" h2="Leia Código de barras UPC (código de produto universal) em C++ usando a API Aspose.BarCode do lado do servidor para C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
