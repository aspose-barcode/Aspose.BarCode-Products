---
title: Digitalize código de barras USPS OneCode Imagens via C++
weight: 1510
description: Código de amostra C++ para escanear e decodificar código de barras USPS OneCode no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits ou Linux de 64 bits.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/cpp/onecode/recognize/
aliases:
- /pt/cpp/recognize/onecode/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras USPS OneCode com C++" h2="Leia código de barras USPS OneCode em C++ usando a API Aspose.BarCode do lado do servidor para C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="USPS OneCode" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
