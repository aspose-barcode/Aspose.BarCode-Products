---
title: Digitalize Código Aztec Imagens via C++
weight: 1510
description: Código de amostra C++ para escanear e decodificar Código Aztec no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits ou Linux de 64 bits.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/cpp/aztec/recognize/
aliases:
- /pt/cpp/recognize/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras Aztec com C++" h2="Leia Código Aztec em C++ usando a API Aspose.BarCode do lado do servidor para C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
