---
title: Gere Código Aztec Imagens via C++
description: Exemplo de código C++ para gerar Código Aztec no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits e Linux de 64 bits.
lang: pt
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pt/cpp/aztec/generate/
aliases:
- /pt/cpp/generate/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas Aztec com C++" h2="Crie Código Aztec em C++ usando a API Aspose.BarCode do lado do servidor para C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Crie um objeto da classe BarcodeGenerator</li><li>Passe Código Aztec como parâmetro</li><li>Insira o texto de entrada para codificar como o segundo parâmetro</li><li>Defina as dimensões da imagem, se necessário</li><li>Chame o método BarcodeGenerator.Save para baixar o código de barras Código Aztec</li></ul>
