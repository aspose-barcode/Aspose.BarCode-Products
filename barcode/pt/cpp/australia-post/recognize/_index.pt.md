---
title: Digitalize Australia Post código de barras e Australia Post eParcel Imagens via C++
weight: 1510
description: Código de amostra C++ para escanear e decodificar Australia Post código de barras e Australia Post eParcel no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits ou Linux de 64 bits.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/cpp/australia-post/recognize/
aliases:
- /pt/cpp/recognize/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras Australia Post com C++" h2="Leia Australia Post código de barras e Australia Post eParcel em C++ usando a API Aspose.BarCode do lado do servidor para C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
