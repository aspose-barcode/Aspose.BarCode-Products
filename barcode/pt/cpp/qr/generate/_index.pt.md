...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Código QR em C++" %}}
...
<ul><li>Crie um objeto da classe BarcodeGenerator</li><li>Passe Código QR, Código GS1 QR como parâmetro</li><li>Insira o texto de entrada para codificar como o segundo parâmetro</li><li>Defina as dimensões da imagem, se necessário</li><li>Chame o método BarcodeGenerator.Save para baixar o código de barras Código QR, Código GS1 QR</li></ul>
