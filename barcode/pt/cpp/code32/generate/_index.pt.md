...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Code 32 código de barras em C++" %}}
...
<ul><li>Crie um objeto da classe BarcodeGenerator</li><li>Passe Código de barras italiano Pharmacode (Code 32) como parâmetro</li><li>Insira o texto de entrada para codificar como o segundo parâmetro</li><li>Defina as dimensões da imagem, se necessário</li><li>Chame o método BarcodeGenerator.Save para baixar o código de barras Código de barras italiano Pharmacode (Code 32)</li></ul>
