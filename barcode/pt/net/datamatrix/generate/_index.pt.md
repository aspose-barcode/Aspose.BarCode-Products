---
title: Gere Código Data Matrix Imagens via .NET
description: Código-fonte C# para geração de Código Data Matrix em .NET Framework, .NET Standard, COM Interloop para PHP, VBScript, Delphi e C++.
lang: pt
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pt/net/datamatrix/generate/
aliases:
- /pt/net/generate/datamatrix/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas Data Matrix com .NET" h2="Crie Código Data Matrix em C# usando a API Aspose.BarCode do lado do servidor para .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Data Matrix" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Código Data Matrix Using .NET" %}}
Para criar Código Data Matrix, experimente a API [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/), uma biblioteca de códigos de barras rica em recursos, poderosa e fácil de usar para plataformas C#. Abra o gerenciador de pacotes [NuGet](https://www.nuget.org/packages/aspose.barcode), procure por **Aspose.BarCode** e instale o pacote. Você também pode executar o seguinte comando no console do Package Manager:
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Código Data Matrix em C#" %}}
