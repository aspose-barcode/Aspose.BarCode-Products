---
title: Gere Australia Post código de barras e Australia Post eParcel Imagens via .NET
description: Código-fonte C# para geração de Australia Post código de barras e Australia Post eParcel em .NET Framework, .NET Standard, COM Interloop para PHP, VBScript, Delphi e C++.
lang: pt
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pt/net/australia-post/generate/
aliases:
- /pt/net/generate/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas Australia Post com .NET" h2="Crie Australia Post código de barras e Australia Post eParcel em C# usando a API Aspose.BarCode do lado do servidor para .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Australia Post código de barras Using .NET" %}}
Para criar Australia Post código de barras, experimente a API [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/), uma biblioteca de códigos de barras rica em recursos, poderosa e fácil de usar para plataformas C#. Abra o gerenciador de pacotes [NuGet](https://www.nuget.org/packages/aspose.barcode), procure por **Aspose.BarCode** e instale o pacote. Você também pode executar o seguinte comando no console do Package Manager:
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Australia Post código de barras em C#" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode torna mais fácil para os desenvolvedores criar imagens Australia Post código de barras com poucas linhas de código.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Crie uma instância da classe BarcodeGenerator</li><li>Passe Australia Post código de barras e Australia Post eParcel como um parâmetro</li><li>Defina o texto para codificar como o segundo parâmetro</li><li> Especifique as dimensões do código de barras, se necessário</li><li>Chame o método BarcodeGenerator.Save para obter a imagem Australia Post código de barras e Australia Post eParcel</li></ul>
