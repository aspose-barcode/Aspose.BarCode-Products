---
title: Gere Code 39 código de barras Imagens via .NET
description: Código-fonte C# para geração de Code 39 código de barras em .NET Framework, .NET Standard, COM Interloop para PHP, VBScript, Delphi e C++.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/net/code39/generate/
aliases:
- /pt/net/generate/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas Code 39 com .NET" h2="Crie Code 39 código de barras em C# usando a API Aspose.BarCode do lado do servidor para .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Code 39 código de barras Using .NET" %}}
Para criar Code 39 código de barras, experimente a API [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/), uma biblioteca de códigos de barras rica em recursos, poderosa e fácil de usar para plataformas C#. Abra o gerenciador de pacotes [NuGet](https://www.nuget.org/packages/aspose.barcode), procure por **Aspose.BarCode** e instale o pacote. Você também pode executar o seguinte comando no console do Package Manager:
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Code 39 código de barras em C#" %}}
...
<ul><li>Crie uma instância da classe BarcodeGenerator</li><li>Passe Code 39 código de barras como um parâmetro</li><li>Defina o texto para codificar como o segundo parâmetro</li><li> Especifique as dimensões do código de barras, se necessário</li><li>Chame o método BarcodeGenerator.Save para obter a imagem Code 39 código de barras</li></ul>
