---
title: Digitalize Código Aztec Imagens via .NET
weight: 1510
description: Exemplo de código C# para escanear e decodificar o tipo de código de barras Código Aztec em .NET Framework, .NET Standard, COM Interloop para PHP, VBScript, Delphi ou C++.
lang: pt
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pt/net/aztec/recognize/
aliases:
- /pt/net/recognize/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras Aztec com .NET" h2="Leia Código Aztec em C# usando a API Aspose.BarCode do lado do servidor para .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Código Aztec Using .NET" %}}
Para decodificar Código Aztec, experimente a API [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/), uma biblioteca de códigos de barras rica em recursos, poderosa e fácil de usar para plataformas C#. Use [NuGet](https://www.nuget.org/packages/aspose.barcode) e procure por **Aspose.BarCode** para instalar o pacote. Como alternativa, execute o seguinte comando no console do Package Manager:
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para digitalizar Código Aztec em C#" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode permite que os desenvolvedores leiam códigos de barras Código Aztec de stream ou imagem com poucas linhas de código

{{% /blocks/products/pf/agp/text %}}

<ul><li>Crie uma nova instância da classe Aspose.BarCode.BarCodeReader</li><li>Passe o caminho da imagem de origem contendo Código Aztec como um parâmetro</li><li>Passe um DecodeType apropriado como o segundo parâmetro</li><li>Percorrer os resultados da decodificação</li><li>Obter o texto do código de barras usando a propriedade CodeText</li></ul>
