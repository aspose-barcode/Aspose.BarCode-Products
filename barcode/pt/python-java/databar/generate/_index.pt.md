---
title: Gere Código de barras GS1 DataBar (Omnidirecional, Empilhado Omnidirecional, Expandido, Empilhado Expandido e Truncado) Imagens via Python via Java
description: Exemplo de código Python para gerar Código de barras GS1 DataBar (Omnidirecional, Empilhado Omnidirecional, Expandido, Empilhado Expandido e Truncado) usando o Java Runtime Environment.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/python-java/databar/generate/
aliases:
- /pt/python-java/generate/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas GS1 DataBar com Python via Java" h2="Crie Código de barras GS1 DataBar (Omnidirecional, Empilhado Omnidirecional, Expandido, Empilhado Expandido e Truncado) em Python usando a API Aspose.BarCode do lado do servidor para Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate GS1 DataBar código de barras Using Python via Java" %}}
Para criar imagens GS1 DataBar código de barras, obtenha a API [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/), uma API rica em recursos, poderosa e fácil de -use a biblioteca de código de barras para aplicativos baseados em Python. Obtenha a versão mais recente diretamente do portal [Versões do Aspose](https://releases.aspose.com/barcode/python-java/) ou instale 'aspose-barcode' do pip com o seguinte comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar GS1 DataBar código de barras em Python" %}}
...
<ul><li>Crie um novo objeto da classe BarCodeGenerator</li><li>Determine os tipos de código de barras desejados como o parâmetro EncodeTypes</li><li>Insira o texto de entrada como o segundo parâmetro</li><li> Chame o método BarCodeGenerator.save para obter a imagem Código de barras GS1 DataBar (Omnidirecional, Empilhado Omnidirecional, Expandido, Empilhado Expandido e Truncado) gerada</li></ul>
...
<ul><li>Microsoft Windows, Linux ou qualquer sistema operacional compatível com os ambientes de desenvolvimento Python</li><li>Java 8 ou superior</li><li>Python 3.6 ou superior</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/pdf417/generate/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/qr/generate/" name="QR" description="Código QR, Código GS1 QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/datamatrix/generate/" name="Data Matrix" description="Código Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/aztec/generate/" name="Aztec" description="Código Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/swiss-qr/generate/" name="Swiss QR" description="Swiss QR conta" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/dotcode/generate/" name="DotCode" description="DotCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/hibc/generate/" name="HIBC" description="HIBC (código de barras do setor de saúde)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/codablock/generate/" name="Codablock-F" description="Códigos de barras Codablock-F e GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/databar/generate/" name="GS1 DataBar" description="Código de barras GS1 DataBar (Omnidirecional, Empilhado Omnidirecional, Expandido, Empilhado Expandido e Truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/itf/generate/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/ean/generate/" name="EAN" description="Código de barras EAN (número de artigo internacional)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/upc/generate/" name="UPC" description="Código de barras UPC (código de produto universal)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/code128/generate/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/code39/generate/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/code16k/generate/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/code32/generate/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/code93/generate/" name="Code 93" description="Code 93 Estendido e Code 93 Códigos de barras padrão" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/onecode/generate/" name="USPS OneCode" description="código de barras USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/standard2of5/generate/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 de 5) código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/isbn/generate/" name="ISBN" description="código de barras ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/ismn/generate/" name="ISMN" description="código de barras ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/issn/generate/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/australia-post/generate/" name="Australia Post" description="Australia Post código de barras e Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Identcode e Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/rm4scc/generate/" name="RM4SCC" description="Royal Mail 4-State Customer Code (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/postnet/generate/" name="Postnet" description="código de barras Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/royal-mail/generate/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/singapore-post/generate/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/python-java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
