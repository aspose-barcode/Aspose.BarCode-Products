---
title: Digitalize GS1 Code 128 código de barras Imagens via Python via Java
weight: 1510
description: Código-fonte Python para reconhecimento de GS1 Code 128 código de barras usando Java Runtime Environment.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/python-java/code128/recognize/
aliases:
- /pt/python-java/recognize/code128/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras GS1 Code 128 com Python via Java" h2="Leia GS1 Code 128 código de barras em Python usando a API Aspose.BarCode do lado do servidor para Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 Code 128 código de barras Using Python via Java" %}}
Para escanear e decodificar GS1 Code 128 código de barras, instale [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, uma API versátil, poderosa e fácil de use a biblioteca de código de barras para aplicativos baseados em Python. Obtenha a versão mais recente diretamente do portal [Versões do Aspose](https://releases.aspose.com/barcode/python-java/) ou instale 'aspose-barcode' do pip executando o seguinte comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para digitalizar GS1 Code 128 código de barras em Python" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode permite que os desenvolvedores leiam códigos de barras GS1 Code 128 código de barras de stream ou imagem com poucas linhas de código

{{% /blocks/products/pf/agp/text %}}

<ul><li>Crie um objeto da classe Aspose.BarCode.BarCodeReader</li><li>Defina o caminho do arquivo de origem contendo GS1 Code 128 código de barras como parâmetro</li><li>Determine os tipos de códigos de barras necessários em DecodeType como o segundo parâmetro</li><li>Percorrer os resultados da decodificação</li><li>Obter o texto do código de barras usando a propriedade CodeText</li></ul>
