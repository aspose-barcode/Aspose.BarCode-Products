---
title: Gere Code 39 código de barras Imagens via Python via Java
description: Exemplo de código Python para gerar Code 39 código de barras usando o Java Runtime Environment.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/python-java/code39/generate/
aliases:
- /pt/python-java/generate/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas Code 39 com Python via Java" h2="Crie Code 39 código de barras em Python usando a API Aspose.BarCode do lado do servidor para Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Code 39 código de barras em Python" %}}
...
<ul><li>Crie um novo objeto da classe BarCodeGenerator</li><li>Determine os tipos de código de barras desejados como o parâmetro EncodeTypes</li><li>Insira o texto de entrada como o segundo parâmetro</li><li> Chame o método BarCodeGenerator.save para obter a imagem Code 39 código de barras gerada</li></ul>
