---
title: Gere Swiss Post Parcel Imagens via Python via Java
description: Exemplo de código Python para gerar Swiss Post Parcel usando o Java Runtime Environment.
lang: pt
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pt/python-java/swiss-post-parcel/generate/
aliases:
- /pt/python-java/generate/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas Swiss Post Parcel com Python via Java" h2="Crie Swiss Post Parcel em Python usando a API Aspose.BarCode do lado do servidor para Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Swiss Post Parcel em Python" %}}
...
<ul><li>Crie um novo objeto da classe BarCodeGenerator</li><li>Determine os tipos de código de barras desejados como o parâmetro EncodeTypes</li><li>Insira o texto de entrada como o segundo parâmetro</li><li> Chame o método BarCodeGenerator.save para obter a imagem Swiss Post Parcel gerada</li></ul>
