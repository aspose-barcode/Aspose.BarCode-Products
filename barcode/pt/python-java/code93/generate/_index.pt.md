---
title: Gere Code 93 Estendido e Code 93 Códigos de barras padrão Imagens via Python via Java
description: Exemplo de código Python para gerar Code 93 Estendido e Code 93 Códigos de barras padrão usando o Java Runtime Environment.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/python-java/code93/generate/
aliases:
- /pt/python-java/generate/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas Code 93 com Python via Java" h2="Crie Code 93 Estendido e Code 93 Códigos de barras padrão em Python usando a API Aspose.BarCode do lado do servidor para Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Code 93 código de barras Using Python via Java" %}}
Para criar imagens Code 93 código de barras, obtenha a API [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/), uma API rica em recursos, poderosa e fácil de -use a biblioteca de código de barras para aplicativos baseados em Python. Obtenha a versão mais recente diretamente do portal [Versões do Aspose](https://releases.aspose.com/barcode/python-java/) ou instale 'aspose-barcode' do pip com o seguinte comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Code 93 código de barras em Python" %}}
...
<ul><li>Crie um novo objeto da classe BarCodeGenerator</li><li>Determine os tipos de código de barras desejados como o parâmetro EncodeTypes</li><li>Insira o texto de entrada como o segundo parâmetro</li><li> Chame o método BarCodeGenerator.save para obter a imagem Code 93 Estendido e Code 93 Códigos de barras padrão gerada</li></ul>
