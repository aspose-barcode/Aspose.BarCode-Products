---
title: Digitalize Código de barras italiano Pharmacode (Code 32) Imagens via Python via Java
weight: 1510
description: Código-fonte Python para reconhecimento de Código de barras italiano Pharmacode (Code 32) usando Java Runtime Environment.
lang: pt
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pt/python-java/code32/recognize/
aliases:
- /pt/python-java/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras Code 32 com Python via Java" h2="Leia Código de barras italiano Pharmacode (Code 32) em Python usando a API Aspose.BarCode do lado do servidor para Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 32 código de barras Using Python via Java" %}}
Para escanear e decodificar Code 32 código de barras, instale [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, uma API versátil, poderosa e fácil de use a biblioteca de código de barras para aplicativos baseados em Python. Obtenha a versão mais recente diretamente do portal [Versões do Aspose](https://releases.aspose.com/barcode/python-java/) ou instale 'aspose-barcode' do pip executando o seguinte comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para digitalizar Code 32 código de barras em Python" %}}
