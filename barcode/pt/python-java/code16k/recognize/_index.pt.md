---
title: Digitalize Code 16K código de barras Imagens via Python via Java
weight: 1510
description: Código-fonte Python para reconhecimento de Code 16K código de barras usando Java Runtime Environment.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/python-java/code16k/recognize/
aliases:
- /pt/python-java/recognize/code16k/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras Code 16K com Python via Java" h2="Leia Code 16K código de barras em Python usando a API Aspose.BarCode do lado do servidor para Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 16K código de barras Using Python via Java" %}}
Para escanear e decodificar Code 16K código de barras, instale [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, uma API versátil, poderosa e fácil de use a biblioteca de código de barras para aplicativos baseados em Python. Obtenha a versão mais recente diretamente do portal [Versões do Aspose](https://releases.aspose.com/barcode/python-java/) ou instale 'aspose-barcode' do pip executando o seguinte comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para digitalizar Code 16K código de barras em Python" %}}
