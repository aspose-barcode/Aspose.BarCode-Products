---
title: Digitalize Código de barras italiano Pharmacode (Code 32) Imagens via PHP via Java
weight: 1510
description: Exemplo de código PHP para ler Código de barras italiano Pharmacode (Code 32) em aplicativos baseados em PHP.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/php-java/code32/recognize/
aliases:
- /pt/php-java/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras Code 32 com PHP via Java" h2="Leia Código de barras italiano Pharmacode (Code 32) em PHP usando a API Aspose.BarCode do lado do servidor para PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para digitalizar Code 32 código de barras em PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode permite que os desenvolvedores leiam códigos de barras Code 32 código de barras de stream ou imagem com poucas linhas de código

{{% /blocks/products/pf/agp/text %}}

<ul><li>Criar um objeto da classe Aspose.BarCode.BarCodeReader</li><li>Definir o caminho da imagem de origem contendo Code 32 código de barras como um parâmetro</li><li>Especificar os tipos de códigos de barras de destino em DecodeType como o segundo parâmetro</li><li>Percorrer os resultados da leitura</li><li>Obter o texto do código de barras usando a propriedade CodeText</li></ul>
...
<span class="hljs-keyword">try</span>
{
    ...
    <span class="hljs-variable">$reader</span> = <span class="hljs-keyword">new</span> <span class="hljs-title class_">BarCodeReader</span>(<span class="hljs-variable">$image</span>, <span class="hljs-literal">null</span>, <span class="hljs-title class_">DecodeType</span>::<span class="barcode-read-lcs-type">Code32</span>);
