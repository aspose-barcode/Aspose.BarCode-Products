---
title: Gere Royal Mail 4-State Customer Code (RM4SCC) Imagens via PHP via Java
description: Código-fonte PHP para criar Royal Mail 4-State Customer Code (RM4SCC) em aplicativos baseados em PHP.
lang: pt
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pt/php-java/rm4scc/generate/
aliases:
- /pt/php-java/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas RM4SCC com PHP via Java" h2="Crie Royal Mail 4-State Customer Code (RM4SCC) em PHP usando a API Aspose.BarCode do lado do servidor para PHP via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Royal Mail 4-State Customer Code (RM4SCC) em PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode torna mais fácil para os desenvolvedores criar imagens Royal Mail 4-State Customer Code (RM4SCC) com poucas linhas de código.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Crie uma nova instância da classe BarCodeGenerator</li><li>Especifique Royal Mail 4-State Customer Code (RM4SCC) e outros tipos de código de barras relevantes como o parâmetro EncodeTypes</li><li>Defina o texto do código de barras como o segundo parâmetro</li><li>Especificar as dimensões e localização da imagem, se necessário</li><li>Chame o método BarCodeGenerator.save para obter a imagem Royal Mail 4-State Customer Code (RM4SCC) no formato necessário</li></ul>
