---
title: Digitalize código de barras Postnet Imagens via PHP via Java
weight: 1510
description: Exemplo de código PHP para ler código de barras Postnet em aplicativos baseados em PHP.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/php-java/postnet/recognize/
aliases:
- /pt/php-java/recognize/postnet/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras Postnet com PHP via Java" h2="Leia código de barras Postnet em PHP usando a API Aspose.BarCode do lado do servidor para PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Postnet" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para digitalizar código de barras Postnet em PHP" %}}
...
<ul><li>Criar um objeto da classe Aspose.BarCode.BarCodeReader</li><li>Definir o caminho da imagem de origem contendo código de barras Postnet como um parâmetro</li><li>Especificar os tipos de códigos de barras de destino em DecodeType como o segundo parâmetro</li><li>Percorrer os resultados da leitura</li><li>Obter o texto do código de barras usando a propriedade CodeText</li></ul>
...
<span class="hljs-keyword">try</span>
{
    ...
    <span class="hljs-variable">$reader</span> = <span class="hljs-keyword">new</span> <span class="hljs-title class_">BarCodeReader</span>(<span class="hljs-variable">$image</span>, <span class="hljs-literal">null</span>, <span class="hljs-title class_">DecodeType</span>::<span class="barcode-read-lcs-type">Postnet</span>);
