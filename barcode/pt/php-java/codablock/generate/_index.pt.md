---
title: Gere Códigos de barras Codablock-F e GS1 Codablock-F Imagens via PHP via Java
description: Código-fonte PHP para criar Códigos de barras Codablock-F e GS1 Codablock-F em aplicativos baseados em PHP.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/php-java/codablock/generate/
aliases:
- /pt/php-java/generate/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas Codablock-F com PHP via Java" h2="Crie Códigos de barras Codablock-F e GS1 Codablock-F em PHP usando a API Aspose.BarCode do lado do servidor para PHP via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Codablock-F código de barras em PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode torna mais fácil para os desenvolvedores criar imagens Codablock-F código de barras com poucas linhas de código.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Crie uma nova instância da classe BarCodeGenerator</li><li>Especifique Codablock-F código de barras e outros tipos de código de barras relevantes como o parâmetro EncodeTypes</li><li>Defina o texto do código de barras como o segundo parâmetro</li><li>Especificar as dimensões e localização da imagem, se necessário</li><li>Chame o método BarCodeGenerator.save para obter a imagem Códigos de barras Codablock-F e GS1 Codablock-F no formato necessário</li></ul>
