...
description: API do SharePoint de código de barras para inserir etiquetas de código de barras em listas personalizadas do SharePoint. Os desenvolvedores podem usar marcadores de serviço para escolher valores de texto de entrada ou inserir o texto manualmente.
lang: pt/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="APIs de código de barras do SharePoint" h2="Barcode SharePoint App para adicionar códigos de barras lineares, 2D e postais às listas do Microsoft SharePoint." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="para SharePoint" downloadUrl="https://releases.aspose.com/barcode/sharepoint/" >}}
...
<p>Aspose.BarCode para SharePoint permite que os desenvolvedores adicionem uma grande variedade de códigos de barras lineares, 2D e postais às listas do Microsoft SharePoint Foundation 2010 e do Microsoft Office SharePoint Server 2010 (MOSS). Você pode criar e inserir códigos de barras em qualquer lista especificando o texto e o tipo de entrada.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Independência de plataforma" description="Aspose.BarCode para SharePoint suporta Microsoft SharePoint Foundation e SharePoint Server." >}}
<div class='diagram1 d1-sharepoint'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Formatos de arquivo suportados" description="Aspose.BarCode para SharePoint funciona com os formatos de arquivo de imagem mais comumente usados." >}}
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Adicionar códigos de barras às listas do Sharepoint
                </h2>
                <p>
                    Aspose.BarCode for SharePoint fornece funcionalidade avançada para adicionar códigos de barras às listas do SharePoint. Essas listas podem ser usadas para armazenar e organizar dados em um formato estruturado. É uma maneira conveniente de gerenciar uma ampla variedade de informações, como contatos, tarefas, eventos de calendário e muito mais. Eles fornecem vários recursos para organizar, classificar, filtrar e compartilhar dados. Pode ser útil adicionar códigos de barras às listas do SharePoint para facilitar o acesso e o gerenciamento das informações na lista. Se uma lista do SharePoint for criada para rastrear itens de inventário, os desenvolvedores podem adicionar códigos de barras para digitalizar e atualizar com rapidez e precisão as informações na lista. Isso pode facilitar o rastreamento e o gerenciamento do estoque, além de reduzir o risco de discrepâncias. Os códigos de barras podem servir para acessar e exibir informações rapidamente em uma lista do SharePoint, por exemplo, digitalizando códigos de barras para exibir rapidamente itens ou registros específicos na lista.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    A biblioteca de códigos de barras é uma ferramenta poderosa que permite aos desenvolvedores gerar facilmente códigos de barras especificando o tipo de código de barras de destino, inserindo os dados de entrada para armazenar o código de barras e personalizando as propriedades relacionadas à aparência. A biblioteca oferece uma variedade de opções para ajustar a aparência dos códigos de barras gerados, incluindo opções para definir as cores de fundo e primeiro plano, fonte, tamanho, resolução e legendas de texto.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    A API de código de barras inclui vários recursos para detectar e ler uma ampla variedade de códigos de barras 1D e 2D populares. Esses recursos podem ser facilmente integrados aos seus aplicativos com apenas algumas linhas de código, fornecendo uma maneira conveniente e eficiente de adicionar recursos de detecção de código de barras aos seus aplicativos.
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/pdf417/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/qr/" name="QR" description="Código QR, Código GS1 QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/datamatrix/" name="Data Matrix" description="Código Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/aztec/" name="Aztec" description="Código Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/swiss-qr/" name="Swiss QR" description="Swiss QR conta" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/dotcode/" name="DotCode" description="DotCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/hibc/" name="HIBC" description="HIBC (código de barras do setor de saúde)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/codablock/" name="Codablock-F" description="Códigos de barras Codablock-F e GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/databar/" name="GS1 DataBar" description="Código de barras GS1 DataBar (Omnidirecional, Empilhado Omnidirecional, Expandido, Empilhado Expandido e Truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/itf/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/ean/" name="EAN" description="Código de barras EAN (número de artigo internacional)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/upc/" name="UPC" description="Código de barras UPC (código de produto universal)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/code128/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/code39/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/code16k/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/code32/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/code93/" name="Code 93" description="Code 93 Estendido e Code 93 Códigos de barras padrão" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/onecode/" name="USPS OneCode" description="código de barras USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 de 5) código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/isbn/" name="ISBN" description="código de barras ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/ismn/" name="ISMN" description="código de barras ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/issn/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/australia-post/" name="Australia Post" description="Australia Post código de barras e Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode e Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/rm4scc/" name="RM4SCC" description="Royal Mail 4-State Customer Code (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/postnet/" name="Postnet" description="código de barras Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/royal-mail/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/singapore-post/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/sharepoint/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Notas de lançamento" href="https://docs.aspose.com/barcode/sharepoint/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
