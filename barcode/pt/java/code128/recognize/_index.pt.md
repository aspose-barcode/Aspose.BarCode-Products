---
title: Digitalize GS1 Code 128 código de barras Imagens via Java
weight: 1510
description: Código-fonte Java para ler e decodificar GS1 Code 128 código de barras no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/java/code128/recognize/
aliases:
- /pt/java/recognize/code128/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras GS1 Code 128 com Java" h2="Leia GS1 Code 128 código de barras em Java usando a API Aspose.BarCode do lado do servidor para Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
