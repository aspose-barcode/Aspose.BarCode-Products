---
title: Digitalize Código de barras UPC (código de produto universal) Imagens via Java
weight: 1510
description: Código-fonte Java para ler e decodificar Código de barras UPC (código de produto universal) no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/java/upc/recognize/
aliases:
- /pt/java/recognize/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras UPC com Java" h2="Leia Código de barras UPC (código de produto universal) em Java usando a API Aspose.BarCode do lado do servidor para Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
