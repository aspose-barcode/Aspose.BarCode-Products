---
title: Gere Código de barras UPC (código de produto universal) Imagens via Java
description: Código de amostra Java para geração de Código de barras UPC (código de produto universal) no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/java/upc/generate/
aliases:
- /pt/java/generate/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas UPC com Java" h2="Crie Código de barras UPC (código de produto universal) em Java usando a API Aspose.BarCode do lado do servidor para Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Código de barras UPC (código de produto universal) Using Java" %}}
Para gerar Código de barras UPC (código de produto universal), obtenha a API [Aspose.BarCode for Java](https://products.aspose.com/barcode/java/), uma API de código de barras avançada, poderosa e fácil de usar para Java- plataformas baseadas. Baixe a versão mais recente diretamente do [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-barcode) e instale-o no seu Maven- baseado no projeto adicionando as seguintes configurações ao pom.xml:
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Código de barras UPC (código de produto universal) em Java" %}}
...
<ul><li>Crie um novo objeto da classe BarCodeGenerator</li><li>Defina Código de barras UPC (código de produto universal) e outros tipos de código de barras necessários como o parâmetro EncodeTypes</li><li>Especifique o texto de entrada usando o método setCodeText</li><li>Use o método BarCodeGenerator.save para salvar a imagem do código de barras gerado</li></ul>
...
<ul><li>Microsoft Windows, Linux ou qualquer sistema operacional compatível com o Java Runtime Environment para JSP/JSF e aplicativos de desktop</li><li>Ambiente de desenvolvimento Java, como JRE 1.6 ou superior</li><li>Desenvolvimento Java versão JSE2 7.0 ou superior</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/pdf417/generate/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/qr/generate/" name="QR" description="Código QR, Código GS1 QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/datamatrix/generate/" name="Data Matrix" description="Código Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/aztec/generate/" name="Aztec" description="Código Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/swiss-qr/generate/" name="Swiss QR" description="Swiss QR conta" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/dotcode/generate/" name="DotCode" description="DotCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/hibc/generate/" name="HIBC" description="HIBC (código de barras do setor de saúde)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/codablock/generate/" name="Codablock-F" description="Códigos de barras Codablock-F e GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/databar/generate/" name="GS1 DataBar" description="Código de barras GS1 DataBar (Omnidirecional, Empilhado Omnidirecional, Expandido, Empilhado Expandido e Truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/itf/generate/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/ean/generate/" name="EAN" description="Código de barras EAN (número de artigo internacional)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/upc/generate/" name="UPC" description="Código de barras UPC (código de produto universal)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/code128/generate/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/code39/generate/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/code16k/generate/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/code32/generate/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/code93/generate/" name="Code 93" description="Code 93 Estendido e Code 93 Códigos de barras padrão" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/onecode/generate/" name="USPS OneCode" description="código de barras USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/standard2of5/generate/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 de 5) código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/isbn/generate/" name="ISBN" description="código de barras ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/ismn/generate/" name="ISMN" description="código de barras ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/issn/generate/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/australia-post/generate/" name="Australia Post" description="Australia Post código de barras e Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Identcode e Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/rm4scc/generate/" name="RM4SCC" description="Royal Mail 4-State Customer Code (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/postnet/generate/" name="Postnet" description="código de barras Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/royal-mail/generate/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/singapore-post/generate/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
