---
title: Gere Royal Mail 4-State Customer Code (RM4SCC) Imagens via Java
description: Código de amostra Java para geração de Royal Mail 4-State Customer Code (RM4SCC) no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/java/rm4scc/generate/
aliases:
- /pt/java/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas RM4SCC com Java" h2="Crie Royal Mail 4-State Customer Code (RM4SCC) em Java usando a API Aspose.BarCode do lado do servidor para Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar Royal Mail 4-State Customer Code (RM4SCC) em Java" %}}
