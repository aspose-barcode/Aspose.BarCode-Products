...
{{< blocks/products/pf/upper-banner h1="API de geração e reconhecimento de código de barras Java" h2="Crie e reconheça códigos de barras de tipos lineares, 2D e postais em qualquer aplicativo Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" pfName="Aspose.BarCode" subTitlepfName="para Java" downloadUrl="https://releases.aspose.com/barcode/java/" >}}
...
<p>Aspose.BarCode for Java é uma API robusta e confiável que fornece geração de código de barras e recursos de reconhecimento para aplicativos Java. Ele suporta os padrões e especificações mais estabelecidos e permite que os desenvolvedores leiam códigos de barras 1D e 2D de diferentes arquivos de imagem em qualquer ângulo. Aspose.BarCode para Java renderiza imagens de código de barras em uma variedade de formatos de imagem com opções de imagem altamente flexíveis. A biblioteca suporta codificação e decodificação de mais de 60 tipos de códigos de barras e permite a impressão direta de imagens de códigos de barras.</p>
{{< /blocks/products/pf/tab-content >}}
...
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>Linear, 2D e postal</li><li>Detecção de fluxo ou imagem</li><li>Obter orientação do código de barras</li><li>Decodificar caracteres não ingleses</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                Impressão
            </header>
            <ul><li>Imprimir código de barras diretamente</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>Linear, 2D e postal</li><li>Salvar em fluxo ou imagem</li><li>Personalizar aparência&colon; tamanho, cor, ângulo</li><li>Codificar caracteres não ingleses </li></ul>
            <header>
...
{{< blocks/products/pf/carousel-item h3="Independência de plataforma" description="Você pode usar a biblioteca de código de barras para criar qualquer tipo de aplicativo Java com JRE 1.6 ou superior instalado." >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Formatos de arquivo suportados" description="Aspose.BarCode para Java funciona com os formatos de arquivo de imagem mais comumente usados." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Recursos avançados da biblioteca Java
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/control-the-appearance-of-code-text/'>Ajustar e modificar as propriedades relacionadas à aparência do texto do código</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-the-barcode-caption/'>Gerenciar estilos de legenda e fonte</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/use-checksum-and-supplement-data-for-barcodes/'>Suporte para soma de verificação e dados suplementares</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#image-formats'>Gere imagens de código de barras para vários formatos de imagem</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/advanced-barcode-recognition-features/'>Leia tipos 1D e 2D em qualquer ângulo</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/barcode-regions/'>Digitalize o código de barras especificando a área</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/generate-barcode-by-specifying-custom-image-size/'>Personalize o tamanho das imagens</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-x-dimension-and-y-dimension/'>Suporte de dimensão X e Y para tipo 2D</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#barcode-types'>Suporte para simbologias lineares, 2D e postais</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    A API de código de barras permite que os desenvolvedores gerem facilmente imagens de código de barras de alta qualidade em seus aplicativos. Ele oferece suporte a uma ampla variedade de tipos de códigos de barras, incluindo os mais usados, como QR Code e Code 128, bem como tipos mais especializados, como Aztec Code e Data Matrix. A API permite que os desenvolvedores personalizem a aparência dos códigos de barras gerados, incluindo as cores de primeiro plano e de fundo, fonte e alinhamento da legenda. Usando a API, os desenvolvedores podem facilmente gerar códigos de barras 2D da mesma forma que gerariam códigos de barras unidimensionais.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Inserir códigos de barras em documentos PDF
                </h2>
                <p>
                    A biblioteca de códigos de barras permite que os desenvolvedores não apenas criem códigos de barras personalizados, mas também adicionem imagens geradas diretamente em documentos PDF. Você pode primeiro criar imagens de código de barras usando um dos formatos raster suportados e depois inseri-los em um arquivo PDF. A API permite adicionar códigos de barras sem compressão de imagem e perdas de qualidade. Ele também fornece funcionalidade para modificar os parâmetros e a aparência do código de barras antes das inserções ou adicionar a imagem gerada em várias páginas do documento de uma só vez. A API Aspose.BarCode pode ser usada para impressão de alta qualidade de imagens de código de barras. As imagens raster possuem resolução padrão de 96 dpi, o que não é suficiente para este fim. A API permite definir uma resolução de imagem de código de barras de 300 ou 600 dpi para imprimir documentos PDF de alta qualidade.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
                ...
                <p>
                    A biblioteca de código de barras Java é uma ferramenta poderosa para trabalhar com códigos de barras em aplicativos Java. Uma de suas principais características é a capacidade de ler códigos de barras de diferentes formatos de arquivo de imagem. A classe BarCodeReader, que é a principal classe responsável pelo reconhecimento de código de barras, suporta muitos formatos de imagem populares, incluindo BMP, PNG, TIFF, JPEG e GIF. Isso facilita a integração da funcionalidade de reconhecimento de código de barras em uma ampla gama de aplicações.
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
<div class="barcode-read-lcs" style="width: 100%;">
    ...
    <div class="barcode-read-lcs-controls">
        <div class="barcode-read-lcs-drop" onclick="BarcodeReadLcsUpload(this);" ondragover="event.preventDefault();" ondrop="BarcodeReadLcsDropped(event,this);">
            ...
            <span class="barcode-read-lcs-recognizing">Reconhecendo<span></span></span>
            <span class="barcode-read-lcs-hint">Solte um arquivo aqui ou clique para navegar *</span>
        </div>
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">Todos os tipos</option>
                <option value="Pdf417 ">PDF417</option>
                <option value="QR ">QR</option>
    ...
    <p class="barcode-read-lcs-disclaimer">* Ao enviar seus arquivos ou usar o serviço, você concorda com nossos <a href='https://about.aspose.com/legal/terms-of-use' rel='nofollow noreferrer' target='_blank'>Termos de use</a> e <a href='https://about.aspose.com/legal/privacy-policy' rel='nofollow noreferrer' target='_blank'>Política de Privacidade</a>.</p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    Além de ler códigos de barras de arquivos de imagem, a biblioteca de códigos de barras pode ser usada para digitalizar códigos de barras de arquivos PDF. Os desenvolvedores podem implementar a detecção rápida de código de barras em documentos PDF com várias páginas. A API fornece várias maneiras de fazer isso. A maneira recomendada é converter as páginas do documento em imagens raster e, em seguida, aplicar mecanismos de leitura de código de barras. A renderização do conteúdo da página em imagens raster é sugerida como a abordagem mais fácil e eficiente. Caso contrário, as imagens de código de barras podem ser detectadas primeiro e extraídas do documento PDF de origem. Este método facilita a leitura de códigos de barras com resolução original. A API Aspose.BarCode permite o processamento de arquivos PDF de várias páginas para detectar e reconhecer todos os códigos de barras apresentados em um documento.
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/pdf417/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/qr/" name="QR" description="Código QR, Código GS1 QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/datamatrix/" name="Data Matrix" description="Código Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/aztec/" name="Aztec" description="Código Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/swiss-qr/" name="Swiss QR" description="Swiss QR conta" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/dotcode/" name="DotCode" description="DotCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/hibc/" name="HIBC" description="HIBC (código de barras do setor de saúde)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/codablock/" name="Codablock-F" description="Códigos de barras Codablock-F e GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/databar/" name="GS1 DataBar" description="Código de barras GS1 DataBar (Omnidirecional, Empilhado Omnidirecional, Expandido, Empilhado Expandido e Truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/itf/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/ean/" name="EAN" description="Código de barras EAN (número de artigo internacional)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/upc/" name="UPC" description="Código de barras UPC (código de produto universal)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/code128/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/code39/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/code16k/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/code32/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/code93/" name="Code 93" description="Code 93 Estendido e Code 93 Códigos de barras padrão" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/onecode/" name="USPS OneCode" description="código de barras USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 de 5) código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/isbn/" name="ISBN" description="código de barras ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/ismn/" name="ISMN" description="código de barras ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/issn/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/australia-post/" name="Australia Post" description="Australia Post código de barras e Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode e Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/rm4scc/" name="RM4SCC" description="Royal Mail 4-State Customer Code (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/postnet/" name="Postnet" description="código de barras Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/royal-mail/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/singapore-post/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pt/java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="O que as pessoas estão dizendo" subTitle="Não acredite apenas em nossa palavra. Veja o que os usuários têm a dizer sobre APIs." caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 Passei muitos anos desenvolvendo e aprimorando meu produto e o Aspose me permitiu tornar meu produto muito mais amigável e útil e, portanto, mais comercializável. <em>Kiel Diller | KD Solutions, Polônia</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode é verdadeiramente escrito em código gerenciado e nos dá uma variedade de tipos de códigos de barras para lidar com todos os tipos de reconhecimento de documentos e processamento posterior. <em>Dennis Alexander Petrasc | Keil IT, Alemanha</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Documentação" href="https://docs.aspose.com/barcode/java/" >}}
{{< blocks/products/pf/slr-element name="Código fonte" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="Referências de API" href="https://reference.aspose.com/barcode/java/" >}}
...
{{< blocks/products/pf/slr-element name="Notas de lançamento" href="https://docs.aspose.com/barcode/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.BarCode para Java?" tabId="success-stories" >}}
{{< blocks/products/pf/slr-element name="Lista de clientes" href="https://about.aspose.com/customers" >}}
{{< blocks/products/pf/slr-element name="Histórias de sucesso" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Aspose.BarCode oferece APIs individuais de geração e reconhecimento de código de barras para outros ambientes de desenvolvimento populares, conforme listado abaixo:" >}}
