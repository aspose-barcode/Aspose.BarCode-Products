---
title: Digitalize Code 93 Estendido e Code 93 Códigos de barras padrão Imagens via Java
weight: 1510
description: Código-fonte Java para ler e decodificar Code 93 Estendido e Code 93 Códigos de barras padrão no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
lang: pt
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pt/java/code93/recognize/
aliases:
- /pt/java/recognize/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leia códigos de barras Code 93 com Java" h2="Leia Code 93 Estendido e Code 93 Códigos de barras padrão em Java usando a API Aspose.BarCode do lado do servidor para Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
