---
title: Gere Código Aztec Imagens via Android via Java
description: Código-fonte do Android para criar Código Aztec no Android Runtime Environment.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/android-java/aztec/generate/
aliases:
- /pt/android-java/generate/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas Aztec com Android via Java" h2="Crie Código Aztec em Java usando a API Aspose.BarCode do lado do servidor para Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Código Aztec Using Android via Java" %}}
Experimente o Aspose.BarCode para Android via Java para criar facilmente Código Aztec em aplicativos Android. É uma biblioteca de códigos de barras versátil, robusta e fácil de usar, projetada especificamente para aplicativos Android. Você pode facilmente Aspose.BarCode para Android via Java diretamente de um projeto baseado em Maven inserindo as seguintes configurações em build.gradle:
...
<ul><li>Crie uma nova instância da classe BarCodeGenerator</li><li>Passe o tipo de código de barras Código Aztec como o parâmetro EncodeTypes</li><li>Defina o texto do código de barras usando o método setCodeText</li><li>Inicie o método generateBarCodeImage() para salvar a imagem do código de barras Código Aztec</li></ul>
