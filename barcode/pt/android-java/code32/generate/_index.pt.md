...
Experimente o Aspose.BarCode para Android via Java para criar facilmente Code 32 código de barras em aplicativos Android. É uma biblioteca de códigos de barras versátil, robusta e fácil de usar, projetada especificamente para aplicativos Android. Você pode facilmente Aspose.BarCode para Android via Java diretamente de um projeto baseado em Maven inserindo as seguintes configurações em build.gradle:
...
<ul><li>Crie uma nova instância da classe BarCodeGenerator</li><li>Passe o tipo de código de barras Code 32 código de barras como o parâmetro EncodeTypes</li><li>Defina o texto do código de barras usando o método setCodeText</li><li>Inicie o método generateBarCodeImage() para salvar a imagem do código de barras Código de barras italiano Pharmacode (Code 32)</li></ul>
