---
title: Gere Code 39 código de barras Imagens via Android via Java
description: Código-fonte do Android para criar Code 39 código de barras no Android Runtime Environment.
lang: pt/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pt/android-java/code39/generate/
aliases:
- /pt/android-java/generate/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gere etiquetas Code 39 com Android via Java" h2="Crie Code 39 código de barras em Java usando a API Aspose.BarCode do lado do servidor para Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Experimente o Aspose.BarCode para Android via Java para criar facilmente Code 39 código de barras em aplicativos Android. É uma biblioteca de códigos de barras versátil, robusta e fácil de usar, projetada especificamente para aplicativos Android. Você pode facilmente Aspose.BarCode para Android via Java diretamente de um projeto baseado em Maven inserindo as seguintes configurações em build.gradle:
...
<ul><li>Crie uma nova instância da classe BarCodeGenerator</li><li>Passe o tipo de código de barras Code 39 código de barras como o parâmetro EncodeTypes</li><li>Defina o texto do código de barras usando o método setCodeText</li><li>Inicie o método generateBarCodeImage() para salvar a imagem do código de barras Code 39 código de barras</li></ul>
