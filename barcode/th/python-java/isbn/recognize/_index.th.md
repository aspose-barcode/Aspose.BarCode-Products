---
title: สแกนรูปภาพ ISBN บาร์โค้ด ผ่าน Python via Java
weight: 1510
description: ซอร์สโค้ด Python สำหรับการจดจำ ISBN บาร์โค้ด โดยใช้ Java Runtime Environment
lang: th/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /th/python-java/isbn/recognize/
aliases:
- /th/python-java/recognize/isbn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="อ่านบาร์โค้ด ISBN ด้วย Python via Java" h2="อ่าน ISBN บาร์โค้ด ใน Python โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISBN" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read ISBN บาร์โค้ด Using Python via Java" %}}
หากต้องการสแกนและถอดรหัส ISBN บาร์โค้ด ให้ติดตั้ง [Aspose.BarCode for Python ผ่าน Java](https://products.aspose.com/barcode/python-java/) API ซึ่งเป็น API อเนกประสงค์ ทรงพลัง และใช้งานง่าย ใช้ไลบรารีบาร์โค้ดสำหรับแอปพลิเคชันที่ใช้ Python รับเวอร์ชันล่าสุดโดยตรงจากพอร์ทัล [Aspose releases](https://releases.aspose.com/barcode/python-java/) หรือติดตั้ง 'aspose-barcode' จาก pip โดยเรียกใช้คำสั่งต่อไปนี้:
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสแกน ISBN บาร์โค้ด ใน Python" %}}
...
<ul><li>สร้างวัตถุของคลาส Aspose.BarCode.BarCodeReader</li><li>กำหนดเส้นทางไฟล์ต้นฉบับที่มี ISBN บาร์โค้ด เป็นพารามิเตอร์</li><li>กำหนดประเภทบาร์โค้ดที่ต้องการใน DecodeType เป็นพารามิเตอร์ที่สอง</li><li>วนซ้ำผลลัพธ์การถอดรหัส</li><li>รับข้อความบาร์โค้ดโดยใช้คุณสมบัติ CodeText</li></ul>
