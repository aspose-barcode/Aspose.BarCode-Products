---
title: สร้าง บาร์โค้ด GS1 Code 128 รูปภาพผ่าน Python via Java
description: โค้ดตัวอย่าง Python เพื่อสร้าง บาร์โค้ด GS1 Code 128 โดยใช้ Java Runtime Environment
lang: th
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /th/python-java/code128/generate/
aliases:
- /th/python-java/generate/code128/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="สร้างป้ายกำกับ GS1 Code 128 ด้วย Python via Java" h2="สร้าง บาร์โค้ด GS1 Code 128 ใน Python โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate บาร์โค้ด GS1 Code 128 Using Python via Java" %}}
หากต้องการสร้างรูปภาพ บาร์โค้ด GS1 Code 128 ให้ดาวน์โหลด [Aspose.BarCode for Python ผ่าน Java](https://products.aspose.com/barcode/python-java/) API ซึ่งมีคุณลักษณะหลากหลาย ทรงพลัง และใช้งานง่าย - ใช้ไลบรารีบาร์โค้ดสำหรับแอปพลิเคชันที่ใช้ Python รับเวอร์ชันล่าสุดโดยตรงจากพอร์ทัล [Aspose releases](https://releases.aspose.com/barcode/python-java/) หรือติดตั้ง 'aspose-barcode' จาก pip ด้วยคำสั่งต่อไปนี้:
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้าง บาร์โค้ด GS1 Code 128 ใน Python" %}}
...
<ul><li>สร้างวัตถุใหม่ของคลาส BarCodeGenerator</li><li>กำหนดประเภทบาร์โค้ดที่ต้องการเป็นพารามิเตอร์ EncodeTypes</li><li>แทรกข้อความอินพุตเป็นพารามิเตอร์ที่สอง</li><li> เรียกใช้เมธอด BarCodeGenerator.save เพื่อรับอิมเมจ บาร์โค้ด GS1 Code 128 ที่สร้างขึ้น</li></ul>
