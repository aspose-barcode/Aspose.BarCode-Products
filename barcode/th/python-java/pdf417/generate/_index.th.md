...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้าง PDF417 บาร์โค้ด ใน Python" %}}
...
<ul><li>สร้างวัตถุใหม่ของคลาส BarCodeGenerator</li><li>กำหนดประเภทบาร์โค้ดที่ต้องการเป็นพารามิเตอร์ EncodeTypes</li><li>แทรกข้อความอินพุตเป็นพารามิเตอร์ที่สอง</li><li> เรียกใช้เมธอด BarCodeGenerator.save เพื่อรับอิมเมจ PDF417 บาร์โค้ด ที่สร้างขึ้น</li></ul>
