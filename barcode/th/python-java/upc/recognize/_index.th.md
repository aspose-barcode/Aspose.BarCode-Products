...
{{% blocks/products/pf/agp/content h2="How to Read บาร์โค้ด UPC (รหัสผลิตภัณฑ์สากล) Using Python via Java" %}}
หากต้องการสแกนและถอดรหัส บาร์โค้ด UPC (รหัสผลิตภัณฑ์สากล) ให้ติดตั้ง [Aspose.BarCode for Python ผ่าน Java](https://products.aspose.com/barcode/python-java/) API ซึ่งเป็น API อเนกประสงค์ ทรงพลัง และใช้งานง่าย ใช้ไลบรารีบาร์โค้ดสำหรับแอปพลิเคชันที่ใช้ Python รับเวอร์ชันล่าสุดโดยตรงจากพอร์ทัล [Aspose releases](https://releases.aspose.com/barcode/python-java/) หรือติดตั้ง 'aspose-barcode' จาก pip โดยเรียกใช้คำสั่งต่อไปนี้:
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสแกน บาร์โค้ด UPC (รหัสผลิตภัณฑ์สากล) ใน Python" %}}
...
<ul><li>สร้างวัตถุของคลาส Aspose.BarCode.BarCodeReader</li><li>กำหนดเส้นทางไฟล์ต้นฉบับที่มี บาร์โค้ด UPC (รหัสผลิตภัณฑ์สากล) เป็นพารามิเตอร์</li><li>กำหนดประเภทบาร์โค้ดที่ต้องการใน DecodeType เป็นพารามิเตอร์ที่สอง</li><li>วนซ้ำผลลัพธ์การถอดรหัส</li><li>รับข้อความบาร์โค้ดโดยใช้คุณสมบัติ CodeText</li></ul>
