...
{{% blocks/products/pf/agp/content h2="How to Generate บาร์โค้ด Code 93 Using Python via Java" %}}
หากต้องการสร้างรูปภาพ บาร์โค้ด Code 93 ให้ดาวน์โหลด [Aspose.BarCode for Python ผ่าน Java](https://products.aspose.com/barcode/python-java/) API ซึ่งมีคุณลักษณะหลากหลาย ทรงพลัง และใช้งานง่าย - ใช้ไลบรารีบาร์โค้ดสำหรับแอปพลิเคชันที่ใช้ Python รับเวอร์ชันล่าสุดโดยตรงจากพอร์ทัล [Aspose releases](https://releases.aspose.com/barcode/python-java/) หรือติดตั้ง 'aspose-barcode' จาก pip ด้วยคำสั่งต่อไปนี้:
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้าง บาร์โค้ด Code 93 ใน Python" %}}
...
<ul><li>สร้างวัตถุใหม่ของคลาส BarCodeGenerator</li><li>กำหนดประเภทบาร์โค้ดที่ต้องการเป็นพารามิเตอร์ EncodeTypes</li><li>แทรกข้อความอินพุตเป็นพารามิเตอร์ที่สอง</li><li> เรียกใช้เมธอด BarCodeGenerator.save เพื่อรับอิมเมจ Code 93 Extended และ Code 93 บาร์โค้ดมาตรฐาน ที่สร้างขึ้น</li></ul>
