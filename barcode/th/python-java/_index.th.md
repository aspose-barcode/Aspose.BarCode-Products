...
<p>Aspose.BarCode สำหรับ Python ผ่าน Java เป็นชุดของการสร้างบาร์โค้ดและการอ่าน API ที่จะรวมเข้ากับแอปพลิเคชัน Python โดยใช้บริดจ์ python-java นักพัฒนาสามารถเพิ่มฟังก์ชันการสร้างและจดจำบาร์โค้ดได้อย่างง่ายดาย API บาร์โค้ดที่ใช้ Python สร้างภาพบาร์โค้ดและบันทึกในรูปแบบต่างๆ เช่น PNG, JPG, GIF, BMP และ TIFF รองรับคุณลักษณะภาพต่างๆ เช่น การปรับแต่งเส้นขอบ โทนสี มุมหมุน ความละเอียด และอื่นๆ อีกมากมาย</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="ความเป็นอิสระของแพลตฟอร์ม" description="Aspose.Barcode สำหรับ Python ผ่าน Java ใช้สะพาน python-java และพร้อมใช้งานสำหรับ Python 3.6 และสูงกว่า" >}}
<div class='diagram1 d1-python'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="รูปแบบไฟล์ที่รองรับ" description="Aspose.BarCode สำหรับ Python via Java ใช้งานได้กับรูปแบบไฟล์รูปภาพที่ใช้บ่อยที่สุด" >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/set-barcode-parameters/'>จัดการพารามิเตอร์บาร์โค้ด</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/manage-barcode-appearance/'>ปรับแต่งขนาดบาร์โค้ด</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/generate-qr-code/'>สร้างรหัส QR</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/barcode-text-settings/'>ปรับแต่งคำบรรยายข้อความ</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/save-generated-barcodes/'>บันทึกบาร์โค้ดในรูปแบบต่างๆ</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/read-barcode-properties/'>อ่านคุณสมบัติของบาร์โค้ด</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/pdf417/" name="PDF417" description="PDF417 บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/qr/" name="QR" description="QR รหัส, GS1 QR รหัส" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/datamatrix/" name="Data Matrix" description="รหัส Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/aztec/" name="Aztec" description="รหัส Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/swiss-qr/" name="Swiss QR" description="Swiss QR ใบเรียกเก็บเงิน" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/dotcode/" name="DotCode" description="บาร์โค้ด DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/hibc/" name="HIBC" description="HIBC (บาร์โค้ดอุตสาหกรรมสุขภาพ)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/codablock/" name="Codablock-F" description="บาร์โค้ด Codablock-F และ GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked และ Truncated) บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/itf/" name="ITF" description="บาร์โค้ดแบบ 2 ใน 5 ของ Interleaved (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/ean/" name="EAN" description="บาร์โค้ด EAN (หมายเลขบทความระหว่างประเทศ)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/upc/" name="UPC" description="บาร์โค้ด UPC (รหัสผลิตภัณฑ์สากล)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/code128/" name="GS1 Code 128" description="บาร์โค้ด GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/code39/" name="Code 39" description="บาร์โค้ด Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/code16k/" name="Code 16K" description="บาร์โค้ด Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/code32/" name="Code 32" description="บาร์โค้ดของอิตาลี Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/code93/" name="Code 93" description="Code 93 Extended และ Code 93 บาร์โค้ดมาตรฐาน" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/onecode/" name="USPS OneCode" description="บาร์โค้ด USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (อุตสาหกรรม 2 จาก 5) บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/isbn/" name="ISBN" description="ISBN บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/ismn/" name="ISMN" description="ISMN บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/issn/" name="ISSN" description="ISSN บาร์โค้ด" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/australia-post/" name="Australia Post" description="บาร์โค้ด Australia Post และ Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode และ Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/rm4scc/" name="RM4SCC" description="รหัสลูกค้า Royal Mail 4 รัฐ (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/postnet/" name="Postnet" description="Postnet บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/royal-mail/" name="Royal Mail" description="บาร์โค้ด Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/singapore-post/" name="Singapore Post" description="บาร์โค้ด Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/python-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="เอกสาร" href="https://docs.aspose.com/barcode/python-java/" >}}
{{< blocks/products/pf/slr-element name="รหัสแหล่งที่มา" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Python-via-Java" >}}
{{< blocks/products/pf/slr-element name="การอ้างอิง API" href="https://reference.aspose.com/barcode/python-java/" >}}
...
{{< blocks/products/pf/slr-element name="บันทึกประจำรุ่น" href="https://docs.aspose.com/barcode/python-java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="ทำไมต้องใช้ Aspose.BarCode สำหรับ Python via Java" tabId="success-stories" >}}
