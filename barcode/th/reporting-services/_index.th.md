---
title: แสดงรูปภาพบาร์โค้ดเชิงเส้นและ 2D ในบริการรายงานของ SQL Server
description: ส่วนขยายการแสดงผลบริการรายงานของ SQL Server - ส่งออกรูปภาพบาร์โค้ดเชิงเส้นและ 2D ใน SSRS แสดงฉลากบาร์โค้ดในรูปแบบ BMP JPEG GIF และ PNG
lang: th/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="SSRS บาร์โค้ด API" h2="สร้างบาร์โค้ดเชิงเส้นและ 2D จากภายใน Microsoft SQL Server Reporting Services" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-reporting-services.svg" pfName="Aspose.BarCode" subTitlepfName="สำหรับ SQL Reporting Services" downloadUrl="https://releases.aspose.com/barcode/reportingservices/" >}}
...
<p>Aspose.BarCode สำหรับบริการรายงานเป็นโซลูชันที่ครอบคลุมสำหรับการแสดงบาร์โค้ดเชิงเส้นและ 2 มิติภายในบริการรายงานของ Microsoft SQL Server ฉลากบาร์โค้ดสามารถเข้ารหัสด้วยอักขระที่ไม่ใช่ภาษาอังกฤษและแสดงผลในรูปแบบ BMP, JPEG, GIF และ PNG</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="ความเป็นอิสระของแพลตฟอร์ม" description="รองรับบริการรายงานของ Microsoft SQL Server" >}}
<div class='diagram1 d1-rs'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="รูปแบบไฟล์ที่รองรับ" description="Aspose.BarCode สำหรับ SQL Reporting Services ใช้งานได้กับรูปแบบไฟล์รูปภาพที่ใช้บ่อยที่สุด" >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                คุณลักษณะขั้นสูงของ .NET Barcode API
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/dynamically-display-barcodes-in-table/'>แสดงบาร์โค้ดแบบไดนามิกในตาราง</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/display-barcodes-from-dataset/'>แสดงบาร์โค้ดจากชุดข้อมูล</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/barcode-types-and-image-formats/'>บันทึกบาร์โค้ดในรูปแบบภาพเวกเตอร์</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    การรวมเข้ากับบริการรายงานของ SQL Server
                </h2>
                <p>
                    Aspose.BarCode สำหรับ Reporting Services สามารถรวมเข้ากับโครงการที่มีอยู่หรือโครงการใหม่ได้อย่างง่ายดาย โดยการเพิ่ม Aspose.BarCode สำหรับ Reporting Services ไปยัง Visual Studio Toolbox เมื่อพร้อมใช้งานในกล่องเครื่องมือแล้ว คุณสามารถลากและวางลงบนโปรเจ็กต์ได้ทุกที่ที่ต้องการ
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    API บาร์โค้ดนี้ช่วยให้นักพัฒนาสร้างบาร์โค้ดคุณภาพสูงโดยการตั้งค่าประเภทบาร์โค้ด ข้อมูลอินพุตที่จะเข้ารหัส และคุณสมบัติที่เกี่ยวข้องกับรูปลักษณ์ที่กำหนดเอง ซึ่งมีตัวเลือกมากมายสำหรับการปรับแต่งลักษณะที่ปรากฏของบาร์โค้ดที่สร้างขึ้น รวมถึงสีพื้นหลังและพื้นหน้า แบบอักษร ขนาด ความละเอียด และคำอธิบายข้อความ
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    ขนาดและสีบาร์โค้ดที่กำหนดเอง
                </h2>
                <p>
                    Aspose.BarCode สำหรับ SQL Reporting Services API มีฟังก์ชันมากมายในการสร้างภาพบาร์โค้ดด้วยพารามิเตอร์ที่กำหนดเอง นักพัฒนาสามารถสร้างแอปพลิเคชันเพื่อสร้างบาร์โค้ดของสีหรือขนาดใดก็ได้ขึ้นอยู่กับความต้องการทางธุรกิจ เป็นไปได้ที่จะปรับแต่งลักษณะที่ปรากฏขององค์ประกอบบาร์โค้ดทั้งหมด รวมถึงสีของแถบ พื้นหลัง เส้นขอบ และคำอธิบายข้อความ ตลอดจนการวางตำแหน่ง สามารถสร้างบาร์โค้ดโดยมีหรือไม่มีการแสดงข้อความป้อน คำบรรยายด้านบนและ/หรือด้านล่าง ช่องว่างภายใน และเส้นขอบ ขนาดบาร์โค้ดสามารถตั้งค่าได้โดยอัตโนมัติขึ้นอยู่กับ X-dimension หรือตั้งค่าด้วยตนเอง สามารถกำหนดเป็นหน่วยต่างๆ เช่น มิลลิเมตร นิ้ว จุด หรือพิกเซล หากจำเป็น สัดส่วนและความละเอียดของภาพสามารถแก้ไขได้ ขนาดของตัวอักษรข้อความสามารถปรับแต่งได้เช่นกัน
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    โปรแกรมออกแบบบาร์โค้ดสำหรับ Visual Studio
                </h2>
                <p>
                    เค้าโครงของฉลากบาร์โค้ดสามารถเปลี่ยนแปลงได้โดยใช้ Barcode Designer ที่ผสานรวมอย่างสมบูรณ์สำหรับ Visual Studio นักพัฒนาสามารถดูตัวอย่างและปรับภาพบาร์โค้ดในขณะออกแบบได้ ผู้ออกแบบยังอนุญาตให้ปรับแต่งการตั้งค่าต่างๆ เพื่อปรับรูปลักษณ์ของภาพบาร์โค้ด
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/pdf417/" name="PDF417" description="PDF417 บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/qr/" name="QR" description="QR รหัส, GS1 QR รหัส" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/datamatrix/" name="Data Matrix" description="รหัส Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/aztec/" name="Aztec" description="รหัส Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/swiss-qr/" name="Swiss QR" description="Swiss QR ใบเรียกเก็บเงิน" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/dotcode/" name="DotCode" description="บาร์โค้ด DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/hibc/" name="HIBC" description="HIBC (บาร์โค้ดอุตสาหกรรมสุขภาพ)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/codablock/" name="Codablock-F" description="บาร์โค้ด Codablock-F และ GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked และ Truncated) บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/itf/" name="ITF" description="บาร์โค้ดแบบ 2 ใน 5 ของ Interleaved (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/ean/" name="EAN" description="บาร์โค้ด EAN (หมายเลขบทความระหว่างประเทศ)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/upc/" name="UPC" description="บาร์โค้ด UPC (รหัสผลิตภัณฑ์สากล)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/code128/" name="GS1 Code 128" description="บาร์โค้ด GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/code39/" name="Code 39" description="บาร์โค้ด Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/code16k/" name="Code 16K" description="บาร์โค้ด Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/code32/" name="Code 32" description="บาร์โค้ดของอิตาลี Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/code93/" name="Code 93" description="Code 93 Extended และ Code 93 บาร์โค้ดมาตรฐาน" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/onecode/" name="USPS OneCode" description="บาร์โค้ด USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (อุตสาหกรรม 2 จาก 5) บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/isbn/" name="ISBN" description="ISBN บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/ismn/" name="ISMN" description="ISMN บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/issn/" name="ISSN" description="ISSN บาร์โค้ด" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/australia-post/" name="Australia Post" description="บาร์โค้ด Australia Post และ Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode และ Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/rm4scc/" name="RM4SCC" description="รหัสลูกค้า Royal Mail 4 รัฐ (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/postnet/" name="Postnet" description="Postnet บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/royal-mail/" name="Royal Mail" description="บาร์โค้ด Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/singapore-post/" name="Singapore Post" description="บาร์โค้ด Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/reporting-services/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="การอ้างอิง API" href="https://reference.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/slr-element name="บันทึกประจำรุ่น" href="https://docs.aspose.com/barcode/reportingservices/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="ทำไมต้องใช้ Aspose.BarCode สำหรับ SQL Reporting Services" tabId="success-stories" >}}
