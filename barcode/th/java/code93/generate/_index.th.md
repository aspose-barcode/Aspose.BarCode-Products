...
<ul><li>สร้างวัตถุใหม่ของคลาส BarCodeGenerator</li><li>กำหนด บาร์โค้ด Code 93 และประเภทบาร์โค้ดที่จำเป็นอื่นๆ เป็นพารามิเตอร์ EncodeTypes</li><li>ระบุข้อความป้อนเข้าโดยใช้เมธอด setCodeText</li><li>ใช้วิธี BarCodeGenerator.save เพื่อบันทึกภาพบาร์โค้ดที่สร้างขึ้น</li></ul>
