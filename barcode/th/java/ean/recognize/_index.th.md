---
title: สแกนรูปภาพ บาร์โค้ด EAN (หมายเลขบทความระหว่างประเทศ) ผ่าน Java
weight: 1510
description: ซอร์สโค้ด Java เพื่ออ่านและถอดรหัส บาร์โค้ด EAN (หมายเลขบทความระหว่างประเทศ) ใน Java Runtime Environment สำหรับ JSP/JSF Application และ Desktop Applications
lang: th
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /th/java/ean/recognize/
aliases:
- /th/java/recognize/ean/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="อ่านบาร์โค้ด EAN ด้วย Java" h2="อ่าน บาร์โค้ด EAN (หมายเลขบทความระหว่างประเทศ) ใน Java โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read บาร์โค้ด EAN (หมายเลขบทความระหว่างประเทศ) Using Java" %}}
ในการจดจำ บาร์โค้ด EAN (หมายเลขบทความระหว่างประเทศ) ให้ใช้ [Aspose.BarCode for Java](https://products.aspose.com/barcode/java/) API ไลบรารีบาร์โค้ดขั้นสูง แข็งแกร่ง และใช้งานง่ายสำหรับ Java- แพลตฟอร์มที่ใช้ ดาวน์โหลดเวอร์ชันล่าสุดโดยตรงจาก [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-barcode) และติดตั้งภายใน Maven-based โครงการโดยรวมการกำหนดค่าต่อไปนี้ใน pom.xml:
...
<ul><li>สร้างวัตถุใหม่ของคลาส BarCodeReader</li><li>ตั้งค่าเส้นทางไฟล์ต้นฉบับที่มี บาร์โค้ด EAN (หมายเลขบทความระหว่างประเทศ)</li><li>ส่งประเภทบาร์โค้ดที่จำเป็นไปยัง DecodeType เป็นพารามิเตอร์ที่สอง</li><li>วนซ้ำผลการถอดรหัส</li><li>รับข้อความบาร์โค้ดโดยใช้เมธอด getCodeText</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/pdf417/recognize/" name="PDF417" description="PDF417 บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/qr/recognize/" name="QR" description="QR รหัส, GS1 QR รหัส" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/datamatrix/recognize/" name="Data Matrix" description="รหัส Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/aztec/recognize/" name="Aztec" description="รหัส Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR ใบเรียกเก็บเงิน" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/dotcode/recognize/" name="DotCode" description="บาร์โค้ด DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/hibc/recognize/" name="HIBC" description="HIBC (บาร์โค้ดอุตสาหกรรมสุขภาพ)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/codablock/recognize/" name="Codablock-F" description="บาร์โค้ด Codablock-F และ GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked และ Truncated) บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/itf/recognize/" name="ITF" description="บาร์โค้ดแบบ 2 ใน 5 ของ Interleaved (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/ean/recognize/" name="EAN" description="บาร์โค้ด EAN (หมายเลขบทความระหว่างประเทศ)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/upc/recognize/" name="UPC" description="บาร์โค้ด UPC (รหัสผลิตภัณฑ์สากล)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/code128/recognize/" name="GS1 Code 128" description="บาร์โค้ด GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/code39/recognize/" name="Code 39" description="บาร์โค้ด Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/code16k/recognize/" name="Code 16K" description="บาร์โค้ด Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/code32/recognize/" name="Code 32" description="บาร์โค้ดของอิตาลี Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/code93/recognize/" name="Code 93" description="Code 93 Extended และ Code 93 บาร์โค้ดมาตรฐาน" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/onecode/recognize/" name="USPS OneCode" description="บาร์โค้ด USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (อุตสาหกรรม 2 จาก 5) บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/isbn/recognize/" name="ISBN" description="ISBN บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/ismn/recognize/" name="ISMN" description="ISMN บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/issn/recognize/" name="ISSN" description="ISSN บาร์โค้ด" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/australia-post/recognize/" name="Australia Post" description="บาร์โค้ด Australia Post และ Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode และ Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/rm4scc/recognize/" name="RM4SCC" description="รหัสลูกค้า Royal Mail 4 รัฐ (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/postnet/recognize/" name="Postnet" description="Postnet บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/royal-mail/recognize/" name="Royal Mail" description="บาร์โค้ด Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/singapore-post/recognize/" name="Singapore Post" description="บาร์โค้ด Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
