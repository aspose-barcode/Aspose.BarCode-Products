---
title: สแกนรูปภาพ Postnet บาร์โค้ด ผ่าน Java
weight: 1510
description: ซอร์สโค้ด Java เพื่ออ่านและถอดรหัส Postnet บาร์โค้ด ใน Java Runtime Environment สำหรับ JSP/JSF Application และ Desktop Applications
lang: th/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /th/java/postnet/recognize/
aliases:
- /th/java/recognize/postnet/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="อ่านบาร์โค้ด Postnet ด้วย Java" h2="อ่าน Postnet บาร์โค้ด ใน Java โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Postnet" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>สร้างวัตถุใหม่ของคลาส BarCodeReader</li><li>ตั้งค่าเส้นทางไฟล์ต้นฉบับที่มี Postnet บาร์โค้ด</li><li>ส่งประเภทบาร์โค้ดที่จำเป็นไปยัง DecodeType เป็นพารามิเตอร์ที่สอง</li><li>วนซ้ำผลการถอดรหัส</li><li>รับข้อความบาร์โค้ดโดยใช้เมธอด getCodeText</li></ul>
