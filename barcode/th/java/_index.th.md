...
{{< blocks/products/pf/upper-banner h1="Java Barcode Generation & Recognition API" h2="สร้างและจดจำบาร์โค้ดแบบเชิงเส้น แบบ 2 มิติ และแบบไปรษณีย์ภายในแอปพลิเคชัน Java ใดๆ" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" pfName="Aspose.BarCode" subTitlepfName="สำหรับ Java" downloadUrl="https://releases.aspose.com/barcode/java/" >}}
...
<p>Aspose.BarCode สำหรับ Java เป็น API ที่มีประสิทธิภาพและเชื่อถือได้ ซึ่งให้คุณลักษณะการสร้างบาร์โค้ดและการจดจำสำหรับแอปพลิเคชัน Java รองรับมาตรฐานและข้อกำหนดที่กำหนดไว้มากที่สุด และช่วยให้นักพัฒนาสามารถอ่านบาร์โค้ด 1D และ 2D จากไฟล์รูปภาพต่างๆ ได้ทุกมุม Aspose.BarCode สำหรับ Java แสดงภาพบาร์โค้ดในรูปแบบภาพที่หลากหลายพร้อมตัวเลือกภาพที่ยืดหยุ่นสูง ไลบรารีรองรับการเข้ารหัสและถอดรหัสบาร์โค้ดมากกว่า 60 ประเภท และเปิดใช้งานการพิมพ์ภาพบาร์โค้ดโดยตรง</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="ได้อย่างรวดเร็ว" description="ภาพรวมของการจดจำบาร์โค้ดและความสามารถในการสร้างของ API" >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>เชิงเส้น 2 มิติ และไปรษณีย์</li><li>ตรวจหาจากสตรีมหรือรูปภาพ</li><li>รับทิศทางของบาร์โค้ด</li><li>ถอดรหัสอักขระที่ไม่ใช่ภาษาอังกฤษ</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                การพิมพ์
            </header>
            <ul><li>พิมพ์บาร์โค้ดโดยตรง</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>เชิงเส้น 2 มิติ & ไปรษณีย์</li><li>บันทึกไปยังสตรีมหรือรูปภาพ</li><li>ปรับแต่งรูปลักษณ์&colon; ขนาด สี มุมมอง</li><li>เข้ารหัสอักขระที่ไม่ใช่ภาษาอังกฤษ </li></ul>
            <header>
                <i class="fa fa-qrcode">
                </i>
                ประเภท
            </header>
            <ul><li>เชิงเส้น</li><li>2D</li><li>ไปรษณีย์</li></ul>
        </div>
        <!--/right-->
    </div>
    <!--/row-->
...
{{< blocks/products/pf/carousel-item h3="ความเป็นอิสระของแพลตฟอร์ม" description="คุณสามารถใช้ไลบรารีบาร์โค้ดเพื่อสร้างแอปพลิเคชัน Java ประเภทใดก็ได้ที่ติดตั้ง JRE 1.6 หรือสูงกว่า" >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="รูปแบบไฟล์ที่รองรับ" description="Aspose.BarCode สำหรับ Java ใช้งานได้กับรูปแบบไฟล์รูปภาพที่ใช้บ่อยที่สุด" >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                คุณสมบัติ Java Library ขั้นสูง
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/control-the-appearance-of-code-text/'>ปรับและแก้ไขคุณสมบัติเกี่ยวกับลักษณะที่ปรากฏของข้อความโค้ด</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-the-barcode-caption/'>จัดการคำบรรยายและรูปแบบตัวอักษร</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/use-checksum-and-supplement-data-for-barcodes/'>รองรับ Checksum & ข้อมูลเสริม</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#image-formats'>สร้างภาพบาร์โค้ดเป็นรูปแบบภาพต่างๆ</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/advanced-barcode-recognition-features/'>อ่านประเภท 1D และ 2D ได้ทุกมุม</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/barcode-regions/'>สแกนบาร์โค้ดโดยระบุพื้นที่</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/generate-barcode-by-specifying-custom-image-size/'>ปรับแต่งขนาดภาพ</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-x-dimension-and-y-dimension/'>รองรับมิติ X และ Y สำหรับประเภท 2 มิติ</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#barcode-types'>รองรับสัญลักษณ์เชิงเส้น 2D และไปรษณีย์</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    ปรับแต่งประเภทบาร์โค้ดและรูปลักษณ์
                </h2>
                <p>
                    API บาร์โค้ดสำหรับ Java ช่วยให้นักพัฒนาปรับแต่งลักษณะที่ปรากฏของบาร์โค้ดที่สร้างขึ้นได้อย่างละเอียด โดยระบุประเภทบาร์โค้ด ข้อความป้อน ลักษณะแบบอักษร สีพื้นหลังและพื้นหน้า การจัดตำแหน่งและคำอธิบายภาพ และคุณสมบัติอื่นๆ คุณสามารถแก้ไขคำอธิบายภาพได้โดยการตั้งค่าการเปิดเผยสำหรับคำอธิบายภาพด้านบนและด้านล่าง แบบอักษร สี และการจัดตำแหน่ง
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    API บาร์โค้ดช่วยให้นักพัฒนาสร้างภาพบาร์โค้ดคุณภาพสูงในแอปพลิเคชันได้อย่างง่ายดาย รองรับบาร์โค้ดหลายประเภท รวมถึงบาร์โค้ดที่ใช้กันอย่างแพร่หลาย เช่น QR Code และ Code 128 ตลอดจนประเภทพิเศษอื่นๆ เช่น Aztec Code และ Data Matrix API ช่วยให้นักพัฒนาปรับแต่งลักษณะที่ปรากฏของบาร์โค้ดที่สร้างขึ้น รวมถึงสีพื้นหน้าและพื้นหลัง แบบอักษร และการจัดตำแหน่งคำบรรยาย เมื่อใช้ API นักพัฒนาสามารถสร้างบาร์โค้ด 2 มิติได้อย่างง่ายดายในลักษณะเดียวกับที่พวกเขาสร้างบาร์โค้ดหนึ่งมิติ
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    ใส่บาร์โค้ดลงในเอกสาร PDF
                </h2>
                <p>
                    ไลบรารีบาร์โค้ดช่วยให้นักพัฒนาไม่เพียงสร้างบาร์โค้ดแบบกำหนดเองเท่านั้น แต่ยังเพิ่มรูปภาพที่สร้างลงในเอกสาร PDF ได้โดยตรงอีกด้วย ขั้นแรก คุณสามารถสร้างภาพบาร์โค้ดโดยใช้หนึ่งในรูปแบบแรสเตอร์ที่รองรับ แล้วจึงแทรกลงในไฟล์ PDF API ช่วยให้สามารถเพิ่มบาร์โค้ดได้โดยไม่มีการบีบอัดภาพและคุณภาพลดลง นอกจากนี้ยังมีฟังก์ชันในการปรับเปลี่ยนพารามิเตอร์บาร์โค้ดและรูปลักษณ์ก่อนการแทรกหรือเพิ่มรูปภาพที่สร้างขึ้นลงในหน้าเอกสารหลายหน้าพร้อมกัน สามารถใช้ Aspose.BarCode API สำหรับการพิมพ์ภาพบาร์โค้ดคุณภาพสูงได้ ภาพแรสเตอร์มีความละเอียดมาตรฐาน 96 dpi ซึ่งไม่เพียงพอสำหรับจุดประสงค์นี้ API อนุญาตให้ตั้งค่าความละเอียดของภาพบาร์โค้ดที่ 300 หรือ 600 dpi เพื่อพิมพ์เอกสาร PDF คุณภาพสูง
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
                ...
                <p>
                    ไลบรารีบาร์โค้ด Java เป็นเครื่องมือที่มีประสิทธิภาพสำหรับการทำงานกับบาร์โค้ดในแอปพลิเคชัน Java คุณสมบัติหลักประการหนึ่งคือความสามารถในการอ่านบาร์โค้ดจากไฟล์รูปภาพรูปแบบต่างๆ คลาส BarCodeReader ซึ่งเป็นคลาสหลักที่รับผิดชอบการจดจำบาร์โค้ด รองรับรูปแบบรูปภาพยอดนิยมมากมาย รวมถึง BMP, PNG, TIFF, JPEG และ GIF ทำให้ง่ายต่อการรวมฟังก์ชันการจดจำบาร์โค้ดเข้ากับแอปพลิเคชันที่หลากหลาย
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
    ...
    <div class="barcode-read-lcs-controls">
        ...
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">ทุกประเภท</option>
                <option value="Pdf417 ">PDF417</option>
                <option value="QR ">QR</option>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    สแกนบาร์โค้ดจากเอกสาร PDF
                </h2>
                <p>
                    นอกจากการอ่านบาร์โค้ดจากไฟล์รูปภาพแล้ว ไลบรารีบาร์โค้ดยังสามารถใช้เพื่อสแกนบาร์โค้ดจากไฟล์ PDF นักพัฒนาสามารถใช้การตรวจจับบาร์โค้ดอย่างรวดเร็วในเอกสาร PDF ที่มีหลายหน้า API มีหลายวิธีในการดำเนินการ วิธีที่แนะนำคือแปลงหน้าเอกสารเป็นภาพแรสเตอร์ แล้วใช้กลไกการอ่านบาร์โค้ด ในการแสดงเนื้อหาของหน้าเป็นภาพแรสเตอร์เป็นวิธีที่ง่ายที่สุดและมีประสิทธิภาพมากที่สุด มิฉะนั้น ภาพบาร์โค้ดจะถูกตรวจจับและแยกออกจากเอกสาร PDF ต้นทางก่อน วิธีนี้ช่วยอำนวยความสะดวกในการอ่านบาร์โค้ดด้วยความละเอียดดั้งเดิม Aspose.BarCode API อนุญาตให้ประมวลผลไฟล์ PDF หลายหน้าเพื่อตรวจหาและจดจำบาร์โค้ดทั้งหมดที่แสดงในเอกสาร
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/pdf417/" name="PDF417" description="PDF417 บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/qr/" name="QR" description="QR รหัส, GS1 QR รหัส" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/datamatrix/" name="Data Matrix" description="รหัส Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/aztec/" name="Aztec" description="รหัส Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/swiss-qr/" name="Swiss QR" description="Swiss QR ใบเรียกเก็บเงิน" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/dotcode/" name="DotCode" description="บาร์โค้ด DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/hibc/" name="HIBC" description="HIBC (บาร์โค้ดอุตสาหกรรมสุขภาพ)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/codablock/" name="Codablock-F" description="บาร์โค้ด Codablock-F และ GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked และ Truncated) บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/itf/" name="ITF" description="บาร์โค้ดแบบ 2 ใน 5 ของ Interleaved (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/ean/" name="EAN" description="บาร์โค้ด EAN (หมายเลขบทความระหว่างประเทศ)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/upc/" name="UPC" description="บาร์โค้ด UPC (รหัสผลิตภัณฑ์สากล)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/code128/" name="GS1 Code 128" description="บาร์โค้ด GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/code39/" name="Code 39" description="บาร์โค้ด Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/code16k/" name="Code 16K" description="บาร์โค้ด Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/code32/" name="Code 32" description="บาร์โค้ดของอิตาลี Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/code93/" name="Code 93" description="Code 93 Extended และ Code 93 บาร์โค้ดมาตรฐาน" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/onecode/" name="USPS OneCode" description="บาร์โค้ด USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (อุตสาหกรรม 2 จาก 5) บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/isbn/" name="ISBN" description="ISBN บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/ismn/" name="ISMN" description="ISMN บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/issn/" name="ISSN" description="ISSN บาร์โค้ด" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/australia-post/" name="Australia Post" description="บาร์โค้ด Australia Post และ Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode และ Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/rm4scc/" name="RM4SCC" description="รหัสลูกค้า Royal Mail 4 รัฐ (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/postnet/" name="Postnet" description="Postnet บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/royal-mail/" name="Royal Mail" description="บาร์โค้ด Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/singapore-post/" name="Singapore Post" description="บาร์โค้ด Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="สิ่งที่ผู้คนกำลังพูด" subTitle="อย่าเพิ่งเชื่อคำพูดของเรา ดูความคิดเห็นของผู้ใช้เกี่ยวกับ API" caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 ฉันใช้เวลาหลายปีในการพัฒนาและปรับปรุงผลิตภัณฑ์ของฉัน และ Aspose ทำให้ฉันสามารถสร้างผลิตภัณฑ์ที่เป็นมิตรและมีประโยชน์มากขึ้น และด้วยเหตุนี้จึงเป็นที่ต้องการของตลาดมากขึ้น <em>คีล ดิลเลอร์ | KD Solutions ประเทศโปแลนด์</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode เขียนด้วยโค้ดที่มีการจัดการอย่างแท้จริง และทำให้เรามีบาร์โค้ดประเภทต่างๆ เพื่อจัดการกับการจดจำเอกสารทุกประเภทและการประมวลผลเพิ่มเติม <em>เดนนิส อเล็กซานเดอร์ เปตราสค์ | Keil IT เยอรมนี</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="เอกสาร" href="https://docs.aspose.com/barcode/java/" >}}
{{< blocks/products/pf/slr-element name="รหัสแหล่งที่มา" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="การอ้างอิง API" href="https://reference.aspose.com/barcode/java/" >}}
...
{{< blocks/products/pf/slr-element name="บันทึกประจำรุ่น" href="https://docs.aspose.com/barcode/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="ทำไมต้องใช้ Aspose.BarCode สำหรับ Java" tabId="success-stories" >}}
{{< blocks/products/pf/slr-element name="รายชื่อลูกค้า" href="https://about.aspose.com/customers" >}}
{{< blocks/products/pf/slr-element name="เรื่องราวความสำเร็จ" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Aspose.BarCode นำเสนอการสร้างบาร์โค้ดและ API การจดจำสำหรับสภาพแวดล้อมการพัฒนายอดนิยมอื่น ๆ ตามรายการด้านล่าง:" >}}
