---
title: สแกนรูปภาพ Standard 2 of 5 (อุตสาหกรรม 2 จาก 5) บาร์โค้ด ผ่าน PHP via Java
weight: 1510
description: โค้ดตัวอย่าง PHP เพื่ออ่าน Standard 2 of 5 (อุตสาหกรรม 2 จาก 5) บาร์โค้ด ในแอปพลิเคชันที่ใช้ PHP
lang: th/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /th/php-java/standard2of5/recognize/
aliases:
- /th/php-java/recognize/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="อ่านบาร์โค้ด Standard 2 of 5 ด้วย PHP via Java" h2="อ่าน Standard 2 of 5 (อุตสาหกรรม 2 จาก 5) บาร์โค้ด ใน PHP โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสแกน บาร์โค้ด Standard 2 of 5 ใน PHP" %}}
...
<ul><li>สร้างวัตถุของคลาส Aspose.BarCode.BarCodeReader</li><li>ตั้งค่าเส้นทางรูปภาพต้นฉบับที่มี บาร์โค้ด Standard 2 of 5 เป็นพารามิเตอร์</li><li>ระบุประเภทบาร์โค้ดเป้าหมายใน DecodeType เป็นพารามิเตอร์ที่สอง</li><li>วนซ้ำผลการอ่าน</li><li>รับข้อความบาร์โค้ดโดยใช้คุณสมบัติ CodeText</li></ul>
