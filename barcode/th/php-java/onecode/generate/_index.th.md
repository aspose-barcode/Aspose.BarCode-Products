...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้าง บาร์โค้ด USPS OneCode ใน PHP" %}}
...
<ul><li>สร้างตัวอย่างใหม่ของคลาส BarCodeGenerator</li><li>ระบุ บาร์โค้ด USPS OneCode และประเภทบาร์โค้ดที่เกี่ยวข้องอื่นๆ เป็นพารามิเตอร์ EncodeTypes</li><li>ตั้งค่าข้อความบาร์โค้ดเป็นพารามิเตอร์ที่สอง</li><li>ระบุขนาดและตำแหน่งรูปภาพหากจำเป็น</li><li>เรียกใช้เมธอด BarCodeGenerator.save เพื่อรับรูปภาพ บาร์โค้ด USPS OneCode ในรูปแบบที่ต้องการ</li></ul>
