...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสแกน บาร์โค้ด GS1 Code 128 ใน PHP" %}}
...
<ul><li>สร้างวัตถุของคลาส Aspose.BarCode.BarCodeReader</li><li>ตั้งค่าเส้นทางรูปภาพต้นฉบับที่มี บาร์โค้ด GS1 Code 128 เป็นพารามิเตอร์</li><li>ระบุประเภทบาร์โค้ดเป้าหมายใน DecodeType เป็นพารามิเตอร์ที่สอง</li><li>วนซ้ำผลการอ่าน</li><li>รับข้อความบาร์โค้ดโดยใช้คุณสมบัติ CodeText</li></ul>
