...
description: Aspose.BarCode สำหรับ .NET API เพื่อสร้างและจดจำบาร์โค้ด 1D 2D ผสานรวมภายในแอปพลิเคชัน C# VB.NET ASP.NET เพื่อสแกนและพิมพ์ฉลากบาร์โค้ด
lang: th
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="เครื่องสร้างบาร์โค้ดและเครื่องอ่าน API" h2="สร้างและจดจำบาร์โค้ดแบบเชิงเส้น แบบ 2 มิติ และแบบไปรษณีย์ภายในแอปพลิเคชัน .NET ใดๆ" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" pfName="Aspose.BarCode" subTitlepfName="สำหรับ .NET" downloadUrl="https://releases.aspose.com/barcode/net/" >}}
...
<p>Aspose.BarCode สำหรับ .NET เป็นไลบรารีการพัฒนาที่มีประสิทธิภาพในการสร้างและจดจำบาร์โค้ด 1D และ 2D จากรูปภาพประเภทต่างๆ ในทุกมุม นักพัฒนาสามารถเพิ่มฟังก์ชันการสร้างบาร์โค้ดและการสแกนลงในแอปพลิเคชัน .NET ได้อย่างง่ายดาย API นี้ช่วยให้สามารถส่งออกบาร์โค้ดที่สร้างขึ้นไปยังรูปแบบรูปภาพคุณภาพสูงต่างๆ ได้</p><p>Aspose.BarCode สำหรับ .NET ช่วยให้สามารถปรับเปลี่ยนลักษณะที่ปรากฏของบาร์โค้ดที่สร้างขึ้นและพารามิเตอร์ เช่น สีพื้นหลัง สีของแถบ มุมการหมุน x -มิติ คุณภาพของภาพ ความละเอียด คำอธิบายภาพ ขนาด และอื่นๆ อีกมากมาย นอกจากนี้ยังมีฟังก์ชันตรวจจับและอ่านบาร์โค้ดที่หลากหลายและรองรับบาร์โค้ดมากกว่า 60 ประเภท</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="ความเป็นอิสระของแพลตฟอร์ม" description="คุณสามารถใช้ไลบรารีเพื่อสร้างแอปพลิเคชัน .NET แบบ 32 บิตหรือ 64 บิตประเภทใดก็ได้ รวมถึง ASP.NET, WinForms, WPF, .NET Standard และอื่นๆ" >}}
<div class='diagram1 d1-net'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="รูปแบบไฟล์ที่รองรับ" description="Aspose.BarCode สำหรับ .NET ใช้งานได้กับรูปแบบไฟล์รูปภาพที่ใช้บ่อยที่สุด" >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/saving-barcode-image/'>บันทึกฉลากบาร์โค้ดในรูปแบบต่างๆ</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/read-barcodes-with-aspose-barcode-apis/#setting-barcode-recognition-source'>รับรู้จากสตรีมหรือไฟล์</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/qr-and-micro-qr-barcode/#eciencoding-mode'>เข้ารหัสและถอดรหัสอักขระ (ไม่ใช่ภาษาอังกฤษ) ในประเภท 2 มิติ</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/image-formatting-and-display-settings/'>หมุนภาพบาร์โค้ดได้ทุกมุม</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/how-to-read-barcode-from-multi-page-tiff-images/'>สแกนบาร์โค้ดจาก TIFF หลายหน้า</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/barcode-types-and-image-formats/'>รองรับสัญลักษณ์เชิงเส้น 2D และไปรษณีย์</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    API บาร์โค้ดสำหรับ .NET ช่วยให้นักพัฒนาปรับแต่งลักษณะที่ปรากฏของบาร์โค้ดที่สร้างขึ้นได้อย่างละเอียด โดยระบุประเภทบาร์โค้ด ข้อความป้อน ลักษณะแบบอักษร สีพื้นหลังและพื้นหน้า การจัดตำแหน่งและคำอธิบายภาพ และคุณสมบัติอื่นๆ คุณสามารถแก้ไขคำอธิบายภาพได้โดยการตั้งค่าการเปิดเผยสำหรับคำอธิบายภาพด้านบนและด้านล่าง แบบอักษร สี และการจัดตำแหน่ง
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    API ตัวสร้างบาร์โค้ดช่วยให้นักพัฒนาสร้างบาร์โค้ดโดยระบุประเภทบาร์โค้ดที่ต้องการ ตั้งค่าข้อความอินพุต (ข้อมูลที่จะเข้ารหัสในรูปภาพบาร์โค้ด) และปรับแต่งคุณสมบัติที่เกี่ยวข้องกับรูปลักษณ์ เช่น พื้นหลังและสีพื้นหน้า แบบอักษร ตำแหน่งข้อความ (ซ่อน ด้านบนหรือด้านล่าง) และการจัดตำแหน่ง บาร์โค้ดสองมิติ เช่น QR Code, PDF417, Data Matrix, Aztec Code เป็นต้น ในลักษณะเดียวกับบาร์โค้ดหนึ่งมิติ
                </p>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/pdf417/" name="PDF417" description="PDF417 บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/qr/" name="QR" description="QR รหัส, GS1 QR รหัส" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/datamatrix/" name="Data Matrix" description="รหัส Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/aztec/" name="Aztec" description="รหัส Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/swiss-qr/" name="Swiss QR" description="Swiss QR ใบเรียกเก็บเงิน" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/dotcode/" name="DotCode" description="บาร์โค้ด DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/hibc/" name="HIBC" description="HIBC (บาร์โค้ดอุตสาหกรรมสุขภาพ)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/codablock/" name="Codablock-F" description="บาร์โค้ด Codablock-F และ GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked และ Truncated) บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/itf/" name="ITF" description="บาร์โค้ดแบบ 2 ใน 5 ของ Interleaved (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/ean/" name="EAN" description="บาร์โค้ด EAN (หมายเลขบทความระหว่างประเทศ)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/upc/" name="UPC" description="บาร์โค้ด UPC (รหัสผลิตภัณฑ์สากล)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/code128/" name="GS1 Code 128" description="บาร์โค้ด GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/code39/" name="Code 39" description="บาร์โค้ด Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/code16k/" name="Code 16K" description="บาร์โค้ด Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/code32/" name="Code 32" description="บาร์โค้ดของอิตาลี Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/code93/" name="Code 93" description="Code 93 Extended และ Code 93 บาร์โค้ดมาตรฐาน" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/onecode/" name="USPS OneCode" description="บาร์โค้ด USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (อุตสาหกรรม 2 จาก 5) บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/isbn/" name="ISBN" description="ISBN บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/ismn/" name="ISMN" description="ISMN บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/issn/" name="ISSN" description="ISSN บาร์โค้ด" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/australia-post/" name="Australia Post" description="บาร์โค้ด Australia Post และ Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode และ Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/rm4scc/" name="RM4SCC" description="รหัสลูกค้า Royal Mail 4 รัฐ (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/postnet/" name="Postnet" description="Postnet บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/royal-mail/" name="Royal Mail" description="บาร์โค้ด Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/singapore-post/" name="Singapore Post" description="บาร์โค้ด Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="บันทึกประจำรุ่น" href="https://docs.aspose.com/barcode/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="ทำไมต้องใช้ Aspose.BarCode สำหรับ .NET" tabId="success-stories" >}}
