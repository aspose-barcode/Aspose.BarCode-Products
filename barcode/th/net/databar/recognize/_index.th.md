---
title: สแกนรูปภาพ GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked และ Truncated) บาร์โค้ด ผ่าน .NET
weight: 1510
description: โค้ดตัวอย่าง C# เพื่อสแกนและถอดรหัสประเภทบาร์โค้ด GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked และ Truncated) บาร์โค้ด ใน .NET Framework, .NET Standard, COM Interloop สำหรับ PHP, VBScript, Delphi หรือ C++
lang: th/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /th/net/databar/recognize/
aliases:
- /th/net/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="อ่านบาร์โค้ด GS1 DataBar ด้วย .NET" h2="อ่าน GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked และ Truncated) บาร์โค้ด ใน C# โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read บาร์โค้ด GS1 DataBar Using .NET" %}}
หากต้องการถอดรหัส บาร์โค้ด GS1 DataBar ให้ลองใช้ [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API ซึ่งเป็นไลบรารีบาร์โค้ดที่มีคุณลักษณะหลากหลาย ทรงพลัง และใช้งานง่าย สำหรับแพลตฟอร์ม C# ใช้ [NuGet](https://www.nuget.org/packages/aspose.barcode) และค้นหา **Aspose.BarCode** เพื่อติดตั้งแพ็คเกจ หรือรันคำสั่งต่อไปนี้จากคอนโซล Package Manager:
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสแกน บาร์โค้ด GS1 DataBar ใน C#" %}}
...
<ul><li>สร้างอินสแตนซ์ใหม่ของคลาส Aspose.BarCode.BarCodeReader</li><li>ส่งเส้นทางรูปภาพต้นฉบับที่มี บาร์โค้ด GS1 DataBar เป็นพารามิเตอร์</li><li>ส่ง DecodeType ที่เหมาะสมเป็น พารามิเตอร์ที่สอง</li><li>วนซ้ำผลการถอดรหัส</li><li>รับข้อความบาร์โค้ดโดยใช้คุณสมบัติ CodeText</li></ul>
