...
{{% blocks/products/pf/agp/content h2="How to Generate บาร์โค้ด Standard 2 of 5 Using .NET" %}}
หากต้องการสร้าง บาร์โค้ด Standard 2 of 5 ให้ลองใช้ [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API ซึ่งเป็นไลบรารีบาร์โค้ดที่มีฟีเจอร์หลากหลาย ทรงพลัง และใช้งานง่าย สำหรับแพลตฟอร์ม C# เปิดตัวจัดการแพ็กเกจ [NuGet](https://www.nuget.org/packages/aspose.barcode) ค้นหา **Aspose.BarCode** และติดตั้งแพ็กเกจ คุณยังสามารถรันคำสั่งต่อไปนี้จากคอนโซล Package Manager:
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้าง บาร์โค้ด Standard 2 of 5 ใน C#" %}}
...
<ul><li>สร้างอินสแตนซ์ของคลาส BarcodeGenerator</li><li>ส่ง Standard 2 of 5 (อุตสาหกรรม 2 จาก 5) บาร์โค้ด เป็นพารามิเตอร์</li><li>ตั้งค่าข้อความเพื่อเข้ารหัสเป็นพารามิเตอร์ที่สอง</li><li> ระบุขนาดบาร์โค้ดหากจำเป็น</li><li>เรียกใช้เมธอด BarcodeGenerator บันทึกเพื่อรับอิมเมจ Standard 2 of 5 (อุตสาหกรรม 2 จาก 5) บาร์โค้ด </li></ul>
