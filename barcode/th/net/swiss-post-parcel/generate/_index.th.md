...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้าง Swiss Post Parcel ใน C#" %}}
...
<ul><li>สร้างอินสแตนซ์ของคลาส BarcodeGenerator</li><li>ส่ง Swiss Post Parcel เป็นพารามิเตอร์</li><li>ตั้งค่าข้อความเพื่อเข้ารหัสเป็นพารามิเตอร์ที่สอง</li><li> ระบุขนาดบาร์โค้ดหากจำเป็น</li><li>เรียกใช้เมธอด BarcodeGenerator บันทึกเพื่อรับอิมเมจ Swiss Post Parcel </li></ul>
