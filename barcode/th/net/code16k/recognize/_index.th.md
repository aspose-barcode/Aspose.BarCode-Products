...
{{% blocks/products/pf/agp/content h2="How to Read บาร์โค้ด Code 16K Using .NET" %}}
หากต้องการถอดรหัส บาร์โค้ด Code 16K ให้ลองใช้ [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API ซึ่งเป็นไลบรารีบาร์โค้ดที่มีคุณลักษณะหลากหลาย ทรงพลัง และใช้งานง่าย สำหรับแพลตฟอร์ม C# ใช้ [NuGet](https://www.nuget.org/packages/aspose.barcode) และค้นหา **Aspose.BarCode** เพื่อติดตั้งแพ็คเกจ หรือรันคำสั่งต่อไปนี้จากคอนโซล Package Manager:
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสแกน บาร์โค้ด Code 16K ใน C#" %}}
...
<ul><li>สร้างอินสแตนซ์ใหม่ของคลาส Aspose.BarCode.BarCodeReader</li><li>ส่งเส้นทางรูปภาพต้นฉบับที่มี บาร์โค้ด Code 16K เป็นพารามิเตอร์</li><li>ส่ง DecodeType ที่เหมาะสมเป็น พารามิเตอร์ที่สอง</li><li>วนซ้ำผลการถอดรหัส</li><li>รับข้อความบาร์โค้ดโดยใช้คุณสมบัติ CodeText</li></ul>
