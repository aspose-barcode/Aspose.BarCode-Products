---
title: สแกนรูปภาพ Deutsche Post Identcode และ Deutsche Post Leitcode ผ่าน Node.js via Java
weight: 1510
description: ซอร์สโค้ด Node.js สำหรับการสแกนและถอดรหัส Deutsche Post Identcode และ Deutsche Post Leitcode ในแอปพลิเคชัน JavaScript
lang: th/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /th/nodejs-java/deutsche-post/recognize/
aliases:
- /th/nodejs-java/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="อ่านบาร์โค้ด Deutsche Post ด้วย Node.js via Java" h2="อ่าน Deutsche Post Identcode และ Deutsche Post Leitcode ใน JavaScript โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสแกน บาร์โค้ด Deutsche Post ใน JavaScript" %}}
...
<ul><li>สร้างวัตถุของคลาส Aspose.BarCode.BarCodeReader</li><li>ส่งเส้นทางไฟล์ต้นฉบับที่มี บาร์โค้ด Deutsche Post เป็นพารามิเตอร์</li><li>ตั้งค่าประเภทบาร์โค้ดเป้าหมายใน DecodeType เป็นพารามิเตอร์ที่สอง</li><li>วนซ้ำผ่านบาร์โค้ดที่ตรวจพบทั้งหมด</li><li>ดึงข้อความบาร์โค้ดที่ได้โดยใช้คุณสมบัติ CodeText</li></ul>
