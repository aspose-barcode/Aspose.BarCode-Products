...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสแกน Postnet บาร์โค้ด ใน JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode ช่วยให้นักพัฒนาสามารถอ่านบาร์โค้ด Postnet บาร์โค้ด จากสตรีมหรือรูปภาพด้วยโค้ดไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

<ul><li>สร้างวัตถุของคลาส Aspose.BarCode.BarCodeReader</li><li>ส่งเส้นทางไฟล์ต้นฉบับที่มี Postnet บาร์โค้ด เป็นพารามิเตอร์</li><li>ตั้งค่าประเภทบาร์โค้ดเป้าหมายใน DecodeType เป็นพารามิเตอร์ที่สอง</li><li>วนซ้ำผ่านบาร์โค้ดที่ตรวจพบทั้งหมด</li><li>ดึงข้อความบาร์โค้ดที่ได้โดยใช้คุณสมบัติ CodeText</li></ul>
