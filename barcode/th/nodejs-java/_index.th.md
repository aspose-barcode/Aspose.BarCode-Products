---
title: Nodejs Barcode Scanner และ Generator API
description: การสแกนบาร์โค้ด Node.js และการสร้างไลบรารีสำหรับประเภท 1D, 2D และ Postal ผสานรวมกับแอป React Angular ได้อย่างง่ายดายสำหรับ QR Code maxicode Aztec Code128 EAN-128 และอีกมากมาย
lang: th/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Node.js Barcode Generator และ Scanner API" h2="จดจำหรือสร้างบาร์โค้ด 1D, 2D และไปรษณีย์ รวมถึง Code128, Code93, Code39, QR Code จากภาพต่างๆ" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" pfName="Aspose.BarCode" subTitlepfName="สำหรับ Node.js via Java" downloadUrl="https://releases.aspose.com/barcode/nodejs/" >}}
...
<p>Aspose.BarCode สำหรับ Node.js ผ่าน Java เป็นเครื่องกำเนิดบาร์โค้ดและ API ตัวถอดรหัสที่ปรับแต่งได้ง่าย นักพัฒนาสามารถรวมฟังก์ชันการสร้างและการอ่านบาร์โค้ดในแอปพลิเคชันของตนผ่านทางบริดจ์ nodejs-java สามารถใช้อ่านบาร์โค้ด 1D, 2D และไปรษณีย์ทั่วไปจากรูปภาพได้ทุกมุม ไลบรารีบาร์โค้ดนี้ช่วยให้นักพัฒนาสร้างภาพบาร์โค้ดได้มากกว่า 60 ชนิดและบันทึกในรูปแบบต่างๆ เช่น JPG, PNG, GIF, BMP และ TIFF รองรับการปรับแต่งคุณลักษณะภาพต่างๆ เช่น สีและรูปแบบเส้นขอบบาร์โค้ด ระยะขอบ มุมการหมุน ความละเอียด และสีบาร์โค้ด</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="ความเป็นอิสระของแพลตฟอร์ม" description="Aspose.BarCode สำหรับ Node.js ผ่าน Java เป็น JavaScript API ฝั่งเซิร์ฟเวอร์ที่ใช้ Node.js สามารถทำงานบนแพลตฟอร์ม Windows, Unix/Linux และ Mac ที่มี JDK 1.7 ขึ้นไป" >}}
<div class='diagram1 d1-nodejs'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="รูปแบบไฟล์ที่รองรับ" description="Aspose.BarCode สำหรับ Node.js via Java ใช้งานได้กับรูปแบบไฟล์รูปภาพที่ใช้บ่อยที่สุด" >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/nodejsjava/supported-barcode-types-and-formats/#barcode-types'>สร้างและสแกนบาร์โค้ดมากกว่า 60 ประเภท</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/nodejsjava/set-barcode-text/'>ปรับแต่งคำบรรยายบาร์โค้ดและรูปแบบตัวอักษร</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/nodejsjava/barcode-reading-settings/#checksum-verification'>ทำการตรวจสอบ Checksum</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/pdf417/" name="PDF417" description="PDF417 บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/qr/" name="QR" description="QR รหัส, GS1 QR รหัส" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/datamatrix/" name="Data Matrix" description="รหัส Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/aztec/" name="Aztec" description="รหัส Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/swiss-qr/" name="Swiss QR" description="Swiss QR ใบเรียกเก็บเงิน" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/dotcode/" name="DotCode" description="บาร์โค้ด DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/hibc/" name="HIBC" description="HIBC (บาร์โค้ดอุตสาหกรรมสุขภาพ)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/codablock/" name="Codablock-F" description="บาร์โค้ด Codablock-F และ GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked และ Truncated) บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/itf/" name="ITF" description="บาร์โค้ดแบบ 2 ใน 5 ของ Interleaved (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/ean/" name="EAN" description="บาร์โค้ด EAN (หมายเลขบทความระหว่างประเทศ)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/upc/" name="UPC" description="บาร์โค้ด UPC (รหัสผลิตภัณฑ์สากล)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/code128/" name="GS1 Code 128" description="บาร์โค้ด GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/code39/" name="Code 39" description="บาร์โค้ด Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/code16k/" name="Code 16K" description="บาร์โค้ด Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/code32/" name="Code 32" description="บาร์โค้ดของอิตาลี Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/code93/" name="Code 93" description="Code 93 Extended และ Code 93 บาร์โค้ดมาตรฐาน" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/onecode/" name="USPS OneCode" description="บาร์โค้ด USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (อุตสาหกรรม 2 จาก 5) บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/isbn/" name="ISBN" description="ISBN บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/ismn/" name="ISMN" description="ISMN บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/issn/" name="ISSN" description="ISSN บาร์โค้ด" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/australia-post/" name="Australia Post" description="บาร์โค้ด Australia Post และ Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode และ Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/rm4scc/" name="RM4SCC" description="รหัสลูกค้า Royal Mail 4 รัฐ (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/postnet/" name="Postnet" description="Postnet บาร์โค้ด" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/royal-mail/" name="Royal Mail" description="บาร์โค้ด Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/singapore-post/" name="Singapore Post" description="บาร์โค้ด Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/th/nodejs-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="เอกสาร" href="https://docs.aspose.com/barcode/nodejsjava/" >}}
{{< blocks/products/pf/slr-element name="รหัสแหล่งที่มา" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="การอ้างอิง API" href="https://reference.aspose.com/barcode/nodejs/" >}}
...
{{< blocks/products/pf/slr-element name="บันทึกประจำรุ่น" href="https://docs.aspose.com/barcode/nodejsjava/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="ทำไมต้องใช้ Aspose.BarCode สำหรับ Node.js via Java" tabId="success-stories" >}}
