...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้าง รหัส Data Matrix ใน JavaScript" %}}
...
<ul><li>สร้างอินสแตนซ์ของคลาส BarCodeGenerator</li><li>ตั้งค่า รหัส Data Matrix เป็นพารามิเตอร์ EncodeTypes</li><li>กำหนดข้อความที่จะเข้ารหัสเป็นพารามิเตอร์ที่สอง</li><li>กำหนดขนาดและตำแหน่งบาร์โค้ดหากจำเป็น</li><li>เรียกใช้เมธอด BarCodeGenerator.save เพื่อรับภาพบาร์โค้ดที่สร้างขึ้น</li></ul>
