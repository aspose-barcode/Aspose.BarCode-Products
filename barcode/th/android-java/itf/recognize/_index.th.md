...
{{% blocks/products/pf/agp/content h2="How to Read บาร์โค้ดแบบ 2 ใน 5 ของ Interleaved (ITF) Using Android via Java" %}}
ลองใช้ Aspose.BarCode สำหรับ Android ผ่าน Java เพื่อตรวจจับและอ่าน บาร์โค้ดแบบ 2 ใน 5 ของ Interleaved (ITF) ภายในแอปพลิเคชัน Android ได้อย่างง่ายดาย เป็น API บาร์โค้ดที่สมบูรณ์ ปรับขนาดได้ และเป็นมิตรกับผู้ใช้ซึ่งมีไว้สำหรับแอปพลิเคชัน Android รับ Aspose.BarCode สำหรับ Java โดยตรงจากโปรเจ็กต์ที่ใช้ Maven โดยเพิ่มการกำหนดค่าต่อไปนี้ใน build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสแกน บาร์โค้ดแบบ 2 ใน 5 ของ Interleaved (ITF) ใน Java" %}}
...
<ul><li>สร้างอินสแตนซ์ของคลาส BarCodeReader</li><li>กำหนดเส้นทางรูปภาพต้นฉบับที่มี บาร์โค้ดแบบ 2 ใน 5 ของ Interleaved (ITF)</li><li>กำหนดประเภทบาร์โค้ดเป้าหมายใน DecodeType เป็นพารามิเตอร์ที่สอง</li><li>วนซ้ำผลการจดจำ</li><li>โหลดข้อความที่ถอดรหัสโดยเรียกใช้เมธอด getCodeText</li></ul>
