---
title: สแกนรูปภาพ ISMN บาร์โค้ด ผ่าน Android via Java
weight: 1510
description: โค้ดตัวอย่าง Android เพื่อจดจำ ISMN บาร์โค้ด ใน Android Runtime Environment
lang: th
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /th/android-java/ismn/recognize/
aliases:
- /th/android-java/recognize/ismn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="อ่านบาร์โค้ด ISMN ด้วย Android via Java" h2="อ่าน ISMN บาร์โค้ด ใน Java โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสแกน ISMN บาร์โค้ด ใน Java" %}}
...
<ul><li>สร้างอินสแตนซ์ของคลาส BarCodeReader</li><li>กำหนดเส้นทางรูปภาพต้นฉบับที่มี ISMN บาร์โค้ด</li><li>กำหนดประเภทบาร์โค้ดเป้าหมายใน DecodeType เป็นพารามิเตอร์ที่สอง</li><li>วนซ้ำผลการจดจำ</li><li>โหลดข้อความที่ถอดรหัสโดยเรียกใช้เมธอด getCodeText</li></ul>
