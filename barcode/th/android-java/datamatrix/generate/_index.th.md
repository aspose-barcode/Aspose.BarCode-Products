...
{{% blocks/products/pf/agp/content h2="How to Generate รหัส Data Matrix Using Android via Java" %}}
ลองใช้ Aspose.BarCode สำหรับ Android ผ่าน Java เพื่อสร้าง รหัส Data Matrix ภายในแอปพลิเคชัน Android ได้อย่างง่ายดาย เป็นไลบรารีบาร์โค้ดอเนกประสงค์ แข็งแกร่ง และใช้งานง่ายซึ่งออกแบบมาโดยเฉพาะสำหรับแอปพลิเคชัน Android คุณสามารถ Aspose.BarCode สำหรับ Android ผ่าน Java ได้โดยตรงจากโครงการที่ใช้ Maven โดยใส่การกำหนดค่าต่อไปนี้ลงใน build.gradle:
...
<ul><li>สร้างตัวอย่างใหม่ของคลาส BarCodeGenerator</li><li>ส่งประเภทบาร์โค้ด รหัส Data Matrix เป็นพารามิเตอร์ EncodeTypes</li><li>กำหนดข้อความบาร์โค้ดโดยใช้เมธอด setCodeText</li><li>เปิดเมธอด createBarCodeImage() เพื่อบันทึกภาพบาร์โค้ด รหัส Data Matrix </li></ul>
