---
title: สแกนรูปภาพ ISBN บาร์โค้ด ผ่าน Android via Java
weight: 1510
description: โค้ดตัวอย่าง Android เพื่อจดจำ ISBN บาร์โค้ด ใน Android Runtime Environment
lang: th/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /th/android-java/isbn/recognize/
aliases:
- /th/android-java/recognize/isbn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="อ่านบาร์โค้ด ISBN ด้วย Android via Java" h2="อ่าน ISBN บาร์โค้ด ใน Java โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISBN" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสแกน ISBN บาร์โค้ด ใน Java" %}}
...
<ul><li>สร้างอินสแตนซ์ของคลาส BarCodeReader</li><li>กำหนดเส้นทางรูปภาพต้นฉบับที่มี ISBN บาร์โค้ด</li><li>กำหนดประเภทบาร์โค้ดเป้าหมายใน DecodeType เป็นพารามิเตอร์ที่สอง</li><li>วนซ้ำผลการจดจำ</li><li>โหลดข้อความที่ถอดรหัสโดยเรียกใช้เมธอด getCodeText</li></ul>
