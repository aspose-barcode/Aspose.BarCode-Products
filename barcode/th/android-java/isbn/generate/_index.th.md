---
title: สร้าง ISBN บาร์โค้ด รูปภาพผ่าน Android via Java
description: ซอร์สโค้ดของ Android เพื่อสร้าง ISBN บาร์โค้ด ใน Android Runtime Environment
lang: th/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /th/android-java/isbn/generate/
aliases:
- /th/android-java/generate/isbn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="สร้างป้ายกำกับ ISBN ด้วย Android via Java" h2="สร้าง ISBN บาร์โค้ด ใน Java โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISBN" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้าง ISBN บาร์โค้ด ใน Java" %}}
...
<ul><li>สร้างตัวอย่างใหม่ของคลาส BarCodeGenerator</li><li>ส่งประเภทบาร์โค้ด ISBN บาร์โค้ด เป็นพารามิเตอร์ EncodeTypes</li><li>กำหนดข้อความบาร์โค้ดโดยใช้เมธอด setCodeText</li><li>เปิดเมธอด createBarCodeImage() เพื่อบันทึกภาพบาร์โค้ด ISBN บาร์โค้ด </li></ul>
