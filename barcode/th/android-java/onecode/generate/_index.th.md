---
title: สร้าง บาร์โค้ด USPS OneCode รูปภาพผ่าน Android via Java
description: ซอร์สโค้ดของ Android เพื่อสร้าง บาร์โค้ด USPS OneCode ใน Android Runtime Environment
lang: th/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /th/android-java/onecode/generate/
aliases:
- /th/android-java/generate/onecode/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="สร้างป้ายกำกับ USPS OneCode ด้วย Android via Java" h2="สร้าง บาร์โค้ด USPS OneCode ใน Java โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="USPS OneCode" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate บาร์โค้ด USPS OneCode Using Android via Java" %}}
ลองใช้ Aspose.BarCode สำหรับ Android ผ่าน Java เพื่อสร้าง บาร์โค้ด USPS OneCode ภายในแอปพลิเคชัน Android ได้อย่างง่ายดาย เป็นไลบรารีบาร์โค้ดอเนกประสงค์ แข็งแกร่ง และใช้งานง่ายซึ่งออกแบบมาโดยเฉพาะสำหรับแอปพลิเคชัน Android คุณสามารถ Aspose.BarCode สำหรับ Android ผ่าน Java ได้โดยตรงจากโครงการที่ใช้ Maven โดยใส่การกำหนดค่าต่อไปนี้ลงใน build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้าง บาร์โค้ด USPS OneCode ใน Java" %}}
...
<ul><li>สร้างตัวอย่างใหม่ของคลาส BarCodeGenerator</li><li>ส่งประเภทบาร์โค้ด บาร์โค้ด USPS OneCode เป็นพารามิเตอร์ EncodeTypes</li><li>กำหนดข้อความบาร์โค้ดโดยใช้เมธอด setCodeText</li><li>เปิดเมธอด createBarCodeImage() เพื่อบันทึกภาพบาร์โค้ด บาร์โค้ด USPS OneCode </li></ul>
