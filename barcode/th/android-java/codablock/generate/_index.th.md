---
title: สร้าง บาร์โค้ด Codablock-F และ GS1 Codablock-F รูปภาพผ่าน Android via Java
description: ซอร์สโค้ดของ Android เพื่อสร้าง บาร์โค้ด Codablock-F และ GS1 Codablock-F ใน Android Runtime Environment
lang: th
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /th/android-java/codablock/generate/
aliases:
- /th/android-java/generate/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="สร้างป้ายกำกับ Codablock-F ด้วย Android via Java" h2="สร้าง บาร์โค้ด Codablock-F และ GS1 Codablock-F ใน Java โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate บาร์โค้ด Codablock-F Using Android via Java" %}}
ลองใช้ Aspose.BarCode สำหรับ Android ผ่าน Java เพื่อสร้าง บาร์โค้ด Codablock-F ภายในแอปพลิเคชัน Android ได้อย่างง่ายดาย เป็นไลบรารีบาร์โค้ดอเนกประสงค์ แข็งแกร่ง และใช้งานง่ายซึ่งออกแบบมาโดยเฉพาะสำหรับแอปพลิเคชัน Android คุณสามารถ Aspose.BarCode สำหรับ Android ผ่าน Java ได้โดยตรงจากโครงการที่ใช้ Maven โดยใส่การกำหนดค่าต่อไปนี้ลงใน build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้าง บาร์โค้ด Codablock-F ใน Java" %}}
...
<ul><li>สร้างตัวอย่างใหม่ของคลาส BarCodeGenerator</li><li>ส่งประเภทบาร์โค้ด บาร์โค้ด Codablock-F เป็นพารามิเตอร์ EncodeTypes</li><li>กำหนดข้อความบาร์โค้ดโดยใช้เมธอด setCodeText</li><li>เปิดเมธอด createBarCodeImage() เพื่อบันทึกภาพบาร์โค้ด บาร์โค้ด Codablock-F และ GS1 Codablock-F </li></ul>
