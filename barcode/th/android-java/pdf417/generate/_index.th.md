---
title: สร้าง PDF417 บาร์โค้ด รูปภาพผ่าน Android via Java
description: ซอร์สโค้ดของ Android เพื่อสร้าง PDF417 บาร์โค้ด ใน Android Runtime Environment
lang: th
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /th/android-java/pdf417/generate/
aliases:
- /th/android-java/generate/pdf417/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="สร้างป้ายกำกับ PDF417 ด้วย Android via Java" h2="สร้าง PDF417 บาร์โค้ด ใน Java โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF417" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้าง PDF417 บาร์โค้ด ใน Java" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode ช่วยให้นักพัฒนาสร้างภาพ PDF417 บาร์โค้ด ได้ง่ายด้วยโค้ดไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

<ul><li>สร้างตัวอย่างใหม่ของคลาส BarCodeGenerator</li><li>ส่งประเภทบาร์โค้ด PDF417 บาร์โค้ด เป็นพารามิเตอร์ EncodeTypes</li><li>กำหนดข้อความบาร์โค้ดโดยใช้เมธอด setCodeText</li><li>เปิดเมธอด createBarCodeImage() เพื่อบันทึกภาพบาร์โค้ด PDF417 บาร์โค้ด </li></ul>
