---
title: สแกนรูปภาพ บาร์โค้ด Code 39 ผ่าน Android via Java
weight: 1510
description: โค้ดตัวอย่าง Android เพื่อจดจำ บาร์โค้ด Code 39 ใน Android Runtime Environment
lang: th/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /th/android-java/code39/recognize/
aliases:
- /th/android-java/recognize/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="อ่านบาร์โค้ด Code 39 ด้วย Android via Java" h2="อ่าน บาร์โค้ด Code 39 ใน Java โดยใช้ Aspose.BarCode ฝั่งเซิร์ฟเวอร์สำหรับ Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read บาร์โค้ด Code 39 Using Android via Java" %}}
ลองใช้ Aspose.BarCode สำหรับ Android ผ่าน Java เพื่อตรวจจับและอ่าน บาร์โค้ด Code 39 ภายในแอปพลิเคชัน Android ได้อย่างง่ายดาย เป็น API บาร์โค้ดที่สมบูรณ์ ปรับขนาดได้ และเป็นมิตรกับผู้ใช้ซึ่งมีไว้สำหรับแอปพลิเคชัน Android รับ Aspose.BarCode สำหรับ Java โดยตรงจากโปรเจ็กต์ที่ใช้ Maven โดยเพิ่มการกำหนดค่าต่อไปนี้ใน build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสแกน บาร์โค้ด Code 39 ใน Java" %}}
...
<ul><li>สร้างอินสแตนซ์ของคลาส BarCodeReader</li><li>กำหนดเส้นทางรูปภาพต้นฉบับที่มี บาร์โค้ด Code 39</li><li>กำหนดประเภทบาร์โค้ดเป้าหมายใน DecodeType เป็นพารามิเตอร์ที่สอง</li><li>วนซ้ำผลการจดจำ</li><li>โหลดข้อความที่ถอดรหัสโดยเรียกใช้เมธอด getCodeText</li></ul>
