...
{{% blocks/products/pf/agp/content h2="How to Generate Kod kreskowy EAN (międzynarodowy numer artykułu). Using .NET" %}}
Aby utworzyć Kod kreskowy EAN (międzynarodowy numer artykułu)., wypróbuj [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, bogatą w funkcje, wydajną i łatwą w użyciu bibliotekę kodów kreskowych dla platform C#. Otwórz menedżera pakietów [NuGet](https://www.nuget.org/packages/aspose.barcode), wyszukaj **Aspose.BarCode** i zainstaluj pakiet. Możesz także uruchomić następujące polecenie z konsoli Menedżera pakietów:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Kod kreskowy EAN (międzynarodowy numer artykułu). w C#" %}}
...
<ul><li>Utwórz instancję klasy BarcodeGenerator</li><li>Przekaż Kod kreskowy EAN (międzynarodowy numer artykułu). jako parametr</li><li>Ustaw tekst do zakodowania jako drugi parametr</li><li> W razie potrzeby określ wymiary kodu kreskowego</li><li>Wywołaj metodę BarcodeGenerator.Save, aby uzyskać obraz Kod kreskowy EAN (międzynarodowy numer artykułu).</li></ul>
