---
title: Wygeneruj obrazy Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy za pomocą .NET
description: Kod źródłowy C# dla generacji Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy w .NET Framework, .NET Standard, COM Interloop dla PHP, VBScript, Delphi i C++.
lang: pl
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pl/net/standard2of5/generate/
aliases:
- /pl/net/generate/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety Standard 2 of 5 za pomocą .NET" h2="Utwórz Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy w C# przy użyciu Aspose.BarCode po stronie serwera dla .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Standard 2 of 5 kod kreskowy Using .NET" %}}
Aby utworzyć Standard 2 of 5 kod kreskowy, wypróbuj [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, bogatą w funkcje, wydajną i łatwą w użyciu bibliotekę kodów kreskowych dla platform C#. Otwórz menedżera pakietów [NuGet](https://www.nuget.org/packages/aspose.barcode), wyszukaj **Aspose.BarCode** i zainstaluj pakiet. Możesz także uruchomić następujące polecenie z konsoli Menedżera pakietów:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Standard 2 of 5 kod kreskowy w C#" %}}
...
<ul><li>Utwórz instancję klasy BarcodeGenerator</li><li>Przekaż Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy jako parametr</li><li>Ustaw tekst do zakodowania jako drugi parametr</li><li> W razie potrzeby określ wymiary kodu kreskowego</li><li>Wywołaj metodę BarcodeGenerator.Save, aby uzyskać obraz Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy</li></ul>
