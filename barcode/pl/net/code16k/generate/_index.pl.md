---
title: Wygeneruj obrazy Kod kreskowy Code 16K za pomocą .NET
description: Kod źródłowy C# dla generacji Kod kreskowy Code 16K w .NET Framework, .NET Standard, COM Interloop dla PHP, VBScript, Delphi i C++.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/net/code16k/generate/
aliases:
- /pl/net/generate/code16k/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety Code 16K za pomocą .NET" h2="Utwórz Kod kreskowy Code 16K w C# przy użyciu Aspose.BarCode po stronie serwera dla .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Kod kreskowy Code 16K Using .NET" %}}
Aby utworzyć Kod kreskowy Code 16K, wypróbuj [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, bogatą w funkcje, wydajną i łatwą w użyciu bibliotekę kodów kreskowych dla platform C#. Otwórz menedżera pakietów [NuGet](https://www.nuget.org/packages/aspose.barcode), wyszukaj **Aspose.BarCode** i zainstaluj pakiet. Możesz także uruchomić następujące polecenie z konsoli Menedżera pakietów:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Kod kreskowy Code 16K w C#" %}}
...
<ul><li>Utwórz instancję klasy BarcodeGenerator</li><li>Przekaż Kod kreskowy Code 16K jako parametr</li><li>Ustaw tekst do zakodowania jako drugi parametr</li><li> W razie potrzeby określ wymiary kodu kreskowego</li><li>Wywołaj metodę BarcodeGenerator.Save, aby uzyskać obraz Kod kreskowy Code 16K</li></ul>
