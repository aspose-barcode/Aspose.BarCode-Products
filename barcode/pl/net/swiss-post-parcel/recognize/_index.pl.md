---
title: Zeskanuj obrazy Swiss Post Parcel za pomocą .NET
weight: 1510
description: Przykładowy kod C# do skanowania i dekodowania typu kodu kreskowego Swiss Post Parcel w .NET Framework, .NET Standard, COM Interloop dla PHP, VBScript, Delphi lub C++.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/net/swiss-post-parcel/recognize/
aliases:
- /pl/net/recognize/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Czytaj kody kreskowe Swiss Post Parcel za pomocą .NET" h2="Odczyt Swiss Post Parcel w C# przy użyciu Aspose.BarCode po stronie serwera dla .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Aby zdekodować kod Swiss Post Parcel, wypróbuj interfejs API [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/), bogatą w funkcje, wydajną i łatwą w użyciu bibliotekę kodów kreskowych dla platform C#. Użyj [NuGet](https://www.nuget.org/packages/aspose.barcode) i wyszukaj **Aspose.BarCode**, aby zainstalować pakiet. Alternatywnie uruchom następujące polecenie z konsoli Menedżera pakietów:
...
{{% blocks/products/pf/agp/feature-section-col title="Instrukcje skanowania Swiss Post Parcel w C#" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode umożliwia programistom odczytywanie kodów kreskowych Swiss Post Parcel ze strumienia lub obrazu za pomocą kilku wierszy kodu

{{% /blocks/products/pf/agp/text %}}

<ul><li>Utwórz nową instancję klasy Aspose.BarCode.BarCodeReader</li><li>Przekaż ścieżkę obrazu źródłowego zawierającą Swiss Post Parcel jako parametr</li><li>Przekaż odpowiedni DecodeType jako drugi parametr</li><li>Przejrzyj wyniki dekodowania w pętli</li><li>Pobierz tekst kodu kreskowego za pomocą właściwości CodeText</li></ul>
