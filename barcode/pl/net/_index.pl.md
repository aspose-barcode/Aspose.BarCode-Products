---
title: C# .NET Barcode API — odczyt, generowanie i rozpoznawanie kodów kreskowych 
weight: 440
url: /pl/net/ 
description: Aspose.BarCode dla interfejsów API platformy .NET do odczytu, tworzenia i rozpoznawania kodów kreskowych 1D 2D. Zintegruj z aplikacjami C# VB.NET ASP.NET, aby skanować i drukować etykiety z kodami kreskowymi
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Interfejsy API .NET do generowania i rozpoznawania kodów kreskowych" h2="Twórz i rozpoznawaj kody kreskowe typów liniowych, 2D i pocztowych z wielu obrazów w dowolnej aplikacji .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/barcode/net" >}}
...
<p>Aspose.BarCode dla platformy .NET to potężna biblioteka do generowania i rozpoznawania kodów kreskowych 1D i 2D z wielu typów obrazów pod dowolnym kątem. Deweloperzy mogą łatwo dodać funkcję generowania i skanowania kodów kreskowych do swoich aplikacji .NET. Umożliwia również eksport wygenerowanych kodów kreskowych do różnych formatów obrazu wysokiej jakości.</p>

<p>Aspose.BarCode dla platformy .NET obsługuje manipulowanie wyglądem wygenerowanych kodów kreskowych, takich jak kolor tła, kolor paska, kąt obrotu, wymiar x, jakość obrazu, rozdzielczość, podpisy, rozmiar i wiele innych. Co więcej, API obsługuje wiele typów funkcji rozpoznawania i obrazowania, a także różne rodzaje symboli.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    ...
    <li>
     Uzyskaj orientację kodu kreskowego
    </li>
    <li>
     Dekoduj znaki inne niż angielskie
    </li>
   </ul>
   <header>
    <i class="fa fa-print">
   ...
   <ul>
    <li>
     Bezpośrednio drukuj kod kreskowy
    </li>
   </ul>
  </div>
  <!--/left-->
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Zapisz w strumieniu lub obrazie
    </li>
    <li>
     Dostosuj rozmiar
    </li>
    <li>
     Koduj znaki inne niż angielskie
    </li>
   </ul>
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Biblioteka kodów kreskowych .NET" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Niezależność od platformy" description="Możesz użyć biblioteki do zbudowania dowolnego typu 32-bitowej lub 64-bitowej aplikacji .NET, w tym ASP.NET, WinForms, WPF, Standard .NET i innych." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Generator kodów kreskowych w C#" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="Aspose.BarCode dla .NET działa z najczęściej używanym obrazem [formaty plików](https://docs.aspose.com/barcode/net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Interfejs API czytnika kodów kreskowych .NET" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray">
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    <!-- <h2 class="h2title">Pocztowy Symbologies Include:</h2> -->
    <p>
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="cs"> // Ścieżka do katalogu dokumentów.
...
{{< blocks/products/pf/i18n/testimonials title="Co ludzie mówią" subTitle="Nie wierz nam tylko na słowo. Zobacz, co użytkownicy mają do powiedzenia na temat interfejsów API." caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}

{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 Spędziłem wiele lat na rozwijaniu i ulepszaniu mojego produktu, a Aspose pozwolił mi uczynić mój produkt o wiele bardziej przyjaznym i użytecznym, a przez to bardziej dostępnym na rynku.
 <em>
  Kiloński Diller | KD Solutions, Polska
 </em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode jest naprawdę napisany w kodzie zarządzanym i daje nam różne typy kodów kreskowych do obsługi wszelkiego rodzaju rozpoznawania dokumentów i dalszego przetwarzania.
 <em>
  Dennis Alexander Petrašc | Keil IT, Niemcy
 </em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Referencje API" href="https://apireference.aspose.com/net/barcode" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Dlaczego Aspose.BarCode dla platformy .NET?" tabId="success-stories" >}}
