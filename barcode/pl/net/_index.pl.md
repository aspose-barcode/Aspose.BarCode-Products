...
{{< blocks/products/pf/upper-banner h1="Generator kodów kreskowych i API czytnika" h2="Twórz i rozpoznawaj kody kreskowe typu liniowego, 2D i pocztowego w dowolnej aplikacji .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" pfName="Aspose.BarCode" subTitlepfName="dla .NET" downloadUrl="https://releases.aspose.com/barcode/net/" >}}
...
<p>Aspose.BarCode dla .NET to potężna biblioteka programistyczna do generowania i rozpoznawania kodów kreskowych 1D i 2D z różnych typów obrazów pod dowolnym kątem. Deweloperzy mogą łatwo dodawać funkcje generowania i skanowania kodów kreskowych do swoich aplikacji .NET. To API umożliwia eksportowanie wygenerowanych kodów kreskowych do różnych formatów obrazów wysokiej jakości.</p><p>Aspose.BarCode for .NET umożliwia modyfikowanie wyglądu generowanych kodów kreskowych i ich parametrów, takich jak kolor tła, kolor paska, kąt obrotu, x -wymiar, jakość obrazu, rozdzielczość, napisy, rozmiar i wiele innych. Zapewnia również bogate funkcje wykrywania i odczytu kodów kreskowych oraz obsługuje ponad 60 typów kodów kreskowych.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Obsługiwane formaty plików" description="Aspose.BarCode dla .NET współpracuje z najczęściej używanymi formatami plików graficznych." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/saving-barcode-image/'>Zapisz etykiety z kodami kreskowymi w różnych formatach</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/read-barcodes-with-aspose-barcode-apis/#setting-barcode-recognition-source'>Rozpoznaj ze strumienia lub pliku</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/qr-and-micro-qr-barcode/#eciencoding-mode'>Koduj i dekoduj znaki (nieanglojęzyczne) w typach 2D</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/image-formatting-and-display-settings/'>Obracaj obrazy kodów kreskowych pod dowolnym kątem</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/how-to-read-barcode-from-multi-page-tiff-images/'>Skanuj kody kreskowe z wielostronicowego TIFF</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/barcode-types-and-image-formats/'>Obsługa symboli liniowych, 2D i pocztowych</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/pdf417/" name="PDF417" description="PDF417 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/qr/" name="QR" description="QR Kod, GS1 QR Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/datamatrix/" name="Data Matrix" description="Kod Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/aztec/" name="Aztec" description="Kod Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/swiss-qr/" name="Swiss QR" description="Swiss QR rachunek" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/dotcode/" name="DotCode" description="DotCode kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/hibc/" name="HIBC" description="HIBC (kod kreskowy branży medycznej)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/codablock/" name="Codablock-F" description="Kody kreskowe Codablock-F i GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/databar/" name="GS1 DataBar" description="GS1 DataBar (wielokierunkowy, skumulowany wielokierunkowy, rozszerzony, rozszerzony skumulowany i obcięty) kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/itf/" name="ITF" description="Przeplatany kod kreskowy 2 z 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/ean/" name="EAN" description="Kod kreskowy EAN (międzynarodowy numer artykułu)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/upc/" name="UPC" description="Kod kreskowy UPC (uniwersalny kod produktu)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/code128/" name="GS1 Code 128" description="GS1 Code 128 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/code39/" name="Code 39" description="Code 39 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/code16k/" name="Code 16K" description="Kod kreskowy Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/code32/" name="Code 32" description="Włoski kod kreskowy Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/code93/" name="Code 93" description="Kody kreskowe Code 93 rozszerzone i Code 93 standardowe" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/onecode/" name="USPS OneCode" description="Kod kreskowy USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/isbn/" name="ISBN" description="ISBN kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/ismn/" name="ISMN" description="ISMN kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/issn/" name="ISSN" description="ISSN kod kreskowy" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/australia-post/" name="Australia Post" description="Kod kreskowy Australia Post i Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Kod identyfikacyjny i Deutsche Post Kod identyfikacyjny" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/rm4scc/" name="RM4SCC" description="Royal Mail 4-stanowy kod klienta (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/postnet/" name="Postnet" description="Kod kreskowy Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/royal-mail/" name="Royal Mail" description="Royal Mail kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/singapore-post/" name="Singapore Post" description="Singapore Post kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentacja" href="https://docs.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/slr-element name="Informacje o wydaniu" href="https://docs.aspose.com/barcode/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Dlaczego Aspose.BarCode dla .NET?" tabId="success-stories" >}}
