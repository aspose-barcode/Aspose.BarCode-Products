---
title: Wygeneruj obrazy Swiss Post Parcel za pomocą Java
description: Przykładowy kod Java dla generacji Swiss Post Parcel w środowisku Java Runtime Environment dla aplikacji JSP/JSF i aplikacji komputerowych.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/java/swiss-post-parcel/generate/
aliases:
- /pl/java/generate/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety Swiss Post Parcel za pomocą Java" h2="Utwórz Swiss Post Parcel w Java przy użyciu Aspose.BarCode po stronie serwera dla Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Utwórz nowy obiekt klasy BarCodeGenerator</li><li>Zdefiniuj Swiss Post Parcel i inne wymagane typy kodów kreskowych jako parametr EncodeTypes</li><li>Określ tekst wejściowy za pomocą metody setCodeText</li><li>Użyj metody BarCodeGenerator.save, aby zapisać wygenerowany obraz kodu kreskowego</li></ul>
