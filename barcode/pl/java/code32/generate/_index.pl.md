---
title: Wygeneruj obrazy Włoski kod kreskowy Pharmacode (Code 32). za pomocą Java
description: Przykładowy kod Java dla generacji Włoski kod kreskowy Pharmacode (Code 32). w środowisku Java Runtime Environment dla aplikacji JSP/JSF i aplikacji komputerowych.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/java/code32/generate/
aliases:
- /pl/java/generate/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety Code 32 za pomocą Java" h2="Utwórz Włoski kod kreskowy Pharmacode (Code 32). w Java przy użyciu Aspose.BarCode po stronie serwera dla Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Code 32 kod kreskowy w Java" %}}
...
<ul><li>Utwórz nowy obiekt klasy BarCodeGenerator</li><li>Zdefiniuj Code 32 kod kreskowy i inne wymagane typy kodów kreskowych jako parametr EncodeTypes</li><li>Określ tekst wejściowy za pomocą metody setCodeText</li><li>Użyj metody BarCodeGenerator.save, aby zapisać wygenerowany obraz kodu kreskowego</li></ul>
