...
{{% blocks/products/pf/agp/content h2="How to Generate Deutsche Post kod kreskowy Using Python via Java" %}}
Aby tworzyć obrazy Deutsche Post kod kreskowy, pobierz [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, bogate w funkcje, wydajne i łatwe w użyciu -użyj biblioteki kodów kreskowych dla aplikacji opartych na Pythonie. Pobierz najnowszą wersję bezpośrednio z portalu [Aspose releases](https://releases.aspose.com/barcode/python-java/) lub zainstaluj „aspose-barcode” z pip za pomocą następującego polecenia:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Deutsche Post kod kreskowy w Python" %}}
...
<ul><li>Utwórz nowy obiekt klasy BarCodeGenerator</li><li>Określ żądane typy kodów kreskowych jako parametr EncodeTypes</li><li>Wstaw tekst wejściowy jako drugi parametr</li><li> Wywołaj metodę BarCodeGenerator.save, aby uzyskać wygenerowany obraz Deutsche Post Kod identyfikacyjny i Deutsche Post Kod identyfikacyjny</li></ul>
