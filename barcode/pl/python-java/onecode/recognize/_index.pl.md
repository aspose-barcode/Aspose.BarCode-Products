---
title: Zeskanuj obrazy Kod kreskowy USPS OneCode za pomocą Python via Java
weight: 1510
description: Kod źródłowy Pythona do rozpoznawania Kod kreskowy USPS OneCode przy użyciu Java Runtime Environment.
lang: pl
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pl/python-java/onecode/recognize/
aliases:
- /pl/python-java/recognize/onecode/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Czytaj kody kreskowe USPS OneCode za pomocą Python via Java" h2="Odczyt Kod kreskowy USPS OneCode w Python przy użyciu Aspose.BarCode po stronie serwera dla Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="USPS OneCode" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Kod kreskowy USPS OneCode Using Python via Java" %}}
Aby zeskanować i zdekodować Kod kreskowy USPS OneCode, zainstaluj [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, wszechstronne, wydajne i łatwe w użyciu użyj biblioteki kodów kreskowych dla aplikacji opartych na Pythonie. Pobierz najnowszą wersję bezpośrednio z portalu [Aspose releases](https://releases.aspose.com/barcode/python-java/) lub zainstaluj „aspose-barcode” z pip, uruchamiając następujące polecenie:
...
{{% blocks/products/pf/agp/feature-section-col title="Instrukcje skanowania Kod kreskowy USPS OneCode w Python" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode umożliwia programistom odczytywanie kodów kreskowych Kod kreskowy USPS OneCode ze strumienia lub obrazu za pomocą kilku wierszy kodu

{{% /blocks/products/pf/agp/text %}}

<ul><li>Utwórz obiekt klasy Aspose.BarCode.BarCodeReader</li><li>Zdefiniuj ścieżkę pliku źródłowego zawierającego Kod kreskowy USPS OneCode jako parametr</li><li>Określ wymagane typy kodów kreskowych w DecodeType jako drugi parametr</li><li>Przeglądaj wyniki dekodowania w pętli</li><li>Pobierz tekst kodu kreskowego za pomocą właściwości CodeText</li></ul>
