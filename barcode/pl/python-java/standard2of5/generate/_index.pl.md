---
title: Wygeneruj obrazy Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy za pomocą Python via Java
description: Przykładowy kod w języku Python do generowania Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy przy użyciu Java Runtime Environment.
lang: pl
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pl/python-java/standard2of5/generate/
aliases:
- /pl/python-java/generate/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety Standard 2 of 5 za pomocą Python via Java" h2="Utwórz Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy w Python przy użyciu Aspose.BarCode po stronie serwera dla Python via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Standard 2 of 5 kod kreskowy Using Python via Java" %}}
Aby tworzyć obrazy Standard 2 of 5 kod kreskowy, pobierz [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, bogate w funkcje, wydajne i łatwe w użyciu -użyj biblioteki kodów kreskowych dla aplikacji opartych na Pythonie. Pobierz najnowszą wersję bezpośrednio z portalu [Aspose releases](https://releases.aspose.com/barcode/python-java/) lub zainstaluj „aspose-barcode” z pip za pomocą następującego polecenia:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Standard 2 of 5 kod kreskowy w Python" %}}
...
<ul><li>Utwórz nowy obiekt klasy BarCodeGenerator</li><li>Określ żądane typy kodów kreskowych jako parametr EncodeTypes</li><li>Wstaw tekst wejściowy jako drugi parametr</li><li> Wywołaj metodę BarCodeGenerator.save, aby uzyskać wygenerowany obraz Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy</li></ul>
