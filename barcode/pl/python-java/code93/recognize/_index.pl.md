---
title: Zeskanuj obrazy Kody kreskowe Code 93 rozszerzone i Code 93 standardowe za pomocą Python via Java
weight: 1510
description: Kod źródłowy Pythona do rozpoznawania Kody kreskowe Code 93 rozszerzone i Code 93 standardowe przy użyciu Java Runtime Environment.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/python-java/code93/recognize/
aliases:
- /pl/python-java/recognize/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Czytaj kody kreskowe Code 93 za pomocą Python via Java" h2="Odczyt Kody kreskowe Code 93 rozszerzone i Code 93 standardowe w Python przy użyciu Aspose.BarCode po stronie serwera dla Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 93 kod kreskowy Using Python via Java" %}}
Aby zeskanować i zdekodować Code 93 kod kreskowy, zainstaluj [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, wszechstronne, wydajne i łatwe w użyciu użyj biblioteki kodów kreskowych dla aplikacji opartych na Pythonie. Pobierz najnowszą wersję bezpośrednio z portalu [Aspose releases](https://releases.aspose.com/barcode/python-java/) lub zainstaluj „aspose-barcode” z pip, uruchamiając następujące polecenie:
...
{{% blocks/products/pf/agp/feature-section-col title="Instrukcje skanowania Code 93 kod kreskowy w Python" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode umożliwia programistom odczytywanie kodów kreskowych Code 93 kod kreskowy ze strumienia lub obrazu za pomocą kilku wierszy kodu

{{% /blocks/products/pf/agp/text %}}

<ul><li>Utwórz obiekt klasy Aspose.BarCode.BarCodeReader</li><li>Zdefiniuj ścieżkę pliku źródłowego zawierającego Code 93 kod kreskowy jako parametr</li><li>Określ wymagane typy kodów kreskowych w DecodeType jako drugi parametr</li><li>Przeglądaj wyniki dekodowania w pętli</li><li>Pobierz tekst kodu kreskowego za pomocą właściwości CodeText</li></ul>
