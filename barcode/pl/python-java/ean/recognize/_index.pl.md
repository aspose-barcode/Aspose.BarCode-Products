...
{{< blocks/products/pf/upper-banner h1="Czytaj kody kreskowe EAN za pomocą Python via Java" h2="Odczyt Kod kreskowy EAN (międzynarodowy numer artykułu). w Python przy użyciu Aspose.BarCode po stronie serwera dla Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Kod kreskowy EAN (międzynarodowy numer artykułu). Using Python via Java" %}}
Aby zeskanować i zdekodować Kod kreskowy EAN (międzynarodowy numer artykułu)., zainstaluj [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, wszechstronne, wydajne i łatwe w użyciu użyj biblioteki kodów kreskowych dla aplikacji opartych na Pythonie. Pobierz najnowszą wersję bezpośrednio z portalu [Aspose releases](https://releases.aspose.com/barcode/python-java/) lub zainstaluj „aspose-barcode” z pip, uruchamiając następujące polecenie:
...
{{% blocks/products/pf/agp/feature-section-col title="Instrukcje skanowania Kod kreskowy EAN (międzynarodowy numer artykułu). w Python" %}}
...
<ul><li>Utwórz obiekt klasy Aspose.BarCode.BarCodeReader</li><li>Zdefiniuj ścieżkę pliku źródłowego zawierającego Kod kreskowy EAN (międzynarodowy numer artykułu). jako parametr</li><li>Określ wymagane typy kodów kreskowych w DecodeType jako drugi parametr</li><li>Przeglądaj wyniki dekodowania w pętli</li><li>Pobierz tekst kodu kreskowego za pomocą właściwości CodeText</li></ul>
