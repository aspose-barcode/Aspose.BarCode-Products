---
title: Interfejs API kodów kreskowych programu SharePoint — wstawianie kodów kreskowych na listach programu SharePoint
description: Barcode SharePoint API do wstawiania etykiet z kodami kreskowymi na niestandardowych listach SharePoint. Deweloperzy mogą używać znaczników usług do wybierania wejściowych wartości tekstowych lub wstawiania tekstu ręcznie.
lang: pl/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Interfejsy API kodów kreskowych programu SharePoint" h2="Barcode SharePoint App do dodawania liniowych, 2D i pocztowych kodów kreskowych do list Microsoft SharePoint." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="dla SharePoint" downloadUrl="https://releases.aspose.com/barcode/sharepoint/" >}}
...
<p>Aspose.BarCode for SharePoint umożliwia programistom dodawanie szerokiej gamy liniowych, 2D i pocztowych kodów kreskowych do list programów Microsoft SharePoint Foundation 2010 i Microsoft Office SharePoint Server 2010 (MOSS). Możesz tworzyć, a następnie wstawiać kody kreskowe do dowolnej listy, określając tekst wejściowy i typ.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Niezależność Platformy" description="Aspose.BarCode dla SharePoint obsługuje Microsoft SharePoint Foundation i SharePoint Server." >}}
<div class='diagram1 d1-sharepoint'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Obsługiwane formaty plików" description="Aspose.BarCode dla SharePoint współpracuje z najczęściej używanymi formatami plików graficznych." >}}
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Dodaj kody kreskowe do list Sharepoint
                </h2>
                <p>
                    Aspose.BarCode dla SharePoint zapewnia bogatą funkcjonalność dodawania kodów kreskowych do list SharePoint. Listy takie mogą służyć do przechowywania i organizowania danych w ustrukturyzowanym formacie. Jest to wygodny sposób zarządzania szeroką gamą informacji, takich jak kontakty, zadania, wydarzenia w kalendarzu i nie tylko. Zapewniają wiele funkcji do organizowania, sortowania, filtrowania i udostępniania danych. Przydatne może być dodanie kodów kreskowych do list programu SharePoint w celu ułatwienia dostępu do informacji na liście i zarządzania nimi. Jeśli lista programu SharePoint jest tworzona w celu śledzenia pozycji magazynowych, programiści mogą dodawać kody kreskowe, aby szybko i dokładnie skanować i aktualizować informacje na liście. Może to ułatwić śledzenie i zarządzanie zapasami, a także zmniejszyć ryzyko rozbieżności. Kody kreskowe mogą służyć do szybkiego dostępu i przeglądania informacji na liście programu SharePoint, na przykład poprzez skanowanie kodów kreskowych w celu szybkiego wyświetlenia określonych elementów lub rekordów na liście.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Biblioteka kodów kreskowych to potężne narzędzie, które umożliwia programistom łatwe generowanie kodów kreskowych poprzez określenie docelowego typu kodu kreskowego, wstawienie danych wejściowych do przechowywania kodu kreskowego i dostosowanie właściwości związanych z wyglądem. Biblioteka zapewnia szereg opcji dostrajania wyglądu generowanych kodów kreskowych, w tym opcje ustawiania kolorów tła i pierwszego planu, czcionki, rozmiaru, rozdzielczości i podpisów tekstowych.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    Biblioteka kodów kreskowych zapewnia różne opcje zapisywania wygenerowanych kodów kreskowych nie tylko przy użyciu popularnych formatów obrazów rastrowych, ale także strumieniowych lub wektorowych. Kody kreskowe można pobrać przy użyciu jednego z pięciu najczęściej używanych formatów graficznych lub dwóch formatów wektorowych. Możliwe jest również ładowanie kodów kreskowych w postaci plików, strumieni lub map bitowych. Deweloperzy mogą dostosować proces generowania i zapisywania kodów kreskowych do konkretnych potrzeb biznesowych, ustawiając wymagany tryb wyjściowy. Interfejs API obsługuje następujące formaty plików&colon; BMP, PNG, GIF, JPEG i TIFF dla wejścia/wyjścia; EMF i SVG do wydruku.<br>Programiści mogą zapisywać kody kreskowe jako obrazy wektorowe, takie jak pliki EMF i SVG, aby skalować je bez utraty rozdzielczości.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
                ...
                <p>
                    Barcode API zawiera różne funkcje do wykrywania i odczytu szerokiej gamy popularnych kodów kreskowych 1D i 2D. Funkcje te można łatwo zintegrować z aplikacjami za pomocą zaledwie kilku wierszy kodu, zapewniając wygodny i skuteczny sposób dodawania funkcji wykrywania kodów kreskowych do aplikacji.
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/pdf417/" name="PDF417" description="PDF417 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/qr/" name="QR" description="QR Kod, GS1 QR Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/datamatrix/" name="Data Matrix" description="Kod Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/aztec/" name="Aztec" description="Kod Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/swiss-qr/" name="Swiss QR" description="Swiss QR rachunek" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/dotcode/" name="DotCode" description="DotCode kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/hibc/" name="HIBC" description="HIBC (kod kreskowy branży medycznej)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/codablock/" name="Codablock-F" description="Kody kreskowe Codablock-F i GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/databar/" name="GS1 DataBar" description="GS1 DataBar (wielokierunkowy, skumulowany wielokierunkowy, rozszerzony, rozszerzony skumulowany i obcięty) kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/itf/" name="ITF" description="Przeplatany kod kreskowy 2 z 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/ean/" name="EAN" description="Kod kreskowy EAN (międzynarodowy numer artykułu)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/upc/" name="UPC" description="Kod kreskowy UPC (uniwersalny kod produktu)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/code128/" name="GS1 Code 128" description="GS1 Code 128 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/code39/" name="Code 39" description="Code 39 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/code16k/" name="Code 16K" description="Kod kreskowy Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/code32/" name="Code 32" description="Włoski kod kreskowy Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/code93/" name="Code 93" description="Kody kreskowe Code 93 rozszerzone i Code 93 standardowe" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/onecode/" name="USPS OneCode" description="Kod kreskowy USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/isbn/" name="ISBN" description="ISBN kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/ismn/" name="ISMN" description="ISMN kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/issn/" name="ISSN" description="ISSN kod kreskowy" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/australia-post/" name="Australia Post" description="Kod kreskowy Australia Post i Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/deutsche-post/" name="Deutsche Post" description="Deutsche Post Kod identyfikacyjny i Deutsche Post Kod identyfikacyjny" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/rm4scc/" name="RM4SCC" description="Royal Mail 4-stanowy kod klienta (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/postnet/" name="Postnet" description="Kod kreskowy Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/royal-mail/" name="Royal Mail" description="Royal Mail kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/singapore-post/" name="Singapore Post" description="Singapore Post kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/sharepoint/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Kod źródłowy" href="https://github.com/aspose-barcode/Aspose.BarCode-for-.NET" >}}
{{< blocks/products/pf/slr-element name="Referencje API" href="https://reference.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/slr-element name="Informacje o wydaniu" href="https://docs.aspose.com/barcode/sharepoint/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
