---
title: Wygeneruj obrazy Przeplatany kod kreskowy 2 z 5 (ITF). za pomocą PHP via Java
description: Kod źródłowy PHP do tworzenia Przeplatany kod kreskowy 2 z 5 (ITF). w aplikacjach opartych na PHP.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/php-java/itf/generate/
aliases:
- /pl/php-java/generate/itf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety ITF za pomocą PHP via Java" h2="Utwórz Przeplatany kod kreskowy 2 z 5 (ITF). w PHP przy użyciu Aspose.BarCode po stronie serwera dla PHP via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Przeplatany kod kreskowy 2 z 5 (ITF). w PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode ułatwia programistom tworzenie obrazów Przeplatany kod kreskowy 2 z 5 (ITF). z kilkoma liniami kodu.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Utwórz nową instancję klasy BarCodeGenerator</li><li>Określ Przeplatany kod kreskowy 2 z 5 (ITF). i inne odpowiednie typy kodów kreskowych jako parametr EncodeTypes</li><li>Ustaw tekst kodu kreskowego jako drugi parametr</li><li>W razie potrzeby określ wymiary i lokalizację obrazu</li><li>Wywołaj metodę BarCodeGenerator.save, aby uzyskać obraz Przeplatany kod kreskowy 2 z 5 (ITF). w wymaganym formacie</li></ul>
