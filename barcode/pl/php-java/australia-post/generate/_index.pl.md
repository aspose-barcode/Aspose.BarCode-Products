---
title: Wygeneruj obrazy Kod kreskowy Australia Post i Australia Post eParcel za pomocą PHP via Java
description: Kod źródłowy PHP do tworzenia Kod kreskowy Australia Post i Australia Post eParcel w aplikacjach opartych na PHP.
lang: pl
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pl/php-java/australia-post/generate/
aliases:
- /pl/php-java/generate/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety Australia Post za pomocą PHP via Java" h2="Utwórz Kod kreskowy Australia Post i Australia Post eParcel w PHP przy użyciu Aspose.BarCode po stronie serwera dla PHP via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Australia Post kod kreskowy w PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode ułatwia programistom tworzenie obrazów Australia Post kod kreskowy z kilkoma liniami kodu.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Utwórz nową instancję klasy BarCodeGenerator</li><li>Określ Australia Post kod kreskowy i inne odpowiednie typy kodów kreskowych jako parametr EncodeTypes</li><li>Ustaw tekst kodu kreskowego jako drugi parametr</li><li>W razie potrzeby określ wymiary i lokalizację obrazu</li><li>Wywołaj metodę BarCodeGenerator.save, aby uzyskać obraz Kod kreskowy Australia Post i Australia Post eParcel w wymaganym formacie</li></ul>
