---
title: Zeskanuj obrazy QR Kod, GS1 QR Kod za pomocą PHP via Java
weight: 1510
description: Przykładowy kod PHP do odczytu QR Kod, GS1 QR Kod w aplikacjach opartych na PHP.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/php-java/qr/recognize/
aliases:
- /pl/php-java/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Czytaj kody kreskowe QR za pomocą PHP via Java" h2="Odczyt QR Kod, GS1 QR Kod w PHP przy użyciu Aspose.BarCode po stronie serwera dla PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Instrukcje skanowania Kod QR w PHP" %}}
...
<ul><li>Utwórz obiekt klasy Aspose.BarCode.BarCodeReader</li><li>Ustaw jako parametr ścieżkę do obrazu źródłowego zawierającego Kod QR</li><li>Określ typy docelowych kodów kreskowych w DecodeType jako drugi parametr</li><li>Przejrzyj wyniki odczytu w pętli</li><li>Uzyskaj tekst kodu kreskowego za pomocą właściwości CodeText</li></ul>
