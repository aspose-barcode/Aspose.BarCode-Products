---
title: Zeskanuj obrazy Włoski kod kreskowy Pharmacode (Code 32). za pomocą PHP via Java
weight: 1510
description: Przykładowy kod PHP do odczytu Włoski kod kreskowy Pharmacode (Code 32). w aplikacjach opartych na PHP.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/php-java/code32/recognize/
aliases:
- /pl/php-java/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Czytaj kody kreskowe Code 32 za pomocą PHP via Java" h2="Odczyt Włoski kod kreskowy Pharmacode (Code 32). w PHP przy użyciu Aspose.BarCode po stronie serwera dla PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Instrukcje skanowania Code 32 kod kreskowy w PHP" %}}
...
<ul><li>Utwórz obiekt klasy Aspose.BarCode.BarCodeReader</li><li>Ustaw jako parametr ścieżkę do obrazu źródłowego zawierającego Code 32 kod kreskowy</li><li>Określ typy docelowych kodów kreskowych w DecodeType jako drugi parametr</li><li>Przejrzyj wyniki odczytu w pętli</li><li>Uzyskaj tekst kodu kreskowego za pomocą właściwości CodeText</li></ul>
