---
title: Zeskanuj obrazy Przeplatany kod kreskowy 2 z 5 (ITF). za pomocą Node.js via Java
weight: 1510
description: Kod źródłowy Node.js do skanowania i dekodowania Przeplatany kod kreskowy 2 z 5 (ITF). w aplikacjach JavaScript.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/nodejs-java/itf/recognize/
aliases:
- /pl/nodejs-java/recognize/itf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Czytaj kody kreskowe ITF za pomocą Node.js via Java" h2="Odczyt Przeplatany kod kreskowy 2 z 5 (ITF). w JavaScript przy użyciu Aspose.BarCode po stronie serwera dla Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Przeplatany kod kreskowy 2 z 5 (ITF). Using Node.js via Java" %}}
Aby rozpoznać Przeplatany kod kreskowy 2 z 5 (ITF). w aplikacjach Node.js, użyj Aspose.BarCode dla Node.js przez Javę, solidną, wszechstronną i przyjazną dla użytkownika bibliotekę kodów kreskowych wprowadzoną dla środowisk opartych na Javie. Możesz załadować [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) dla Javascript bezpośrednio z NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Instrukcje skanowania Przeplatany kod kreskowy 2 z 5 (ITF). w JavaScript" %}}
...
<ul><li>Utwórz obiekt klasy Aspose.BarCode.BarCodeReader</li><li>Przekaż ścieżkę pliku źródłowego zawierającego Przeplatany kod kreskowy 2 z 5 (ITF). jako parametr</li><li>Ustaw docelowe typy kodów kreskowych w DecodeType jako drugi parametr</li><li>Przejdź przez wszystkie wykryte kody kreskowe</li><li>Pobierz wynikowy tekst kodu kreskowego za pomocą właściwości CodeText</li></ul>
