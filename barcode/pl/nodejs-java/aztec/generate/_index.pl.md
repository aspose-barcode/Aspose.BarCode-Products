---
title: Wygeneruj obrazy Kod Aztec za pomocą Node.js via Java
description: Przykładowy kod Node.js dla generacji Kod Aztec w aplikacjach JavaScript.
lang: pl
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pl/nodejs-java/aztec/generate/
aliases:
- /pl/nodejs-java/generate/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety Aztec za pomocą Node.js via Java" h2="Utwórz Kod Aztec w JavaScript przy użyciu Aspose.BarCode po stronie serwera dla Node.js via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Kod Aztec Using Node.js via Java" %}}
Aby utworzyć kody kreskowe Kod Aztec w aplikacjach Node.js, zdobądź Aspose.BarCode dla Node.js przez Javę, zaawansowane, potężne i przyjazne dla użytkownika API kodów kreskowych zaprojektowane dla platform zorientowanych na Javę. Możesz łatwo zainstalować [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) dla Javascript z NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Kod Aztec w JavaScript" %}}
