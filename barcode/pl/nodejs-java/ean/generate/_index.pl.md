...
{{% blocks/products/pf/agp/content h2="How to Generate Kod kreskowy EAN (międzynarodowy numer artykułu). Using Node.js via Java" %}}
Aby utworzyć kody kreskowe Kod kreskowy EAN (międzynarodowy numer artykułu). w aplikacjach Node.js, zdobądź Aspose.BarCode dla Node.js przez Javę, zaawansowane, potężne i przyjazne dla użytkownika API kodów kreskowych zaprojektowane dla platform zorientowanych na Javę. Możesz łatwo zainstalować [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) dla Javascript z NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Kod kreskowy EAN (międzynarodowy numer artykułu). w JavaScript" %}}
...
<ul><li>Utwórz instancję klasy BarCodeGenerator</li><li>Ustaw Kod kreskowy EAN (międzynarodowy numer artykułu). jako parametr EncodeTypes</li><li>Zdefiniuj tekst do zakodowania jako drugi parametr</li><li>W razie potrzeby określ wymiary i lokalizację kodu kreskowego</li><li>Wywołaj metodę BarCodeGenerator.save, aby uzyskać wygenerowany obraz kodu kreskowego</li></ul>
