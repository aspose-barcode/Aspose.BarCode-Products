---
title: Zeskanuj obrazy Kod kreskowy EAN (międzynarodowy numer artykułu). za pomocą Node.js via Java
weight: 1510
description: Kod źródłowy Node.js do skanowania i dekodowania Kod kreskowy EAN (międzynarodowy numer artykułu). w aplikacjach JavaScript.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/nodejs-java/ean/recognize/
aliases:
- /pl/nodejs-java/recognize/ean/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Czytaj kody kreskowe EAN za pomocą Node.js via Java" h2="Odczyt Kod kreskowy EAN (międzynarodowy numer artykułu). w JavaScript przy użyciu Aspose.BarCode po stronie serwera dla Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Kod kreskowy EAN (międzynarodowy numer artykułu). Using Node.js via Java" %}}
Aby rozpoznać Kod kreskowy EAN (międzynarodowy numer artykułu). w aplikacjach Node.js, użyj Aspose.BarCode dla Node.js przez Javę, solidną, wszechstronną i przyjazną dla użytkownika bibliotekę kodów kreskowych wprowadzoną dla środowisk opartych na Javie. Możesz załadować [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) dla Javascript bezpośrednio z NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Instrukcje skanowania Kod kreskowy EAN (międzynarodowy numer artykułu). w JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode umożliwia programistom odczytywanie kodów kreskowych Kod kreskowy EAN (międzynarodowy numer artykułu). ze strumienia lub obrazu za pomocą kilku wierszy kodu

{{% /blocks/products/pf/agp/text %}}

<ul><li>Utwórz obiekt klasy Aspose.BarCode.BarCodeReader</li><li>Przekaż ścieżkę pliku źródłowego zawierającego Kod kreskowy EAN (międzynarodowy numer artykułu). jako parametr</li><li>Ustaw docelowe typy kodów kreskowych w DecodeType jako drugi parametr</li><li>Przejdź przez wszystkie wykryte kody kreskowe</li><li>Pobierz wynikowy tekst kodu kreskowego za pomocą właściwości CodeText</li></ul>
