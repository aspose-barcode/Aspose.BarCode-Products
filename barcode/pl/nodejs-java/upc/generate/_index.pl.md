---
title: Wygeneruj obrazy Kod kreskowy UPC (uniwersalny kod produktu). za pomocą Node.js via Java
description: Przykładowy kod Node.js dla generacji Kod kreskowy UPC (uniwersalny kod produktu). w aplikacjach JavaScript.
lang: pl
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pl/nodejs-java/upc/generate/
aliases:
- /pl/nodejs-java/generate/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety UPC za pomocą Node.js via Java" h2="Utwórz Kod kreskowy UPC (uniwersalny kod produktu). w JavaScript przy użyciu Aspose.BarCode po stronie serwera dla Node.js via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Kod kreskowy UPC (uniwersalny kod produktu). Using Node.js via Java" %}}
Aby utworzyć kody kreskowe Kod kreskowy UPC (uniwersalny kod produktu). w aplikacjach Node.js, zdobądź Aspose.BarCode dla Node.js przez Javę, zaawansowane, potężne i przyjazne dla użytkownika API kodów kreskowych zaprojektowane dla platform zorientowanych na Javę. Możesz łatwo zainstalować [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) dla Javascript z NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Kod kreskowy UPC (uniwersalny kod produktu). w JavaScript" %}}
...
<ul><li>Utwórz instancję klasy BarCodeGenerator</li><li>Ustaw Kod kreskowy UPC (uniwersalny kod produktu). jako parametr EncodeTypes</li><li>Zdefiniuj tekst do zakodowania jako drugi parametr</li><li>W razie potrzeby określ wymiary i lokalizację kodu kreskowego</li><li>Wywołaj metodę BarCodeGenerator.save, aby uzyskać wygenerowany obraz kodu kreskowego</li></ul>
