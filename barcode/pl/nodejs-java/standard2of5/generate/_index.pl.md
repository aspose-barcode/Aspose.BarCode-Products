---
title: Wygeneruj obrazy Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy za pomocą Node.js via Java
description: Przykładowy kod Node.js dla generacji Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy w aplikacjach JavaScript.
lang: pl
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pl/nodejs-java/standard2of5/generate/
aliases:
- /pl/nodejs-java/generate/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety Standard 2 of 5 za pomocą Node.js via Java" h2="Utwórz Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy w JavaScript przy użyciu Aspose.BarCode po stronie serwera dla Node.js via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Standard 2 of 5 kod kreskowy Using Node.js via Java" %}}
Aby utworzyć kody kreskowe Standard 2 of 5 kod kreskowy w aplikacjach Node.js, zdobądź Aspose.BarCode dla Node.js przez Javę, zaawansowane, potężne i przyjazne dla użytkownika API kodów kreskowych zaprojektowane dla platform zorientowanych na Javę. Możesz łatwo zainstalować [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) dla Javascript z NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Standard 2 of 5 kod kreskowy w JavaScript" %}}
