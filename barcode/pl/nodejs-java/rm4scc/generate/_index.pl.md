---
title: Wygeneruj obrazy Royal Mail 4-stanowy kod klienta (RM4SCC) za pomocą Node.js via Java
description: Przykładowy kod Node.js dla generacji Royal Mail 4-stanowy kod klienta (RM4SCC) w aplikacjach JavaScript.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/nodejs-java/rm4scc/generate/
aliases:
- /pl/nodejs-java/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety RM4SCC za pomocą Node.js via Java" h2="Utwórz Royal Mail 4-stanowy kod klienta (RM4SCC) w JavaScript przy użyciu Aspose.BarCode po stronie serwera dla Node.js via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Royal Mail 4-stanowy kod klienta (RM4SCC) Using Node.js via Java" %}}
Aby utworzyć kody kreskowe Royal Mail 4-stanowy kod klienta (RM4SCC) w aplikacjach Node.js, zdobądź Aspose.BarCode dla Node.js przez Javę, zaawansowane, potężne i przyjazne dla użytkownika API kodów kreskowych zaprojektowane dla platform zorientowanych na Javę. Możesz łatwo zainstalować [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) dla Javascript z NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Royal Mail 4-stanowy kod klienta (RM4SCC) w JavaScript" %}}
...
<ul><li>Utwórz instancję klasy BarCodeGenerator</li><li>Ustaw Royal Mail 4-stanowy kod klienta (RM4SCC) jako parametr EncodeTypes</li><li>Zdefiniuj tekst do zakodowania jako drugi parametr</li><li>W razie potrzeby określ wymiary i lokalizację kodu kreskowego</li><li>Wywołaj metodę BarCodeGenerator.save, aby uzyskać wygenerowany obraz kodu kreskowego</li></ul>
