---
title: Wygeneruj obrazy QR Kod, GS1 QR Kod za pomocą Node.js via Java
description: Przykładowy kod Node.js dla generacji QR Kod, GS1 QR Kod w aplikacjach JavaScript.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/nodejs-java/qr/generate/
aliases:
- /pl/nodejs-java/generate/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety QR za pomocą Node.js via Java" h2="Utwórz QR Kod, GS1 QR Kod w JavaScript przy użyciu Aspose.BarCode po stronie serwera dla Node.js via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Kod QR w JavaScript" %}}
