---
title: Zeskanuj obrazy DotCode kod kreskowy za pomocą Node.js via Java
weight: 1510
description: Kod źródłowy Node.js do skanowania i dekodowania DotCode kod kreskowy w aplikacjach JavaScript.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/nodejs-java/dotcode/recognize/
aliases:
- /pl/nodejs-java/recognize/dotcode/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Czytaj kody kreskowe DotCode za pomocą Node.js via Java" h2="Odczyt DotCode kod kreskowy w JavaScript przy użyciu Aspose.BarCode po stronie serwera dla Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DotCode" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read DotCode kod kreskowy Using Node.js via Java" %}}
Aby rozpoznać DotCode kod kreskowy w aplikacjach Node.js, użyj Aspose.BarCode dla Node.js przez Javę, solidną, wszechstronną i przyjazną dla użytkownika bibliotekę kodów kreskowych wprowadzoną dla środowisk opartych na Javie. Możesz załadować [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) dla Javascript bezpośrednio z NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Instrukcje skanowania DotCode kod kreskowy w JavaScript" %}}
