---
title: Interfejs API przetwarzania kodów kreskowych C++
description: Skaner kodów kreskowych C++ i biblioteka generatorów kodów kreskowych 1D i 2D. Twórz i czytaj różne rodzaje kodów kreskowych 1D, 2D i pocztowych
lang: pl
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Biblioteka kodów kreskowych C++" h2="Twórz i rozpoznawaj kody kreskowe typu liniowego, 2D i pocztowego w dowolnej aplikacji C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" pfName="Aspose.BarCode" subTitlepfName="dla C++" downloadUrl="https://releases.aspose.com/barcode/cpp/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.BarCode" subTitlepfName="dla C++" >}}
...
{{< blocks/products/pf/carousel-item h3="Niezależność Platformy" description="Możesz użyć biblioteki do zbudowania dowolnego typu 32-bitowej lub 64-bitowej aplikacji .NET, w tym ASP.NET, WinForms, WPF, .NET Standard i innych." >}}
<div class='diagram1 d1-cplus'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Obsługiwane formaty plików" description="Aspose.BarCode dla C++ współpracuje z najczęściej używanymi formatami plików graficznych." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/generate-barcodes-with-aspose-barcode-apis/'>Zapisz wygenerowane obrazy kodów kreskowych do strumienia lub pliku</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/read-barcodes-with-aspose-barcode-apis/'>Rozpoznawaj kody ze strumienia lub obrazu</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/qr-and-micro-qr-barcode/#qr-code-encoding-in-the-eci-mode'>Koduj i dekoduj znaki inne niż angielskie w typach 2D</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/image-formatting-and-display-settings/'>Kontroluj rozmiar i orientację</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/image-formatting-and-display-settings/#rotate-barcode-image'>Obracaj obrazy pod dowolnym kątem</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/image-formatting-and-display-settings/'>Kontroluj rozmiar kodu, kolor i tekst kodu</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/product-overview/#supported-barcode-symbologies'>Obsługa symboli 1D, 2D i pocztowych</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/pdf417/" name="PDF417" description="PDF417 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/qr/" name="QR" description="QR Kod, GS1 QR Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/datamatrix/" name="Data Matrix" description="Kod Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/aztec/" name="Aztec" description="Kod Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/swiss-qr/" name="Swiss QR" description="Swiss QR rachunek" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/dotcode/" name="DotCode" description="DotCode kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/hibc/" name="HIBC" description="HIBC (kod kreskowy branży medycznej)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/codablock/" name="Codablock-F" description="Kody kreskowe Codablock-F i GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/databar/" name="GS1 DataBar" description="GS1 DataBar (wielokierunkowy, skumulowany wielokierunkowy, rozszerzony, rozszerzony skumulowany i obcięty) kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/itf/" name="ITF" description="Przeplatany kod kreskowy 2 z 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/ean/" name="EAN" description="Kod kreskowy EAN (międzynarodowy numer artykułu)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/upc/" name="UPC" description="Kod kreskowy UPC (uniwersalny kod produktu)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/code128/" name="GS1 Code 128" description="GS1 Code 128 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/code39/" name="Code 39" description="Code 39 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/code16k/" name="Code 16K" description="Kod kreskowy Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/code32/" name="Code 32" description="Włoski kod kreskowy Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/code93/" name="Code 93" description="Kody kreskowe Code 93 rozszerzone i Code 93 standardowe" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/onecode/" name="USPS OneCode" description="Kod kreskowy USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/isbn/" name="ISBN" description="ISBN kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/ismn/" name="ISMN" description="ISMN kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/issn/" name="ISSN" description="ISSN kod kreskowy" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/australia-post/" name="Australia Post" description="Kod kreskowy Australia Post i Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/deutsche-post/" name="Deutsche Post" description="Deutsche Post Kod identyfikacyjny i Deutsche Post Kod identyfikacyjny" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/rm4scc/" name="RM4SCC" description="Royal Mail 4-stanowy kod klienta (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/postnet/" name="Postnet" description="Kod kreskowy Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/royal-mail/" name="Royal Mail" description="Royal Mail kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/singapore-post/" name="Singapore Post" description="Singapore Post kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentacja" href="https://docs.aspose.com/barcode/cpp/" >}}
{{< blocks/products/pf/slr-element name="Kod źródłowy" href="https://github.com/aspose-barcode/Aspose.Barcode-for-C" >}}
{{< blocks/products/pf/slr-element name="Referencje API" href="https://reference.aspose.com/barcode/cpp/" >}}
...
{{< blocks/products/pf/slr-element name="Informacje o wydaniu" href="https://docs.aspose.com/barcode/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Dlaczego Aspose.BarCode dla C++?" tabId="success-stories" >}}
