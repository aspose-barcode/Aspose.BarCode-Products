---
title: Wygeneruj obrazy GS1 DataBar (wielokierunkowy, skumulowany wielokierunkowy, rozszerzony, rozszerzony skumulowany i obcięty) kod kreskowy za pomocą C++
description: Przykład kodu C++ do generowania kodu GS1 DataBar (wielokierunkowy, skumulowany wielokierunkowy, rozszerzony, rozszerzony skumulowany i obcięty) kod kreskowy w środowisku wykonawczym C++ dla 32-bitowych systemów Windows, 64-bitowych systemów Windows i 64-bitowych systemów Linux.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/cpp/databar/generate/
aliases:
- /pl/cpp/generate/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety GS1 DataBar za pomocą C++" h2="Utwórz GS1 DataBar (wielokierunkowy, skumulowany wielokierunkowy, rozszerzony, rozszerzony skumulowany i obcięty) kod kreskowy w C++ przy użyciu Aspose.BarCode po stronie serwera dla C++ API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate GS1 DataBar kod kreskowy Using C++" %}}
Aby wygenerować GS1 DataBar kod kreskowy, zainstaluj [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, niezawodną i łatwą w użyciu bibliotekę kodów kreskowych z bogatą funkcjonalnością dla platform C++ . Pobierz najnowszą wersję bezpośrednio z menedżera pakietów [NuGet](https://www.nuget.org/packages/aspose.barcode)&colon; wyszukaj **Aspose.BarCode.Cpp**, a następnie zainstaluj pakiet. Alternatywnie otwórz konsolę Menedżera pakietów i uruchom następujące polecenie:
...
<ul><li>Utwórz obiekt klasy BarcodeGenerator</li><li>Przekaż GS1 DataBar (wielokierunkowy, skumulowany wielokierunkowy, rozszerzony, rozszerzony skumulowany i obcięty) kod kreskowy jako parametr</li><li>Wstaw tekst wejściowy do zakodowania jako drugi parametr</li><li>W razie potrzeby zdefiniuj wymiary obrazu</li><li>Wywołaj metodę BarcodeGenerator.Save, aby pobrać kod kreskowy GS1 DataBar (wielokierunkowy, skumulowany wielokierunkowy, rozszerzony, rozszerzony skumulowany i obcięty) kod kreskowy</li></ul>
...
<ul><li>Microsoft Windows, Linux lub dowolny system operacyjny zgodny ze środowiskiem wykonawczym C++ dla 32-bitowego systemu Windows, 64-bitowego systemu Windows lub 64-bitowego systemu Linux.</li><li>Aspose.BarCode dla biblioteki DLL języka C++, o której mowa w Twój projekt</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/pdf417/generate/" name="PDF417" description="PDF417 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/qr/generate/" name="QR" description="QR Kod, GS1 QR Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/datamatrix/generate/" name="Data Matrix" description="Kod Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/aztec/generate/" name="Aztec" description="Kod Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/swiss-qr/generate/" name="Swiss QR" description="Swiss QR rachunek" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/dotcode/generate/" name="DotCode" description="DotCode kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/hibc/generate/" name="HIBC" description="HIBC (kod kreskowy branży medycznej)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/codablock/generate/" name="Codablock-F" description="Kody kreskowe Codablock-F i GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/databar/generate/" name="GS1 DataBar" description="GS1 DataBar (wielokierunkowy, skumulowany wielokierunkowy, rozszerzony, rozszerzony skumulowany i obcięty) kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/itf/generate/" name="ITF" description="Przeplatany kod kreskowy 2 z 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/ean/generate/" name="EAN" description="Kod kreskowy EAN (międzynarodowy numer artykułu)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/upc/generate/" name="UPC" description="Kod kreskowy UPC (uniwersalny kod produktu)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/code128/generate/" name="GS1 Code 128" description="GS1 Code 128 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/code39/generate/" name="Code 39" description="Code 39 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/code16k/generate/" name="Code 16K" description="Kod kreskowy Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/code32/generate/" name="Code 32" description="Włoski kod kreskowy Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/code93/generate/" name="Code 93" description="Kody kreskowe Code 93 rozszerzone i Code 93 standardowe" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/onecode/generate/" name="USPS OneCode" description="Kod kreskowy USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/standard2of5/generate/" name="Standard 2 of 5" description="Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/isbn/generate/" name="ISBN" description="ISBN kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/ismn/generate/" name="ISMN" description="ISMN kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/issn/generate/" name="ISSN" description="ISSN kod kreskowy" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/australia-post/generate/" name="Australia Post" description="Kod kreskowy Australia Post i Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Kod identyfikacyjny i Deutsche Post Kod identyfikacyjny" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/rm4scc/generate/" name="RM4SCC" description="Royal Mail 4-stanowy kod klienta (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/postnet/generate/" name="Postnet" description="Kod kreskowy Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/royal-mail/generate/" name="Royal Mail" description="Royal Mail kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/singapore-post/generate/" name="Singapore Post" description="Singapore Post kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/cpp/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
