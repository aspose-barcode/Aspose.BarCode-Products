---
title: Zeskanuj obrazy Przeplatany kod kreskowy 2 z 5 (ITF). za pomocą C++
weight: 1510
description: Przykładowy kod C++ do skanowania i dekodowania Przeplatany kod kreskowy 2 z 5 (ITF). w środowisku wykonawczym C++ dla 32-bitowego systemu Windows, 64-bitowego systemu Windows lub 64-bitowego systemu Linux.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/cpp/itf/recognize/
aliases:
- /pl/cpp/recognize/itf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Czytaj kody kreskowe ITF za pomocą C++" h2="Odczyt Przeplatany kod kreskowy 2 z 5 (ITF). w C++ przy użyciu Aspose.BarCode po stronie serwera dla C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Przeplatany kod kreskowy 2 z 5 (ITF). Using C++" %}}
Aby zeskanować Przeplatany kod kreskowy 2 z 5 (ITF)., wypróbuj [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, potężną i łatwą w użyciu bibliotekę kodów kreskowych z bogatą funkcjonalnością dla platform C++ . Możesz pobrać jego najnowszą wersję bezpośrednio&colon; po prostu otwórz menedżera pakietów [NuGet](https://www.nuget.org/packages/aspose.barcode), wyszukaj **Aspose.BarCode.Cpp** i zainstaluj pakiet. Alternatywnie możesz uruchomić następujące polecenie z konsoli Menedżera pakietów.
