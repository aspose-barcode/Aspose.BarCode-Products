---
title: Wygeneruj obrazy Przeplatany kod kreskowy 2 z 5 (ITF). za pomocą C++
description: Przykład kodu C++ do generowania kodu Przeplatany kod kreskowy 2 z 5 (ITF). w środowisku wykonawczym C++ dla 32-bitowych systemów Windows, 64-bitowych systemów Windows i 64-bitowych systemów Linux.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/cpp/itf/generate/
aliases:
- /pl/cpp/generate/itf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety ITF za pomocą C++" h2="Utwórz Przeplatany kod kreskowy 2 z 5 (ITF). w C++ przy użyciu Aspose.BarCode po stronie serwera dla C++ API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Przeplatany kod kreskowy 2 z 5 (ITF). Using C++" %}}
Aby wygenerować Przeplatany kod kreskowy 2 z 5 (ITF)., zainstaluj [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, niezawodną i łatwą w użyciu bibliotekę kodów kreskowych z bogatą funkcjonalnością dla platform C++ . Pobierz najnowszą wersję bezpośrednio z menedżera pakietów [NuGet](https://www.nuget.org/packages/aspose.barcode)&colon; wyszukaj **Aspose.BarCode.Cpp**, a następnie zainstaluj pakiet. Alternatywnie otwórz konsolę Menedżera pakietów i uruchom następujące polecenie:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Przeplatany kod kreskowy 2 z 5 (ITF). w C++" %}}
...
<ul><li>Utwórz obiekt klasy BarcodeGenerator</li><li>Przekaż Przeplatany kod kreskowy 2 z 5 (ITF). jako parametr</li><li>Wstaw tekst wejściowy do zakodowania jako drugi parametr</li><li>W razie potrzeby zdefiniuj wymiary obrazu</li><li>Wywołaj metodę BarcodeGenerator.Save, aby pobrać kod kreskowy Przeplatany kod kreskowy 2 z 5 (ITF).</li></ul>
