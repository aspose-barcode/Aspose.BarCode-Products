---
title: Interfejs API Androida z kodami kreskowymi | Skanuj lub generuj kody kreskowe
description: Biblioteka skanera kodów kreskowych Androida do rozpoznawania różnych rodzajów kodów kreskowych 1D, 2D i pocztowych. Skanuj kody kreskowe pod dowolnym kątem w aplikacjach na Androida.
lang: pl/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Interfejsy API systemu Android do generowania i rozpoznawania kodów kreskowych" h2="Twórz lub czytaj kody kreskowe 1D, 2D i pocztowe z obrazów w dowolnej aplikacji mobilnej na Androida." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" pfName="Aspose.BarCode" subTitlepfName="dla Android via Java" downloadUrl="https://releases.aspose.com/barcode/androidjava/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.BarCode" subTitlepfName="dla Android via Java" >}}
...
<p>Aspose.BarCode dla Androida przez Javę to interfejs API do generowania i odczytu kodów kreskowych dla aplikacji na Androida. Obsługuje skanowanie kodów kreskowych 1D, 2D i pocztowych z obrazów pod różnymi kątami. API generatora kodów kreskowych może łatwo tworzyć obrazy kodów kreskowych i zapisywać je w różnych formatach. Zapewnia również bogate funkcje obrazowania, takie jak dostosowywanie obramowań kodów kreskowych, kolorów, kątów obrotu, rozdzielczości i wiele więcej.</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="w skrócie" description="Przegląd funkcji API do rozpoznawania i generowania kodów kreskowych." >}}
<div class='diagram1 d1-android'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>Liniowe, 2D i pocztowe</li><li>Wykrywanie ze strumienia lub obrazu</li><li>Pobieranie orientacji kodu kreskowego</li><li>Dekodowanie znaków innych niż angielskie</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                Druk
            </header>
            <ul><li>Drukuj bezpośrednio kod kreskowy</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>Liniowe, 2D i pocztowe</li><li>Zapisz w strumieniu lub obrazie</li><li>Dostosuj wygląd&colon; rozmiar, kolor, kąt</li><li>Koduj znaki inne niż angielskie </li></ul>
            <header>
                <i class="fa fa-qrcode">
                </i>
                typy
            </header>
            <ul><li>Liniowy</li><li>2D</li><li>Pocztowy</li></ul>
        </div>
        <!--/right-->
    </div>
    <!--/row-->
...
{{< blocks/products/pf/carousel-item h3="Niezależność Platformy" description="Korzystaj z interfejsu API na dowolnej platformie, na której dostępne jest środowisko wykonawcze systemu Android." >}}
<div class='diagram1 d1-android'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Obsługiwane formaty plików" description="Aspose.BarCode dla Android via Java współpracuje z najczęściej używanymi formatami plików graficznych." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Zaawansowane funkcje interfejsu API kodów kreskowych systemu Android
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/qr-code-generation/'>Koduj znaki inne niż angielskie w kodach QR</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-color-modification/'>Zmodyfikuj schemat kolorów kodu kreskowego</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-appearance-customization/'>Obracaj obrazy kodów kreskowych pod dowolnym kątem</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/working-with-barcode-types/'>Generuj i rozpoznawaj kody kreskowe ponad 60 typów</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/recognition-settings/'>Odczytywanie kodów kreskowych z obrazów</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-image-saving/'>Eksportuj kody kreskowe w różnych formatach graficznych</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Twórz niestandardowe kody kreskowe
                </h2>
                <p>
                    Biblioteka kodów kreskowych dla Android via Java umożliwia programistom dostosowanie niektórych typowych parametrów kodów kreskowych, w tym typu kodu kreskowego, danych do zakodowania, rozmiaru kodu kreskowego, stylu i koloru czcionki oraz kąta orientacji. Aby wygenerować kod kreskowy, należy wybrać wymagany typ kodu kreskowego do utworzenia, np. UPC lub EAN. Należy również wprowadzić dane, które mają być zapisane w kodzie kreskowym, takie jak numer produktu czy adres URL. Ponadto możesz ustawić wymagany tryb zmiany rozmiaru i dostosować kolor elementów kodu kreskowego, rozdzielczość, styl obramowania i inne parametry związane z wyglądem. Istnieje możliwość modyfikacji szerokości prętów oraz rozstawu między nimi. Te dodatkowe parametry mogą wpływać na czytelność i jakość kodów kreskowych, dlatego ważne jest zrozumienie ich przeznaczenia i sposobu ich prawidłowego dostosowania.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Interfejs API generatora kodów kreskowych może tworzyć kody kreskowe, określając wymagany typ, ustawiając tekst wejściowy (dane do zakodowania w kodzie kreskowym) i dostosowując właściwości związane z wyglądem, takie jak kolor tła i pierwszego planu, czcionka i podpisy tekstowe. Dwuwymiarowe kody kreskowe, takie jak PDF417, Data Matrix, Aztec Code, QR Code i Micro QR Code można generować w taki sam sposób, jak typy 1D.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    API kodów kreskowych umożliwia wykrywanie i odczyt kodów kreskowych ponad 60 popularnych typów 1D i 2D. Do skanowania kodów kreskowych wystarczy kilka wierszy kodu, co ułatwia integrację tej funkcji z aplikacjami. Ta potężna funkcja umożliwia skanowanie i odczytywanie kodów kreskowych z szerokiej gamy źródeł, takich jak obrazy, dokumenty itp. Może służyć do automatyzacji procesów, zmniejszenia ryzyka błędów i poprawy ogólnej wydajności operacji. Niezależnie od tego, czy potrzebujesz opracować aplikacje dla handlu detalicznego, logistyki, opieki zdrowotnej czy jakiejkolwiek innej dziedziny, ten interfejs API kodów kreskowych może zapewnić rozwiązanie do zadań związanych z wykrywaniem i odczytywaniem kodów kreskowych.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
    ...
    <div class="barcode-read-lcs-controls">
        ...
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">Wszystkie typy</option>
                <option value="Pdf417 ">PDF417</option>
                <option value="QR ">QR</option>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/pdf417/" name="PDF417" description="PDF417 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/qr/" name="QR" description="QR Kod, GS1 QR Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/datamatrix/" name="Data Matrix" description="Kod Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/aztec/" name="Aztec" description="Kod Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/swiss-qr/" name="Swiss QR" description="Swiss QR rachunek" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/dotcode/" name="DotCode" description="DotCode kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/hibc/" name="HIBC" description="HIBC (kod kreskowy branży medycznej)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/codablock/" name="Codablock-F" description="Kody kreskowe Codablock-F i GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/databar/" name="GS1 DataBar" description="GS1 DataBar (wielokierunkowy, skumulowany wielokierunkowy, rozszerzony, rozszerzony skumulowany i obcięty) kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/itf/" name="ITF" description="Przeplatany kod kreskowy 2 z 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/ean/" name="EAN" description="Kod kreskowy EAN (międzynarodowy numer artykułu)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/upc/" name="UPC" description="Kod kreskowy UPC (uniwersalny kod produktu)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/code128/" name="GS1 Code 128" description="GS1 Code 128 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/code39/" name="Code 39" description="Code 39 kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/code16k/" name="Code 16K" description="Kod kreskowy Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/code32/" name="Code 32" description="Włoski kod kreskowy Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/code93/" name="Code 93" description="Kody kreskowe Code 93 rozszerzone i Code 93 standardowe" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/onecode/" name="USPS OneCode" description="Kod kreskowy USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (przemysłowy 2 z 5) kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/isbn/" name="ISBN" description="ISBN kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/ismn/" name="ISMN" description="ISMN kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/issn/" name="ISSN" description="ISSN kod kreskowy" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/australia-post/" name="Australia Post" description="Kod kreskowy Australia Post i Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Kod identyfikacyjny i Deutsche Post Kod identyfikacyjny" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/rm4scc/" name="RM4SCC" description="Royal Mail 4-stanowy kod klienta (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/postnet/" name="Postnet" description="Kod kreskowy Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/royal-mail/" name="Royal Mail" description="Royal Mail kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/singapore-post/" name="Singapore Post" description="Singapore Post kod kreskowy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/pl/android-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="Co ludzie mówią" subTitle="Nie wierz nam tylko na słowo. Zobacz, co użytkownicy mają do powiedzenia na temat interfejsów API." caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 Spędziłem wiele lat na opracowywaniu i ulepszaniu mojego produktu, a Aspose pozwoliło mi uczynić go znacznie bardziej przyjaznym i użytecznym, a przez to bardziej dostępnym na rynku. <em>Kilonia Diller | KD Solutions, Polska</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode jest naprawdę napisany w zarządzanym kodzie i daje nam różnorodne typy kodów kreskowych do obsługi wszelkiego rodzaju rozpoznawania dokumentów i dalszego przetwarzania. <em>Dennis Alexander Petrasc | Keil IT, Niemcy</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Dokumentacja" href="https://docs.aspose.com/barcode/java/" >}}
{{< blocks/products/pf/slr-element name="Kod źródłowy" href="https://github.com/aspose-barcode/Android-Library-Usage-Examples" >}}
{{< blocks/products/pf/slr-element name="Referencje API" href="https://reference.aspose.com/barcode/androidjava/" >}}
...
{{< blocks/products/pf/slr-element name="Informacje o wydaniu" href="https://docs.aspose.com/barcode/java/android-via-java-release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Dlaczego Aspose.BarCode dla Android via Java?" tabId="success-stories" >}}
{{< blocks/products/pf/slr-element name="Lista klientów" href="https://about.aspose.com/customers" >}}
{{< blocks/products/pf/slr-element name="Historie sukcesów" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Aspose.BarCode oferuje indywidualne interfejsy API do generowania i rozpoznawania kodów kreskowych dla innych popularnych środowisk programistycznych, wymienionych poniżej:" >}}
