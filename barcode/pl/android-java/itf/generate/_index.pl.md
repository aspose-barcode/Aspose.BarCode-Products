---
title: Wygeneruj obrazy Przeplatany kod kreskowy 2 z 5 (ITF). za pomocą Android via Java
description: Kod źródłowy Androida do utworzenia Przeplatany kod kreskowy 2 z 5 (ITF). w Android Runtime Environment.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/android-java/itf/generate/
aliases:
- /pl/android-java/generate/itf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Wygeneruj etykiety ITF za pomocą Android via Java" h2="Utwórz Przeplatany kod kreskowy 2 z 5 (ITF). w Java przy użyciu Aspose.BarCode po stronie serwera dla Android via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Przeplatany kod kreskowy 2 z 5 (ITF). Using Android via Java" %}}
Wypróbuj Aspose.BarCode dla Androida przez Javę, aby łatwo utworzyć Przeplatany kod kreskowy 2 z 5 (ITF). w aplikacjach na Androida. Jest to wszechstronna, solidna i przyjazna dla użytkownika biblioteka kodów kreskowych zaprojektowana specjalnie dla aplikacji na Androida. Możesz łatwo Aspose.BarCode dla Androida przez Javę bezpośrednio z projektu opartego na Maven, wstawiając następujące konfiguracje do build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować Przeplatany kod kreskowy 2 z 5 (ITF). w Java" %}}
...
<ul><li>Utwórz nową instancję klasy BarCodeGenerator</li><li>Przekaż typ kodu kreskowego Przeplatany kod kreskowy 2 z 5 (ITF). jako parametr EncodeTypes</li><li>Definiuj tekst kodu kreskowego za pomocą metody setCodeText</li><li>Uruchom metodę generateBarCodeImage(), aby zapisać obraz kodu kreskowego Przeplatany kod kreskowy 2 z 5 (ITF).</li></ul>
