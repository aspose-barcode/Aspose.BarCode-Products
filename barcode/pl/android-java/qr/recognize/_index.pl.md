---
title: Zeskanuj obrazy QR Kod, GS1 QR Kod za pomocą Android via Java
weight: 1510
description: Przykładowy kod Androida do rozpoznawania QR Kod, GS1 QR Kod w Android Runtime Environment.
lang: pl
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /pl/android-java/qr/recognize/
aliases:
- /pl/android-java/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Czytaj kody kreskowe QR za pomocą Android via Java" h2="Odczyt QR Kod, GS1 QR Kod w Java przy użyciu Aspose.BarCode po stronie serwera dla Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Kod QR Using Android via Java" %}}
Wypróbuj Aspose.BarCode dla Androida przez Javę, aby łatwo wykryć i odczytać kod Kod QR w aplikacjach na Androida. Jest to bogaty, skalowalny i przyjazny dla użytkownika interfejs API kodów kreskowych przeznaczony dla aplikacji na Androida. Uzyskaj Aspose.BarCode for Java bezpośrednio z projektu opartego na Maven, dodając następujące konfiguracje do pliku build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Instrukcje skanowania Kod QR w Java" %}}
...
<ul><li>Utwórz instancję klasy BarCodeReader</li><li>Określ ścieżkę obrazu źródłowego zawierającą Kod QR</li><li>Zdefiniuj docelowe typy kodów kreskowych w DecodeType jako drugi parametr</li><li>Przejrzyj wyniki rozpoznawania w pętli</li><li>Załaduj zdekodowany tekst, uruchamiając metodę getCodeText</li></ul>
