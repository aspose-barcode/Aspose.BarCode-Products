---
title: Zeskanuj obrazy Włoski kod kreskowy Pharmacode (Code 32). za pomocą Android via Java
weight: 1510
description: Przykładowy kod Androida do rozpoznawania Włoski kod kreskowy Pharmacode (Code 32). w Android Runtime Environment.
lang: pl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /pl/android-java/code32/recognize/
aliases:
- /pl/android-java/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Czytaj kody kreskowe Code 32 za pomocą Android via Java" h2="Odczyt Włoski kod kreskowy Pharmacode (Code 32). w Java przy użyciu Aspose.BarCode po stronie serwera dla Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 32 kod kreskowy Using Android via Java" %}}
Wypróbuj Aspose.BarCode dla Androida przez Javę, aby łatwo wykryć i odczytać kod Code 32 kod kreskowy w aplikacjach na Androida. Jest to bogaty, skalowalny i przyjazny dla użytkownika interfejs API kodów kreskowych przeznaczony dla aplikacji na Androida. Uzyskaj Aspose.BarCode for Java bezpośrednio z projektu opartego na Maven, dodając następujące konfiguracje do pliku build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Instrukcje skanowania Code 32 kod kreskowy w Java" %}}
