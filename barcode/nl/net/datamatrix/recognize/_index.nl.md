---
title: Scan Data Matrix-code afbeeldingen via .NET
weight: 1510
description: C#-voorbeeldcode om Data Matrix-code-barcodetype te scannen en te decoderen in .NET Framework, .NET Standard, COM Interloop voor PHP, VBScript, Delphi of C++.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/net/datamatrix/recognize/
aliases:
- /nl/net/recognize/datamatrix/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lees Data Matrix streepjescodes met .NET" h2="Lees Data Matrix-code in C# met behulp van server-side Aspose.BarCode voor .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Data Matrix" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Om Data Matrix-code te decoderen, probeert u [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, een functierijke, krachtige en gebruiksvriendelijke barcodebibliotheek voor C#-platforms. Gebruik [NuGet](https://www.nuget.org/packages/aspose.barcode) en zoek naar **Aspose.BarCode** om het pakket te installeren. U kunt ook de volgende opdracht uitvoeren vanaf de Package Manager-console:
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het scannen van Data Matrix-code in C#" %}}

{{% blocks/products/pf/agp/text %}}

Met Aspose.BarCode kunnen ontwikkelaars Data Matrix-code-streepjescodes uit een stream of afbeelding lezen met een paar regels code

{{% /blocks/products/pf/agp/text %}}

<ul><li>Maak een nieuwe instantie van de klasse Aspose.BarCode.BarCodeReader</li><li>Geef het pad van de bronafbeelding met Data Matrix-code door als parameter</li><li>Geef een geschikt DecodeType door als de tweede parameter</li><li>Loop door de decoderingsresultaten</li><li>Haal streepjescodetekst op met behulp van de eigenschap CodeText</li></ul>
