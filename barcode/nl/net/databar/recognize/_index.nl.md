---
title: Scan GS1 DataBar (omnidirectioneel, gestapeld omnidirectioneel, uitgevouwen, uitgevouwen gestapeld en afgekapt) streepjescode afbeeldingen via .NET
weight: 1510
description: C#-voorbeeldcode om GS1 DataBar (omnidirectioneel, gestapeld omnidirectioneel, uitgevouwen, uitgevouwen gestapeld en afgekapt) streepjescode-barcodetype te scannen en te decoderen in .NET Framework, .NET Standard, COM Interloop voor PHP, VBScript, Delphi of C++.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/net/databar/recognize/
aliases:
- /nl/net/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lees GS1 DataBar streepjescodes met .NET" h2="Lees GS1 DataBar (omnidirectioneel, gestapeld omnidirectioneel, uitgevouwen, uitgevouwen gestapeld en afgekapt) streepjescode in C# met behulp van server-side Aspose.BarCode voor .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 DataBar streepjescode Using .NET" %}}
Om GS1 DataBar streepjescode te decoderen, probeert u [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, een functierijke, krachtige en gebruiksvriendelijke barcodebibliotheek voor C#-platforms. Gebruik [NuGet](https://www.nuget.org/packages/aspose.barcode) en zoek naar **Aspose.BarCode** om het pakket te installeren. U kunt ook de volgende opdracht uitvoeren vanaf de Package Manager-console:
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het scannen van GS1 DataBar streepjescode in C#" %}}
...
<ul><li>Maak een nieuwe instantie van de klasse Aspose.BarCode.BarCodeReader</li><li>Geef het pad van de bronafbeelding met GS1 DataBar streepjescode door als parameter</li><li>Geef een geschikt DecodeType door als de tweede parameter</li><li>Loop door de decoderingsresultaten</li><li>Haal streepjescodetekst op met behulp van de eigenschap CodeText</li></ul>
...
<ul><li>Microsoft Windows, Linux of elk besturingssysteem dat compatibel is met .NET Framework, .NET Standard, COM Interloop voor PHP, VBScript, Delphi of C++</li><li>Ontwikkelomgeving, zoals Microsoft Visual Studio .</li><li>Aspose.BarCode voor .NET-bibliotheek-DLL waarnaar wordt verwezen in uw project - Installeer vanuit NuGet met behulp van de downloadknop</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/pdf417/recognize/" name="PDF417" description="PDF417 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/qr/recognize/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/datamatrix/recognize/" name="Data Matrix" description="Data Matrix-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/aztec/recognize/" name="Aztec" description="Aztec-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR rekening" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/dotcode/recognize/" name="DotCode" description="DotCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/hibc/recognize/" name="HIBC" description="HIBC (streepjescode voor de gezondheidsindustrie)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/codablock/recognize/" name="Codablock-F" description="Codablock-F en GS1 Codablock-F streepjescodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (omnidirectioneel, gestapeld omnidirectioneel, uitgevouwen, uitgevouwen gestapeld en afgekapt) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/itf/recognize/" name="ITF" description="Doorschoten 2-van-5 (ITF) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/ean/recognize/" name="EAN" description="EAN (internationaal artikelnummer) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/upc/recognize/" name="UPC" description="UPC (Universele productcode) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/code39/recognize/" name="Code 39" description="Code 39 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/code16k/recognize/" name="Code 16K" description="Code 16K streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/code32/recognize/" name="Code 32" description="Italiaanse farmacode (Code 32) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/code93/recognize/" name="Code 93" description="Code 93 Uitgebreide en Code 93 Standaard barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/onecode/recognize/" name="USPS OneCode" description="USPS OneCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriële 2 van 5) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/isbn/recognize/" name="ISBN" description="ISBN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/ismn/recognize/" name="ISMN" description="ISMN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/issn/recognize/" name="ISSN" description="ISSN streepjescode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/australia-post/recognize/" name="Australia Post" description="Australia Post streepjescode en Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode en Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4-Staten klantcode (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/postnet/recognize/" name="Postnet" description="Postnet barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/royal-mail/recognize/" name="Royal Mail" description="Royal Mail streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/singapore-post/recognize/" name="Singapore Post" description="Singapore Post streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/net/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
