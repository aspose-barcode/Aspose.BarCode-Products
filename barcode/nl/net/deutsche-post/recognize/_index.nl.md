---
title: Scan Deutsche Post Identcode en Deutsche Post Leitcode afbeeldingen via .NET
weight: 1510
description: C#-voorbeeldcode om Deutsche Post Identcode en Deutsche Post Leitcode-barcodetype te scannen en te decoderen in .NET Framework, .NET Standard, COM Interloop voor PHP, VBScript, Delphi of C++.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/net/deutsche-post/recognize/
aliases:
- /nl/net/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lees Deutsche Post streepjescodes met .NET" h2="Lees Deutsche Post Identcode en Deutsche Post Leitcode in C# met behulp van server-side Aspose.BarCode voor .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Deutsche Post streepjescode Using .NET" %}}
Om Deutsche Post streepjescode te decoderen, probeert u [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, een functierijke, krachtige en gebruiksvriendelijke barcodebibliotheek voor C#-platforms. Gebruik [NuGet](https://www.nuget.org/packages/aspose.barcode) en zoek naar **Aspose.BarCode** om het pakket te installeren. U kunt ook de volgende opdracht uitvoeren vanaf de Package Manager-console:
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het scannen van Deutsche Post streepjescode in C#" %}}
...
<ul><li>Maak een nieuwe instantie van de klasse Aspose.BarCode.BarCodeReader</li><li>Geef het pad van de bronafbeelding met Deutsche Post streepjescode door als parameter</li><li>Geef een geschikt DecodeType door als de tweede parameter</li><li>Loop door de decoderingsresultaten</li><li>Haal streepjescodetekst op met behulp van de eigenschap CodeText</li></ul>
