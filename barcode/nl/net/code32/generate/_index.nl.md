---
title: Genereer Italiaanse farmacode (Code 32) streepjescode afbeeldingen via .NET
description: C#-broncode voor het genereren van Italiaanse farmacode (Code 32) streepjescode in .NET Framework, .NET Standard, COM Interloop voor PHP, VBScript, Delphi en C++.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/net/code32/generate/
aliases:
- /nl/net/generate/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genereer Code 32-labels met .NET" h2="Maak Italiaanse farmacode (Code 32) streepjescode in C# met Aspose.BarCode aan de serverzijde voor .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Code 32 streepjescode Using .NET" %}}
Om Code 32 streepjescode te maken, probeert u [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, een veelzijdige, krachtige en gebruiksvriendelijke barcodebibliotheek voor C#-platforms. Open de [NuGet](https://www.nuget.org/packages/aspose.barcode) pakketbeheerder, zoek naar **Aspose.BarCode** en installeer het pakket. U kunt ook de volgende opdracht uitvoeren vanaf de Package Manager-console:
...
<ul><li>Maak een instantie van BarcodeGenerator-klasse</li><li>Geef Italiaanse farmacode (Code 32) streepjescode door als parameter</li><li>Stel tekst in om te coderen als de tweede parameter</li><li> Geef indien nodig de afmetingen van de streepjescode op</li><li>Roep de methode BarcodeGenerator.Save aan om de afbeelding Italiaanse farmacode (Code 32) streepjescode te verkrijgen</li></ul>
