---
title: Python-streepjescodegenerator en scanner-API
description: Python-barcodelezerbibliotheek om meerdere soorten streepjescodes te herkennen en te genereren, waaronder 1D, 2D en Postal. Gebruik API in Python-toepassingen.
lang: nl/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Python Barcode-bibliotheek" h2="Herken of genereer 1D-, 2D- en postbarcodes in elke Python-toepassing." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-net.svg" pfName="Aspose.BarCode" subTitlepfName="voor Python via .NET" downloadUrl="https://releases.aspose.com/barcode/python-net" >}}
...
<p>Aspose.BarCode voor Python via NET is een set API's voor het genereren en lezen van streepjescodes die in Python-toepassingen moeten worden geïntegreerd. Ontwikkelaars kunnen eenvoudig functionaliteit voor het genereren en herkennen van streepjescodes toevoegen. Python barcode API maakt barcode-afbeeldingen in verschillende formaten zoals PNG, JPG, GIF, BMP. Bovendien ondersteunt het meerdere beeldfuncties, zoals het manipuleren van randen, kleur, roterende afbeeldingen, het aanpassen van de resolutie en nog veel meer.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Platformonafhankelijkheid" description="Aspose.Barcode voor Python via NET is beschikbaar voor Python 3.6 en hoger." >}}
<div class='diagram1 d1-python'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Ondersteunde bestandsindelingen" description="Aspose.BarCode voor Python via .NET werkt met de meest gebruikte indelingen voor afbeeldingsbestanden." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Geavanceerde Python via .NET Barcode API-functies
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/swiss-qr-code/'>Zwitserse QR-code</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/manage-barcode-appearance/'>Pas de weergave van de streepjescode aan</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/barcode-text-settings/'>Beheer streepjescodetekstinstellingen</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/generate-1d-barcodes/'>Speciale parameters van 1D-streepjescodetypen</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/generate-qr-code/'>Genereer QR-code en Micro QR-code</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/barcode-reading-presets/'>Kwaliteitsopties en voorinstellingen voor het lezen van streepjescodes</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Barcodeparameters aanpassen
                </h2>
                <p>
                    Aspose.BarCode voor Python via .NET biedt uitgebreide functionaliteit om aangepaste barcodeafbeeldingen te maken. Het maakt het genereren van streepjescodes van elke kleur of grootte mogelijk, afhankelijk van de zakelijke behoeften. Het is mogelijk om het uiterlijk van alle streepjescode-elementen aan te passen, inclusief kleuren van balken, achtergrond, randen en tekstbijschriften, evenals hun positionering. Barcode kan worden gegenereerd met of zonder weergave van invoertekst, bovenste en/of onderste bijschrift, opvullingen en randen. De grootte van de streepjescode kan automatisch worden ingesteld afhankelijk van de X-dimensie of handmatig. Het kan worden gedefinieerd in verschillende eenheden, zoals millimeters, inches, punten of pixels. Indien nodig kunnen beeldverhoudingen en resolutie worden aangepast. Het lettertype van de tekst kan ook worden aangepast.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
            <div class="col-lg-12">
                ...
                <p>
                    API heeft de mogelijkheid om 2D-streepjescodes van de meest populaire typen te genereren, zoals Data Matrix, Aztec Code, PDF417, enz. Deze typen maken het mogelijk om grote of niet-standaard invoerwaarden te coderen. Hier is de code voor het genereren van QR-codes.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Optimaliseer de leessnelheid of -kwaliteit van de streepjescode
                </h2>
                <p>
                    De streepjescodebibliotheek biedt een reeks krachtige functies voor het optimaliseren van het lezen van streepjescodes om aan de specifieke behoeften van uw bedrijf te voldoen. Ontwikkelaars kunnen de parameters van de herkenningsengine aanpassen om snel scannen van streepjescodes mogelijk te maken of de leesprecisie te verbeteren. Afhankelijk van de kwaliteit en parameters van de bronstreepjescodebeelden, maakt de bibliotheek het mogelijk om het herkenningsproces aan te passen. Het bevat verschillende vooraf ingestelde configuraties van dergelijke parameters, die kunnen worden gebruikt om snel hoogwaardige barcodeafbeeldingen te scannen of om het decoderen van beschadigde of verslechterde barcodes te vergemakkelijken. Daarnaast zijn er speciale instellingen die het lezen van streepjescodes kunnen verbeteren voor verschillende soorten vervormingen, zoals Gaussiaanse ruis, witte vlekken en omgekeerde kleuren. Met de mogelijkheid om het herkenningsproces te verfijnen, kan de API worden aangepast om de meest efficiënte barcodelezing te bieden voor een breed scala aan toepassingen en scenario's.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/pdf417/" name="PDF417" description="PDF417 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/qr/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/datamatrix/" name="Data Matrix" description="Data Matrix-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/aztec/" name="Aztec" description="Aztec-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/swiss-qr/" name="Swiss QR" description="Swiss QR rekening" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/dotcode/" name="DotCode" description="DotCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/hibc/" name="HIBC" description="HIBC (streepjescode voor de gezondheidsindustrie)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/codablock/" name="Codablock-F" description="Codablock-F en GS1 Codablock-F streepjescodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/databar/" name="GS1 DataBar" description="GS1 DataBar (omnidirectioneel, gestapeld omnidirectioneel, uitgevouwen, uitgevouwen gestapeld en afgekapt) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/itf/" name="ITF" description="Doorschoten 2-van-5 (ITF) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/ean/" name="EAN" description="EAN (internationaal artikelnummer) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/upc/" name="UPC" description="UPC (Universele productcode) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/code128/" name="GS1 Code 128" description="GS1 Code 128 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/code39/" name="Code 39" description="Code 39 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/code16k/" name="Code 16K" description="Code 16K streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/code32/" name="Code 32" description="Italiaanse farmacode (Code 32) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/code93/" name="Code 93" description="Code 93 Uitgebreide en Code 93 Standaard barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/onecode/" name="USPS OneCode" description="USPS OneCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriële 2 van 5) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/isbn/" name="ISBN" description="ISBN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/ismn/" name="ISMN" description="ISMN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/issn/" name="ISSN" description="ISSN streepjescode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/australia-post/" name="Australia Post" description="Australia Post streepjescode en Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode en Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/rm4scc/" name="RM4SCC" description="Royal Mail 4-Staten klantcode (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/postnet/" name="Postnet" description="Postnet barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/royal-mail/" name="Royal Mail" description="Royal Mail streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/singapore-post/" name="Singapore Post" description="Singapore Post streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/python-net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Documentatie" href="https://docs.aspose.com/barcode/python-net/" >}}
{{< blocks/products/pf/slr-element name="Broncode" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Python-via-.NET" >}}
{{< blocks/products/pf/slr-element name="API-referenties" href="https://docs.aspose.com/barcode/python-net/api-reference/" >}}
...
{{< blocks/products/pf/slr-element name="Release-opmerkingen" href="https://docs.aspose.com/barcode/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Waarom Aspose.BarCode voor Python via .NET?" tabId="success-stories" >}}
