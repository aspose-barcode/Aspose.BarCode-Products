---
title: Nodejs barcodescanner en generator-API
description: Node.js barcodescanning en generatiebibliotheek voor 1D-, 2D- en posttypes. Integreer eenvoudig in React Angular-apps voor QR Code maxicode Aztec Code128 EAN-128 en meer.
lang: nl/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Node.js streepjescodegenerator en scanner-API" h2="Herken of genereer 1D-, 2D- en postbarcodes, waaronder Code128, Code93, Code39, QR-code van verschillende afbeeldingen." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" pfName="Aspose.BarCode" subTitlepfName="voor Node.js via Java" downloadUrl="https://releases.aspose.com/barcode/nodejs/" >}}
...
<p>Aspose.BarCode voor Node.js via Java is een eenvoudig aanpasbare barcodegenerator en decoder-API. Ontwikkelaars kunnen de functionaliteit voor het genereren en lezen van streepjescodes integreren in hun toepassingen via de nodejs-java-brug. Het kan worden gebruikt om algemene 1D-, 2D- en postbarcodes uit afbeeldingen vanuit elke hoek te lezen. Met deze streepjescodebibliotheek kunnen ontwikkelaars streepjescodeafbeeldingen van meer dan 60 soorten genereren en opslaan in verschillende indelingen, zoals JPG, PNG, GIF, BMP en TIFF. Het ondersteunt het aanpassen van verschillende beeldfuncties, zoals de kleur en stijl van de streepjescoderand, marges, rotatiehoek, resolutie en streepjescodekleur.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Platformonafhankelijkheid" description="Aspose.BarCode voor Node.js via Java is een server-side JavaScript API gebaseerd op Node.js. Het kan worden uitgevoerd op Windows-, Unix/Linux- en Mac-platforms met JDK 1.7 of hoger." >}}
<div class='diagram1 d1-nodejs'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Ondersteunde bestandsindelingen" description="Aspose.BarCode voor Node.js via Java werkt met de meest gebruikte indelingen voor afbeeldingsbestanden." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Geavanceerde Node.js Barcode API-functies
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/nodejsjava/supported-barcode-types-and-formats/#barcode-types'>Genereer en scan meer dan 60 soorten streepjescodes</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/nodejsjava/set-barcode-text/'>Pas streepjescode-onderschriften en letterstijlen aan</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/nodejsjava/barcode-reading-settings/#checksum-verification'>Voer checksum-validatie uit</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Genereer Zwitserse QR-code
                </h2>
                <p>
                    Naast 2D-barcodes en QR-codes maakt de barcodebibliotheek het genereren en lezen van Zwitserse QR-codes mogelijk. Ze zijn gebaseerd op de QR-code (Quick Response) en worden in Zwitserland gebruikt om betalingen tussen bedrijven en particulieren te vergemakkelijken. QR-codes zijn tweedimensionale streepjescodes die kunnen worden gescand met een smartphone of ander apparaat om snel en eenvoudig toegang te krijgen tot informatie of een actie uit te voeren. Zwitserse QR-codes zijn een nationale standaard voor elektronische betalingen in Zwitserland. Ze worden door bedrijven gebruikt om betalingen van klanten te ontvangen. Wanneer een klant een Zwitserse QR-code scant, krijgt hij betalingsinformatie en kan hij een betaling starten vanuit zijn app voor mobiel bankieren. Dit biedt een handige en veilige manier voor bedrijven om betalingen van hun klanten te accepteren. Zwitserse QR-codes worden veel gebruikt in verschillende sectoren, waaronder de detailhandel, horeca en gezondheidszorg. Om een ​​Zwitserse QR-code te genereren, moet u de nodige informatie verstrekken, zoals uw bedrijfsnaam, bankrekeninggegevens en het bedrag van de betaling. De Aspose QR-codegenerator gebruikt deze informatie om een ​​Zwitserse QR-code te maken die vervolgens door uw klanten kan worden gescand om een ​​betaling te initiëren. Zodra de QR-code is gegenereerd, kunt u deze downloaden en in uw bedrijf gebruiken om betalingen van uw klanten te accepteren.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Live voorbeeld van het genereren van QR-codes
                </h2>
                <p>
                    Met de streepjescodebibliotheek kunnen ontwikkelaars een breed scala aan 2D-streepjescodes genereren, waaronder Data Matrix, Aztec Code, PDF417, Macro PDF417 en andere. Het is vooral handig voor het genereren van grote of meerdere streepjescodes die lange of complexe gegevenswaarden bevatten. De bibliotheek biedt een eenvoudige en intuïtieve interface voor het specificeren van het type streepjescode dat moet worden gegenereerd, het invoeren van de invoergegevens die moeten worden opgeslagen en het instellen van uiterlijkgerelateerde parameters. Dit maakt het een gebruiksvriendelijke en krachtige tool voor het maken van hoogwaardige barcodes voor verschillende toepassingen. Het onderstaande codevoorbeeld laat zien hoe u QR-codes maakt.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Optimaliseer het lezen van streepjescodes
                </h2>
                <p>
                    Aspose.Barcode voor C++ is een uitgebreide barcodebibliotheek voor het werken met barcodes in een breed scala aan toepassingen. Een van de belangrijkste kenmerken is de mogelijkheid om het herkenningsproces te verfijnen om zowel de kwaliteit als de snelheid van barcodedetectie te optimaliseren. De bibliotheek biedt verschillende geavanceerde instellingen die kunnen worden gebruikt om het scannen van streepjescodes te optimaliseren, afhankelijk van de specifieke behoeften van een toepassing. De bibliotheek biedt bijvoorbeeld speciale leesmodi waarmee snel hoogwaardige lineaire barcodes kunnen worden gescand. Dit kan handig zijn in toepassingen die snel grote hoeveelheden streepjescodegegevens moeten verwerken. Bovendien stelt de bibliotheek ontwikkelaars in staat om doelscanregio's en barcodetypes te specificeren, wat de nauwkeurigheid van de scan kan verbeteren door zich te concentreren op de meest relevante delen van de afbeelding. De API ondersteunt ook het detecteren van meerdere streepjescodes in één afbeelding, wat handig kan zijn in toepassingen die meerdere streepjescodes tegelijk moeten verwerken.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/pdf417/" name="PDF417" description="PDF417 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/qr/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/datamatrix/" name="Data Matrix" description="Data Matrix-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/aztec/" name="Aztec" description="Aztec-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/swiss-qr/" name="Swiss QR" description="Swiss QR rekening" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/dotcode/" name="DotCode" description="DotCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/hibc/" name="HIBC" description="HIBC (streepjescode voor de gezondheidsindustrie)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/codablock/" name="Codablock-F" description="Codablock-F en GS1 Codablock-F streepjescodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/databar/" name="GS1 DataBar" description="GS1 DataBar (omnidirectioneel, gestapeld omnidirectioneel, uitgevouwen, uitgevouwen gestapeld en afgekapt) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/itf/" name="ITF" description="Doorschoten 2-van-5 (ITF) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/ean/" name="EAN" description="EAN (internationaal artikelnummer) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/upc/" name="UPC" description="UPC (Universele productcode) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/code128/" name="GS1 Code 128" description="GS1 Code 128 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/code39/" name="Code 39" description="Code 39 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/code16k/" name="Code 16K" description="Code 16K streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/code32/" name="Code 32" description="Italiaanse farmacode (Code 32) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/code93/" name="Code 93" description="Code 93 Uitgebreide en Code 93 Standaard barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/onecode/" name="USPS OneCode" description="USPS OneCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriële 2 van 5) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/isbn/" name="ISBN" description="ISBN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/ismn/" name="ISMN" description="ISMN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/issn/" name="ISSN" description="ISSN streepjescode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/australia-post/" name="Australia Post" description="Australia Post streepjescode en Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode en Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/rm4scc/" name="RM4SCC" description="Royal Mail 4-Staten klantcode (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/postnet/" name="Postnet" description="Postnet barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/royal-mail/" name="Royal Mail" description="Royal Mail streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/singapore-post/" name="Singapore Post" description="Singapore Post streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/nodejs-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Documentatie" href="https://docs.aspose.com/barcode/nodejsjava/" >}}
{{< blocks/products/pf/slr-element name="Broncode" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="API-referenties" href="https://reference.aspose.com/barcode/nodejs/" >}}
...
{{< blocks/products/pf/slr-element name="Release-opmerkingen" href="https://docs.aspose.com/barcode/nodejsjava/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Waarom Aspose.BarCode voor Node.js via Java?" tabId="success-stories" >}}
