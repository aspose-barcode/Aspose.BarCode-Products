---
title: Nodejs barcodescanner, herkenning en generator-API - Aspose 
weight: 660
url: /nl/nodejs-java/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="Node.js Barcode Generator en Scanner API" h2="Herken of genereer 1D-, 2D- en postbarcodes inclusief Code128, Code93, Code39, QR-code van verschillende afbeeldingen." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="https://downloads.aspose.com/barcode/nodejs" >}}

{{< blocks/products/pf/main-container pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" >}}

{{< blocks/products/pf/i18n/sub-menu logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-nodejs-java.svg" liveDemosLink="" PricingLink="https://purchase.aspose.com/pricing/barcode/nodejs-java" buyLink="https://purchase.aspose.com/buy" docsLink="https://docs.aspose.com/barcode/java/node-js-via-java-release-notes/" installationsDocsLink="" nugetLink="" nugetPackageName="" mavenRepoLink="https://repository.aspose.com/webapp/#/artifacts/browse/tree/Algemeen/repo/com/aspose/aspose-barcode" directDownloadLink="https://downloads.aspose.com/barcode/nodejs" >}}

{{< blocks/products/pf/i18n/tab-content >}}
<p>
 Aspose.BarCode voor Node.js via Java is een eenvoudig aanpasbare API voor het scannen en genereren van streepjescodes. Ontwikkelaars kunnen het integreren via nodejs-java bridge. Het is een snelle en eenvoudige barcode-decoder-API om algemene 1D-, 2D-barcodes overal en vanuit elke hoek van een afbeelding te decoderen. Men kan eenvoudig een gebied in de afbeelding specificeren om de streepjescode te scannen. API genereert barcode-afbeeldingen in meerdere formaten zoals JPG, PNG, GIF, BMP en ondersteunt meerdere beeldfuncties zoals het manipuleren van randen en stijlen, kleur, marges, roterende afbeeldingen, het aanpassen van de resolutie en nog veel meer.
</p>
...
{{< blocks/products/pf/carousel-item h3="In een oogopslag" description="Een overzicht van de mogelijkheden voor het herkennen en genereren van streepjescodes van API." >}}
<div class="diagram1 d1-nodejs">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    <li>
     Lineaire en 2D-typen
    </li>
    <li>
     Regio-informatie ophalen
    </li>
   </ul>
   <header>
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    <li>
     Specificeer verschillende symbolieken
    </li>
    <li>
     Codetekst instellen
    </li>
    ...
    <li>
     Bijschrift streepjescode
    </li>
    <li>
     Barcode X- en Y-dimensie
    </li>
   </ul>
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Android-bibliotheek met streepjescode" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-nodejs-java.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Platformonafhankelijkheid" description="Aspose.BarCode voor Node.js via Java is een server-side JavaScript API op basis van Node.js. Het kan draaien op Windows-, Unix/Linux- en Mac-platforms met JDK 1.7 of hoger." >}}
<div class="diagram1 d1-nodejs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Barcodegenerator Android" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-nodejs-java.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Ondersteunde bestandsindelingen" description="API werkt met de meest gebruikte afbeeldingsformaten." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Specificeer verschillende soorten symboliek
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Codetekst en stijlen instellen
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Bijschrift streepjescode beheren
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Pas de X- en Y-afmetingen aan voor 2D-typen
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Verschillende soorten streepjescodes herkennen
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Genereer meerdere barcodetypes
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Scan streepjescode door gebied op te geven
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Manipuleer de randstijlen van barcodeafbeeldingen
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Draai barcode-afbeeldingen in elke mate
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Afbeeldingsmarges voor streepjescodes beheren
    </p>
   </div>
   <div class="col-lg-4">
...
<p class="col-lg-10">Switch Barcode Herkenning Modes as of Requirement</p>

</div>-->
   <!--<div class="col-lg-12">

<h2 class="h2title">QR Code Generatie</h2>
...
// Display or echo Status
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.BarCode voor Node.js via Java ondersteunt een groot aantal numerieke, alfanumerieke en 2D-barcodesymbologieën voor zowel codering als decodering.
    </p>
    <p>
     Door API ondersteunde Numerieke symbolieken omvatten:
    </p>
    <div class="col-lg-6">
     <ul class="unstyled">
      <li>
    ...
    <p>
     API-ondersteunde alfanumerieke symbolieken zijn onder meer:
    </p>
    <div>
     <div class="col-lg-6">
      <ul class="unstyled">
    ...
    <p>
     Ondersteunde 2D-symbolen zijn onder meer:
    </p>
    <div>
     <div class="col-lg-6">
      <ul class="unstyled">
...
<h2 class="h2title">In beeld brengen, Rotation & Sizing</h2>
...
{{< blocks/products/pf/slr-element name="API-referenties" href="https://apireference.aspose.com/java/barcode" >}}
