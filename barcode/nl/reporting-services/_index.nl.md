---
title: Render lineaire en 2D-barcodeafbeeldingen in SQL Server-rapportageservices 
weight: 790
url: /nl/reporting-services/ 
description: Renderextensie voor SQL Server-rapportageservices - Exporteer lineaire en 2D-streepjescodeafbeeldingen in SSRS. Render barcodelabels in BMP JPEG GIF- en PNG-indelingen
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Barcodes renderen in SSRS-rapporten" h2="Genereer lineaire en 2D-barcodes vanuit Microsoft SQL Server-rapportageservices." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-reporting-services.svg" pfName="Aspose.BarCode" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/barcode/reportingservices" >}}
...
<p>
 Aspose.BarCode voor Reporting Services is een uitgebreide oplossing voor het renderen van lineaire en 2D-barcodes binnen Microsoft SQL Server-rapportageservices. Barcodelabels kunnen worden gecodeerd met niet-Engelse tekens en worden weergegeven in BMP-, JPEG-, GIF- en PNG-indeling.
</p>
...
{{< blocks/products/pf/carousel-item h3="In een oogopslag" description="Een overzicht van de barcode Reporting Services API." >}}
<div class="diagram1 d1-rs">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    <li>
     Lineair Soorten streepjescodes
    </li>
    <li>
     2D Soorten streepjescodes
    </li>
   </ul>
  </div>
  <!--/left-->
  <div class="d1-col d1-right">
   ...
   <ul>
    <li>
     Afbeelding naar rapport renderen
    </li>
    <li>
     Beeldrichting instellen
    </li>
    <li>
     Codeer niet-Engelse tekens
    </li>
   </ul>
  </div>
  <!--/right-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="BarCode-API's voor SSRS" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-reporting-services.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Platformonafhankelijkheid" description="Het ondersteunt Microsoft SQL Servier Reporting Services." >}}
<div class="diagram1 d1-rs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Ondersteunde bestandsindelingen" description="Reporting Services BarCode API ondersteunt de meest populaire afbeelding [bestandsformaten](https://docs.aspose.com/barcode/reportingservices/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-rs">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Barcodegenerator voor rapportageservices" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-reporting-services.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Geavanceerde Barcode Reporting Services API-functies
   </h2>
   <div class="col-lg-12">
    <p>
    </p>
    <div class="col-lg-4">
     ...
     <p class="col-lg-10">
      Genereer en herken EPC QR-gecodeerde barcode
     </p>
    </div>
    <div class="col-lg-4">
    ...
    <div class="col-lg-4">
     ...
     <p class="col-lg-10">
      Bewaar streepjescode in elk Vector-afbeeldingsformaat
     </p>
    </div>
    <div class="col-lg-4">
    ...
    <p>
     Aspose.BarCode voor Reporting Services ondersteunt meer dan 40 meest populaire barcodesymbologieën, waaronder:
    </p>
    <div class="col-lg-3">
     <ul class="unstyled">
      <li>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Aanpassing van barcodelabels
    </h2>
    <p>
     Barcodes gegenereerd door Aspose.BarCode voor Reporting Services kunnen op verschillende manieren worden aangepast, bijvoorbeeld - grootte, voorkleur, achterkleur, code-tekstlocatie, hoek, bijschrift (kleur, locatie en grootte) enz. Het is ideaal voor het genereren van streepjescodes voor de meest voorkomende toepassingsbehoeften.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Integration with SQL Server-rapportageservices
    </h2>
    <p>
     Aspose.BarCode for Reporting Services kan eenvoudig worden geïntegreerd met bestaande en nieuwe projecten door Aspose.BarCode for Reporting Services toe te voegen aan Visual Studio's Toolbox. Eenmaal beschikbaar in de Toolbox, kunt u het gemakkelijk naar het project slepen en neerzetten waar u maar wilt.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Barcode Designer voor Visual Studio
    </h2>
    <p>
     The layout of the barcode labels can be altered by using the fully-integrated Barcode Designer voor Visual Studio. Developers can preview and adjust the barcode images at design-time. The designer also allows customizing various settings to adjust the appearance of barcode images.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Waarom Aspose.BarCode voor rapportageservices?" tabId="success-stories" >}}
