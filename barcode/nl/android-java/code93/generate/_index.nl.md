---
title: Genereer Code 93 Uitgebreide en Code 93 Standaard barcodes afbeeldingen via Android via Java
description: Android-broncode om Code 93 Uitgebreide en Code 93 Standaard barcodes te maken in Android Runtime Environment.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/android-java/code93/generate/
aliases:
- /nl/android-java/generate/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genereer Code 93-labels met Android via Java" h2="Maak Code 93 Uitgebreide en Code 93 Standaard barcodes in Java met Aspose.BarCode aan de serverzijde voor Android via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Code 93 streepjescode Using Android via Java" %}}
Probeer Aspose.BarCode voor Android via Java om eenvoudig Code 93 streepjescode te maken binnen Android-applicaties. Het is een veelzijdige, robuuste en gebruiksvriendelijke barcodebibliotheek die speciaal is ontworpen voor Android-applicaties. U kunt eenvoudig Aspose.BarCode voor Android via Java rechtstreeks vanuit een op Maven gebaseerd project uitvoeren door de volgende configuraties in build.gradle in te voegen:
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om Code 93 streepjescode te genereren in Java" %}}
...
<ul><li>Maak een nieuwe instantie van de klasse BarCodeGenerator</li><li>Geef het streepjescodetype Code 93 streepjescode door als parameter EncodeTypes</li><li>Definieer streepjescodetekst met de methode setCodeText</li><li>Start de methode generatedBarCodeImage() om de Code 93 Uitgebreide en Code 93 Standaard barcodes barcode-afbeelding op te slaan</li></ul>
