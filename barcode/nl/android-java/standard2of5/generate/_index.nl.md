...
{{% blocks/products/pf/agp/content h2="How to Generate Standard 2 of 5 streepjescode Using Android via Java" %}}
Probeer Aspose.BarCode voor Android via Java om eenvoudig Standard 2 of 5 streepjescode te maken binnen Android-applicaties. Het is een veelzijdige, robuuste en gebruiksvriendelijke barcodebibliotheek die speciaal is ontworpen voor Android-applicaties. U kunt eenvoudig Aspose.BarCode voor Android via Java rechtstreeks vanuit een op Maven gebaseerd project uitvoeren door de volgende configuraties in build.gradle in te voegen:
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om Standard 2 of 5 streepjescode te genereren in Java" %}}
...
<ul><li>Maak een nieuwe instantie van de klasse BarCodeGenerator</li><li>Geef het streepjescodetype Standard 2 of 5 streepjescode door als parameter EncodeTypes</li><li>Definieer streepjescodetekst met de methode setCodeText</li><li>Start de methode generatedBarCodeImage() om de Standard 2 of 5 (Industriële 2 van 5) streepjescode barcode-afbeelding op te slaan</li></ul>
