...
Probeer Aspose.BarCode voor Android via Java om eenvoudig Data Matrix-code te maken binnen Android-applicaties. Het is een veelzijdige, robuuste en gebruiksvriendelijke barcodebibliotheek die speciaal is ontworpen voor Android-applicaties. U kunt eenvoudig Aspose.BarCode voor Android via Java rechtstreeks vanuit een op Maven gebaseerd project uitvoeren door de volgende configuraties in build.gradle in te voegen:
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om Data Matrix-code te genereren in Java" %}}
...
<ul><li>Maak een nieuwe instantie van de klasse BarCodeGenerator</li><li>Geef het streepjescodetype Data Matrix-code door als parameter EncodeTypes</li><li>Definieer streepjescodetekst met de methode setCodeText</li><li>Start de methode generatedBarCodeImage() om de Data Matrix-code barcode-afbeelding op te slaan</li></ul>
