...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het scannen van Australia Post streepjescode in Java" %}}
...
<ul><li>Maak een instantie van de BarCodeReader-klasse</li><li>Bepaal het pad van de bronafbeelding met Australia Post streepjescode</li><li>Definieer de typen doelstreepjescodes in DecodeType als de tweede parameter</li><li>Loop door de herkenningsresultaten</li><li>Laad de gedecodeerde tekst met de methode getCodeText</li></ul>
