---
title: Barcode Android-API | Scan of genereer streepjescodes
description: Android-barcodescannerbibliotheek om verschillende soorten 1D-, 2D- en postbarcodes te herkennen. Scan streepjescodes vanuit elke hoek in Android-apps.
lang: nl/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Android API's voor het genereren en herkennen van streepjescodes" h2="Maak of lees 1D-, 2D- en postbarcodes van afbeeldingen in elke mobiele Android-app." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" pfName="Aspose.BarCode" subTitlepfName="voor Android via Java" downloadUrl="https://releases.aspose.com/barcode/androidjava/" >}}
...
<p>Aspose.BarCode voor Android via Java is een API voor het genereren en lezen van streepjescodes voor Android-applicaties. Het ondersteunt het scannen van 1D-, 2D- en postbarcodes van afbeeldingen vanuit verschillende hoeken. De streepjescodegenerator-API kan eenvoudig streepjescodeafbeeldingen maken en deze in verschillende formaten opslaan. Het biedt ook uitgebreide beeldfunctionaliteit, zoals het aanpassen van streepjescoderanden, kleur, rotatiehoek, resolutie en nog veel meer.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Platformonafhankelijkheid" description="Gebruik API op elk platform waar de Android Runtime Environment beschikbaar is." >}}
<div class='diagram1 d1-android'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Ondersteunde bestandsindelingen" description="Aspose.BarCode voor Android via Java werkt met de meest gebruikte indelingen voor afbeeldingsbestanden." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Geavanceerde Android Barcode API-functies
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/qr-code-generation/'>Codeer niet-Engelse tekens in QR-codes</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-color-modification/'>Pas het kleurenschema van de streepjescode aan</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-appearance-customization/'>Roteer barcode-afbeeldingen in elke hoek</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/working-with-barcode-types/'>Genereer en herken barcodes van meer dan 60 typen</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/recognition-settings/'>Lees streepjescodes van afbeeldingen</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-image-saving/'>Exporteer streepjescodes in verschillende afbeeldingsindelingen</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Maak aangepaste streepjescodes
                </h2>
                <p>
                    Met de streepjescodebibliotheek voor Android via Java kunnen ontwikkelaars enkele algemene streepjescodeparameters aanpassen, waaronder het type streepjescode, de te coderen gegevens, de grootte van de streepjescode, de letterstijl en -kleur en de oriëntatiehoek. Om een ​​streepjescode te genereren, moet u het vereiste type streepjescode selecteren om aan te maken, zoals bijvoorbeeld UPC of EAN. Ook moet u de gegevens invoeren die in de streepjescode moeten worden opgeslagen, zoals een productnummer of een URL. Bovendien kunt u de vereiste formaatmodus instellen en de kleur van streepjescode-elementen, resolutie, randstijl en andere uiterlijkgerelateerde parameters aanpassen. Het is mogelijk om de breedte van de staven en de afstand ertussen te wijzigen. Deze aanvullende parameters kunnen de leesbaarheid en kwaliteit van streepjescodes beïnvloeden, dus het is belangrijk om hun doel te begrijpen en hoe u ze correct kunt aanpassen.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    De streepjescodegenerator-API kan streepjescodes maken door het vereiste type op te geven, invoertekst in te stellen (gegevens die in een streepjescode moeten worden gecodeerd) en uiterlijkgerelateerde eigenschappen aan te passen, zoals achtergrond- en voorgrondkleur, lettertype en tekstbijschriften. Tweedimensionale streepjescodes, zoals PDF417, Data Matrix, Aztec Code, QR Code en Micro QR Code kunnen op dezelfde manier worden gegenereerd als 1D-typen.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Barcodescanner en -decoder
                </h2>
                <p>
                    De barcode-API maakt het mogelijk om barcodes van meer dan 60 populaire 1D- en 2D-types te detecteren en te lezen. Er zijn slechts een paar regels code nodig om streepjescodes te scannen, waardoor deze functionaliteit eenvoudig in uw toepassingen kan worden geïntegreerd. Met deze krachtige functie kunt u streepjescodes scannen en lezen uit een breed scala aan bronnen, zoals afbeeldingen, documenten, enz. Het kan worden gebruikt om processen te automatiseren, het risico op fouten te verkleinen en de algehele efficiëntie van bewerkingen te verbeteren. Of u nu toepassingen moet ontwikkelen voor de detailhandel, logistiek, gezondheidszorg of een ander gebied, deze barcode-API kan een oplossing bieden voor het detecteren en lezen van barcodes.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/pdf417/" name="PDF417" description="PDF417 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/qr/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/datamatrix/" name="Data Matrix" description="Data Matrix-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/aztec/" name="Aztec" description="Aztec-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/swiss-qr/" name="Swiss QR" description="Swiss QR rekening" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/dotcode/" name="DotCode" description="DotCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/hibc/" name="HIBC" description="HIBC (streepjescode voor de gezondheidsindustrie)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/codablock/" name="Codablock-F" description="Codablock-F en GS1 Codablock-F streepjescodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/databar/" name="GS1 DataBar" description="GS1 DataBar (omnidirectioneel, gestapeld omnidirectioneel, uitgevouwen, uitgevouwen gestapeld en afgekapt) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/itf/" name="ITF" description="Doorschoten 2-van-5 (ITF) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/ean/" name="EAN" description="EAN (internationaal artikelnummer) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/upc/" name="UPC" description="UPC (Universele productcode) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/code128/" name="GS1 Code 128" description="GS1 Code 128 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/code39/" name="Code 39" description="Code 39 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/code16k/" name="Code 16K" description="Code 16K streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/code32/" name="Code 32" description="Italiaanse farmacode (Code 32) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/code93/" name="Code 93" description="Code 93 Uitgebreide en Code 93 Standaard barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/onecode/" name="USPS OneCode" description="USPS OneCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriële 2 van 5) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/isbn/" name="ISBN" description="ISBN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/ismn/" name="ISMN" description="ISMN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/issn/" name="ISSN" description="ISSN streepjescode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/australia-post/" name="Australia Post" description="Australia Post streepjescode en Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode en Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/rm4scc/" name="RM4SCC" description="Royal Mail 4-Staten klantcode (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/postnet/" name="Postnet" description="Postnet barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/royal-mail/" name="Royal Mail" description="Royal Mail streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/singapore-post/" name="Singapore Post" description="Singapore Post streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/android-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Broncode" href="https://github.com/aspose-barcode/Android-Library-Usage-Examples" >}}
{{< blocks/products/pf/slr-element name="API-referenties" href="https://reference.aspose.com/barcode/androidjava/" >}}
...
{{< blocks/products/pf/slr-element name="Release-opmerkingen" href="https://docs.aspose.com/barcode/java/android-via-java-release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Waarom Aspose.BarCode voor Android via Java?" tabId="success-stories" >}}
