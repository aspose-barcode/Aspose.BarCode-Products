---
title: SharePoint Barcode API - Voeg streepjescodes in op SharePoint-lijsten
description: Barcode SharePoint API om barcodelabels in te voegen in aangepaste SharePoint-lijsten. Ontwikkelaars kunnen Service Markers gebruiken om invoertekstwaarden te kiezen of de tekst handmatig in te voegen.
lang: nl/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="SharePoint Barcode-API's" h2="Barcode SharePoint-app om lineaire, 2D- en postbarcodes toe te voegen aan Microsoft SharePoint-lijsten." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="voor SharePoint" downloadUrl="https://releases.aspose.com/barcode/sharepoint/" >}}
...
<p>Met Aspose.BarCode voor SharePoint kunnen ontwikkelaars een grote verscheidenheid aan lineaire, 2D- en postbarcodes toevoegen aan lijsten van Microsoft SharePoint Foundation 2010 en Microsoft Office SharePoint Server 2010 (MOSS). U kunt streepjescodes maken en vervolgens in elke lijst invoegen door de invoertekst en het type op te geven.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Platformonafhankelijkheid" description="Aspose.BarCode voor SharePoint ondersteunt Microsoft SharePoint Foundation & SharePoint Server." >}}
<div class='diagram1 d1-sharepoint'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Ondersteunde bestandsindelingen" description="Aspose.BarCode voor SharePoint werkt met de meest gebruikte indelingen voor afbeeldingsbestanden." >}}
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Barcodes toevoegen aan Sharepoint-lijsten
                </h2>
                <p>
                    Aspose.BarCode voor SharePoint biedt uitgebreide functionaliteit om streepjescodes toe te voegen aan SharePoint-lijsten. Dergelijke lijsten kunnen worden gebruikt om gegevens in een gestructureerd formaat op te slaan en te ordenen. Het is een handige manier om een ​​breed scala aan informatie te beheren, zoals contacten, taken, agenda-afspraken en meer. Ze bieden meerdere functies voor het organiseren, sorteren, filteren en delen van gegevens. Het kan handig zijn om streepjescodes toe te voegen aan SharePoint-lijsten om de toegang tot en het beheer van de informatie in de lijst te vergemakkelijken. Als er een SharePoint-lijst wordt gemaakt om inventarisitems bij te houden, kunnen ontwikkelaars streepjescodes toevoegen om de informatie in de lijst snel en nauwkeurig te scannen en bij te werken. Dit kan het volgen en beheren van de voorraad vergemakkelijken en het risico op afwijkingen verminderen. Streepjescodes kunnen dienen om snel toegang te krijgen tot informatie in een SharePoint-lijst en deze te bekijken, bijvoorbeeld door streepjescodes te scannen om snel specifieke items of records in de lijst weer te geven.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    De streepjescodebibliotheek is een krachtige tool waarmee ontwikkelaars eenvoudig streepjescodes kunnen genereren door het doelstreepjescodetype te specificeren, de invoergegevens in te voegen om de streepjescode op te slaan en uiterlijkgerelateerde eigenschappen aan te passen. De bibliotheek biedt een verscheidenheid aan opties voor het verfijnen van het uiterlijk van de gegenereerde streepjescodes, inclusief opties voor het instellen van de achtergrond- en voorgrondkleuren, lettertype, grootte, resolutie en tekstbijschriften.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    De Barcode API bevat verschillende functies voor het detecteren en lezen van een breed scala aan populaire 1D- en 2D-barcodes. Deze functies kunnen eenvoudig in uw toepassingen worden geïntegreerd met slechts een paar regels code, wat een handige en efficiënte manier is om streepjescodedetectiemogelijkheden aan uw toepassingen toe te voegen.
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/pdf417/" name="PDF417" description="PDF417 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/qr/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/datamatrix/" name="Data Matrix" description="Data Matrix-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/aztec/" name="Aztec" description="Aztec-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/swiss-qr/" name="Swiss QR" description="Swiss QR rekening" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/dotcode/" name="DotCode" description="DotCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/hibc/" name="HIBC" description="HIBC (streepjescode voor de gezondheidsindustrie)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/codablock/" name="Codablock-F" description="Codablock-F en GS1 Codablock-F streepjescodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/databar/" name="GS1 DataBar" description="GS1 DataBar (omnidirectioneel, gestapeld omnidirectioneel, uitgevouwen, uitgevouwen gestapeld en afgekapt) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/itf/" name="ITF" description="Doorschoten 2-van-5 (ITF) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/ean/" name="EAN" description="EAN (internationaal artikelnummer) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/upc/" name="UPC" description="UPC (Universele productcode) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/code128/" name="GS1 Code 128" description="GS1 Code 128 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/code39/" name="Code 39" description="Code 39 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/code16k/" name="Code 16K" description="Code 16K streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/code32/" name="Code 32" description="Italiaanse farmacode (Code 32) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/code93/" name="Code 93" description="Code 93 Uitgebreide en Code 93 Standaard barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/onecode/" name="USPS OneCode" description="USPS OneCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriële 2 van 5) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/isbn/" name="ISBN" description="ISBN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/ismn/" name="ISMN" description="ISMN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/issn/" name="ISSN" description="ISSN streepjescode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/australia-post/" name="Australia Post" description="Australia Post streepjescode en Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode en Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/rm4scc/" name="RM4SCC" description="Royal Mail 4-Staten klantcode (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/postnet/" name="Postnet" description="Postnet barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/royal-mail/" name="Royal Mail" description="Royal Mail streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/singapore-post/" name="Singapore Post" description="Singapore Post streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/sharepoint/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Documentatie" href="https://docs.aspose.com/barcode/sharepoint/" >}}
...
{{< blocks/products/pf/slr-element name="Release-opmerkingen" href="https://docs.aspose.com/barcode/sharepoint/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Waarom Aspose.BarCode voor SharePoint?" tabId="success-stories" >}}
