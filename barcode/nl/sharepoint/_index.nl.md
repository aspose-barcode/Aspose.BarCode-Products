---
title: SharePoint Barcode API - Streepjescodes invoegen in SharePoint-lijsten 
weight: 220
url: /nl/sharepoint/ 
description: Barcode SharePoint API om barcodelabels in aangepaste SharePoint-lijsten in te voegen. Ontwikkelaars kunnen servicemarkeringen gebruiken om codetekstwaarden te kiezen of de tekst handmatig in te voegen
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Streepjescodes toevoegen aan Microsoft SharePoint-lijsten" h2="Barcode SharePoint-app om lineaire, 2D- en poststreepjescodesymbolen toe te voegen aan Microsoft SharePoint-lijsten." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/barcode/sharepoint" >}}
...
<p>
 Met Aspose.BarCode voor SharePoint kunt u een groot aantal lineaire, 2D- en poststreepjescodesymbolen toevoegen aan Microsoft SharePoint Foundation 2010 en Microsoft Office SharePoint Server 2010 (MOSS)-lijsten. U kunt streepjescodes aan elke lijst toevoegen door codetekst en symboliek op te geven.
</p>
...
{{< blocks/products/pf/carousel-item h3="In een oogopslag" description="Een overzicht van functies voor het genereren van streepjescodes." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    ...
    <li>
     Streepjescode toevoegen aan lijst
    </li>
   </ul>
  </div>
  <!--/left-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="SharePoint-streepjescodegenerator" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-sharepoint.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Ondersteund platform" description="Aspose.BarCode voor SharePoint ondersteunt Microsoft SharePoint Foundation & SharePoint Server." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
{{< blocks/products/pf/carousel-item h3="Ondersteunde barcodetypes" description="Aspose.BarCode voor SharePoint ondersteunt het volgende: [bestandsformaten](https://docs.aspose.com/barcode/sharepoint/supported-file-formats/)  :" >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
  ...
  <div class="d1-col d1-right">
   ...
   <!--<header><i class="fa fa-qrcode"> </i>Barcode Soorten</header>

<ul>

<li>Lineaire barcodetypes</li>

<li>2D-barcodetypen</li>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <div class="col-lg-12">
    <h2 class="h2title">
     Kolom met streepjescodetype toevoegen aan SharePoint-lijsten
    </h2>
    <p>
     Aspose.BarCode voor SharePoint maakt het gemakkelijk om een kolom van het type streepjescode toe te voegen aan de SharePoint-lijsten. Met dit onderdeel kunt u ook de tekst van de streepjescodecode instellen met behulp van de GUI of door servicemarkeringen op te nemen.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     De SharePoint-barcode-app ondersteunt de meest populaire symbolieken, waaronder:
    </p>
    <div class="col-lg-3">
     <ul class="unstyled">
      <li>
   ...
   <div class="container">
    ...
    <div class="col-lg-12 mgtb55">
     <ul class="list-unstyled" id="resources">
      ...
      <!-- <li><a href="https://apireference.aspose.com/">API-referenties</a></li> -->
      <li>
     ...
     <ul class="list-unstyled" id="success-stories">
      <li class="resourcesheading">
       Waarom Aspose.BarCode voor SharePoint?
      </li>
   ...
   <div class="container">
    <div class="col-lg-12">
     ...
     <a class="btn btn-primary btn-lg" href="https://github.com/aspose-barcode?tab=repositories">
      GitHub-opslagplaats downloaden
     </a>
    </div>
   </div>
  </div>
 ...
 <div class="container-fluid offers-section bg-darkergray tc">
  <div class="row">
   <div class="container">
    <div class="col-lg-12">
     <p>
      Aspose.BarCode biedt individuele Barcode generatie en herkenning API's voor andere populaire ontwikkelomgevingen zoals hieronder vermeld:
     </p>
    </div>
