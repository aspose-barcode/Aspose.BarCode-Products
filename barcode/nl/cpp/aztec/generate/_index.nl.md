---
title: Genereer Aztec-code afbeeldingen via C++
description: C++ voorbeeld van code om Aztec-code te genereren in C++ Runtime Environment voor Windows 32-bits, Windows 64-bits en Linux 64-bits.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/cpp/aztec/generate/
aliases:
- /nl/cpp/generate/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genereer Aztec-labels met C++" h2="Maak Aztec-code in C++ met Aspose.BarCode aan de serverzijde voor C++ API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Aztec-code Using C++" %}}
Om Aztec-code te genereren, installeert u [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, een robuuste en gebruiksvriendelijke barcodebibliotheek met uitgebreide functionaliteit voor C++-platforms . Download de nieuwste versie rechtstreeks van de [NuGet](https://www.nuget.org/packages/aspose.barcode) pakketbeheerder&colon; zoek naar **Aspose.BarCode.Cpp** en installeer het pakket. U kunt ook de Package Manager-console openen en de volgende opdracht uitvoeren:
...
<ul><li>Maak een object van BarcodeGenerator-klasse</li><li>Geef Aztec-code door als parameter</li><li>Voeg invoertekst in om te coderen als de tweede parameter</li><li>Definieer afbeeldingsafmetingen indien nodig</li><li>Roep de BarcodeGenerator.Save-methode aan om de Aztec-code-streepjescode te downloaden</li></ul>
...
{
    <span class="hljs-keyword">auto</span> tmp_0 = System::<span class="hljs-built_in">MakeObject</span>&lt;BarcodeGenerator&gt;(EncodeTypes::<span class="barcode-gen-lcs-type-param">Aztec</span>, <span class="hljs-string">u&quot;<span class="hljs-string barcode-gen-lcs-codetext-param"></span>&quot;</span>);
