---
title: Scan Deutsche Post Identcode en Deutsche Post Leitcode afbeeldingen via C++
weight: 1510
description: C++-voorbeeldcode om Deutsche Post Identcode en Deutsche Post Leitcode te scannen en te decoderen in C++ Runtime Environment voor Windows 32-bits, Windows 64-bits of Linux 64-bits.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/cpp/deutsche-post/recognize/
aliases:
- /nl/cpp/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lees Deutsche Post streepjescodes met C++" h2="Lees Deutsche Post Identcode en Deutsche Post Leitcode in C++ met behulp van server-side Aspose.BarCode voor C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Deutsche Post streepjescode Using C++" %}}
Om Deutsche Post streepjescode te scannen, probeert u [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, een krachtige en gebruiksvriendelijke barcodebibliotheek met uitgebreide functionaliteit voor C++-platforms . U kunt de nieuwste versie direct downloaden&colon; open [NuGet](https://www.nuget.org/packages/aspose.barcode) pakketbeheerder, zoek naar **Aspose.BarCode.Cpp** en installeer het pakket. U kunt ook de volgende opdracht uitvoeren vanuit de Package Manager-console.
...
<ul><li>Maak een object van de klasse Aspose.BarCode.BarCodeReader</li><li>Specificeer het pad naar de bronafbeelding dat Deutsche Post streepjescode als parameter bevat</li><li>Geef de vereiste typen streepjescodes door in DecodeType als de tweede parameter</li><li>Loop door de herkenningsresultaten</li><li>Laad de gedecodeerde streepjescodetekst met behulp van de eigenschap CodeText</li></ul>
