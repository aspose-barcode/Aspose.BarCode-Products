---
title: Java Barcode API - Genereer of scan 1D 2D & Postal Barcodes
description: Java-streepjescodebibliotheek om lees-herken streepjescodes te genereren. Barcode SDK ondersteunt lineaire en 2D-barcodes, evenals export naar JPG, GIF, PNG, BMP en meer afbeeldingsindelingen
lang: nl/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="API voor het genereren en herkennen van Java-barcodes" h2="Maak en herken streepjescodes van lineaire, 2D- en posttypes binnen elke Java-toepassing." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" pfName="Aspose.BarCode" subTitlepfName="voor Java" downloadUrl="https://releases.aspose.com/barcode/java/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.BarCode" subTitlepfName="voor Java" >}}
...
<p>Aspose.BarCode voor Java is een robuuste en betrouwbare API die zorgt voor het genereren en herkennen van streepjescodes voor Java-toepassingen. Het ondersteunt de meest gevestigde standaarden en specificaties en stelt ontwikkelaars in staat om 1D- en 2D-barcodes van verschillende afbeeldingsbestanden vanuit elke hoek te lezen. Aspose.BarCode voor Java geeft barcode-afbeeldingen weer in verschillende afbeeldingsindelingen met zeer flexibele afbeeldingsopties. De bibliotheek ondersteunt het coderen en decoderen van meer dan 60 soorten streepjescodes en maakt het direct afdrukken van streepjescodeafbeeldingen mogelijk.</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="In een oogopslag" description="Een overzicht van de barcodeherkenning en generatiemogelijkheden van API." >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>Lineair, 2D en postaal</li><li>Detectie van stream of afbeelding</li><li>Oriëntatie van streepjescode ophalen</li><li>Niet-Engelse tekens decoderen</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                Afdrukken
            </header>
            <ul><li>Streepjescode rechtstreeks afdrukken</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>Lineair, 2D en postaal</li><li>Opslaan in stream of afbeelding</li><li>Uiterlijk aanpassen&colon; grootte, kleur, hoek</li><li>Niet-Engelse tekens coderen </li></ul>
            <header>
                <i class="fa fa-qrcode">
                </i>
                Soorten
            </header>
            <ul><li>Lineair</li><li>2D</li><li>Post</li></ul>
        </div>
        <!--/right-->
    </div>
    <!--/row-->
    <div class="d1-logo">
        <img width="70" height="75" alt='Barcode Java Library' src='https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg'/>
        <header>
            Aspose.BarCode
        </header>
        <footer>
...
{{< blocks/products/pf/carousel-item h3="Platformonafhankelijkheid" description="U kunt de streepjescodebibliotheek gebruiken om elk type Java-toepassing te bouwen waarop JRE 1.6 of hoger is geïnstalleerd." >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
    ...
    <!--/row-->
    <div class="d1-logo">
        <img width="70" height="75" alt='Barcode Generator in Java' src='https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg'/>
        <header>
            Aspose.BarCode
        </header>
        <footer>
...
{{< blocks/products/pf/carousel-item h3="Ondersteunde bestandsindelingen" description="Aspose.BarCode voor Java werkt met de meest gebruikte indelingen voor afbeeldingsbestanden." >}}
<div class='diagram1 d2 d1-java'>
    ...
    <!--/row-->
    <div class="d1-logo">
        <img width="70" height="75" alt='Java Barcode Reader API' src='https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg'/>
        <header>
            Aspose.BarCode
        </header>
        <footer>
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Geavanceerde Java-bibliotheekfuncties
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/control-the-appearance-of-code-text/'>Aan uiterlijk gerelateerde eigenschappen van codetekst aanpassen en wijzigen</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-the-barcode-caption/'>Beheer ondertitelings- en lettertypestijlen</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/use-checksum-and-supplement-data-for-barcodes/'>Ondersteuning voor Checksum & Supplement-gegevens</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#image-formats'>Genereer streepjescodeafbeeldingen naar meerdere afbeeldingsindelingen</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/advanced-barcode-recognition-features/'>Lees 1D- en 2D-typen vanuit elke hoek</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/barcode-regions/'>Scan de streepjescode door het gebied op te geven</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/generate-barcode-by-specifying-custom-image-size/'>Pas de afbeeldingsgrootte aan</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-x-dimension-and-y-dimension/'>Ondersteuning van X- en Y-dimensie voor 2D-type</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#barcode-types'>Ondersteuning voor lineaire, 2D- en postsymbolen</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Pas streepjescodetypen en uiterlijk aan
                </h2>
                <p>
                    Met de streepjescode-API voor Java kunnen ontwikkelaars het uiterlijk van gegenereerde streepjescodes verfijnen door het type streepjescode, invoertekst, lettertypestijl, achtergrond- en voorgrondkleuren, uitlijning en locatie van bijschriften en andere eigenschappen te specificeren. U kunt het bijschrift wijzigen door de zichtbaarheid in te stellen voor de bovenste en onderste bijschriften, het lettertype, de kleuren en de uitlijning.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    De barcode-API stelt ontwikkelaars in staat om eenvoudig hoogwaardige barcode-afbeeldingen te genereren in hun applicaties. Het ondersteunt een breed scala aan barcodetypen, waaronder veelgebruikte typen zoals QR Code en Code 128, evenals meer gespecialiseerde typen zoals Aztec Code en Data Matrix. Met de API kunnen ontwikkelaars het uiterlijk van de gegenereerde streepjescodes aanpassen, inclusief de voor- en achtergrondkleuren, het lettertype en de uitlijning van bijschriften. Met behulp van de API kunnen ontwikkelaars eenvoudig 2D-streepjescodes genereren op dezelfde manier als eendimensionale streepjescodes.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Voeg streepjescodes in PDF-documenten in
                </h2>
                <p>
                    Met de streepjescodebibliotheek kunnen ontwikkelaars niet alleen aangepaste streepjescodes maken, maar ook rechtstreeks gegenereerde afbeeldingen toevoegen aan PDF-documenten. U kunt eerst streepjescodeafbeeldingen maken met een van de ondersteunde rasterindelingen en deze vervolgens in een PDF-bestand invoegen. De API maakt het toevoegen van barcodes mogelijk zonder beeldcompressie en kwaliteitsverlies. Het biedt ook functionaliteit om streepjescodeparameters en -uiterlijk te wijzigen voordat ze worden ingevoegd of om de gegenereerde afbeelding in meerdere documentpagina's tegelijk toe te voegen. Aspose.BarCode API kan worden gebruikt voor het afdrukken van barcodeafbeeldingen met hoge kwaliteit. Rasterafbeeldingen hebben de standaardresolutie van 96 dpi, wat hiervoor niet voldoende is. Met de API kan een afbeeldingsresolutie van streepjescodes van 300 of 600 dpi worden ingesteld om PDF-documenten van hoge kwaliteit af te drukken.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
                ...
                <p>
                    De Java-streepjescodebibliotheek is een krachtig hulpmiddel voor het werken met streepjescodes in Java-toepassingen. Een van de belangrijkste kenmerken is de mogelijkheid om streepjescodes van verschillende afbeeldingsbestandsindelingen te lezen. De klasse BarCodeReader, de hoofdklasse die verantwoordelijk is voor streepjescodeherkenning, ondersteunt veel populaire afbeeldingsindelingen, waaronder BMP, PNG, TIFF, JPEG en GIF. Dit maakt het eenvoudig om functionaliteit voor streepjescodeherkenning te integreren in een breed scala aan toepassingen.
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
<div class="barcode-read-lcs" style="width: 100%;">
    ...
    <div class="barcode-read-lcs-controls">
        <div class="barcode-read-lcs-drop" onclick="BarcodeReadLcsUpload(this);" ondragover="event.preventDefault();" ondrop="BarcodeReadLcsDropped(event,this);">
            ...
            <span class="barcode-read-lcs-recognizing">Herkennen<span></span></span>
            <span class="barcode-read-lcs-hint">Zet hier een bestand neer of klik om te bladeren *</span>
        </div>
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">Alle typen</option>
                <option value="Pdf417 ">PDF417</option>
                <option value="QR ">QR</option>
    ...
    <p class="barcode-read-lcs-disclaimer">* Door uw bestanden te uploaden of de service te gebruiken, gaat u akkoord met onze <a href='https://about.aspose.com/legal/terms-of-use' rel='nofollow noreferrer' target='_blank'>Algemene voorwaarden gebruik</a> en <a href='https://about.aspose.com/legal/privacy-policy' rel='nofollow noreferrer' target='_blank'>privacybeleid</a>.</p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Scan streepjescodes van PDF-documenten
                </h2>
                <p>
                    Naast het lezen van streepjescodes uit afbeeldingsbestanden, kan de streepjescodebibliotheek worden gebruikt om streepjescodes uit PDF-bestanden te scannen. Ontwikkelaars kunnen snelle streepjescodedetectie implementeren in PDF-documenten met meerdere pagina's. De API biedt verschillende manieren om dit te doen. De aanbevolen manier is om documentpagina's om te zetten in rasterafbeeldingen en vervolgens mechanismen voor het lezen van streepjescodes toe te passen. Het omzetten van pagina-inhoud in rasterafbeeldingen wordt voorgesteld als de gemakkelijkste en meest efficiënte aanpak. Anders kunnen streepjescodeafbeeldingen eerst worden gedetecteerd en geëxtraheerd uit het PDF-brondocument. Deze methode vergemakkelijkt het lezen van streepjescodes met originele resolutie. Met de Aspose.BarCode API kunnen PDF-bestanden met meerdere pagina's worden verwerkt om alle streepjescodes in een document te detecteren en te herkennen.
                </p>
            </div>
<!--supportedSymbologiesSection-->
{{< blocks/products/pf/agp/other-symbologies-section title="Supported Barcode Types" subTitle="Using Java, developers can read and generate barcodes of differen types, including the following." >}}

<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">2D:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/pdf417/" name="PDF417" description="PDF417 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/qr/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/datamatrix/" name="Data Matrix" description="Data Matrix-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/aztec/" name="Aztec" description="Aztec-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/swiss-qr/" name="Swiss QR" description="Swiss QR rekening" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/dotcode/" name="DotCode" description="DotCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/hibc/" name="HIBC" description="HIBC (streepjescode voor de gezondheidsindustrie)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/codablock/" name="Codablock-F" description="Codablock-F en GS1 Codablock-F streepjescodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/databar/" name="GS1 DataBar" description="GS1 DataBar (omnidirectioneel, gestapeld omnidirectioneel, uitgevouwen, uitgevouwen gestapeld en afgekapt) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/itf/" name="ITF" description="Doorschoten 2-van-5 (ITF) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/ean/" name="EAN" description="EAN (internationaal artikelnummer) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/upc/" name="UPC" description="UPC (Universele productcode) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/code128/" name="GS1 Code 128" description="GS1 Code 128 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/code39/" name="Code 39" description="Code 39 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/code16k/" name="Code 16K" description="Code 16K streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/code32/" name="Code 32" description="Italiaanse farmacode (Code 32) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/code93/" name="Code 93" description="Code 93 Uitgebreide en Code 93 Standaard barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/onecode/" name="USPS OneCode" description="USPS OneCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriële 2 van 5) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/isbn/" name="ISBN" description="ISBN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/ismn/" name="ISMN" description="ISMN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/issn/" name="ISSN" description="ISSN streepjescode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/australia-post/" name="Australia Post" description="Australia Post streepjescode en Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode en Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/rm4scc/" name="RM4SCC" description="Royal Mail 4-Staten klantcode (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/postnet/" name="Postnet" description="Postnet barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/royal-mail/" name="Royal Mail" description="Royal Mail streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/singapore-post/" name="Singapore Post" description="Singapore Post streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="Wat mensen zeggen" subTitle="Geloof ons niet zomaar op ons woord. Bekijk wat gebruikers te zeggen hebben over API's." caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 Ik heb vele jaren besteed aan het ontwikkelen en verbeteren van mijn product en Aspose heeft me in staat gesteld mijn product veel vriendelijker en nuttiger te maken, en daardoor verkoopbaarder. <em>Kiel Diller | KD Solutions, Polen</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode is echt geschreven in beheerde code en geeft ons een verscheidenheid aan barcodetypes om allerlei soorten documentherkenning en verdere verwerking aan te kunnen. <em>Dennis Alexander Petrasc | Keil IT, Duitsland</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Documentatie" href="https://docs.aspose.com/barcode/java/" >}}
{{< blocks/products/pf/slr-element name="Broncode" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="API-referenties" href="https://reference.aspose.com/barcode/java/" >}}
...
{{< blocks/products/pf/slr-element name="Release-opmerkingen" href="https://docs.aspose.com/barcode/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Waarom Aspose.BarCode voor Java?" tabId="success-stories" >}}
{{< blocks/products/pf/slr-element name="Klanten lijst" href="https://about.aspose.com/customers" >}}
{{< blocks/products/pf/slr-element name="Succesverhalen" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Aspose.BarCode biedt individuele API's voor het genereren en herkennen van streepjescodes voor andere populaire ontwikkelomgevingen, zoals hieronder vermeld:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/barcode/nl/jasperreports/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg" sdkName="JasperReports" >}}
