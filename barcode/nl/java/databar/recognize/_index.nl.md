---
title: Scan GS1 DataBar (omnidirectioneel, gestapeld omnidirectioneel, uitgevouwen, uitgevouwen gestapeld en afgekapt) streepjescode afbeeldingen via Java
weight: 1510
description: Java-broncode voor het lezen en decoderen van GS1 DataBar (omnidirectioneel, gestapeld omnidirectioneel, uitgevouwen, uitgevouwen gestapeld en afgekapt) streepjescode in Java Runtime Environment voor JSP/JSF-applicaties en desktopapplicaties.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/java/databar/recognize/
aliases:
- /nl/java/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lees GS1 DataBar streepjescodes met Java" h2="Lees GS1 DataBar (omnidirectioneel, gestapeld omnidirectioneel, uitgevouwen, uitgevouwen gestapeld en afgekapt) streepjescode in Java met behulp van server-side Aspose.BarCode voor Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 DataBar streepjescode Using Java" %}}
Om GS1 DataBar streepjescode te herkennen, gebruikt u [Aspose.BarCode for Java](https://products.aspose.com/barcode/java/) API, een geavanceerde, robuuste en gebruiksvriendelijke barcodebibliotheek voor Java- gebaseerde platformen. Download de nieuwste versie rechtstreeks van [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-barcode) en installeer deze binnen uw op Maven gebaseerde projecten door de volgende configuraties op te nemen in pom.xml:
...
<ul><li>Maak een nieuw object van BarCodeReader-klasse</li><li>Stel het bronbestandspad in dat {{BARCODE_FULL_NAME} bevat</li><li>Geef de vereiste barcodetypes door aan DecodeType als de tweede parameter</li><li>Loop door de decoderingsresultaten</li><li>Haal streepjescodetekst op met de methode getCodeText</li></ul>
...
<ul><li>Microsoft Windows, Linux of elk besturingssysteem dat compatibel is met Java Runtime Environment voor JSP/JSF en desktoptoepassingen</li><li>Java-ontwikkelomgeving, zoals JRE 1.6 of hoger</li><li> Java Development-versie JSE2 7.0 of hoger</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/pdf417/recognize/" name="PDF417" description="PDF417 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/qr/recognize/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/aztec/recognize/" name="Aztec" description="Aztec-code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR rekening" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/dotcode/recognize/" name="DotCode" description="DotCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/hibc/recognize/" name="HIBC" description="HIBC (streepjescode voor de gezondheidsindustrie)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/codablock/recognize/" name="Codablock-F" description="Codablock-F en GS1 Codablock-F streepjescodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (omnidirectioneel, gestapeld omnidirectioneel, uitgevouwen, uitgevouwen gestapeld en afgekapt) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/itf/recognize/" name="ITF" description="Doorschoten 2-van-5 (ITF) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/ean/recognize/" name="EAN" description="EAN (internationaal artikelnummer) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/upc/recognize/" name="UPC" description="UPC (Universele productcode) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/code39/recognize/" name="Code 39" description="Code 39 streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/code16k/recognize/" name="Code 16K" description="Code 16K streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/code32/recognize/" name="Code 32" description="Italiaanse farmacode (Code 32) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/code93/recognize/" name="Code 93" description="Code 93 Uitgebreide en Code 93 Standaard barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriële 2 van 5) streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/isbn/recognize/" name="ISBN" description="ISBN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/ismn/recognize/" name="ISMN" description="ISMN streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/issn/recognize/" name="ISSN" description="ISSN streepjescode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/australia-post/recognize/" name="Australia Post" description="Australia Post streepjescode en Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode en Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4-Staten klantcode (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/postnet/recognize/" name="Postnet" description="Postnet barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/royal-mail/recognize/" name="Royal Mail" description="Royal Mail streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/singapore-post/recognize/" name="Singapore Post" description="Singapore Post streepjescode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/nl/java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
