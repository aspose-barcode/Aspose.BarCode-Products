...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om Code 39 streepjescode te genereren in Python" %}}
...
<ul><li>Maak een nieuw object van BarCodeGenerator-klasse</li><li>Bepaal de gewenste barcodetypes als de parameter EncodeTypes</li><li>Voeg invoertekst in als tweede parameter</li><li> Roep de BarCodeGenerator.save-methode aan om de gegenereerde Code 39 streepjescode-afbeelding op te halen</li></ul>
