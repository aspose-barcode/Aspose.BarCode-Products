---
title: Scan QR Code, GS1 QR Code afbeeldingen via Python via Java
weight: 1510
description: Python-broncode voor QR Code, GS1 QR Code-herkenning met behulp van Java Runtime Environment.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/python-java/qr/recognize/
aliases:
- /nl/python-java/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lees QR streepjescodes met Python via Java" h2="Lees QR Code, GS1 QR Code in Python met behulp van server-side Aspose.BarCode voor Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het scannen van QR-code in Python" %}}
...
<ul><li>Maak een object van de klasse Aspose.BarCode.BarCodeReader</li><li>Definieer het pad naar het bronbestand dat QR-code als parameter bevat</li><li>Bepaal de vereiste typen streepjescodes in DecodeType als de tweede parameter</li><li>Loop door de decoderingsresultaten</li><li>Haal de streepjescodetekst op met behulp van de eigenschap CodeText</li></ul>
