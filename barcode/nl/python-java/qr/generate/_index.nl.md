---
title: Genereer QR Code, GS1 QR Code afbeeldingen via Python via Java
description: Python-voorbeeldcode om QR Code, GS1 QR Code te genereren met Java Runtime Environment.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/python-java/qr/generate/
aliases:
- /nl/python-java/generate/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genereer QR-labels met Python via Java" h2="Maak QR Code, GS1 QR Code in Python met Aspose.BarCode aan de serverzijde voor Python via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om QR-code te genereren in Python" %}}
...
<ul><li>Maak een nieuw object van BarCodeGenerator-klasse</li><li>Bepaal de gewenste barcodetypes als de parameter EncodeTypes</li><li>Voeg invoertekst in als tweede parameter</li><li> Roep de BarCodeGenerator.save-methode aan om de gegenereerde QR Code, GS1 QR Code-afbeelding op te halen</li></ul>
