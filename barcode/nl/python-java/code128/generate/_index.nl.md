---
title: Genereer GS1 Code 128 streepjescode afbeeldingen via Python via Java
description: Python-voorbeeldcode om GS1 Code 128 streepjescode te genereren met Java Runtime Environment.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/python-java/code128/generate/
aliases:
- /nl/python-java/generate/code128/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genereer GS1 Code 128-labels met Python via Java" h2="Maak GS1 Code 128 streepjescode in Python met Aspose.BarCode aan de serverzijde voor Python via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate GS1 Code 128 streepjescode Using Python via Java" %}}
Als u GS1 Code 128 streepjescode-afbeeldingen wilt maken, downloadt u [Aspose.BarCode voor Python via Java](https://products.aspose.com/barcode/python-java/) API, een veelzijdige, krachtige en gebruiksvriendelijke -gebruik streepjescodebibliotheek voor op Python gebaseerde toepassingen. Download de nieuwste versie rechtstreeks van de [Aspose releases](https://releases.aspose.com/barcode/python-java/) portal of installeer 'aspose-barcode' van pip met de volgende opdracht:
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om GS1 Code 128 streepjescode te genereren in Python" %}}
...
<ul><li>Maak een nieuw object van BarCodeGenerator-klasse</li><li>Bepaal de gewenste barcodetypes als de parameter EncodeTypes</li><li>Voeg invoertekst in als tweede parameter</li><li> Roep de BarCodeGenerator.save-methode aan om de gegenereerde GS1 Code 128 streepjescode-afbeelding op te halen</li></ul>
