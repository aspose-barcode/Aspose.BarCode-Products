---
title: Scan ISMN streepjescode afbeeldingen via Python via Java
weight: 1510
description: Python-broncode voor ISMN streepjescode-herkenning met behulp van Java Runtime Environment.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/python-java/ismn/recognize/
aliases:
- /nl/python-java/recognize/ismn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lees ISMN streepjescodes met Python via Java" h2="Lees ISMN streepjescode in Python met behulp van server-side Aspose.BarCode voor Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het scannen van ISMN streepjescode in Python" %}}

{{% blocks/products/pf/agp/text %}}

Met Aspose.BarCode kunnen ontwikkelaars ISMN streepjescode-streepjescodes uit een stream of afbeelding lezen met een paar regels code

{{% /blocks/products/pf/agp/text %}}

<ul><li>Maak een object van de klasse Aspose.BarCode.BarCodeReader</li><li>Definieer het pad naar het bronbestand dat ISMN streepjescode als parameter bevat</li><li>Bepaal de vereiste typen streepjescodes in DecodeType als de tweede parameter</li><li>Loop door de decoderingsresultaten</li><li>Haal de streepjescodetekst op met behulp van de eigenschap CodeText</li></ul>
