---
title: Genereer Codablock-F en GS1 Codablock-F streepjescodes afbeeldingen via Python via Java
description: Python-voorbeeldcode om Codablock-F en GS1 Codablock-F streepjescodes te genereren met Java Runtime Environment.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/python-java/codablock/generate/
aliases:
- /nl/python-java/generate/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genereer Codablock-F-labels met Python via Java" h2="Maak Codablock-F en GS1 Codablock-F streepjescodes in Python met Aspose.BarCode aan de serverzijde voor Python via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Codablock-F streepjescode Using Python via Java" %}}
Als u Codablock-F streepjescode-afbeeldingen wilt maken, downloadt u [Aspose.BarCode voor Python via Java](https://products.aspose.com/barcode/python-java/) API, een veelzijdige, krachtige en gebruiksvriendelijke -gebruik streepjescodebibliotheek voor op Python gebaseerde toepassingen. Download de nieuwste versie rechtstreeks van de [Aspose releases](https://releases.aspose.com/barcode/python-java/) portal of installeer 'aspose-barcode' van pip met de volgende opdracht:
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om Codablock-F streepjescode te genereren in Python" %}}
...
<ul><li>Maak een nieuw object van BarCodeGenerator-klasse</li><li>Bepaal de gewenste barcodetypes als de parameter EncodeTypes</li><li>Voeg invoertekst in als tweede parameter</li><li> Roep de BarCodeGenerator.save-methode aan om de gegenereerde Codablock-F en GS1 Codablock-F streepjescodes-afbeelding op te halen</li></ul>
