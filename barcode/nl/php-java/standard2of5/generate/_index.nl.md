---
title: Genereer Standard 2 of 5 (Industriële 2 van 5) streepjescode afbeeldingen via PHP via Java
description: PHP-broncode om Standard 2 of 5 (Industriële 2 van 5) streepjescode te maken in op PHP gebaseerde applicaties.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/php-java/standard2of5/generate/
aliases:
- /nl/php-java/generate/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genereer Standard 2 of 5-labels met PHP via Java" h2="Maak Standard 2 of 5 (Industriële 2 van 5) streepjescode in PHP met Aspose.BarCode aan de serverzijde voor PHP via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Standard 2 of 5 streepjescode Using PHP via Java" %}}
Genereer aangepaste Standard 2 of 5 streepjescode-barcodes binnen PHP-applicaties door middel van de Aspose.BarCode voor PHP via Java, een efficiënte, schaalbare en gebruiksvriendelijke barcode-API bedoeld voor op Java gebaseerde platforms. Om de barcodebibliotheek te starten, downloadt u de nieuwste versie van de [Aspose releases](https://releases.aspose.com/barcode/php/) portal. Haal anders het pakket [aspose/barcode](https://packagist.org/packages/aspose/barcode) van Packagist en sluit het vervolgens in uw PHP-projecten in met behulp van composer:
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om Standard 2 of 5 streepjescode te genereren in PHP" %}}

{{% blocks/products/pf/agp/text %}}

Met Aspose.BarCode kunnen ontwikkelaars gemakkelijk Standard 2 of 5 streepjescode-afbeeldingen maken met weinig regels code.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Maak een nieuwe instantie van BarCodeGenerator-klasse</li><li>Specificeer Standard 2 of 5 streepjescode en andere relevante streepjescodetypen als de EncodeTypes-parameter</li><li>Stel streepjescodetekst in als de tweede parameter</li><li>Geef zo ​​nodig de afmetingen en locatie van de afbeelding op</li><li>Roep de BarCodeGenerator.save-methode aan om de Standard 2 of 5 (Industriële 2 van 5) streepjescode-afbeelding in het vereiste formaat te verkrijgen</li></ul>
