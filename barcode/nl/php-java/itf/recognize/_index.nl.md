---
title: Scan Doorschoten 2-van-5 (ITF) streepjescode afbeeldingen via PHP via Java
weight: 1510
description: PHP-voorbeeldcode om Doorschoten 2-van-5 (ITF) streepjescode te lezen in op PHP gebaseerde applicaties.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/php-java/itf/recognize/
aliases:
- /nl/php-java/recognize/itf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lees ITF streepjescodes met PHP via Java" h2="Lees Doorschoten 2-van-5 (ITF) streepjescode in PHP met behulp van server-side Aspose.BarCode voor PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het scannen van Doorschoten 2-van-5 (ITF) streepjescode in PHP" %}}
...
<ul><li>Maak een object van de klasse Aspose.BarCode.BarCodeReader</li><li>Stel het bronafbeeldingspad met Doorschoten 2-van-5 (ITF) streepjescode in als een parameter</li><li>Specificeer doelstreepjescodetypen in DecodeType als de tweede parameter</li><li>Loop door de leesresultaten</li><li>Verkrijg de streepjescodetekst met behulp van de eigenschap CodeText</li></ul>
