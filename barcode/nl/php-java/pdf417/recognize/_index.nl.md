---
title: Scan PDF417 streepjescode afbeeldingen via PHP via Java
weight: 1510
description: PHP-voorbeeldcode om PDF417 streepjescode te lezen in op PHP gebaseerde applicaties.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/php-java/pdf417/recognize/
aliases:
- /nl/php-java/recognize/pdf417/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lees PDF417 streepjescodes met PHP via Java" h2="Lees PDF417 streepjescode in PHP met behulp van server-side Aspose.BarCode voor PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF417" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het scannen van PDF417 streepjescode in PHP" %}}
...
<ul><li>Maak een object van de klasse Aspose.BarCode.BarCodeReader</li><li>Stel het bronafbeeldingspad met PDF417 streepjescode in als een parameter</li><li>Specificeer doelstreepjescodetypen in DecodeType als de tweede parameter</li><li>Loop door de leesresultaten</li><li>Verkrijg de streepjescodetekst met behulp van de eigenschap CodeText</li></ul>
