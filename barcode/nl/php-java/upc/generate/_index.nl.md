---
title: Genereer UPC (Universele productcode) streepjescode afbeeldingen via PHP via Java
description: PHP-broncode om UPC (Universele productcode) streepjescode te maken in op PHP gebaseerde applicaties.
lang: nl/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /nl/php-java/upc/generate/
aliases:
- /nl/php-java/generate/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genereer UPC-labels met PHP via Java" h2="Maak UPC (Universele productcode) streepjescode in PHP met Aspose.BarCode aan de serverzijde voor PHP via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate UPC (Universele productcode) streepjescode Using PHP via Java" %}}
Genereer aangepaste UPC (Universele productcode) streepjescode-barcodes binnen PHP-applicaties door middel van de Aspose.BarCode voor PHP via Java, een efficiënte, schaalbare en gebruiksvriendelijke barcode-API bedoeld voor op Java gebaseerde platforms. Om de barcodebibliotheek te starten, downloadt u de nieuwste versie van de [Aspose releases](https://releases.aspose.com/barcode/php/) portal. Haal anders het pakket [aspose/barcode](https://packagist.org/packages/aspose/barcode) van Packagist en sluit het vervolgens in uw PHP-projecten in met behulp van composer:
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om UPC (Universele productcode) streepjescode te genereren in PHP" %}}

{{% blocks/products/pf/agp/text %}}

Met Aspose.BarCode kunnen ontwikkelaars gemakkelijk UPC (Universele productcode) streepjescode-afbeeldingen maken met weinig regels code.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Maak een nieuwe instantie van BarCodeGenerator-klasse</li><li>Specificeer UPC (Universele productcode) streepjescode en andere relevante streepjescodetypen als de EncodeTypes-parameter</li><li>Stel streepjescodetekst in als de tweede parameter</li><li>Geef zo ​​nodig de afmetingen en locatie van de afbeelding op</li><li>Roep de BarCodeGenerator.save-methode aan om de UPC (Universele productcode) streepjescode-afbeelding in het vereiste formaat te verkrijgen</li></ul>
