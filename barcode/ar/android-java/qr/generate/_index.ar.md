...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء QR الرمز في Java" %}}
...
<ul> <li> إنشاء مثيل جديد لفئة BarCodeGenerator </li> <li> تمرير نوع الرمز الشريطي QR الرمز كمعامل EncodeTypes </li> <li> تحديد نص الرمز الشريطي باستخدام طريقة setCodeText </li> <li> قم بتشغيل طريقة () createBarCodeImage لحفظ QR الرمز ، GS1 QR الرمز صورة الرمز الشريطي </li> </ul>
