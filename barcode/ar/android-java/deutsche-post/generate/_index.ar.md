---
title: إنشاء صور Deutsche Post رمز التعريف و Deutsche Post Leitcode عبر Android via Java
description: كود مصدر Android لإنشاء Deutsche Post رمز التعريف و Deutsche Post Leitcode في بيئة وقت تشغيل Android.
lang: ar/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ar/android-java/deutsche-post/generate/
aliases:
- /ar/android-java/generate/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="إنشاء ملصقات Deutsche Post باستخدام Android via Java" h2="أنشئ Deutsche Post رمز التعريف و Deutsche Post Leitcode في Java باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Deutsche Post الرمز الشريطي Using Android via Java" %}}
جرب Aspose.BarCode لنظام Android عبر Java لإنشاء Deutsche Post الرمز الشريطي داخل تطبيقات Android بسهولة. إنها مكتبة باركود متعددة الاستخدامات وقوية وسهلة الاستخدام مصممة خصيصًا لتطبيقات Android. يمكنك بسهولة Aspose.BarCode لنظام Android عبر Java مباشرة من مشروع قائم على Maven عن طريق إدخال التكوينات التالية في build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء Deutsche Post الرمز الشريطي في Java" %}}
...
<ul> <li> إنشاء مثيل جديد لفئة BarCodeGenerator </li> <li> تمرير نوع الرمز الشريطي Deutsche Post الرمز الشريطي كمعامل EncodeTypes </li> <li> تحديد نص الرمز الشريطي باستخدام طريقة setCodeText </li> <li> قم بتشغيل طريقة () createBarCodeImage لحفظ Deutsche Post رمز التعريف و Deutsche Post Leitcode صورة الرمز الشريطي </li> </ul>
