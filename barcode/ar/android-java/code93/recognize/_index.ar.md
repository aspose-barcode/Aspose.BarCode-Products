---
title: مسح ضوئي لصور Code 93 موسعة و Code 93 رموز شريطية قياسية عبر Android via Java
weight: 1510
description: نموذج رمز Android للتعرف على Code 93 موسعة و Code 93 رموز شريطية قياسية في بيئة وقت تشغيل Android.
lang: ar/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ar/android-java/code93/recognize/
aliases:
- /ar/android-java/recognize/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="قراءة الرموز الشريطية لـ Code 93 باستخدام Android via Java" h2="اقرأ Code 93 موسعة و Code 93 رموز شريطية قياسية في Java باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات Android via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 93 الرمز الشريطي Using Android via Java" %}}
جرب Aspose.BarCode لنظام Android عبر Java لاكتشاف وقراءة Code 93 الرمز الشريطي داخل تطبيقات Android بسهولة. إنها واجهة برمجة تطبيقات باركود غنية وقابلة للتطوير وسهلة الاستخدام مخصصة لتطبيقات Android. احصل على Aspose.BarCode لـ Java مباشرة من مشروع قائم على Maven عن طريق إضافة التكوينات التالية إلى build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات فحص Code 93 الرمز الشريطي في Java" %}}
...
<ul> <li> إنشاء مثيل لفئة BarCodeReader </li> <li> تحديد مسار الصورة المصدر الذي يحتوي على Code 93 الرمز الشريطي </li> <li> تحديد أنواع الرموز الشريطية المستهدفة في DecodeType على أنها المعلمة الثانية </li> <li> تكرار نتائج التعرف </li> <li> تحميل النص الذي تم فك ترميزه باستخدام طريقة getCodeText </li> </ul>
