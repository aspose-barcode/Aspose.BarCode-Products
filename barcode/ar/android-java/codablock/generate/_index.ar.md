---
title: إنشاء صور Codablock-F و GS1 Codablock-F الرموز الشريطية عبر Android via Java
description: كود مصدر Android لإنشاء Codablock-F و GS1 Codablock-F الرموز الشريطية في بيئة وقت تشغيل Android.
lang: ar/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ar/android-java/codablock/generate/
aliases:
- /ar/android-java/generate/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="إنشاء ملصقات Codablock-F باستخدام Android via Java" h2="أنشئ Codablock-F و GS1 Codablock-F الرموز الشريطية في Java باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Codablock-F الرمز الشريطي Using Android via Java" %}}
جرب Aspose.BarCode لنظام Android عبر Java لإنشاء Codablock-F الرمز الشريطي داخل تطبيقات Android بسهولة. إنها مكتبة باركود متعددة الاستخدامات وقوية وسهلة الاستخدام مصممة خصيصًا لتطبيقات Android. يمكنك بسهولة Aspose.BarCode لنظام Android عبر Java مباشرة من مشروع قائم على Maven عن طريق إدخال التكوينات التالية في build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء Codablock-F الرمز الشريطي في Java" %}}

{{% blocks/products/pf/agp/text %}}

يسهّل Aspose.BarCode للمطورين إنشاء صور Codablock-F الرمز الشريطي ببضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

<ul> <li> إنشاء مثيل جديد لفئة BarCodeGenerator </li> <li> تمرير نوع الرمز الشريطي Codablock-F الرمز الشريطي كمعامل EncodeTypes </li> <li> تحديد نص الرمز الشريطي باستخدام طريقة setCodeText </li> <li> قم بتشغيل طريقة () createBarCodeImage لحفظ Codablock-F و GS1 Codablock-F الرموز الشريطية صورة الرمز الشريطي </li> </ul>
