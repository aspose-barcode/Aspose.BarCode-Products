...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء Swiss Post Parcel في Java" %}}
...
<ul> <li> إنشاء مثيل جديد لفئة BarCodeGenerator </li> <li> تمرير نوع الرمز الشريطي Swiss Post Parcel كمعامل EncodeTypes </li> <li> تحديد نص الرمز الشريطي باستخدام طريقة setCodeText </li> <li> قم بتشغيل طريقة () createBarCodeImage لحفظ Swiss Post Parcel صورة الرمز الشريطي </li> </ul>
