...
{{% blocks/products/pf/agp/content h2="How to Read ISMN الرمز الشريطي Using Android via Java" %}}
جرب Aspose.BarCode لنظام Android عبر Java لاكتشاف وقراءة ISMN الرمز الشريطي داخل تطبيقات Android بسهولة. إنها واجهة برمجة تطبيقات باركود غنية وقابلة للتطوير وسهلة الاستخدام مخصصة لتطبيقات Android. احصل على Aspose.BarCode لـ Java مباشرة من مشروع قائم على Maven عن طريق إضافة التكوينات التالية إلى build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات فحص ISMN الرمز الشريطي في Java" %}}
...
<ul> <li> إنشاء مثيل لفئة BarCodeReader </li> <li> تحديد مسار الصورة المصدر الذي يحتوي على ISMN الرمز الشريطي </li> <li> تحديد أنواع الرموز الشريطية المستهدفة في DecodeType على أنها المعلمة الثانية </li> <li> تكرار نتائج التعرف </li> <li> تحميل النص الذي تم فك ترميزه باستخدام طريقة getCodeText </li> </ul>
