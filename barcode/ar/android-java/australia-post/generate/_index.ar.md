---
title: إنشاء صور Australia Post الرمز الشريطي و Australia Post eParcel عبر Android via Java
description: كود مصدر Android لإنشاء Australia Post الرمز الشريطي و Australia Post eParcel في بيئة وقت تشغيل Android.
lang: ar
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ar/android-java/australia-post/generate/
aliases:
- /ar/android-java/generate/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="إنشاء ملصقات Australia Post باستخدام Android via Java" h2="أنشئ Australia Post الرمز الشريطي و Australia Post eParcel في Java باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Australia Post الرمز الشريطي Using Android via Java" %}}
جرب Aspose.BarCode لنظام Android عبر Java لإنشاء Australia Post الرمز الشريطي داخل تطبيقات Android بسهولة. إنها مكتبة باركود متعددة الاستخدامات وقوية وسهلة الاستخدام مصممة خصيصًا لتطبيقات Android. يمكنك بسهولة Aspose.BarCode لنظام Android عبر Java مباشرة من مشروع قائم على Maven عن طريق إدخال التكوينات التالية في build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء Australia Post الرمز الشريطي في Java" %}}
...
<ul> <li> إنشاء مثيل جديد لفئة BarCodeGenerator </li> <li> تمرير نوع الرمز الشريطي Australia Post الرمز الشريطي كمعامل EncodeTypes </li> <li> تحديد نص الرمز الشريطي باستخدام طريقة setCodeText </li> <li> قم بتشغيل طريقة () createBarCodeImage لحفظ Australia Post الرمز الشريطي و Australia Post eParcel صورة الرمز الشريطي </li> </ul>
...
<ul> <li> Microsoft Windows أو Linux أو أي نظام تشغيل متوافق مع بيئة Android Runtime </li> <li> Android SDK v.30 </li> <li> أنظمة Android التي تعمل بنظام التشغيل Android OS 2.0 أو إصدار أحدث </li> </ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/pdf417/generate/" name="PDF417" description="PDF417 الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/qr/generate/" name="QR" description="QR الرمز ، GS1 QR الرمز" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/datamatrix/generate/" name="Data Matrix" description="رمز Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/aztec/generate/" name="Aztec" description="رمز Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/swiss-qr/generate/" name="Swiss QR" description="فاتورة Swiss QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/dotcode/generate/" name="DotCode" description="DotCode الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/hibc/generate/" name="HIBC" description="HIBC (الرمز الشريطي للصحة)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/codablock/generate/" name="Codablock-F" description="Codablock-F و GS1 Codablock-F الرموز الشريطية" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/databar/generate/" name="GS1 DataBar" description="GS1 DataBar (الرمز الشريطي متعدد الاتجاهات والمكدس متعدد الاتجاهات والموسّع والمكدس والمقطع)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/itf/generate/" name="ITF" description="معشق 2 من 5 (ITF) الباركود" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/ean/generate/" name="EAN" description="EAN (رقم المقالة الدولي) الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/upc/generate/" name="UPC" description="UPC (رمز المنتج العالمي) الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/code128/generate/" name="GS1 Code 128" description="GS1 Code 128 الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/code39/generate/" name="Code 39" description="Code 39 الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/code16k/generate/" name="Code 16K" description="Code 16K الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/code32/generate/" name="Code 32" description="الرمز الشريطي الإيطالي (Code 32) الباركود" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/code93/generate/" name="Code 93" description="Code 93 موسعة و Code 93 رموز شريطية قياسية" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/onecode/generate/" name="USPS OneCode" description="USPS OneCode الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/standard2of5/generate/" name="Standard 2 of 5" description="Standard 2 of 5 (صناعي 2 من 5) رمز شريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/isbn/generate/" name="ISBN" description="ISBN الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/ismn/generate/" name="ISMN" description="ISMN الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/issn/generate/" name="ISSN" description="ISSN الرمز الشريطي" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/australia-post/generate/" name="Australia Post" description="Australia Post الرمز الشريطي و Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post رمز التعريف و Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/rm4scc/generate/" name="RM4SCC" description="رمز عميل Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/postnet/generate/" name="Postnet" description="Postnet الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/royal-mail/generate/" name="Royal Mail" description="Royal Mail الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/singapore-post/generate/" name="Singapore Post" description="Singapore Post الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/android-java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
