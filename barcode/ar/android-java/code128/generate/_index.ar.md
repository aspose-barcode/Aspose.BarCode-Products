...
{{% blocks/products/pf/agp/content h2="How to Generate GS1 Code 128 الرمز الشريطي Using Android via Java" %}}
جرب Aspose.BarCode لنظام Android عبر Java لإنشاء GS1 Code 128 الرمز الشريطي داخل تطبيقات Android بسهولة. إنها مكتبة باركود متعددة الاستخدامات وقوية وسهلة الاستخدام مصممة خصيصًا لتطبيقات Android. يمكنك بسهولة Aspose.BarCode لنظام Android عبر Java مباشرة من مشروع قائم على Maven عن طريق إدخال التكوينات التالية في build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء GS1 Code 128 الرمز الشريطي في Java" %}}
...
<ul> <li> إنشاء مثيل جديد لفئة BarCodeGenerator </li> <li> تمرير نوع الرمز الشريطي GS1 Code 128 الرمز الشريطي كمعامل EncodeTypes </li> <li> تحديد نص الرمز الشريطي باستخدام طريقة setCodeText </li> <li> قم بتشغيل طريقة () createBarCodeImage لحفظ GS1 Code 128 الرمز الشريطي صورة الرمز الشريطي </li> </ul>
