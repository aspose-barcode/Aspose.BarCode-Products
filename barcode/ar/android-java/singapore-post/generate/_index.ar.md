---
title: إنشاء صور Singapore Post الرمز الشريطي عبر Android via Java
description: كود مصدر Android لإنشاء Singapore Post الرمز الشريطي في بيئة وقت تشغيل Android.
lang: ar
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ar/android-java/singapore-post/generate/
aliases:
- /ar/android-java/generate/singapore-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="إنشاء ملصقات Singapore Post باستخدام Android via Java" h2="أنشئ Singapore Post الرمز الشريطي في Java باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Singapore Post الرمز الشريطي Using Android via Java" %}}
جرب Aspose.BarCode لنظام Android عبر Java لإنشاء Singapore Post الرمز الشريطي داخل تطبيقات Android بسهولة. إنها مكتبة باركود متعددة الاستخدامات وقوية وسهلة الاستخدام مصممة خصيصًا لتطبيقات Android. يمكنك بسهولة Aspose.BarCode لنظام Android عبر Java مباشرة من مشروع قائم على Maven عن طريق إدخال التكوينات التالية في build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء Singapore Post الرمز الشريطي في Java" %}}
...
<ul> <li> إنشاء مثيل جديد لفئة BarCodeGenerator </li> <li> تمرير نوع الرمز الشريطي Singapore Post الرمز الشريطي كمعامل EncodeTypes </li> <li> تحديد نص الرمز الشريطي باستخدام طريقة setCodeText </li> <li> قم بتشغيل طريقة () createBarCodeImage لحفظ Singapore Post الرمز الشريطي صورة الرمز الشريطي </li> </ul>
