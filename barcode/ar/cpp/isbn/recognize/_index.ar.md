---
title: مسح ضوئي لصور ISBN الرمز الشريطي عبر C++
weight: 1510
description: نموذج لرمز C ++ لمسح ISBN الرمز الشريطي وفك تشفيره في C ++ Runtime Environment لنظام التشغيل Windows 32 بت أو Windows 64 بت أو Linux 64 بت.
lang: ar/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ar/cpp/isbn/recognize/
aliases:
- /ar/cpp/recognize/isbn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="قراءة الرموز الشريطية لـ ISBN باستخدام C++" h2="اقرأ ISBN الرمز الشريطي في C++ باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISBN" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read ISBN الرمز الشريطي Using C++" %}}
لمسح ISBN الرمز الشريطي ، جرب [Aspose.BarCode for C ++] (https://products.aspose.com/barcode/cpp/) API ، مكتبة باركود قوية وسهلة الاستخدام مع وظائف غنية لأنظمة C ++ . يمكنك تنزيل أحدث إصدار مباشرة&colon; فقط افتح مدير الحزم [NuGet] (https://www.nuget.org/packages/aspose.barcode) ، وابحث عن ** Aspose.BarCode.Cpp ** ، وقم بتثبيت الحزمة. بدلاً من ذلك ، يمكنك تشغيل الأمر التالي من Package Manager Console.
...
<ul> <li> أنشئ كائنًا من فئة Aspose.BarCode.BarCodeReader </li> <li> حدد مسار الصورة المصدر الذي يحتوي على ISBN الرمز الشريطي كمعامل </li> <li> قم بتمرير أنواع الرموز الشريطية المطلوبة في DecodeType كمعامل ثاني </li> <li> تكرار نتائج التعرف </li> <li> تحميل نص الرمز الشريطي الذي تم فك تشفيره باستخدام خاصية CodeText </li> </ul>
