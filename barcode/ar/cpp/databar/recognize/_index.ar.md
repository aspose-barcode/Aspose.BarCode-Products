---
title: مسح ضوئي لصور GS1 DataBar (الرمز الشريطي متعدد الاتجاهات والمكدس متعدد الاتجاهات والموسّع والمكدس والمقطع) عبر C++
weight: 1510
description: نموذج لرمز C ++ لمسح GS1 DataBar (الرمز الشريطي متعدد الاتجاهات والمكدس متعدد الاتجاهات والموسّع والمكدس والمقطع) وفك تشفيره في C ++ Runtime Environment لنظام التشغيل Windows 32 بت أو Windows 64 بت أو Linux 64 بت.
lang: ar/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ar/cpp/databar/recognize/
aliases:
- /ar/cpp/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="قراءة الرموز الشريطية لـ GS1 DataBar باستخدام C++" h2="اقرأ GS1 DataBar (الرمز الشريطي متعدد الاتجاهات والمكدس متعدد الاتجاهات والموسّع والمكدس والمقطع) في C++ باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 DataBar الرمز الشريطي Using C++" %}}
لمسح GS1 DataBar الرمز الشريطي ، جرب [Aspose.BarCode for C ++] (https://products.aspose.com/barcode/cpp/) API ، مكتبة باركود قوية وسهلة الاستخدام مع وظائف غنية لأنظمة C ++ . يمكنك تنزيل أحدث إصدار مباشرة&colon; فقط افتح مدير الحزم [NuGet] (https://www.nuget.org/packages/aspose.barcode) ، وابحث عن ** Aspose.BarCode.Cpp ** ، وقم بتثبيت الحزمة. بدلاً من ذلك ، يمكنك تشغيل الأمر التالي من Package Manager Console.
...
<ul> <li> أنشئ كائنًا من فئة Aspose.BarCode.BarCodeReader </li> <li> حدد مسار الصورة المصدر الذي يحتوي على GS1 DataBar الرمز الشريطي كمعامل </li> <li> قم بتمرير أنواع الرموز الشريطية المطلوبة في DecodeType كمعامل ثاني </li> <li> تكرار نتائج التعرف </li> <li> تحميل نص الرمز الشريطي الذي تم فك تشفيره باستخدام خاصية CodeText </li> </ul>
...
<ul> <li> Microsoft Windows أو Linux أو أي نظام تشغيل متوافق مع C ++ Runtime Environment لأنظمة Windows 32 بت و Windows 64 بت و Linux 64 بت. </li> <li> تمت الإشارة إلى Aspose.BarCode لـ C ++ DLL في مشروعك. </li> </ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/pdf417/recognize/" name="PDF417" description="PDF417 الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/qr/recognize/" name="QR" description="QR الرمز ، GS1 QR الرمز" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/datamatrix/recognize/" name="Data Matrix" description="رمز Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/aztec/recognize/" name="Aztec" description="رمز Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/swiss-qr/recognize/" name="Swiss QR" description="فاتورة Swiss QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/dotcode/recognize/" name="DotCode" description="DotCode الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/hibc/recognize/" name="HIBC" description="HIBC (الرمز الشريطي للصحة)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/codablock/recognize/" name="Codablock-F" description="Codablock-F و GS1 Codablock-F الرموز الشريطية" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (الرمز الشريطي متعدد الاتجاهات والمكدس متعدد الاتجاهات والموسّع والمكدس والمقطع)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/itf/recognize/" name="ITF" description="معشق 2 من 5 (ITF) الباركود" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/ean/recognize/" name="EAN" description="EAN (رقم المقالة الدولي) الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/upc/recognize/" name="UPC" description="UPC (رمز المنتج العالمي) الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/code39/recognize/" name="Code 39" description="Code 39 الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/code16k/recognize/" name="Code 16K" description="Code 16K الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/code32/recognize/" name="Code 32" description="الرمز الشريطي الإيطالي (Code 32) الباركود" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/code93/recognize/" name="Code 93" description="Code 93 موسعة و Code 93 رموز شريطية قياسية" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/onecode/recognize/" name="USPS OneCode" description="USPS OneCode الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (صناعي 2 من 5) رمز شريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/isbn/recognize/" name="ISBN" description="ISBN الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/ismn/recognize/" name="ISMN" description="ISMN الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/issn/recognize/" name="ISSN" description="ISSN الرمز الشريطي" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/australia-post/recognize/" name="Australia Post" description="Australia Post الرمز الشريطي و Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post رمز التعريف و Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/rm4scc/recognize/" name="RM4SCC" description="رمز عميل Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/postnet/recognize/" name="Postnet" description="Postnet الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/royal-mail/recognize/" name="Royal Mail" description="Royal Mail الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/singapore-post/recognize/" name="Singapore Post" description="Singapore Post الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/cpp/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
