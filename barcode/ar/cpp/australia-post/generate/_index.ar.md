---
title: إنشاء صور Australia Post الرمز الشريطي و Australia Post eParcel عبر C++
description: مثال C ++ على رمز لإنشاء Australia Post الرمز الشريطي و Australia Post eParcel في بيئة تشغيل C ++ لنظام التشغيل Windows 32 بت و Windows 64 بت و Linux 64 بت.
lang: ar
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ar/cpp/australia-post/generate/
aliases:
- /ar/cpp/generate/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="إنشاء ملصقات Australia Post باستخدام C++" h2="أنشئ Australia Post الرمز الشريطي و Australia Post eParcel في C++ باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Australia Post الرمز الشريطي Using C++" %}}
لإنشاء Australia Post الرمز الشريطي ، ثبّت [Aspose.BarCode for C ++] (https://products.aspose.com/barcode/cpp/) API ، مكتبة باركود قوية وسهلة الاستخدام مع وظائف غنية لأنظمة C ++ . قم بتنزيل أحدث إصدار مباشرة من مدير الحزم [NuGet] (https://www.nuget.org/packages/aspose.barcode)&colon; ابحث عن ** Aspose.BarCode.Cpp ** ثم ثبّت الحزمة. بدلاً من ذلك ، افتح وحدة تحكم مدير الحزم وقم بتشغيل الأمر التالي:
...
<ul> <li> إنشاء كائن من فئة BarcodeGenerator </li> <li> تمرير Australia Post الرمز الشريطي و Australia Post eParcel كمعامل </li> <li> أدخل نص الإدخال لترميزه كمعامل ثاني </li> <li> حدد أبعاد الصورة إذا لزم الأمر </li> <li> اتصل بأسلوب BarcodeGenerator.Save لتنزيل Australia Post الرمز الشريطي و Australia Post eParcel الرمز الشريطي </li> </ul>
