---
title: إنشاء صور Codablock-F و GS1 Codablock-F الرموز الشريطية عبر C++
description: مثال C ++ على رمز لإنشاء Codablock-F و GS1 Codablock-F الرموز الشريطية في بيئة تشغيل C ++ لنظام التشغيل Windows 32 بت و Windows 64 بت و Linux 64 بت.
lang: ar
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ar/cpp/codablock/generate/
aliases:
- /ar/cpp/generate/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="إنشاء ملصقات Codablock-F باستخدام C++" h2="أنشئ Codablock-F و GS1 Codablock-F الرموز الشريطية في C++ باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Codablock-F الرمز الشريطي Using C++" %}}
لإنشاء Codablock-F الرمز الشريطي ، ثبّت [Aspose.BarCode for C ++] (https://products.aspose.com/barcode/cpp/) API ، مكتبة باركود قوية وسهلة الاستخدام مع وظائف غنية لأنظمة C ++ . قم بتنزيل أحدث إصدار مباشرة من مدير الحزم [NuGet] (https://www.nuget.org/packages/aspose.barcode)&colon; ابحث عن ** Aspose.BarCode.Cpp ** ثم ثبّت الحزمة. بدلاً من ذلك ، افتح وحدة تحكم مدير الحزم وقم بتشغيل الأمر التالي:
...
<ul> <li> إنشاء كائن من فئة BarcodeGenerator </li> <li> تمرير Codablock-F و GS1 Codablock-F الرموز الشريطية كمعامل </li> <li> أدخل نص الإدخال لترميزه كمعامل ثاني </li> <li> حدد أبعاد الصورة إذا لزم الأمر </li> <li> اتصل بأسلوب BarcodeGenerator.Save لتنزيل Codablock-F و GS1 Codablock-F الرموز الشريطية الرمز الشريطي </li> </ul>
