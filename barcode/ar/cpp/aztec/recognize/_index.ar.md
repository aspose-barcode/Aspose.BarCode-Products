...
{{% blocks/products/pf/agp/content h2="How to Read رمز Aztec Using C++" %}}
لمسح رمز Aztec ، جرب [Aspose.BarCode for C ++] (https://products.aspose.com/barcode/cpp/) API ، مكتبة باركود قوية وسهلة الاستخدام مع وظائف غنية لأنظمة C ++ . يمكنك تنزيل أحدث إصدار مباشرة&colon; فقط افتح مدير الحزم [NuGet] (https://www.nuget.org/packages/aspose.barcode) ، وابحث عن ** Aspose.BarCode.Cpp ** ، وقم بتثبيت الحزمة. بدلاً من ذلك ، يمكنك تشغيل الأمر التالي من Package Manager Console.
...
<ul> <li> أنشئ كائنًا من فئة Aspose.BarCode.BarCodeReader </li> <li> حدد مسار الصورة المصدر الذي يحتوي على رمز Aztec كمعامل </li> <li> قم بتمرير أنواع الرموز الشريطية المطلوبة في DecodeType كمعامل ثاني </li> <li> تكرار نتائج التعرف </li> <li> تحميل نص الرمز الشريطي الذي تم فك تشفيره باستخدام خاصية CodeText </li> </ul>
