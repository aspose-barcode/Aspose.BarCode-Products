---
title: مسح ضوئي لصور Australia Post الرمز الشريطي و Australia Post eParcel عبر PHP via Java
weight: 1510
description: نموذج تعليمة برمجية PHP لقراءة Australia Post الرمز الشريطي و Australia Post eParcel في التطبيقات المستندة إلى PHP.
lang: ar/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ar/php-java/australia-post/recognize/
aliases:
- /ar/php-java/recognize/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="قراءة الرموز الشريطية لـ Australia Post باستخدام PHP via Java" h2="اقرأ Australia Post الرمز الشريطي و Australia Post eParcel في PHP باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Australia Post الرمز الشريطي Using PHP via Java" %}}
اقرأ الرموز الشريطية Australia Post الرمز الشريطي داخل تطبيقات PHP باستخدام Aspose.BarCode لـ PHP عبر Java ، مكتبة باركود قوية وغنية وسهلة الاستخدام مخصصة للأنظمة الأساسية القائمة على Java. لتجربة واجهة برمجة تطبيقات الباركود ، تحتاج إلى الحصول على أحدث إصدار من بوابة [Aspose release] (https://releases.aspose.com/barcode/php/). يمكنك أيضًا العثور على حزمة [aspose / barcode] (https://packagist.org/packages/aspose/barcode) في Packagist ثم دمجها في مشروع PHP الخاص بك عبر الملحن:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات فحص Australia Post الرمز الشريطي في PHP" %}}
...
<ul> <li> قم بإنشاء كائن من فئة Aspose.BarCode.BarCodeReader </li> <li> قم بتعيين مسار الصورة المصدر الذي يحتوي على Australia Post الرمز الشريطي كمعامل </li> <li> حدد أنواع الرموز الشريطية المستهدفة في DecodeType كمعامل ثاني </li> <li> تكرار نتائج القراءة </li> <li> الحصول على نص الرمز الشريطي باستخدام خاصية CodeText </li> </ul>
