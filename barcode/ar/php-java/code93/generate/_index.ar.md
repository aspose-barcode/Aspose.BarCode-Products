---
title: إنشاء صور Code 93 موسعة و Code 93 رموز شريطية قياسية عبر PHP via Java
description: كود مصدر PHP لإنشاء Code 93 موسعة و Code 93 رموز شريطية قياسية في التطبيقات المستندة إلى PHP.
lang: ar/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ar/php-java/code93/generate/
aliases:
- /ar/php-java/generate/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="إنشاء ملصقات Code 93 باستخدام PHP via Java" h2="أنشئ Code 93 موسعة و Code 93 رموز شريطية قياسية في PHP باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات PHP via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Code 93 الرمز الشريطي Using PHP via Java" %}}
قم بإنشاء رموز شريطية مخصصة Code 93 الرمز الشريطي داخل تطبيقات PHP عن طريق Aspose.BarCode لـ PHP عبر Java ، واجهة برمجة تطبيقات باركود فعالة وقابلة للتطوير وسهلة الاستخدام مخصصة للأنظمة الأساسية القائمة على Java. لبدء تشغيل مكتبة الباركود ، قم بتنزيل أحدث إصدار من بوابة [Aspose release] (https://releases.aspose.com/barcode/php/). بخلاف ذلك ، احصل على حزمة [aspose / barcode] (https://packagist.org/packages/aspose/barcode) من Packagist ثم قم بتضمينها في مشاريع PHP الخاصة بك باستخدام الملحن:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء Code 93 الرمز الشريطي في PHP" %}}

{{% blocks/products/pf/agp/text %}}

يسهّل Aspose.BarCode للمطورين إنشاء صور Code 93 الرمز الشريطي ببضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

<ul> <li> إنشاء مثيل جديد لفئة BarCodeGenerator </li> <li> حدد Code 93 الرمز الشريطي وأنواع الباركود الأخرى ذات الصلة كمعامل EncodeTypes </li> <li> تعيين نص الرمز الشريطي كمعامل ثاني </li> <li> حدد أبعاد الصورة والموقع إذا لزم الأمر </li> <li> اتصل بطريقة BarCodeGenerator.save للحصول على صورة Code 93 موسعة و Code 93 رموز شريطية قياسية بالتنسيق المطلوب </li> </ul>
