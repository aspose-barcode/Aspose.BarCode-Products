---
title: مسح ضوئي لصور USPS OneCode الرمز الشريطي عبر PHP via Java
weight: 1510
description: نموذج تعليمة برمجية PHP لقراءة USPS OneCode الرمز الشريطي في التطبيقات المستندة إلى PHP.
lang: ar/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ar/php-java/onecode/recognize/
aliases:
- /ar/php-java/recognize/onecode/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="قراءة الرموز الشريطية لـ USPS OneCode باستخدام PHP via Java" h2="اقرأ USPS OneCode الرمز الشريطي في PHP باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="USPS OneCode" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read USPS OneCode barcocde Using PHP via Java" %}}
اقرأ الرموز الشريطية USPS OneCode barcocde داخل تطبيقات PHP باستخدام Aspose.BarCode لـ PHP عبر Java ، مكتبة باركود قوية وغنية وسهلة الاستخدام مخصصة للأنظمة الأساسية القائمة على Java. لتجربة واجهة برمجة تطبيقات الباركود ، تحتاج إلى الحصول على أحدث إصدار من بوابة [Aspose release] (https://releases.aspose.com/barcode/php/). يمكنك أيضًا العثور على حزمة [aspose / barcode] (https://packagist.org/packages/aspose/barcode) في Packagist ثم دمجها في مشروع PHP الخاص بك عبر الملحن:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات فحص USPS OneCode barcocde في PHP" %}}
...
<ul> <li> قم بإنشاء كائن من فئة Aspose.BarCode.BarCodeReader </li> <li> قم بتعيين مسار الصورة المصدر الذي يحتوي على USPS OneCode barcocde كمعامل </li> <li> حدد أنواع الرموز الشريطية المستهدفة في DecodeType كمعامل ثاني </li> <li> تكرار نتائج القراءة </li> <li> الحصول على نص الرمز الشريطي باستخدام خاصية CodeText </li> </ul>
