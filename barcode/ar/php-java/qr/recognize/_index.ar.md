...
{{% blocks/products/pf/agp/content h2="How to Read QR الرمز Using PHP via Java" %}}
اقرأ الرموز الشريطية QR الرمز داخل تطبيقات PHP باستخدام Aspose.BarCode لـ PHP عبر Java ، مكتبة باركود قوية وغنية وسهلة الاستخدام مخصصة للأنظمة الأساسية القائمة على Java. لتجربة واجهة برمجة تطبيقات الباركود ، تحتاج إلى الحصول على أحدث إصدار من بوابة [Aspose release] (https://releases.aspose.com/barcode/php/). يمكنك أيضًا العثور على حزمة [aspose / barcode] (https://packagist.org/packages/aspose/barcode) في Packagist ثم دمجها في مشروع PHP الخاص بك عبر الملحن:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات فحص QR الرمز في PHP" %}}
...
<ul> <li> قم بإنشاء كائن من فئة Aspose.BarCode.BarCodeReader </li> <li> قم بتعيين مسار الصورة المصدر الذي يحتوي على QR الرمز كمعامل </li> <li> حدد أنواع الرموز الشريطية المستهدفة في DecodeType كمعامل ثاني </li> <li> تكرار نتائج القراءة </li> <li> الحصول على نص الرمز الشريطي باستخدام خاصية CodeText </li> </ul>
