...
{{% blocks/products/pf/agp/content h2="How to Generate GS1 Code 128 الرمز الشريطي Using Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء GS1 Code 128 الرمز الشريطي في Python" %}}
...
<ul> <li> أنشئ كائنًا جديدًا من فئة BarCodeGenerator </li> <li> حدد أنواع الرمز الشريطي المطلوبة كمعامل EncodeTypes </li> <li> أدخل نص الإدخال كمعامل ثاني </li> <li> اتصل بطريقة BarCodeGenerator.save للحصول على الصورة GS1 Code 128 الرمز الشريطي التي تم إنشاؤها </li> </ul>
