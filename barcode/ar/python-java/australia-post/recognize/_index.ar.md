---
title: مسح ضوئي لصور Australia Post الرمز الشريطي و Australia Post eParcel عبر Python via Java
weight: 1510
description: كود مصدر Python للتعرف على Australia Post الرمز الشريطي و Australia Post eParcel باستخدام Java Runtime Environment.
lang: ar
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ar/python-java/australia-post/recognize/
aliases:
- /ar/python-java/recognize/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="قراءة الرموز الشريطية لـ Australia Post باستخدام Python via Java" h2="اقرأ Australia Post الرمز الشريطي و Australia Post eParcel في Python باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Australia Post الرمز الشريطي Using Python via Java" %}}
لمسح وفك تشفير Australia Post الرمز الشريطي ، ثبّت [Aspose.BarCode for Python via Java] (https://products.aspose.com/barcode/python-java/) واجهة برمجة تطبيقات ، متعددة الاستخدامات وقوية وسهلة الاستخدام استخدام مكتبة الباركود للتطبيقات المستندة إلى Python. احصل على أحدث إصدار مباشرة من بوابة [Aspose release] (https://releases.aspose.com/barcode/python-java/) أو ثبّت "aspose-barcode" من النقطة عن طريق تشغيل الأمر التالي:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات فحص Australia Post الرمز الشريطي في Python" %}}
...
<ul> <li> أنشئ كائنًا من فئة Aspose.BarCode.BarCodeReader </li> <li> حدد مسار الملف المصدر الذي يحتوي على Australia Post الرمز الشريطي كمعامل </li> <li> حدد أنواع الرموز الشريطية المطلوبة في DecodeType كمعامل ثاني </li> <li> تكرار نتائج فك التشفير </li> <li> الحصول على نص الرمز الشريطي باستخدام خاصية CodeText </li> </ul>
