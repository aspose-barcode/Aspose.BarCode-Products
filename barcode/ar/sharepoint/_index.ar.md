...
weight: 220
url: /ar/sharepoint/ 
description: باركود SharePoint API لإدراج ملصقات الرموز الشريطية في قوائم SharePoint المخصصة. يمكن للمطورين استخدام "علامات الخدمة" لاختيار قيم نص التعليمات البرمجية أو إدراج النص يدويًا
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="أضف الرموز الشريطية إلى قوائم Microsoft SharePoint" h2="تطبيق SharePoint الباركود لإضافة رموز الباركود الخطية والثنائية الأبعاد والبريدية إلى قوائم Microsoft SharePoint." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/barcode/sharepoint" >}}
...
<p>
 Aspose.BarCode for SharePoint يسمح بإضافة عدد كبير من الرموز الشريطية الخطية ، ثنائية الأبعاد والبريدية إلى قوائم Microsoft SharePoint Foundation 2010 و Microsoft Office SharePoint Server 2010 (MOSS). يمكنك إضافة الباركود إلى أي قائمة عن طريق تحديد نص الكود والترميز.
</p>
...
{{< blocks/products/pf/carousel-item h3="لمحة سريعة" description="نظرة عامة على ميزات إنشاء الباركود." >}}
<div class="diagram1 d1-sharepoint">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="مولد الباركود SharePoint" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-sharepoint.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="النظام الأساسي المدعوم" description="Aspose.BarCode لـ SharePoint يدعم Microsoft SharePoint Foundation و SharePoint Server." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="تطبيق SharePoint Barcode" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-sharepoint.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="أنواع الباركود المدعومة" description="يدعم Aspose.BarCode لـ SharePoint ما يلي [تنسيقات الملفات](https://docs.aspose.com/barcode/sharepoint/supported-file-formats/)  :" >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
  ...
  <div class="d1-col d1-right">
   ...
   <!--<header><i class="fa fa-qrcode"> </i>Barcode أنواع</header>

<ul>

<li>أنواع الباركود الخطي</li>

<li>أنواع الباركود ثنائية الأبعاد</li>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <div class="col-lg-12">
    <h2 class="h2title">
     أضف عمود نوع الرمز الشريطي إلى قوائم SharePoint
    </h2>
    <p>
     يسهّل Aspose.BarCode لـ SharePoint إضافة عمود نوع الرمز الشريطي إلى قوائم SharePoint. يسمح لك هذا المكون أيضًا بتعيين نص الرمز الشريطي باستخدام واجهة المستخدم الرسومية أو من خلال دمج علامات الخدمة.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     يدعم تطبيق الباركود في SharePoint الرموز الأكثر شيوعًا بما في ذلك:
    </p>
    <div class="col-lg-3">
     <ul class="unstyled">
      <li>
    ...
    <div class="col-lg-3">
     <ul class="unstyled">
      <li>
       DeutcheبريديIdentificationCode
      </li>
      <li>
       DeutcheبريديleitCode
      </li>
      <li>
       EAN128
      </li>
   ...
   <div class="container">
    ...
    <div class="col-lg-12 mgtb55">
     <ul class="list-unstyled" id="resources">
      ...
      <!-- <li><a href="https://apireference.aspose.com/">مراجع API</a></li> -->
      <li>
     ...
     <ul class="list-unstyled" id="success-stories">
      <li class="resourcesheading">
       لماذا Aspose.BarCode لـ SharePoint؟
      </li>
