...
<ul> <li> إنشاء كائن جديد لفئة BarCodeGenerator </li> <li> تحديد DotCode الرمز الشريطي وأنواع الباركود الأخرى المطلوبة كمعامل EncodeTypes </li> <li> تحديد نص الإدخال باستخدام طريقة setCodeText </li> <li> استخدم طريقة BarCodeGenerator.save لحفظ صورة الرمز الشريطي التي تم إنشاؤها </li> </ul>
