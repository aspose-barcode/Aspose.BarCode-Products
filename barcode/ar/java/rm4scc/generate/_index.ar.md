---
title: إنشاء صور رمز عميل Royal Mail 4-State (RM4SCC) عبر Java
description: نموذج كود جافا للإنشاء رمز عميل Royal Mail 4-State (RM4SCC) في بيئة وقت تشغيل جافا لتطبيقات JSP / JSF وتطبيقات سطح المكتب.
lang: ar/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ar/java/rm4scc/generate/
aliases:
- /ar/java/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="إنشاء ملصقات RM4SCC باستخدام Java" h2="أنشئ رمز عميل Royal Mail 4-State (RM4SCC) في Java باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul> <li> إنشاء كائن جديد لفئة BarCodeGenerator </li> <li> تحديد رمز عميل Royal Mail 4-State (RM4SCC) وأنواع الباركود الأخرى المطلوبة كمعامل EncodeTypes </li> <li> تحديد نص الإدخال باستخدام طريقة setCodeText </li> <li> استخدم طريقة BarCodeGenerator.save لحفظ صورة الرمز الشريطي التي تم إنشاؤها </li> </ul>
