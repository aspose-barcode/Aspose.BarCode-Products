---
title: إنشاء صور Singapore Post الرمز الشريطي عبر Java
description: نموذج كود جافا للإنشاء Singapore Post الرمز الشريطي في بيئة وقت تشغيل جافا لتطبيقات JSP / JSF وتطبيقات سطح المكتب.
lang: ar/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ar/java/singapore-post/generate/
aliases:
- /ar/java/generate/singapore-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="إنشاء ملصقات Singapore Post باستخدام Java" h2="أنشئ Singapore Post الرمز الشريطي في Java باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul> <li> إنشاء كائن جديد لفئة BarCodeGenerator </li> <li> تحديد Singapore Post الرمز الشريطي وأنواع الباركود الأخرى المطلوبة كمعامل EncodeTypes </li> <li> تحديد نص الإدخال باستخدام طريقة setCodeText </li> <li> استخدم طريقة BarCodeGenerator.save لحفظ صورة الرمز الشريطي التي تم إنشاؤها </li> </ul>
