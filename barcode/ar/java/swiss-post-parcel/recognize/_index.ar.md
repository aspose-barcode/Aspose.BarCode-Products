...
<ul> <li> إنشاء كائن جديد لفئة BarCodeReader </li> <li> تعيين مسار الملف المصدر الذي يحتوي على Swiss Post Parcel </li> <li> قم بتمرير أنواع الرموز الشريطية المطلوبة إلى DecodeType كمعامل ثاني </li> <li> تكرار نتائج فك التشفير </li> <li> الحصول على نص الرمز الشريطي باستخدام طريقة getCodeText </li> </ul>
