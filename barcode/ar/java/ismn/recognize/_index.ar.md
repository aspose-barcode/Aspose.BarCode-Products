---
title: مسح ضوئي لصور ISMN الرمز الشريطي عبر Java
weight: 1510
description: كود مصدر جافا لقراءة وفك تشفير ISMN الرمز الشريطي في Java Runtime Environment لتطبيق JSP / JSF وتطبيقات سطح المكتب.
lang: ar/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ar/java/ismn/recognize/
aliases:
- /ar/java/recognize/ismn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="قراءة الرموز الشريطية لـ ISMN باستخدام Java" h2="اقرأ ISMN الرمز الشريطي في Java باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul> <li> إنشاء كائن جديد لفئة BarCodeReader </li> <li> تعيين مسار الملف المصدر الذي يحتوي على ISMN الرمز الشريطي </li> <li> قم بتمرير أنواع الرموز الشريطية المطلوبة إلى DecodeType كمعامل ثاني </li> <li> تكرار نتائج فك التشفير </li> <li> الحصول على نص الرمز الشريطي باستخدام طريقة getCodeText </li> </ul>
