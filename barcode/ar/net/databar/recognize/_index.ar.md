---
title: مسح ضوئي لصور GS1 DataBar (الرمز الشريطي متعدد الاتجاهات والمكدس متعدد الاتجاهات والموسّع والمكدس والمقطع) عبر .NET
weight: 1510
description: نموذج كود C # لمسح نوع الرمز الشريطي GS1 DataBar (الرمز الشريطي متعدد الاتجاهات والمكدس متعدد الاتجاهات والموسّع والمكدس والمقطع) وفك تشفيره في .NET Framework أو .NET Standard أو COM Interloop لـ PHP أو VBScript أو Delphi أو C ++.
lang: ar/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ar/net/databar/recognize/
aliases:
- /ar/net/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="قراءة الرموز الشريطية لـ GS1 DataBar باستخدام .NET" h2="اقرأ GS1 DataBar (الرمز الشريطي متعدد الاتجاهات والمكدس متعدد الاتجاهات والموسّع والمكدس والمقطع) في C# باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 DataBar الرمز الشريطي Using .NET" %}}
لفك تشفير GS1 DataBar الرمز الشريطي ، جرب [Aspose.BarCode for .NET] (https://products.aspose.com/barcode/net/) API ، مكتبة باركود غنية بالميزات وقوية وسهلة الاستخدام لمنصات C #. استخدم [NuGet] (https://www.nuget.org/packages/aspose.barcode) وابحث عن ** Aspose.BarCode ** لتثبيت الحزمة. بدلاً من ذلك ، قم بتشغيل الأمر التالي من وحدة تحكم مدير الحزم:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات فحص GS1 DataBar الرمز الشريطي في C#" %}}
...
<ul> <li> قم بإنشاء مثيل جديد لفئة Aspose.BarCode.BarCodeReader </li> <li> قم بتمرير مسار الصورة المصدر الذي يحتوي على GS1 DataBar الرمز الشريطي كمعامل </li> <li> قم بتمرير DecodeType مناسب كـ المعلمة الثانية </li> <li> تكرار نتائج فك التشفير </li> <li> الحصول على نص الرمز الشريطي باستخدام خاصية CodeText </li> </ul>
...
<ul> <li> Microsoft Windows أو Linux أو أي نظام تشغيل متوافق مع .NET Framework أو .NET Standard أو COM Interloop لـ PHP أو VBScript أو Delphi أو C ++ </li> <li> بيئة التطوير ، مثل Microsoft Visual Studio . </li> <li> Aspose.BarCode for .NET library DLL المشار إليها في مشروعك - قم بالتثبيت من NuGet باستخدام الزر Download </li> </ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/pdf417/recognize/" name="PDF417" description="PDF417 الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/qr/recognize/" name="QR" description="QR الرمز ، GS1 QR الرمز" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/datamatrix/recognize/" name="Data Matrix" description="رمز Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/aztec/recognize/" name="Aztec" description="رمز Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/swiss-qr/recognize/" name="Swiss QR" description="فاتورة Swiss QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/dotcode/recognize/" name="DotCode" description="DotCode الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/hibc/recognize/" name="HIBC" description="HIBC (الرمز الشريطي للصحة)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/codablock/recognize/" name="Codablock-F" description="Codablock-F و GS1 Codablock-F الرموز الشريطية" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (الرمز الشريطي متعدد الاتجاهات والمكدس متعدد الاتجاهات والموسّع والمكدس والمقطع)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/itf/recognize/" name="ITF" description="معشق 2 من 5 (ITF) الباركود" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/ean/recognize/" name="EAN" description="EAN (رقم المقالة الدولي) الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/upc/recognize/" name="UPC" description="UPC (رمز المنتج العالمي) الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/code39/recognize/" name="Code 39" description="Code 39 الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/code16k/recognize/" name="Code 16K" description="Code 16K الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/code32/recognize/" name="Code 32" description="الرمز الشريطي الإيطالي (Code 32) الباركود" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/code93/recognize/" name="Code 93" description="Code 93 موسعة و Code 93 رموز شريطية قياسية" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/onecode/recognize/" name="USPS OneCode" description="USPS OneCode الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (صناعي 2 من 5) رمز شريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/isbn/recognize/" name="ISBN" description="ISBN الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/ismn/recognize/" name="ISMN" description="ISMN الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/issn/recognize/" name="ISSN" description="ISSN الرمز الشريطي" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/australia-post/recognize/" name="Australia Post" description="Australia Post الرمز الشريطي و Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post رمز التعريف و Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/rm4scc/recognize/" name="RM4SCC" description="رمز عميل Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/postnet/recognize/" name="Postnet" description="Postnet الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/royal-mail/recognize/" name="Royal Mail" description="Royal Mail الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/singapore-post/recognize/" name="Singapore Post" description="Singapore Post الرمز الشريطي" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ar/net/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
