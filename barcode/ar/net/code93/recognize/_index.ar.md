---
title: مسح ضوئي لصور Code 93 موسعة و Code 93 رموز شريطية قياسية عبر .NET
weight: 1510
description: نموذج كود C # لمسح نوع الرمز الشريطي Code 93 موسعة و Code 93 رموز شريطية قياسية وفك تشفيره في .NET Framework أو .NET Standard أو COM Interloop لـ PHP أو VBScript أو Delphi أو C ++.
lang: ar
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ar/net/code93/recognize/
aliases:
- /ar/net/recognize/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="قراءة الرموز الشريطية لـ Code 93 باستخدام .NET" h2="اقرأ Code 93 موسعة و Code 93 رموز شريطية قياسية في C# باستخدام Aspose.BarCode من جانب الخادم لواجهة برمجة تطبيقات .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 93 الرمز الشريطي Using .NET" %}}
لفك تشفير Code 93 الرمز الشريطي ، جرب [Aspose.BarCode for .NET] (https://products.aspose.com/barcode/net/) API ، مكتبة باركود غنية بالميزات وقوية وسهلة الاستخدام لمنصات C #. استخدم [NuGet] (https://www.nuget.org/packages/aspose.barcode) وابحث عن ** Aspose.BarCode ** لتثبيت الحزمة. بدلاً من ذلك ، قم بتشغيل الأمر التالي من وحدة تحكم مدير الحزم:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات فحص Code 93 الرمز الشريطي في C#" %}}
...
<ul> <li> قم بإنشاء مثيل جديد لفئة Aspose.BarCode.BarCodeReader </li> <li> قم بتمرير مسار الصورة المصدر الذي يحتوي على Code 93 الرمز الشريطي كمعامل </li> <li> قم بتمرير DecodeType مناسب كـ المعلمة الثانية </li> <li> تكرار نتائج فك التشفير </li> <li> الحصول على نص الرمز الشريطي باستخدام خاصية CodeText </li> </ul>
