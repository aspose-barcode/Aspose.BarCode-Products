...
{{% blocks/products/pf/agp/content h2="How to Read QR الرمز Using .NET" %}}
لفك تشفير QR الرمز ، جرب [Aspose.BarCode for .NET] (https://products.aspose.com/barcode/net/) API ، مكتبة باركود غنية بالميزات وقوية وسهلة الاستخدام لمنصات C #. استخدم [NuGet] (https://www.nuget.org/packages/aspose.barcode) وابحث عن ** Aspose.BarCode ** لتثبيت الحزمة. بدلاً من ذلك ، قم بتشغيل الأمر التالي من وحدة تحكم مدير الحزم:
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات فحص QR الرمز في C#" %}}
...
<ul> <li> قم بإنشاء مثيل جديد لفئة Aspose.BarCode.BarCodeReader </li> <li> قم بتمرير مسار الصورة المصدر الذي يحتوي على QR الرمز كمعامل </li> <li> قم بتمرير DecodeType مناسب كـ المعلمة الثانية </li> <li> تكرار نتائج فك التشفير </li> <li> الحصول على نص الرمز الشريطي باستخدام خاصية CodeText </li> </ul>
