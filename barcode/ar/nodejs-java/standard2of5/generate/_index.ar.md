...
{{% blocks/products/pf/agp/content h2="How to Generate Standard 2 of 5 الرمز الشريطي Using Node.js via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء Standard 2 of 5 الرمز الشريطي في JavaScript" %}}
...
<ul> <li> إنشاء مثيل لفئة BarCodeGenerator </li> <li> قم بتعيين Standard 2 of 5 الرمز الشريطي كمعامل EncodeTypes </li> <li> حدد النص الذي سيتم ترميزه كمعامل ثاني </li> <li> تحديد أبعاد وموقع الرمز الشريطي إذا لزم الأمر </li> <li> اتصل بطريقة BarCodeGenerator.save للحصول على صورة الرمز الشريطي التي تم إنشاؤها </li> </ul>
