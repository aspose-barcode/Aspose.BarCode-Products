---
title: Scannen Sie Code 93 Erweiterte und Code 93 Standard-Barcodes Bilder über Node.js via Java
weight: 1510
description: Node.js-Quellcode für das Scannen und Dekodieren von Code 93 Erweiterte und Code 93 Standard-Barcodes in JavaScript-Anwendungen.
lang: de/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/nodejs-java/code93/recognize/
aliases:
- /de/nodejs-java/recognize/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lesen Sie Code 93 Barcodes mit Node.js via Java" h2="Lesen Sie Code 93 Erweiterte und Code 93 Standard-Barcodes in JavaScript mit der serverseitigen Aspose.BarCode für die Node.js via Java-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Scannen von Code 93 Barcode in JavaScript" %}}
