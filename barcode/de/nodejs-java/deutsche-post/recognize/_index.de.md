---
title: Scannen Sie Deutsche Post Identcode und Deutsche Post Leitcode Bilder über Node.js via Java
weight: 1510
description: Node.js-Quellcode für das Scannen und Dekodieren von Deutsche Post Identcode und Deutsche Post Leitcode in JavaScript-Anwendungen.
lang: de/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/nodejs-java/deutsche-post/recognize/
aliases:
- /de/nodejs-java/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lesen Sie Deutsche Post Barcodes mit Node.js via Java" h2="Lesen Sie Deutsche Post Identcode und Deutsche Post Leitcode in JavaScript mit der serverseitigen Aspose.BarCode für die Node.js via Java-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Scannen von Deutsche Post Barcode in JavaScript" %}}
