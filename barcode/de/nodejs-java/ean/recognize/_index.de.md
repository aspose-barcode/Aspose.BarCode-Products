---
title: Scannen Sie EAN (Internationale Artikelnummer) Barcode Bilder über Node.js via Java
weight: 1510
description: Node.js-Quellcode für das Scannen und Dekodieren von EAN (Internationale Artikelnummer) Barcode in JavaScript-Anwendungen.
lang: de
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/nodejs-java/ean/recognize/
aliases:
- /de/nodejs-java/recognize/ean/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lesen Sie EAN Barcodes mit Node.js via Java" h2="Lesen Sie EAN (Internationale Artikelnummer) Barcode in JavaScript mit der serverseitigen Aspose.BarCode für die Node.js via Java-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read EAN (Internationale Artikelnummer) Barcode Using Node.js via Java" %}}
Um EAN (Internationale Artikelnummer) Barcode in Node.js-Anwendungen zu erkennen, verwenden Sie Aspose.BarCode für Node.js über Java, eine robuste, vielseitige und benutzerfreundliche Barcode-Bibliothek, die für Java-basierte Umgebungen eingeführt wurde. Sie können [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) für Javascript direkt aus NPM laden:
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Scannen von EAN (Internationale Artikelnummer) Barcode in JavaScript" %}}
