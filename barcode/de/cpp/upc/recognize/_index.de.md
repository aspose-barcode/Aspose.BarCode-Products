---
title: Scannen Sie UPC (Universal Product Code) Barcode Bilder über C++
weight: 1510
description: C++-Beispielcode zum Scannen und Dekodieren von UPC (Universal Product Code) Barcode in der C++-Laufzeitumgebung für Windows 32-Bit, Windows 64-Bit oder Linux 64-Bit.
lang: de/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/cpp/upc/recognize/
aliases:
- /de/cpp/recognize/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lesen Sie UPC Barcodes mit C++" h2="Lesen Sie UPC (Universal Product Code) Barcode in C++ mit der serverseitigen Aspose.BarCode für die C++-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read UPC (Universal Product Code) Barcode Using C++" %}}
Um UPC (Universal Product Code) Barcode zu scannen, probieren Sie die API [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) aus, eine leistungsstarke und benutzerfreundliche Barcode-Bibliothek mit umfangreichen Funktionen für C++-Plattformen . Sie können die neueste Version direkt herunterladen&colon; Öffnen Sie einfach den Paketmanager [NuGet](https://www.nuget.org/packages/aspose.barcode), suchen Sie nach **Aspose.BarCode.Cpp** und installieren Sie das Paket. Alternativ können Sie den folgenden Befehl über die Package Manager-Konsole ausführen.
...
<ul><li>Erstellen Sie ein Objekt der Klasse Aspose.BarCode.BarCodeReader</li><li>Geben Sie den Quellbildpfad an, der UPC (Universal Product Code) Barcode als Parameter enthält</li><li>Übergeben Sie die erforderlichen Barcodetypen DecodeType als zweiter Parameter</li><li>Durchlaufen Sie die Erkennungsergebnisse</li><li>Laden Sie den decodierten Barcodetext mithilfe der CodeText-Eigenschaft</li></ul>
