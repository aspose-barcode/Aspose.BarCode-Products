...
{{% blocks/products/pf/agp/content h2="How to Generate Code 93 Barcode Using .NET" %}}
Um Code 93 Barcode zu erstellen, probieren Sie die [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API aus, eine funktionsreiche, leistungsstarke und benutzerfreundliche Barcode-Bibliothek für C#-Plattformen. Öffnen Sie den Paketmanager [NuGet](https://www.nuget.org/packages/aspose.barcode), suchen Sie nach **Aspose.BarCode** und installieren Sie das Paket. Sie können den folgenden Befehl auch über die Package Manager-Konsole ausführen:
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Generieren von Code 93 Barcode in C#" %}}
...
<ul><li>Erstellen Sie eine Instanz der BarcodeGenerator-Klasse</li><li>Übergeben Sie Code 93 Erweiterte und Code 93 Standard-Barcodes als Parameter</li><li>Legen Sie den zu kodierenden Text als zweiten Parameter fest</li><li> Geben Sie bei Bedarf Barcode-Abmessungen an</li><li>Rufen Sie die Methode BarcodeGenerator.Save auf, um das Bild Code 93 Erweiterte und Code 93 Standard-Barcodes zu erhalten</li></ul>
