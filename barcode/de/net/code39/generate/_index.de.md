---
title: Generieren Sie Code 39 Barcode Bilder über .NET
description: C#-Quellcode für die Code 39 Barcode-Generierung in .NET Framework, .NET Standard, COM Interloop für PHP, VBScript, Delphi und C++.
lang: de/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/net/code39/generate/
aliases:
- /de/net/generate/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generieren Sie Code 39-Etiketten mit .NET" h2="Erstellen Sie Code 39 Barcode in C# mit der serverseitigen Aspose.BarCode für die .NET-API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Um Code 39 Barcode zu erstellen, probieren Sie die [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API aus, eine funktionsreiche, leistungsstarke und benutzerfreundliche Barcode-Bibliothek für C#-Plattformen. Öffnen Sie den Paketmanager [NuGet](https://www.nuget.org/packages/aspose.barcode), suchen Sie nach **Aspose.BarCode** und installieren Sie das Paket. Sie können den folgenden Befehl auch über die Package Manager-Konsole ausführen:
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Generieren von Code 39 Barcode in C#" %}}
...
<ul><li>Erstellen Sie eine Instanz der BarcodeGenerator-Klasse</li><li>Übergeben Sie Code 39 Barcode als Parameter</li><li>Legen Sie den zu kodierenden Text als zweiten Parameter fest</li><li> Geben Sie bei Bedarf Barcode-Abmessungen an</li><li>Rufen Sie die Methode BarcodeGenerator.Save auf, um das Bild Code 39 Barcode zu erhalten</li></ul>
