---
title: Scannen Sie Code 39 Barcode Bilder über .NET
weight: 1510
description: C#-Beispielcode zum Scannen und Dekodieren des Barcodetyps Code 39 Barcode in .NET Framework, .NET Standard, COM Interloop für PHP, VBScript, Delphi oder C++.
lang: de/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/net/code39/recognize/
aliases:
- /de/net/recognize/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lesen Sie Code 39 Barcodes mit .NET" h2="Lesen Sie Code 39 Barcode in C# mit der serverseitigen Aspose.BarCode für die .NET-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Um Code 39 Barcode zu dekodieren, probieren Sie die [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API aus, eine funktionsreiche, leistungsstarke und benutzerfreundliche Barcode-Bibliothek für C#-Plattformen. Verwenden Sie [NuGet](https://www.nuget.org/packages/aspose.barcode) und suchen Sie nach **Aspose.BarCode**, um das Paket zu installieren. Alternativ können Sie den folgenden Befehl über die Package Manager-Konsole ausführen:
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Scannen von Code 39 Barcode in C#" %}}

{{% blocks/products/pf/agp/text %}}

Mit Aspose.BarCode können Entwickler mit wenigen Codezeilen Code 39 Barcode Barcodes aus einem Stream oder Bild lesen

{{% /blocks/products/pf/agp/text %}}

<ul><li>Erstellen Sie eine neue Instanz der Aspose.BarCode.BarCodeReader-Klasse</li><li>Übergeben Sie den Quellbildpfad, der Code 39 Barcode enthält, als Parameter</li><li>Übergeben Sie einen geeigneten DecodeType als der zweite Parameter</li><li>Durchlaufen Sie die Dekodierungsergebnisse</li><li>Barcodetext mithilfe der CodeText-Eigenschaft abrufen</li></ul>
