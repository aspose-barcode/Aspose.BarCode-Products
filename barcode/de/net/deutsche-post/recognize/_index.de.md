---
title: Scannen Sie Deutsche Post Identcode und Deutsche Post Leitcode Bilder über .NET
weight: 1510
description: C#-Beispielcode zum Scannen und Dekodieren des Barcodetyps Deutsche Post Identcode und Deutsche Post Leitcode in .NET Framework, .NET Standard, COM Interloop für PHP, VBScript, Delphi oder C++.
lang: de/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/net/deutsche-post/recognize/
aliases:
- /de/net/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lesen Sie Deutsche Post Barcodes mit .NET" h2="Lesen Sie Deutsche Post Identcode und Deutsche Post Leitcode in C# mit der serverseitigen Aspose.BarCode für die .NET-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Deutsche Post Barcode Using .NET" %}}
Um Deutsche Post Barcode zu dekodieren, probieren Sie die [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API aus, eine funktionsreiche, leistungsstarke und benutzerfreundliche Barcode-Bibliothek für C#-Plattformen. Verwenden Sie [NuGet](https://www.nuget.org/packages/aspose.barcode) und suchen Sie nach **Aspose.BarCode**, um das Paket zu installieren. Alternativ können Sie den folgenden Befehl über die Package Manager-Konsole ausführen:
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Scannen von Deutsche Post Barcode in C#" %}}

{{% blocks/products/pf/agp/text %}}

Mit Aspose.BarCode können Entwickler mit wenigen Codezeilen Deutsche Post Barcode Barcodes aus einem Stream oder Bild lesen

{{% /blocks/products/pf/agp/text %}}

<ul><li>Erstellen Sie eine neue Instanz der Aspose.BarCode.BarCodeReader-Klasse</li><li>Übergeben Sie den Quellbildpfad, der Deutsche Post Barcode enthält, als Parameter</li><li>Übergeben Sie einen geeigneten DecodeType als der zweite Parameter</li><li>Durchlaufen Sie die Dekodierungsergebnisse</li><li>Barcodetext mithilfe der CodeText-Eigenschaft abrufen</li></ul>
