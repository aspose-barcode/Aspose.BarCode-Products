---
title: Scannen Sie QR Code, GS1 QR Code Bilder über .NET
weight: 1510
description: C#-Beispielcode zum Scannen und Dekodieren des Barcodetyps QR Code, GS1 QR Code in .NET Framework, .NET Standard, COM Interloop für PHP, VBScript, Delphi oder C++.
lang: de/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/net/qr/recognize/
aliases:
- /de/net/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lesen Sie QR Barcodes mit .NET" h2="Lesen Sie QR Code, GS1 QR Code in C# mit der serverseitigen Aspose.BarCode für die .NET-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Um QR Code zu dekodieren, probieren Sie die [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API aus, eine funktionsreiche, leistungsstarke und benutzerfreundliche Barcode-Bibliothek für C#-Plattformen. Verwenden Sie [NuGet](https://www.nuget.org/packages/aspose.barcode) und suchen Sie nach **Aspose.BarCode**, um das Paket zu installieren. Alternativ können Sie den folgenden Befehl über die Package Manager-Konsole ausführen:
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Scannen von QR Code in C#" %}}
