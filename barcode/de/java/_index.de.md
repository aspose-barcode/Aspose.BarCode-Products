...
{{< blocks/products/pf/upper-banner h1="Java-API zur Barcode-Generierung und -Erkennung" h2="Erstellen und erkennen Sie Barcodes linearer, 2D- und postalischer Typen in jeder Java-Anwendung." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" pfName="Aspose.BarCode" subTitlepfName="für Java" downloadUrl="https://releases.aspose.com/barcode/java/" >}}
...
<p>Aspose.BarCode für Java ist eine robuste und zuverlässige API, die Funktionen zur Barcode-Generierung und -Erkennung für Java-Anwendungen bereitstellt. Es unterstützt die gängigsten Standards und Spezifikationen und ermöglicht Entwicklern das Lesen von 1D- und 2D-Barcodes aus verschiedenen Bilddateien aus jedem Winkel. Aspose.BarCode für Java rendert Barcode-Bilder in verschiedenen Bildformaten mit äußerst flexiblen Bildoptionen. Die Bibliothek unterstützt die Kodierung und Dekodierung von über 60 Barcode-Typen und ermöglicht das direkte Drucken von Barcode-Bildern.</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="Auf einen Blick" description="Ein Überblick über die Barcode-Erkennungs- und Generierungsfunktionen der API." >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>Linear, 2D und postalisch</li><li>Aus Stream oder Bild erkennen</li><li>Ausrichtung des Barcodes ermitteln</li><li>Nicht-englische Zeichen dekodieren</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                Drucken
            </header>
            <ul><li>Barcode direkt drucken</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>Linear, 2D und postalisch</li><li>Als Stream oder Bild speichern</li><li>Darstellung anpassen&colon; Größe, Farbe, Winkel</li><li>Nicht-englische Zeichen kodieren </li></ul>
            <header>
...
{{< blocks/products/pf/carousel-item h3="Plattformunabhängigkeit" description="Sie können die Barcode-Bibliothek verwenden, um jede Art von Java-Anwendung zu erstellen, auf der JRE 1.6 oder höher installiert ist." >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Unterstützte Dateiformate" description="Aspose.BarCode für Java funktioniert mit den am häufigsten verwendeten Bilddateiformaten." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Erweiterte Funktionen der Java-Bibliothek
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/control-the-appearance-of-code-text/'>Passen Sie die Darstellungseigenschaften von Codetext an und ändern Sie sie</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-the-barcode-caption/'>Verwalten Sie Beschriftungs- und Schriftarten</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/use-checksum-and-supplement-data-for-barcodes/'>Unterstützung für Prüfsummen- und Ergänzungsdaten</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#image-formats'>Generieren Sie Barcode-Bilder in mehreren Bildformaten</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/advanced-barcode-recognition-features/'>Lesen Sie 1D- und 2D-Typen aus jedem Winkel</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/barcode-regions/'>Scannen Sie den Barcode, indem Sie den Bereich angeben</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/generate-barcode-by-specifying-custom-image-size/'>Passen Sie die Bildgröße an</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-x-dimension-and-y-dimension/'>Unterstützung der X- und Y-Dimension für 2D-Typen</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#barcode-types'>Unterstützung für lineare, 2D- und postalische Symbologien</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Die Barcode-API ermöglicht Entwicklern die einfache Generierung hochwertiger Barcode-Bilder in ihren Anwendungen. Es unterstützt eine Vielzahl von Barcode-Typen, darunter weit verbreitete wie QR-Code und Code 128, aber auch speziellere Typen wie Aztec-Code und Data Matrix. Mit der API können Entwickler das Erscheinungsbild der generierten Barcodes anpassen, einschließlich der Vordergrund- und Hintergrundfarben, der Schriftart und der Beschriftungsausrichtung. Mit der API können Entwickler problemlos 2D-Barcodes auf die gleiche Weise generieren, wie sie eindimensionale Barcodes generieren würden.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Fügen Sie Barcodes in PDF-Dokumente ein
                </h2>
                <p>
                    Mit der Barcode-Bibliothek können Entwickler nicht nur benutzerdefinierte Barcodes erstellen, sondern auch generierte Bilder direkt in PDF-Dokumente einfügen. Sie können zunächst Barcodebilder in einem der unterstützten Rasterformate erstellen und diese dann in eine PDF-Datei einfügen. Die API ermöglicht das Hinzufügen von Barcodes ohne Bildkomprimierung und Qualitätsverluste. Es bietet außerdem Funktionen zum Ändern der Barcode-Parameter und des Erscheinungsbilds vor dem Einfügen oder zum gleichzeitigen Hinzufügen des generierten Bilds zu mehreren Dokumentseiten. Die Aspose.BarCode-API kann zum Drucken von Barcode-Bildern in hoher Qualität verwendet werden. Rasterbilder haben die Standardauflösung von 96 dpi, was für diesen Zweck nicht ausreicht. Die API ermöglicht die Einstellung einer Barcode-Bildauflösung von 300 oder 600 dpi, um hochwertige PDF-Dokumente zu drucken.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
                ...
                <p>
                    Die Java-Barcode-Bibliothek ist ein leistungsstarkes Tool für die Arbeit mit Barcodes in Java-Anwendungen. Eine seiner Hauptfunktionen ist die Möglichkeit, Barcodes aus verschiedenen Bilddateiformaten zu lesen. Die BarCodeReader-Klasse, die Hauptklasse für die Barcode-Erkennung, unterstützt viele gängige Bildformate, darunter BMP, PNG, TIFF, JPEG und GIF. Dies erleichtert die Integration der Barcode-Erkennungsfunktionalität in eine Vielzahl von Anwendungen.
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
<div class="barcode-read-lcs" style="width: 100%;">
    ...
    <div class="barcode-read-lcs-controls">
        <div class="barcode-read-lcs-drop" onclick="BarcodeReadLcsUpload(this);" ondragover="event.preventDefault();" ondrop="BarcodeReadLcsDropped(event,this);">
            ...
            <span class="barcode-read-lcs-recognizing">Erkennen<span></span></span>
            <span class="barcode-read-lcs-hint">Legen Sie hier eine Datei ab oder klicken Sie zum Durchsuchen *</span>
        </div>
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">Alle Arten</option>
                <option value="Pdf417 ">PDF417</option>
                <option value="QR ">QR</option>
    ...
    <p class="barcode-read-lcs-disclaimer">* Durch das Hochladen Ihrer Dateien oder die Nutzung des Dienstes stimmen Sie unseren <a href='https://about.aspose.com/legal/terms-of-use' rel='nofollow noreferrer' target='_blank'>Nutzungsbedingungen zu Nutzung</a> und <a href='https://about.aspose.com/legal/privacy-policy' rel='nofollow noreferrer' target='_blank'>Datenschutzerklärung</a>.</p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Scannen Sie Barcodes aus PDF-Dokumenten
                </h2>
                <p>
                    Neben dem Lesen von Barcodes aus Bilddateien kann die Barcode-Bibliothek auch zum Scannen von Barcodes aus PDF-Dateien verwendet werden. Entwickler können eine schnelle Barcode-Erkennung in mehrseitigen PDF-Dokumenten implementieren. Die API bietet hierfür mehrere Möglichkeiten. Die empfohlene Methode besteht darin, Dokumentseiten in Rasterbilder zu konvertieren und dann Barcode-Lesemechanismen anzuwenden. Als einfachste und effizienteste Vorgehensweise wird die Darstellung von Seiteninhalten in Rasterbildern vorgeschlagen. Andernfalls können Barcodebilder zunächst aus dem PDF-Quelldokument erkannt und extrahiert werden. Diese Methode ermöglicht das Lesen von Barcodes mit Originalauflösung. Die Aspose.BarCode-API ermöglicht die Verarbeitung mehrseitiger PDF-Dateien, um alle in einem Dokument dargestellten Barcodes zu erkennen und zu erkennen.
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/pdf417/" name="PDF417" description="PDF417 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/qr/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/datamatrix/" name="Data Matrix" description="Data Matrix-Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/aztec/" name="Aztec" description="Aztec Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/swiss-qr/" name="Swiss QR" description="Swiss QR Rechnung" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/dotcode/" name="DotCode" description="DotCode Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/hibc/" name="HIBC" description="HIBC (Barcode für die Gesundheitsbranche)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/codablock/" name="Codablock-F" description="Codablock-F und GS1 Codablock-F Barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirektionaler, gestapelter omnidirektionaler, erweiterter, erweiterter, gestapelter und verkürzter) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/itf/" name="ITF" description="Interleaved 2-of-5 (ITF) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/ean/" name="EAN" description="EAN (Internationale Artikelnummer) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/upc/" name="UPC" description="UPC (Universal Product Code) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/code128/" name="GS1 Code 128" description="GS1 Code 128 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/code39/" name="Code 39" description="Code 39 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/code16k/" name="Code 16K" description="Code 16K Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/code32/" name="Code 32" description="Italienischer Pharmacode (Code 32) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/code93/" name="Code 93" description="Code 93 Erweiterte und Code 93 Standard-Barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/onecode/" name="USPS OneCode" description="USPS OneCode Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrie 2 von 5) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/isbn/" name="ISBN" description="ISBN Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/ismn/" name="ISMN" description="ISMN Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/issn/" name="ISSN" description="ISSN Barcode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/australia-post/" name="Australia Post" description="Australia Post Barcode und Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode und Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/rm4scc/" name="RM4SCC" description="Royal Mail 4-State-Kundencode (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/postnet/" name="Postnet" description="Postnet Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/royal-mail/" name="Royal Mail" description="Royal Mail Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/singapore-post/" name="Singapore Post" description="Singapore Post Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="Was sagen die Leute" subTitle="Verlassen Sie sich nicht nur auf unser Wort. Sehen Sie, was Benutzer über APIs sagen." caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 Ich habe viele Jahre damit verbracht, mein Produkt zu entwickeln und zu verbessern, und Aspose hat es mir ermöglicht, mein Produkt viel benutzerfreundlicher und nützlicher und damit marktfähiger zu machen. <em>Kiel Diller | KD Solutions, Polen</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode ist wirklich in verwaltetem Code geschrieben und bietet uns eine Vielzahl von Barcode-Typen für alle Arten der Dokumentenerkennung und Weiterverarbeitung. <em>Dennis Alexander Petrasc | Keil IT, Deutschland</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="API-Referenzen" href="https://reference.aspose.com/barcode/java/" >}}
{{< blocks/products/pf/slr-element name="Tutorial-Videos" href="https://www.youtube.com/user/asposevideo" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Produkt Support" tabId="support" >}}
{{< blocks/products/pf/slr-element name="Kostenloser Support" href="https://forum.aspose.com/c/barcode/" >}}
...
{{< blocks/products/pf/slr-element name="Versionshinweise" href="https://docs.aspose.com/barcode/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Warum Aspose.BarCode für Java?" tabId="success-stories" >}}
{{< blocks/products/pf/slr-element name="Kundenliste" href="https://about.aspose.com/customers" >}}
{{< blocks/products/pf/slr-element name="Erfolgsgeschichten" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Aspose.BarCode bietet individuelle APIs zur Barcode-Generierung und -Erkennung für andere gängige Entwicklungsumgebungen, wie unten aufgeführt:" >}}
