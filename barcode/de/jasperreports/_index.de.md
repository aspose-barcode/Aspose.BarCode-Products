---
title: Generieren Sie Barcodes in JasperReports und rendern Sie sie in BMP, JPG, GIF und PNG
description: Mit Aspose.BarCode für JasperReports können Entwickler Barcodes in Jasper Reports generieren, die in den Formaten BMP, JPG, GIF und PNG weiter gerendert werden.
lang: de
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Generieren und exportieren Sie Barcodes in JasperReports" h2="JasperReports & JasperServer API zum Generieren, Anzeigen und Exportieren von 1D-, 2D- und Post-Barcodes." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="für JasperReports" downloadUrl="https://releases.aspose.com/barcode/jasperreports/" >}}
...
<p>Aspose.BarCode für JasperReports ist eine flexible JasperReports- und JasperServer-Erweiterung zum Erstellen und Anzeigen von Barcode-Etiketten in Ihren Anwendungen. Diese Barcode-Etiketten können in vielen gängigen Bildformaten gerendert werden.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformunabhängigkeit" description="Aspose.BarCode für JasperReports kann mit JasperServer und JasperReports verwendet werden." >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Unterstützte Dateiformate" description="Aspose.BarCode für JasperReports funktioniert mit den am häufigsten verwendeten Bilddateiformaten." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Erweiterte JasperReports-zu-Barcode-Exportfunktionen
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Erstellen und drucken Sie Berichte mit Barcodes</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Erhöhen Sie den Anwendungsworkflow durch Hinzufügen der Barcode-Funktionalität</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Betten Sie Barcodes in Dateien ein, um die Rückverfolgbarkeit zu erleichtern</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/barcode-image-basic-features/'>Größe, Farbe und Codetext des Steuercodes</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/read-barcodes-with-aspose-barcode-apis/'>Erkennung von 3D-verzerrten und gedrehten 2D-Barcodes</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/generate-barcode-by-specifying-custom-image-size/'>Erstellen Sie Barcode-Bilder einer bestimmten Größe</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    Aspose.BarCode für JasperReports bietet eine Reihe spezieller Tools für die Arbeit mit Barcodes in JasperReports. Mithilfe dieser API können Entwickler in vorhandenen Berichten platzierte Barcodes scannen oder sie zu neuen Berichten hinzufügen. Diese Barcode-Bibliothek ist ausschließlich in Java codiert, wird als einzelnes JAR-Dokument bereitgestellt und kann problemlos auf Computern bereitgestellt werden, auf denen JasperReports oder JasperServer installiert ist. Um die JasperReports-Barcode-Erweiterung zu installieren, kopieren Sie einfach das JAR-Dokument in den richtigen Ordner und beginnen Sie mit der Arbeit.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Mit der Barcode-Generator-Bibliothek können Entwickler auf einfache Weise Barcodes erstellen, indem sie den Typ des Barcodes angeben, die zu codierenden Daten eingeben und benutzerdefinierte Eigenschaften im Zusammenhang mit dem Erscheinungsbild festlegen. Dazu gehören verschiedene Optionen wie Hintergrund- und Vordergrundfarbe, Schriftart, Größe, Auflösung und Textbeschriftungen. Die API kann sowohl 1D- als auch 2D-Barcodes generieren, einschließlich PDF417-, Data Matrix-, Aztec-Code, QR-Code und Micro-QR-Code, wobei der gleiche Basisansatz verwendet wird. Dies macht es zu einem praktischen und benutzerfreundlichen Tool zum Generieren einer breiten Palette von Barcode-Typen für verschiedene Anwendungen, einschließlich JasperReports.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Fügen Sie Barcodes in JasperReports ein
                </h2>
                <p>
                    JasperReports ermöglicht Entwicklern die Erstellung von Berichten mithilfe der in verschiedenen Quellen gespeicherten Daten, beispielsweise Datenbanken, CSV-Dateien und XML-Dokumenten. Es bietet zahlreiche Funktionen zum Entwerfen, Formatieren und Exportieren von Berichten, die problemlos in Java-Anwendungen integriert werden können. Zu den häufigen Verwendungszwecken von JasperReports gehört die Erstellung von Rechnungen, Quittungen, Finanzberichten und anderen Arten von Geschäftsberichten. Es kann nützlich sein, Barcodes in JasperReports einzufügen, um den Zugriff auf und die Verwaltung der Informationen in Berichten zu erleichtern. Beispielsweise können Barcodes verwendet werden, um die Informationen in einem JasperReport schnell und genau zu scannen und zu aktualisieren, indem beispielsweise ein Barcode auf einer Rechnung gescannt wird, um die zugehörigen Daten abzurufen und anzuzeigen. Dies könnte die Nachverfolgung und Verwaltung von Informationen erleichtern und das Risiko von Fehlern oder Unstimmigkeiten verringern. Barcodes können auch dazu dienen, bestimmte Elemente oder Datensätze im Bericht anzuzeigen.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/pdf417/" name="PDF417" description="PDF417 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/qr/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/datamatrix/" name="Data Matrix" description="Data Matrix-Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/aztec/" name="Aztec" description="Aztec Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/swiss-qr/" name="Swiss QR" description="Swiss QR Rechnung" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/dotcode/" name="DotCode" description="DotCode Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/hibc/" name="HIBC" description="HIBC (Barcode für die Gesundheitsbranche)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/codablock/" name="Codablock-F" description="Codablock-F und GS1 Codablock-F Barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirektionaler, gestapelter omnidirektionaler, erweiterter, erweiterter, gestapelter und verkürzter) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/itf/" name="ITF" description="Interleaved 2-of-5 (ITF) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/ean/" name="EAN" description="EAN (Internationale Artikelnummer) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/upc/" name="UPC" description="UPC (Universal Product Code) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/code128/" name="GS1 Code 128" description="GS1 Code 128 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/code39/" name="Code 39" description="Code 39 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/code16k/" name="Code 16K" description="Code 16K Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/code32/" name="Code 32" description="Italienischer Pharmacode (Code 32) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/code93/" name="Code 93" description="Code 93 Erweiterte und Code 93 Standard-Barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/onecode/" name="USPS OneCode" description="USPS OneCode Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrie 2 von 5) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/isbn/" name="ISBN" description="ISBN Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/ismn/" name="ISMN" description="ISMN Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/issn/" name="ISSN" description="ISSN Barcode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/australia-post/" name="Australia Post" description="Australia Post Barcode und Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode und Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/rm4scc/" name="RM4SCC" description="Royal Mail 4-State-Kundencode (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/postnet/" name="Postnet" description="Postnet Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/royal-mail/" name="Royal Mail" description="Royal Mail Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/singapore-post/" name="Singapore Post" description="Singapore Post Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/jasperreports/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentation" href="https://docs.aspose.com/barcode/jasperreports/" >}}
...
{{< blocks/products/pf/slr-element name="Versionshinweise" href="https://docs.aspose.com/barcode/jasperreports/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Warum Aspose.BarCode für JasperReports?" tabId="success-stories" >}}
