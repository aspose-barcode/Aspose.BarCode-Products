---
title: Scannen Sie Deutsche Post Identcode und Deutsche Post Leitcode Bilder über Android via Java
weight: 1510
description: Android-Beispielcode zur Erkennung von Deutsche Post Identcode und Deutsche Post Leitcode in der Android-Laufzeitumgebung.
lang: de/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/android-java/deutsche-post/recognize/
aliases:
- /de/android-java/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lesen Sie Deutsche Post Barcodes mit Android via Java" h2="Lesen Sie Deutsche Post Identcode und Deutsche Post Leitcode in Java mit der serverseitigen Aspose.BarCode für die Android via Java-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Deutsche Post Barcode Using Android via Java" %}}
Probieren Sie Aspose.BarCode für Android über Java aus, um Deutsche Post Barcode problemlos in Android-Anwendungen zu erkennen und zu lesen. Es handelt sich um eine umfangreiche, skalierbare und benutzerfreundliche Barcode-API für Android-Anwendungen. Holen Sie sich Aspose.BarCode für Java direkt aus einem Maven-basierten Projekt, indem Sie die folgenden Konfigurationen zum build.gradle hinzufügen:
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Scannen von Deutsche Post Barcode in Java" %}}
...
<ul><li>Erstellen Sie eine Instanz der BarCodeReader-Klasse</li><li>Bestimmen Sie den Quellbildpfad, der {{BARCODE_FULL_NAME} enthält</li><li>Definieren Sie Ziel-Barcodetypen in DecodeType als zweiten Parameter</li><li>Durchlaufen Sie die Erkennungsergebnisse</li><li>Laden Sie den dekodierten Text mit der getCodeText-Methode</li></ul>
...
<ul><li>Microsoft Windows, Linux oder jedes mit der Android-Laufzeitumgebung kompatible Betriebssystem</li><li>Android SDK v.30</li><li>Android-Systeme mit Android OS 2.0 oder höher</li> </ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/pdf417/recognize/" name="PDF417" description="PDF417 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/qr/recognize/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix-Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/aztec/recognize/" name="Aztec" description="Aztec Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR Rechnung" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/dotcode/recognize/" name="DotCode" description="DotCode Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/hibc/recognize/" name="HIBC" description="HIBC (Barcode für die Gesundheitsbranche)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/codablock/recognize/" name="Codablock-F" description="Codablock-F und GS1 Codablock-F Barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (Omnidirektionaler, gestapelter omnidirektionaler, erweiterter, erweiterter, gestapelter und verkürzter) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/itf/recognize/" name="ITF" description="Interleaved 2-of-5 (ITF) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/ean/recognize/" name="EAN" description="EAN (Internationale Artikelnummer) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/upc/recognize/" name="UPC" description="UPC (Universal Product Code) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/code39/recognize/" name="Code 39" description="Code 39 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/code16k/recognize/" name="Code 16K" description="Code 16K Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/code32/recognize/" name="Code 32" description="Italienischer Pharmacode (Code 32) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/code93/recognize/" name="Code 93" description="Code 93 Erweiterte und Code 93 Standard-Barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrie 2 von 5) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/isbn/recognize/" name="ISBN" description="ISBN Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/ismn/recognize/" name="ISMN" description="ISMN Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/issn/recognize/" name="ISSN" description="ISSN Barcode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/australia-post/recognize/" name="Australia Post" description="Australia Post Barcode und Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode und Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4-State-Kundencode (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/postnet/recognize/" name="Postnet" description="Postnet Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/royal-mail/recognize/" name="Royal Mail" description="Royal Mail Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/singapore-post/recognize/" name="Singapore Post" description="Singapore Post Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/android-java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
