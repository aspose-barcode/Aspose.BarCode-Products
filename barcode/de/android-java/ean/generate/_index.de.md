...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Generieren von EAN (Internationale Artikelnummer) Barcode in Java" %}}
...
<ul><li>Erstellen Sie eine neue Instanz der BarCodeGenerator-Klasse</li><li>Übergeben Sie den Barcode-Typ EAN (Internationale Artikelnummer) Barcode als EncodeTypes-Parameter</li><li>Definieren Sie Barcode-Text mit der setCodeText-Methode</li><li>Starten Sie die Methode genericBarCodeImage(), um das Barcodebild EAN (Internationale Artikelnummer) Barcode zu speichern</li></ul>
