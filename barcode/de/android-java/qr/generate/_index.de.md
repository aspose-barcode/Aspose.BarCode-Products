...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Generieren von QR Code in Java" %}}
...
<ul><li>Erstellen Sie eine neue Instanz der BarCodeGenerator-Klasse</li><li>Übergeben Sie den Barcode-Typ QR Code als EncodeTypes-Parameter</li><li>Definieren Sie Barcode-Text mit der setCodeText-Methode</li><li>Starten Sie die Methode genericBarCodeImage(), um das Barcodebild QR Code, GS1 QR Code zu speichern</li></ul>
