...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Generieren von Royal Mail 4-State-Kundencode (RM4SCC) in Java" %}}
...
<ul><li>Erstellen Sie eine neue Instanz der BarCodeGenerator-Klasse</li><li>Übergeben Sie den Barcode-Typ Royal Mail 4-State-Kundencode (RM4SCC) als EncodeTypes-Parameter</li><li>Definieren Sie Barcode-Text mit der setCodeText-Methode</li><li>Starten Sie die Methode genericBarCodeImage(), um das Barcodebild Royal Mail 4-State-Kundencode (RM4SCC) zu speichern</li></ul>
