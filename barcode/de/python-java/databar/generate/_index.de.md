---
title: Generieren Sie GS1 DataBar (Omnidirektionaler, gestapelter omnidirektionaler, erweiterter, erweiterter, gestapelter und verkürzter) Barcode Bilder über Python via Java
description: Python-Beispielcode zum Generieren von GS1 DataBar (Omnidirektionaler, gestapelter omnidirektionaler, erweiterter, erweiterter, gestapelter und verkürzter) Barcode mithilfe der Java Runtime Environment.
lang: de/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/python-java/databar/generate/
aliases:
- /de/python-java/generate/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generieren Sie GS1 DataBar-Etiketten mit Python via Java" h2="Erstellen Sie GS1 DataBar (Omnidirektionaler, gestapelter omnidirektionaler, erweiterter, erweiterter, gestapelter und verkürzter) Barcode in Python mit der serverseitigen Aspose.BarCode für die Python via Java-API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate GS1 DataBar Barcode Using Python via Java" %}}
Um GS1 DataBar Barcode-Bilder zu erstellen, holen Sie sich die API [Aspose.BarCode für Python über Java](https://products.aspose.com/barcode/python-java/), eine funktionsreiche, leistungsstarke und benutzerfreundliche API -Barcode-Bibliothek für Python-basierte Anwendungen verwenden. Holen Sie sich die neueste Version direkt vom Portal [Aspose-Releases](https://releases.aspose.com/barcode/python-java/) oder installieren Sie „aspose-barcode“ von pip mit dem folgenden Befehl:
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Generieren von GS1 DataBar Barcode in Python" %}}
...
<ul><li>Erstellen Sie ein neues Objekt der BarCodeGenerator-Klasse</li><li>Bestimmen Sie die gewünschten Barcode-Typen als EncodeTypes-Parameter</li><li>Fügen Sie Eingabetext als zweiten Parameter ein</li><li> Rufen Sie die Methode BarCodeGenerator.save auf, um das generierte GS1 DataBar (Omnidirektionaler, gestapelter omnidirektionaler, erweiterter, erweiterter, gestapelter und verkürzter) Barcode-Bild</li></ul> abzurufen
...
<ul><li>Microsoft Windows, Linux oder jedes andere Betriebssystem, das mit den Python-Entwicklungsumgebungen kompatibel ist</li><li>Java 8 oder höher</li><li>Python 3.6 oder höher</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/pdf417/generate/" name="PDF417" description="PDF417 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/qr/generate/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/datamatrix/generate/" name="Data Matrix" description="Data Matrix-Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/aztec/generate/" name="Aztec" description="Aztec Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/swiss-qr/generate/" name="Swiss QR" description="Swiss QR Rechnung" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/dotcode/generate/" name="DotCode" description="DotCode Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/hibc/generate/" name="HIBC" description="HIBC (Barcode für die Gesundheitsbranche)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/codablock/generate/" name="Codablock-F" description="Codablock-F und GS1 Codablock-F Barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/databar/generate/" name="GS1 DataBar" description="GS1 DataBar (Omnidirektionaler, gestapelter omnidirektionaler, erweiterter, erweiterter, gestapelter und verkürzter) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/itf/generate/" name="ITF" description="Interleaved 2-of-5 (ITF) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/ean/generate/" name="EAN" description="EAN (Internationale Artikelnummer) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/upc/generate/" name="UPC" description="UPC (Universal Product Code) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/code128/generate/" name="GS1 Code 128" description="GS1 Code 128 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/code39/generate/" name="Code 39" description="Code 39 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/code16k/generate/" name="Code 16K" description="Code 16K Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/code32/generate/" name="Code 32" description="Italienischer Pharmacode (Code 32) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/code93/generate/" name="Code 93" description="Code 93 Erweiterte und Code 93 Standard-Barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/onecode/generate/" name="USPS OneCode" description="USPS OneCode Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/standard2of5/generate/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrie 2 von 5) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/isbn/generate/" name="ISBN" description="ISBN Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/ismn/generate/" name="ISMN" description="ISMN Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/issn/generate/" name="ISSN" description="ISSN Barcode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/australia-post/generate/" name="Australia Post" description="Australia Post Barcode und Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Identcode und Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/rm4scc/generate/" name="RM4SCC" description="Royal Mail 4-State-Kundencode (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/postnet/generate/" name="Postnet" description="Postnet Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/royal-mail/generate/" name="Royal Mail" description="Royal Mail Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/singapore-post/generate/" name="Singapore Post" description="Singapore Post Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/python-java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
