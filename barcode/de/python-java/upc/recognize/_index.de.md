---
title: Scannen Sie UPC (Universal Product Code) Barcode Bilder über Python via Java
weight: 1510
description: Python-Quellcode für die UPC (Universal Product Code) Barcode-Erkennung mithilfe der Java Runtime Environment.
lang: de
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/python-java/upc/recognize/
aliases:
- /de/python-java/recognize/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lesen Sie UPC Barcodes mit Python via Java" h2="Lesen Sie UPC (Universal Product Code) Barcode in Python mit der serverseitigen Aspose.BarCode für die Python via Java-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Scannen von UPC (Universal Product Code) Barcode in Python" %}}
...
<ul><li>Erstellen Sie ein Objekt der Klasse Aspose.BarCode.BarCodeReader</li><li>Definieren Sie den Quelldateipfad, der UPC (Universal Product Code) Barcode als Parameter enthält</li><li>Bestimmen Sie die erforderlichen Barcodetypen DecodeType als zweiter Parameter</li><li>Durchlaufen Sie die Dekodierungsergebnisse</li><li>Rufen Sie den Barcode-Text mithilfe der CodeText-Eigenschaft ab</li></ul>
