---
title: PHP-Barcode-Generator und Scanner-API
description: PHP-Barcode-Lesebibliothek zur Erkennung mehrerer Barcode-Typen, einschließlich 1D-, 2D- und Post-Barcodes. Verwenden Sie die API im Kern-PHP oder innerhalb von Frameworks wie Codeigniter, Cakephp oder Laravel.
lang: de/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="PHP-Barcode-Generator und Reader-API" h2="Scannen oder generieren Sie 1D-, 2D- und Post-Barcodes aus Bildern in jeder PHP-Webanwendung." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" pfName="Aspose.BarCode" subTitlepfName="für PHP via Java" downloadUrl="https://releases.aspose.com/barcode/php/" >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformunabhängigkeit" description="Aspose.Barcode für PHP über Java erfordert PHP 5.3 (oder höher) und JavaBridge. Es kann auf jeder Plattform ausgeführt werden, auf der diese Anforderungen erfüllt werden können." >}}
<div class='diagram1 d1-php-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Unterstützte Dateiformate" description="Aspose.BarCode für PHP via Java funktioniert mit den am häufigsten verwendeten Bilddateiformaten." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/set-barcode-parameters/'>Barcode-Parameter verwalten</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/customize-barcodes/'>Passen Sie die Barcodegröße an</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/generate-codabar/'>Codabar generieren</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/set-barcode-text/'>Passen Sie Textbeschriftungen an</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/barcode-reading-presets/'>Barcode-Lesevoreinstellungen</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/read-damaged-barcodes/'>Lesen Sie beschädigte Barcodes</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/pdf417/" name="PDF417" description="PDF417 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/qr/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/datamatrix/" name="Data Matrix" description="Data Matrix-Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/aztec/" name="Aztec" description="Aztec Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/swiss-qr/" name="Swiss QR" description="Swiss QR Rechnung" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/dotcode/" name="DotCode" description="DotCode Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/hibc/" name="HIBC" description="HIBC (Barcode für die Gesundheitsbranche)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/codablock/" name="Codablock-F" description="Codablock-F und GS1 Codablock-F Barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirektionaler, gestapelter omnidirektionaler, erweiterter, erweiterter, gestapelter und verkürzter) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/itf/" name="ITF" description="Interleaved 2-of-5 (ITF) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/ean/" name="EAN" description="EAN (Internationale Artikelnummer) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/upc/" name="UPC" description="UPC (Universal Product Code) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/code128/" name="GS1 Code 128" description="GS1 Code 128 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/code39/" name="Code 39" description="Code 39 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/code16k/" name="Code 16K" description="Code 16K Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/code32/" name="Code 32" description="Italienischer Pharmacode (Code 32) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/code93/" name="Code 93" description="Code 93 Erweiterte und Code 93 Standard-Barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/onecode/" name="USPS OneCode" description="USPS OneCode Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrie 2 von 5) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/isbn/" name="ISBN" description="ISBN Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/ismn/" name="ISMN" description="ISMN Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/issn/" name="ISSN" description="ISSN Barcode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/australia-post/" name="Australia Post" description="Australia Post Barcode und Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode und Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/rm4scc/" name="RM4SCC" description="Royal Mail 4-State-Kundencode (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/postnet/" name="Postnet" description="Postnet Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/royal-mail/" name="Royal Mail" description="Royal Mail Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/singapore-post/" name="Singapore Post" description="Singapore Post Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentation" href="https://docs.aspose.com/barcode/phpjava/" >}}
{{< blocks/products/pf/slr-element name="Quellcode" href="https://github.com/aspose-barcode/Aspose.BarCode-for-PHP-via-Java" >}}
{{< blocks/products/pf/slr-element name="API-Referenzen" href="https://reference.aspose.com/barcode/php/" >}}
...
{{< blocks/products/pf/slr-element name="Versionshinweise" href="https://docs.aspose.com/barcode/phpjava/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Warum Aspose.BarCode für PHP via Java?" tabId="success-stories" >}}
