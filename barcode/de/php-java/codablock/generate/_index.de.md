---
title: Generieren Sie Codablock-F und GS1 Codablock-F Barcodes Bilder über PHP via Java
description: PHP-Quellcode zum Erstellen von Codablock-F und GS1 Codablock-F Barcodes in PHP-basierten Anwendungen.
lang: de/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/php-java/codablock/generate/
aliases:
- /de/php-java/generate/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generieren Sie Codablock-F-Etiketten mit PHP via Java" h2="Erstellen Sie Codablock-F und GS1 Codablock-F Barcodes in PHP mit der serverseitigen Aspose.BarCode für die PHP via Java-API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Generieren von Codablock-F Barcode in PHP" %}}

{{% blocks/products/pf/agp/text %}}

Mit Aspose.BarCode können Entwickler ganz einfach Codablock-F Barcode Bilder mit wenigen Codezeilen erstellen.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Erstellen Sie eine neue Instanz der BarCodeGenerator-Klasse</li><li>Geben Sie Codablock-F Barcode und andere relevante Barcode-Typen als EncodeTypes-Parameter an</li><li>Legen Sie Barcode-Text als zweiten Parameter fest</li><li>Geben Sie bei Bedarf die Bildabmessungen und die Position an</li><li>Rufen Sie die Methode BarCodeGenerator.save auf, um das Codablock-F und GS1 Codablock-F Barcodes-Bild im erforderlichen Format zu erhalten</li></ul>
