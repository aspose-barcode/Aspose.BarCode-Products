---
title: Scannen Sie ISBN Barcode Bilder über PHP via Java
weight: 1510
description: PHP-Beispielcode zum Lesen von ISBN Barcode in PHP-basierten Anwendungen.
lang: de
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/php-java/isbn/recognize/
aliases:
- /de/php-java/recognize/isbn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lesen Sie ISBN Barcodes mit PHP via Java" h2="Lesen Sie ISBN Barcode in PHP mit der serverseitigen Aspose.BarCode für die PHP via Java-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISBN" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Scannen von ISBN Barcode in PHP" %}}

{{% blocks/products/pf/agp/text %}}

Mit Aspose.BarCode können Entwickler mit wenigen Codezeilen ISBN Barcode Barcodes aus einem Stream oder Bild lesen

{{% /blocks/products/pf/agp/text %}}

<ul><li>Erstellen Sie ein Objekt der Klasse Aspose.BarCode.BarCodeReader</li><li>Legen Sie den Quellbildpfad fest, der ISBN Barcode als Parameter enthält</li><li>Geben Sie Ziel-Barcodetypen in DecodeType an als zweiter Parameter</li><li>Durchlaufen Sie die Leseergebnisse</li><li>Erhalten Sie den Barcode-Text mithilfe der CodeText-Eigenschaft</li></ul>
