---
title: Scannen Sie Deutsche Post Identcode und Deutsche Post Leitcode Bilder über PHP via Java
weight: 1510
description: PHP-Beispielcode zum Lesen von Deutsche Post Identcode und Deutsche Post Leitcode in PHP-basierten Anwendungen.
lang: de/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /de/php-java/deutsche-post/recognize/
aliases:
- /de/php-java/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lesen Sie Deutsche Post Barcodes mit PHP via Java" h2="Lesen Sie Deutsche Post Identcode und Deutsche Post Leitcode in PHP mit der serverseitigen Aspose.BarCode für die PHP via Java-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Deutsche Post Barcode Using PHP via Java" %}}
Lesen Sie Deutsche Post Barcode-Barcodes in PHP-Anwendungen mit Aspose.BarCode für PHP über Java, einer leistungsstarken, umfangreichen und benutzerfreundlichen Barcode-Bibliothek für Java-basierte Plattformen. Um die Barcode-API auszuprobieren, müssen Sie die neueste Version vom Portal [Aspose-Releases](https://releases.aspose.com/barcode/php/) herunterladen. Sie können das Paket [aspose/barcode](https://packagist.org/packages/aspose/barcode) auch in Packagist finden und es dann über Composer in Ihr PHP-Projekt integrieren:
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Scannen von Deutsche Post Barcode in PHP" %}}
...
<ul><li>Erstellen Sie ein Objekt der Klasse Aspose.BarCode.BarCodeReader</li><li>Legen Sie den Quellbildpfad fest, der Deutsche Post Barcode als Parameter enthält</li><li>Geben Sie Ziel-Barcodetypen in DecodeType an als zweiter Parameter</li><li>Durchlaufen Sie die Leseergebnisse</li><li>Erhalten Sie den Barcode-Text mithilfe der CodeText-Eigenschaft</li></ul>
...
<ul><li>Microsoft Windows, Linux oder jedes andere Betriebssystem, das mit PHP-basierten Entwicklungsumgebungen kompatibel ist</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/pdf417/recognize/" name="PDF417" description="PDF417 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/qr/recognize/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix-Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/aztec/recognize/" name="Aztec" description="Aztec Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR Rechnung" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/dotcode/recognize/" name="DotCode" description="DotCode Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/hibc/recognize/" name="HIBC" description="HIBC (Barcode für die Gesundheitsbranche)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/codablock/recognize/" name="Codablock-F" description="Codablock-F und GS1 Codablock-F Barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (Omnidirektionaler, gestapelter omnidirektionaler, erweiterter, erweiterter, gestapelter und verkürzter) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/itf/recognize/" name="ITF" description="Interleaved 2-of-5 (ITF) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/ean/recognize/" name="EAN" description="EAN (Internationale Artikelnummer) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/upc/recognize/" name="UPC" description="UPC (Universal Product Code) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/code39/recognize/" name="Code 39" description="Code 39 Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/code16k/recognize/" name="Code 16K" description="Code 16K Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/code32/recognize/" name="Code 32" description="Italienischer Pharmacode (Code 32) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/code93/recognize/" name="Code 93" description="Code 93 Erweiterte und Code 93 Standard-Barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrie 2 von 5) Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/isbn/recognize/" name="ISBN" description="ISBN Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/ismn/recognize/" name="ISMN" description="ISMN Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/issn/recognize/" name="ISSN" description="ISSN Barcode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/australia-post/recognize/" name="Australia Post" description="Australia Post Barcode und Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode und Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4-State-Kundencode (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/postnet/recognize/" name="Postnet" description="Postnet Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/royal-mail/recognize/" name="Royal Mail" description="Royal Mail Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/singapore-post/recognize/" name="Singapore Post" description="Singapore Post Barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/de/php-java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
