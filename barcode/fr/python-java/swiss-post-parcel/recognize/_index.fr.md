---
title: Numérisez les images Swiss Post Parcel via Python via Java
weight: 1510
description: Code source Python pour la reconnaissance de Swiss Post Parcel à l'aide de Java Runtime Environment.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/python-java/swiss-post-parcel/recognize/
aliases:
- /fr/python-java/recognize/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lire les codes-barres Swiss Post Parcel avec Python via Java" h2="Lire Swiss Post Parcel en Python en utilisant Aspose.BarCode côté serveur pour l'API Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Pour analyser et décoder Swiss Post Parcel, installez l'API [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/), une application polyvalente, puissante et facile à utiliser. utiliser la bibliothèque de codes à barres pour les applications basées sur Python. Obtenez la dernière version directement depuis le portail [Aspose releases](https://releases.aspose.com/barcode/python-java/) ou installez "aspose-barcode" depuis pip en exécutant la commande suivante :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour scanner Swiss Post Parcel en Python" %}}
...
<ul> <li>Créer un objet de la classe Aspose.BarCode.BarCodeReader</li> <li>Définir le chemin du fichier source contenant Swiss Post Parcel comme paramètre</li> <li>Déterminer les types de codes à barres requis dans DecodeType comme deuxième paramètre</li><li>Parcourir les résultats du décodage</li><li>Obtenir le texte du code-barres à l'aide de la propriété CodeText</li></ul>
