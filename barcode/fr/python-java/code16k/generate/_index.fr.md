---
title: Générez des images Code 16K code-barres via Python via Java
description: Exemple de code Python pour générer Code 16K code-barres à l'aide de Java Runtime Environment.
lang: fr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /fr/python-java/code16k/generate/
aliases:
- /fr/python-java/generate/code16k/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes Code 16K avec Python via Java" h2="Créez Code 16K code-barres dans Python à l'aide de l'API Aspose.BarCode côté serveur pour Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer Code 16K code-barres en Python" %}}
...
<ul> <li>Créer un nouvel objet de la classe BarCodeGenerator</li> <li>Déterminer les types de codes à barres souhaités comme paramètre EncodeTypes</li> <li>Insérer le texte d'entrée comme deuxième paramètre</li> <li> Appelez la méthode BarCodeGenerator.save pour obtenir l'image Code 16K code-barres générée</li></ul>
