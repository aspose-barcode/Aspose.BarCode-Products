---
title: Générez des images Code-barres UPC (code de produit universel) via Python via Java
description: Exemple de code Python pour générer Code-barres UPC (code de produit universel) à l'aide de Java Runtime Environment.
lang: fr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /fr/python-java/upc/generate/
aliases:
- /fr/python-java/generate/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes UPC avec Python via Java" h2="Créez Code-barres UPC (code de produit universel) dans Python à l'aide de l'API Aspose.BarCode côté serveur pour Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Code-barres UPC (code de produit universel) Using Python via Java" %}}
Pour créer des images Code-barres UPC (code de produit universel), obtenez l'API [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/), une application riche en fonctionnalités, puissante et facile à utiliser -utiliser la bibliothèque de codes à barres pour les applications basées sur Python. Obtenez la dernière version directement depuis le portail [Aspose releases](https://releases.aspose.com/barcode/python-java/) ou installez "aspose-barcode" depuis pip avec la commande suivante :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer Code-barres UPC (code de produit universel) en Python" %}}
...
<ul> <li>Créer un nouvel objet de la classe BarCodeGenerator</li> <li>Déterminer les types de codes à barres souhaités comme paramètre EncodeTypes</li> <li>Insérer le texte d'entrée comme deuxième paramètre</li> <li> Appelez la méthode BarCodeGenerator.save pour obtenir l'image Code-barres UPC (code de produit universel) générée</li></ul>
