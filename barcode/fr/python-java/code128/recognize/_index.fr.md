---
title: Numérisez les images GS1 Code 128 code-barres via Python via Java
weight: 1510
description: Code source Python pour la reconnaissance de GS1 Code 128 code-barres à l'aide de Java Runtime Environment.
lang: fr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /fr/python-java/code128/recognize/
aliases:
- /fr/python-java/recognize/code128/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lire les codes-barres GS1 Code 128 avec Python via Java" h2="Lire GS1 Code 128 code-barres en Python en utilisant Aspose.BarCode côté serveur pour l'API Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour scanner GS1 Code 128 code-barres en Python" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode permet aux développeurs de lire les codes-barres GS1 Code 128 code-barres à partir d'un flux ou d'une image avec quelques lignes de code

{{% /blocks/products/pf/agp/text %}}

<ul> <li>Créer un objet de la classe Aspose.BarCode.BarCodeReader</li> <li>Définir le chemin du fichier source contenant GS1 Code 128 code-barres comme paramètre</li> <li>Déterminer les types de codes à barres requis dans DecodeType comme deuxième paramètre</li><li>Parcourir les résultats du décodage</li><li>Obtenir le texte du code-barres à l'aide de la propriété CodeText</li></ul>
