...
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes GS1 DataBar avec Python via Java" h2="Créez Code-barres GS1 DataBar (omnidirectionnel, empilé omnidirectionnel, déplié, déplié empilé et tronqué) dans Python à l'aide de l'API Aspose.BarCode côté serveur pour Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer GS1 DataBar code-barres en Python" %}}
...
<ul> <li>Créer un nouvel objet de la classe BarCodeGenerator</li> <li>Déterminer les types de codes à barres souhaités comme paramètre EncodeTypes</li> <li>Insérer le texte d'entrée comme deuxième paramètre</li> <li> Appelez la méthode BarCodeGenerator.save pour obtenir l'image Code-barres GS1 DataBar (omnidirectionnel, empilé omnidirectionnel, déplié, déplié empilé et tronqué) générée</li></ul>
