...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer Code 32 code-barres en Python" %}}
...
<ul> <li>Créer un nouvel objet de la classe BarCodeGenerator</li> <li>Déterminer les types de codes à barres souhaités comme paramètre EncodeTypes</li> <li>Insérer le texte d'entrée comme deuxième paramètre</li> <li> Appelez la méthode BarCodeGenerator.save pour obtenir l'image Code-barres italien Pharmacode (Code 32) générée</li></ul>
