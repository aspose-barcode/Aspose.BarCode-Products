---
title: Numérisez les images ISMN code-barres via Python via Java
weight: 1510
description: Code source Python pour la reconnaissance de ISMN code-barres à l'aide de Java Runtime Environment.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/python-java/ismn/recognize/
aliases:
- /fr/python-java/recognize/ismn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lire les codes-barres ISMN avec Python via Java" h2="Lire ISMN code-barres en Python en utilisant Aspose.BarCode côté serveur pour l'API Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read ISMN code-barres Using Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour scanner ISMN code-barres en Python" %}}
...
<ul> <li>Créer un objet de la classe Aspose.BarCode.BarCodeReader</li> <li>Définir le chemin du fichier source contenant ISMN code-barres comme paramètre</li> <li>Déterminer les types de codes à barres requis dans DecodeType comme deuxième paramètre</li><li>Parcourir les résultats du décodage</li><li>Obtenir le texte du code-barres à l'aide de la propriété CodeText</li></ul>
