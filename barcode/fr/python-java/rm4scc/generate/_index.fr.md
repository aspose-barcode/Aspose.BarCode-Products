---
title: Générez des images Code client Royal Mail 4-State (RM4SCC) via Python via Java
description: Exemple de code Python pour générer Code client Royal Mail 4-State (RM4SCC) à l'aide de Java Runtime Environment.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/python-java/rm4scc/generate/
aliases:
- /fr/python-java/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes RM4SCC avec Python via Java" h2="Créez Code client Royal Mail 4-State (RM4SCC) dans Python à l'aide de l'API Aspose.BarCode côté serveur pour Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Code client Royal Mail 4-State (RM4SCC) Using Python via Java" %}}
Pour créer des images Code client Royal Mail 4-State (RM4SCC), obtenez l'API [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/), une application riche en fonctionnalités, puissante et facile à utiliser -utiliser la bibliothèque de codes à barres pour les applications basées sur Python. Obtenez la dernière version directement depuis le portail [Aspose releases](https://releases.aspose.com/barcode/python-java/) ou installez "aspose-barcode" depuis pip avec la commande suivante :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer Code client Royal Mail 4-State (RM4SCC) en Python" %}}
...
<ul> <li>Créer un nouvel objet de la classe BarCodeGenerator</li> <li>Déterminer les types de codes à barres souhaités comme paramètre EncodeTypes</li> <li>Insérer le texte d'entrée comme deuxième paramètre</li> <li> Appelez la méthode BarCodeGenerator.save pour obtenir l'image Code client Royal Mail 4-State (RM4SCC) générée</li></ul>
