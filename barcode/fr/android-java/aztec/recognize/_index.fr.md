...
{{% blocks/products/pf/agp/content h2="How to Read Code Aztec Using Android via Java" %}}
Essayez Aspose.BarCode pour Android via Java pour détecter et lire facilement Code Aztec dans les applications Android. Il s'agit d'une API de code-barres riche, évolutive et conviviale destinée aux applications Android. Obtenez Aspose.BarCode pour Java directement à partir d'un projet basé sur Maven en ajoutant les configurations suivantes au build.gradle :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour scanner Code Aztec en Java" %}}
