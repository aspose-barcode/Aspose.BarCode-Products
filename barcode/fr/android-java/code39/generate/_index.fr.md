---
title: Générez des images Code 39 code-barres via Android via Java
description: Code source Android pour créer Code 39 code-barres dans l'environnement d'exécution Android.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/android-java/code39/generate/
aliases:
- /fr/android-java/generate/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes Code 39 avec Android via Java" h2="Créez Code 39 code-barres dans Java à l'aide de l'API Aspose.BarCode côté serveur pour Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer Code 39 code-barres en Java" %}}
...
<ul> <li>Créer une nouvelle instance de la classe BarCodeGenerator</li> <li>Transmettre le type de code à barres Code 39 code-barres comme paramètre EncodeTypes</li> <li>Définir le texte du code à barres à l'aide de la méthode setCodeText</li><li>Lancez la méthode generateBarCodeImage() pour enregistrer l'image du code-barres Code 39 code-barres</li></ul>
