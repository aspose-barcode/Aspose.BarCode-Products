...
{{% blocks/products/pf/agp/content h2="How to Read Postnet code-barres Using Android via Java" %}}
Essayez Aspose.BarCode pour Android via Java pour détecter et lire facilement Postnet code-barres dans les applications Android. Il s'agit d'une API de code-barres riche, évolutive et conviviale destinée aux applications Android. Obtenez Aspose.BarCode pour Java directement à partir d'un projet basé sur Maven en ajoutant les configurations suivantes au build.gradle :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour scanner Postnet code-barres en Java" %}}
...
<ul><li>Créer une instance de la classe BarCodeReader</li><li>Déterminer le chemin de l'image source contenant Postnet code-barres</li><li>Définir les types de codes-barres cibles dans DecodeType comme second paramètre</li><li>Parcourir les résultats de la reconnaissance</li><li>Charger le texte décodé en exécutant la méthode getCodeText</li></ul>
