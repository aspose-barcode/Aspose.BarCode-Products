---
title: API Android de code-barres | Scanner ou générer des codes-barres
description: Bibliothèque de scanners de codes-barres Android pour reconnaître différents types de codes-barres 1D, 2D et postaux. Scannez les codes-barres sous n'importe quel angle dans les applications Android.
lang: fr/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="API Android pour la génération et la reconnaissance de codes-barres" h2="Créez ou lisez des codes-barres 1D, 2D et postaux à partir d'images dans n'importe quelle application mobile Android." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" pfName="Aspose.BarCode" subTitlepfName="pour Android via Java" downloadUrl="https://releases.aspose.com/barcode/androidjava/" >}}
...
<p>Aspose.BarCode pour Android via Java est une API de génération et de lecture de codes-barres pour les applications Android. Il prend en charge la numérisation de codes-barres 1D, 2D et postaux à partir d'images sous différents angles. L'API du générateur de codes-barres peut facilement créer des images de codes-barres et les enregistrer dans différents formats. Il fournit également des fonctionnalités d'imagerie riches, telles que la personnalisation des bordures de code-barres, de la couleur, de l'angle de rotation, de la résolution et bien plus encore.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Indépendance de la plate-forme" description="Utilisez l'API sur n'importe quelle plate-forme où l'environnement d'exécution Android est disponible." >}}
<div class='diagram1 d1-android'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Formats de fichiers pris en charge" description="Aspose.BarCode pour Android via Java fonctionne avec les formats de fichiers image les plus couramment utilisés." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/qr-code-generation/'>Encoder des caractères non anglais dans les codes QR</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-color-modification/'>Modifier le jeu de couleurs du code-barres</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-appearance-customization/'>Faites pivoter les images de codes-barres sous n'importe quel angle</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/working-with-barcode-types/'>Générez et reconnaissez des codes-barres de plus de 60 types</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/recognition-settings/'>Lire les codes-barres à partir d'images</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-image-saving/'>Exporter des codes-barres dans différents formats d'image</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/pdf417/" name="PDF417" description="PDF417 code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/qr/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/datamatrix/" name="Data Matrix" description="Code Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/aztec/" name="Aztec" description="Code Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/swiss-qr/" name="Swiss QR" description="Swiss QR facture" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/dotcode/" name="DotCode" description="DotCode code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/hibc/" name="HIBC" description="HIBC (code à barres de l'industrie de la santé)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/codablock/" name="Codablock-F" description="Codes-barres Codablock-F et GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/databar/" name="GS1 DataBar" description="Code-barres GS1 DataBar (omnidirectionnel, empilé omnidirectionnel, déplié, déplié empilé et tronqué)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/itf/" name="ITF" description="Code-barres 2 sur 5 entrelacé (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/ean/" name="EAN" description="Code-barres EAN (numéro d'article international)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/upc/" name="UPC" description="Code-barres UPC (code de produit universel)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/code128/" name="GS1 Code 128" description="GS1 Code 128 code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/code39/" name="Code 39" description="Code 39 code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/code16k/" name="Code 16K" description="Code 16K code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/code32/" name="Code 32" description="Code-barres italien Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/code93/" name="Code 93" description="Codes-barres Code 93 étendus et Code 93 standard" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/onecode/" name="USPS OneCode" description="USPS OneCode code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/standard2of5/" name="Standard 2 of 5" description="Code-barres Standard 2 of 5 (Industriel 2 sur 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/isbn/" name="ISBN" description="ISBN code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/ismn/" name="ISMN" description="ISMN code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/issn/" name="ISSN" description="ISSN code-barres" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/australia-post/" name="Australia Post" description="Code-barres Australia Post et e-colis Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode et Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/rm4scc/" name="RM4SCC" description="Code client Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/postnet/" name="Postnet" description="Postnet code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/royal-mail/" name="Royal Mail" description="Royal Mail code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/singapore-post/" name="Singapore Post" description="Singapore Post code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Code source" href="https://github.com/aspose-barcode/Android-Library-Usage-Examples" >}}
{{< blocks/products/pf/slr-element name="Références API" href="https://reference.aspose.com/barcode/androidjava/" >}}
...
{{< blocks/products/pf/slr-element name="Notes de version" href="https://docs.aspose.com/barcode/java/android-via-java-release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.BarCode pour Android via Java ?" tabId="success-stories" >}}
