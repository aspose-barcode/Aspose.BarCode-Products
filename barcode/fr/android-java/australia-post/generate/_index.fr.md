---
title: Générez des images Code-barres Australia Post et e-colis Australia Post via Android via Java
description: Code source Android pour créer Code-barres Australia Post et e-colis Australia Post dans l'environnement d'exécution Android.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/android-java/australia-post/generate/
aliases:
- /fr/android-java/generate/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes Australia Post avec Android via Java" h2="Créez Code-barres Australia Post et e-colis Australia Post dans Java à l'aide de l'API Aspose.BarCode côté serveur pour Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Australia Post code-barres Using Android via Java" %}}
Essayez Aspose.BarCode pour Android via Java pour créer facilement Australia Post code-barres dans les applications Android. Il s'agit d'une bibliothèque de codes-barres polyvalente, robuste et conviviale spécialement conçue pour les applications Android. Vous pouvez facilement Aspose.BarCode pour Android via Java directement à partir d'un projet basé sur Maven en insérant les configurations suivantes dans build.gradle :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer Australia Post code-barres en Java" %}}
...
<ul> <li>Créer une nouvelle instance de la classe BarCodeGenerator</li> <li>Transmettre le type de code à barres Australia Post code-barres comme paramètre EncodeTypes</li> <li>Définir le texte du code à barres à l'aide de la méthode setCodeText</li><li>Lancez la méthode generateBarCodeImage() pour enregistrer l'image du code-barres Code-barres Australia Post et e-colis Australia Post</li></ul>
...
<ul> <li>Microsoft Windows, Linux ou tout système d'exploitation compatible avec l'environnement d'exécution Android</li> <li>Android SDK v.30</li> <li>Systèmes Android exécutant Android OS 2.0 ou version ultérieure</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/pdf417/generate/" name="PDF417" description="PDF417 code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/qr/generate/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/datamatrix/generate/" name="Data Matrix" description="Code Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/aztec/generate/" name="Aztec" description="Code Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/swiss-qr/generate/" name="Swiss QR" description="Swiss QR facture" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/dotcode/generate/" name="DotCode" description="DotCode code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/hibc/generate/" name="HIBC" description="HIBC (code à barres de l'industrie de la santé)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/codablock/generate/" name="Codablock-F" description="Codes-barres Codablock-F et GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/databar/generate/" name="GS1 DataBar" description="Code-barres GS1 DataBar (omnidirectionnel, empilé omnidirectionnel, déplié, déplié empilé et tronqué)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/itf/generate/" name="ITF" description="Code-barres 2 sur 5 entrelacé (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/ean/generate/" name="EAN" description="Code-barres EAN (numéro d'article international)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/upc/generate/" name="UPC" description="Code-barres UPC (code de produit universel)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/code128/generate/" name="GS1 Code 128" description="GS1 Code 128 code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/code39/generate/" name="Code 39" description="Code 39 code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/code16k/generate/" name="Code 16K" description="Code 16K code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/code32/generate/" name="Code 32" description="Code-barres italien Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/code93/generate/" name="Code 93" description="Codes-barres Code 93 étendus et Code 93 standard" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/onecode/generate/" name="USPS OneCode" description="USPS OneCode code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/standard2of5/generate/" name="Standard 2 of 5" description="Code-barres Standard 2 of 5 (Industriel 2 sur 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/isbn/generate/" name="ISBN" description="ISBN code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/ismn/generate/" name="ISMN" description="ISMN code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/issn/generate/" name="ISSN" description="ISSN code-barres" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/australia-post/generate/" name="Australia Post" description="Code-barres Australia Post et e-colis Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Identcode et Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/rm4scc/generate/" name="RM4SCC" description="Code client Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/postnet/generate/" name="Postnet" description="Postnet code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/royal-mail/generate/" name="Royal Mail" description="Royal Mail code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/singapore-post/generate/" name="Singapore Post" description="Singapore Post code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/android-java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
