---
title: Générez des images Code-barres GS1 DataBar (omnidirectionnel, empilé omnidirectionnel, déplié, déplié empilé et tronqué) via Android via Java
description: Code source Android pour créer Code-barres GS1 DataBar (omnidirectionnel, empilé omnidirectionnel, déplié, déplié empilé et tronqué) dans l'environnement d'exécution Android.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/android-java/databar/generate/
aliases:
- /fr/android-java/generate/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes GS1 DataBar avec Android via Java" h2="Créez Code-barres GS1 DataBar (omnidirectionnel, empilé omnidirectionnel, déplié, déplié empilé et tronqué) dans Java à l'aide de l'API Aspose.BarCode côté serveur pour Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer GS1 DataBar code-barres en Java" %}}
...
<ul> <li>Créer une nouvelle instance de la classe BarCodeGenerator</li> <li>Transmettre le type de code à barres GS1 DataBar code-barres comme paramètre EncodeTypes</li> <li>Définir le texte du code à barres à l'aide de la méthode setCodeText</li><li>Lancez la méthode generateBarCodeImage() pour enregistrer l'image du code-barres Code-barres GS1 DataBar (omnidirectionnel, empilé omnidirectionnel, déplié, déplié empilé et tronqué)</li></ul>
