...
<ul> <li>Créer un nouvel objet de la classe BarCodeGenerator</li> <li>Définir Code Aztec et les autres types de codes à barres requis comme paramètre EncodeTypes</li> <li>Spécifier le texte d'entrée à l'aide de la méthode setCodeText</li><li>Utilisez la méthode BarCodeGenerator.save pour enregistrer l'image de code-barres générée</li></ul>
