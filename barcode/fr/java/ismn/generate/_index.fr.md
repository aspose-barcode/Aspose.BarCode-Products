---
title: Générez des images ISMN code-barres via Java
description: Exemple de code Java pour la génération de ISMN code-barres dans Java Runtime Environment pour les applications JSP/JSF et les applications de bureau.
lang: fr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /fr/java/ismn/generate/
aliases:
- /fr/java/generate/ismn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes ISMN avec Java" h2="Créez ISMN code-barres dans Java à l'aide de l'API Aspose.BarCode côté serveur pour Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul> <li>Créer un nouvel objet de la classe BarCodeGenerator</li> <li>Définir ISMN code-barres et les autres types de codes à barres requis comme paramètre EncodeTypes</li> <li>Spécifier le texte d'entrée à l'aide de la méthode setCodeText</li><li>Utilisez la méthode BarCodeGenerator.save pour enregistrer l'image de code-barres générée</li></ul>
