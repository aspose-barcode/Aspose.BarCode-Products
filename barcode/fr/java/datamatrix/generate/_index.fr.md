---
title: Générez des images Code Data Matrix via Java
description: Exemple de code Java pour la génération de Code Data Matrix dans Java Runtime Environment pour les applications JSP/JSF et les applications de bureau.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/java/datamatrix/generate/
aliases:
- /fr/java/generate/datamatrix/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes Data Matrix avec Java" h2="Créez Code Data Matrix dans Java à l'aide de l'API Aspose.BarCode côté serveur pour Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Data Matrix" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul> <li>Créer un nouvel objet de la classe BarCodeGenerator</li> <li>Définir Code Data Matrix et les autres types de codes à barres requis comme paramètre EncodeTypes</li> <li>Spécifier le texte d'entrée à l'aide de la méthode setCodeText</li><li>Utilisez la méthode BarCodeGenerator.save pour enregistrer l'image de code-barres générée</li></ul>
