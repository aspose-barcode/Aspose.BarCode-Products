...
<ul><li>Créer un nouvel objet de la classe BarCodeReader</li><li>Définir le chemin du fichier source contenant Code-barres UPC (code de produit universel)</li><li>Passer les types de codes-barres requis à DecodeType comme second paramètre</li><li>Parcourir les résultats de décodage</li><li>Obtenir le texte du code-barres à l'aide de la méthode getCodeText</li></ul>
