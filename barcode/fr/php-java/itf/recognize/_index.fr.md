...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour scanner Code-barres 2 sur 5 entrelacé (ITF) en PHP" %}}
...
<ul> <li>Créer un objet de la classe Aspose.BarCode.BarCodeReader</li> <li>Définir le chemin de l'image source contenant Code-barres 2 sur 5 entrelacé (ITF) comme paramètre</li> <li>Spécifier les types de codes à barres cibles dans DecodeType comme deuxième paramètre</li><li>Parcourir les résultats de lecture</li><li>Obtenir le texte du code-barres à l'aide de la propriété CodeText</li></ul>
