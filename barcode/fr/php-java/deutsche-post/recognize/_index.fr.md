---
title: Numérisez les images Deutsche Post Identcode et Deutsche Post Leitcode via PHP via Java
weight: 1510
description: Exemple de code PHP pour lire Deutsche Post Identcode et Deutsche Post Leitcode dans les applications basées sur PHP.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/php-java/deutsche-post/recognize/
aliases:
- /fr/php-java/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lire les codes-barres Deutsche Post avec PHP via Java" h2="Lire Deutsche Post Identcode et Deutsche Post Leitcode en PHP en utilisant Aspose.BarCode côté serveur pour l'API PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour scanner Deutsche Post code-barres en PHP" %}}
...
<ul> <li>Créer un objet de la classe Aspose.BarCode.BarCodeReader</li> <li>Définir le chemin de l'image source contenant Deutsche Post code-barres comme paramètre</li> <li>Spécifier les types de codes à barres cibles dans DecodeType comme deuxième paramètre</li><li>Parcourir les résultats de lecture</li><li>Obtenir le texte du code-barres à l'aide de la propriété CodeText</li></ul>
