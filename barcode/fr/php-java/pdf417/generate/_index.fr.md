---
title: Générez des images PDF417 code-barres via PHP via Java
description: Code source PHP pour créer PDF417 code-barres dans les applications basées sur PHP.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/php-java/pdf417/generate/
aliases:
- /fr/php-java/generate/pdf417/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes PDF417 avec PHP via Java" h2="Créez PDF417 code-barres dans PHP à l'aide de l'API Aspose.BarCode côté serveur pour PHP via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF417" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer PDF417 code-barres en PHP" %}}
...
<ul> <li>Créer une nouvelle instance de la classe BarCodeGenerator</li> <li>Spécifier PDF417 code-barres et d'autres types de codes à barres pertinents comme paramètre EncodeTypes</li> <li>Définir le texte du code à barres comme second paramètre</li><li>Spécifiez les dimensions et l'emplacement de l'image si nécessaire</li><li>Appelez la méthode BarCodeGenerator.save pour obtenir l'image PDF417 code-barres au format requis</li></ul>
