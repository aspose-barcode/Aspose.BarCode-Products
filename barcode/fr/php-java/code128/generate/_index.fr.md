---
title: Générez des images GS1 Code 128 code-barres via PHP via Java
description: Code source PHP pour créer GS1 Code 128 code-barres dans les applications basées sur PHP.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/php-java/code128/generate/
aliases:
- /fr/php-java/generate/code128/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes GS1 Code 128 avec PHP via Java" h2="Créez GS1 Code 128 code-barres dans PHP à l'aide de l'API Aspose.BarCode côté serveur pour PHP via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer GS1 Code 128 code-barres en PHP" %}}
...
<ul> <li>Créer une nouvelle instance de la classe BarCodeGenerator</li> <li>Spécifier GS1 Code 128 code-barres et d'autres types de codes à barres pertinents comme paramètre EncodeTypes</li> <li>Définir le texte du code à barres comme second paramètre</li><li>Spécifiez les dimensions et l'emplacement de l'image si nécessaire</li><li>Appelez la méthode BarCodeGenerator.save pour obtenir l'image GS1 Code 128 code-barres au format requis</li></ul>
