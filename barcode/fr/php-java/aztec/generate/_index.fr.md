...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer Code Aztec en PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode permet aux développeurs de créer facilement des images Code Aztec avec quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

<ul> <li>Créer une nouvelle instance de la classe BarCodeGenerator</li> <li>Spécifier Code Aztec et d'autres types de codes à barres pertinents comme paramètre EncodeTypes</li> <li>Définir le texte du code à barres comme second paramètre</li><li>Spécifiez les dimensions et l'emplacement de l'image si nécessaire</li><li>Appelez la méthode BarCodeGenerator.save pour obtenir l'image Code Aztec au format requis</li></ul>
