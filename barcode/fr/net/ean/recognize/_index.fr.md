---
title: Numérisez les images Code-barres EAN (numéro d'article international) via .NET
weight: 1510
description: Exemple de code C# pour analyser et décoder le type de code-barres Code-barres EAN (numéro d'article international) dans .NET Framework, .NET Standard, COM Interloop pour PHP, VBScript, Delphi ou C++.
lang: fr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /fr/net/ean/recognize/
aliases:
- /fr/net/recognize/ean/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lire les codes-barres EAN avec .NET" h2="Lire Code-barres EAN (numéro d'article international) en C# en utilisant Aspose.BarCode côté serveur pour l'API .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code-barres EAN (numéro d'article international) Using .NET" %}}
Pour décoder Code-barres EAN (numéro d'article international), essayez l'API [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/), une bibliothèque de codes-barres riche en fonctionnalités, puissante et facile à utiliser pour les plateformes C#. Utilisez [NuGet](https://www.nuget.org/packages/aspose.barcode) et recherchez **Aspose.BarCode** pour installer le package. Vous pouvez également exécuter la commande suivante à partir de la console du gestionnaire de packages :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour scanner Code-barres EAN (numéro d'article international) en C#" %}}
...
<ul> <li>Créez une nouvelle instance de la classe Aspose.BarCode.BarCodeReader</li> <li>Passez le chemin de l'image source contenant Code-barres EAN (numéro d'article international) comme paramètre</li> <li>Passez un DecodeType approprié comme le deuxième paramètre</li><li>Parcourir les résultats de décodage</li><li>Obtenir le texte du code-barres à l'aide de la propriété CodeText</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/pdf417/recognize/" name="PDF417" description="PDF417 code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/qr/recognize/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/datamatrix/recognize/" name="Data Matrix" description="Code Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/aztec/recognize/" name="Aztec" description="Code Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR facture" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/dotcode/recognize/" name="DotCode" description="DotCode code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/hibc/recognize/" name="HIBC" description="HIBC (code à barres de l'industrie de la santé)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/codablock/recognize/" name="Codablock-F" description="Codes-barres Codablock-F et GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/databar/recognize/" name="GS1 DataBar" description="Code-barres GS1 DataBar (omnidirectionnel, empilé omnidirectionnel, déplié, déplié empilé et tronqué)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/itf/recognize/" name="ITF" description="Code-barres 2 sur 5 entrelacé (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/ean/recognize/" name="EAN" description="Code-barres EAN (numéro d'article international)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/upc/recognize/" name="UPC" description="Code-barres UPC (code de produit universel)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/code39/recognize/" name="Code 39" description="Code 39 code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/code16k/recognize/" name="Code 16K" description="Code 16K code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/code32/recognize/" name="Code 32" description="Code-barres italien Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/code93/recognize/" name="Code 93" description="Codes-barres Code 93 étendus et Code 93 standard" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/onecode/recognize/" name="USPS OneCode" description="USPS OneCode code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/standard2of5/recognize/" name="Standard 2 of 5" description="Code-barres Standard 2 of 5 (Industriel 2 sur 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/isbn/recognize/" name="ISBN" description="ISBN code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/ismn/recognize/" name="ISMN" description="ISMN code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/issn/recognize/" name="ISSN" description="ISSN code-barres" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/australia-post/recognize/" name="Australia Post" description="Code-barres Australia Post et e-colis Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode et Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/rm4scc/recognize/" name="RM4SCC" description="Code client Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/postnet/recognize/" name="Postnet" description="Postnet code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/royal-mail/recognize/" name="Royal Mail" description="Royal Mail code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/singapore-post/recognize/" name="Singapore Post" description="Singapore Post code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/net/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
