---
title: Générez des images QR Code, GS1 QR Code via .NET
description: Code source C# pour la génération de QR Code, GS1 QR Code dans .NET Framework, .NET Standard, COM Interloop pour PHP, VBScript, Delphi et C++.
lang: fr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /fr/net/qr/generate/
aliases:
- /fr/net/generate/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes QR avec .NET" h2="Créez QR Code, GS1 QR Code dans C# à l'aide de l'API Aspose.BarCode côté serveur pour .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Créer une instance de la classe BarcodeGenerator</li><li>Passer QR Code, GS1 QR Code comme paramètre</li><li>Définir le texte à encoder comme second paramètre</li><li> Spécifiez les dimensions du code-barres si nécessaire</li><li>Appelez la méthode BarcodeGenerator.Save pour obtenir l'image QR Code, GS1 QR Code</li></ul>
