---
title: Générez des images ISMN code-barres via .NET
description: Code source C# pour la génération de ISMN code-barres dans .NET Framework, .NET Standard, COM Interloop pour PHP, VBScript, Delphi et C++.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/net/ismn/generate/
aliases:
- /fr/net/generate/ismn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes ISMN avec .NET" h2="Créez ISMN code-barres dans C# à l'aide de l'API Aspose.BarCode côté serveur pour .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate ISMN code-barres Using .NET" %}}
Pour créer ISMN code-barres, essayez l'API [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/), une bibliothèque de codes-barres riche en fonctionnalités, puissante et facile à utiliser pour les plateformes C#. Ouvrez le gestionnaire de packages [NuGet](https://www.nuget.org/packages/aspose.barcode), recherchez **Aspose.BarCode** et installez le package. Vous pouvez également exécuter la commande suivante depuis la console du gestionnaire de packages :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer ISMN code-barres en C#" %}}
...
<ul><li>Créer une instance de la classe BarcodeGenerator</li><li>Passer ISMN code-barres comme paramètre</li><li>Définir le texte à encoder comme second paramètre</li><li> Spécifiez les dimensions du code-barres si nécessaire</li><li>Appelez la méthode BarcodeGenerator.Save pour obtenir l'image ISMN code-barres</li></ul>
