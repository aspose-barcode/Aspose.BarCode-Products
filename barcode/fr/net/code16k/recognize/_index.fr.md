---
title: Numérisez les images Code 16K code-barres via .NET
weight: 1510
description: Exemple de code C# pour analyser et décoder le type de code-barres Code 16K code-barres dans .NET Framework, .NET Standard, COM Interloop pour PHP, VBScript, Delphi ou C++.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/net/code16k/recognize/
aliases:
- /fr/net/recognize/code16k/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lire les codes-barres Code 16K avec .NET" h2="Lire Code 16K code-barres en C# en utilisant Aspose.BarCode côté serveur pour l'API .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 16K code-barres Using .NET" %}}
Pour décoder Code 16K code-barres, essayez l'API [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/), une bibliothèque de codes-barres riche en fonctionnalités, puissante et facile à utiliser pour les plateformes C#. Utilisez [NuGet](https://www.nuget.org/packages/aspose.barcode) et recherchez **Aspose.BarCode** pour installer le package. Vous pouvez également exécuter la commande suivante à partir de la console du gestionnaire de packages :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour scanner Code 16K code-barres en C#" %}}
...
<ul> <li>Créez une nouvelle instance de la classe Aspose.BarCode.BarCodeReader</li> <li>Passez le chemin de l'image source contenant Code 16K code-barres comme paramètre</li> <li>Passez un DecodeType approprié comme le deuxième paramètre</li><li>Parcourir les résultats de décodage</li><li>Obtenir le texte du code-barres à l'aide de la propriété CodeText</li></ul>
