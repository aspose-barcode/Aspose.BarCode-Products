---
title: Numérisez les images Codes-barres Codablock-F et GS1 Codablock-F via .NET
weight: 1510
description: Exemple de code C# pour analyser et décoder le type de code-barres Codes-barres Codablock-F et GS1 Codablock-F dans .NET Framework, .NET Standard, COM Interloop pour PHP, VBScript, Delphi ou C++.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/net/codablock/recognize/
aliases:
- /fr/net/recognize/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lire les codes-barres Codablock-F avec .NET" h2="Lire Codes-barres Codablock-F et GS1 Codablock-F en C# en utilisant Aspose.BarCode côté serveur pour l'API .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Codablock-F code-barres Using .NET" %}}
Pour décoder Codablock-F code-barres, essayez l'API [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/), une bibliothèque de codes-barres riche en fonctionnalités, puissante et facile à utiliser pour les plateformes C#. Utilisez [NuGet](https://www.nuget.org/packages/aspose.barcode) et recherchez **Aspose.BarCode** pour installer le package. Vous pouvez également exécuter la commande suivante à partir de la console du gestionnaire de packages :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour scanner Codablock-F code-barres en C#" %}}
...
<ul> <li>Créez une nouvelle instance de la classe Aspose.BarCode.BarCodeReader</li> <li>Passez le chemin de l'image source contenant Codablock-F code-barres comme paramètre</li> <li>Passez un DecodeType approprié comme le deuxième paramètre</li><li>Parcourir les résultats de décodage</li><li>Obtenir le texte du code-barres à l'aide de la propriété CodeText</li></ul>
