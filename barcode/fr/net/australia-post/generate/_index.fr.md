...
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes Australia Post avec .NET" h2="Créez Code-barres Australia Post et e-colis Australia Post dans C# à l'aide de l'API Aspose.BarCode côté serveur pour .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Australia Post code-barres Using .NET" %}}
Pour créer Australia Post code-barres, essayez l'API [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/), une bibliothèque de codes-barres riche en fonctionnalités, puissante et facile à utiliser pour les plateformes C#. Ouvrez le gestionnaire de packages [NuGet](https://www.nuget.org/packages/aspose.barcode), recherchez **Aspose.BarCode** et installez le package. Vous pouvez également exécuter la commande suivante depuis la console du gestionnaire de packages :
...
<ul><li>Créer une instance de la classe BarcodeGenerator</li><li>Passer Code-barres Australia Post et e-colis Australia Post comme paramètre</li><li>Définir le texte à encoder comme second paramètre</li><li> Spécifiez les dimensions du code-barres si nécessaire</li><li>Appelez la méthode BarcodeGenerator.Save pour obtenir l'image Code-barres Australia Post et e-colis Australia Post</li></ul>
