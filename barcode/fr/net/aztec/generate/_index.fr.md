...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer Code Aztec en C#" %}}
...
<ul><li>Créer une instance de la classe BarcodeGenerator</li><li>Passer Code Aztec comme paramètre</li><li>Définir le texte à encoder comme second paramètre</li><li> Spécifiez les dimensions du code-barres si nécessaire</li><li>Appelez la méthode BarcodeGenerator.Save pour obtenir l'image Code Aztec</li></ul>
