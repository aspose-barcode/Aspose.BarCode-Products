...
<ul><li>Créer un objet de la classe BarcodeGenerator</li><li>Passer Code Aztec comme paramètre</li><li>Insérer le texte d'entrée à encoder comme second paramètre</li><li>Définissez les dimensions de l'image si nécessaire</li><li>Appelez la méthode BarcodeGenerator.Save pour télécharger le code-barres Code Aztec</li></ul>
