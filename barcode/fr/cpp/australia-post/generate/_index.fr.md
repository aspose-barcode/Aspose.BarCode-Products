---
title: Générez des images Code-barres Australia Post et e-colis Australia Post via C++
description: Exemple de code C++ pour générer Code-barres Australia Post et e-colis Australia Post dans l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/cpp/australia-post/generate/
aliases:
- /fr/cpp/generate/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes Australia Post avec C++" h2="Créez Code-barres Australia Post et e-colis Australia Post dans C++ à l'aide de l'API Aspose.BarCode côté serveur pour C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer Australia Post code-barres en C++" %}}
...
<ul><li>Créer un objet de la classe BarcodeGenerator</li><li>Passer Code-barres Australia Post et e-colis Australia Post comme paramètre</li><li>Insérer le texte d'entrée à encoder comme second paramètre</li><li>Définissez les dimensions de l'image si nécessaire</li><li>Appelez la méthode BarcodeGenerator.Save pour télécharger le code-barres Code-barres Australia Post et e-colis Australia Post</li></ul>
