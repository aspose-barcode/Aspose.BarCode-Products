---
title: Numérisez les images Singapore Post code-barres via C++
weight: 1510
description: Exemple de code C++ pour analyser et décoder Singapore Post code-barres dans l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits ou Linux 64 bits.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/cpp/singapore-post/recognize/
aliases:
- /fr/cpp/recognize/singapore-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lire les codes-barres Singapore Post avec C++" h2="Lire Singapore Post code-barres en C++ en utilisant Aspose.BarCode côté serveur pour l'API C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
