...
weight: 220
url: /fr/sharepoint/ 
description: API SharePoint de code-barres pour insérer des étiquettes de code-barres dans des listes SharePoint personnalisées. Les développeurs peuvent utiliser des marqueurs de service pour sélectionner des valeurs de texte de code ou insérer le texte manuellement
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ajouter des codes-barres aux listes Microsoft SharePoint" h2="Barcode SharePoint App pour ajouter des symboles de codes-barres linéaires, 2D et postaux aux listes Microsoft SharePoint." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/barcode/sharepoint" >}}
...
{{< blocks/products/pf/carousel-item h3="En bref" description="Un aperçu des fonctionnalités de génération de codes-barres." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    ...
    <li>
     Ajouter un code-barres à la liste
    </li>
   </ul>
  </div>
  <!--/left-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Générateur de codes-barres SharePoint" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-sharepoint.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Plate-forme prise en charge" description="Aspose.BarCode pour SharePoint prend en charge Microsoft SharePoint Foundation et SharePoint Server." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Application de code-barres SharePoint" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-sharepoint.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Les types de codes-barres pris en charge" description="Aspose.BarCode pour SharePoint prend en charge les éléments suivants [formats de fichiers](https://docs.aspose.com/barcode/sharepoint/supported-file-formats/)  :" >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
  ...
  <div class="d1-col d1-right">
   ...
   <!--<header><i class="fa fa-qrcode"> </i>Barcode Les types</header>

<ul>

<li>Les types de codes-barres linéaires</li>

<li>Les types de codes-barres 2D</li>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <div class="col-lg-12">
    <h2 class="h2title">
     Ajouter une colonne de type de code-barres aux listes SharePoint
    </h2>
    <p>
     Aspose.BarCode for SharePoint facilite l'ajout d'une colonne de type code-barres aux listes SharePoint. Ce composant vous permet également de définir le texte du code à barres à l'aide de l'interface graphique ou en incorporant des marqueurs de service.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     L'application de code-barres SharePoint prend en charge les symbologies les plus populaires, notamment :
    </p>
    <div class="col-lg-3">
     <ul class="unstyled">
      <li>
 ...
 <!-- Support & Ressources d'apprentissage -->
   ...
   <div class="container">
    ...
    <div class="col-lg-12 mgtb55">
     <ul class="list-unstyled" id="resources">
      ...
      <!-- <li><a href="https://apireference.aspose.com/">Références API</a></li> -->
      <li>
     ...
     <ul class="list-unstyled" id="success-stories">
      <li class="resourcesheading">
       Pourquoi Aspose.BarCode pour SharePoint ?
      </li>
