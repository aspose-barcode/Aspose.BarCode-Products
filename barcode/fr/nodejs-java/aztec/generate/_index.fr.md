...
{{% blocks/products/pf/agp/content h2="How to Generate Code Aztec Using Node.js via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer Code Aztec en JavaScript" %}}
