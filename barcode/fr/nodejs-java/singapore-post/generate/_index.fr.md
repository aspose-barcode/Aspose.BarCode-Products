---
title: Générez des images Singapore Post code-barres via Node.js via Java
description: Exemple de code Node.js pour la génération de Singapore Post code-barres dans les applications JavaScript.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/nodejs-java/singapore-post/generate/
aliases:
- /fr/nodejs-java/generate/singapore-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes Singapore Post avec Node.js via Java" h2="Créez Singapore Post code-barres dans JavaScript à l'aide de l'API Aspose.BarCode côté serveur pour Node.js via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Singapore Post code-barres Using Node.js via Java" %}}
Pour créer des codes-barres Singapore Post code-barres dans les applications Node.js, procurez-vous Aspose.BarCode pour Node.js via Java, une API de code-barres avancée, puissante et conviviale conçue pour les plates-formes orientées Java. Vous pouvez facilement installer [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) pour Javascript à partir de NPM :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer Singapore Post code-barres en JavaScript" %}}
