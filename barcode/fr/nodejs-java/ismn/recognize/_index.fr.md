---
title: Numérisez les images ISMN code-barres via Node.js via Java
weight: 1510
description: Code source Node.js pour l'analyse et le décodage de ISMN code-barres dans les applications JavaScript.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/nodejs-java/ismn/recognize/
aliases:
- /fr/nodejs-java/recognize/ismn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lire les codes-barres ISMN avec Node.js via Java" h2="Lire ISMN code-barres en JavaScript en utilisant Aspose.BarCode côté serveur pour l'API Node.js via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read ISMN code-barres Using Node.js via Java" %}}
Pour reconnaître ISMN code-barres dans les applications Node.js, utilisez Aspose.BarCode pour Node.js via Java, une bibliothèque de codes-barres robuste, polyvalente et conviviale introduite pour les environnements basés sur Java. Vous pouvez charger [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) pour Javascript directement depuis NPM :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour scanner ISMN code-barres en JavaScript" %}}
...
<ul><li>Créer un objet de la classe Aspose.BarCode.BarCodeReader</li><li>Passer le chemin du fichier source contenant ISMN code-barres comme paramètre</li><li>Définir les types de codes-barres cibles dans DecodeType comme deuxième paramètre</li><li>Parcourir tous les codes-barres détectés</li><li>Récupérer le texte du code-barres résultant à l'aide de la propriété CodeText</li></ul>
