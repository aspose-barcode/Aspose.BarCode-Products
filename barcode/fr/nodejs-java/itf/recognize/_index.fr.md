---
title: Numérisez les images Code-barres 2 sur 5 entrelacé (ITF) via Node.js via Java
weight: 1510
description: Code source Node.js pour l'analyse et le décodage de Code-barres 2 sur 5 entrelacé (ITF) dans les applications JavaScript.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/nodejs-java/itf/recognize/
aliases:
- /fr/nodejs-java/recognize/itf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lire les codes-barres ITF avec Node.js via Java" h2="Lire Code-barres 2 sur 5 entrelacé (ITF) en JavaScript en utilisant Aspose.BarCode côté serveur pour l'API Node.js via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code-barres 2 sur 5 entrelacé (ITF) Using Node.js via Java" %}}
Pour reconnaître Code-barres 2 sur 5 entrelacé (ITF) dans les applications Node.js, utilisez Aspose.BarCode pour Node.js via Java, une bibliothèque de codes-barres robuste, polyvalente et conviviale introduite pour les environnements basés sur Java. Vous pouvez charger [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) pour Javascript directement depuis NPM :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour scanner Code-barres 2 sur 5 entrelacé (ITF) en JavaScript" %}}
...
<ul><li>Créer un objet de la classe Aspose.BarCode.BarCodeReader</li><li>Passer le chemin du fichier source contenant Code-barres 2 sur 5 entrelacé (ITF) comme paramètre</li><li>Définir les types de codes-barres cibles dans DecodeType comme deuxième paramètre</li><li>Parcourir tous les codes-barres détectés</li><li>Récupérer le texte du code-barres résultant à l'aide de la propriété CodeText</li></ul>
