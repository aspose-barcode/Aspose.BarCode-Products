---
title: Générez des images Code-barres 2 sur 5 entrelacé (ITF) via Node.js via Java
description: Exemple de code Node.js pour la génération de Code-barres 2 sur 5 entrelacé (ITF) dans les applications JavaScript.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/nodejs-java/itf/generate/
aliases:
- /fr/nodejs-java/generate/itf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes ITF avec Node.js via Java" h2="Créez Code-barres 2 sur 5 entrelacé (ITF) dans JavaScript à l'aide de l'API Aspose.BarCode côté serveur pour Node.js via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Code-barres 2 sur 5 entrelacé (ITF) Using Node.js via Java" %}}
Pour créer des codes-barres Code-barres 2 sur 5 entrelacé (ITF) dans les applications Node.js, procurez-vous Aspose.BarCode pour Node.js via Java, une API de code-barres avancée, puissante et conviviale conçue pour les plates-formes orientées Java. Vous pouvez facilement installer [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) pour Javascript à partir de NPM :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer Code-barres 2 sur 5 entrelacé (ITF) en JavaScript" %}}
