---
title: Générez des images Code-barres EAN (numéro d'article international) via Node.js via Java
description: Exemple de code Node.js pour la génération de Code-barres EAN (numéro d'article international) dans les applications JavaScript.
lang: fr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /fr/nodejs-java/ean/generate/
aliases:
- /fr/nodejs-java/generate/ean/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Générez des étiquettes EAN avec Node.js via Java" h2="Créez Code-barres EAN (numéro d'article international) dans JavaScript à l'aide de l'API Aspose.BarCode côté serveur pour Node.js via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Code-barres EAN (numéro d'article international) Using Node.js via Java" %}}
Pour créer des codes-barres Code-barres EAN (numéro d'article international) dans les applications Node.js, procurez-vous Aspose.BarCode pour Node.js via Java, une API de code-barres avancée, puissante et conviviale conçue pour les plates-formes orientées Java. Vous pouvez facilement installer [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) pour Javascript à partir de NPM :
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer Code-barres EAN (numéro d'article international) en JavaScript" %}}
...
<ul><li>Créer une instance de la classe BarCodeGenerator</li><li>Définir Code-barres EAN (numéro d'article international) comme paramètre EncodeTypes</li><li>Définir le texte à encoder comme deuxième paramètre</li><li>Déterminer les dimensions et l'emplacement du code-barres si nécessaire</li><li>Appelez la méthode BarCodeGenerator.save pour obtenir l'image du code-barres générée</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/pdf417/generate/" name="PDF417" description="PDF417 code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/qr/generate/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/datamatrix/generate/" name="Data Matrix" description="Code Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/aztec/generate/" name="Aztec" description="Code Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/swiss-qr/generate/" name="Swiss QR" description="Swiss QR facture" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/dotcode/generate/" name="DotCode" description="DotCode code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/hibc/generate/" name="HIBC" description="HIBC (code à barres de l'industrie de la santé)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/codablock/generate/" name="Codablock-F" description="Codes-barres Codablock-F et GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/databar/generate/" name="GS1 DataBar" description="Code-barres GS1 DataBar (omnidirectionnel, empilé omnidirectionnel, déplié, déplié empilé et tronqué)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/itf/generate/" name="ITF" description="Code-barres 2 sur 5 entrelacé (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/ean/generate/" name="EAN" description="Code-barres EAN (numéro d'article international)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/upc/generate/" name="UPC" description="Code-barres UPC (code de produit universel)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/code128/generate/" name="GS1 Code 128" description="GS1 Code 128 code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/code39/generate/" name="Code 39" description="Code 39 code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/code16k/generate/" name="Code 16K" description="Code 16K code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/code32/generate/" name="Code 32" description="Code-barres italien Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/code93/generate/" name="Code 93" description="Codes-barres Code 93 étendus et Code 93 standard" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/onecode/generate/" name="USPS OneCode" description="USPS OneCode code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/standard2of5/generate/" name="Standard 2 of 5" description="Code-barres Standard 2 of 5 (Industriel 2 sur 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/isbn/generate/" name="ISBN" description="ISBN code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/ismn/generate/" name="ISMN" description="ISMN code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/issn/generate/" name="ISSN" description="ISSN code-barres" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/australia-post/generate/" name="Australia Post" description="Code-barres Australia Post et e-colis Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Identcode et Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/rm4scc/generate/" name="RM4SCC" description="Code client Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/postnet/generate/" name="Postnet" description="Postnet code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/royal-mail/generate/" name="Royal Mail" description="Royal Mail code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/singapore-post/generate/" name="Singapore Post" description="Singapore Post code-barres" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/fr/nodejs-java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
