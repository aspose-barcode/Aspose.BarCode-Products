---
title: Generáljon vonalkódokat a JasperReportsban, és renderelje le BMP JPG GIF és PNG formátumban
description: Az Aspose.BarCode for JasperReports használatával a fejlesztők vonalkódokat generálhatnak a Jasper Reports-ban, amelyeket tovább lehet renderelni BMP JPG GIF és PNG formátumban.
lang: hu/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Vonalkódok generálása és exportálása a JasperReportsban" h2="JasperReports & JasperServer API 1D, 2D és postai vonalkódok generálásához, megjelenítéséhez és exportálásához." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="a következőhöz&colon; JasperReports" downloadUrl="https://releases.aspose.com/barcode/jasperreports/" >}}
...
<p>Az Aspose.BarCode for JasperReports egy rugalmas JasperReports és JasperServer bővítmény, amellyel vonalkódcímkéket hozhat létre és jeleníthet meg alkalmazásaiban. Ezek a vonalkódcímkék számos népszerű képformátumban renderelhetők.</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="Ránézésre" description="Az API vonalkód-felismerési és generálási képességeinek áttekintése." >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>Lineáris, 2D és postai</li><li>Érzékelés adatfolyamból vagy képből</li><li>Vonalkód tájolása</li><li>Nem angol karakterek dekódolása</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                Nyomtatás
            </header>
            <ul><li>Vonalkód közvetlen nyomtatása</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>Lineáris, 2D és postai</li><li>Mentés adatfolyamba vagy képbe</li><li>Megjelenés testreszabása&colon; méret, szín, szög</li><li>nem angol karakterek kódolása </li></ul>
            <header>
                <i class="fa fa-qrcode">
                </i>
                Típusok
            </header>
            <ul><li>Lineáris</li><li>2D</li><li>Posta</li></ul>
        </div>
        <!--/right-->
    </div>
    <!--/row-->
    <div class="d1-logo">
        <img width="70" height="75" alt='Barcode JasperReports Library' src='https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg'/>
        <header>
            Aspose.BarCode
        </header>
        <footer>
...
{{< blocks/products/pf/carousel-item h3="Platformfüggetlenség" description="Az Aspose.BarCode for JasperReports használható a JasperServerrel és a JasperReports-szal." >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
    ...
    <!--/row-->
    <div class="d1-logo">
        <img width="70" height="75" alt='Barcode Generator in JasperReports' src='https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg'/>
        <header>
            Aspose.BarCode
        </header>
        <footer>
...
{{< blocks/products/pf/carousel-item h3="Támogatott fájlformátumok" description="Az Aspose.BarCode for JasperReports a leggyakrabban használt képfájlformátumokkal működik." >}}
<div class='diagram1 d2 d1-jasper'>
    ...
    <!--/row-->
    <div class="d1-logo">
        <img width="70" height="75" alt='JasperReports Barcode Reader API' src='https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg'/>
        <header>
            Aspose.BarCode
        </header>
        <footer>
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Speciális JasperReports a vonalkódexportálási szolgáltatásokhoz
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Jelentések létrehozása és nyomtatása vonalkóddal</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Növelje az alkalmazás munkafolyamatát vonalkód-funkciók hozzáadásával</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Vonalkódok beágyazása fájlokba a nyomon követhetőség érdekében</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/barcode-image-basic-features/'>A vezérlőkód mérete, színe és kódszövege</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/read-barcodes-with-aspose-barcode-apis/'>3D torzított és elforgatott 2D vonalkódok felismerése</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/generate-barcode-by-specifying-custom-image-size/'>Adott méretű vonalkódképek létrehozása</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    Az Aspose.BarCode for JasperReports egy speciális eszközkészletet biztosít a JasperReports vonalkódjainak kezeléséhez. Ezzel az API-val a fejlesztők beolvashatják a meglévő jelentésekben elhelyezett vonalkódokat, vagy hozzáadhatják azokat új jelentésekhez. Ez a vonalkód-könyvtár tisztán Java-ban van kódolva, és egyetlen JAR-dokumentumként áll rendelkezésre, és könnyen telepíthető olyan gépeken, amelyekre telepítve van a JasperReports vagy a JasperServer. A JasperReports vonalkód-kiterjesztés telepítéséhez egyszerűen másolja a JAR-dokumentumot a megfelelő mappába, és kezdje el a munkát.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    A vonalkód-generátor könyvtár lehetővé teszi a fejlesztők számára, hogy egyszerűen hozzanak létre vonalkódokat a vonalkód típusának megadásával, a kódolandó adatok megadásával és egyéni megjelenéssel kapcsolatos tulajdonságok beállításával. Ez magában foglalja a különféle beállításokat, például a háttér és az előtér színét, a betűtípust, a méretet, a felbontást és a szöveges feliratokat. Az API 1D és 2D vonalkódokat is képes generálni, beleértve a PDF417-et, a Data Matrix-et, a Aztec kódot, a QR-kódot és a Micro QR-kódot, ugyanazzal az alapelvvel. Ez kényelmes és felhasználóbarát eszközzé teszi a vonalkód-típusok széles skálájának generálására különféle alkalmazásokhoz, beleértve a JasperReports-t is.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Illessze be a vonalkódokat a JasperReportsba
                </h2>
                <p>
                    A JasperReports lehetővé teszi a fejlesztők számára, hogy jelentéseket készítsenek a különféle forrásokban, például adatbázisokban, CSV-fájlokban és XML-dokumentumokban tárolt adatok felhasználásával. A jelentések tervezésére, formázására és exportálására szolgáló funkciók széles skáláját kínálja, amelyek könnyen integrálhatók a Java alkalmazásokba. A JasperReports néhány gyakori felhasználási területe a számlák, nyugták, pénzügyi kimutatások és más típusú üzleti jelentések generálása. Hasznos lehet vonalkódokat beszúrni a JasperReportsba, hogy megkönnyítse a jelentésekben található információk elérését és kezelését. Például a vonalkódok felhasználhatók a JasperReport információinak gyors és pontos beolvasására és frissítésére, nevezetesen a számlán lévő vonalkód beolvasásával a kapcsolódó adatok lekéréséhez és megjelenítéséhez. Ez megkönnyítheti az információk nyomon követését és kezelését, valamint csökkentheti a hibák és eltérések kockázatát. A vonalkód adott tételek vagy rekordok megjelenítésére is szolgálhat a jelentésben.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
<div class="barcode-read-lcs" style="width: 100%;">
    ...
    <div class="barcode-read-lcs-controls">
        <div class="barcode-read-lcs-drop" onclick="BarcodeReadLcsUpload(this);" ondragover="event.preventDefault();" ondrop="BarcodeReadLcsDropped(event,this);">
            ...
            <span class="barcode-read-lcs-recognizing">Felismerés<span></span></span>
            <span class="barcode-read-lcs-hint">Dobjon ide egy fájlt, vagy kattintson a böngészéshez *</span>
        </div>
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">Minden típus</option>
                <option value="Pdf417 ">PDF417</option>
                <option value="QR ">QR</option>
    ...
    <p class="barcode-read-lcs-disclaimer">* A fájlok feltöltésével vagy a szolgáltatás használatával Ön elfogadja <a href='https://about.aspose.com/legal/terms-of-use' rel='nofollow noreferrer' target='_blank'>Feltételeinket használja</a> és az <a href='https://about.aspose.com/legal/privacy-policy' rel='nofollow noreferrer' target='_blank'>Adatvédelmi irányelveket</a>.</p>
...
{{< blocks/products/pf/agp/other-symbologies-section title="Supported Barcode Types" subTitle="Using JasperReports, developers can read and generate barcodes of differen types, including the following." >}}

<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">2D:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/pdf417/" name="PDF417" description="PDF417 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/qr/" name="QR" description="QR kód, GS1 QR kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/datamatrix/" name="Data Matrix" description="Data Matrix kódot" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/aztec/" name="Aztec" description="Aztec Kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/swiss-qr/" name="Swiss QR" description="Swiss QR számla" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/dotcode/" name="DotCode" description="DotCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/hibc/" name="HIBC" description="HIBC (Egészségügyi vonalkód)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/codablock/" name="Codablock-F" description="Codablock-F és GS1 Codablock-F vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/itf/" name="ITF" description="Interleaved 2-of-5 (ITF) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/ean/" name="EAN" description="EAN (nemzetközi cikkszám) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/upc/" name="UPC" description="UPC (Univerzális termékkód) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/code128/" name="GS1 Code 128" description="GS1 Code 128 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/code39/" name="Code 39" description="Code 39 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/code16k/" name="Code 16K" description="Code 16K vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/code32/" name="Code 32" description="Olasz Pharmacode (Code 32) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/code93/" name="Code 93" description="Code 93 kiterjesztett és Code 93 szabványos vonalkódok" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/onecode/" name="USPS OneCode" description="USPS OneCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Ipari 2/5) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/isbn/" name="ISBN" description="ISBN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/ismn/" name="ISMN" description="ISMN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/issn/" name="ISSN" description="ISSN vonalkód" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/australia-post/" name="Australia Post" description="Australia Post vonalkód és Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode és Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/rm4scc/" name="RM4SCC" description="Royal Mail 4 állam ügyfélkódja (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/postnet/" name="Postnet" description="Postnet vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/royal-mail/" name="Royal Mail" description="Royal Mail vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/singapore-post/" name="Singapore Post" description="Singapore Post vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/jasperreports/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="Mit mondanak az emberek" subTitle="Ne csak szót fogadjon. Tekintse meg, mit mondanak a felhasználók az API-król." caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 Sok évet töltöttem a termékem fejlesztésével és továbbfejlesztésével, és az Aspose lehetővé tette számomra, hogy termékemet sokkal barátságosabbá és hasznosabbá tegyem, ezáltal pedig piacképesebbé tegyem. <em>Kiel Diller | KD Solutions, Lengyelország</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Az Aspose.BarCode valóban felügyelt kódban íródott, és számos vonalkód-típust biztosít számunkra mindenféle dokumentumfelismerés és további feldolgozás kezelésére. <em>Dennis Alexander Petrasc | Keil IT, Németország</em>ban
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Dokumentáció" href="https://docs.aspose.com/barcode/jasperreports/" >}}
{{< blocks/products/pf/slr-element name="Forráskód" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="API referenciák" href="https://reference.aspose.com/barcode/java/" >}}
{{< blocks/products/pf/slr-element name="Oktatóvideók" href="https://www.youtube.com/user/asposevideo" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Terméktámogatás" tabId="support" >}}
{{< blocks/products/pf/slr-element name="Ingyenes támogatás" href="https://forum.aspose.com/c/barcode/" >}}
{{< blocks/products/pf/slr-element name="Fizetett támogatás" href="https://helpdesk.aspose.com/" >}}
{{< blocks/products/pf/slr-element name="Blog" href="https://blog.aspose.com/category/barcode/" >}}
{{< blocks/products/pf/slr-element name="Kiadási megjegyzések" href="https://docs.aspose.com/barcode/jasperreports/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Miért az Aspose.BarCode a JasperReports számára?" tabId="success-stories" >}}
{{< blocks/products/pf/slr-element name="Ügyfelek listája" href="https://about.aspose.com/customers" >}}
{{< blocks/products/pf/slr-element name="Sikertörténetek" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< /blocks/products/pf/support-learning-resources >}}

{{< blocks/products/pf/download-section downloadFreeTrialLink="https://releases.aspose.com/barcode/jasperreports/" pricingInformationLink="https://purchase.aspose.com/pricing/barcode/jasperreports" >}}

{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Az Aspose.BarCode egyedi vonalkód-generáló és -felismerő API-kat kínál más népszerű fejlesztői környezetekhez, az alábbiak szerint:" >}}

    {{< blocks/products/pf/offers-section-item link="/barcode/hu/net/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sdkName=".NET" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/hu/java/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sdkName="Java" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/hu/cpp/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sdkName="C++" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/hu/android-java/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-android-java.svg" sdkName="Android via Java" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/hu/sharepoint/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-sharepoint.svg" sdkName="SharePoint" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/hu/reporting-services/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-reporting-services.svg" sdkName="Reporting Services" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/hu/php-java/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-php-java.svg" sdkName="PHP via Java" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/hu/nodejs-java/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-nodejs-java.svg" sdkName="Node.js via Java" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/hu/python-java/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-python-java.svg" sdkName="Python via Java" >}}
