...
{{% blocks/products/pf/agp/feature-section-col title="A(z) Interleaved 2-of-5 (ITF) vonalkód létrehozásának lépései a PHP alkalmazásban" %}}
...
<ul><li>A BarCodeGenerator osztály új példányának létrehozása</li><li>Adja meg a(z) Interleaved 2-of-5 (ITF) vonalkód és más releváns vonalkódtípusokat az EncodeTypes paraméterként.</li><li>Vonalkódszöveg beállítása második paraméterként</li><li>Adja meg a kép méretét és helyét, ha szükséges.</li><li>Hívja a BarCodeGenerator.save metódust a(z) Interleaved 2-of-5 (ITF) vonalkód kép megfelelő formátumban történő beszerzéséhez.</li></ul>
