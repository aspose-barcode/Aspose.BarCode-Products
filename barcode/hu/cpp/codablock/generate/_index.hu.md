---
title: Codablock-F és GS1 Codablock-F vonalkód képek létrehozása a C++ segítségével
description: Példa C++ kódra a(z) Codablock-F és GS1 Codablock-F vonalkód létrehozásához C++ futási környezetben 32 bites Windows, 64 bites Windows és 64 bites Linux rendszeren.
lang: hu/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hu/cpp/codablock/generate/
aliases:
- /hu/cpp/generate/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hozzon létre Codablock-F címkéket a következővel&colon; C++" h2="Hozzon létre Codablock-F és GS1 Codablock-F vonalkód-et a C++-ban a szerveroldali Aspose.BarCode for C++ API használatával." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Hozzon létre egy BarcodeGenerator osztályú objektumot</li><li>Adja meg a(z) Codablock-F és GS1 Codablock-F vonalkód paramétert paraméterként</li><li>Szúrjon be beviteli szöveget a kódoláshoz második paraméterként</li><li>Ha szükséges, adja meg a kép méretét</li><li>Hívja a BarcodeGenerator programot. Mentse a módszert a Codablock-F és GS1 Codablock-F vonalkód vonalkód letöltéséhez</li></ul>
