---
title: Australia Post vonalkód és Australia Post eParcel képek létrehozása a C++ segítségével
description: Példa C++ kódra a(z) Australia Post vonalkód és Australia Post eParcel létrehozásához C++ futási környezetben 32 bites Windows, 64 bites Windows és 64 bites Linux rendszeren.
lang: hu/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hu/cpp/australia-post/generate/
aliases:
- /hu/cpp/generate/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hozzon létre Australia Post címkéket a következővel&colon; C++" h2="Hozzon létre Australia Post vonalkód és Australia Post eParcel-et a C++-ban a szerveroldali Aspose.BarCode for C++ API használatával." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Hozzon létre egy BarcodeGenerator osztályú objektumot</li><li>Adja meg a(z) Australia Post vonalkód és Australia Post eParcel paramétert paraméterként</li><li>Szúrjon be beviteli szöveget a kódoláshoz második paraméterként</li><li>Ha szükséges, adja meg a kép méretét</li><li>Hívja a BarcodeGenerator programot. Mentse a módszert a Australia Post vonalkód és Australia Post eParcel vonalkód letöltéséhez</li></ul>
