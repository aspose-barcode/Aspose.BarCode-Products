...
{{% blocks/products/pf/agp/feature-section-col title="A(z) QR Kód létrehozásának lépései a C++ alkalmazásban" %}}

{{% blocks/products/pf/agp/text %}}

Az Aspose.BarCode megkönnyíti a fejlesztők számára a QR Kód képek létrehozását néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Hozzon létre egy BarcodeGenerator osztályú objektumot</li><li>Adja meg a(z) QR kód, GS1 QR kód paramétert paraméterként</li><li>Szúrjon be beviteli szöveget a kódoláshoz második paraméterként</li><li>Ha szükséges, adja meg a kép méretét</li><li>Hívja a BarcodeGenerator programot. Mentse a módszert a QR kód, GS1 QR kód vonalkód letöltéséhez</li></ul>
