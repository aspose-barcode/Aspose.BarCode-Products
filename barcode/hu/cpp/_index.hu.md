---
title: C++ vonalkód-feldolgozó API
description: C++ vonalkód olvasó és generátor könyvtár 1D és 2D vonalkódokhoz. Különféle 1D, 2D és postai vonalkódok létrehozása és olvasása
lang: hu/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="C++ Vonalkód könyvtár" h2="Létrehozhat és felismerhet lineáris, 2D és postai típusú vonalkódokat bármely C++ alkalmazásban." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" pfName="Aspose.BarCode" subTitlepfName="a következőhöz&colon; C++" downloadUrl="https://releases.aspose.com/barcode/cpp/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.BarCode" subTitlepfName="a következőhöz&colon; C++" >}}
...
{{< blocks/products/pf/carousel-item h3="Támogatott fájlformátumok" description="Az Aspose.BarCode for C++ a leggyakrabban használt képfájlformátumokkal működik." >}}
<div class='diagram1 d2 d1-cplus'>
    ...
    <!--/row-->
    <div class="d1-logo">
        <img width="70" height="75" alt='C++ Barcode Reader API' src='https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg'/>
        <header>
            Aspose.BarCode
        </header>
        <footer>
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/generate-barcodes-with-aspose-barcode-apis/'>Mentse el a generált vonalkódképeket adatfolyamba vagy fájlba</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/read-barcodes-with-aspose-barcode-apis/'>Kódok felismerése adatfolyamból vagy képből</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/qr-and-micro-qr-barcode/#qr-code-encoding-in-the-eci-mode'>Nem angol karakterek kódolása és dekódolása 2D típusokban</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/image-formatting-and-display-settings/'>Méret és tájolás szabályozása</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/image-formatting-and-display-settings/#rotate-barcode-image'>Forgassa el a képeket bármilyen szögben</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/image-formatting-and-display-settings/'>A vezérlőkód mérete, színe és kódszövege</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/cpp/product-overview/#supported-barcode-symbologies'>1D, 2D és postai szimbólumok támogatása</a>
                </p>
            </div>
...
{
    <span class="hljs-keyword">auto</span> tmp_0 = System::<span class="hljs-built_in">MakeObject</span>&lt;BarcodeGenerator&gt;(EncodeTypes::<span class="barcode-gen-lcs-type-param">QR</span>, <span class="hljs-string">u&quot;<span class="hljs-string barcode-gen-lcs-codetext-param"></span>&quot;</span>);
...
{{< blocks/products/pf/agp/other-symbologies-section title="Supported Barcode Types" subTitle="Using C++, developers can read and generate barcodes of differen types, including the following." >}}

<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">2D:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/pdf417/" name="PDF417" description="PDF417 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/qr/" name="QR" description="QR kód, GS1 QR kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/datamatrix/" name="Data Matrix" description="Data Matrix kódot" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/aztec/" name="Aztec" description="Aztec Kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/swiss-qr/" name="Swiss QR" description="Swiss QR számla" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/dotcode/" name="DotCode" description="DotCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/hibc/" name="HIBC" description="HIBC (Egészségügyi vonalkód)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/codablock/" name="Codablock-F" description="Codablock-F és GS1 Codablock-F vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/itf/" name="ITF" description="Interleaved 2-of-5 (ITF) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/ean/" name="EAN" description="EAN (nemzetközi cikkszám) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/upc/" name="UPC" description="UPC (Univerzális termékkód) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/code128/" name="GS1 Code 128" description="GS1 Code 128 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/code39/" name="Code 39" description="Code 39 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/code16k/" name="Code 16K" description="Code 16K vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/code32/" name="Code 32" description="Olasz Pharmacode (Code 32) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/code93/" name="Code 93" description="Code 93 kiterjesztett és Code 93 szabványos vonalkódok" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/onecode/" name="USPS OneCode" description="USPS OneCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Ipari 2/5) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/isbn/" name="ISBN" description="ISBN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/ismn/" name="ISMN" description="ISMN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/issn/" name="ISSN" description="ISSN vonalkód" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/australia-post/" name="Australia Post" description="Australia Post vonalkód és Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode és Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/rm4scc/" name="RM4SCC" description="Royal Mail 4 állam ügyfélkódja (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/postnet/" name="Postnet" description="Postnet vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/royal-mail/" name="Royal Mail" description="Royal Mail vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/singapore-post/" name="Singapore Post" description="Singapore Post vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/cpp/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentáció" href="https://docs.aspose.com/barcode/cpp/" >}}
{{< blocks/products/pf/slr-element name="Forráskód" href="https://github.com/aspose-barcode/Aspose.Barcode-for-C" >}}
{{< blocks/products/pf/slr-element name="API referenciák" href="https://reference.aspose.com/barcode/cpp/" >}}
...
{{< blocks/products/pf/slr-element name="Kiadási megjegyzések" href="https://docs.aspose.com/barcode/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Miért az Aspose.BarCode a C++ számára?" tabId="success-stories" >}}
