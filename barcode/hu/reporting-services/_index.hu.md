---
title: Lineáris és 2D vonalkódképek megjelenítése az SQL Server Reporting Servicesben
description: SQL Server Reporting Services renderelő bővítmény – Lineáris és 2D vonalkódképek exportálása SSRS-ben. Rendereljen vonalkódcímkéket BMP JPEG GIF és PNG formátumban.
lang: hu/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="SSRS vonalkód API-k" h2="Lineáris és 2D vonalkódok létrehozása a Microsoft SQL Server Reporting Services szolgáltatásból." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-reporting-services.svg" pfName="Aspose.BarCode" subTitlepfName="a következőhöz&colon; SQL Reporting Services" downloadUrl="https://releases.aspose.com/barcode/reportingservices/" >}}
...
<p>Az Aspose.BarCode for Reporting Services egy átfogó megoldás lineáris és 2D vonalkódok megjelenítésére a Microsoft SQL Server Reporting Services szolgáltatáson belül. A vonalkódcímkék nem angol karakterekkel kódolhatók, és BMP, JPEG, GIF és PNG formátumban jeleníthetők meg.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Platformfüggetlenség" description="Támogatja a Microsoft SQL Server Reporting Services szolgáltatást." >}}
<div class='diagram1 d1-rs'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Támogatott fájlformátumok" description="Az Aspose.BarCode for SQL Reporting Services a leggyakrabban használt képfájlformátumokkal működik." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/dynamically-display-barcodes-in-table/'>A vonalkódok dinamikus megjelenítése táblázatokban</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/display-barcodes-from-dataset/'>Vonalkódok megjelenítése adatkészletekből</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/barcode-types-and-image-formats/'>Mentse el a vonalkódokat vektoros képformátumban</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Integráció az SQL Server Reporting Services szolgáltatással
                </h2>
                <p>
                    Az Aspose.BarCode for Reporting Services egyszerűen integrálható meglévő vagy új projektekbe az Aspose.BarCode for Reporting Services Visual Studio Toolbox hozzáadásával. Amint elérhető az Eszköztárban, a kívánt helyre húzhatja a projektre.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Ez a vonalkód API lehetővé teszi a fejlesztők számára, hogy kiváló minőségű vonalkódokat állítsanak elő a vonalkód típusának, a kódolandó bemeneti adatoknak és az egyéni megjelenéssel kapcsolatos tulajdonságoknak a beállításával. Számos lehetőséget kínál a generált vonalkódok megjelenésének finomhangolására, beleértve a háttér és az előtér színét, a betűtípust, a méretet, a felbontást és a szöveges feliratokat.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Vonalkód tervező a Visual Studio számára
                </h2>
                <p>
                    A vonalkódcímkék elrendezése módosítható a Visual Studio teljesen integrált vonalkódtervezőjével. A fejlesztők a tervezés során megtekinthetik és módosíthatják a vonalkódképeket. A tervező különböző beállítások testreszabását is lehetővé teszi a vonalkódképek megjelenésének módosításához.
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/pdf417/" name="PDF417" description="PDF417 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/qr/" name="QR" description="QR kód, GS1 QR kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/datamatrix/" name="Data Matrix" description="Data Matrix kódot" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/aztec/" name="Aztec" description="Aztec Kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/swiss-qr/" name="Swiss QR" description="Swiss QR számla" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/dotcode/" name="DotCode" description="DotCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/hibc/" name="HIBC" description="HIBC (Egészségügyi vonalkód)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/codablock/" name="Codablock-F" description="Codablock-F és GS1 Codablock-F vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/itf/" name="ITF" description="Interleaved 2-of-5 (ITF) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/ean/" name="EAN" description="EAN (nemzetközi cikkszám) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/upc/" name="UPC" description="UPC (Univerzális termékkód) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/code128/" name="GS1 Code 128" description="GS1 Code 128 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/code39/" name="Code 39" description="Code 39 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/code16k/" name="Code 16K" description="Code 16K vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/code32/" name="Code 32" description="Olasz Pharmacode (Code 32) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/code93/" name="Code 93" description="Code 93 kiterjesztett és Code 93 szabványos vonalkódok" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/onecode/" name="USPS OneCode" description="USPS OneCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Ipari 2/5) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/isbn/" name="ISBN" description="ISBN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/ismn/" name="ISMN" description="ISMN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/issn/" name="ISSN" description="ISSN vonalkód" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/australia-post/" name="Australia Post" description="Australia Post vonalkód és Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode és Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/rm4scc/" name="RM4SCC" description="Royal Mail 4 állam ügyfélkódja (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/postnet/" name="Postnet" description="Postnet vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/royal-mail/" name="Royal Mail" description="Royal Mail vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/singapore-post/" name="Singapore Post" description="Singapore Post vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/reporting-services/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentáció" href="https://docs.aspose.com/barcode/reportingservices/" >}}
...
{{< blocks/products/pf/slr-element name="Kiadási megjegyzések" href="https://docs.aspose.com/barcode/reportingservices/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Miért az Aspose.BarCode a SQL Reporting Services számára?" tabId="success-stories" >}}
