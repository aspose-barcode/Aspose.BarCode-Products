...
{{% blocks/products/pf/agp/feature-section-col title="A(z) PDF417 vonalkód létrehozásának lépései a C# alkalmazásban" %}}
...
<ul><li>Hozzon létre egy BarcodeGenerator osztály példányt</li><li>Adja meg a(z) PDF417 vonalkód paramétert paraméterként</li><li>Kódolás szövegének beállítása második paraméterként</li><li> Ha szükséges, adja meg a vonalkód méreteit.</li><li>Hívja a BarcodeGenerator.Save metódust a(z) PDF417 vonalkód kép beszerzéséhez.</li></ul>
