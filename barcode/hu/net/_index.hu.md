---
title: C# .NET Vonalkód API - Olvasás Vonalkódok generálása és felismerése
description: Aspose.BarCode .NET API-khoz 1D 2D vonalkódok létrehozásához és felismeréséhez. Integrálható a C# VB.NET ASP.NET alkalmazásokba a vonalkódos címkék beolvasásához és nyomtatásához
lang: hu/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Vonalkód generátor és olvasó API" h2="Létrehozhat és felismerhet lineáris, 2D és postai típusú vonalkódokat bármely .NET alkalmazásban." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" pfName="Aspose.BarCode" subTitlepfName="a következőhöz&colon; .NET" downloadUrl="https://releases.aspose.com/barcode/net/" >}}
...
<p>Az Aspose.BarCode for .NET egy hatékony fejlesztői könyvtár 1D és 2D vonalkódok generálására és felismerésére különféle képtípusokból, bármilyen szögben. A fejlesztők könnyedén hozzáadhatnak vonalkód generálási és szkennelési funkciókat .NET-alkalmazásaikhoz. Ez az API lehetővé teszi a generált vonalkódok exportálását különböző kiváló minőségű képformátumokba.</p><p>Az Aspose.BarCode for .NET lehetővé teszi a generált vonalkódok megjelenésének és paramétereinek módosítását, mint például a háttérszín, a sáv színe, az elforgatási szög, x -dimenzió, képminőség, felbontás, feliratok, méret és még sok más. Gazdag vonalkód-észlelési és -olvasási funkciókat is biztosít, és több mint 60 vonalkód-típust támogat.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Platformfüggetlenség" description="A könyvtár segítségével bármilyen típusú 32 bites vagy 64 bites .NET-alkalmazást készíthet, beleértve az ASP.NET-et, a WinForms-t, a WPF-et, a .NET Standard-ot és még sok mást." >}}
<div class='diagram1 d1-net'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
            ...
            <ul><li>PHP, VBScript, Delphi, C++</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            <header>
    ...
    <!--/row-->
    <div class="d1-logo">
        <img width="70" height="75" alt='Barcode Generator in .NET' src='https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg'/>
        <header>
            Aspose.BarCode
        </header>
        <footer>
...
{{< blocks/products/pf/carousel-item h3="Támogatott fájlformátumok" description="Az Aspose.BarCode for .NET a leggyakrabban használt képfájlformátumokkal működik." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/saving-barcode-image/'>Mentse el a vonalkódcímkéket különböző formátumokban</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/read-barcodes-with-aspose-barcode-apis/#setting-barcode-recognition-source'>Felismerés adatfolyamból vagy fájlból</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/qr-and-micro-qr-barcode/#eciencoding-mode'>Karakterek kódolása és dekódolása (nem angol nyelvű) 2D típusokban</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/image-formatting-and-display-settings/'>Forgassa el a vonalkód képeket bármilyen szögben</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/how-to-read-barcode-from-multi-page-tiff-images/'>Vonalkódok beolvasása többoldalas TIFF-ből</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/barcode-types-and-image-formats/'>Lineáris, 2D és postai szimbólumok támogatása</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section title="Supported Barcode Types" subTitle="Using .NET, developers can read and generate barcodes of differen types, including the following." >}}

<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">2D:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/pdf417/" name="PDF417" description="PDF417 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/qr/" name="QR" description="QR kód, GS1 QR kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/datamatrix/" name="Data Matrix" description="Data Matrix kódot" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/aztec/" name="Aztec" description="Aztec Kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/swiss-qr/" name="Swiss QR" description="Swiss QR számla" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/dotcode/" name="DotCode" description="DotCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/hibc/" name="HIBC" description="HIBC (Egészségügyi vonalkód)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/codablock/" name="Codablock-F" description="Codablock-F és GS1 Codablock-F vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/itf/" name="ITF" description="Interleaved 2-of-5 (ITF) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/ean/" name="EAN" description="EAN (nemzetközi cikkszám) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/upc/" name="UPC" description="UPC (Univerzális termékkód) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/code128/" name="GS1 Code 128" description="GS1 Code 128 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/code39/" name="Code 39" description="Code 39 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/code16k/" name="Code 16K" description="Code 16K vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/code32/" name="Code 32" description="Olasz Pharmacode (Code 32) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/code93/" name="Code 93" description="Code 93 kiterjesztett és Code 93 szabványos vonalkódok" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/onecode/" name="USPS OneCode" description="USPS OneCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Ipari 2/5) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/isbn/" name="ISBN" description="ISBN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/ismn/" name="ISMN" description="ISMN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/issn/" name="ISSN" description="ISSN vonalkód" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/australia-post/" name="Australia Post" description="Australia Post vonalkód és Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode és Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/rm4scc/" name="RM4SCC" description="Royal Mail 4 állam ügyfélkódja (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/postnet/" name="Postnet" description="Postnet vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/royal-mail/" name="Royal Mail" description="Royal Mail vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/singapore-post/" name="Singapore Post" description="Singapore Post vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentáció" href="https://docs.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/slr-element name="Kiadási megjegyzések" href="https://docs.aspose.com/barcode/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Miért az Aspose.BarCode a .NET számára?" tabId="success-stories" >}}
