...
{{% blocks/products/pf/agp/feature-section-col title="A(z) EAN (nemzetközi cikkszám) vonalkód létrehozásának lépései a C# alkalmazásban" %}}
...
<ul><li>Hozzon létre egy BarcodeGenerator osztály példányt</li><li>Adja meg a(z) EAN (nemzetközi cikkszám) vonalkód paramétert paraméterként</li><li>Kódolás szövegének beállítása második paraméterként</li><li> Ha szükséges, adja meg a vonalkód méreteit.</li><li>Hívja a BarcodeGenerator.Save metódust a(z) EAN (nemzetközi cikkszám) vonalkód kép beszerzéséhez.</li></ul>
