---
title: Deutsche Post Identcode és Deutsche Post Leitcode képek létrehozása a .NET segítségével
description: C# forráskód a Deutsche Post Identcode és Deutsche Post Leitcode generációhoz .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi és C++.
lang: hu/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hu/net/deutsche-post/generate/
aliases:
- /hu/net/generate/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hozzon létre Deutsche Post címkéket a következővel&colon; .NET" h2="Hozzon létre Deutsche Post Identcode és Deutsche Post Leitcode-et a C#-ban a szerveroldali Aspose.BarCode for .NET API használatával." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Hozzon létre egy BarcodeGenerator osztály példányt</li><li>Adja meg a(z) Deutsche Post Identcode és Deutsche Post Leitcode paramétert paraméterként</li><li>Kódolás szövegének beállítása második paraméterként</li><li> Ha szükséges, adja meg a vonalkód méreteit.</li><li>Hívja a BarcodeGenerator.Save metódust a(z) Deutsche Post Identcode és Deutsche Post Leitcode kép beszerzéséhez.</li></ul>
