...
<ul><li>Hozzon létre egy BarcodeGenerator osztály példányt</li><li>Adja meg a(z) QR kód, GS1 QR kód paramétert paraméterként</li><li>Kódolás szövegének beállítása második paraméterként</li><li> Ha szükséges, adja meg a vonalkód méreteit.</li><li>Hívja a BarcodeGenerator.Save metódust a(z) QR kód, GS1 QR kód kép beszerzéséhez.</li></ul>
