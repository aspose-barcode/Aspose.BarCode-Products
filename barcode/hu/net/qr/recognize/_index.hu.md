---
title: Szkennelje be a(z) QR kód, GS1 QR kód képeit a(z) .NET segítségével
weight: 1510
description: C# mintakód a QR kód, GS1 QR kód vonalkód típusának beolvasásához és dekódolásához .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi vagy C++.
lang: hu/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hu/net/qr/recognize/
aliases:
- /hu/net/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Olvassa el a QR vonalkódokat a .NET segítségével" h2="Olvassa el a(z) QR kód, GS1 QR kód C# nyelvet a szerveroldali Aspose.BarCode for .NET API használatával" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="A(z) QR Kód beolvasásának lépései a C# programban" %}}
