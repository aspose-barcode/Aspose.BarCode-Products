---
title: SharePoint Vonalkód API – Vonalkódok beszúrása a SharePoint-listákba
description: Vonalkód SharePoint API vonalkódcímkék beszúrásához az egyéni SharePoint-listákba. A fejlesztők a szolgáltatásjelölőket használhatják a beviteli szövegértékek kiválasztására vagy a szöveg manuális beszúrására.
lang: hu/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="SharePoint vonalkód API-k" h2="Vonalkód SharePoint alkalmazás Lineáris, 2D és postai vonalkódok hozzáadásához a Microsoft SharePoint listákhoz." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="a következőhöz&colon; SharePoint" downloadUrl="https://releases.aspose.com/barcode/sharepoint/" >}}
...
<p>Az Aspose.BarCode for SharePoint lehetővé teszi a fejlesztők számára, hogy lineáris, 2D és postai vonalkódok széles választékát adják hozzá a Microsoft SharePoint Foundation 2010 és a Microsoft Office SharePoint Server 2010 (MOSS) listáihoz. Bármely listába létrehozhat, majd beilleszthet vonalkódokat a beviteli szöveg és típus megadásával.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Platformfüggetlenség" description="Az Aspose.BarCode for SharePoint támogatja a Microsoft SharePoint Foundationt és a SharePoint Servert." >}}
<div class='diagram1 d1-sharepoint'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Támogatott fájlformátumok" description="Az Aspose.BarCode for SharePoint a leggyakrabban használt képfájlformátumokkal működik." >}}
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Vonalkódok hozzáadása a Sharepoint listákhoz
                </h2>
                <p>
                    Az Aspose.BarCode for SharePoint gazdag funkcionalitást biztosít vonalkódok SharePoint-listákhoz való hozzáadásához. Az ilyen listák az adatok strukturált formátumban történő tárolására és rendszerezésére használhatók. Ezzel kényelmesen kezelheti az információk széles körét, például névjegyeket, feladatokat, naptári eseményeket stb. Számos funkciót biztosítanak az adatok rendszerezéséhez, rendezéséhez, szűréséhez és megosztásához. Hasznos lehet vonalkódok hozzáadása a SharePoint-listákhoz, hogy megkönnyítse a listában található információk elérését és kezelését. Ha létrehoz egy SharePoint-listát a készletelemek nyomon követésére, a fejlesztők vonalkódokat adhatnak hozzá a listában található információk gyors és pontos beolvasásához és frissítéséhez. Ez megkönnyítheti a készlet nyomon követését és kezelését, valamint csökkentheti az eltérések kockázatát. A vonalkódok segítségével gyorsan elérheti és megtekintheti a SharePoint-listában található információkat, például vonalkódok beolvasásával a lista egyes elemei vagy rekordjai gyorsan megjeleníthetők.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    A vonalkód-könyvtár egy hatékony eszköz, amely lehetővé teszi a fejlesztők számára, hogy egyszerűen állítsanak elő vonalkódokat a cél vonalkód típusának megadásával, a vonalkód tárolására szolgáló bemeneti adatok beszúrásával és a megjelenéssel kapcsolatos tulajdonságok testreszabásával. A könyvtár számos lehetőséget kínál a generált vonalkódok megjelenésének finomhangolására, beleértve a háttér és az előtér színének, a betűtípusnak, a méretnek, a felbontásnak és a szöveges feliratoknak a beállítását.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    A Vonalkód API különféle funkciókat tartalmaz a népszerű 1D és 2D vonalkódok széles körének észleléséhez és olvasásához. Ezek a funkciók egyszerűen, néhány sornyi kóddal integrálhatók alkalmazásaiba, kényelmes és hatékony módot biztosítva arra, hogy az alkalmazásait vonalkód-észlelési képességekkel egészítse ki.
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/pdf417/" name="PDF417" description="PDF417 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/qr/" name="QR" description="QR kód, GS1 QR kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/datamatrix/" name="Data Matrix" description="Data Matrix kódot" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/aztec/" name="Aztec" description="Aztec Kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/swiss-qr/" name="Swiss QR" description="Swiss QR számla" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/dotcode/" name="DotCode" description="DotCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/hibc/" name="HIBC" description="HIBC (Egészségügyi vonalkód)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/codablock/" name="Codablock-F" description="Codablock-F és GS1 Codablock-F vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/itf/" name="ITF" description="Interleaved 2-of-5 (ITF) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/ean/" name="EAN" description="EAN (nemzetközi cikkszám) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/upc/" name="UPC" description="UPC (Univerzális termékkód) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/code128/" name="GS1 Code 128" description="GS1 Code 128 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/code39/" name="Code 39" description="Code 39 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/code16k/" name="Code 16K" description="Code 16K vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/code32/" name="Code 32" description="Olasz Pharmacode (Code 32) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/code93/" name="Code 93" description="Code 93 kiterjesztett és Code 93 szabványos vonalkódok" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/onecode/" name="USPS OneCode" description="USPS OneCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Ipari 2/5) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/isbn/" name="ISBN" description="ISBN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/ismn/" name="ISMN" description="ISMN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/issn/" name="ISSN" description="ISSN vonalkód" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/australia-post/" name="Australia Post" description="Australia Post vonalkód és Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode és Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/rm4scc/" name="RM4SCC" description="Royal Mail 4 állam ügyfélkódja (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/postnet/" name="Postnet" description="Postnet vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/royal-mail/" name="Royal Mail" description="Royal Mail vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/singapore-post/" name="Singapore Post" description="Singapore Post vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/sharepoint/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentáció" href="https://docs.aspose.com/barcode/sharepoint/" >}}
{{< blocks/products/pf/slr-element name="Forráskód" href="https://github.com/aspose-barcode/Aspose.BarCode-for-.NET" >}}
{{< blocks/products/pf/slr-element name="API referenciák" href="https://reference.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/slr-element name="Kiadási megjegyzések" href="https://docs.aspose.com/barcode/sharepoint/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Miért az Aspose.BarCode a SharePoint számára?" tabId="success-stories" >}}
