---
title: GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód képek létrehozása a Java segítségével
description: Java mintakód a GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód generációhoz Java Runtime Environment-ben JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
lang: hu/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hu/java/databar/generate/
aliases:
- /hu/java/generate/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hozzon létre GS1 DataBar címkéket a következővel&colon; Java" h2="Hozzon létre GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód-et a Java-ban a szerveroldali Aspose.BarCode for Java API használatával." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
