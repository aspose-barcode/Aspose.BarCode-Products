---
title: Szkennelje be a(z) GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód képeit a(z) Java segítségével
weight: 1510
description: Java-forráskód a(z) GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód olvasásához és dekódolásához Java Runtime Environment-ben JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
lang: hu/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hu/java/databar/recognize/
aliases:
- /hu/java/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Olvassa el a GS1 DataBar vonalkódokat a Java segítségével" h2="Olvassa el a(z) GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód Java nyelvet a szerveroldali Aspose.BarCode for Java API használatával" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 DataBar vonalkód Using Java" %}}
A(z) GS1 DataBar vonalkód felismeréséhez használja az [Aspose.BarCode for Java](https://products.aspose.com/barcode/java/) API-t, amely egy fejlett, robusztus és könnyen használható vonalkódkönyvtár a Java-hoz. alapú platformok. Töltse le a legújabb verziót közvetlenül a [Maven] webhelyről (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-barcode), és telepítse a Maven-alapú készülékére projektekhez a következő konfigurációk belefoglalásával a pom.xml fájlba:
...
<ul><li>A BarCodeReader osztály új objektumának létrehozása</li><li>Állítsa be a forrásfájl elérési útját, amely tartalmazza a következőt&colon; {{BARCODE_FULL_NAME}</li><li>Adja át a szükséges vonalkódtípusokat a DecodeType-nak második paraméterként</li><li>Lépjen végig a dekódolási eredményeken</li><li>Vonalkódszöveg lekérése a getCodeText metódussal</li></ul>
...
<ul><li>Microsoft Windows, Linux vagy bármely olyan operációs rendszer, amely kompatibilis a Java futási környezettel JSP/JSF és asztali alkalmazásokhoz</li><li>Java fejlesztői környezet, például JRE 1.6 vagy újabb</li><li> Java fejlesztési verzió JSE2 7.0 vagy újabb</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/pdf417/recognize/" name="PDF417" description="PDF417 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/qr/recognize/" name="QR" description="QR kód, GS1 QR kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix kódot" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/aztec/recognize/" name="Aztec" description="Aztec Kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR számla" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/dotcode/recognize/" name="DotCode" description="DotCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/hibc/recognize/" name="HIBC" description="HIBC (Egészségügyi vonalkód)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/codablock/recognize/" name="Codablock-F" description="Codablock-F és GS1 Codablock-F vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/itf/recognize/" name="ITF" description="Interleaved 2-of-5 (ITF) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/ean/recognize/" name="EAN" description="EAN (nemzetközi cikkszám) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/upc/recognize/" name="UPC" description="UPC (Univerzális termékkód) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/code39/recognize/" name="Code 39" description="Code 39 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/code16k/recognize/" name="Code 16K" description="Code 16K vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/code32/recognize/" name="Code 32" description="Olasz Pharmacode (Code 32) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/code93/recognize/" name="Code 93" description="Code 93 kiterjesztett és Code 93 szabványos vonalkódok" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Ipari 2/5) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/isbn/recognize/" name="ISBN" description="ISBN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/ismn/recognize/" name="ISMN" description="ISMN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/issn/recognize/" name="ISSN" description="ISSN vonalkód" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/australia-post/recognize/" name="Australia Post" description="Australia Post vonalkód és Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode és Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4 állam ügyfélkódja (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/postnet/recognize/" name="Postnet" description="Postnet vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/royal-mail/recognize/" name="Royal Mail" description="Royal Mail vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/singapore-post/recognize/" name="Singapore Post" description="Singapore Post vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
