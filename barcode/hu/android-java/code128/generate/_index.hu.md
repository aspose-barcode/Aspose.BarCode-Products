...
{{% blocks/products/pf/agp/feature-section-col title="A(z) GS1 Code 128 vonalkód létrehozásának lépései a Java alkalmazásban" %}}

{{% blocks/products/pf/agp/text %}}

Az Aspose.BarCode megkönnyíti a fejlesztők számára a GS1 Code 128 vonalkód képek létrehozását néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

<ul><li>A BarCodeGenerator osztály új példányának létrehozása</li><li>Adja meg a GS1 Code 128 vonalkód vonalkódtípust EncodeTypes paraméterként</li><li>Vonalkód szöveg meghatározása a setCodeText metódussal</li><li>Indítsa el a generateBarCodeImage() metódust a GS1 Code 128 vonalkód vonalkód kép mentéséhez.</li></ul>
