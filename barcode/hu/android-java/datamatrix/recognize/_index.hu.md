---
title: Szkennelje be a(z) Data Matrix kódot képeit a(z) Android via Java segítségével
weight: 1510
description: Android mintakód a(z) Data Matrix kódot felismerésére az Android futási környezetben.
lang: hu/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hu/android-java/datamatrix/recognize/
aliases:
- /hu/android-java/recognize/datamatrix/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Olvassa el a Data Matrix vonalkódokat a Android via Java segítségével" h2="Olvassa el a(z) Data Matrix kódot Java nyelvet a szerveroldali Aspose.BarCode for Android via Java API használatával" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Data Matrix" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Data Matrix kódot Using Android via Java" %}}
Próbálja ki az Aspose.BarCode for Android programot Java-n keresztül, hogy könnyen észlelje és beolvassa a(z) Data Matrix kódot elemet az Android alkalmazásokban. Ez egy gazdag, méretezhető és felhasználóbarát vonalkód API, amelyet Android alkalmazásokhoz terveztek. Szerezze be az Aspose.BarCode for Java-t közvetlenül egy Maven-alapú projektből a következő konfigurációk hozzáadásával a build.gradle fájlhoz:
...
{{% blocks/products/pf/agp/feature-section-col title="A(z) Data Matrix kódot beolvasásának lépései a Java programban" %}}
