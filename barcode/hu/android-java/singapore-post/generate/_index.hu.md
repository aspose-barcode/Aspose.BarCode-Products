...
{{% blocks/products/pf/agp/feature-section-col title="A(z) Singapore Post vonalkód létrehozásának lépései a Java alkalmazásban" %}}
...
<ul><li>A BarCodeGenerator osztály új példányának létrehozása</li><li>Adja meg a Singapore Post vonalkód vonalkódtípust EncodeTypes paraméterként</li><li>Vonalkód szöveg meghatározása a setCodeText metódussal</li><li>Indítsa el a generateBarCodeImage() metódust a Singapore Post vonalkód vonalkód kép mentéséhez.</li></ul>
