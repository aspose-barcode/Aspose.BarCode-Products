---
title: GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód képek létrehozása a Android via Java segítségével
description: Android-forráskód a(z) GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód létrehozásához Android Runtime Environment-ben.
lang: hu/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hu/android-java/databar/generate/
aliases:
- /hu/android-java/generate/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hozzon létre GS1 DataBar címkéket a következővel&colon; Android via Java" h2="Hozzon létre GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód-et a Java-ban a szerveroldali Aspose.BarCode for Android via Java API használatával." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="A(z) GS1 DataBar vonalkód létrehozásának lépései a Java alkalmazásban" %}}
...
<ul><li>A BarCodeGenerator osztály új példányának létrehozása</li><li>Adja meg a GS1 DataBar vonalkód vonalkódtípust EncodeTypes paraméterként</li><li>Vonalkód szöveg meghatározása a setCodeText metódussal</li><li>Indítsa el a generateBarCodeImage() metódust a GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód vonalkód kép mentéséhez.</li></ul>
