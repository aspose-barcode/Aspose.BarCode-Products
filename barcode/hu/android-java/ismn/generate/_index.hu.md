...
{{% blocks/products/pf/agp/feature-section-col title="A(z) ISMN vonalkód létrehozásának lépései a Java alkalmazásban" %}}
...
<ul><li>A BarCodeGenerator osztály új példányának létrehozása</li><li>Adja meg a ISMN vonalkód vonalkódtípust EncodeTypes paraméterként</li><li>Vonalkód szöveg meghatározása a setCodeText metódussal</li><li>Indítsa el a generateBarCodeImage() metódust a ISMN vonalkód vonalkód kép mentéséhez.</li></ul>
