...
{{% blocks/products/pf/agp/feature-section-col title="A(z) Code 32 vonalkód létrehozásának lépései a Java alkalmazásban" %}}
...
<ul><li>A BarCodeGenerator osztály új példányának létrehozása</li><li>Adja meg a Code 32 vonalkód vonalkódtípust EncodeTypes paraméterként</li><li>Vonalkód szöveg meghatározása a setCodeText metódussal</li><li>Indítsa el a generateBarCodeImage() metódust a Olasz Pharmacode (Code 32) vonalkód vonalkód kép mentéséhez.</li></ul>
