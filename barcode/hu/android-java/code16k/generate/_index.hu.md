...
{{% blocks/products/pf/agp/feature-section-col title="A(z) Code 16K vonalkód létrehozásának lépései a Java alkalmazásban" %}}
...
<ul><li>A BarCodeGenerator osztály új példányának létrehozása</li><li>Adja meg a Code 16K vonalkód vonalkódtípust EncodeTypes paraméterként</li><li>Vonalkód szöveg meghatározása a setCodeText metódussal</li><li>Indítsa el a generateBarCodeImage() metódust a Code 16K vonalkód vonalkód kép mentéséhez.</li></ul>
