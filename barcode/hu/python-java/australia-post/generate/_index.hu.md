---
title: Australia Post vonalkód és Australia Post eParcel képek létrehozása a Python via Java segítségével
description: Python mintakód a Australia Post vonalkód és Australia Post eParcel létrehozásához Java futási környezet használatával.
lang: hu/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hu/python-java/australia-post/generate/
aliases:
- /hu/python-java/generate/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hozzon létre Australia Post címkéket a következővel&colon; Python via Java" h2="Hozzon létre Australia Post vonalkód és Australia Post eParcel-et a Python-ban a szerveroldali Aspose.BarCode for Python via Java API használatával." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Australia Post vonalkód Using Python via Java" %}}
A(z) Australia Post vonalkód képek készítéséhez szerezze be az [Aspose.BarCode for Python for Java via](https://products.aspose.com/barcode/python-java/) API-t, amely funkciókban gazdag, hatékony és könnyen kezelhető - Vonalkód könyvtár használata Python-alapú alkalmazásokhoz. Szerezze be a legújabb verziót közvetlenül az [Aspose releases](https://releases.aspose.com/barcode/python-java/) portálról, vagy telepítse az „aspose-barcode”-t a pip-ből a következő paranccsal:
...
{{% blocks/products/pf/agp/feature-section-col title="A(z) Australia Post vonalkód létrehozásának lépései a Python alkalmazásban" %}}
...
<ul><li>Új objektum létrehozása a BarCodeGenerator osztályból</li><li>Határozza meg a kívánt vonalkód típusokat az EncodeTypes paraméterként.</li><li>Bemeneti szöveg beszúrása második paraméterként</li><li> Hívja a BarCodeGenerator.save metódust a generált Australia Post vonalkód és Australia Post eParcel kép lekéréséhez</li></ul>
