---
title: Szkennelje be a(z) Data Matrix kódot képeit a(z) Python via Java segítségével
weight: 1510
description: Python-forráskód a Data Matrix kódot felismeréséhez Java Runtime Environment használatával.
lang: hu/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hu/python-java/datamatrix/recognize/
aliases:
- /hu/python-java/recognize/datamatrix/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Olvassa el a Data Matrix vonalkódokat a Python via Java segítségével" h2="Olvassa el a(z) Data Matrix kódot Python nyelvet a szerveroldali Aspose.BarCode for Python via Java API használatával" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Data Matrix" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Data Matrix kódot Using Python via Java" %}}
A(z) Data Matrix kódot beolvasásához és dekódolásához telepítse az [Aspose.BarCode for Python for Java via](https://products.aspose.com/barcode/python-java/) API-t, amely egy sokoldalú, hatékony és könnyen kezelhető. vonalkód-könyvtár használata Python-alapú alkalmazásokhoz. Szerezze be a legújabb verziót közvetlenül az [Aspose releases](https://releases.aspose.com/barcode/python-java/) portálról, vagy telepítse az „aspose-barcode”-t a pip-ből a következő parancs futtatásával:
...
{{% blocks/products/pf/agp/feature-section-col title="A(z) Data Matrix kódot beolvasásának lépései a Python programban" %}}
...
<ul><li>Hozzon létre egy Aspose.BarCode.BarCodeReader osztály objektumot</li><li>Határozza meg a(z) Data Matrix kódot paramétert tartalmazó forrásfájl elérési útját.</li><li>Határozza meg a szükséges vonalkódtípusokat Második paraméterként a DecodeType</li><li>A dekódolási eredmények áttekintése</li><li>A CodeText tulajdonság használatával kérje le a vonalkód szövegét.</li></ul>
