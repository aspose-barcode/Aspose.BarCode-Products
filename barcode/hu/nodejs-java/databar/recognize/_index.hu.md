---
title: Szkennelje be a(z) GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód képeit a(z) Node.js via Java segítségével
weight: 1510
description: Node.js forráskód a GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód szkenneléséhez és dekódolásához JavaScript-alkalmazásokban.
lang: hu/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hu/nodejs-java/databar/recognize/
aliases:
- /hu/nodejs-java/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Olvassa el a GS1 DataBar vonalkódokat a Node.js via Java segítségével" h2="Olvassa el a(z) GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód JavaScript nyelvet a szerveroldali Aspose.BarCode for Node.js via Java API használatával" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 DataBar vonalkód Using Node.js via Java" %}}
A(z) GS1 DataBar vonalkód Node.js alkalmazásokon belüli felismeréséhez használja az Aspose.BarCode for Node.js programot a Java-n keresztül, amely egy robusztus, sokoldalú és felhasználóbarát vonalkódkönyvtár, amelyet Java-alapú környezetekhez vezettek be. Az [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) fájlt közvetlenül az NPM-ből töltheti be a Javascripthez:
...
{{% blocks/products/pf/agp/feature-section-col title="A(z) GS1 DataBar vonalkód beolvasásának lépései a JavaScript programban" %}}
...
<ul><li>Hozzon létre egy Aspose.BarCode.BarCodeReader osztályú objektumot</li><li>Adja meg a(z) GS1 DataBar vonalkód paramétert tartalmazó forrásfájl elérési útját.</li><li>Cél vonalkódtípusok beállítása a DecodeType-ban második paraméterként</li><li>Az összes észlelt vonalkód végigjátszása</li><li>Az eredményül kapott vonalkódszöveg lekérése a CodeText tulajdonság használatával</li></ul>
...
<ul><li>Microsoft Windows, Linux vagy bármely olyan operációs rendszer, amely kompatibilis a Node.js-szel.</li><li>Node.js és Node.js/Java Bridge telepítve</li><li>Az Oracle JDK 7-es vagy újabb verziója </li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/pdf417/recognize/" name="PDF417" description="PDF417 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/qr/recognize/" name="QR" description="QR kód, GS1 QR kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix kódot" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/aztec/recognize/" name="Aztec" description="Aztec Kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR számla" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/dotcode/recognize/" name="DotCode" description="DotCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/hibc/recognize/" name="HIBC" description="HIBC (Egészségügyi vonalkód)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/codablock/recognize/" name="Codablock-F" description="Codablock-F és GS1 Codablock-F vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Halmozott Omnidirectional, Expanded, Expanded Halmozott és Csonka) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/itf/recognize/" name="ITF" description="Interleaved 2-of-5 (ITF) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/ean/recognize/" name="EAN" description="EAN (nemzetközi cikkszám) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/upc/recognize/" name="UPC" description="UPC (Univerzális termékkód) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/code39/recognize/" name="Code 39" description="Code 39 vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/code16k/recognize/" name="Code 16K" description="Code 16K vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/code32/recognize/" name="Code 32" description="Olasz Pharmacode (Code 32) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/code93/recognize/" name="Code 93" description="Code 93 kiterjesztett és Code 93 szabványos vonalkódok" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Ipari 2/5) vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/isbn/recognize/" name="ISBN" description="ISBN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/ismn/recognize/" name="ISMN" description="ISMN vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/issn/recognize/" name="ISSN" description="ISSN vonalkód" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/australia-post/recognize/" name="Australia Post" description="Australia Post vonalkód és Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode és Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4 állam ügyfélkódja (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/postnet/recognize/" name="Postnet" description="Postnet vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/royal-mail/recognize/" name="Royal Mail" description="Royal Mail vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/singapore-post/recognize/" name="Singapore Post" description="Singapore Post vonalkód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hu/nodejs-java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
