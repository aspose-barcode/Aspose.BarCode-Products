---
title: Australia Post vonalkód és Australia Post eParcel képek létrehozása a Node.js via Java segítségével
description: Node.js mintakód a Australia Post vonalkód és Australia Post eParcel generációhoz JavaScript-alkalmazásokban.
lang: hu/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hu/nodejs-java/australia-post/generate/
aliases:
- /hu/nodejs-java/generate/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hozzon létre Australia Post címkéket a következővel&colon; Node.js via Java" h2="Hozzon létre Australia Post vonalkód és Australia Post eParcel-et a JavaScript-ban a szerveroldali Aspose.BarCode for Node.js via Java API használatával." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Australia Post vonalkód Using Node.js via Java" %}}
Ha Australia Post vonalkód vonalkódokat szeretne létrehozni a Node.js alkalmazásokon belül, szerezze be az Aspose.BarCode for Node.js szoftvert a Java-n keresztül, amely egy fejlett, hatékony és felhasználóbarát vonalkód API Java-orientált platformokhoz. Könnyedén telepítheti az [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) Javascriptet az NPM-ből:
...
{{% blocks/products/pf/agp/feature-section-col title="A(z) Australia Post vonalkód létrehozásának lépései a JavaScript alkalmazásban" %}}
...
<ul><li>A BarCodeGenerator osztály példányának létrehozása</li><li>Állítsa be a(z) Australia Post vonalkód értéket EncodeTypes paraméterként.</li><li>Szöveg meghatározása a kódolandó második paraméterként</li><li>Ha szükséges, határozza meg a vonalkód méretét és helyét.</li><li>Hívja a BarCodeGenerator.save metódust a generált vonalkód kép lekéréséhez.</li></ul>
