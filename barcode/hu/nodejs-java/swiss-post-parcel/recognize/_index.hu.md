...
{{% blocks/products/pf/agp/feature-section-col title="A(z) Swiss Post Parcel beolvasásának lépései a JavaScript programban" %}}

{{% blocks/products/pf/agp/text %}}

Az Aspose.BarCode segítségével a fejlesztők Swiss Post Parcel vonalkódokat olvashatnak adatfolyamból vagy képből néhány sornyi kóddal

{{% /blocks/products/pf/agp/text %}}

<ul><li>Hozzon létre egy Aspose.BarCode.BarCodeReader osztályú objektumot</li><li>Adja meg a(z) Swiss Post Parcel paramétert tartalmazó forrásfájl elérési útját.</li><li>Cél vonalkódtípusok beállítása a DecodeType-ban második paraméterként</li><li>Az összes észlelt vonalkód végigjátszása</li><li>Az eredményül kapott vonalkódszöveg lekérése a CodeText tulajdonság használatával</li></ul>
