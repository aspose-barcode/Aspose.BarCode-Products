---
title: Szkennelje be a(z) DotCode vonalkód képeit a(z) Node.js via Java segítségével
weight: 1510
description: Node.js forráskód a DotCode vonalkód szkenneléséhez és dekódolásához JavaScript-alkalmazásokban.
lang: hu/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hu/nodejs-java/dotcode/recognize/
aliases:
- /hu/nodejs-java/recognize/dotcode/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Olvassa el a DotCode vonalkódokat a Node.js via Java segítségével" h2="Olvassa el a(z) DotCode vonalkód JavaScript nyelvet a szerveroldali Aspose.BarCode for Node.js via Java API használatával" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DotCode" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="A(z) DotCode vonalkód beolvasásának lépései a JavaScript programban" %}}
...
<ul><li>Hozzon létre egy Aspose.BarCode.BarCodeReader osztályú objektumot</li><li>Adja meg a(z) DotCode vonalkód paramétert tartalmazó forrásfájl elérési útját.</li><li>Cél vonalkódtípusok beállítása a DecodeType-ban második paraméterként</li><li>Az összes észlelt vonalkód végigjátszása</li><li>Az eredményül kapott vonalkódszöveg lekérése a CodeText tulajdonság használatával</li></ul>
