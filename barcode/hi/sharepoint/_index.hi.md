---
title: शेयरपॉइंट बारकोड एपीआई - शेयरपॉइंट सूचियों पर बारकोड डालें
description: कस्टम शेयरपॉइंट सूचियों में बारकोड लेबल डालने के लिए बारकोड शेयरपॉइंट एपीआई। डेवलपर इनपुट टेक्स्ट वैल्यू चुनने या मैन्युअल रूप से टेक्स्ट डालने के लिए सर्विस मार्कर का उपयोग कर सकते हैं।
lang: hi/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="शेयरपॉइंट बारकोड एपीआई" h2="माइक्रोसॉफ्ट शेयरपॉइंट सूचियों में रैखिक, 2डी और पोस्टल बारकोड जोड़ने के लिए बारकोड शेयरपॉइंट ऐप।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="SharePoint के लिए" downloadUrl="https://releases.aspose.com/barcode/sharepoint/" >}}
...
<p>SharePoint के लिए Aspose.BarCode डेवलपर्स को Microsoft SharePoint Foundation 2010 और Microsoft Office SharePoint Server 2010 (MOSS) सूचियों में बड़ी संख्या में रैखिक, 2D और पोस्टल बारकोड जोड़ने की अनुमति देता है। आप इनपुट टेक्स्ट और टाइप निर्दिष्ट करके किसी भी सूची में बारकोड बना सकते हैं और फिर उसमें बारकोड डाल सकते हैं।</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="प्लेटफार्म स्वतंत्रता" description="SharePoint के लिए Aspose.BarCode Microsoft SharePoint Foundation और SharePoint सर्वर का समर्थन करता है।" >}}
<div class='diagram1 d1-sharepoint'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="समर्थित फ़ाइल स्वरूप" description="SharePoint के लिए Aspose.BarCode सबसे अधिक उपयोग किए जाने वाले छवि फ़ाइल स्वरूपों के साथ काम करता है।" >}}
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    शेयरपॉइंट सूचियों में बारकोड जोड़ें
                </h2>
                <p>
                    SharePoint के लिए Aspose.BarCode SharePoint सूचियों में बारकोड जोड़ने के लिए समृद्ध कार्यक्षमता प्रदान करता है। ऐसी सूचियों का उपयोग संरचित प्रारूप में डेटा को संग्रहीत और व्यवस्थित करने के लिए किया जा सकता है। यह सूचनाओं की एक विस्तृत श्रृंखला को प्रबंधित करने का एक सुविधाजनक तरीका है, जैसे संपर्क, कार्य, कैलेंडर ईवेंट, और बहुत कुछ। वे डेटा को व्यवस्थित करने, छांटने, फ़िल्टर करने और साझा करने के लिए कई सुविधाएँ प्रदान करते हैं। सूची में जानकारी तक पहुँचने और प्रबंधित करने की सुविधा के लिए SharePoint सूचियों में बारकोड जोड़ना उपयोगी हो सकता है। यदि इन्वेंट्री आइटम को ट्रैक करने के लिए SharePoint सूची बनाई जाती है, तो डेवलपर सूची में सूचनाओं को जल्दी और सटीक रूप से स्कैन करने और अपडेट करने के लिए बारकोड जोड़ सकते हैं। यह इन्वेंट्री को ट्रैक करने और प्रबंधित करने की सुविधा प्रदान कर सकता है, साथ ही विसंगतियों के जोखिम को कम कर सकता है। बारकोड किसी SharePoint सूची में जानकारी को त्वरित रूप से एक्सेस करने और देखने के लिए काम कर सकते हैं, उदाहरण के लिए, सूची में विशिष्ट आइटम या रिकॉर्ड को त्वरित रूप से प्रदर्शित करने के लिए बारकोड को स्कैन करके।
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    बारकोड लाइब्रेरी एक शक्तिशाली उपकरण है जो डेवलपर्स को लक्ष्य बारकोड प्रकार निर्दिष्ट करके, बारकोड स्टोर करने के लिए इनपुट डेटा डालने और उपस्थिति-संबंधी गुणों को अनुकूलित करके आसानी से बारकोड उत्पन्न करने की अनुमति देता है। पृष्ठभूमि और अग्रभूमि रंग, फ़ॉन्ट, आकार, रिज़ॉल्यूशन और टेक्स्ट कैप्शन सेट करने के विकल्पों सहित उत्पन्न बारकोड की उपस्थिति को ठीक करने के लिए पुस्तकालय कई प्रकार के विकल्प प्रदान करता है।
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    बारकोड एपीआई में लोकप्रिय 1डी और 2डी बारकोड की एक विस्तृत श्रृंखला का पता लगाने और पढ़ने के लिए विभिन्न विशेषताएं शामिल हैं। कोड की कुछ पंक्तियों के साथ इन सुविधाओं को आसानी से आपके एप्लिकेशन में एकीकृत किया जा सकता है, जिससे आपके एप्लिकेशन में बारकोड पहचान क्षमताओं को जोड़ने का एक सुविधाजनक और कुशल तरीका मिल जाता है।
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/pdf417/" name="PDF417" description="PDF417 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/qr/" name="QR" description="QR कोड, GS1 QR कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/datamatrix/" name="Data Matrix" description="Data Matrix कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/aztec/" name="Aztec" description="Aztec कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/swiss-qr/" name="Swiss QR" description="Swiss QR बिल" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/dotcode/" name="DotCode" description="DotCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/hibc/" name="HIBC" description="HIBC (स्वास्थ्य उद्योग बार कोड)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/codablock/" name="Codablock-F" description="Codablock-F और GS1 Codablock-F बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/databar/" name="GS1 DataBar" description="GS1 DataBar (सर्वदिशात्मक, स्टैक्ड सर्वदिशात्मक, विस्तारित, विस्तारित स्टैक्ड, और छोटा) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/itf/" name="ITF" description="इंटरलीव्ड 2-ऑफ-5 (ITF) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/ean/" name="EAN" description="EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/upc/" name="UPC" description="UPC (यूनिवर्सल प्रोडक्ट कोड) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/code128/" name="GS1 Code 128" description="GS1 Code 128 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/code39/" name="Code 39" description="Code 39 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/code16k/" name="Code 16K" description="Code 16K बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/code32/" name="Code 32" description="इतालवी फार्माकोड (Code 32) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/code93/" name="Code 93" description="Code 93 विस्तारित और Code 93 मानक बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/onecode/" name="USPS OneCode" description="USPS OneCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (इंडस्ट्रियल 2 ऑफ़ 5) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/isbn/" name="ISBN" description="ISBN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/ismn/" name="ISMN" description="ISMN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/issn/" name="ISSN" description="ISSN बारकोड" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/australia-post/" name="Australia Post" description="Australia Post बारकोड और Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode और Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/rm4scc/" name="RM4SCC" description="रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/postnet/" name="Postnet" description="Postnet बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/royal-mail/" name="Royal Mail" description="Royal Mail बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/singapore-post/" name="Singapore Post" description="Singapore Post बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/sharepoint/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="प्रलेखन" href="https://docs.aspose.com/barcode/sharepoint/" >}}
...
{{< blocks/products/pf/slr-element name="रिलीज नोट्स" href="https://docs.aspose.com/barcode/sharepoint/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="SharePoint के लिए Aspose.BarCode क्यों?" tabId="success-stories" >}}
