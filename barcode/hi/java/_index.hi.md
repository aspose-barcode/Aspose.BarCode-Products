---
title: जावा बारकोड एपीआई - 1डी 2डी और पोस्टल बारकोड उत्पन्न या स्कैन करें
description: पढ़ने के लिए बारकोड को पहचानने के लिए जावा बारकोड लाइब्रेरी। बारकोड एसडीके रैखिक और 2डी बारकोड का समर्थन करता है और साथ ही जेपीजी, जीआईएफ, पीएनजी, बीएमपी और अधिक छवि प्रारूपों को निर्यात करता है।
lang: hi/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="जावा बारकोड जनरेशन और रिकग्निशन एपीआई" h2="किसी भी Java एप्लिकेशन में लीनियर, 2D और पोस्टल प्रकार के बारकोड बनाएं और पहचानें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" pfName="Aspose.BarCode" subTitlepfName="Java के लिए" downloadUrl="https://releases.aspose.com/barcode/java/" >}}
...
<p>जावा के लिए Aspose.BarCode एक मजबूत और विश्वसनीय एपीआई है जो जावा अनुप्रयोगों के लिए बारकोड जनरेशन और रेकग्निशन फीचर प्रदान करता है। यह सबसे स्थापित मानकों और विनिर्देशों का समर्थन करता है और डेवलपर्स को किसी भी कोण पर विभिन्न छवि फ़ाइलों से 1डी और 2डी बारकोड पढ़ने की अनुमति देता है। Aspose.BarCode for Java अत्यधिक लचीले इमेजिंग विकल्पों के साथ विभिन्न प्रकार के छवि प्रारूपों में बारकोड छवियों को प्रस्तुत करता है। पुस्तकालय 60 से अधिक बारकोड प्रकारों को एन्कोडिंग और डिकोडिंग का समर्थन करता है और बारकोड छवियों के प्रत्यक्ष मुद्रण को सक्षम करता है।</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="एक नजर में" description="एपीआई की बारकोड पहचान और उत्पादन क्षमताओं का अवलोकन।" >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>लीनियर, 2डी और पोस्टल</li><li>स्ट्रीम या इमेज से डिटेक्ट करें</li><li>बारकोड का ओरिएंटेशन प्राप्त करें</li><li>गैर-अंग्रेज़ी वर्णों को डिकोड करें</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                मुद्रण
            </header>
            <ul><li>सीधे बारकोड प्रिंट करें</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>लीनियर, 2D और पोस्टल</li><li>स्ट्रीम या इमेज में सेव करें</li><li>अपीयरेंस कस्टमाइज़ करें&colon; आकार, रंग, कोण</li><li>गैर-अंग्रेज़ी वर्ण एन्कोड करें </li></ul>
            <header>
                <i class="fa fa-qrcode">
                </i>
                प्रकार
            </header>
            <ul><li>रैखिक</li><li>2D</li><li>पोस्टल</li></ul>
        </div>
        <!--/right-->
    </div>
    <!--/row-->
...
{{< blocks/products/pf/carousel-item h3="प्लेटफार्म स्वतंत्रता" description="आप JRE 1.6 या उच्चतर स्थापित किसी भी प्रकार के जावा एप्लिकेशन को बनाने के लिए बारकोड लाइब्रेरी का उपयोग कर सकते हैं।" >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="समर्थित फ़ाइल स्वरूप" description="Java के लिए Aspose.BarCode सबसे अधिक उपयोग किए जाने वाले छवि फ़ाइल स्वरूपों के साथ काम करता है।" >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/control-the-appearance-of-code-text/'>कोड टेक्स्ट के प्रकटन-संबंधित गुणों को समायोजित और संशोधित करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-the-barcode-caption/'>कैप्शन और फ़ॉन्ट शैली प्रबंधित करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/use-checksum-and-supplement-data-for-barcodes/'>चेकसम और पूरक डेटा के लिए समर्थन</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#image-formats'>एकाधिक छवि प्रारूपों में बारकोड छवियां उत्पन्न करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/advanced-barcode-recognition-features/'>किसी भी कोण पर 1D और 2D प्रकार पढ़ें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/barcode-regions/'>क्षेत्र निर्दिष्ट करके बारकोड स्कैन करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/generate-barcode-by-specifying-custom-image-size/'>छवियों का आकार अनुकूलित करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-x-dimension-and-y-dimension/'>2डी प्रकार के लिए एक्स और वाई-आयाम का समर्थन</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#barcode-types'>रैखिक, 2डी और डाक सहजीवन के लिए समर्थन</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    बारकोड प्रकार और रूप को अनुकूलित करें
                </h2>
                <p>
                    Java के लिए बारकोड एपीआई डेवलपर्स को बारकोड प्रकार, इनपुट टेक्स्ट, फ़ॉन्ट शैली, पृष्ठभूमि और अग्रभूमि रंग, कैप्शन संरेखण और स्थान, और अन्य गुणों को निर्दिष्ट करके जेनरेट किए गए बारकोड की उपस्थिति को ठीक करने की अनुमति देता है। आप ऊपरी और निचले कैप्शन, फ़ॉन्ट, रंग और संरेखण के लिए इसकी दृश्यता सेट करके कैप्शन को संशोधित कर सकते हैं।
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    बारकोड एपीआई डेवलपर्स को उनके अनुप्रयोगों में आसानी से उच्च-गुणवत्ता वाली बारकोड छवियां उत्पन्न करने में सक्षम बनाता है। यह QR कोड और कोड 128 जैसे व्यापक रूप से उपयोग किए जाने वाले बारकोड प्रकारों के साथ-साथ Aztec कोड और Data Matrix जैसे अधिक विशिष्ट प्रकारों सहित बारकोड प्रकारों की एक विस्तृत श्रृंखला का समर्थन करता है। एपीआई डेवलपर्स को अग्रभूमि और पृष्ठभूमि रंग, फ़ॉन्ट और कैप्शन संरेखण सहित उत्पन्न बारकोड की उपस्थिति को अनुकूलित करने की अनुमति देता है। एपीआई का उपयोग करके, डेवलपर्स उसी तरह आसानी से 2डी बारकोड उत्पन्न कर सकते हैं जैसे वे एक आयामी बारकोड उत्पन्न करते हैं।
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    पीडीएफ दस्तावेज़ों में बारकोड डालें
                </h2>
                <p>
                    बारकोड लाइब्रेरी डेवलपर्स को न केवल अनुकूलित बारकोड बनाने की अनुमति देती है बल्कि पीडीएफ दस्तावेज़ों में उत्पन्न छवियों को सीधे जोड़ने की भी अनुमति देती है। आप पहले समर्थित रास्टर स्वरूपों में से किसी एक का उपयोग करके बारकोड इमेज बना सकते हैं और फिर उन्हें एक पीडीएफ फाइल में डाल सकते हैं। एपीआई छवि संपीड़न और गुणवत्ता हानि के बिना बारकोड जोड़ने में सक्षम बनाता है। यह सम्मिलन से पहले बारकोड पैरामीटर और उपस्थिति को संशोधित करने या जेनरेट की गई छवि को एक साथ कई दस्तावेज़ पृष्ठों में जोड़ने की कार्यक्षमता भी प्रदान करता है। Aspose.BarCode API का उपयोग बारकोड छवियों की उच्च-गुणवत्ता वाली प्रिंटिंग के लिए किया जा सकता है। रेखापुंज छवियों में 96 डीपीआई का मानक रिज़ॉल्यूशन है, जो इस उद्देश्य के लिए पर्याप्त नहीं है। एपीआई उच्च गुणवत्ता वाले पीडीएफ दस्तावेजों को प्रिंट करने के लिए 300 या 600 डीपीआई के बारकोड छवि रिज़ॉल्यूशन को सेट करने की अनुमति देता है।
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
                ...
                <p>
                    जावा अनुप्रयोगों में बारकोड के साथ काम करने के लिए जावा बारकोड लाइब्रेरी एक शक्तिशाली उपकरण है। इसकी प्रमुख विशेषताओं में से एक विभिन्न छवि फ़ाइल स्वरूपों से बारकोड पढ़ने की क्षमता है। बारकोडरीडर वर्ग, जो बारकोड पहचान के लिए जिम्मेदार मुख्य वर्ग है, बीएमपी, पीएनजी, टीआईएफएफ, जेपीईजी और जीआईएफ सहित कई लोकप्रिय छवि प्रारूपों का समर्थन करता है। यह बारकोड पहचान कार्यक्षमता को अनुप्रयोगों की एक विस्तृत श्रृंखला में एकीकृत करना आसान बनाता है।
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
    ...
    <div class="barcode-read-lcs-controls">
        ...
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">सभी प्रकार के</option>
                <option value="Pdf417 ">PDF417</option>
                <option value="QR ">QR</option>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    पीडीएफ दस्तावेज़ों से बारकोड स्कैन करें
                </h2>
                <p>
                    छवि फ़ाइलों से बारकोड पढ़ने के अलावा, बारकोड लाइब्रेरी का उपयोग पीडीएफ फाइलों से बारकोड स्कैन करने के लिए किया जा सकता है। डेवलपर्स कई पृष्ठों वाले पीडीएफ दस्तावेजों में तेजी से बारकोड का पता लगाने को लागू कर सकते हैं। एपीआई इसे करने के कई तरीके प्रदान करता है। अनुशंसित तरीका दस्तावेज़ पृष्ठों को रेखापुंज छवियों में बदलना है और फिर बारकोड रीडिंग मैकेनिज्म लागू करना है। पृष्ठ सामग्री को रेखापुंज छवियों में प्रस्तुत करने के लिए सबसे आसान और सबसे कुशल दृष्टिकोण के रूप में सुझाया गया है। अन्यथा, बारकोड छवियों को पहले पता लगाया जा सकता है और स्रोत पीडीएफ दस्तावेज़ से निकाला जा सकता है। यह विधि मूल संकल्प के साथ बारकोड पढ़ने की सुविधा प्रदान करती है। Aspose.BarCode API एक दस्तावेज़ में प्रस्तुत सभी बारकोड का पता लगाने और पहचानने के लिए मल्टीपेज पीडीएफ फाइलों को संसाधित करने की अनुमति देता है।
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/pdf417/" name="PDF417" description="PDF417 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/qr/" name="QR" description="QR कोड, GS1 QR कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/datamatrix/" name="Data Matrix" description="Data Matrix कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/aztec/" name="Aztec" description="Aztec कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/swiss-qr/" name="Swiss QR" description="Swiss QR बिल" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/dotcode/" name="DotCode" description="DotCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/hibc/" name="HIBC" description="HIBC (स्वास्थ्य उद्योग बार कोड)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/codablock/" name="Codablock-F" description="Codablock-F और GS1 Codablock-F बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/databar/" name="GS1 DataBar" description="GS1 DataBar (सर्वदिशात्मक, स्टैक्ड सर्वदिशात्मक, विस्तारित, विस्तारित स्टैक्ड, और छोटा) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/itf/" name="ITF" description="इंटरलीव्ड 2-ऑफ-5 (ITF) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/ean/" name="EAN" description="EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/upc/" name="UPC" description="UPC (यूनिवर्सल प्रोडक्ट कोड) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/code128/" name="GS1 Code 128" description="GS1 Code 128 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/code39/" name="Code 39" description="Code 39 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/code16k/" name="Code 16K" description="Code 16K बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/code32/" name="Code 32" description="इतालवी फार्माकोड (Code 32) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/code93/" name="Code 93" description="Code 93 विस्तारित और Code 93 मानक बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/onecode/" name="USPS OneCode" description="USPS OneCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (इंडस्ट्रियल 2 ऑफ़ 5) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/isbn/" name="ISBN" description="ISBN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/ismn/" name="ISMN" description="ISMN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/issn/" name="ISSN" description="ISSN बारकोड" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/australia-post/" name="Australia Post" description="Australia Post बारकोड और Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode और Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/rm4scc/" name="RM4SCC" description="रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/postnet/" name="Postnet" description="Postnet बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/royal-mail/" name="Royal Mail" description="Royal Mail बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/singapore-post/" name="Singapore Post" description="Singapore Post बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="लोग क्या कह रहे हैं" subTitle="इसके लिए सिर्फ हमारा शब्द न लें। देखें कि उपयोगकर्ताओं का एपीआई के बारे में क्या कहना है।" caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 मैंने अपने उत्पाद को विकसित करने और बढ़ाने में कई साल बिताए हैं और Aspose ने मुझे अपने उत्पाद को और अधिक अनुकूल और उपयोगी बनाने की अनुमति दी है, और इसलिए अधिक बिक्री योग्य है। <em>कील डिलर | केडी सॉल्यूशंस, पोलैंड</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode वास्तव में प्रबंधित कोड में लिखा गया है और हमें सभी प्रकार की दस्तावेज़ पहचान और आगे की प्रक्रिया को संभालने के लिए विभिन्न प्रकार के बारकोड प्रदान करता है। <em>डेनिस एलेक्जेंडर पेट्रास्क | केइल आईटी, जर्मनी</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="एपीआई संदर्भ" href="https://reference.aspose.com/barcode/java/" >}}
...
{{< blocks/products/pf/slr-element name="रिलीज नोट्स" href="https://docs.aspose.com/barcode/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Java के लिए Aspose.BarCode क्यों?" tabId="success-stories" >}}
{{< blocks/products/pf/slr-element name="ग्राहकों की सूची" href="https://about.aspose.com/customers" >}}
{{< blocks/products/pf/slr-element name="सफलता की कहानियां" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}
