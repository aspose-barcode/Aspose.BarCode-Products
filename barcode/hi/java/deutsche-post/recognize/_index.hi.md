---
title: Java के द्वारा Deutsche Post Identcode और Deutsche Post Leitcode छवियों को स्कैन करें
weight: 1510
description: JSP/JSF एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए जावा रनटाइम एनवायरनमेंट में Deutsche Post Identcode और Deutsche Post Leitcode को पढ़ने और डिकोड करने के लिए जावा सोर्स कोड।
lang: hi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hi/java/deutsche-post/recognize/
aliases:
- /hi/java/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Deutsche Post बारकोड को Java के साथ पढ़ें" h2="सर्वर साइड Aspose.BarCode for Java API का उपयोग करके Java में Deutsche Post Identcode और Deutsche Post Leitcode पढ़ें" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Deutsche Post बारकोड Using Java" %}}
Deutsche Post बारकोड को पहचानने के लिए, [जावा के लिए Aspose.BarCode](https://products.aspose.com/barcode/java/) API का इस्तेमाल करें, जो जावा के लिए एक एडवांस, मजबूत और इस्तेमाल में आसान बारकोड लाइब्रेरी है- आधारित प्लेटफॉर्म। [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-barcode) से सीधे नवीनतम संस्करण डाउनलोड करें और इसे अपने मावेन-आधारित में स्थापित करें pom.xml में निम्नलिखित कॉन्फ़िगरेशन को शामिल करके प्रोजेक्ट करें:
...
<ul><li>BarCodeReader वर्ग का एक नया ऑब्जेक्ट बनाएं</li><li>स्रोत फ़ाइल पथ सेट करें जिसमें {{BARCODE_FULL_NAME} शामिल हो</li><li>दूसरा पैरामीटर के रूप में आवश्यक बारकोड प्रकार को DecodeType में पास करें</li><li>डिकोडिंग परिणामों के माध्यम से लूप करें</li><li>getCodeText विधि का उपयोग करके बारकोड टेक्स्ट प्राप्त करें</li></ul>
...
<ul><li>JSP/JSF और डेस्कटॉप एप्लिकेशन के लिए Microsoft Windows, Linux, या Java रनटाइम एनवायरनमेंट के साथ संगत कोई भी OS</li><li>Java डेवलपमेंट एनवायरनमेंट, जैसे JRE 1.6 या ऊपर</li><li> जावा विकास संस्करण JSE2 7.0 या ऊपर</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/pdf417/recognize/" name="PDF417" description="PDF417 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/qr/recognize/" name="QR" description="QR कोड, GS1 QR कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/aztec/recognize/" name="Aztec" description="Aztec कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR बिल" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/dotcode/recognize/" name="DotCode" description="DotCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/hibc/recognize/" name="HIBC" description="HIBC (स्वास्थ्य उद्योग बार कोड)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/codablock/recognize/" name="Codablock-F" description="Codablock-F और GS1 Codablock-F बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (सर्वदिशात्मक, स्टैक्ड सर्वदिशात्मक, विस्तारित, विस्तारित स्टैक्ड, और छोटा) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/itf/recognize/" name="ITF" description="इंटरलीव्ड 2-ऑफ-5 (ITF) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/ean/recognize/" name="EAN" description="EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/upc/recognize/" name="UPC" description="UPC (यूनिवर्सल प्रोडक्ट कोड) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/code39/recognize/" name="Code 39" description="Code 39 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/code16k/recognize/" name="Code 16K" description="Code 16K बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/code32/recognize/" name="Code 32" description="इतालवी फार्माकोड (Code 32) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/code93/recognize/" name="Code 93" description="Code 93 विस्तारित और Code 93 मानक बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (इंडस्ट्रियल 2 ऑफ़ 5) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/isbn/recognize/" name="ISBN" description="ISBN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/ismn/recognize/" name="ISMN" description="ISMN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/issn/recognize/" name="ISSN" description="ISSN बारकोड" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/australia-post/recognize/" name="Australia Post" description="Australia Post बारकोड और Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode और Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/rm4scc/recognize/" name="RM4SCC" description="रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/postnet/recognize/" name="Postnet" description="Postnet बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/royal-mail/recognize/" name="Royal Mail" description="Royal Mail बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/singapore-post/recognize/" name="Singapore Post" description="Singapore Post बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
