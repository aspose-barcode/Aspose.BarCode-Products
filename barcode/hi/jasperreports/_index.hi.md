---
title: JasperReports में बारकोड जेनरेट करें और BMP JPG GIF और PNG में रेंडर करें
description: JasperReports के लिए Aspose.BarCode का उपयोग करते हुए, डेवलपर्स आगे BMP JPG GIF और PNG स्वरूपों में प्रदान किए जाने के लिए Jasper रिपोर्ट्स में बारकोड उत्पन्न कर सकते हैं।
lang: hi/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="JasperReports में बारकोड जनरेट करें और निर्यात करें" h2="JasperReports और JasperServer API 1D, 2D, और पोस्टल बारकोड उत्पन्न करने, प्रदर्शित करने और निर्यात करने के लिए।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="JasperReports के लिए" downloadUrl="https://releases.aspose.com/barcode/jasperreports/" >}}
...
<p>Aspose.BarCode for JasperReports आपके अनुप्रयोगों में बारकोड लेबल बनाने और प्रदर्शित करने के लिए एक लचीला JasperReports और JasperServer एक्सटेंशन है। ये बारकोड लेबल कई लोकप्रिय छवि प्रारूपों में प्रस्तुत किए जा सकते हैं।</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="प्लेटफार्म स्वतंत्रता" description="JasperReports के लिए Aspose.BarCode का उपयोग JasperServer और JasperReports के साथ किया जा सकता है।" >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
        ...
        <div class="d1-col d1-right">
            <header>
                ...
                जैस्पर रिपोर्ट्स 2.0 या उच्चतर
            </header>
            ...
            <header>
                ...
                जैस्पर रिपोर्ट्स 3.0 या उच्चतर
            </header>
...
{{< blocks/products/pf/carousel-item h3="समर्थित फ़ाइल स्वरूप" description="JasperReports के लिए Aspose.BarCode सबसे अधिक उपयोग किए जाने वाले छवि फ़ाइल स्वरूपों के साथ काम करता है।" >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                उन्नत JasperReports बारकोड निर्यात सुविधाओं के लिए
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>बारकोड के साथ रिपोर्ट तैयार करें और प्रिंट करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>बारकोड कार्यक्षमता जोड़कर एप्लिकेशन वर्कफ़्लो बढ़ाएँ</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>ट्रेसबिलिटी में सहायता के लिए फाइलों में बारकोड एम्बेड करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/barcode-image-basic-features/'>नियंत्रण कोड का आकार, रंग और कोड टेक्स्ट</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/read-barcodes-with-aspose-barcode-apis/'>एक 3D-विकृत और घुमाए गए 2D-बारकोड की पहचान</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/generate-barcode-by-specifying-custom-image-size/'>विशिष्ट आकार की बारकोड छवियां बनाएं</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    JasperReports के लिए Aspose.BarCode JasperReports में बारकोड के साथ काम करने के लिए उपकरणों का एक विशेष सेट प्रदान करता है। इस API का उपयोग करके, डेवलपर मौजूदा रिपोर्ट में रखे गए बारकोड को स्कैन कर सकते हैं या उन्हें नई रिपोर्ट में जोड़ सकते हैं। यह बारकोड लाइब्रेरी विशुद्ध रूप से जावा में कोडित है और इसे एक एकल JAR दस्तावेज़ के रूप में प्रदान किया गया है और इसे आसानी से JasperReports या JasperServer स्थापित मशीनों पर तैनात किया जा सकता है। JasperReports बारकोड एक्सटेंशन को स्थापित करने के लिए, बस JAR दस्तावेज़ को सही फ़ोल्डर स्थान पर कॉपी करें और काम करना शुरू करें।
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    बारकोड जनरेटर लाइब्रेरी डेवलपर्स को बारकोड के प्रकार को निर्दिष्ट करके, एन्कोड करने के लिए डेटा दर्ज करके और कस्टम उपस्थिति-संबंधित गुणों को सेट करके आसानी से बारकोड बनाने की अनुमति देती है। इसमें विभिन्न विकल्प शामिल हैं, जैसे पृष्ठभूमि और अग्रभूमि का रंग, फ़ॉन्ट, आकार, रिज़ॉल्यूशन और टेक्स्ट कैप्शन। एपीआई पीडीएफ 417, Data Matrix, Aztec कोड, क्यूआर कोड और माइक्रो क्यूआर कोड सहित 1डी और 2डी बारकोड दोनों को समान आधार दृष्टिकोण का उपयोग करके उत्पन्न कर सकता है। यह JasperReports सहित विभिन्न अनुप्रयोगों के लिए बारकोड प्रकारों की एक विस्तृत श्रृंखला उत्पन्न करने के लिए एक सुविधाजनक और उपयोगकर्ता के अनुकूल उपकरण बनाता है।
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    JasperReports में बारकोड डालें
                </h2>
                <p>
                    JasperReports डेवलपर्स को डेटाबेस, CSV फ़ाइलों और XML दस्तावेज़ों जैसे विभिन्न स्रोतों में संग्रहीत डेटा का उपयोग करके रिपोर्ट बनाने की अनुमति देता है। यह रिपोर्ट को डिज़ाइन करने, स्वरूपित करने और निर्यात करने के लिए कई प्रकार की सुविधाएँ प्रदान करता है, जिन्हें जावा अनुप्रयोगों में आसानी से एकीकृत किया जा सकता है। JasperReports के कुछ सामान्य उपयोगों में चालान, रसीदें, वित्तीय विवरण और अन्य प्रकार की व्यावसायिक रिपोर्ट बनाना शामिल है। रिपोर्ट में जानकारी तक पहुँचने और प्रबंधित करने की सुविधा के लिए JasperReports में बारकोड सम्मिलित करना उपयोगी हो सकता है। उदाहरण के लिए, बारकोड का उपयोग JasperReport में जानकारी को जल्दी और सटीक रूप से स्कैन और अपडेट करने के लिए किया जा सकता है, अर्थात् संबंधित डेटा को पुनः प्राप्त करने और प्रदर्शित करने के लिए इनवॉइस पर बारकोड स्कैन करके। इससे जानकारी को ट्रैक करना और प्रबंधित करना और त्रुटियों या विसंगतियों के जोखिम को कम करना आसान हो सकता है। बारकोड रिपोर्ट में विशिष्ट आइटम या रिकॉर्ड प्रदर्शित करने के लिए भी काम कर सकता है।
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/pdf417/" name="PDF417" description="PDF417 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/qr/" name="QR" description="QR कोड, GS1 QR कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/datamatrix/" name="Data Matrix" description="Data Matrix कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/aztec/" name="Aztec" description="Aztec कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/swiss-qr/" name="Swiss QR" description="Swiss QR बिल" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/dotcode/" name="DotCode" description="DotCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/hibc/" name="HIBC" description="HIBC (स्वास्थ्य उद्योग बार कोड)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/codablock/" name="Codablock-F" description="Codablock-F और GS1 Codablock-F बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/databar/" name="GS1 DataBar" description="GS1 DataBar (सर्वदिशात्मक, स्टैक्ड सर्वदिशात्मक, विस्तारित, विस्तारित स्टैक्ड, और छोटा) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/itf/" name="ITF" description="इंटरलीव्ड 2-ऑफ-5 (ITF) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/ean/" name="EAN" description="EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/upc/" name="UPC" description="UPC (यूनिवर्सल प्रोडक्ट कोड) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/code128/" name="GS1 Code 128" description="GS1 Code 128 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/code39/" name="Code 39" description="Code 39 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/code16k/" name="Code 16K" description="Code 16K बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/code32/" name="Code 32" description="इतालवी फार्माकोड (Code 32) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/code93/" name="Code 93" description="Code 93 विस्तारित और Code 93 मानक बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/onecode/" name="USPS OneCode" description="USPS OneCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (इंडस्ट्रियल 2 ऑफ़ 5) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/isbn/" name="ISBN" description="ISBN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/ismn/" name="ISMN" description="ISMN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/issn/" name="ISSN" description="ISSN बारकोड" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/australia-post/" name="Australia Post" description="Australia Post बारकोड और Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode और Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/rm4scc/" name="RM4SCC" description="रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/postnet/" name="Postnet" description="Postnet बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/royal-mail/" name="Royal Mail" description="Royal Mail बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/singapore-post/" name="Singapore Post" description="Singapore Post बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/jasperreports/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="रिलीज नोट्स" href="https://docs.aspose.com/barcode/jasperreports/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="JasperReports के लिए Aspose.BarCode क्यों?" tabId="success-stories" >}}
