---
title: Android via Java के द्वारा Deutsche Post Identcode और Deutsche Post Leitcode छवियों को स्कैन करें
weight: 1510
description: Android रनटाइम वातावरण में Deutsche Post Identcode और Deutsche Post Leitcode को पहचानने के लिए Android नमूना कोड।
lang: hi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hi/android-java/deutsche-post/recognize/
aliases:
- /hi/android-java/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Deutsche Post बारकोड को Android via Java के साथ पढ़ें" h2="सर्वर साइड Aspose.BarCode for Android via Java API का उपयोग करके Java में Deutsche Post Identcode और Deutsche Post Leitcode पढ़ें" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Deutsche Post बारकोड Using Android via Java" %}}
Android ऐप्लिकेशन में आसानी से Deutsche Post बारकोड का पता लगाने और पढ़ने के लिए जावा के माध्यम से Android के लिए Aspose.BarCode आज़माएं। यह Android अनुप्रयोगों के लिए एक समृद्ध, स्केलेबल और उपयोगकर्ता के अनुकूल बारकोड एपीआई है। बिल्ड.ग्रेडल में निम्नलिखित कॉन्फ़िगरेशन जोड़कर सीधे मेवेन-आधारित प्रोजेक्ट से जावा के लिए Aspose.BarCode प्राप्त करें:
...
{{% blocks/products/pf/agp/feature-section-col title="Java में Deutsche Post बारकोड को स्कैन करने के चरण" %}}
...
<ul><li>BarCodeReader वर्ग का एक उदाहरण बनाएं</li><li> {{BARCODE_FULL_NAME} से युक्त स्रोत छवि पथ निर्धारित करें</li><li>दूसरे पैरामीटर के रूप में DecodeType में लक्ष्य बारकोड प्रकार परिभाषित करें</li><li>पहचान परिणामों के माध्यम से लूप करें</li><li>getCodeText विधि को चलाने वाले डिकोड किए गए टेक्स्ट को लोड करें</li></ul>
...
<ul><li>Microsoft Windows, Linux, या Android रनटाइम एनवायरनमेंट के साथ संगत कोई भी OS</li><li>Android SDK v.30</li><li>Android OS 2.0 या बाद के संस्करण चलाने वाले Android सिस्टम</li> </ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/pdf417/recognize/" name="PDF417" description="PDF417 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/qr/recognize/" name="QR" description="QR कोड, GS1 QR कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/aztec/recognize/" name="Aztec" description="Aztec कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR बिल" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/dotcode/recognize/" name="DotCode" description="DotCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/hibc/recognize/" name="HIBC" description="HIBC (स्वास्थ्य उद्योग बार कोड)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/codablock/recognize/" name="Codablock-F" description="Codablock-F और GS1 Codablock-F बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (सर्वदिशात्मक, स्टैक्ड सर्वदिशात्मक, विस्तारित, विस्तारित स्टैक्ड, और छोटा) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/itf/recognize/" name="ITF" description="इंटरलीव्ड 2-ऑफ-5 (ITF) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/ean/recognize/" name="EAN" description="EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/upc/recognize/" name="UPC" description="UPC (यूनिवर्सल प्रोडक्ट कोड) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/code39/recognize/" name="Code 39" description="Code 39 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/code16k/recognize/" name="Code 16K" description="Code 16K बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/code32/recognize/" name="Code 32" description="इतालवी फार्माकोड (Code 32) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/code93/recognize/" name="Code 93" description="Code 93 विस्तारित और Code 93 मानक बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (इंडस्ट्रियल 2 ऑफ़ 5) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/isbn/recognize/" name="ISBN" description="ISBN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/ismn/recognize/" name="ISMN" description="ISMN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/issn/recognize/" name="ISSN" description="ISSN बारकोड" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/australia-post/recognize/" name="Australia Post" description="Australia Post बारकोड और Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode और Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/rm4scc/recognize/" name="RM4SCC" description="रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/postnet/recognize/" name="Postnet" description="Postnet बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/royal-mail/recognize/" name="Royal Mail" description="Royal Mail बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/singapore-post/recognize/" name="Singapore Post" description="Singapore Post बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
