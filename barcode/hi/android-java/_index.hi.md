---
title: बारकोड एंड्रॉइड एपीआई | स्कैन या बारकोड उत्पन्न करें
description: एंड्रॉइड बारकोड स्कैनर लाइब्रेरी विभिन्न प्रकार के 1D, 2D और पोस्टल बारकोड को पहचानने के लिए। Android ऐप्स में किसी भी कोण पर बारकोड स्कैन करें।
lang: hi/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="बारकोड जनरेशन और रिकग्निशन के लिए एंड्रॉइड एपीआई" h2="किसी भी Android मोबाइल ऐप में इमेज से 1D, 2D और पोस्टल बारकोड बनाएं या पढ़ें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" pfName="Aspose.BarCode" subTitlepfName="Android via Java के लिए" downloadUrl="https://releases.aspose.com/barcode/androidjava/" >}}
...
<p>Aspose.BarCode for Android via Java Android एप्लिकेशन के लिए एक बारकोड जेनरेशन और रीडिंग API है। यह विभिन्न कोणों पर छवियों से 1D, 2D और पोस्टल बारकोड को स्कैन करने का समर्थन करता है। बारकोड जनरेटर एपीआई आसानी से बारकोड छवियां बना सकता है और उन्हें विभिन्न स्वरूपों में सहेज सकता है। यह समृद्ध इमेजिंग कार्यक्षमता भी प्रदान करता है, जैसे कि बारकोड सीमाओं को अनुकूलित करना, रंग, घूर्णन कोण, रिज़ॉल्यूशन, और बहुत कुछ।</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="प्लेटफार्म स्वतंत्रता" description="किसी भी प्लेटफ़ॉर्म पर API का उपयोग करें जहाँ Android रनटाइम एनवायरनमेंट उपलब्ध है।" >}}
<div class='diagram1 d1-android'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="समर्थित फ़ाइल स्वरूप" description="Android via Java के लिए Aspose.BarCode सबसे अधिक उपयोग किए जाने वाले छवि फ़ाइल स्वरूपों के साथ काम करता है।" >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/qr-code-generation/'>क्यूआर कोड में गैर-अंग्रेज़ी वर्णों को एनकोड करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-color-modification/'>बारकोड रंग योजना संशोधित करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-appearance-customization/'>किसी भी कोण पर बारकोड छवियों को घुमाएँ</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/working-with-barcode-types/'>60+ प्रकार के बारकोड बनाएं और पहचानें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/recognition-settings/'>छवियों से बारकोड पढ़ें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-image-saving/'>विभिन्न छवि प्रारूपों में बारकोड निर्यात करें</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    Android via Java के लिए बारकोड लाइब्रेरी डेवलपर्स को बारकोड के प्रकार, एन्कोड किए जाने वाले डेटा, बारकोड आकार, फ़ॉन्ट शैली और रंग, और ओरिएंटेशन कोण सहित कुछ सामान्य बारकोड पैरामीटर को अनुकूलित करने की अनुमति देती है। बारकोड उत्पन्न करने के लिए, आपको बनाने के लिए आवश्यक प्रकार के बारकोड का चयन करना होगा, जैसे, उदाहरण के लिए, यूपीसी या ईएएन। आपको बारकोड में संग्रहीत किए जाने वाले डेटा, जैसे उत्पाद संख्या या URL, को भी दर्ज करना होगा। इसके अलावा, आप आवश्यक आकार मोड सेट कर सकते हैं और बारकोड तत्वों के रंग, रिज़ॉल्यूशन, बॉर्डर शैली और अन्य उपस्थिति-संबंधी मापदंडों को समायोजित कर सकते हैं। बार की चौड़ाई और उनके बीच की दूरी को संशोधित करना संभव है। ये अतिरिक्त पैरामीटर बारकोड की पठनीयता और गुणवत्ता को प्रभावित कर सकते हैं, इसलिए यह समझना महत्वपूर्ण है कि उनका उद्देश्य क्या है और उन्हें सही तरीके से कैसे समायोजित किया जाए।
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    बारकोड जनरेटर एपीआई आवश्यक प्रकार निर्दिष्ट करके, इनपुट टेक्स्ट सेट करके (बारकोड में एन्कोड किया जाने वाला डेटा), और पृष्ठभूमि और अग्रभूमि रंग, फ़ॉन्ट और टेक्स्ट कैप्शन जैसे उपस्थिति-संबंधित गुणों को अनुकूलित करके बारकोड बना सकता है। द्वि-आयामी बारकोड, जैसे कि PDF417, Data Matrix, Aztec कोड, QR कोड और माइक्रो QR कोड उसी तरह उत्पन्न किए जा सकते हैं जैसे 1D प्रकार।
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    बारकोड एपीआई 60 से अधिक लोकप्रिय 1डी और 2डी प्रकारों के बारकोड का पता लगाने और पढ़ने में सक्षम बनाता है। बारकोड को स्कैन करने के लिए केवल कुछ पंक्तियों के कोड की आवश्यकता होती है, जिससे इस कार्यक्षमता को आपके अनुप्रयोगों में एकीकृत करना आसान हो जाता है। यह शक्तिशाली विशेषता आपको छवियों, दस्तावेज़ों आदि जैसे स्रोतों की एक विस्तृत श्रृंखला से बारकोड को स्कैन करने और पढ़ने की अनुमति देती है। इसका उपयोग प्रक्रियाओं को स्वचालित करने, त्रुटियों के जोखिम को कम करने और संचालन की समग्र दक्षता में सुधार करने के लिए किया जा सकता है। चाहे आपको रिटेल, लॉजिस्टिक्स, हेल्थकेयर या किसी अन्य क्षेत्र के लिए एप्लिकेशन विकसित करने की आवश्यकता हो, यह बारकोड एपीआई बारकोड का पता लगाने और पढ़ने के कार्यों के लिए एक समाधान प्रदान कर सकता है।
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/pdf417/" name="PDF417" description="PDF417 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/qr/" name="QR" description="QR कोड, GS1 QR कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/datamatrix/" name="Data Matrix" description="Data Matrix कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/aztec/" name="Aztec" description="Aztec कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/swiss-qr/" name="Swiss QR" description="Swiss QR बिल" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/dotcode/" name="DotCode" description="DotCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/hibc/" name="HIBC" description="HIBC (स्वास्थ्य उद्योग बार कोड)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/codablock/" name="Codablock-F" description="Codablock-F और GS1 Codablock-F बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/databar/" name="GS1 DataBar" description="GS1 DataBar (सर्वदिशात्मक, स्टैक्ड सर्वदिशात्मक, विस्तारित, विस्तारित स्टैक्ड, और छोटा) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/itf/" name="ITF" description="इंटरलीव्ड 2-ऑफ-5 (ITF) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/ean/" name="EAN" description="EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/upc/" name="UPC" description="UPC (यूनिवर्सल प्रोडक्ट कोड) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/code128/" name="GS1 Code 128" description="GS1 Code 128 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/code39/" name="Code 39" description="Code 39 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/code16k/" name="Code 16K" description="Code 16K बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/code32/" name="Code 32" description="इतालवी फार्माकोड (Code 32) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/code93/" name="Code 93" description="Code 93 विस्तारित और Code 93 मानक बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/onecode/" name="USPS OneCode" description="USPS OneCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (इंडस्ट्रियल 2 ऑफ़ 5) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/isbn/" name="ISBN" description="ISBN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/ismn/" name="ISMN" description="ISMN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/issn/" name="ISSN" description="ISSN बारकोड" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/australia-post/" name="Australia Post" description="Australia Post बारकोड और Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode और Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/rm4scc/" name="RM4SCC" description="रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/postnet/" name="Postnet" description="Postnet बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/royal-mail/" name="Royal Mail" description="Royal Mail बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/singapore-post/" name="Singapore Post" description="Singapore Post बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/android-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="सोर्स कोड" href="https://github.com/aspose-barcode/Android-Library-Usage-Examples" >}}
{{< blocks/products/pf/slr-element name="एपीआई संदर्भ" href="https://reference.aspose.com/barcode/androidjava/" >}}
...
{{< blocks/products/pf/slr-element name="रिलीज नोट्स" href="https://docs.aspose.com/barcode/java/android-via-java-release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Android via Java के लिए Aspose.BarCode क्यों?" tabId="success-stories" >}}
