---
title: पायथन बारकोड जेनरेटर और स्कैनर एपीआई
description: 1D, 2D और पोस्टल सहित कई प्रकार के बारकोड को पहचानने और उत्पन्न करने के लिए पायथन बारकोड रीडर लाइब्रेरी। पायथन अनुप्रयोगों में एपीआई का प्रयोग करें।
lang: hi/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="पायथन बारकोड लाइब्रेरी" h2="किसी भी पायथन एप्लिकेशन में 1D, 2D और पोस्टल बारकोड को पहचानें या उत्पन्न करें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-net.svg" pfName="Aspose.BarCode" subTitlepfName="Python via .NET के लिए" downloadUrl="https://releases.aspose.com/barcode/python-net" >}}
...
<p>नेट के माध्यम से पायथन के लिए Aspose.BarCode बारकोड जनरेशन और रीडिंग APIs का एक सेट है जिसे Python अनुप्रयोगों में एकीकृत किया जाना है। डेवलपर आसानी से बारकोड जनरेशन और रिकग्निशन फंक्शनैलिटी जोड़ सकते हैं। पायथन बारकोड एपीआई पीएनजी, जेपीजी, जीआईएफ, बीएमपी जैसे विभिन्न स्वरूपों में बारकोड छवियां बनाता है। इसके अलावा, यह कई इमेजिंग सुविधाओं का समर्थन करता है जैसे सीमाओं में हेरफेर करना, रंग, छवियों को घुमाना, रिज़ॉल्यूशन को अनुकूलित करना और बहुत कुछ।</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="प्लेटफार्म स्वतंत्रता" description="नेट के माध्यम से पायथन के लिए Aspose.Barcode Python 3.6 और उच्चतर के लिए उपलब्ध है।" >}}
<div class='diagram1 d1-python'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="समर्थित फ़ाइल स्वरूप" description="Python via .NET के लिए Aspose.BarCode सबसे अधिक उपयोग किए जाने वाले छवि फ़ाइल स्वरूपों के साथ काम करता है।" >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                उन्नत पायथन .NET बारकोड एपीआई सुविधाओं के माध्यम से
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/swiss-qr-code/'>स्विस क्यूआर कोड</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/manage-barcode-appearance/'>बारकोड उपस्थिति को अनुकूलित करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/barcode-text-settings/'>बारकोड पाठ सेटिंग प्रबंधित करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/generate-1d-barcodes/'>1D बारकोड प्रकार के विशेष पैरामीटर</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/generate-qr-code/'>क्यूआर कोड और माइक्रो क्यूआर कोड जेनरेट करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/barcode-reading-presets/'>बारकोड पठन गुणवत्ता विकल्प और प्रीसेट</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    बारकोड पैरामीटर को अनुकूलित करें
                </h2>
                <p>
                    .NET के माध्यम से पायथन के लिए Aspose.BarCode अनुकूलित बारकोड छवियां बनाने के लिए समृद्ध कार्यक्षमता प्रदान करता है। यह व्यावसायिक आवश्यकताओं के आधार पर किसी भी रंग या आकार के बारकोड उत्पन्न करने में सक्षम बनाता है। सभी बारकोड तत्वों की उपस्थिति को अनुकूलित करना संभव है, जिसमें बार के रंग, पृष्ठभूमि, बॉर्डर और टेक्स्ट कैप्शन शामिल हैं, साथ ही साथ उनकी स्थिति भी। बारकोड को इनपुट टेक्स्ट, ऊपरी और/या निचले कैप्शन, पैडिंग और बॉर्डर के साथ या प्रदर्शित किए बिना उत्पन्न किया जा सकता है। एक्स-आयाम या मैन्युअल रूप से निर्भर करते हुए बारकोड आकार स्वचालित रूप से सेट किया जा सकता है। इसे विभिन्न इकाइयों में परिभाषित किया जा सकता है, जैसे मिलीमीटर, इंच, अंक या पिक्सेल। यदि आवश्यक हो, छवि अनुपात और संकल्प समायोजित किया जा सकता है। पाठ फ़ॉन्ट को भी अनुकूलित किया जा सकता है।
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
            <div class="col-lg-12">
                ...
                <p>
                    एपीआई में सबसे लोकप्रिय प्रकार के 2डी बारकोड उत्पन्न करने की क्षमता है, जैसे Data Matrix, Aztec कोड, PDF417, आदि। ये प्रकार बड़े या गैर-मानक इनपुट मानों को एनकोड करने की अनुमति देते हैं। यहाँ क्यूआर कोड जनरेशन के लिए कोड है।
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    बारकोड पढ़ने की गति या गुणवत्ता को अनुकूलित करें
                </h2>
                <p>
                    बारकोड लाइब्रेरी आपके व्यवसाय की विशिष्ट आवश्यकताओं को पूरा करने के लिए बारकोड रीडिंग को अनुकूलित करने के लिए शक्तिशाली सुविधाओं की एक श्रृंखला प्रदान करती है। डेवलपर्स तेजी से बारकोड स्कैनिंग को सक्षम करने या पढ़ने की सटीकता में सुधार करने के लिए मान्यता इंजन के मापदंडों को समायोजित कर सकते हैं। स्रोत बारकोड छवियों की गुणवत्ता और मापदंडों के आधार पर, पुस्तकालय मान्यता प्रक्रिया को अनुकूलित करने की अनुमति देता है। इसमें ऐसे मापदंडों के कई प्रीसेट कॉन्फ़िगरेशन शामिल हैं, जिनका उपयोग उच्च-गुणवत्ता वाली बारकोड छवियों को जल्दी से स्कैन करने या क्षतिग्रस्त या खराब बारकोड को डिकोड करने की सुविधा के लिए किया जा सकता है। इसके अतिरिक्त, विशेष सेटिंग्स हैं जो विभिन्न प्रकार की विकृतियों, जैसे गॉसियन शोर, सफेद धब्बे और उल्टे रंगों के लिए बारकोड रीडिंग में सुधार कर सकती हैं। मान्यता प्रक्रिया को ठीक करने की क्षमता के साथ, एपीआई को अनुप्रयोगों और परिदृश्यों की एक विस्तृत श्रृंखला के लिए सबसे कुशल बारकोड रीडिंग प्रदान करने के लिए तैयार किया जा सकता है।
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/pdf417/" name="PDF417" description="PDF417 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/qr/" name="QR" description="QR कोड, GS1 QR कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/datamatrix/" name="Data Matrix" description="Data Matrix कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/aztec/" name="Aztec" description="Aztec कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/swiss-qr/" name="Swiss QR" description="Swiss QR बिल" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/dotcode/" name="DotCode" description="DotCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/hibc/" name="HIBC" description="HIBC (स्वास्थ्य उद्योग बार कोड)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/codablock/" name="Codablock-F" description="Codablock-F और GS1 Codablock-F बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/databar/" name="GS1 DataBar" description="GS1 DataBar (सर्वदिशात्मक, स्टैक्ड सर्वदिशात्मक, विस्तारित, विस्तारित स्टैक्ड, और छोटा) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/itf/" name="ITF" description="इंटरलीव्ड 2-ऑफ-5 (ITF) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/ean/" name="EAN" description="EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/upc/" name="UPC" description="UPC (यूनिवर्सल प्रोडक्ट कोड) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/code128/" name="GS1 Code 128" description="GS1 Code 128 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/code39/" name="Code 39" description="Code 39 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/code16k/" name="Code 16K" description="Code 16K बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/code32/" name="Code 32" description="इतालवी फार्माकोड (Code 32) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/code93/" name="Code 93" description="Code 93 विस्तारित और Code 93 मानक बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/onecode/" name="USPS OneCode" description="USPS OneCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (इंडस्ट्रियल 2 ऑफ़ 5) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/isbn/" name="ISBN" description="ISBN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/ismn/" name="ISMN" description="ISMN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/issn/" name="ISSN" description="ISSN बारकोड" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/australia-post/" name="Australia Post" description="Australia Post बारकोड और Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode और Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/rm4scc/" name="RM4SCC" description="रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/postnet/" name="Postnet" description="Postnet बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/royal-mail/" name="Royal Mail" description="Royal Mail बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/singapore-post/" name="Singapore Post" description="Singapore Post बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="प्रलेखन" href="https://docs.aspose.com/barcode/python-net/" >}}
{{< blocks/products/pf/slr-element name="सोर्स कोड" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Python-via-.NET" >}}
{{< blocks/products/pf/slr-element name="एपीआई संदर्भ" href="https://docs.aspose.com/barcode/python-net/api-reference/" >}}
...
{{< blocks/products/pf/slr-element name="रिलीज नोट्स" href="https://docs.aspose.com/barcode/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Python via .NET के लिए Aspose.BarCode क्यों?" tabId="success-stories" >}}
