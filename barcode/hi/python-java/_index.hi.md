...
description: 1D, 2D और पोस्टल प्रकार सहित कई प्रकार के बारकोड को पहचानने और उत्पन्न करने के लिए पायथन बारकोड रीडर लाइब्रेरी। पायथन अनुप्रयोगों में एपीआई का प्रयोग करें।
lang: hi/
langdirlevel: 2
...
<p>Aspose.BarCode for Python via Java बारकोड जेनरेशन और रीडिंग एपीआई का एक सेट है जिसे पाइथन-जावा ब्रिज का उपयोग करके पायथन अनुप्रयोगों में एकीकृत किया जाना है। डेवलपर आसानी से बारकोड जनरेशन और रिकग्निशन फंक्शनैलिटी जोड़ सकते हैं। पायथन पर आधारित यह बारकोड एपीआई बारकोड छवियां बनाता है और उन्हें पीएनजी, जेपीजी, जीआईएफ, बीएमपी और टीआईएफएफ जैसे विभिन्न स्वरूपों में सहेजता है। यह विभिन्न इमेजिंग सुविधाओं का समर्थन करता है जैसे सीमाओं को अनुकूलित करना, रंग योजना, घूर्णन कोण, रिज़ॉल्यूशन और बहुत कुछ।</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="प्लेटफार्म स्वतंत्रता" description="Aspose.Barcode for Python via Java, python-java ब्रिज का उपयोग करता है और Python 3.6 और उच्चतर के लिए उपलब्ध है।" >}}
<div class='diagram1 d1-python'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="समर्थित फ़ाइल स्वरूप" description="Python via Java के लिए Aspose.BarCode सबसे अधिक उपयोग किए जाने वाले छवि फ़ाइल स्वरूपों के साथ काम करता है।" >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/set-barcode-parameters/'>बारकोड पैरामीटर प्रबंधित करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/manage-barcode-appearance/'>बारकोड आकार को अनुकूलित करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/generate-qr-code/'>क्यूआर कोड उत्पन्न करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/barcode-text-settings/'>टेक्स्ट कैप्शन को अनुकूलित करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/save-generated-barcodes/'>विभिन्न स्वरूपों में बारकोड सहेजें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/read-barcode-properties/'>बारकोड गुण पढ़ें</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/pdf417/" name="PDF417" description="PDF417 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/qr/" name="QR" description="QR कोड, GS1 QR कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/datamatrix/" name="Data Matrix" description="Data Matrix कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/aztec/" name="Aztec" description="Aztec कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/swiss-qr/" name="Swiss QR" description="Swiss QR बिल" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/dotcode/" name="DotCode" description="DotCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/hibc/" name="HIBC" description="HIBC (स्वास्थ्य उद्योग बार कोड)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/codablock/" name="Codablock-F" description="Codablock-F और GS1 Codablock-F बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/databar/" name="GS1 DataBar" description="GS1 DataBar (सर्वदिशात्मक, स्टैक्ड सर्वदिशात्मक, विस्तारित, विस्तारित स्टैक्ड, और छोटा) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/itf/" name="ITF" description="इंटरलीव्ड 2-ऑफ-5 (ITF) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/ean/" name="EAN" description="EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/upc/" name="UPC" description="UPC (यूनिवर्सल प्रोडक्ट कोड) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/code128/" name="GS1 Code 128" description="GS1 Code 128 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/code39/" name="Code 39" description="Code 39 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/code16k/" name="Code 16K" description="Code 16K बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/code32/" name="Code 32" description="इतालवी फार्माकोड (Code 32) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/code93/" name="Code 93" description="Code 93 विस्तारित और Code 93 मानक बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/onecode/" name="USPS OneCode" description="USPS OneCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (इंडस्ट्रियल 2 ऑफ़ 5) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/isbn/" name="ISBN" description="ISBN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/ismn/" name="ISMN" description="ISMN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/issn/" name="ISSN" description="ISSN बारकोड" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/australia-post/" name="Australia Post" description="Australia Post बारकोड और Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode और Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/rm4scc/" name="RM4SCC" description="रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/postnet/" name="Postnet" description="Postnet बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/royal-mail/" name="Royal Mail" description="Royal Mail बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/singapore-post/" name="Singapore Post" description="Singapore Post बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/python-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="प्रलेखन" href="https://docs.aspose.com/barcode/python-java/" >}}
{{< blocks/products/pf/slr-element name="सोर्स कोड" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Python-via-Java" >}}
{{< blocks/products/pf/slr-element name="एपीआई संदर्भ" href="https://reference.aspose.com/barcode/python-java/" >}}
...
{{< blocks/products/pf/slr-element name="रिलीज नोट्स" href="https://docs.aspose.com/barcode/python-java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Python via Java के लिए Aspose.BarCode क्यों?" tabId="success-stories" >}}
