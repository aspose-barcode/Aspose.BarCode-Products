---
title: PHP via Java के द्वारा रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC) छवियां उत्पन्न करें
description: PHP-आधारित अनुप्रयोगों में रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC) बनाने के लिए PHP स्रोत कोड।
lang: hi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hi/php-java/rm4scc/generate/
aliases:
- /hi/php-java/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="RM4SCC लेबल PHP via Java के साथ जनरेट करें" h2="PHP via Java API के लिए सर्वर-साइड Aspose.BarCode का उपयोग करके PHP में रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC) बनाएं।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="PHP में रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC) जनरेट करने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode डेवलपर्स के लिए कोड की कुछ पंक्तियों के साथ रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC) छवियां बनाना आसान बनाता है।

{{% /blocks/products/pf/agp/text %}}

<ul><li>BarCodeGenerator वर्ग का एक नया उदाहरण बनाएं</li><li> रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC) और अन्य प्रासंगिक बारकोड प्रकारों को EncodeTypes पैरामीटर के रूप में निर्दिष्ट करें</li><li>दूसरे पैरामीटर के रूप में बारकोड टेक्स्ट सेट करें</li><li>यदि आवश्यक हो तो छवि आयाम और स्थान निर्दिष्ट करें</li><li>आवश्यक प्रारूप में रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC) छवि प्राप्त करने के लिए BarCodeGenerator.save पद्धति को कॉल करें</li></ul>
