---
title: PHP via Java के द्वारा Swiss Post Parcel छवियों को स्कैन करें
weight: 1510
description: PHP-आधारित अनुप्रयोगों में Swiss Post Parcel पढ़ने के लिए PHP नमूना कोड।
lang: hi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hi/php-java/swiss-post-parcel/recognize/
aliases:
- /hi/php-java/recognize/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Swiss Post Parcel बारकोड को PHP via Java के साथ पढ़ें" h2="सर्वर साइड Aspose.BarCode for PHP via Java API का उपयोग करके PHP में Swiss Post Parcel पढ़ें" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="PHP में Swiss Post Parcel को स्कैन करने के चरण" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader वर्ग का एक ऑब्जेक्ट बनाएं</li><li>पैरामीटर के रूप में Swiss Post Parcel वाले स्रोत छवि पथ को सेट करें</li><li>DecodeType में लक्ष्य बारकोड प्रकार निर्दिष्ट करें दूसरे पैरामीटर के रूप में</li><li>पठन परिणामों के माध्यम से लूप करें</li><li>CodeText गुण का उपयोग करके बारकोड टेक्स्ट प्राप्त करें</li></ul>
