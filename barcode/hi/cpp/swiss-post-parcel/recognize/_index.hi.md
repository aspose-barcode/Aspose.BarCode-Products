---
title: C++ के द्वारा Swiss Post Parcel छवियों को स्कैन करें
weight: 1510
description: Windows 32-बिट, Windows 64-बिट, या Linux 64-बिट के लिए C++ रनटाइम वातावरण में Swiss Post Parcel को स्कैन और डीकोड करने के लिए C++ नमूना कोड।
lang: hi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hi/cpp/swiss-post-parcel/recognize/
aliases:
- /hi/cpp/recognize/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Swiss Post Parcel बारकोड को C++ के साथ पढ़ें" h2="सर्वर साइड Aspose.BarCode for C++ API का उपयोग करके C++ में Swiss Post Parcel पढ़ें" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
