---
title: C++ के द्वारा Codablock-F और GS1 Codablock-F बारकोड छवियां उत्पन्न करें
description: Windows 32-बिट, Windows 64-बिट और Linux 64-बिट के लिए C++ रनटाइम वातावरण में Codablock-F और GS1 Codablock-F बारकोड उत्पन्न करने के लिए कोड का C++ उदाहरण।
lang: hi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hi/cpp/codablock/generate/
aliases:
- /hi/cpp/generate/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Codablock-F लेबल C++ के साथ जनरेट करें" h2="C++ API के लिए सर्वर-साइड Aspose.BarCode का उपयोग करके C++ में Codablock-F और GS1 Codablock-F बारकोड बनाएं।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>बारकोड जेनरेटर वर्ग का एक ऑब्जेक्ट बनाएं</li><li>पैरामीटर के रूप में Codablock-F और GS1 Codablock-F बारकोड पास करें</li><li>दूसरे पैरामीटर के रूप में एन्कोड करने के लिए इनपुट टेक्स्ट डालें</li><li>यदि आवश्यक हो तो छवि आयामों को परिभाषित करें</li><li>बारकोड जेनरेटर को कॉल करें। Codablock-F और GS1 Codablock-F बारकोड बारकोड डाउनलोड करने के लिए विधि सहेजें</li></ul>
