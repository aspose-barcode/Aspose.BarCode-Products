---
title: एसक्यूएल सर्वर रिपोर्टिंग सेवाओं में रैखिक और 2डी बारकोड छवियां प्रस्तुत करें
description: एसक्यूएल सर्वर रिपोर्टिंग सर्विसेज रेंडरिंग एक्सटेंशन - एसएसआरएस में निर्यात रैखिक और 2डी बारकोड छवियां। बीएमपी जेपीईजी जीआईएफ और पीएनजी प्रारूपों में बारकोड लेबल प्रस्तुत करें।
lang: hi/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="एसएसआरएस बारकोड एपीआई" h2="Microsoft SQL सर्वर रिपोर्टिंग सेवाओं के भीतर से रेखीय और 2D बारकोड उत्पन्न करें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-reporting-services.svg" pfName="Aspose.BarCode" subTitlepfName="SQL Reporting Services के लिए" downloadUrl="https://releases.aspose.com/barcode/reportingservices/" >}}
...
<p>Aspose.BarCode रिपोर्टिंग सेवाओं के लिए Microsoft SQL Server रिपोर्टिंग सेवाओं के भीतर रैखिक और 2D बारकोड रेंडर करने के लिए एक व्यापक समाधान है। बारकोड लेबल को गैर-अंग्रेज़ी वर्णों के साथ एन्कोड किया जा सकता है और BMP, JPEG, GIF और PNG स्वरूपों में रेंडर किया जा सकता है।</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="प्लेटफार्म स्वतंत्रता" description="यह Microsoft SQL सर्वर रिपोर्टिंग सेवाओं का समर्थन करता है।" >}}
<div class='diagram1 d1-rs'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="समर्थित फ़ाइल स्वरूप" description="SQL Reporting Services के लिए Aspose.BarCode सबसे अधिक उपयोग किए जाने वाले छवि फ़ाइल स्वरूपों के साथ काम करता है।" >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/dynamically-display-barcodes-in-table/'>तालिकाओं में गतिशील रूप से बारकोड प्रदर्शित करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/display-barcodes-from-dataset/'>डेटासेट से बारकोड प्रदर्शित करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/barcode-types-and-image-formats/'>वेक्टर छवि स्वरूपों में बारकोड सहेजें</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    SQL सर्वर रिपोर्टिंग सेवाओं के साथ एकीकरण
                </h2>
                <p>
                    रिपोर्टिंग सेवाओं के लिए Aspose.BarCode को विजुअल स्टूडियो टूलबॉक्स में रिपोर्टिंग सेवाओं के लिए Aspose.BarCode जोड़कर आसानी से मौजूदा या नई परियोजनाओं में एकीकृत किया जा सकता है। एक बार टूलबॉक्स में उपलब्ध होने के बाद, आप इसे जहाँ चाहें प्रोजेक्ट पर ड्रैग और ड्रॉप कर सकते हैं।
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    यह बारकोड एपीआई डेवलपर्स को बारकोड प्रकार, एन्कोड करने के लिए इनपुट डेटा और कस्टम उपस्थिति-संबंधित गुणों को सेट करके उच्च-गुणवत्ता वाले बारकोड उत्पन्न करने की अनुमति देता है। यह पृष्ठभूमि और अग्रभूमि रंग, फ़ॉन्ट, आकार, रिज़ॉल्यूशन और टेक्स्ट कैप्शन सहित उत्पन्न बारकोड की उपस्थिति को ठीक करने के लिए कई प्रकार के विकल्प प्रदान करता है।
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    कस्टम बारकोड आकार और रंग
                </h2>
                <p>
                    SQL Reporting Services के लिए Aspose.BarCode एपीआई कस्टम पैरामीटर के साथ बारकोड छवियां उत्पन्न करने के लिए समृद्ध कार्यक्षमता प्रदान करता है। व्यावसायिक आवश्यकताओं के आधार पर विकासकर्ता किसी भी रंग या आकार के बारकोड उत्पन्न करने के लिए अनुप्रयोग बना सकते हैं। सभी बारकोड तत्वों की उपस्थिति को अनुकूलित करना संभव है, जिसमें बार के रंग, पृष्ठभूमि, बॉर्डर और टेक्स्ट कैप्शन शामिल हैं, साथ ही साथ उनकी स्थिति भी। बारकोड को इनपुट टेक्स्ट, ऊपरी और/या निचले कैप्शन, पैडिंग और बॉर्डर के साथ या प्रदर्शित किए बिना उत्पन्न किया जा सकता है। एक्स-आयाम या मैन्युअल रूप से निर्भर करते हुए बारकोड आकार स्वचालित रूप से सेट किया जा सकता है। इसे विभिन्न इकाइयों में परिभाषित किया जा सकता है, जैसे मिलीमीटर, इंच, अंक या पिक्सेल। यदि आवश्यक हो, छवि अनुपात और संकल्प को संशोधित किया जा सकता है। पाठ फ़ॉन्ट का आकार भी अनुकूलित किया जा सकता है।
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    विजुअल स्टूडियो के लिए बारकोड डिजाइनर
                </h2>
                <p>
                    विजुअल स्टूडियो के लिए पूरी तरह से एकीकृत बारकोड डिजाइनर का उपयोग करके बारकोड लेबल के लेआउट को बदला जा सकता है। डेवलपर डिज़ाइन-समय पर बारकोड छवियों का पूर्वावलोकन और समायोजन कर सकते हैं। डिजाइनर बारकोड छवियों की उपस्थिति को समायोजित करने के लिए विभिन्न सेटिंग्स को अनुकूलित करने की भी अनुमति देता है।
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/pdf417/" name="PDF417" description="PDF417 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/qr/" name="QR" description="QR कोड, GS1 QR कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/datamatrix/" name="Data Matrix" description="Data Matrix कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/aztec/" name="Aztec" description="Aztec कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/swiss-qr/" name="Swiss QR" description="Swiss QR बिल" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/dotcode/" name="DotCode" description="DotCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/hibc/" name="HIBC" description="HIBC (स्वास्थ्य उद्योग बार कोड)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/codablock/" name="Codablock-F" description="Codablock-F और GS1 Codablock-F बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/databar/" name="GS1 DataBar" description="GS1 DataBar (सर्वदिशात्मक, स्टैक्ड सर्वदिशात्मक, विस्तारित, विस्तारित स्टैक्ड, और छोटा) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/itf/" name="ITF" description="इंटरलीव्ड 2-ऑफ-5 (ITF) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/ean/" name="EAN" description="EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/upc/" name="UPC" description="UPC (यूनिवर्सल प्रोडक्ट कोड) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/code128/" name="GS1 Code 128" description="GS1 Code 128 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/code39/" name="Code 39" description="Code 39 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/code16k/" name="Code 16K" description="Code 16K बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/code32/" name="Code 32" description="इतालवी फार्माकोड (Code 32) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/code93/" name="Code 93" description="Code 93 विस्तारित और Code 93 मानक बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/onecode/" name="USPS OneCode" description="USPS OneCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (इंडस्ट्रियल 2 ऑफ़ 5) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/isbn/" name="ISBN" description="ISBN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/ismn/" name="ISMN" description="ISMN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/issn/" name="ISSN" description="ISSN बारकोड" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/australia-post/" name="Australia Post" description="Australia Post बारकोड और Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode और Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/rm4scc/" name="RM4SCC" description="रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/postnet/" name="Postnet" description="Postnet बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/royal-mail/" name="Royal Mail" description="Royal Mail बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/singapore-post/" name="Singapore Post" description="Singapore Post बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/reporting-services/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="प्रलेखन" href="https://docs.aspose.com/barcode/reportingservices/" >}}
{{< blocks/products/pf/slr-element name="सोर्स कोड" href="https://github.com/aspose-barcode/Aspose.BarCode-for-.NET" >}}
{{< blocks/products/pf/slr-element name="एपीआई संदर्भ" href="https://reference.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/slr-element name="रिलीज नोट्स" href="https://docs.aspose.com/barcode/reportingservices/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="SQL Reporting Services के लिए Aspose.BarCode क्यों?" tabId="success-stories" >}}
