---
title: Node.js via Java के द्वारा Swiss Post Parcel छवियां उत्पन्न करें
description: जावास्क्रिप्ट अनुप्रयोगों में Swiss Post Parcel पीढ़ी के लिए Node.js नमूना कोड।
lang: hi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hi/nodejs-java/swiss-post-parcel/generate/
aliases:
- /hi/nodejs-java/generate/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Swiss Post Parcel लेबल Node.js via Java के साथ जनरेट करें" h2="Node.js via Java API के लिए सर्वर-साइड Aspose.BarCode का उपयोग करके JavaScript में Swiss Post Parcel बनाएं।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript में Swiss Post Parcel जनरेट करने के चरण" %}}
