---
title: Nodejs बारकोड स्कैनर और जेनरेटर एपीआई
description: 1D, 2D और पोस्टल प्रकारों के लिए Node.js बारकोड स्कैनिंग और जनरेशन लाइब्रेरी। QR कोड maxicode Aztec Code128 EAN-128 और अधिक के लिए आसानी से प्रतिक्रिया कोणीय ऐप्स में एकीकृत करें।
lang: hi/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Node.js बारकोड जेनरेटर और स्कैनर एपीआई" h2="विभिन्न छवियों से कोड128, कोड93, कोड39, क्यूआर कोड सहित 1डी, 2डी और पोस्टल बारकोड को पहचानें या उत्पन्न करें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" pfName="Aspose.BarCode" subTitlepfName="Node.js via Java के लिए" downloadUrl="https://releases.aspose.com/barcode/nodejs/" >}}
...
<p>जावा के माध्यम से Node.js के लिए Aspose.BarCode एक आसानी से अनुकूलन योग्य बारकोड जनरेटर और डिकोडर API है। डेवलपर्स नोडज-जावा ब्रिज के माध्यम से अपने अनुप्रयोगों में इसके बारकोड जनरेटिंग और रीडिंग कार्यक्षमता को एकीकृत कर सकते हैं। इसका उपयोग किसी भी कोण पर छवियों से सामान्य 1D, 2D और पोस्टल बारकोड को पढ़ने के लिए किया जा सकता है। यह बारकोड लाइब्रेरी डेवलपर्स को 60 से अधिक प्रकार की बारकोड छवियां उत्पन्न करने और उन्हें जेपीजी, पीएनजी, जीआईएफ, बीएमपी और टीआईएफएफ जैसे विभिन्न प्रारूपों में सहेजने की अनुमति देती है। यह विभिन्न इमेजिंग सुविधाओं को अनुकूलित करने का समर्थन करता है, जैसे बारकोड बॉर्डर रंग और शैली, मार्जिन, रोटेशन कोण, रिज़ॉल्यूशन और बारकोड रंग।</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="प्लेटफार्म स्वतंत्रता" description="Aspose.BarCode जावा के माध्यम से Node.js के लिए Node.js पर आधारित एक सर्वर-साइड JavaScript API है। यह JDK 1.7 या इसके बाद के संस्करण के साथ विंडोज, यूनिक्स/लिनक्स और मैक प्लेटफॉर्म पर चल सकता है।" >}}
<div class='diagram1 d1-nodejs'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="समर्थित फ़ाइल स्वरूप" description="Node.js via Java के लिए Aspose.BarCode सबसे अधिक उपयोग किए जाने वाले छवि फ़ाइल स्वरूपों के साथ काम करता है।" >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                उन्नत Node.js बारकोड एपीआई सुविधाएँ
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/nodejsjava/supported-barcode-types-and-formats/#barcode-types'>60+ बारकोड प्रकार जनरेट और स्कैन करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/nodejsjava/set-barcode-text/'>बारकोड कैप्शन और फ़ॉन्ट शैलियों को अनुकूलित करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/nodejsjava/barcode-reading-settings/#checksum-verification'>चेकसम सत्यापन करें</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    स्विस क्यूआर कोड उत्पन्न करें
                </h2>
                <p>
                    2डी बारकोड और क्यूआर कोड के अलावा, बारकोड लाइब्रेरी स्विस क्यूआर कोड को जनरेट करने और पढ़ने में सक्षम बनाती है। वे क्यूआर (त्वरित प्रतिक्रिया) कोड विनिर्देश पर आधारित हैं और स्विट्जरलैंड में व्यवसायों और व्यक्तियों के बीच भुगतान की सुविधा के लिए उपयोग किए जाते हैं। क्यूआर कोड द्वि-आयामी बारकोड होते हैं जिन्हें स्मार्टफोन या अन्य डिवाइस से स्कैन किया जा सकता है ताकि सूचनाओं को जल्दी और आसानी से एक्सेस किया जा सके या कोई कार्रवाई की जा सके। स्विस क्यूआर कोड स्विट्जरलैंड में इलेक्ट्रॉनिक भुगतान के लिए राष्ट्रीय मानक हैं। उनका उपयोग व्यवसायों द्वारा ग्राहकों से भुगतान प्राप्त करने के लिए किया जाता है। जब कोई ग्राहक स्विस क्यूआर कोड को स्कैन करता है, तो उन्हें भुगतान की जानकारी दी जाती है और वे अपने मोबाइल बैंकिंग ऐप से भुगतान शुरू कर सकते हैं। यह व्यवसायों को अपने ग्राहकों से भुगतान स्वीकार करने का एक सुविधाजनक और सुरक्षित तरीका प्रदान करता है। स्विस क्यूआर कोड आमतौर पर विभिन्न प्रकार के उद्योगों में उपयोग किए जाते हैं, जिनमें खुदरा, आतिथ्य और स्वास्थ्य सेवा शामिल हैं। स्विस क्यूआर कोड जनरेट करने के लिए, आपको आवश्यक जानकारी प्रदान करनी होगी, जैसे कि आपके व्यवसाय का नाम, बैंक खाता विवरण और भुगतान की राशि। एस्पोज क्यूआर कोड जनरेटर इस जानकारी का उपयोग स्विस क्यूआर कोड बनाने के लिए करेगा जिसे भुगतान शुरू करने के लिए आपके ग्राहकों द्वारा स्कैन किया जा सकता है। क्यूआर कोड जनरेट होने के बाद, आप इसे डाउनलोड कर सकते हैं और अपने ग्राहकों से भुगतान स्वीकार करने के लिए अपने व्यवसाय में इसका उपयोग कर सकते हैं।
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    क्यूआर कोड जनरेशन लाइव उदाहरण
                </h2>
                <p>
                    बारकोड लाइब्रेरी डेवलपर्स को Data Matrix, Aztec कोड, PDF417, मैक्रो PDF417, और अन्य सहित 2D बारकोड की एक विस्तृत श्रृंखला उत्पन्न करने की अनुमति देती है। यह बड़े या एकाधिक बारकोड उत्पन्न करने के लिए विशेष रूप से उपयोगी है जिसमें लंबे या जटिल डेटा मान होते हैं। पुस्तकालय उत्पन्न करने के लिए बारकोड के प्रकार को निर्दिष्ट करने, स्टोर करने के लिए इनपुट डेटा दर्ज करने और उपस्थिति से संबंधित पैरामीटर सेट करने के लिए एक सरल और सहज ज्ञान युक्त इंटरफ़ेस प्रदान करता है। यह इसे विभिन्न अनुप्रयोगों के लिए उच्च-गुणवत्ता वाले बारकोड बनाने के लिए उपयोगकर्ता के अनुकूल और शक्तिशाली उपकरण बनाता है। नीचे दिए गए कोड नमूने में क्यूआर कोड बनाने का तरीका दिखाया गया है।
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    बारकोड रीडिंग को ऑप्टिमाइज़ करें
                </h2>
                <p>
                    Aspose.Barcode for C++ अनुप्रयोगों की एक विस्तृत श्रृंखला में बारकोड के साथ काम करने के लिए एक व्यापक बारकोड लाइब्रेरी है। इसकी प्रमुख विशेषताओं में से एक बारकोड पहचान की गुणवत्ता और गति दोनों को अनुकूलित करने के लिए मान्यता प्रक्रिया को ठीक करने की क्षमता है। पुस्तकालय कई उन्नत सेटिंग्स प्रदान करता है जिनका उपयोग किसी एप्लिकेशन की विशिष्ट आवश्यकताओं के आधार पर बारकोड स्कैनिंग को अनुकूलित करने के लिए किया जा सकता है। उदाहरण के लिए, पुस्तकालय विशेष पठन मोड प्रदान करता है जो उच्च-गुणवत्ता वाले रैखिक बारकोड की तेजी से स्कैनिंग को सक्षम करता है। यह उन अनुप्रयोगों में उपयोगी हो सकता है जिन्हें बड़ी मात्रा में बारकोड डेटा को त्वरित रूप से संसाधित करने की आवश्यकता होती है। इसके अतिरिक्त, पुस्तकालय डेवलपर्स को लक्ष्य स्कैनिंग क्षेत्रों और बारकोड प्रकारों को निर्दिष्ट करने की अनुमति देता है, जो छवि के सबसे प्रासंगिक क्षेत्रों पर ध्यान केंद्रित करके स्कैन की सटीकता में सुधार कर सकता है। एपीआई एक छवि में कई बारकोड का पता लगाने का भी समर्थन करता है, जो उन अनुप्रयोगों में उपयोगी हो सकता है जिन्हें एक साथ कई बारकोड संसाधित करने की आवश्यकता होती है।
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/pdf417/" name="PDF417" description="PDF417 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/qr/" name="QR" description="QR कोड, GS1 QR कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/datamatrix/" name="Data Matrix" description="Data Matrix कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/aztec/" name="Aztec" description="Aztec कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/swiss-qr/" name="Swiss QR" description="Swiss QR बिल" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/dotcode/" name="DotCode" description="DotCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/hibc/" name="HIBC" description="HIBC (स्वास्थ्य उद्योग बार कोड)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/codablock/" name="Codablock-F" description="Codablock-F और GS1 Codablock-F बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/databar/" name="GS1 DataBar" description="GS1 DataBar (सर्वदिशात्मक, स्टैक्ड सर्वदिशात्मक, विस्तारित, विस्तारित स्टैक्ड, और छोटा) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/itf/" name="ITF" description="इंटरलीव्ड 2-ऑफ-5 (ITF) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/ean/" name="EAN" description="EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/upc/" name="UPC" description="UPC (यूनिवर्सल प्रोडक्ट कोड) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/code128/" name="GS1 Code 128" description="GS1 Code 128 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/code39/" name="Code 39" description="Code 39 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/code16k/" name="Code 16K" description="Code 16K बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/code32/" name="Code 32" description="इतालवी फार्माकोड (Code 32) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/code93/" name="Code 93" description="Code 93 विस्तारित और Code 93 मानक बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/onecode/" name="USPS OneCode" description="USPS OneCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (इंडस्ट्रियल 2 ऑफ़ 5) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/isbn/" name="ISBN" description="ISBN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/ismn/" name="ISMN" description="ISMN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/issn/" name="ISSN" description="ISSN बारकोड" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/australia-post/" name="Australia Post" description="Australia Post बारकोड और Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode और Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/rm4scc/" name="RM4SCC" description="रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/postnet/" name="Postnet" description="Postnet बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/royal-mail/" name="Royal Mail" description="Royal Mail बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/singapore-post/" name="Singapore Post" description="Singapore Post बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="प्रलेखन" href="https://docs.aspose.com/barcode/nodejsjava/" >}}
{{< blocks/products/pf/slr-element name="सोर्स कोड" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="एपीआई संदर्भ" href="https://reference.aspose.com/barcode/nodejs/" >}}
...
{{< blocks/products/pf/slr-element name="रिलीज नोट्स" href="https://docs.aspose.com/barcode/nodejsjava/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Node.js via Java के लिए Aspose.BarCode क्यों?" tabId="success-stories" >}}
