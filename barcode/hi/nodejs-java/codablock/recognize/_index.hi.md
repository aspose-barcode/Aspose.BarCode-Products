---
title: Node.js via Java के द्वारा Codablock-F और GS1 Codablock-F बारकोड छवियों को स्कैन करें
weight: 1510
description: Codablock-F और GS1 Codablock-F बारकोड के लिए Node.js स्रोत कोड JavaScript अनुप्रयोगों में स्कैनिंग और डिकोडिंग।
lang: hi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hi/nodejs-java/codablock/recognize/
aliases:
- /hi/nodejs-java/recognize/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Codablock-F बारकोड को Node.js via Java के साथ पढ़ें" h2="सर्वर साइड Aspose.BarCode for Node.js via Java API का उपयोग करके JavaScript में Codablock-F और GS1 Codablock-F बारकोड पढ़ें" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript में Codablock-F बारकोड को स्कैन करने के चरण" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader वर्ग का एक ऑब्जेक्ट बनाएं</li><li>पैरामीटर के रूप में Codablock-F बारकोड वाले स्रोत फ़ाइल पथ को पास करें</li><li>DecodeType में लक्ष्य बारकोड प्रकार सेट करें दूसरे पैरामीटर के रूप में</li><li>सभी ज्ञात बारकोड के माध्यम से लूप करें</li><li>CodeText गुण का उपयोग करके परिणामी बारकोड टेक्स्ट प्राप्त करें</li></ul>
