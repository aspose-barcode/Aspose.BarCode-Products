---
title: Node.js via Java के द्वारा Deutsche Post Identcode और Deutsche Post Leitcode छवियों को स्कैन करें
weight: 1510
description: Deutsche Post Identcode और Deutsche Post Leitcode के लिए Node.js स्रोत कोड JavaScript अनुप्रयोगों में स्कैनिंग और डिकोडिंग।
lang: hi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hi/nodejs-java/deutsche-post/recognize/
aliases:
- /hi/nodejs-java/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Deutsche Post बारकोड को Node.js via Java के साथ पढ़ें" h2="सर्वर साइड Aspose.BarCode for Node.js via Java API का उपयोग करके JavaScript में Deutsche Post Identcode और Deutsche Post Leitcode पढ़ें" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Deutsche Post बारकोड Using Node.js via Java" %}}
Node.js अनुप्रयोगों के भीतर Deutsche Post बारकोड को पहचानने के लिए, जावा के माध्यम से Node.js के लिए Aspose.BarCode का उपयोग करें, जो जावा-आधारित वातावरणों के लिए पेश की गई एक मजबूत, बहुमुखी और उपयोगकर्ता के अनुकूल बारकोड लाइब्रेरी है। आप एनपीएम से सीधे जावास्क्रिप्ट के लिए [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) लोड कर सकते हैं:
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript में Deutsche Post बारकोड को स्कैन करने के चरण" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader वर्ग का एक ऑब्जेक्ट बनाएं</li><li>पैरामीटर के रूप में Deutsche Post बारकोड वाले स्रोत फ़ाइल पथ को पास करें</li><li>DecodeType में लक्ष्य बारकोड प्रकार सेट करें दूसरे पैरामीटर के रूप में</li><li>सभी ज्ञात बारकोड के माध्यम से लूप करें</li><li>CodeText गुण का उपयोग करके परिणामी बारकोड टेक्स्ट प्राप्त करें</li></ul>
...
<ul><li>Microsoft Windows, Linux, या Node.js के साथ संगत कोई भी OS</li><li>Node.js और Node.js/Java Bridge स्थापित</li><li>Oracle JDK संस्करण 7 या ऊपर </li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/pdf417/recognize/" name="PDF417" description="PDF417 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/qr/recognize/" name="QR" description="QR कोड, GS1 QR कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/aztec/recognize/" name="Aztec" description="Aztec कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR बिल" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/dotcode/recognize/" name="DotCode" description="DotCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/hibc/recognize/" name="HIBC" description="HIBC (स्वास्थ्य उद्योग बार कोड)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/codablock/recognize/" name="Codablock-F" description="Codablock-F और GS1 Codablock-F बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (सर्वदिशात्मक, स्टैक्ड सर्वदिशात्मक, विस्तारित, विस्तारित स्टैक्ड, और छोटा) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/itf/recognize/" name="ITF" description="इंटरलीव्ड 2-ऑफ-5 (ITF) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/ean/recognize/" name="EAN" description="EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/upc/recognize/" name="UPC" description="UPC (यूनिवर्सल प्रोडक्ट कोड) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/code39/recognize/" name="Code 39" description="Code 39 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/code16k/recognize/" name="Code 16K" description="Code 16K बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/code32/recognize/" name="Code 32" description="इतालवी फार्माकोड (Code 32) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/code93/recognize/" name="Code 93" description="Code 93 विस्तारित और Code 93 मानक बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (इंडस्ट्रियल 2 ऑफ़ 5) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/isbn/recognize/" name="ISBN" description="ISBN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/ismn/recognize/" name="ISMN" description="ISMN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/issn/recognize/" name="ISSN" description="ISSN बारकोड" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/australia-post/recognize/" name="Australia Post" description="Australia Post बारकोड और Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode और Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/rm4scc/recognize/" name="RM4SCC" description="रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/postnet/recognize/" name="Postnet" description="Postnet बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/royal-mail/recognize/" name="Royal Mail" description="Royal Mail बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/singapore-post/recognize/" name="Singapore Post" description="Singapore Post बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/nodejs-java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
