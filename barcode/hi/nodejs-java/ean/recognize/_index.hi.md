---
title: Node.js via Java के द्वारा EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड छवियों को स्कैन करें
weight: 1510
description: EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड के लिए Node.js स्रोत कोड JavaScript अनुप्रयोगों में स्कैनिंग और डिकोडिंग।
lang: hi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hi/nodejs-java/ean/recognize/
aliases:
- /hi/nodejs-java/recognize/ean/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="EAN बारकोड को Node.js via Java के साथ पढ़ें" h2="सर्वर साइड Aspose.BarCode for Node.js via Java API का उपयोग करके JavaScript में EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड पढ़ें" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript में EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड को स्कैन करने के चरण" %}}
