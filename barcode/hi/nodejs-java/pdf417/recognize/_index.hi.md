...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript में PDF417 बारकोड को स्कैन करने के चरण" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader वर्ग का एक ऑब्जेक्ट बनाएं</li><li>पैरामीटर के रूप में PDF417 बारकोड वाले स्रोत फ़ाइल पथ को पास करें</li><li>DecodeType में लक्ष्य बारकोड प्रकार सेट करें दूसरे पैरामीटर के रूप में</li><li>सभी ज्ञात बारकोड के माध्यम से लूप करें</li><li>CodeText गुण का उपयोग करके परिणामी बारकोड टेक्स्ट प्राप्त करें</li></ul>
