---
title: सी# .नेट बारकोड एपीआई - बारकोड पढ़ें और पहचानें
...
{{< blocks/products/pf/upper-banner h1="बारकोड जनरेटर और रीडर एपीआई" h2="किसी भी .NET एप्लिकेशन में लीनियर, 2D और पोस्टल प्रकार के बारकोड बनाएं और पहचानें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" pfName="Aspose.BarCode" subTitlepfName=".NET के लिए" downloadUrl="https://releases.aspose.com/barcode/net/" >}}
...
<p>Aspose.BarCode for .NET किसी भी कोण पर विभिन्न छवि प्रकारों से 1D और 2D बारकोड उत्पन्न करने और पहचानने के लिए एक शक्तिशाली विकास पुस्तकालय है। डेवलपर आसानी से अपने .NET अनुप्रयोगों में बारकोड जनरेशन और स्कैनिंग कार्यक्षमता जोड़ सकते हैं। यह एपीआई जनरेट किए गए बारकोड को विभिन्न उच्च-गुणवत्ता वाले छवि प्रारूपों में निर्यात करने की अनुमति देता है।</p><p>Aspose.BarCode for .NET जनरेट किए गए बारकोड और उनके पैरामीटर, जैसे पृष्ठभूमि रंग, बार रंग, रोटेशन कोण, x की उपस्थिति को संशोधित करने में सक्षम बनाता है। -आयाम, छवि गुणवत्ता, रिज़ॉल्यूशन, कैप्शन, आकार और कई अन्य। यह समृद्ध बारकोड का पता लगाने और पढ़ने की कार्यक्षमता भी प्रदान करता है और 60 से अधिक बारकोड प्रकारों का समर्थन करता है।</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="प्लेटफार्म स्वतंत्रता" description="आप ASP.NET, WinForms, WPF, .NET मानक और अन्य सहित किसी भी प्रकार के 32-बिट या 64-बिट .NET एप्लिकेशन को बनाने के लिए लाइब्रेरी का उपयोग कर सकते हैं।" >}}
<div class='diagram1 d1-net'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
            ...
            <ul><li>PHP, VBScript, डेल्फी, C++</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            <header>
...
{{< blocks/products/pf/carousel-item h3="समर्थित फ़ाइल स्वरूप" description=".NET के लिए Aspose.BarCode सबसे अधिक उपयोग किए जाने वाले छवि फ़ाइल स्वरूपों के साथ काम करता है।" >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/saving-barcode-image/'>बारकोड लेबल को विभिन्न स्वरूपों में सहेजें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/read-barcodes-with-aspose-barcode-apis/#setting-barcode-recognition-source'>स्ट्रीम या फ़ाइल से पहचानें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/qr-and-micro-qr-barcode/#eciencoding-mode'>2D प्रकारों में वर्णों (गैर-अंग्रेज़ी) को एनकोड और डिकोड करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/image-formatting-and-display-settings/'>किसी भी कोण पर बारकोड छवियों को घुमाएँ</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/how-to-read-barcode-from-multi-page-tiff-images/'>बहु-पृष्ठ TIFF से बारकोड स्कैन करें</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/barcode-types-and-image-formats/'>रैखिक, 2डी और डाक सहजीवन के लिए समर्थन</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    बारकोड जनरेटर एपीआई डेवलपर्स को आवश्यक बारकोड प्रकार निर्दिष्ट करके, इनपुट टेक्स्ट सेट करके (बारकोड छवि में एन्कोड किया जाने वाला डेटा), और पृष्ठभूमि और अग्रभूमि रंग, फ़ॉन्ट, टेक्स्ट स्थान (छुपाएं, ऊपर, या नीचे), और संरेखण। द्वि-आयामी बारकोड, जैसे QR कोड, PDF417, Data Matrix, Aztec कोड, आदि उसी तरह जैसे एक-आयामी वाले।
                </p>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/pdf417/" name="PDF417" description="PDF417 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/qr/" name="QR" description="QR कोड, GS1 QR कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/datamatrix/" name="Data Matrix" description="Data Matrix कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/aztec/" name="Aztec" description="Aztec कोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/swiss-qr/" name="Swiss QR" description="Swiss QR बिल" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/dotcode/" name="DotCode" description="DotCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/hibc/" name="HIBC" description="HIBC (स्वास्थ्य उद्योग बार कोड)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/codablock/" name="Codablock-F" description="Codablock-F और GS1 Codablock-F बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/databar/" name="GS1 DataBar" description="GS1 DataBar (सर्वदिशात्मक, स्टैक्ड सर्वदिशात्मक, विस्तारित, विस्तारित स्टैक्ड, और छोटा) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/itf/" name="ITF" description="इंटरलीव्ड 2-ऑफ-5 (ITF) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/ean/" name="EAN" description="EAN (इंटरनेशनल आर्टिकल नंबर) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/upc/" name="UPC" description="UPC (यूनिवर्सल प्रोडक्ट कोड) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/code128/" name="GS1 Code 128" description="GS1 Code 128 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/code39/" name="Code 39" description="Code 39 बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/code16k/" name="Code 16K" description="Code 16K बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/code32/" name="Code 32" description="इतालवी फार्माकोड (Code 32) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/code93/" name="Code 93" description="Code 93 विस्तारित और Code 93 मानक बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/onecode/" name="USPS OneCode" description="USPS OneCode बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (इंडस्ट्रियल 2 ऑफ़ 5) बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/isbn/" name="ISBN" description="ISBN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/ismn/" name="ISMN" description="ISMN बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/issn/" name="ISSN" description="ISSN बारकोड" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/australia-post/" name="Australia Post" description="Australia Post बारकोड और Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode और Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/rm4scc/" name="RM4SCC" description="रॉयल मेल 4-राज्य ग्राहक कोड (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/postnet/" name="Postnet" description="Postnet बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/royal-mail/" name="Royal Mail" description="Royal Mail बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/singapore-post/" name="Singapore Post" description="Singapore Post बारकोड" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/hi/net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="रिलीज नोट्स" href="https://docs.aspose.com/barcode/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle=".NET के लिए Aspose.BarCode क्यों?" tabId="success-stories" >}}
