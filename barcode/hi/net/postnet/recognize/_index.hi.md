---
title: .NET के द्वारा Postnet बारकोड छवियों को स्कैन करें
weight: 1510
description: स्कैन और डिकोड करने के लिए C# नमूना कोड Postnet बारकोड .NET Framework, .NET Standard, PHP, VBScript, Delphi, या C++ के लिए COM इंटरलूप में बारकोड प्रकार।
lang: hi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hi/net/postnet/recognize/
aliases:
- /hi/net/recognize/postnet/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Postnet बारकोड को .NET के साथ पढ़ें" h2="सर्वर साइड Aspose.BarCode for .NET API का उपयोग करके C# में Postnet बारकोड पढ़ें" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Postnet" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# में Postnet बारकोड को स्कैन करने के चरण" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader वर्ग का एक नया उदाहरण बनाएं</li><li>पैरामीटर के रूप में Postnet बारकोड वाले स्रोत छवि पथ को पास करें</li><li>इस रूप में एक उपयुक्त DecodeType पास करें दूसरा पैरामीटर</li><li>डिकोडिंग परिणामों के माध्यम से लूप करें</li><li>CodeText गुण का उपयोग करके बारकोड टेक्स्ट प्राप्त करें</li></ul>
