---
title: .NET के द्वारा Swiss Post Parcel छवियां उत्पन्न करें
description: .NET फ्रेमवर्क में Swiss Post Parcel जेनरेशन के लिए C# सोर्स कोड, .NET स्टैंडर्ड, PHP के लिए COM इंटरलूप, VBScript, डेल्फी और C++।
lang: hi/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /hi/net/swiss-post-parcel/generate/
aliases:
- /hi/net/generate/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Swiss Post Parcel लेबल .NET के साथ जनरेट करें" h2=".NET API के लिए सर्वर-साइड Aspose.BarCode का उपयोग करके C# में Swiss Post Parcel बनाएं।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# में Swiss Post Parcel जनरेट करने के चरण" %}}
...
<ul><li>BarcodeGenerator वर्ग का एक उदाहरण बनाएं</li><li>पैरामीटर के रूप में Swiss Post Parcel पास करें</li><li>दूसरे पैरामीटर के रूप में एन्कोड करने के लिए टेक्स्ट सेट करें</li><li> यदि आवश्यक हो तो बारकोड आयाम निर्दिष्ट करें</li><li>बारकोडजेनरेटर को कॉल करें। Swiss Post Parcel छवि प्राप्त करने के लिए विधि सहेजें</li></ul>
