---
title: 在 JasperReports 中生成条形码并在 BMP JPG GIF 和 PNG 中呈现 
weight: 1900
url: /zh/jasperreports/ 
description: 使用 Aspose.BarCode for JasperReports - 开发人员可以在 Jasper Reports 中生成条形码，这些条形码可以进一步以 BMP JPG GIF 和 PNG 格式呈现
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 JasperReports 中生成和导出条形码" h2="JasperReports 和 JasperServer API 用于生成、显示和导出线性、二维和邮政条码为多种格式。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/barcode/jasperreports" >}}
...
<p>
 Aspose.BarCode for JasperReports 是一个灵活的 JasperReports 和 JasperServer 扩展，用于在您的应用程序中创建和显示条形码标签。这些条形码标签可以以许多流行的图像格式呈现。
</p>
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="JasperReports API 的 Aspose.BarCode 概述。" >}}
<div class="diagram1 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Jasper 报告条码生成器" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Platform Independence" description="JasperReports 的 Aspose.BarCode 可以与 JasperServer 和 JasperReports 一起使用。" >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="在 Jasper 报告中生成条形码" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="JasperReports 条码扩展支持流行 [图像格式](https://docs.aspose.com/barcode/jasperreports/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="条码生成 in Jasper Report" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     JasperReports 的 Aspose.BarCode 支持超过 25 种最流行的线性、二维和邮政条码符号，包括：
    </p>
    <div class="col-lg-6">
     <ul class="unstyled">
      <li>
    ...
    <div class="col-lg-6">
     <ul class="unstyled">
      ...
      <li>
       Supplement Code +2 （对于 EAN 和 UPC 代码）
      </li>
      <li>
       Supplement Code +5 （对于 EAN 和 UPC 代码）
      </li>
      <li>
       UPC A
      </li>
    ...
    <div class="col-lg-12">
     ...
     <p>
      Aspose.BarCode for JasperReports 允许通过指定各种选项来自定义条形码，例如符号类型、文本（将编码为条形码图像的代码数据）以及调整外观的属性，例如字体、背景和前景颜色。
     </p>
     <p>
      您还可以自定义条码标题，例如标题字体、背景/前景色、对齐和位置（隐藏、上方、下方）等。
     </p>
    </div>
    <div class="col-lg-12">
     <h2 class="h2title">
     ...
     <p>
      JasperReports 的 Aspose.BarCode 完全用 Java 编码，并作为单个 JAR 文档提供，并可轻松部署到运行 JasperReports 或 JasperServer 的机器上。为了安装 JasperReports Barcode 扩展，只需将 JAR 文档复制到正确的文件夹位置，就可以开始了。
     </p>
    </div>
   </div>
  </div>
...
{{< blocks/products/pf/slr-element name="文档" href="https://docs.aspose.com/barcode/jasperreports/" >}}
{{< blocks/products/pf/slr-element name="源代码" href="https://github.com/aspose-barcode?tab=repositories" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="为什么为 JasperReports 使用 Aspose.BarCode？" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Aspose.BarCode 为其他流行的开发环境提供单独的条码生成和识别 API，如下所列：" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/barcode/zh/cpp/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sdkName="C++" >}}
