---
title: SharePoint Barcode API - Barkodları SharePoint Listelerine Ekle 
weight: 220
url: /tr/sharepoint/ 
description: Özel SharePoint Listelerine barkod etiketleri eklemek için Barkod SharePoint API. Geliştiriciler, kod metni değerlerini seçmek veya metni manuel olarak eklemek için Hizmet İşaretçilerini kullanabilir
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Barkodları Microsoft SharePoint Listelerine Ekleyin" h2="Microsoft SharePoint listelerine Doğrusal, 2B ve Posta barkod sembolleri eklemek için Barkod SharePoint Uygulaması." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/barcode/sharepoint" >}}
...
<p>
 Aspose.BarCode for SharePoint, Microsoft SharePoint Foundation 2010 ve Microsoft Office SharePoint Server 2010 (MOSS) listelerine çok sayıda doğrusal, 2B ve posta barkodu sembolü eklemeye olanak tanır. Kod metni ve semboloji belirterek herhangi bir listeye barkod ekleyebilirsiniz.
</p>
...
{{< blocks/products/pf/carousel-item h3="Bir Bakışta" description="Barkod oluşturma özelliklerine genel bakış." >}}
<div class="diagram1 d1-sharepoint">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="SharePoint Barkod Oluşturucu" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-sharepoint.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Desteklenen Platform" description="Aspose.BarCode for SharePoint, Microsoft SharePoint Foundation ve SharePoint Server'ı destekler." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="SharePoint Barkod Uygulaması" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-sharepoint.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Desteklenen Barkod Türleri" description="Aspose.BarCode for SharePoint aşağıdakileri destekler [dosya formatları](https://docs.aspose.com/barcode/sharepoint/supported-file-formats/)  :" >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
  ...
  <div class="d1-col d1-right">
   ...
   <!--<header><i class="fa fa-qrcode"> </i>Barcode Türler</header>

<ul>

<li>Doğrusal Barkod Çeşitleri</li>

<li>2D Barkod Çeşitleri</li>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <div class="col-lg-12">
    <h2 class="h2title">
     SharePoint Listelerine Barkod Türü Sütunu Ekleme
    </h2>
    <p>
     Aspose.BarCode for SharePoint, SharePoint listelerine barkod tipi sütun eklemeyi kolaylaştırır. Bu bileşen aynı zamanda, GUI kullanarak veya Servis İşaretleyicileri dahil ederek barkod kodu metnini ayarlamanıza da olanak tanır.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     SharePoint barkod uygulaması, aşağıdakiler dahil en popüler sembolojileri destekler:
    </p>
    <div class="col-lg-3">
     <ul class="unstyled">
      <li>
    ...
    <div class="col-lg-3">
     <ul class="unstyled">
      <li>
       DeutchePostaIdentificationCode
      </li>
      <li>
       DeutchePostaleitCode
      </li>
      <li>
       EAN128
      </li>
   ...
   <div class="container">
    ...
    <div class="col-lg-12 mgtb55">
     <ul class="list-unstyled" id="resources">
      ...
      <!-- <li><a href="https://apireference.aspose.com/">API Referansları</a></li> -->
      <li>
     ...
     <ul class="list-unstyled" id="success-stories">
      <li class="resourcesheading">
       Neden Aspose.BarCode for SharePoint?
      </li>
 ...
 <div class="container-fluid offers-section bg-darkergray tc">
  <div class="row">
   <div class="container">
    <div class="col-lg-12">
     <p>
      Aspose.BarCode, aşağıda listelenen diğer popüler geliştirme ortamları için bireysel Barkod oluşturma ve tanıma API'leri sunar:
     </p>
    </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Neden Aspose.BarCode for SharePoint?" tabId="success-stories" >}}
