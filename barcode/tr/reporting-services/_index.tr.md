---
title: SQL Server Raporlama Hizmetlerinde Doğrusal ve 2B Barkod Görüntüleri İşleyin
description: SQL Server Raporlama Hizmetleri işleme uzantısı - SSRS'de Doğrusal ve 2B Barkod görüntülerini dışa aktarın. Barkod etiketlerini BMP JPEG GIF ve PNG formatlarında işleyin.
lang: tr/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="SSRS Barkod API'leri" h2="Microsoft SQL Server Raporlama Hizmetleri içinden Doğrusal ve 2B barkodlar oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-reporting-services.svg" pfName="Aspose.BarCode" subTitlepfName="SQL Reporting Services için" downloadUrl="https://releases.aspose.com/barcode/reportingservices/" >}}
...
<p>Aspose.BarCode for Reporting Services, Microsoft SQL Server Reporting Services içinde doğrusal ve 2B barkodlar oluşturmaya yönelik kapsamlı bir çözümdür. Barkod etiketleri İngilizce olmayan karakterlerle kodlanabilir ve BMP, JPEG, GIF ve PNG formatlarında oluşturulabilir.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Platform Bağımsızlığı" description="Microsoft SQL Servier Raporlama Hizmetlerini destekler." >}}
<div class='diagram1 d1-rs'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Desteklenen Dosya Biçimleri" description="SQL Reporting Services için Aspose.BarCode, en sık kullanılan görüntü dosyası biçimleriyle çalışır." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Gelişmiş .NET Barkod API Özellikleri
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/dynamically-display-barcodes-in-table/'>Barkodları tablolarda dinamik olarak görüntüleyin</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/display-barcodes-from-dataset/'>Veri kümelerinden barkodları görüntüleyin</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/barcode-types-and-image-formats/'>Barkodları vektör görüntü formatlarında kaydedin</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    SQL Server Raporlama Servisleri ile Entegrasyon
                </h2>
                <p>
                    Aspose.BarCode for Reporting Services, Aspose.BarCode for Reporting Services'i Visual Studio Toolbox'a ekleyerek mevcut veya yeni projelere kolayca entegre edilebilir. Araç Kutusu'nda mevcut olduğunda, projede istediğiniz yere sürükleyip bırakabilirsiniz.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Bu barkod API'si, geliştiricilerin barkod türünü, kodlanacak giriş verilerini ve görünümle ilgili özel özellikleri ayarlayarak yüksek kaliteli barkodlar oluşturmasına olanak tanır. Oluşturulan barkodların görünümüne ince ayar yapmak için arka plan ve ön plan renkleri, yazı tipi, boyut, çözünürlük ve metin açıklamaları gibi çeşitli seçenekler sunar.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Özel Barkod Boyutu ve Rengi
                </h2>
                <p>
                    Aspose.BarCode for SQL Reporting Services API, özel parametrelerle barkod görüntüleri oluşturmak için zengin işlevsellik sağlar. Geliştiriciler, iş gereksinimlerine bağlı olarak herhangi bir renk veya boyutta barkod oluşturmak için uygulamalar oluşturabilir. Çubukların renkleri, arka plan, kenarlıklar ve metin başlıkları dahil olmak üzere tüm barkod öğelerinin görünümünü ve konumlarını özelleştirmek mümkündür. Barkod, giriş metni, üst ve/veya alt başlık, dolgular ve kenarlıklar görüntülenerek veya görüntülenmeden oluşturulabilir. Barkod boyutu, X boyutuna bağlı olarak otomatik veya manuel olarak ayarlanabilir. Milimetre, inç, nokta veya piksel gibi çeşitli birimlerde tanımlanabilir. Gerekirse, görüntü oranları ve çözünürlük değiştirilebilir. Metin yazı tipinin boyutu da özelleştirilebilir.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Visual Studio için Barkod Tasarımcısı
                </h2>
                <p>
                    Barkod etiketlerinin düzeni, Visual Studio için tam entegre Barkod Tasarımcısı kullanılarak değiştirilebilir. Geliştiriciler, tasarım zamanında barkod görüntülerini önizleyebilir ve ayarlayabilir. Tasarımcı ayrıca barkod görüntülerinin görünümünü ayarlamak için çeşitli ayarların özelleştirilmesine de izin verir.
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/pdf417/" name="PDF417" description="PDF417 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/qr/" name="QR" description="QR Kodu, GS1 QR Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/datamatrix/" name="Data Matrix" description="Data Matrix kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/aztec/" name="Aztec" description="Aztec Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/swiss-qr/" name="Swiss QR" description="Swiss QR faturası" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/dotcode/" name="DotCode" description="DotCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/hibc/" name="HIBC" description="HIBC (Sağlık Sektörü Barkodu)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/codablock/" name="Codablock-F" description="Codablock-F ve GS1 Codablock-F barkodları" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/databar/" name="GS1 DataBar" description="GS1 DataBar (Çok Yönlü, Yığılmış Çok Yönlü, Genişletilmiş, Genişletilmiş Yığınlanmış ve Kesilmiş) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/itf/" name="ITF" description="Aralıklı 2/5 (ITF) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/ean/" name="EAN" description="EAN (Uluslararası Makale Numarası) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/upc/" name="UPC" description="UPC (Evrensel Ürün Kodu) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/code128/" name="GS1 Code 128" description="GS1 Code 128 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/code39/" name="Code 39" description="Code 39 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/code16k/" name="Code 16K" description="Code 16K barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/code32/" name="Code 32" description="İtalyan Ecza Kodu (Code 32) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/code93/" name="Code 93" description="Code 93 Genişletilmiş ve Code 93 Standart barkodlar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/onecode/" name="USPS OneCode" description="USPS OneCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Endüstriyel 2/5) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/isbn/" name="ISBN" description="ISBN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/ismn/" name="ISMN" description="ISMN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/issn/" name="ISSN" description="ISSN barkod" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/australia-post/" name="Australia Post" description="Australia Post barkod ve Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/deutsche-post/" name="Deutsche Post" description="Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/rm4scc/" name="RM4SCC" description="Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/postnet/" name="Postnet" description="Postnet barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/royal-mail/" name="Royal Mail" description="Royal Mail barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/singapore-post/" name="Singapore Post" description="Singapore Post barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/reporting-services/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Belgeler" href="https://docs.aspose.com/barcode/reportingservices/" >}}
{{< blocks/products/pf/slr-element name="Kaynak kodu" href="https://github.com/aspose-barcode/Aspose.BarCode-for-.NET" >}}
{{< blocks/products/pf/slr-element name="API Referansları" href="https://reference.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/slr-element name="Sürüm notları" href="https://docs.aspose.com/barcode/reportingservices/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Neden SQL Reporting Services için Aspose.BarCode?" tabId="success-stories" >}}
