...
{{% blocks/products/pf/agp/feature-section-col title="PHP Dilinde Code 32 barkod Oluşturma Adımları" %}}
...
<ul><li>Yeni bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak Code 32 barkod ve diğer ilgili barkod türlerini belirtin</li><li>Barkod metnini ikinci parametre olarak ayarlayın</li><li>Gerekirse görüntü boyutlarını ve konumunu belirtin</li><li>Gerekli biçimde İtalyan Ecza Kodu (Code 32) barkodu görüntüsünü elde etmek için BarCodeGenerator.save yöntemini çağırın</li></ul>
