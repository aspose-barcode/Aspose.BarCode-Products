---
title: PHP via Java aracılığıyla QR Kodu, GS1 QR Kodu Görselleri oluşturun
description: PHP tabanlı uygulamalarda QR Kodu, GS1 QR Kodu oluşturmak için PHP kaynak kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/php-java/qr/generate/
aliases:
- /tr/php-java/generate/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PHP via Java ile QR Etiketleri oluşturun" h2="Sunucu tarafı Aspose.BarCode for PHP via Java API'sini kullanarak PHP içinde QR Kodu, GS1 QR Kodu oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="PHP Dilinde QR Kodu Oluşturma Adımları" %}}
...
<ul><li>Yeni bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak QR Kodu ve diğer ilgili barkod türlerini belirtin</li><li>Barkod metnini ikinci parametre olarak ayarlayın</li><li>Gerekirse görüntü boyutlarını ve konumunu belirtin</li><li>Gerekli biçimde QR Kodu, GS1 QR Kodu görüntüsünü elde etmek için BarCodeGenerator.save yöntemini çağırın</li></ul>
