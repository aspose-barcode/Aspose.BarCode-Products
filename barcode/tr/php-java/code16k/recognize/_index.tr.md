---
title: PHP via Java aracılığıyla Code 16K barkod Görsellerini tarayın
weight: 1510
description: PHP tabanlı uygulamalarda Code 16K barkod okumak için PHP örnek kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/php-java/code16k/recognize/
aliases:
- /tr/php-java/recognize/code16k/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PHP via Java ile Code 16K Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for PHP via Java API'sini kullanarak PHP içinde Code 16K barkod okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="PHP'da Code 16K barkod Tarama Adımları" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode, geliştiricilerin birkaç satır kodla akış veya görüntüden Code 16K barkod barkodlarını okumasına olanak tanır

{{% /blocks/products/pf/agp/text %}}

<ul><li>Aspose.BarCode.BarCodeReader sınıfından bir nesne oluşturun</li><li>Parametre olarak Code 16K barkod içeren kaynak görüntü yolunu ayarlayın</li><li>DecodeType'ta hedef barkod türlerini belirtin ikinci parametre olarak</li><li>Okuma sonuçları arasında geçiş yapın</li><li>CodeText özelliğini kullanarak barkod metnini elde edin</li></ul>
