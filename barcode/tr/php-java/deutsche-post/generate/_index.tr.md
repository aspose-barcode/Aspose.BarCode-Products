...
{{% blocks/products/pf/agp/feature-section-col title="PHP Dilinde Deutsche Post barkodu Oluşturma Adımları" %}}
...
<ul><li>Yeni bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak Deutsche Post barkodu ve diğer ilgili barkod türlerini belirtin</li><li>Barkod metnini ikinci parametre olarak ayarlayın</li><li>Gerekirse görüntü boyutlarını ve konumunu belirtin</li><li>Gerekli biçimde Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode görüntüsünü elde etmek için BarCodeGenerator.save yöntemini çağırın</li></ul>
