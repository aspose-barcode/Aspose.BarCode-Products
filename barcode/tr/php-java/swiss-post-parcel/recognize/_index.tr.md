---
title: PHP via Java aracılığıyla Swiss Post Parcel Görsellerini tarayın
weight: 1510
description: PHP tabanlı uygulamalarda Swiss Post Parcel okumak için PHP örnek kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/php-java/swiss-post-parcel/recognize/
aliases:
- /tr/php-java/recognize/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PHP via Java ile Swiss Post Parcel Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for PHP via Java API'sini kullanarak PHP içinde Swiss Post Parcel okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Java tabanlı platformlar için tasarlanmış güçlü, zengin ve kullanıcı dostu bir barkod kitaplığı olan Java aracılığıyla PHP için Aspose.BarCode'u kullanarak PHP uygulamalarında Swiss Post Parcel barkodlarını okuyun. Barkod API'sini denemek için [Aspose sürümleri](https://releases.aspose.com/barcode/php/) portalından en son sürümü almanız gerekir. [aspose/barcode](https://packagist.org/packages/aspose/barcode) paketini Packagist'te de bulabilir ve ardından onu besteci aracılığıyla PHP projenize entegre edebilirsiniz:
...
{{% blocks/products/pf/agp/feature-section-col title="PHP'da Swiss Post Parcel Tarama Adımları" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader sınıfından bir nesne oluşturun</li><li>Parametre olarak Swiss Post Parcel içeren kaynak görüntü yolunu ayarlayın</li><li>DecodeType'ta hedef barkod türlerini belirtin ikinci parametre olarak</li><li>Okuma sonuçları arasında geçiş yapın</li><li>CodeText özelliğini kullanarak barkod metnini elde edin</li></ul>
