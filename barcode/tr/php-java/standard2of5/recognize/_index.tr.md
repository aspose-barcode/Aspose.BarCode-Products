...
{{< blocks/products/pf/upper-banner h1="PHP via Java ile Standard 2 of 5 Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for PHP via Java API'sini kullanarak PHP içinde Standard 2 of 5 (Endüstriyel 2/5) barkod okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="PHP'da Standard 2 of 5 barkod Tarama Adımları" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader sınıfından bir nesne oluşturun</li><li>Parametre olarak Standard 2 of 5 barkod içeren kaynak görüntü yolunu ayarlayın</li><li>DecodeType'ta hedef barkod türlerini belirtin ikinci parametre olarak</li><li>Okuma sonuçları arasında geçiş yapın</li><li>CodeText özelliğini kullanarak barkod metnini elde edin</li></ul>
