---
title: PHP via Java aracılığıyla Standard 2 of 5 (Endüstriyel 2/5) barkod Görselleri oluşturun
description: PHP tabanlı uygulamalarda Standard 2 of 5 (Endüstriyel 2/5) barkod oluşturmak için PHP kaynak kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/php-java/standard2of5/generate/
aliases:
- /tr/php-java/generate/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PHP via Java ile Standard 2 of 5 Etiketleri oluşturun" h2="Sunucu tarafı Aspose.BarCode for PHP via Java API'sini kullanarak PHP içinde Standard 2 of 5 (Endüstriyel 2/5) barkod oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="PHP Dilinde Standard 2 of 5 barkod Oluşturma Adımları" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode, geliştiricilerin birkaç satır kodla Standard 2 of 5 barkod görüntüleri oluşturmasını kolaylaştırır.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Yeni bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak Standard 2 of 5 barkod ve diğer ilgili barkod türlerini belirtin</li><li>Barkod metnini ikinci parametre olarak ayarlayın</li><li>Gerekirse görüntü boyutlarını ve konumunu belirtin</li><li>Gerekli biçimde Standard 2 of 5 (Endüstriyel 2/5) barkod görüntüsünü elde etmek için BarCodeGenerator.save yöntemini çağırın</li></ul>
