---
title: PHP via Java aracılığıyla Australia Post barkod ve Australia Post eParcel Görsellerini tarayın
weight: 1510
description: PHP tabanlı uygulamalarda Australia Post barkod ve Australia Post eParcel okumak için PHP örnek kodu.
lang: tr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /tr/php-java/australia-post/recognize/
aliases:
- /tr/php-java/recognize/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PHP via Java ile Australia Post Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for PHP via Java API'sini kullanarak PHP içinde Australia Post barkod ve Australia Post eParcel okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Australia Post barkodu Using PHP via Java" %}}
Java tabanlı platformlar için tasarlanmış güçlü, zengin ve kullanıcı dostu bir barkod kitaplığı olan Java aracılığıyla PHP için Aspose.BarCode'u kullanarak PHP uygulamalarında Australia Post barkodu barkodlarını okuyun. Barkod API'sini denemek için [Aspose sürümleri](https://releases.aspose.com/barcode/php/) portalından en son sürümü almanız gerekir. [aspose/barcode](https://packagist.org/packages/aspose/barcode) paketini Packagist'te de bulabilir ve ardından onu besteci aracılığıyla PHP projenize entegre edebilirsiniz:
...
{{% blocks/products/pf/agp/feature-section-col title="PHP'da Australia Post barkodu Tarama Adımları" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode, geliştiricilerin birkaç satır kodla akış veya görüntüden Australia Post barkodu barkodlarını okumasına olanak tanır

{{% /blocks/products/pf/agp/text %}}

<ul><li>Aspose.BarCode.BarCodeReader sınıfından bir nesne oluşturun</li><li>Parametre olarak Australia Post barkodu içeren kaynak görüntü yolunu ayarlayın</li><li>DecodeType'ta hedef barkod türlerini belirtin ikinci parametre olarak</li><li>Okuma sonuçları arasında geçiş yapın</li><li>CodeText özelliğini kullanarak barkod metnini elde edin</li></ul>
