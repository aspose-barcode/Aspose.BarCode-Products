---
title: Python via Java aracılığıyla Codablock-F ve GS1 Codablock-F barkodları Görselleri oluşturun
description: Java Runtime Environment kullanarak Codablock-F ve GS1 Codablock-F barkodları oluşturmak için Python örnek kodu.
lang: tr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /tr/python-java/codablock/generate/
aliases:
- /tr/python-java/generate/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Python via Java ile Codablock-F Etiketleri oluşturun" h2="Sunucu tarafı Aspose.BarCode for Python via Java API'sini kullanarak Python içinde Codablock-F ve GS1 Codablock-F barkodları oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python Dilinde Codablock-F barkod Oluşturma Adımları" %}}
...
<ul><li>BarCodeGenerator sınıfından yeni bir nesne oluşturun</li><li>EncodeTypes parametresi olarak istenen barkod türlerini belirleyin</li><li>Giriş metnini ikinci parametre olarak girin</li><li> Oluşturulan Codablock-F ve GS1 Codablock-F barkodları görüntüsünü</li></ul> almak için BarCodeGenerator.save yöntemini çağırın
