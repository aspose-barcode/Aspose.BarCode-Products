...
{{% blocks/products/pf/agp/feature-section-col title="Python Dilinde Code 39 barkod Oluşturma Adımları" %}}
...
<ul><li>BarCodeGenerator sınıfından yeni bir nesne oluşturun</li><li>EncodeTypes parametresi olarak istenen barkod türlerini belirleyin</li><li>Giriş metnini ikinci parametre olarak girin</li><li> Oluşturulan Code 39 barkod görüntüsünü</li></ul> almak için BarCodeGenerator.save yöntemini çağırın
