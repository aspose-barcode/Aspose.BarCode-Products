---
title: Python via Java aracılığıyla Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC) Görsellerini tarayın
weight: 1510
description: Java Runtime Environment kullanılarak Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC) tanıma için Python kaynak kodu.
lang: tr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /tr/python-java/rm4scc/recognize/
aliases:
- /tr/python-java/recognize/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Python via Java ile RM4SCC Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for Python via Java API'sini kullanarak Python içinde Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC) okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python'da Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC) Tarama Adımları" %}}
