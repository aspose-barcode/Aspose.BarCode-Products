---
title: Java aracılığıyla Aztec Kodu Görsellerini tarayın
weight: 1510
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment'ta Aztec Kodu adresini okumak ve kodunu çözmek için Java kaynak kodu.
lang: tr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /tr/java/aztec/recognize/
aliases:
- /tr/java/recognize/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Java ile Aztec Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for Java API'sini kullanarak Java içinde Aztec Kodu okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>BarCodeReader sınıfından yeni bir nesne oluşturun</li><li>Aztec Kodu içeren kaynak dosya yolunu ayarlayın</li><li>Gerekli barkod türlerini ikinci parametre olarak DecodeType'a iletin</li><li>Kod çözme sonuçları arasında geçiş yapın</li><li>getCodeText yöntemini kullanarak barkod metnini alın</li></ul>
