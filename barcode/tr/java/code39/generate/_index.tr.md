...
<ul><li>BarCodeGenerator sınıfından yeni bir nesne oluşturun</li><li>EncodeTypes parametresi olarak Code 39 barkod ve diğer gerekli barkod türlerini tanımlayın</li><li>setCodeText yöntemini kullanarak giriş metnini belirtin</li><li>Oluşturulan barkod görüntüsünü kaydetmek için BarCodeGenerator.save yöntemini kullanın</li></ul>
