---
title: Node.js via Java aracılığıyla Australia Post barkod ve Australia Post eParcel Görsellerini tarayın
weight: 1510
description: JavaScript uygulamalarında Australia Post barkod ve Australia Post eParcel tarama ve kod çözme için Node.js kaynak kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/nodejs-java/australia-post/recognize/
aliases:
- /tr/nodejs-java/recognize/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js via Java ile Australia Post Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for Node.js via Java API'sini kullanarak JavaScript içinde Australia Post barkod ve Australia Post eParcel okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Australia Post barkodu Using Node.js via Java" %}}
Node.js uygulamalarında Australia Post barkodu'yi tanımak için, Java tabanlı ortamlar için sunulan sağlam, çok yönlü ve kullanıcı dostu bir barkod kitaplığı olan Aspose.BarCode for Node.js via Java kullanın. Javascript için doğrudan NPM'den [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) yükleyebilirsiniz:
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript'da Australia Post barkodu Tarama Adımları" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader sınıfından bir nesne oluşturun</li><li>Parametre olarak Australia Post barkodu içeren kaynak dosya yolunu iletin</li><li>DecodeType'ta hedef barkod türlerini ayarlayın ikinci parametre olarak</li><li>Algılanan tüm barkodlar arasında geçiş yapın</li><li>CodeText özelliğini kullanarak elde edilen barkod metnini getirin</li></ul>
