---
title: Node.js via Java aracılığıyla Aztec Kodu Görsellerini tarayın
weight: 1510
description: JavaScript uygulamalarında Aztec Kodu tarama ve kod çözme için Node.js kaynak kodu.
lang: tr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /tr/nodejs-java/aztec/recognize/
aliases:
- /tr/nodejs-java/recognize/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js via Java ile Aztec Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for Node.js via Java API'sini kullanarak JavaScript içinde Aztec Kodu okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Aztec Kodu Using Node.js via Java" %}}
Node.js uygulamalarında Aztec Kodu'yi tanımak için, Java tabanlı ortamlar için sunulan sağlam, çok yönlü ve kullanıcı dostu bir barkod kitaplığı olan Aspose.BarCode for Node.js via Java kullanın. Javascript için doğrudan NPM'den [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) yükleyebilirsiniz:
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript'da Aztec Kodu Tarama Adımları" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode, geliştiricilerin birkaç satır kodla akış veya görüntüden Aztec Kodu barkodlarını okumasına olanak tanır

{{% /blocks/products/pf/agp/text %}}

<ul><li>Aspose.BarCode.BarCodeReader sınıfından bir nesne oluşturun</li><li>Parametre olarak Aztec Kodu içeren kaynak dosya yolunu iletin</li><li>DecodeType'ta hedef barkod türlerini ayarlayın ikinci parametre olarak</li><li>Algılanan tüm barkodlar arasında geçiş yapın</li><li>CodeText özelliğini kullanarak elde edilen barkod metnini getirin</li></ul>
