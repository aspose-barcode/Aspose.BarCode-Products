...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript Dilinde Code 39 barkod Oluşturma Adımları" %}}
...
<ul><li>Bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak Code 39 barkod ayarlayın</li><li>Kodlanacak metni ikinci parametre olarak tanımlayın</li><li>Gerekirse barkod boyutlarını ve konumunu belirleyin</li><li>Oluşturulan barkod görüntüsünü almak için BarCodeGenerator.save yöntemini çağırın</li></ul>
