---
title: Node.js via Java aracılığıyla Swiss Post Parcel Görselleri oluşturun
description: JavaScript uygulamalarında Swiss Post Parcel nesli için Node.js örnek kodu.
lang: tr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /tr/nodejs-java/swiss-post-parcel/generate/
aliases:
- /tr/nodejs-java/generate/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js via Java ile Swiss Post Parcel Etiketleri oluşturun" h2="Sunucu tarafı Aspose.BarCode for Node.js via Java API'sini kullanarak JavaScript içinde Swiss Post Parcel oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript Dilinde Swiss Post Parcel Oluşturma Adımları" %}}
...
<ul><li>Bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak Swiss Post Parcel ayarlayın</li><li>Kodlanacak metni ikinci parametre olarak tanımlayın</li><li>Gerekirse barkod boyutlarını ve konumunu belirleyin</li><li>Oluşturulan barkod görüntüsünü almak için BarCodeGenerator.save yöntemini çağırın</li></ul>
