---
title: Node.js via Java aracılığıyla Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC) Görselleri oluşturun
description: JavaScript uygulamalarında Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC) nesli için Node.js örnek kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/nodejs-java/rm4scc/generate/
aliases:
- /tr/nodejs-java/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js via Java ile RM4SCC Etiketleri oluşturun" h2="Sunucu tarafı Aspose.BarCode for Node.js via Java API'sini kullanarak JavaScript içinde Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC) oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC) Using Node.js via Java" %}}
Node.js uygulamalarında Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC) barkodları oluşturmak için, Java odaklı platformlar için tasarlanmış gelişmiş, güçlü ve kullanıcı dostu bir barkod API'si olan Java aracılığıyla Aspose.BarCode for Node.js'yi edinin. Javascript için NPM'den [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) kolayca yükleyebilirsiniz:
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript Dilinde Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC) Oluşturma Adımları" %}}
...
<ul><li>Bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC) ayarlayın</li><li>Kodlanacak metni ikinci parametre olarak tanımlayın</li><li>Gerekirse barkod boyutlarını ve konumunu belirleyin</li><li>Oluşturulan barkod görüntüsünü almak için BarCodeGenerator.save yöntemini çağırın</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/pdf417/generate/" name="PDF417" description="PDF417 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/qr/generate/" name="QR" description="QR Kodu, GS1 QR Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/datamatrix/generate/" name="Data Matrix" description="Data Matrix kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/aztec/generate/" name="Aztec" description="Aztec Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/swiss-qr/generate/" name="Swiss QR" description="Swiss QR faturası" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/dotcode/generate/" name="DotCode" description="DotCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/hibc/generate/" name="HIBC" description="HIBC (Sağlık Sektörü Barkodu)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/codablock/generate/" name="Codablock-F" description="Codablock-F ve GS1 Codablock-F barkodları" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/databar/generate/" name="GS1 DataBar" description="GS1 DataBar (Çok Yönlü, Yığılmış Çok Yönlü, Genişletilmiş, Genişletilmiş Yığınlanmış ve Kesilmiş) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/itf/generate/" name="ITF" description="Aralıklı 2/5 (ITF) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/ean/generate/" name="EAN" description="EAN (Uluslararası Makale Numarası) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/upc/generate/" name="UPC" description="UPC (Evrensel Ürün Kodu) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/code128/generate/" name="GS1 Code 128" description="GS1 Code 128 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/code39/generate/" name="Code 39" description="Code 39 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/code16k/generate/" name="Code 16K" description="Code 16K barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/code32/generate/" name="Code 32" description="İtalyan Ecza Kodu (Code 32) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/code93/generate/" name="Code 93" description="Code 93 Genişletilmiş ve Code 93 Standart barkodlar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/onecode/generate/" name="USPS OneCode" description="USPS OneCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/standard2of5/generate/" name="Standard 2 of 5" description="Standard 2 of 5 (Endüstriyel 2/5) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/isbn/generate/" name="ISBN" description="ISBN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/ismn/generate/" name="ISMN" description="ISMN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/issn/generate/" name="ISSN" description="ISSN barkod" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/australia-post/generate/" name="Australia Post" description="Australia Post barkod ve Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/rm4scc/generate/" name="RM4SCC" description="Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/postnet/generate/" name="Postnet" description="Postnet barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/royal-mail/generate/" name="Royal Mail" description="Royal Mail barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/singapore-post/generate/" name="Singapore Post" description="Singapore Post barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
