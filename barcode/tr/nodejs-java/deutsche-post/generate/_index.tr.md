...
{{% blocks/products/pf/agp/content h2="How to Generate Deutsche Post barkodu Using Node.js via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript Dilinde Deutsche Post barkodu Oluşturma Adımları" %}}
...
<ul><li>Bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak Deutsche Post barkodu ayarlayın</li><li>Kodlanacak metni ikinci parametre olarak tanımlayın</li><li>Gerekirse barkod boyutlarını ve konumunu belirleyin</li><li>Oluşturulan barkod görüntüsünü almak için BarCodeGenerator.save yöntemini çağırın</li></ul>
