---
title: Node.js via Java aracılığıyla GS1 Code 128 barkod Görsellerini tarayın
weight: 1510
description: JavaScript uygulamalarında GS1 Code 128 barkod tarama ve kod çözme için Node.js kaynak kodu.
lang: tr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /tr/nodejs-java/code128/recognize/
aliases:
- /tr/nodejs-java/recognize/code128/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js via Java ile GS1 Code 128 Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for Node.js via Java API'sini kullanarak JavaScript içinde GS1 Code 128 barkod okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 Code 128 barkod Using Node.js via Java" %}}
Node.js uygulamalarında GS1 Code 128 barkod'yi tanımak için, Java tabanlı ortamlar için sunulan sağlam, çok yönlü ve kullanıcı dostu bir barkod kitaplığı olan Aspose.BarCode for Node.js via Java kullanın. Javascript için doğrudan NPM'den [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) yükleyebilirsiniz:
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript'da GS1 Code 128 barkod Tarama Adımları" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode, geliştiricilerin birkaç satır kodla akış veya görüntüden GS1 Code 128 barkod barkodlarını okumasına olanak tanır

{{% /blocks/products/pf/agp/text %}}

<ul><li>Aspose.BarCode.BarCodeReader sınıfından bir nesne oluşturun</li><li>Parametre olarak GS1 Code 128 barkod içeren kaynak dosya yolunu iletin</li><li>DecodeType'ta hedef barkod türlerini ayarlayın ikinci parametre olarak</li><li>Algılanan tüm barkodlar arasında geçiş yapın</li><li>CodeText özelliğini kullanarak elde edilen barkod metnini getirin</li></ul>
