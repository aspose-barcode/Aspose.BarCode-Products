---
title: Nodejs Barkod Tarayıcı ve Oluşturucu API'sı
description: 1D, 2D ve Posta türleri için Node.js barkod tarama ve oluşturma kitaplığı. QR Code maxicode Aztec Code128 EAN-128 ve daha fazlası için React Angular uygulamalarına kolayca entegre edin.
lang: tr/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Node.js Barkod Oluşturucu ve Tarayıcı API'sı" h2="Farklı görüntülerden Code128, Code93, Code39, QR Code dahil olmak üzere 1D, 2D ve Posta barkodlarını tanıyın veya oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" pfName="Aspose.BarCode" subTitlepfName="Node.js via Java için" downloadUrl="https://releases.aspose.com/barcode/nodejs/" >}}
...
<p>Aspose.BarCode for Node.js via Java, kolaylıkla özelleştirilebilir bir barkod oluşturucu ve kod çözücü API'sidir. Geliştiriciler, barkod oluşturma ve okuma işlevini nodejs-java köprüsü aracılığıyla uygulamalarına entegre edebilirler. Herhangi bir açıdan görüntülerden yaygın 1D, 2D ve posta barkodlarını okumak için kullanılabilir. Bu barkod kitaplığı, geliştiricilerin 60'tan fazla türde barkod görüntüsü oluşturmasına ve bunları JPG, PNG, GIF, BMP ve TIFF gibi çeşitli biçimlerde kaydetmesine olanak tanır. Barkod sınır rengi ve stili, kenar boşlukları, döndürme açısı, çözünürlük ve barkod rengi gibi farklı görüntüleme özelliklerinin özelleştirilmesini destekler.</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="Bir Bakışta" description="API'nin barkod tanıma ve oluşturma özelliklerine genel bakış." >}}
<div class='diagram1 d1-nodejs'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>Doğrusal, 2D ve Posta</li><li>Akış veya Görüntüden Tespit Et</li><li>Barkodun Yönünü Al</li><li>İngilizce Olmayan Karakterlerin Kodunu Çöz</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                Baskı
            </header>
            <ul><li>Doğrudan Barkod Yazdır</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>Doğrusal, 2B ve Posta</li><li>Akışa veya Görüntüye Kaydet</li><li>Görünümü Özelleştir&colon; Boyut, Renk, Açı</li><li>İngilizce Olmayan Karakterleri Kodla </li></ul>
            <header>
                <i class="fa fa-qrcode">
                </i>
                Türler
            </header>
            <ul><li>Doğrusal</li><li>2B</li><li>Posta</li></ul>
        </div>
        <!--/right-->
    </div>
    <!--/row-->
...
{{< blocks/products/pf/carousel-item h3="Platform Bağımsızlığı" description="Aspose.BarCode for Node.js via Java, Node.js tabanlı bir sunucu tarafı JavaScript API'sidir. JDK 1.7 veya üzeri Windows, Unix/Linux ve Mac platformlarında çalışabilir." >}}
<div class='diagram1 d1-nodejs'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Desteklenen Dosya Biçimleri" description="Node.js via Java için Aspose.BarCode, en sık kullanılan görüntü dosyası biçimleriyle çalışır." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Gelişmiş Node.js Barkod API Özellikleri
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/nodejsjava/supported-barcode-types-and-formats/#barcode-types'>60'tan fazla barkod türü oluşturun ve tarayın</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/nodejsjava/set-barcode-text/'>Barkod başlığını ve yazı tipi stillerini özelleştirin</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/nodejsjava/barcode-reading-settings/#checksum-verification'>Sağlama Toplamı Doğrulaması Gerçekleştirin</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    İsviçre QR Kodu Oluştur
                </h2>
                <p>
                    Barkod kütüphanesi, 2D barkodlar ve QR kodlarının yanı sıra, İsviçre QR kodlarının oluşturulmasını ve okunmasını sağlar. QR (Hızlı Yanıt) kodu spesifikasyonuna dayalıdır ve İsviçre'de işletmeler ile bireyler arasındaki ödemeleri kolaylaştırmak için kullanılır. QR kodları, bilgilere hızlı ve kolay bir şekilde erişmek veya bir eylemi gerçekleştirmek için bir akıllı telefon veya başka bir cihazla taranabilen iki boyutlu barkodlardır. İsviçre QR kodları, İsviçre'de elektronik ödemeler için ulusal bir standarttır. İşletmeler tarafından müşterilerden ödeme almak için kullanılırlar. Bir müşteri bir İsviçre QR kodunu taradığında kendisine ödeme bilgileri verilir ve mobil bankacılık uygulamasından ödeme başlatabilir. Bu, işletmelerin müşterilerinden ödeme kabul etmesi için uygun ve güvenli bir yol sağlar. İsviçre QR kodları, perakende, konaklama ve sağlık hizmetleri dahil olmak üzere çeşitli sektörlerde yaygın olarak kullanılmaktadır. Bir İsviçre QR kodu oluşturmak için işletme adınız, banka hesap bilgileriniz ve ödeme tutarı gibi gerekli bilgileri sağlamanız gerekir. Aspose QR Code oluşturucu, bu bilgiyi bir İsviçre QR kodu oluşturmak için kullanacaktır ve bu kod daha sonra müşterileriniz tarafından bir ödeme başlatmak için taranabilir. QR kodu oluşturulduktan sonra indirebilir ve müşterilerinizden ödeme almak için işletmenizde kullanabilirsiniz.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    QR Kodu Oluşturma Canlı Örneği
                </h2>
                <p>
                    Barkod kitaplığı, geliştiricilerin Data Matrix, Aztec Code, PDF417, Macro PDF417 ve diğerleri dahil olmak üzere çok çeşitli 2B barkodlar oluşturmasına olanak tanır. Uzun veya karmaşık veri değerleri içeren büyük veya çoklu barkodlar oluşturmak için özellikle kullanışlıdır. Kitaplık, oluşturulacak barkod türünü belirlemek, depolanacak girdi verilerini girmek ve görünümle ilgili parametreleri ayarlamak için basit ve sezgisel bir arabirim sağlar. Bu, onu çeşitli uygulamalar için yüksek kaliteli barkodlar oluşturmak için kullanıcı dostu ve güçlü bir araç haline getirir. Aşağıdaki kod örneği, QR kodlarının nasıl oluşturulacağını gösterir.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Barkod Okumayı Optimize Edin
                </h2>
                <p>
                    Aspose.Barcode for C++, çok çeşitli uygulamalarda barkodlarla çalışmak için kapsamlı bir barkod kitaplığıdır. En önemli özelliklerinden biri, barkod algılamanın hem kalitesini hem de hızını optimize etmek için tanıma sürecine ince ayar yapma yeteneğidir. Kitaplık, bir uygulamanın özel gereksinimlerine bağlı olarak barkod taramayı optimize etmek için kullanılabilecek çeşitli gelişmiş ayarlar sunar. Örneğin, kitaplık, yüksek kaliteli doğrusal barkodların hızlı taranmasını sağlayan özel okuma modları sağlar. Bu, büyük hacimli barkod verilerini hızlı bir şekilde işlemesi gereken uygulamalarda yararlı olabilir. Ayrıca kitaplık, geliştiricilerin görüntünün en alakalı alanlarına odaklanarak taramanın doğruluğunu artırabilen hedef tarama bölgelerini ve barkod türlerini belirlemesine olanak tanır. API ayrıca tek bir görüntüde birden çok barkodun algılanmasını da destekler; bu, aynı anda birden çok barkodu işlemesi gereken uygulamalarda yararlı olabilir.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
    ...
    <div class="barcode-read-lcs-controls">
        ...
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">Her türlü</option>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/pdf417/" name="PDF417" description="PDF417 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/qr/" name="QR" description="QR Kodu, GS1 QR Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/datamatrix/" name="Data Matrix" description="Data Matrix kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/aztec/" name="Aztec" description="Aztec Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/swiss-qr/" name="Swiss QR" description="Swiss QR faturası" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/dotcode/" name="DotCode" description="DotCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/hibc/" name="HIBC" description="HIBC (Sağlık Sektörü Barkodu)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/codablock/" name="Codablock-F" description="Codablock-F ve GS1 Codablock-F barkodları" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/databar/" name="GS1 DataBar" description="GS1 DataBar (Çok Yönlü, Yığılmış Çok Yönlü, Genişletilmiş, Genişletilmiş Yığınlanmış ve Kesilmiş) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/itf/" name="ITF" description="Aralıklı 2/5 (ITF) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/ean/" name="EAN" description="EAN (Uluslararası Makale Numarası) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/upc/" name="UPC" description="UPC (Evrensel Ürün Kodu) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/code128/" name="GS1 Code 128" description="GS1 Code 128 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/code39/" name="Code 39" description="Code 39 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/code16k/" name="Code 16K" description="Code 16K barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/code32/" name="Code 32" description="İtalyan Ecza Kodu (Code 32) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/code93/" name="Code 93" description="Code 93 Genişletilmiş ve Code 93 Standart barkodlar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/onecode/" name="USPS OneCode" description="USPS OneCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Endüstriyel 2/5) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/isbn/" name="ISBN" description="ISBN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/ismn/" name="ISMN" description="ISMN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/issn/" name="ISSN" description="ISSN barkod" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/australia-post/" name="Australia Post" description="Australia Post barkod ve Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/rm4scc/" name="RM4SCC" description="Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/postnet/" name="Postnet" description="Postnet barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/royal-mail/" name="Royal Mail" description="Royal Mail barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/singapore-post/" name="Singapore Post" description="Singapore Post barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/nodejs-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="İnsanlar ne diyor" subTitle="Sadece bizim sözümüze güvenmeyin. Kullanıcıların API'ler hakkında söylediklerini görün." caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 Ürünümü geliştirmek ve geliştirmek için uzun yıllar harcadım ve Aspose, ürünümü çok daha kolay ve kullanışlı ve dolayısıyla daha pazarlanabilir hale getirmemi sağladı. <em>Kiel Diller | KD Solutions, Polonya</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode, gerçekten yönetilen kodla yazılmıştır ve bize her türlü belge tanıma ve ileri işleme işlemlerini gerçekleştirmemiz için çeşitli barkod türleri sunar. <em>Dennis Alexander Petrasc | Keil IT, Almanya</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Belgeler" href="https://docs.aspose.com/barcode/nodejsjava/" >}}
{{< blocks/products/pf/slr-element name="Kaynak kodu" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="API Referansları" href="https://reference.aspose.com/barcode/nodejs/" >}}
...
{{< blocks/products/pf/slr-element name="Sürüm notları" href="https://docs.aspose.com/barcode/nodejsjava/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Neden Node.js via Java için Aspose.BarCode?" tabId="success-stories" >}}
{{< blocks/products/pf/slr-element name="Müşteri Listesi" href="https://about.aspose.com/customers" >}}
{{< blocks/products/pf/slr-element name="Başarı Öyküleri" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Aspose.BarCode, aşağıda listelenen diğer popüler geliştirme ortamları için bireysel Barkod oluşturma ve tanıma API'leri sunar:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/barcode/tr/java/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sdkName="Java" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/barcode/tr/jasperreports/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg" sdkName="JasperReports" >}}
