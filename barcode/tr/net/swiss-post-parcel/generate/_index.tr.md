---
title: .NET aracılığıyla Swiss Post Parcel Görselleri oluşturun
description: .NET Framework, .NET Standard, PHP için COM Interloop, VBScript, Delphi ve C++'da Swiss Post Parcel nesli için C# kaynak kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/net/swiss-post-parcel/generate/
aliases:
- /tr/net/generate/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET ile Swiss Post Parcel Etiketleri oluşturun" h2="Sunucu tarafı Aspose.BarCode for .NET API'sini kullanarak C# içinde Swiss Post Parcel oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>BarcodeGenerator sınıfının bir örneğini oluşturun</li><li>Parametre olarak Swiss Post Parcel iletin</li><li>Metni ikinci parametre olarak kodlamak için ayarlayın</li><li> Gerekirse barkod boyutlarını belirtin</li><li>Swiss Post Parcel görüntüsünü elde etmek için BarcodeGenerator.Save yöntemini çağırın</li></ul>
