---
title: .NET aracılığıyla QR Kodu, GS1 QR Kodu Görselleri oluşturun
description: .NET Framework, .NET Standard, PHP için COM Interloop, VBScript, Delphi ve C++'da QR Kodu, GS1 QR Kodu nesli için C# kaynak kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/net/qr/generate/
aliases:
- /tr/net/generate/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET ile QR Etiketleri oluşturun" h2="Sunucu tarafı Aspose.BarCode for .NET API'sini kullanarak C# içinde QR Kodu, GS1 QR Kodu oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>BarcodeGenerator sınıfının bir örneğini oluşturun</li><li>Parametre olarak QR Kodu, GS1 QR Kodu iletin</li><li>Metni ikinci parametre olarak kodlamak için ayarlayın</li><li> Gerekirse barkod boyutlarını belirtin</li><li>QR Kodu, GS1 QR Kodu görüntüsünü elde etmek için BarcodeGenerator.Save yöntemini çağırın</li></ul>
