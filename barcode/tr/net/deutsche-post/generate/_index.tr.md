...
<ul><li>BarcodeGenerator sınıfının bir örneğini oluşturun</li><li>Parametre olarak Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode iletin</li><li>Metni ikinci parametre olarak kodlamak için ayarlayın</li><li> Gerekirse barkod boyutlarını belirtin</li><li>Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode görüntüsünü elde etmek için BarcodeGenerator.Save yöntemini çağırın</li></ul>
