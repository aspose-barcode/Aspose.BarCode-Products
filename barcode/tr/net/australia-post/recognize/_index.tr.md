---
title: .NET aracılığıyla Australia Post barkod ve Australia Post eParcel Görsellerini tarayın
weight: 1510
description: .NET Framework, .NET Standard, PHP için COM Interloop, VBScript, Delphi veya C++'da Australia Post barkod ve Australia Post eParcel barkod türünü taramak ve kodunu çözmek için C# örnek kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/net/australia-post/recognize/
aliases:
- /tr/net/recognize/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET ile Australia Post Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for .NET API'sini kullanarak C# içinde Australia Post barkod ve Australia Post eParcel okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Aspose.BarCode.BarCodeReader sınıfının yeni bir örneğini oluşturun</li><li>Parametre olarak Australia Post barkodu içeren kaynak görüntü yolunu iletin</li><li>Uygun bir DecodeType'ı şu şekilde iletin ikinci parametre</li><li>Kod çözme sonuçları arasında geçiş yapın</li><li>CodeText özelliğini kullanarak barkod metnini alın</li></ul>
