...
{{< blocks/products/pf/upper-banner h1="Barkod oluşturucu ve okuyucu API'si" h2="Herhangi bir .NET uygulamasında doğrusal, 2B ve posta tipi barkodlar oluşturun ve tanıyın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" pfName="Aspose.BarCode" subTitlepfName=".NET için" downloadUrl="https://releases.aspose.com/barcode/net/" >}}
...
<p>Aspose.BarCode for .NET, çeşitli görüntü türlerinden 1B ve 2B barkodları her açıdan oluşturmak ve tanımak için güçlü bir geliştirme kitaplığıdır. Geliştiriciler, .NET uygulamalarına kolayca barkod oluşturma ve tarama işlevi ekleyebilir. Bu API, oluşturulan barkodların farklı yüksek kaliteli görüntü biçimlerine aktarılmasına izin verir.</p><p>Aspose.BarCode for .NET, oluşturulan barkodların görünümünün ve arka plan rengi, çubuk rengi, dönüş açısı, x gibi parametrelerinin değiştirilmesini sağlar boyut, görüntü kalitesi, çözünürlük, altyazılar, boyut ve diğerleri. Ayrıca zengin barkod algılama ve okuma işlevi sağlar ve 60'tan fazla barkod türünü destekler.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Platform Bağımsızlığı" description="ASP.NET, WinForms, WPF, .NET Standard ve daha fazlasını içeren herhangi bir 32 bit veya 64 bit .NET uygulaması oluşturmak için kitaplığı kullanabilirsiniz." >}}
<div class='diagram1 d1-net'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Desteklenen Dosya Biçimleri" description=".NET için Aspose.BarCode, en sık kullanılan görüntü dosyası biçimleriyle çalışır." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/saving-barcode-image/'>Barkod etiketlerini çeşitli biçimlerde kaydedin</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/read-barcodes-with-aspose-barcode-apis/#setting-barcode-recognition-source'>Akıştan veya dosyadan tanıma</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/qr-and-micro-qr-barcode/#eciencoding-mode'>2B türlerde karakterleri (ingilizce olmayan) kodlayın ve kodunu çözün</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/image-formatting-and-display-settings/'>Barkod resimlerini herhangi bir açıda döndürün</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/how-to-read-barcode-from-multi-page-tiff-images/'>Çok sayfalı TIFF'den barkodları tarayın</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/barcode-types-and-image-formats/'>Lineer, 2D ve posta sembolojileri için destek</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    .NET için barkod API'si, geliştiricilerin barkod türünü, giriş metnini, yazı tipi stilini, arka plan ve ön plan renklerini, altyazı hizalamasını ve konumunu ve diğer özellikleri belirterek oluşturulan barkodların görünümünde ince ayar yapmasına olanak tanır. Üst ve alt başlıklar, yazı tipi, renkler ve hizalama için görünürlüğünü ayarlayarak resim yazısını değiştirebilirsiniz.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Barkod oluşturucu API'si, geliştiricilerin gerekli barkod türünü belirleyerek, giriş metnini ayarlayarak (barkod görüntüsünde kodlanacak veriler) ve arka plan ve ön plan rengi, yazı tipi, metin konumu (gizle, yukarıda veya aşağıda) ve hizalama. QR Kodu, PDF417, Data Matrix, Aztec Code vb. gibi iki boyutlu barkodlar, tek boyutlu barkodlarla aynı şekilde.
                </p>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/pdf417/" name="PDF417" description="PDF417 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/qr/" name="QR" description="QR Kodu, GS1 QR Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/datamatrix/" name="Data Matrix" description="Data Matrix kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/aztec/" name="Aztec" description="Aztec Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/swiss-qr/" name="Swiss QR" description="Swiss QR faturası" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/dotcode/" name="DotCode" description="DotCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/hibc/" name="HIBC" description="HIBC (Sağlık Sektörü Barkodu)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/codablock/" name="Codablock-F" description="Codablock-F ve GS1 Codablock-F barkodları" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/databar/" name="GS1 DataBar" description="GS1 DataBar (Çok Yönlü, Yığılmış Çok Yönlü, Genişletilmiş, Genişletilmiş Yığınlanmış ve Kesilmiş) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/itf/" name="ITF" description="Aralıklı 2/5 (ITF) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/ean/" name="EAN" description="EAN (Uluslararası Makale Numarası) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/upc/" name="UPC" description="UPC (Evrensel Ürün Kodu) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/code128/" name="GS1 Code 128" description="GS1 Code 128 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/code39/" name="Code 39" description="Code 39 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/code16k/" name="Code 16K" description="Code 16K barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/code32/" name="Code 32" description="İtalyan Ecza Kodu (Code 32) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/code93/" name="Code 93" description="Code 93 Genişletilmiş ve Code 93 Standart barkodlar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/onecode/" name="USPS OneCode" description="USPS OneCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Endüstriyel 2/5) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/isbn/" name="ISBN" description="ISBN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/ismn/" name="ISMN" description="ISMN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/issn/" name="ISSN" description="ISSN barkod" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/australia-post/" name="Australia Post" description="Australia Post barkod ve Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/rm4scc/" name="RM4SCC" description="Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/postnet/" name="Postnet" description="Postnet barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/royal-mail/" name="Royal Mail" description="Royal Mail barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/singapore-post/" name="Singapore Post" description="Singapore Post barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Belgeler" href="https://docs.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/slr-element name="Sürüm notları" href="https://docs.aspose.com/barcode/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Neden .NET için Aspose.BarCode?" tabId="success-stories" >}}
