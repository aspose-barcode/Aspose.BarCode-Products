---
title: .NET aracılığıyla ISSN barkod Görsellerini tarayın
weight: 1510
description: .NET Framework, .NET Standard, PHP için COM Interloop, VBScript, Delphi veya C++'da ISSN barkod barkod türünü taramak ve kodunu çözmek için C# örnek kodu.
lang: tr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /tr/net/issn/recognize/
aliases:
- /tr/net/recognize/issn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET ile ISSN Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for .NET API'sini kullanarak C# içinde ISSN barkod okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISSN" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Aspose.BarCode.BarCodeReader sınıfının yeni bir örneğini oluşturun</li><li>Parametre olarak ISSN barkod içeren kaynak görüntü yolunu iletin</li><li>Uygun bir DecodeType'ı şu şekilde iletin ikinci parametre</li><li>Kod çözme sonuçları arasında geçiş yapın</li><li>CodeText özelliğini kullanarak barkod metnini alın</li></ul>
