...
<ul><li>Yeni bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak Aralıklı 2/5 (ITF) barkod barkod türünü iletin</li><li>setCodeText yöntemini kullanarak barkod metnini tanımlayın</li><li>Aralıklı 2/5 (ITF) barkod barkod görüntüsünü kaydetmek için createBarCodeImage() yöntemini başlatın</li></ul>
