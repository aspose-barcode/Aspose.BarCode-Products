---
title: Android via Java aracılığıyla Aralıklı 2/5 (ITF) barkod Görsellerini tarayın
weight: 1510
description: Android Çalışma Zamanı Ortamında Aralıklı 2/5 (ITF) barkod ailesini tanımak için Android örnek kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/android-java/itf/recognize/
aliases:
- /tr/android-java/recognize/itf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Android via Java ile ITF Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for Android via Java API'sini kullanarak Java içinde Aralıklı 2/5 (ITF) barkod okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java'da Aralıklı 2/5 (ITF) barkod Tarama Adımları" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode, geliştiricilerin birkaç satır kodla akış veya görüntüden Aralıklı 2/5 (ITF) barkod barkodlarını okumasına olanak tanır

{{% /blocks/products/pf/agp/text %}}

<ul><li>Bir BarCodeReader sınıfı örneği oluşturun</li><li>Aralıklı 2/5 (ITF) barkod içeren kaynak görüntü yolunu belirleyin</li><li>İkinci parametre olarak DecodeType'ta hedef barkod türlerini tanımlayın</li><li>Tanıma sonuçları arasında geçiş yapın</li><li>getCodeText yöntemini çalıştırarak kodu çözülmüş metni yükleyin</li></ul>
