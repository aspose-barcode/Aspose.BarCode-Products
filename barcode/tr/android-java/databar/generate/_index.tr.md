...
{{% blocks/products/pf/agp/feature-section-col title="Java Dilinde GS1 DataBar barkod Oluşturma Adımları" %}}
...
<ul><li>Yeni bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak GS1 DataBar barkod barkod türünü iletin</li><li>setCodeText yöntemini kullanarak barkod metnini tanımlayın</li><li>GS1 DataBar (Çok Yönlü, Yığılmış Çok Yönlü, Genişletilmiş, Genişletilmiş Yığınlanmış ve Kesilmiş) barkod barkod görüntüsünü kaydetmek için createBarCodeImage() yöntemini başlatın</li></ul>
