---
title: Barkod Android API | Barkodları Tarayın veya Oluşturun
description: Farklı 1D, 2D ve posta barkod türlerini tanımak için Android barkod tarayıcı kitaplığı. Android uygulamalarında barkodları herhangi bir açıda tarayın.
lang: tr/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Barkod Oluşturma ve Tanıma için Android API'leri" h2="Herhangi bir Android mobil uygulamasında görüntülerden 1 boyutlu, 2 boyutlu ve posta barkodları oluşturun veya okuyun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" pfName="Aspose.BarCode" subTitlepfName="Android via Java için" downloadUrl="https://releases.aspose.com/barcode/androidjava/" >}}
...
<p>Aspose.BarCode for Android via Java, Android uygulamaları için bir barkod oluşturma ve okuma API'sidir. Farklı açılardan görüntülerden 1D, 2D ve posta barkodlarını taramayı destekler. Barkod oluşturucu API'si, kolayca barkod görüntüleri oluşturabilir ve bunları çeşitli biçimlerde kaydedebilir. Ayrıca barkod kenarlıklarının, rengin, dönüş açısının, çözünürlüğün ve çok daha fazlasının özelleştirilmesi gibi zengin görüntüleme işlevleri sağlar.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Platform Bağımsızlığı" description="Android Runtime Environment'ın mevcut olduğu herhangi bir platformda API kullanın." >}}
<div class='diagram1 d1-android'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Desteklenen Dosya Biçimleri" description="Android via Java için Aspose.BarCode, en sık kullanılan görüntü dosyası biçimleriyle çalışır." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Gelişmiş Android Barkod API Özellikleri
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/qr-code-generation/'>İngilizce olmayan karakterleri QR kodlarında kodlayın</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-color-modification/'>Barkod renk düzenini değiştir</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-appearance-customization/'>Barkod resimlerini herhangi bir açıda döndürün</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/working-with-barcode-types/'>60'tan fazla türde barkod oluşturun ve tanıyın</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/recognition-settings/'>Görüntülerden barkodları okuyun</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-image-saving/'>Barkodları çeşitli görüntü formatlarında dışa aktarın</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Özel Barkodlar Oluşturun
                </h2>
                <p>
                    Android via Java için barkod kitaplığı, geliştiricilerin barkod türü, kodlanacak veriler, barkod boyutu, yazı tipi stili ve rengi ve yönlendirme açısı dahil olmak üzere bazı genel barkod parametrelerini özelleştirmesine olanak tanır. Bir barkod oluşturmak için, örneğin UPC veya EAN gibi, oluşturmak için gereken barkod türünü seçmeniz gerekir. Ürün numarası veya URL gibi barkodda saklanacak verileri de girmeniz gerekir. Ek olarak, gerekli boyutlandırma modunu ayarlayabilir ve barkod öğelerinin rengini, çözünürlüğü, kenarlık stilini ve diğer görünümle ilgili parametreleri ayarlayabilirsiniz. Çubukların genişliğini ve aralarındaki mesafeyi değiştirmek mümkündür. Bu ek parametreler, barkodların okunabilirliğini ve kalitesini etkileyebilir, bu nedenle amaçlarını anlamak ve doğru şekilde nasıl ayarlayacaklarını anlamak önemlidir.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Barkod oluşturucu API'si, gerekli türü belirterek, giriş metnini ayarlayarak (bir barkodda kodlanacak veriler) ve arka plan ve ön plan rengi, yazı tipi ve metin açıklamaları gibi görünümle ilgili özellikleri özelleştirerek barkodlar oluşturabilir. PDF417, Data Matrix, Aztec Code, QR Code ve Micro QR Code gibi iki boyutlu barkodlar, 1 boyutlu türlerle aynı şekilde oluşturulabilir.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Barkod Tarayıcı ve Kod Çözücü
                </h2>
                <p>
                    Barkod API'si, 60'tan fazla popüler 1D ve 2D türündeki barkodların algılanmasını ve okunmasını sağlar. Barkodları taramak için yalnızca birkaç satır kod gerektirir ve bu işlevi uygulamalarınıza entegre etmeyi kolaylaştırır. Bu güçlü özellik, görüntüler, belgeler vb. gibi çok çeşitli kaynaklardan barkodları taramanıza ve okumanıza olanak tanır. İşlemleri otomatikleştirmek, hata riskini azaltmak ve operasyonların genel verimliliğini artırmak için kullanılabilir. Perakende, lojistik, sağlık veya başka herhangi bir alan için uygulama geliştirmeniz gerekip gerekmediğine bakılmaksızın, bu barkod API'si, barkod algılama ve okuma görevleri için bir çözüm sağlayabilir.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/pdf417/" name="PDF417" description="PDF417 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/qr/" name="QR" description="QR Kodu, GS1 QR Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/datamatrix/" name="Data Matrix" description="Data Matrix kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/aztec/" name="Aztec" description="Aztec Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/swiss-qr/" name="Swiss QR" description="Swiss QR faturası" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/dotcode/" name="DotCode" description="DotCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/hibc/" name="HIBC" description="HIBC (Sağlık Sektörü Barkodu)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/codablock/" name="Codablock-F" description="Codablock-F ve GS1 Codablock-F barkodları" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/databar/" name="GS1 DataBar" description="GS1 DataBar (Çok Yönlü, Yığılmış Çok Yönlü, Genişletilmiş, Genişletilmiş Yığınlanmış ve Kesilmiş) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/itf/" name="ITF" description="Aralıklı 2/5 (ITF) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/ean/" name="EAN" description="EAN (Uluslararası Makale Numarası) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/upc/" name="UPC" description="UPC (Evrensel Ürün Kodu) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/code128/" name="GS1 Code 128" description="GS1 Code 128 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/code39/" name="Code 39" description="Code 39 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/code16k/" name="Code 16K" description="Code 16K barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/code32/" name="Code 32" description="İtalyan Ecza Kodu (Code 32) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/code93/" name="Code 93" description="Code 93 Genişletilmiş ve Code 93 Standart barkodlar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/onecode/" name="USPS OneCode" description="USPS OneCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Endüstriyel 2/5) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/isbn/" name="ISBN" description="ISBN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/ismn/" name="ISMN" description="ISMN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/issn/" name="ISSN" description="ISSN barkod" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/australia-post/" name="Australia Post" description="Australia Post barkod ve Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/rm4scc/" name="RM4SCC" description="Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/postnet/" name="Postnet" description="Postnet barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/royal-mail/" name="Royal Mail" description="Royal Mail barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/singapore-post/" name="Singapore Post" description="Singapore Post barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/android-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Kaynak kodu" href="https://github.com/aspose-barcode/Android-Library-Usage-Examples" >}}
{{< blocks/products/pf/slr-element name="API Referansları" href="https://reference.aspose.com/barcode/androidjava/" >}}
...
{{< blocks/products/pf/slr-element name="Sürüm notları" href="https://docs.aspose.com/barcode/java/android-via-java-release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Neden Android via Java için Aspose.BarCode?" tabId="success-stories" >}}
