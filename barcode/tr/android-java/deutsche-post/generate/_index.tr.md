---
title: Android via Java aracılığıyla Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode Görselleri oluşturun
description: Android Çalışma Zamanı Ortamında Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode oluşturmak için Android kaynak kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/android-java/deutsche-post/generate/
aliases:
- /tr/android-java/generate/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Android via Java ile Deutsche Post Etiketleri oluşturun" h2="Sunucu tarafı Aspose.BarCode for Android via Java API'sini kullanarak Java içinde Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java Dilinde Deutsche Post barkodu Oluşturma Adımları" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode, geliştiricilerin birkaç satır kodla Deutsche Post barkodu görüntüleri oluşturmasını kolaylaştırır.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Yeni bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak Deutsche Post barkodu barkod türünü iletin</li><li>setCodeText yöntemini kullanarak barkod metnini tanımlayın</li><li>Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode barkod görüntüsünü kaydetmek için createBarCodeImage() yöntemini başlatın</li></ul>
