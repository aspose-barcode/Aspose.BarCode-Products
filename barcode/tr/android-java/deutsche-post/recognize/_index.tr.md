---
title: Android via Java aracılığıyla Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode Görsellerini tarayın
weight: 1510
description: Android Çalışma Zamanı Ortamında Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode ailesini tanımak için Android örnek kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/android-java/deutsche-post/recognize/
aliases:
- /tr/android-java/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Android via Java ile Deutsche Post Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for Android via Java API'sini kullanarak Java içinde Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java'da Deutsche Post barkodu Tarama Adımları" %}}
...
<ul><li>Bir BarCodeReader sınıfı örneği oluşturun</li><li>Deutsche Post barkodu içeren kaynak görüntü yolunu belirleyin</li><li>İkinci parametre olarak DecodeType'ta hedef barkod türlerini tanımlayın</li><li>Tanıma sonuçları arasında geçiş yapın</li><li>getCodeText yöntemini çalıştırarak kodu çözülmüş metni yükleyin</li></ul>
