---
title: Android via Java aracılığıyla Code 93 Genişletilmiş ve Code 93 Standart barkodlar Görselleri oluşturun
description: Android Çalışma Zamanı Ortamında Code 93 Genişletilmiş ve Code 93 Standart barkodlar oluşturmak için Android kaynak kodu.
lang: tr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /tr/android-java/code93/generate/
aliases:
- /tr/android-java/generate/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Android via Java ile Code 93 Etiketleri oluşturun" h2="Sunucu tarafı Aspose.BarCode for Android via Java API'sini kullanarak Java içinde Code 93 Genişletilmiş ve Code 93 Standart barkodlar oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java Dilinde Code 93 barkod Oluşturma Adımları" %}}
...
<ul><li>Yeni bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak Code 93 barkod barkod türünü iletin</li><li>setCodeText yöntemini kullanarak barkod metnini tanımlayın</li><li>Code 93 Genişletilmiş ve Code 93 Standart barkodlar barkod görüntüsünü kaydetmek için createBarCodeImage() yöntemini başlatın</li></ul>
