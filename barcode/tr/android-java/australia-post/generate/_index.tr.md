...
{{% blocks/products/pf/agp/feature-section-col title="Java Dilinde Australia Post barkodu Oluşturma Adımları" %}}
...
<ul><li>Yeni bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak Australia Post barkodu barkod türünü iletin</li><li>setCodeText yöntemini kullanarak barkod metnini tanımlayın</li><li>Australia Post barkod ve Australia Post eParcel barkod görüntüsünü kaydetmek için createBarCodeImage() yöntemini başlatın</li></ul>
