---
title: Android via Java aracılığıyla Standard 2 of 5 (Endüstriyel 2/5) barkod Görsellerini tarayın
weight: 1510
description: Android Çalışma Zamanı Ortamında Standard 2 of 5 (Endüstriyel 2/5) barkod ailesini tanımak için Android örnek kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/android-java/standard2of5/recognize/
aliases:
- /tr/android-java/recognize/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Android via Java ile Standard 2 of 5 Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for Android via Java API'sini kullanarak Java içinde Standard 2 of 5 (Endüstriyel 2/5) barkod okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java'da Standard 2 of 5 barkod Tarama Adımları" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode, geliştiricilerin birkaç satır kodla akış veya görüntüden Standard 2 of 5 barkod barkodlarını okumasına olanak tanır

{{% /blocks/products/pf/agp/text %}}

<ul><li>Bir BarCodeReader sınıfı örneği oluşturun</li><li>Standard 2 of 5 barkod içeren kaynak görüntü yolunu belirleyin</li><li>İkinci parametre olarak DecodeType'ta hedef barkod türlerini tanımlayın</li><li>Tanıma sonuçları arasında geçiş yapın</li><li>getCodeText yöntemini çalıştırarak kodu çözülmüş metni yükleyin</li></ul>
