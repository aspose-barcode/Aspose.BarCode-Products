---
title: Android via Java aracılığıyla DotCode barkod Görselleri oluşturun
description: Android Çalışma Zamanı Ortamında DotCode barkod oluşturmak için Android kaynak kodu.
lang: tr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /tr/android-java/dotcode/generate/
aliases:
- /tr/android-java/generate/dotcode/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Android via Java ile DotCode Etiketleri oluşturun" h2="Sunucu tarafı Aspose.BarCode for Android via Java API'sini kullanarak Java içinde DotCode barkod oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DotCode" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java Dilinde DotCode barkod Oluşturma Adımları" %}}
...
<ul><li>Yeni bir BarCodeGenerator sınıfı örneği oluşturun</li><li>EncodeTypes parametresi olarak DotCode barkod barkod türünü iletin</li><li>setCodeText yöntemini kullanarak barkod metnini tanımlayın</li><li>DotCode barkod barkod görüntüsünü kaydetmek için createBarCodeImage() yöntemini başlatın</li></ul>
