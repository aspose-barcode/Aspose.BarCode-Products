---
title: Python Barkod Oluşturucu ve Tarayıcı API'sı
description: 1D, 2D ve Posta dahil olmak üzere çok sayıda barkod türünü tanımak ve oluşturmak için Python barkod okuyucu kitaplığı. API'yi Python uygulamalarında kullanın.
lang: tr
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Python Barkod kitaplığı" h2="Herhangi bir Python uygulamasında 1D, 2D ve Posta barkodlarını tanıyın veya oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-net.svg" pfName="Aspose.BarCode" subTitlepfName="Python via .NET için" downloadUrl="https://releases.aspose.com/barcode/python-net" >}}
...
<p>Aspose.BarCode for Python via NET, Python uygulamalarına entegre edilecek bir dizi barkod oluşturma ve okuma API'sidir. Geliştiriciler kolayca barkod oluşturma ve tanıma işlevi ekleyebilir. Python barkod API'si PNG, JPG, GIF, BMP gibi çeşitli formatlarda barkod görüntüleri oluşturur. Ayrıca, kenarlıkları değiştirme, renk, görüntüleri döndürme, çözünürlüğü özelleştirme ve çok daha fazlası gibi çoklu görüntüleme özelliklerini destekler.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Platform Bağımsızlığı" description="Aspose.Barcode for Python via NET, Python 3.6 ve üstü için mevcuttur." >}}
<div class='diagram1 d1-python'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Desteklenen Dosya Biçimleri" description="Python via .NET için Aspose.BarCode, en sık kullanılan görüntü dosyası biçimleriyle çalışır." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                .NET Barkod API Özellikleri ile Gelişmiş Python
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/swiss-qr-code/'>İsviçre QR Kodu</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/manage-barcode-appearance/'>Barkod Görünümünü Özelleştirin</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/barcode-text-settings/'>Barkod Metin Ayarlarını Yönetin</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/generate-1d-barcodes/'>1D Barkod Tiplerinin Özel Parametreleri</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/generate-qr-code/'>QR Kodu ve Mikro QR Kodu Oluşturun</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/barcode-reading-presets/'>Barkod Okuma Kalitesi Seçenekleri ve Ön Ayarları</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Barkod Parametrelerini Özelleştir
                </h2>
                <p>
                    Aspose.BarCode for Python via .NET, özelleştirilmiş barkod görüntüleri oluşturmak için zengin işlevsellik sağlar. İşletme ihtiyaçlarına göre her renk ve boyutta barkod üretilmesini sağlar. Çubukların renkleri, arka plan, kenarlıklar ve metin başlıkları dahil olmak üzere tüm barkod öğelerinin görünümünü ve konumlarını özelleştirmek mümkündür. Barkod, giriş metni, üst ve/veya alt başlık, dolgular ve kenarlıklar görüntülenerek veya görüntülenmeden oluşturulabilir. Barkod boyutu, X boyutuna bağlı olarak otomatik veya manuel olarak ayarlanabilir. Milimetre, inç, nokta veya piksel gibi çeşitli birimlerde tanımlanabilir. Gerekirse, görüntü oranları ve çözünürlük ayarlanabilir. Metin yazı tipi de özelleştirilebilir.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
            <div class="col-lg-12">
                ...
                <p>
                    API, Data Matrix, Aztec Code, PDF417 vb. gibi en popüler türlerde 2B barkodlar oluşturma yeteneğine sahiptir. Bu türler, büyük veya standart olmayan giriş değerlerinin kodlanmasına olanak tanır. İşte QR kod üretimi için kod.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Barkod Okuma Hızını veya Kalitesini Optimize Edin
                </h2>
                <p>
                    Barkod kitaplığı, işletmenizin özel ihtiyaçlarını karşılamak üzere barkod okumayı optimize etmek için bir dizi güçlü özellik sağlar. Geliştiriciler, hızlı barkod taramayı etkinleştirmek veya okuma hassasiyetini artırmak için tanıma motorunun parametrelerini ayarlayabilir. Kaynak barkod görüntülerinin kalitesine ve parametrelerine bağlı olarak, kitaplık tanıma işleminin özelleştirilmesine olanak tanır. Yüksek kaliteli barkod görüntülerini hızlı bir şekilde taramak veya hasarlı veya bozulmuş barkodların kodunun çözülmesini kolaylaştırmak için kullanılabilen bu tür parametrelerin önceden ayarlanmış birkaç yapılandırmasını içerir. Ek olarak, Gauss gürültüsü, beyaz noktalar ve ters renkler gibi farklı bozulma türleri için barkod okumayı iyileştirebilen özel ayarlar vardır. Tanıma sürecine ince ayar yapma yeteneği ile API, çok çeşitli uygulama ve senaryolar için en verimli barkod okumasını sağlayacak şekilde uyarlanabilir.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/pdf417/" name="PDF417" description="PDF417 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/qr/" name="QR" description="QR Kodu, GS1 QR Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/datamatrix/" name="Data Matrix" description="Data Matrix kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/aztec/" name="Aztec" description="Aztec Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/swiss-qr/" name="Swiss QR" description="Swiss QR faturası" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/dotcode/" name="DotCode" description="DotCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/hibc/" name="HIBC" description="HIBC (Sağlık Sektörü Barkodu)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/codablock/" name="Codablock-F" description="Codablock-F ve GS1 Codablock-F barkodları" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/databar/" name="GS1 DataBar" description="GS1 DataBar (Çok Yönlü, Yığılmış Çok Yönlü, Genişletilmiş, Genişletilmiş Yığınlanmış ve Kesilmiş) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/itf/" name="ITF" description="Aralıklı 2/5 (ITF) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/ean/" name="EAN" description="EAN (Uluslararası Makale Numarası) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/upc/" name="UPC" description="UPC (Evrensel Ürün Kodu) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/code128/" name="GS1 Code 128" description="GS1 Code 128 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/code39/" name="Code 39" description="Code 39 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/code16k/" name="Code 16K" description="Code 16K barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/code32/" name="Code 32" description="İtalyan Ecza Kodu (Code 32) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/code93/" name="Code 93" description="Code 93 Genişletilmiş ve Code 93 Standart barkodlar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/onecode/" name="USPS OneCode" description="USPS OneCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Endüstriyel 2/5) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/isbn/" name="ISBN" description="ISBN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/ismn/" name="ISMN" description="ISMN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/issn/" name="ISSN" description="ISSN barkod" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/australia-post/" name="Australia Post" description="Australia Post barkod ve Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/rm4scc/" name="RM4SCC" description="Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/postnet/" name="Postnet" description="Postnet barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/royal-mail/" name="Royal Mail" description="Royal Mail barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/singapore-post/" name="Singapore Post" description="Singapore Post barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/python-net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Belgeler" href="https://docs.aspose.com/barcode/python-net/" >}}
{{< blocks/products/pf/slr-element name="Kaynak kodu" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Python-via-.NET" >}}
{{< blocks/products/pf/slr-element name="API Referansları" href="https://docs.aspose.com/barcode/python-net/api-reference/" >}}
...
{{< blocks/products/pf/slr-element name="Sürüm notları" href="https://docs.aspose.com/barcode/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Neden Python via .NET için Aspose.BarCode?" tabId="success-stories" >}}
