...
{{% blocks/products/pf/agp/feature-section-col title="C++ Dilinde UPC (Evrensel Ürün Kodu) barkodu Oluşturma Adımları" %}}
...
<ul><li>BarcodeGenerator sınıfından bir nesne oluşturun</li><li>Parametre olarak UPC (Evrensel Ürün Kodu) barkodu iletin</li><li>İkinci parametre olarak kodlamak için giriş metnini girin</li><li>Gerekirse görüntü boyutlarını tanımlayın</li><li>UPC (Evrensel Ürün Kodu) barkodu barkodunu indirmek için BarcodeGenerator.Save yöntemini çağırın</li></ul>
