...
{{% blocks/products/pf/agp/feature-section-col title="C++ Dilinde Codablock-F barkod Oluşturma Adımları" %}}
...
<ul><li>BarcodeGenerator sınıfından bir nesne oluşturun</li><li>Parametre olarak Codablock-F ve GS1 Codablock-F barkodları iletin</li><li>İkinci parametre olarak kodlamak için giriş metnini girin</li><li>Gerekirse görüntü boyutlarını tanımlayın</li><li>Codablock-F ve GS1 Codablock-F barkodları barkodunu indirmek için BarcodeGenerator.Save yöntemini çağırın</li></ul>
