---
title: C++ aracılığıyla Standard 2 of 5 (Endüstriyel 2/5) barkod Görselleri oluşturun
description: Windows 32-bit, Windows 64-bit ve Linux 64-bit için C++ Çalışma Zamanı Ortamında Standard 2 of 5 (Endüstriyel 2/5) barkod oluşturmak için C++ kod örneği.
lang: tr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /tr/cpp/standard2of5/generate/
aliases:
- /tr/cpp/generate/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C++ ile Standard 2 of 5 Etiketleri oluşturun" h2="Sunucu tarafı Aspose.BarCode for C++ API'sini kullanarak C++ içinde Standard 2 of 5 (Endüstriyel 2/5) barkod oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ Dilinde Standard 2 of 5 barkod Oluşturma Adımları" %}}
...
<ul><li>BarcodeGenerator sınıfından bir nesne oluşturun</li><li>Parametre olarak Standard 2 of 5 (Endüstriyel 2/5) barkod iletin</li><li>İkinci parametre olarak kodlamak için giriş metnini girin</li><li>Gerekirse görüntü boyutlarını tanımlayın</li><li>Standard 2 of 5 (Endüstriyel 2/5) barkod barkodunu indirmek için BarcodeGenerator.Save yöntemini çağırın</li></ul>
