---
title: C++ aracılığıyla DotCode barkod Görsellerini tarayın
weight: 1510
description: Windows 32-bit, Windows 64-bit veya Linux 64-bit için C++ Çalışma Zamanı Ortamında DotCode barkod taramak ve kodunu çözmek için C++ örnek kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/cpp/dotcode/recognize/
aliases:
- /tr/cpp/recognize/dotcode/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C++ ile DotCode Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for C++ API'sini kullanarak C++ içinde DotCode barkod okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DotCode" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++'da DotCode barkod Tarama Adımları" %}}
