---
title: C++ aracılığıyla GS1 DataBar (Çok Yönlü, Yığılmış Çok Yönlü, Genişletilmiş, Genişletilmiş Yığınlanmış ve Kesilmiş) barkod Görsellerini tarayın
weight: 1510
description: Windows 32-bit, Windows 64-bit veya Linux 64-bit için C++ Çalışma Zamanı Ortamında GS1 DataBar (Çok Yönlü, Yığılmış Çok Yönlü, Genişletilmiş, Genişletilmiş Yığınlanmış ve Kesilmiş) barkod taramak ve kodunu çözmek için C++ örnek kodu.
lang: tr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /tr/cpp/databar/recognize/
aliases:
- /tr/cpp/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C++ ile GS1 DataBar Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for C++ API'sini kullanarak C++ içinde GS1 DataBar (Çok Yönlü, Yığılmış Çok Yönlü, Genişletilmiş, Genişletilmiş Yığınlanmış ve Kesilmiş) barkod okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 DataBar barkod Using C++" %}}
GS1 DataBar barkod taramak için, C++ platformları için zengin işlevlere sahip güçlü ve kullanımı kolay bir barkod kitaplığı olan [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API'yi deneyin . En son sürümünü doğrudan indirebilirsiniz&colon; [NuGet](https://www.nuget.org/packages/aspose.barcode) paket yöneticisini açın, **Aspose.BarCode.Cpp** ifadesini arayın ve paketi kurun. Alternatif olarak, Paket Yöneticisi Konsolundan aşağıdaki komutu çalıştırabilirsiniz.
...
{{% blocks/products/pf/agp/feature-section-col title="C++'da GS1 DataBar barkod Tarama Adımları" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader sınıfından bir nesne oluşturun</li><li>Parametre olarak GS1 DataBar barkod içeren kaynak görüntü yolunu belirtin</li><li>Gerekli barkod türlerini iletin İkinci parametre olarak DecodeType</li><li>Tanıma sonuçları arasında geçiş yapın</li><li>CodeText özelliğini kullanarak kodu çözülmüş barkod metnini yükleyin</li></ul>
...
<ul><li>Microsoft Windows, Linux veya Windows 32-bit, Windows 64-bit ve Linux 64-bit için C++ Runtime Environment ile uyumlu herhangi bir işletim sistemi.</li><li>Aspose.BarCode for C++ DLL referanslı projenizde.</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/pdf417/recognize/" name="PDF417" description="PDF417 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/qr/recognize/" name="QR" description="QR Kodu, GS1 QR Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/datamatrix/recognize/" name="Data Matrix" description="Data Matrix kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/aztec/recognize/" name="Aztec" description="Aztec Kodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR faturası" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/dotcode/recognize/" name="DotCode" description="DotCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/hibc/recognize/" name="HIBC" description="HIBC (Sağlık Sektörü Barkodu)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/codablock/recognize/" name="Codablock-F" description="Codablock-F ve GS1 Codablock-F barkodları" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (Çok Yönlü, Yığılmış Çok Yönlü, Genişletilmiş, Genişletilmiş Yığınlanmış ve Kesilmiş) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/itf/recognize/" name="ITF" description="Aralıklı 2/5 (ITF) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/ean/recognize/" name="EAN" description="EAN (Uluslararası Makale Numarası) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/upc/recognize/" name="UPC" description="UPC (Evrensel Ürün Kodu) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/code39/recognize/" name="Code 39" description="Code 39 barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/code16k/recognize/" name="Code 16K" description="Code 16K barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/code32/recognize/" name="Code 32" description="İtalyan Ecza Kodu (Code 32) barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/code93/recognize/" name="Code 93" description="Code 93 Genişletilmiş ve Code 93 Standart barkodlar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/onecode/recognize/" name="USPS OneCode" description="USPS OneCode barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Endüstriyel 2/5) barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/isbn/recognize/" name="ISBN" description="ISBN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/ismn/recognize/" name="ISMN" description="ISMN barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/issn/recognize/" name="ISSN" description="ISSN barkod" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/australia-post/recognize/" name="Australia Post" description="Australia Post barkod ve Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Kimlik Kodu ve Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4-Eyalet Müşteri Kodu (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/postnet/recognize/" name="Postnet" description="Postnet barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/royal-mail/recognize/" name="Royal Mail" description="Royal Mail barkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/singapore-post/recognize/" name="Singapore Post" description="Singapore Post barkodu" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/tr/cpp/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
