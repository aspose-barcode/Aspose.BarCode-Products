---
title: C++ aracılığıyla Aztec Kodu Görsellerini tarayın
weight: 1510
description: Windows 32-bit, Windows 64-bit veya Linux 64-bit için C++ Çalışma Zamanı Ortamında Aztec Kodu taramak ve kodunu çözmek için C++ örnek kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/cpp/aztec/recognize/
aliases:
- /tr/cpp/recognize/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C++ ile Aztec Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for C++ API'sini kullanarak C++ içinde Aztec Kodu okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++'da Aztec Kodu Tarama Adımları" %}}
