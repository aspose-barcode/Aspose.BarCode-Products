...
{{% blocks/products/pf/agp/feature-section-col title="C++ Dilinde Australia Post barkodu Oluşturma Adımları" %}}
...
<ul><li>BarcodeGenerator sınıfından bir nesne oluşturun</li><li>Parametre olarak Australia Post barkod ve Australia Post eParcel iletin</li><li>İkinci parametre olarak kodlamak için giriş metnini girin</li><li>Gerekirse görüntü boyutlarını tanımlayın</li><li>Australia Post barkod ve Australia Post eParcel barkodunu indirmek için BarcodeGenerator.Save yöntemini çağırın</li></ul>
