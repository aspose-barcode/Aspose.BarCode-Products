---
title: C++ aracılığıyla Data Matrix kodu Görselleri oluşturun
description: Windows 32-bit, Windows 64-bit ve Linux 64-bit için C++ Çalışma Zamanı Ortamında Data Matrix kodu oluşturmak için C++ kod örneği.
lang: tr
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /tr/cpp/datamatrix/generate/
aliases:
- /tr/cpp/generate/datamatrix/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C++ ile Data Matrix Etiketleri oluşturun" h2="Sunucu tarafı Aspose.BarCode for C++ API'sini kullanarak C++ içinde Data Matrix kodu oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Data Matrix" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ Dilinde Data Matrix kodu Oluşturma Adımları" %}}
...
<ul><li>BarcodeGenerator sınıfından bir nesne oluşturun</li><li>Parametre olarak Data Matrix kodu iletin</li><li>İkinci parametre olarak kodlamak için giriş metnini girin</li><li>Gerekirse görüntü boyutlarını tanımlayın</li><li>Data Matrix kodu barkodunu indirmek için BarcodeGenerator.Save yöntemini çağırın</li></ul>
