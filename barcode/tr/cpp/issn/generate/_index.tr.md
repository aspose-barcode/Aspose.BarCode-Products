...
{{% blocks/products/pf/agp/feature-section-col title="C++ Dilinde ISSN barkod Oluşturma Adımları" %}}
...
<ul><li>BarcodeGenerator sınıfından bir nesne oluşturun</li><li>Parametre olarak ISSN barkod iletin</li><li>İkinci parametre olarak kodlamak için giriş metnini girin</li><li>Gerekirse görüntü boyutlarını tanımlayın</li><li>ISSN barkod barkodunu indirmek için BarcodeGenerator.Save yöntemini çağırın</li></ul>
