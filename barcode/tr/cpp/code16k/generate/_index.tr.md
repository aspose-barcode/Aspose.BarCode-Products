...
{{% blocks/products/pf/agp/feature-section-col title="C++ Dilinde Code 16K barkod Oluşturma Adımları" %}}
...
<ul><li>BarcodeGenerator sınıfından bir nesne oluşturun</li><li>Parametre olarak Code 16K barkod iletin</li><li>İkinci parametre olarak kodlamak için giriş metnini girin</li><li>Gerekirse görüntü boyutlarını tanımlayın</li><li>Code 16K barkod barkodunu indirmek için BarcodeGenerator.Save yöntemini çağırın</li></ul>
