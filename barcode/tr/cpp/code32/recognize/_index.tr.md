---
title: C++ aracılığıyla İtalyan Ecza Kodu (Code 32) barkodu Görsellerini tarayın
weight: 1510
description: Windows 32-bit, Windows 64-bit veya Linux 64-bit için C++ Çalışma Zamanı Ortamında İtalyan Ecza Kodu (Code 32) barkodu taramak ve kodunu çözmek için C++ örnek kodu.
lang: tr/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /tr/cpp/code32/recognize/
aliases:
- /tr/cpp/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C++ ile Code 32 Barkodlarını okuyun" h2="Sunucu tarafı Aspose.BarCode for C++ API'sini kullanarak C++ içinde İtalyan Ecza Kodu (Code 32) barkodu okuyun" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++'da Code 32 barkod Tarama Adımları" %}}
