...
<ul><li>BarcodeGenerator sınıfından bir nesne oluşturun</li><li>Parametre olarak İtalyan Ecza Kodu (Code 32) barkodu iletin</li><li>İkinci parametre olarak kodlamak için giriş metnini girin</li><li>Gerekirse görüntü boyutlarını tanımlayın</li><li>İtalyan Ecza Kodu (Code 32) barkodu barkodunu indirmek için BarcodeGenerator.Save yöntemini çağırın</li></ul>
