---
title: SharePoint Barcode API - Infoga streckkoder på SharePoint-listor
description: Streckkod SharePoint API för att infoga streckkodsetiketter i anpassade SharePoint-listor. Utvecklare kan använda tjänstemarkörer för att välja inmatade textvärden eller infoga texten manuellt.
lang: sv/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="SharePoint streckkods-API:er" h2="Streckkod SharePoint App för att lägga till linjära, 2D och poststreckkoder till Microsoft SharePoint-listor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="för SharePoint" downloadUrl="https://releases.aspose.com/barcode/sharepoint/" >}}
...
<p>Aspose.BarCode för SharePoint tillåter utvecklare att lägga till ett stort utbud av linjära streckkoder, 2D och poststreckkoder till Microsoft SharePoint Foundation 2010 och Microsoft Office SharePoint Server 2010 (MOSS) listor. Du kan skapa och sedan infoga streckkoder i valfri lista genom att ange inmatningstext och typ.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformsoberoende" description="Aspose.BarCode för SharePoint stöder Microsoft SharePoint Foundation och SharePoint Server." >}}
<div class='diagram1 d1-sharepoint'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Filformat som stöds" description="Aspose.BarCode för SharePoint fungerar med de vanligaste bildfilformaten." >}}
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    Streckkodsbiblioteket erbjuder olika alternativ för att spara genererade streckkoder, inte bara med populära rasterbildsformat utan också för att streama eller vektor. Streckkoder kan laddas ner med ett av de fem mest använda bildformaten eller två vektorformat. Det är också möjligt att ladda streckkoder som filer, strömmar eller bitmappar. Utvecklare kan anpassa processen för generering och sparande av streckkoder efter specifika affärsbehov genom att ställa in önskat utdataläge. API:et stöder följande filformat&colon; BMP, PNG, GIF, JPEG och TIFF för input/output; EMF och SVG för utdata.<br>Utvecklare kan spara streckkoder som vektorbilder, som EMF- och SVG-filer, för att skala dem utan att förlora upplösning.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/pdf417/" name="PDF417" description="PDF417 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/qr/" name="QR" description="QR Kod, GS1 QR Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/datamatrix/" name="Data Matrix" description="Data Matrix-kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/aztec/" name="Aztec" description="Aztec Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/swiss-qr/" name="Swiss QR" description="Swiss QR räkning" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/dotcode/" name="DotCode" description="DotCode streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/hibc/" name="HIBC" description="HIBC (hälsobranschens streckkod)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/codablock/" name="Codablock-F" description="Codablock-F och GS1 Codablock-F streckkoder" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/databar/" name="GS1 DataBar" description="GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/itf/" name="ITF" description="Interfolierad 2-av-5 (ITF) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/ean/" name="EAN" description="EAN (internationellt artikelnummer) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/upc/" name="UPC" description="UPC (Universal Product Code) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/code128/" name="GS1 Code 128" description="GS1 Code 128 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/code39/" name="Code 39" description="Code 39 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/code16k/" name="Code 16K" description="Code 16K streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/code32/" name="Code 32" description="Italiensk läkemedelskod (Code 32) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/code93/" name="Code 93" description="Code 93 Utökade och Code 93 standardstreckkoder" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/onecode/" name="USPS OneCode" description="USPS OneCode streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriell 2 av 5) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/isbn/" name="ISBN" description="ISBN streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/ismn/" name="ISMN" description="ISMN streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/issn/" name="ISSN" description="ISSN streckkod" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/australia-post/" name="Australia Post" description="Australia Post streckkod och Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode och Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/rm4scc/" name="RM4SCC" description="Royal Mail 4-stats kundkod (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/postnet/" name="Postnet" description="Postnet streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/royal-mail/" name="Royal Mail" description="Royal Mail streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/singapore-post/" name="Singapore Post" description="Singapore Post streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/sharepoint/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.BarCode för SharePoint?" tabId="success-stories" >}}
