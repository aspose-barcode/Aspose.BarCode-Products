---
title: Generera streckkoder i JasperReports och rendera i BMP JPG GIF & PNG
description: Genom att använda Aspose.BarCode för JasperReports kan utvecklare generera streckkoder i Jasper Reports för att renderas vidare i BMP JPG GIF- och PNG-format.
lang: sv/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Generera och exportera streckkoder i JasperReports" h2="JasperReports & JasperServer API för att generera, visa och exportera streckkoder i 1D, 2D och post." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="för JasperReports" downloadUrl="https://releases.aspose.com/barcode/jasperreports/" >}}
...
<p>Aspose.BarCode för JasperReports är en flexibel JasperReports och JasperServer-tillägg för att skapa och visa streckkodsetiketter i dina applikationer. Dessa streckkodsetiketter kan renderas i många populära bildformat.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformsoberoende" description="Aspose.BarCode för JasperReports kan användas med JasperServer och JasperReports." >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Filformat som stöds" description="Aspose.BarCode för JasperReports fungerar med de vanligaste bildfilformaten." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Generera och skriv ut rapporter med streckkoder</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Öka applikationens arbetsflöde genom att lägga till streckkodsfunktioner</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Bädda in streckkoder i filer för att underlätta spårbarheten</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/barcode-image-basic-features/'>Kontrollkodens storlek, färg & kodtext</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/read-barcodes-with-aspose-barcode-apis/'>Igenkänning av 3D-förvrängda och roterade 2D-streckkoder</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/generate-barcode-by-specifying-custom-image-size/'>Skapa streckkodsbilder av specifik storlek</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    Aspose.BarCode för JasperReports tillhandahåller en speciell uppsättning verktyg för att arbeta med streckkoder i JasperReports. Med hjälp av detta API kan utvecklare skanna streckkoder i befintliga rapporter eller lägga till dem i nya rapporter. Detta streckkodsbibliotek är kodat rent i Java och tillhandahålls som ett enda JAR-dokument och kan enkelt distribueras på maskiner med JasperReports eller JasperServer installerat. För att installera JasperReports streckkodstillägg, kopiera helt enkelt JAR-dokumentet till rätt mappplats och börja arbeta.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Biblioteket för streckkodsgeneratorn låter utvecklare enkelt skapa streckkoder genom att specificera typen av streckkod, ange data som ska kodas och ställa in anpassade utseenderelaterade egenskaper. Detta inkluderar olika alternativ, såsom bakgrunds- och förgrundsfärg, teckensnitt, storlek, upplösning och texttexter. API:et kan generera både 1D- och 2D-streckkoder, inklusive PDF417, Data Matrix, Aztec-kod, QR-kod och Micro QR-kod, med samma grundmetod. Detta gör det till ett bekvämt och användarvänligt verktyg för att generera ett brett utbud av streckkodstyper för olika applikationer, inklusive JasperReports.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Infoga streckkoder i JasperReports
                </h2>
                <p>
                    JasperReports låter utvecklare skapa rapporter med hjälp av data som lagras i en mängd olika källor, såsom databaser, CSV-filer och XML-dokument. Den tillhandahåller ett brett utbud av funktioner för att designa, formatera och exportera rapporter, som enkelt kan integreras i Java-applikationer. Några vanliga användningsområden för JasperReports inkluderar generering av fakturor, kvitton, finansiella rapporter och andra typer av affärsrapporter. Det kan vara användbart att infoga streckkoder i JasperReports för att underlätta åtkomst och hantering av informationen i rapporter. Exempelvis kan streckkoder användas för att snabbt och exakt skanna och uppdatera informationen i en JasperReport, nämligen genom att skanna en streckkod på en faktura för att hämta och visa tillhörande data. Detta kan göra det lättare att spåra och hantera information och minska risken för fel eller avvikelser. Streckkod kan också användas för att visa specifika objekt eller poster i rapporten.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/pdf417/" name="PDF417" description="PDF417 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/qr/" name="QR" description="QR Kod, GS1 QR Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/datamatrix/" name="Data Matrix" description="Data Matrix-kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/aztec/" name="Aztec" description="Aztec Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/swiss-qr/" name="Swiss QR" description="Swiss QR räkning" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/dotcode/" name="DotCode" description="DotCode streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/hibc/" name="HIBC" description="HIBC (hälsobranschens streckkod)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/codablock/" name="Codablock-F" description="Codablock-F och GS1 Codablock-F streckkoder" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/databar/" name="GS1 DataBar" description="GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/itf/" name="ITF" description="Interfolierad 2-av-5 (ITF) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/ean/" name="EAN" description="EAN (internationellt artikelnummer) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/upc/" name="UPC" description="UPC (Universal Product Code) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/code128/" name="GS1 Code 128" description="GS1 Code 128 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/code39/" name="Code 39" description="Code 39 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/code16k/" name="Code 16K" description="Code 16K streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/code32/" name="Code 32" description="Italiensk läkemedelskod (Code 32) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/code93/" name="Code 93" description="Code 93 Utökade och Code 93 standardstreckkoder" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/onecode/" name="USPS OneCode" description="USPS OneCode streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriell 2 av 5) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/isbn/" name="ISBN" description="ISBN streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/ismn/" name="ISMN" description="ISMN streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/issn/" name="ISSN" description="ISSN streckkod" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/australia-post/" name="Australia Post" description="Australia Post streckkod och Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode och Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/rm4scc/" name="RM4SCC" description="Royal Mail 4-stats kundkod (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/postnet/" name="Postnet" description="Postnet streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/royal-mail/" name="Royal Mail" description="Royal Mail streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/singapore-post/" name="Singapore Post" description="Singapore Post streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/jasperreports/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="API-referenser" href="https://reference.aspose.com/barcode/java/" >}}
...
{{< blocks/products/pf/slr-element name="Release Notes" href="https://docs.aspose.com/barcode/jasperreports/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.BarCode för JasperReports?" tabId="success-stories" >}}
