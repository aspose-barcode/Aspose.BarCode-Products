...
description: Använda Aspose.BarCode för JasperReports - utvecklare kan generera streckkoder i Jasper Reports som kan renderas vidare i BMP JPG GIF- och PNG-format
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Generera och exportera streckkoder i JasperReports" h2="JasperReports & JasperServer API för att generera, visa och exportera linjära streckkoder, 2D och poststreckkoder till flera format." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/barcode/jasperreports" >}}
...
{{< blocks/products/pf/carousel-item h3="En överblick" description="En översikt över Aspose.BarCode för JasperReports API." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    <li>
     Återge streckkoden för att rapportera
    </li>
   </ul>
  </div>
  <!--/left-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Jasper Reports streckkodsgenerator" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Platform Independence" description="Aspose.BarCode för JasperReports kan användas med JasperServer och JasperReports." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Generera streckkod i Jasper Report" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="JasperReports streckkodstillägg stöder populära [bildformat](https://docs.aspose.com/barcode/jasperreports/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Streckkodsgenerering in Jasper Report" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/slr-element name="Källkod" href="https://github.com/aspose-barcode?tab=repositories" >}}
