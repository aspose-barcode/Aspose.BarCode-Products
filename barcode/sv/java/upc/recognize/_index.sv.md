...
<ul><li>Skapa ett nytt objekt i klassen BarCodeReader</li><li>Ange källfilens sökväg som innehåller UPC (Universal Product Code) streckkod</li><li>Ge de obligatoriska streckkodstyperna till DecodeType som den andra parametern</li><li>Bläddra igenom avkodningsresultaten</li><li>Hämta streckkodstext med metoden getCodeText</li></ul>
