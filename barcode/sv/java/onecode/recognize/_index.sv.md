---
title: Skanna USPS OneCode streckkod-bilder via Java
weight: 1510
description: Java-källkod för att läsa och avkoda USPS OneCode streckkod i Java Runtime Environment för JSP/JSF Application och Desktop Applications.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/java/onecode/recognize/
aliases:
- /sv/java/recognize/onecode/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för USPS OneCode med Java" h2="Läs USPS OneCode streckkod i Java med Aspose.BarCode på serversidan för Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="USPS OneCode" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Skapa ett nytt objekt i klassen BarCodeReader</li><li>Ange källfilens sökväg som innehåller USPS OneCode streckkod</li><li>Ge de obligatoriska streckkodstyperna till DecodeType som den andra parametern</li><li>Bläddra igenom avkodningsresultaten</li><li>Hämta streckkodstext med metoden getCodeText</li></ul>
