---
title: Generera USPS OneCode streckkod-bilder via Java
description: Java-exempelkod för USPS OneCode streckkod-generationen i Java Runtime Environment för JSP/JSF-applikationer och stationära applikationer.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/java/onecode/generate/
aliases:
- /sv/java/generate/onecode/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generera USPS OneCode-etiketter med Java" h2="Skapa USPS OneCode streckkod i Java med Aspose.BarCode på serversidan för Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="USPS OneCode" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Skapa ett nytt objekt av klassen BarCodeGenerator</li><li>Definiera USPS OneCode streckkod och andra obligatoriska streckkodstyper som EncodeTypes-parametern</li><li>Ange inmatningstext med metoden setCodeText</li><li>Använd metoden BarCodeGenerator.save för att spara den genererade streckkodsbilden</li></ul>
