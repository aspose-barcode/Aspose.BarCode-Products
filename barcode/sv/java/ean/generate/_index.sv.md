...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera EAN (internationellt artikelnummer) streckkod i Java" %}}
...
<ul><li>Skapa ett nytt objekt av klassen BarCodeGenerator</li><li>Definiera EAN (internationellt artikelnummer) streckkod och andra obligatoriska streckkodstyper som EncodeTypes-parametern</li><li>Ange inmatningstext med metoden setCodeText</li><li>Använd metoden BarCodeGenerator.save för att spara den genererade streckkodsbilden</li></ul>
