---
title: Skanna Code 16K streckkod-bilder via Python via Java
weight: 1510
description: Python-källkod för Code 16K streckkod-igenkänning med Java Runtime Environment.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/python-java/code16k/recognize/
aliases:
- /sv/python-java/recognize/code16k/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för Code 16K med Python via Java" h2="Läs Code 16K streckkod i Python med Aspose.BarCode på serversidan för Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 16K streckkod Using Python via Java" %}}
För att skanna och avkoda Code 16K streckkod, installera [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, en mångsidig, kraftfull och lättanvänd använd streckkodsbibliotek för Python-baserade applikationer. Hämta den senaste versionen direkt från portalen [Aspose releases](https://releases.aspose.com/barcode/python-java/) eller installera 'aspose-barcode' från pip genom att köra följande kommando:
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skanna Code 16K streckkod i Python" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode låter utvecklare läsa Code 16K streckkod streckkoder från ström eller bild med några rader kod

{{% /blocks/products/pf/agp/text %}}

<ul><li>Skapa ett objekt av klassen Aspose.BarCode.BarCodeReader</li><li>Definiera källfilens sökväg som innehåller Code 16K streckkod som en parameter</li><li>Bestämma vilka streckkoder som krävs i DecodeType som den andra parametern</li><li>Bläddra igenom avkodningsresultaten</li><li>Hämta streckkodstexten med hjälp av CodeText-egenskapen</li></ul>
