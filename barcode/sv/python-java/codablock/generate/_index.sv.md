---
title: Generera Codablock-F och GS1 Codablock-F streckkoder-bilder via Python via Java
description: Python-exempelkod för att generera Codablock-F och GS1 Codablock-F streckkoder med Java Runtime Environment.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/python-java/codablock/generate/
aliases:
- /sv/python-java/generate/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generera Codablock-F-etiketter med Python via Java" h2="Skapa Codablock-F och GS1 Codablock-F streckkoder i Python med Aspose.BarCode på serversidan för Python via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Codablock-F streckkod Using Python via Java" %}}
För att göra Codablock-F streckkod-bilder, skaffa [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, en funktionsrik, kraftfull och lättanvänd -Använd streckkodsbibliotek för Python-baserade applikationer. Hämta den senaste versionen direkt från portalen [Aspose releases](https://releases.aspose.com/barcode/python-java/) eller installera 'aspose-barcode' från pip med följande kommando:
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera Codablock-F streckkod i Python" %}}
...
<ul><li>Skapa ett nytt objekt av klassen BarCodeGenerator</li><li>Bestämma önskade streckkodstyper som EncodeTypes-parametern</li><li>Infoga inmatningstext som den andra parametern</li><li> Anropa metoden BarCodeGenerator.save för att hämta den genererade Codablock-F och GS1 Codablock-F streckkoder-bilden</li></ul>
