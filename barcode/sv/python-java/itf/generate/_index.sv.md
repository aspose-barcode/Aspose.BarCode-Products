...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera Interfolierad 2-av-5 (ITF) streckkod i Python" %}}
...
<ul><li>Skapa ett nytt objekt av klassen BarCodeGenerator</li><li>Bestämma önskade streckkodstyper som EncodeTypes-parametern</li><li>Infoga inmatningstext som den andra parametern</li><li> Anropa metoden BarCodeGenerator.save för att hämta den genererade Interfolierad 2-av-5 (ITF) streckkod-bilden</li></ul>
