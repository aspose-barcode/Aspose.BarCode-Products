...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skanna UPC (Universal Product Code) streckkod i Java" %}}
...
<ul><li>Skapa en instans av BarCodeReader-klassen</li><li>Bestämma källbildssökvägen som innehåller UPC (Universal Product Code) streckkod</li><li>Definiera målstreckkoderstyper i DecodeType som den andra parametern</li><li>Bläddra igenom igenkänningsresultaten</li><li>Läs in den avkodade texten som kör metoden getCodeText</li></ul>
