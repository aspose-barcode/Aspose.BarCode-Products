---
title: Generera GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod-bilder via Android via Java
description: Android-källkod för att skapa GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod i Android Runtime Environment.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/android-java/databar/generate/
aliases:
- /sv/android-java/generate/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generera GS1 DataBar-etiketter med Android via Java" h2="Skapa GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod i Java med Aspose.BarCode på serversidan för Android via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera GS1 DataBar streckkod i Java" %}}
...
<ul><li>Skapa en ny instans av klassen BarCodeGenerator</li><li>Skapa streckkodstypen GS1 DataBar streckkod som EncodeTypes-parametern</li><li>Definiera streckkodstext med metoden setCodeText</li><li>Starta metoden generBarCodeImage() för att spara streckkodsbilden GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod</li></ul>
