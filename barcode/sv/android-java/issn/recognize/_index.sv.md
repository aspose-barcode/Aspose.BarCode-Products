---
title: Skanna ISSN streckkod-bilder via Android via Java
weight: 1510
description: Android-exempelkod för att känna igen ISSN streckkod i Android Runtime Environment.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/android-java/issn/recognize/
aliases:
- /sv/android-java/recognize/issn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för ISSN med Android via Java" h2="Läs ISSN streckkod i Java med Aspose.BarCode på serversidan för Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISSN" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skanna ISSN streckkod i Java" %}}
...
<ul><li>Skapa en instans av BarCodeReader-klassen</li><li>Bestämma källbildssökvägen som innehåller ISSN streckkod</li><li>Definiera målstreckkoderstyper i DecodeType som den andra parametern</li><li>Bläddra igenom igenkänningsresultaten</li><li>Läs in den avkodade texten som kör metoden getCodeText</li></ul>
