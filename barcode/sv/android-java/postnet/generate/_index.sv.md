---
title: Generera Postnet streckkod-bilder via Android via Java
description: Android-källkod för att skapa Postnet streckkod i Android Runtime Environment.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/android-java/postnet/generate/
aliases:
- /sv/android-java/generate/postnet/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generera Postnet-etiketter med Android via Java" h2="Skapa Postnet streckkod i Java med Aspose.BarCode på serversidan för Android via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Postnet" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Postnet streckkod Using Android via Java" %}}
Prova Aspose.BarCode för Android via Java för att enkelt skapa Postnet streckkod i Android-applikationer. Det är ett mångsidigt, robust och användarvänligt streckkodsbibliotek speciellt designat för Android-applikationer. Du kan enkelt Aspose.BarCode för Android via Java direkt från ett Maven-baserat projekt genom att infoga följande konfigurationer i build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera Postnet streckkod i Java" %}}
...
<ul><li>Skapa en ny instans av klassen BarCodeGenerator</li><li>Skapa streckkodstypen Postnet streckkod som EncodeTypes-parametern</li><li>Definiera streckkodstext med metoden setCodeText</li><li>Starta metoden generBarCodeImage() för att spara streckkodsbilden Postnet streckkod</li></ul>
