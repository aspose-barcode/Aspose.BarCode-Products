---
title: Generera Royal Mail 4-stats kundkod (RM4SCC)-bilder via Android via Java
description: Android-källkod för att skapa Royal Mail 4-stats kundkod (RM4SCC) i Android Runtime Environment.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/android-java/rm4scc/generate/
aliases:
- /sv/android-java/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generera RM4SCC-etiketter med Android via Java" h2="Skapa Royal Mail 4-stats kundkod (RM4SCC) i Java med Aspose.BarCode på serversidan för Android via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Royal Mail 4-stats kundkod (RM4SCC) Using Android via Java" %}}
Prova Aspose.BarCode för Android via Java för att enkelt skapa Royal Mail 4-stats kundkod (RM4SCC) i Android-applikationer. Det är ett mångsidigt, robust och användarvänligt streckkodsbibliotek speciellt designat för Android-applikationer. Du kan enkelt Aspose.BarCode för Android via Java direkt från ett Maven-baserat projekt genom att infoga följande konfigurationer i build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera Royal Mail 4-stats kundkod (RM4SCC) i Java" %}}
...
<ul><li>Skapa en ny instans av klassen BarCodeGenerator</li><li>Skapa streckkodstypen Royal Mail 4-stats kundkod (RM4SCC) som EncodeTypes-parametern</li><li>Definiera streckkodstext med metoden setCodeText</li><li>Starta metoden generBarCodeImage() för att spara streckkodsbilden Royal Mail 4-stats kundkod (RM4SCC)</li></ul>
