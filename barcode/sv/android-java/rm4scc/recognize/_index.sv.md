---
title: Skanna Royal Mail 4-stats kundkod (RM4SCC)-bilder via Android via Java
weight: 1510
description: Android-exempelkod för att känna igen Royal Mail 4-stats kundkod (RM4SCC) i Android Runtime Environment.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/android-java/rm4scc/recognize/
aliases:
- /sv/android-java/recognize/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för RM4SCC med Android via Java" h2="Läs Royal Mail 4-stats kundkod (RM4SCC) i Java med Aspose.BarCode på serversidan för Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skanna Royal Mail 4-stats kundkod (RM4SCC) i Java" %}}
...
<ul><li>Skapa en instans av BarCodeReader-klassen</li><li>Bestämma källbildssökvägen som innehåller Royal Mail 4-stats kundkod (RM4SCC)</li><li>Definiera målstreckkoderstyper i DecodeType som den andra parametern</li><li>Bläddra igenom igenkänningsresultaten</li><li>Läs in den avkodade texten som kör metoden getCodeText</li></ul>
