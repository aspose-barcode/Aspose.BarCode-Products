---
title: Skanna Code 93 Utökade och Code 93 standardstreckkoder-bilder via Android via Java
weight: 1510
description: Android-exempelkod för att känna igen Code 93 Utökade och Code 93 standardstreckkoder i Android Runtime Environment.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/android-java/code93/recognize/
aliases:
- /sv/android-java/recognize/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för Code 93 med Android via Java" h2="Läs Code 93 Utökade och Code 93 standardstreckkoder i Java med Aspose.BarCode på serversidan för Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skanna Code 93 streckkod i Java" %}}
...
<ul><li>Skapa en instans av BarCodeReader-klassen</li><li>Bestämma källbildssökvägen som innehåller Code 93 streckkod</li><li>Definiera målstreckkoderstyper i DecodeType som den andra parametern</li><li>Bläddra igenom igenkänningsresultaten</li><li>Läs in den avkodade texten som kör metoden getCodeText</li></ul>
