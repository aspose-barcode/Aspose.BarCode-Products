...
{{% blocks/products/pf/agp/content h2="How to Generate EAN (internationellt artikelnummer) streckkod Using Android via Java" %}}
Prova Aspose.BarCode för Android via Java för att enkelt skapa EAN (internationellt artikelnummer) streckkod i Android-applikationer. Det är ett mångsidigt, robust och användarvänligt streckkodsbibliotek speciellt designat för Android-applikationer. Du kan enkelt Aspose.BarCode för Android via Java direkt från ett Maven-baserat projekt genom att infoga följande konfigurationer i build.gradle:
...
<ul><li>Skapa en ny instans av klassen BarCodeGenerator</li><li>Skapa streckkodstypen EAN (internationellt artikelnummer) streckkod som EncodeTypes-parametern</li><li>Definiera streckkodstext med metoden setCodeText</li><li>Starta metoden generBarCodeImage() för att spara streckkodsbilden EAN (internationellt artikelnummer) streckkod</li></ul>
