---
title: Skanna GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod-bilder via Node.js via Java
weight: 1510
description: Node.js källkod för GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod skanning och avkodning i JavaScript-applikationer.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/nodejs-java/databar/recognize/
aliases:
- /sv/nodejs-java/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för GS1 DataBar med Node.js via Java" h2="Läs GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod i JavaScript med Aspose.BarCode på serversidan för Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 DataBar streckkod Using Node.js via Java" %}}
För att känna igen GS1 DataBar streckkod i Node.js-applikationer, använd Aspose.BarCode för Node.js via Java, ett robust, mångsidigt och användarvänligt streckkodsbibliotek som introducerats för Java-baserade miljöer. Du kan ladda [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) för Javascript direkt från NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skanna GS1 DataBar streckkod i JavaScript" %}}
...
<ul><li>Skapa ett objekt av klassen Aspose.BarCode.BarCodeReader</li><li>Skapa källfilens sökväg som innehåller GS1 DataBar streckkod som en parameter</li><li>Ange målstreckkoder i DecodeType som den andra parametern</li><li>Slinga igenom alla upptäckta streckkoder</li><li>Hämta den resulterande streckkodstexten med hjälp av CodeText-egenskapen</li></ul>
...
<ul><li>Microsoft Windows, Linux eller något annat operativsystem som är kompatibelt med Node.js</li><li>Node.js och Node.js/Java Bridge installerade</li><li>Oracle JDK version 7 eller senare </li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/pdf417/recognize/" name="PDF417" description="PDF417 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/qr/recognize/" name="QR" description="QR Kod, GS1 QR Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix-kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/aztec/recognize/" name="Aztec" description="Aztec Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR räkning" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/dotcode/recognize/" name="DotCode" description="DotCode streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/hibc/recognize/" name="HIBC" description="HIBC (hälsobranschens streckkod)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/codablock/recognize/" name="Codablock-F" description="Codablock-F och GS1 Codablock-F streckkoder" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/itf/recognize/" name="ITF" description="Interfolierad 2-av-5 (ITF) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/ean/recognize/" name="EAN" description="EAN (internationellt artikelnummer) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/upc/recognize/" name="UPC" description="UPC (Universal Product Code) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/code39/recognize/" name="Code 39" description="Code 39 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/code16k/recognize/" name="Code 16K" description="Code 16K streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/code32/recognize/" name="Code 32" description="Italiensk läkemedelskod (Code 32) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/code93/recognize/" name="Code 93" description="Code 93 Utökade och Code 93 standardstreckkoder" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriell 2 av 5) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/isbn/recognize/" name="ISBN" description="ISBN streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/ismn/recognize/" name="ISMN" description="ISMN streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/issn/recognize/" name="ISSN" description="ISSN streckkod" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/australia-post/recognize/" name="Australia Post" description="Australia Post streckkod och Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode och Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4-stats kundkod (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/postnet/recognize/" name="Postnet" description="Postnet streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/royal-mail/recognize/" name="Royal Mail" description="Royal Mail streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/singapore-post/recognize/" name="Singapore Post" description="Singapore Post streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/nodejs-java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
