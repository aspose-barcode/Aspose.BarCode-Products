---
title: Skanna PDF417 streckkod-bilder via Node.js via Java
weight: 1510
description: Node.js källkod för PDF417 streckkod skanning och avkodning i JavaScript-applikationer.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/nodejs-java/pdf417/recognize/
aliases:
- /sv/nodejs-java/recognize/pdf417/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för PDF417 med Node.js via Java" h2="Läs PDF417 streckkod i JavaScript med Aspose.BarCode på serversidan för Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF417" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skanna PDF417 streckkod i JavaScript" %}}
...
<ul><li>Skapa ett objekt av klassen Aspose.BarCode.BarCodeReader</li><li>Skapa källfilens sökväg som innehåller PDF417 streckkod som en parameter</li><li>Ange målstreckkoder i DecodeType som den andra parametern</li><li>Slinga igenom alla upptäckta streckkoder</li><li>Hämta den resulterande streckkodstexten med hjälp av CodeText-egenskapen</li></ul>
