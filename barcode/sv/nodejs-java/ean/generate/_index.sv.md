...
{{% blocks/products/pf/agp/content h2="How to Generate EAN (internationellt artikelnummer) streckkod Using Node.js via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera EAN (internationellt artikelnummer) streckkod i JavaScript" %}}
...
<ul><li>Skapa en instans av BarCodeGenerator-klassen</li><li>Ange EAN (internationellt artikelnummer) streckkod som EncodeTypes-parametern</li><li>Definiera text som ska kodas som den andra parametern</li><li>Fastställ streckkodsdimensioner och plats vid behov</li><li>Anrop BarCodeGenerator.save-metoden för att få den genererade streckkodsbilden</li></ul>
