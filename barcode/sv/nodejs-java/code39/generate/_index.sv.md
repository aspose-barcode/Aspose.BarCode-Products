---
title: Generera Code 39 streckkod-bilder via Node.js via Java
description: Node.js exempelkod för generering av Code 39 streckkod i JavaScript-applikationer.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/nodejs-java/code39/generate/
aliases:
- /sv/nodejs-java/generate/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generera Code 39-etiketter med Node.js via Java" h2="Skapa Code 39 streckkod i JavaScript med Aspose.BarCode på serversidan för Node.js via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera Code 39 streckkod i JavaScript" %}}
...
<ul><li>Skapa en instans av BarCodeGenerator-klassen</li><li>Ange Code 39 streckkod som EncodeTypes-parametern</li><li>Definiera text som ska kodas som den andra parametern</li><li>Fastställ streckkodsdimensioner och plats vid behov</li><li>Anrop BarCodeGenerator.save-metoden för att få den genererade streckkodsbilden</li></ul>
