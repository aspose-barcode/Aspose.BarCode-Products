...
{{% blocks/products/pf/agp/content h2="How to Generate Interfolierad 2-av-5 (ITF) streckkod Using C++" %}}
...
<ul><li>Skapa ett objekt av klassen BarcodeGenerator</li><li>Skapa Interfolierad 2-av-5 (ITF) streckkod som en parameter</li><li>Infoga inmatningstext för att koda som den andra parametern</li><li>Definiera bildmått vid behov</li><li>Ring BarcodeGenerator. Spara metoden för att ladda ned streckkoden Interfolierad 2-av-5 (ITF) streckkod</li></ul>
