---
title: Skanna GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod-bilder via C++
weight: 1510
description: C++ exempelkod för att skanna och avkoda GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod i C++ Runtime Environment för Windows 32-bitars, Windows 64-bitars eller Linux 64-bitars.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/cpp/databar/recognize/
aliases:
- /sv/cpp/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för GS1 DataBar med C++" h2="Läs GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod i C++ med Aspose.BarCode på serversidan för C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 DataBar streckkod Using C++" %}}
För att skanna GS1 DataBar streckkod, prova [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, ett kraftfullt och lättanvänt streckkodsbibliotek med rik funktionalitet för C++-plattformar . Du kan ladda ner den senaste versionen direkt&colon; öppna bara [NuGet](https://www.nuget.org/packages/aspose.barcode) pakethanteraren, sök efter **Aspose.BarCode.Cpp** och installera paketet. Alternativt kan du köra följande kommando från Package Manager Console.
...
<ul><li>Skapa ett objekt av klassen Aspose.BarCode.BarCodeReader</li><li>Ange sökvägen för källbilden som innehåller GS1 DataBar streckkod som en parameter</li><li>Ge de obligatoriska streckkoderna i DecodeType som den andra parametern</li><li>Bläddra igenom igenkänningsresultaten</li><li>Läs in den avkodade streckkodstexten med hjälp av CodeText-egenskapen</li></ul>
...
<ul><li>Microsoft Windows, Linux eller något annat operativsystem som är kompatibelt med C++ Runtime Environment för Windows 32-bitars, Windows 64-bitars och Linux 64-bitars.</li><li>Aspose.BarCode för C++ DLL refereras till i ditt projekt.</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/pdf417/recognize/" name="PDF417" description="PDF417 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/qr/recognize/" name="QR" description="QR Kod, GS1 QR Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/datamatrix/recognize/" name="Data Matrix" description="Data Matrix-kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/aztec/recognize/" name="Aztec" description="Aztec Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR räkning" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/dotcode/recognize/" name="DotCode" description="DotCode streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/hibc/recognize/" name="HIBC" description="HIBC (hälsobranschens streckkod)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/codablock/recognize/" name="Codablock-F" description="Codablock-F och GS1 Codablock-F streckkoder" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/itf/recognize/" name="ITF" description="Interfolierad 2-av-5 (ITF) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/ean/recognize/" name="EAN" description="EAN (internationellt artikelnummer) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/upc/recognize/" name="UPC" description="UPC (Universal Product Code) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/code39/recognize/" name="Code 39" description="Code 39 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/code16k/recognize/" name="Code 16K" description="Code 16K streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/code32/recognize/" name="Code 32" description="Italiensk läkemedelskod (Code 32) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/code93/recognize/" name="Code 93" description="Code 93 Utökade och Code 93 standardstreckkoder" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/onecode/recognize/" name="USPS OneCode" description="USPS OneCode streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriell 2 av 5) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/isbn/recognize/" name="ISBN" description="ISBN streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/ismn/recognize/" name="ISMN" description="ISMN streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/issn/recognize/" name="ISSN" description="ISSN streckkod" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/australia-post/recognize/" name="Australia Post" description="Australia Post streckkod och Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode och Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4-stats kundkod (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/postnet/recognize/" name="Postnet" description="Postnet streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/royal-mail/recognize/" name="Royal Mail" description="Royal Mail streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/singapore-post/recognize/" name="Singapore Post" description="Singapore Post streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/cpp/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
