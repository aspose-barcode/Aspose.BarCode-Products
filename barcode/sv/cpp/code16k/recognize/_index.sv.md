---
title: Skanna Code 16K streckkod-bilder via C++
weight: 1510
description: C++ exempelkod för att skanna och avkoda Code 16K streckkod i C++ Runtime Environment för Windows 32-bitars, Windows 64-bitars eller Linux 64-bitars.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/cpp/code16k/recognize/
aliases:
- /sv/cpp/recognize/code16k/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för Code 16K med C++" h2="Läs Code 16K streckkod i C++ med Aspose.BarCode på serversidan för C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 16K streckkod Using C++" %}}
För att skanna Code 16K streckkod, prova [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, ett kraftfullt och lättanvänt streckkodsbibliotek med rik funktionalitet för C++-plattformar . Du kan ladda ner den senaste versionen direkt&colon; öppna bara [NuGet](https://www.nuget.org/packages/aspose.barcode) pakethanteraren, sök efter **Aspose.BarCode.Cpp** och installera paketet. Alternativt kan du köra följande kommando från Package Manager Console.
...
<ul><li>Skapa ett objekt av klassen Aspose.BarCode.BarCodeReader</li><li>Ange sökvägen för källbilden som innehåller Code 16K streckkod som en parameter</li><li>Ge de obligatoriska streckkoderna i DecodeType som den andra parametern</li><li>Bläddra igenom igenkänningsresultaten</li><li>Läs in den avkodade streckkodstexten med hjälp av CodeText-egenskapen</li></ul>
