...
{{% blocks/products/pf/agp/content h2="How to Generate UPC (Universal Product Code) streckkod Using C++" %}}
För att generera UPC (Universal Product Code) streckkod, installera [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, ett robust och lättanvänt streckkodsbibliotek med rik funktionalitet för C++-plattformar . Ladda ner den senaste versionen direkt från [NuGet](https://www.nuget.org/packages/aspose.barcode) pakethanteraren&colon; sök efter **Aspose.BarCode.Cpp** och installera sedan paketet. Alternativt, öppna Package Manager-konsolen och kör följande kommando:
...
<ul><li>Skapa ett objekt av klassen BarcodeGenerator</li><li>Skapa UPC (Universal Product Code) streckkod som en parameter</li><li>Infoga inmatningstext för att koda som den andra parametern</li><li>Definiera bildmått vid behov</li><li>Ring BarcodeGenerator. Spara metoden för att ladda ned streckkoden UPC (Universal Product Code) streckkod</li></ul>
