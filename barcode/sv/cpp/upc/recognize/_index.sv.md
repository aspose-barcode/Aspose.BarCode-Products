...
{{% blocks/products/pf/agp/content h2="How to Read UPC (Universal Product Code) streckkod Using C++" %}}
För att skanna UPC (Universal Product Code) streckkod, prova [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, ett kraftfullt och lättanvänt streckkodsbibliotek med rik funktionalitet för C++-plattformar . Du kan ladda ner den senaste versionen direkt&colon; öppna bara [NuGet](https://www.nuget.org/packages/aspose.barcode) pakethanteraren, sök efter **Aspose.BarCode.Cpp** och installera paketet. Alternativt kan du köra följande kommando från Package Manager Console.
...
<ul><li>Skapa ett objekt av klassen Aspose.BarCode.BarCodeReader</li><li>Ange sökvägen för källbilden som innehåller UPC (Universal Product Code) streckkod som en parameter</li><li>Ge de obligatoriska streckkoderna i DecodeType som den andra parametern</li><li>Bläddra igenom igenkänningsresultaten</li><li>Läs in den avkodade streckkodstexten med hjälp av CodeText-egenskapen</li></ul>
