---
title: Generera GS1 Code 128 streckkod-bilder via C++
description: C++ exempel på kod för att generera GS1 Code 128 streckkod i C++ Runtime Environment för Windows 32-bitars, Windows 64-bitars och Linux 64-bitars.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/cpp/code128/generate/
aliases:
- /sv/cpp/generate/code128/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generera GS1 Code 128-etiketter med C++" h2="Skapa GS1 Code 128 streckkod i C++ med Aspose.BarCode på serversidan för C++ API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate GS1 Code 128 streckkod Using C++" %}}
För att generera GS1 Code 128 streckkod, installera [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, ett robust och lättanvänt streckkodsbibliotek med rik funktionalitet för C++-plattformar . Ladda ner den senaste versionen direkt från [NuGet](https://www.nuget.org/packages/aspose.barcode) pakethanteraren&colon; sök efter **Aspose.BarCode.Cpp** och installera sedan paketet. Alternativt, öppna Package Manager-konsolen och kör följande kommando:
...
<ul><li>Skapa ett objekt av klassen BarcodeGenerator</li><li>Skapa GS1 Code 128 streckkod som en parameter</li><li>Infoga inmatningstext för att koda som den andra parametern</li><li>Definiera bildmått vid behov</li><li>Ring BarcodeGenerator. Spara metoden för att ladda ned streckkoden GS1 Code 128 streckkod</li></ul>
