---
title: Generera Royal Mail 4-stats kundkod (RM4SCC)-bilder via PHP via Java
description: PHP-källkod för att skapa Royal Mail 4-stats kundkod (RM4SCC) i PHP-baserade applikationer.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/php-java/rm4scc/generate/
aliases:
- /sv/php-java/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generera RM4SCC-etiketter med PHP via Java" h2="Skapa Royal Mail 4-stats kundkod (RM4SCC) i PHP med Aspose.BarCode på serversidan för PHP via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera Royal Mail 4-stats kundkod (RM4SCC) i PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode gör det enkelt för utvecklare att skapa Royal Mail 4-stats kundkod (RM4SCC)-bilder med några rader kod.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Skapa en ny instans av BarCodeGenerator-klassen</li><li>Ange Royal Mail 4-stats kundkod (RM4SCC) och andra relevanta streckkodstyper som EncodeTypes-parametern</li><li>Ange streckkodstext som den andra parametern</li><li>Ange bildens mått och plats vid behov</li><li>Anropa metoden BarCodeGenerator.save för att få Royal Mail 4-stats kundkod (RM4SCC)-bilden i det format som krävs</li></ul>
