---
title: Generera PDF417 streckkod-bilder via PHP via Java
description: PHP-källkod för att skapa PDF417 streckkod i PHP-baserade applikationer.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/php-java/pdf417/generate/
aliases:
- /sv/php-java/generate/pdf417/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generera PDF417-etiketter med PHP via Java" h2="Skapa PDF417 streckkod i PHP med Aspose.BarCode på serversidan för PHP via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF417" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera PDF417 streckkod i PHP" %}}
...
<ul><li>Skapa en ny instans av BarCodeGenerator-klassen</li><li>Ange PDF417 streckkod och andra relevanta streckkodstyper som EncodeTypes-parametern</li><li>Ange streckkodstext som den andra parametern</li><li>Ange bildens mått och plats vid behov</li><li>Anropa metoden BarCodeGenerator.save för att få PDF417 streckkod-bilden i det format som krävs</li></ul>
