---
title: Skanna Australia Post streckkod och Australia Post eParcel-bilder via PHP via Java
weight: 1510
description: PHP-exempelkod för att läsa Australia Post streckkod och Australia Post eParcel i PHP-baserade applikationer.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/php-java/australia-post/recognize/
aliases:
- /sv/php-java/recognize/australia-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för Australia Post med PHP via Java" h2="Läs Australia Post streckkod och Australia Post eParcel i PHP med Aspose.BarCode på serversidan för PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skanna Australia Post streckkod i PHP" %}}
...
<ul><li>Skapa ett objekt av klassen Aspose.BarCode.BarCodeReader</li><li>Ställ in sökvägen för källbilden som innehåller Australia Post streckkod som en parameter</li><li>Ange målstreckkoderstyper i DecodeType som den andra parametern</li><li>Bläddra igenom läsresultaten</li><li>Hämta streckkodstexten med hjälp av CodeText-egenskapen</li></ul>
