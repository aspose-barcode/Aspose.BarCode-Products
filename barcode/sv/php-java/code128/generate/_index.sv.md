---
title: Generera GS1 Code 128 streckkod-bilder via PHP via Java
description: PHP-källkod för att skapa GS1 Code 128 streckkod i PHP-baserade applikationer.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/php-java/code128/generate/
aliases:
- /sv/php-java/generate/code128/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generera GS1 Code 128-etiketter med PHP via Java" h2="Skapa GS1 Code 128 streckkod i PHP med Aspose.BarCode på serversidan för PHP via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera GS1 Code 128 streckkod i PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode gör det enkelt för utvecklare att skapa GS1 Code 128 streckkod-bilder med några rader kod.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Skapa en ny instans av BarCodeGenerator-klassen</li><li>Ange GS1 Code 128 streckkod och andra relevanta streckkodstyper som EncodeTypes-parametern</li><li>Ange streckkodstext som den andra parametern</li><li>Ange bildens mått och plats vid behov</li><li>Anropa metoden BarCodeGenerator.save för att få GS1 Code 128 streckkod-bilden i det format som krävs</li></ul>
