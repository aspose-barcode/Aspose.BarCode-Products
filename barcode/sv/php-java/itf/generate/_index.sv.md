---
title: Generera Interfolierad 2-av-5 (ITF) streckkod-bilder via PHP via Java
description: PHP-källkod för att skapa Interfolierad 2-av-5 (ITF) streckkod i PHP-baserade applikationer.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/php-java/itf/generate/
aliases:
- /sv/php-java/generate/itf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generera ITF-etiketter med PHP via Java" h2="Skapa Interfolierad 2-av-5 (ITF) streckkod i PHP med Aspose.BarCode på serversidan för PHP via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera Interfolierad 2-av-5 (ITF) streckkod i PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode gör det enkelt för utvecklare att skapa Interfolierad 2-av-5 (ITF) streckkod-bilder med några rader kod.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Skapa en ny instans av BarCodeGenerator-klassen</li><li>Ange Interfolierad 2-av-5 (ITF) streckkod och andra relevanta streckkodstyper som EncodeTypes-parametern</li><li>Ange streckkodstext som den andra parametern</li><li>Ange bildens mått och plats vid behov</li><li>Anropa metoden BarCodeGenerator.save för att få Interfolierad 2-av-5 (ITF) streckkod-bilden i det format som krävs</li></ul>
