---
title: Skanna Standard 2 of 5 (Industriell 2 av 5) streckkod-bilder via PHP via Java
weight: 1510
description: PHP-exempelkod för att läsa Standard 2 of 5 (Industriell 2 av 5) streckkod i PHP-baserade applikationer.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/php-java/standard2of5/recognize/
aliases:
- /sv/php-java/recognize/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för Standard 2 of 5 med PHP via Java" h2="Läs Standard 2 of 5 (Industriell 2 av 5) streckkod i PHP med Aspose.BarCode på serversidan för PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skanna Standard 2 of 5 streckkod i PHP" %}}
...
<ul><li>Skapa ett objekt av klassen Aspose.BarCode.BarCodeReader</li><li>Ställ in sökvägen för källbilden som innehåller Standard 2 of 5 streckkod som en parameter</li><li>Ange målstreckkoderstyper i DecodeType som den andra parametern</li><li>Bläddra igenom läsresultaten</li><li>Hämta streckkodstexten med hjälp av CodeText-egenskapen</li></ul>
