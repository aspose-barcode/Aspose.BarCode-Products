---
title: Skanna Deutsche Post Identcode och Deutsche Post Leitcode-bilder via .NET
weight: 1510
description: C# exempelkod för att skanna och avkoda Deutsche Post Identcode och Deutsche Post Leitcode streckkodstyp i .NET Framework, .NET Standard, COM Interloop för PHP, VBScript, Delphi eller C++.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/net/deutsche-post/recognize/
aliases:
- /sv/net/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för Deutsche Post med .NET" h2="Läs Deutsche Post Identcode och Deutsche Post Leitcode i C# med Aspose.BarCode på serversidan för .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skanna Deutsche Post streckkod i C#" %}}
...
<ul><li>Skapa en ny instans av Aspose.BarCode.BarCodeReader-klassen</li><li>Skapa källbildssökvägen som innehåller Deutsche Post streckkod som en parameter</li><li>Skicka en lämplig DecodeType som den andra parametern</li><li>Bläddra igenom avkodningsresultaten</li><li>Hämta streckkodstext med hjälp av CodeText-egenskapen</li></ul>
