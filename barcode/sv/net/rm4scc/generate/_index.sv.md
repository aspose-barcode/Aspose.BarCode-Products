---
title: Generera Royal Mail 4-stats kundkod (RM4SCC)-bilder via .NET
description: C#-källkod för Royal Mail 4-stats kundkod (RM4SCC)-generationen i .NET Framework, .NET Standard, COM Interloop för PHP, VBScript, Delphi och C++.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/net/rm4scc/generate/
aliases:
- /sv/net/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generera RM4SCC-etiketter med .NET" h2="Skapa Royal Mail 4-stats kundkod (RM4SCC) i C# med Aspose.BarCode på serversidan för .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Royal Mail 4-stats kundkod (RM4SCC) Using .NET" %}}
För att skapa Royal Mail 4-stats kundkod (RM4SCC), prova [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, ett funktionsrikt, kraftfullt och lättanvänt streckkodsbibliotek för C#-plattformar. Öppna [NuGet](https://www.nuget.org/packages/aspose.barcode) pakethanteraren, sök efter **Aspose.BarCode** och installera paketet. Du kan också köra följande kommando från Package Manager-konsolen:
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera Royal Mail 4-stats kundkod (RM4SCC) i C#" %}}
...
<ul><li>Skapa en instans av BarcodeGenerator-klassen</li><li>Skicka Royal Mail 4-stats kundkod (RM4SCC) som en parameter</li><li>Ange text att koda som den andra parametern</li><li> Ange streckkodsmått vid behov</li><li>Ring BarcodeGenerator.Spara-metoden för att få Royal Mail 4-stats kundkod (RM4SCC)-bilden</li></ul>
