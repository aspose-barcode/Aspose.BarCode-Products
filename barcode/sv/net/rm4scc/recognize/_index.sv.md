---
title: Skanna Royal Mail 4-stats kundkod (RM4SCC)-bilder via .NET
weight: 1510
description: C# exempelkod för att skanna och avkoda Royal Mail 4-stats kundkod (RM4SCC) streckkodstyp i .NET Framework, .NET Standard, COM Interloop för PHP, VBScript, Delphi eller C++.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/net/rm4scc/recognize/
aliases:
- /sv/net/recognize/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för RM4SCC med .NET" h2="Läs Royal Mail 4-stats kundkod (RM4SCC) i C# med Aspose.BarCode på serversidan för .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Royal Mail 4-stats kundkod (RM4SCC) Using .NET" %}}
För att avkoda Royal Mail 4-stats kundkod (RM4SCC), prova [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, ett funktionsrikt, kraftfullt och lättanvänt streckkodsbibliotek för C#-plattformar. Använd [NuGet](https://www.nuget.org/packages/aspose.barcode) och sök efter **Aspose.BarCode** för att installera paketet. Alternativt kan du köra följande kommando från Package Manager-konsolen:
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skanna Royal Mail 4-stats kundkod (RM4SCC) i C#" %}}
...
<ul><li>Skapa en ny instans av Aspose.BarCode.BarCodeReader-klassen</li><li>Skapa källbildssökvägen som innehåller Royal Mail 4-stats kundkod (RM4SCC) som en parameter</li><li>Skicka en lämplig DecodeType som den andra parametern</li><li>Bläddra igenom avkodningsresultaten</li><li>Hämta streckkodstext med hjälp av CodeText-egenskapen</li></ul>
