...
{{% blocks/products/pf/agp/content h2="How to Read UPC (Universal Product Code) streckkod Using .NET" %}}
För att avkoda UPC (Universal Product Code) streckkod, prova [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, ett funktionsrikt, kraftfullt och lättanvänt streckkodsbibliotek för C#-plattformar. Använd [NuGet](https://www.nuget.org/packages/aspose.barcode) och sök efter **Aspose.BarCode** för att installera paketet. Alternativt kan du köra följande kommando från Package Manager-konsolen:
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skanna UPC (Universal Product Code) streckkod i C#" %}}
...
<ul><li>Skapa en ny instans av Aspose.BarCode.BarCodeReader-klassen</li><li>Skapa källbildssökvägen som innehåller UPC (Universal Product Code) streckkod som en parameter</li><li>Skicka en lämplig DecodeType som den andra parametern</li><li>Bläddra igenom avkodningsresultaten</li><li>Hämta streckkodstext med hjälp av CodeText-egenskapen</li></ul>
