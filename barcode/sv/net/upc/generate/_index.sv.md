...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera UPC (Universal Product Code) streckkod i C#" %}}
...
<ul><li>Skapa en instans av BarcodeGenerator-klassen</li><li>Skicka UPC (Universal Product Code) streckkod som en parameter</li><li>Ange text att koda som den andra parametern</li><li> Ange streckkodsmått vid behov</li><li>Ring BarcodeGenerator.Spara-metoden för att få UPC (Universal Product Code) streckkod-bilden</li></ul>
