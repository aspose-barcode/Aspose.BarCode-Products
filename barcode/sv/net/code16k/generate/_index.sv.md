---
title: Generera Code 16K streckkod-bilder via .NET
description: C#-källkod för Code 16K streckkod-generationen i .NET Framework, .NET Standard, COM Interloop för PHP, VBScript, Delphi och C++.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/net/code16k/generate/
aliases:
- /sv/net/generate/code16k/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generera Code 16K-etiketter med .NET" h2="Skapa Code 16K streckkod i C# med Aspose.BarCode på serversidan för .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera Code 16K streckkod i C#" %}}
...
<ul><li>Skapa en instans av BarcodeGenerator-klassen</li><li>Skicka Code 16K streckkod som en parameter</li><li>Ange text att koda som den andra parametern</li><li> Ange streckkodsmått vid behov</li><li>Ring BarcodeGenerator.Spara-metoden för att få Code 16K streckkod-bilden</li></ul>
