...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att generera EAN (internationellt artikelnummer) streckkod i C#" %}}
...
<ul><li>Skapa en instans av BarcodeGenerator-klassen</li><li>Skicka EAN (internationellt artikelnummer) streckkod som en parameter</li><li>Ange text att koda som den andra parametern</li><li> Ange streckkodsmått vid behov</li><li>Ring BarcodeGenerator.Spara-metoden för att få EAN (internationellt artikelnummer) streckkod-bilden</li></ul>
