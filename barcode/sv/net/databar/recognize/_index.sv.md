---
title: Skanna GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod-bilder via .NET
weight: 1510
description: C# exempelkod för att skanna och avkoda GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod streckkodstyp i .NET Framework, .NET Standard, COM Interloop för PHP, VBScript, Delphi eller C++.
lang: sv/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /sv/net/databar/recognize/
aliases:
- /sv/net/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Läs streckkoder för GS1 DataBar med .NET" h2="Läs GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod i C# med Aspose.BarCode på serversidan för .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 DataBar streckkod Using .NET" %}}
För att avkoda GS1 DataBar streckkod, prova [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, ett funktionsrikt, kraftfullt och lättanvänt streckkodsbibliotek för C#-plattformar. Använd [NuGet](https://www.nuget.org/packages/aspose.barcode) och sök efter **Aspose.BarCode** för att installera paketet. Alternativt kan du köra följande kommando från Package Manager-konsolen:
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skanna GS1 DataBar streckkod i C#" %}}
...
<ul><li>Skapa en ny instans av Aspose.BarCode.BarCodeReader-klassen</li><li>Skapa källbildssökvägen som innehåller GS1 DataBar streckkod som en parameter</li><li>Skicka en lämplig DecodeType som den andra parametern</li><li>Bläddra igenom avkodningsresultaten</li><li>Hämta streckkodstext med hjälp av CodeText-egenskapen</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/pdf417/recognize/" name="PDF417" description="PDF417 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/qr/recognize/" name="QR" description="QR Kod, GS1 QR Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/datamatrix/recognize/" name="Data Matrix" description="Data Matrix-kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/aztec/recognize/" name="Aztec" description="Aztec Kod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR räkning" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/dotcode/recognize/" name="DotCode" description="DotCode streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/hibc/recognize/" name="HIBC" description="HIBC (hälsobranschens streckkod)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/codablock/recognize/" name="Codablock-F" description="Codablock-F och GS1 Codablock-F streckkoder" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (rundstrålande, staplad rundstrålande, expanderad, expanderad staplad och trunkerad) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/itf/recognize/" name="ITF" description="Interfolierad 2-av-5 (ITF) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/ean/recognize/" name="EAN" description="EAN (internationellt artikelnummer) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/upc/recognize/" name="UPC" description="UPC (Universal Product Code) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/code39/recognize/" name="Code 39" description="Code 39 streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/code16k/recognize/" name="Code 16K" description="Code 16K streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/code32/recognize/" name="Code 32" description="Italiensk läkemedelskod (Code 32) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/code93/recognize/" name="Code 93" description="Code 93 Utökade och Code 93 standardstreckkoder" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/onecode/recognize/" name="USPS OneCode" description="USPS OneCode streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriell 2 av 5) streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/isbn/recognize/" name="ISBN" description="ISBN streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/ismn/recognize/" name="ISMN" description="ISMN streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/issn/recognize/" name="ISSN" description="ISSN streckkod" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/australia-post/recognize/" name="Australia Post" description="Australia Post streckkod och Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode och Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4-stats kundkod (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/postnet/recognize/" name="Postnet" description="Postnet streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/royal-mail/recognize/" name="Royal Mail" description="Royal Mail streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/singapore-post/recognize/" name="Singapore Post" description="Singapore Post streckkod" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/sv/net/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
