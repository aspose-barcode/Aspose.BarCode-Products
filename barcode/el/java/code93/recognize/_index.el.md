---
title: Σάρωση εικόνων Code 93 Extended και Code 93 Τυπικοί γραμμικοί κώδικες μέσω Java
weight: 1510
description: Πηγαίος κώδικας Java για ανάγνωση και αποκωδικοποίηση Code 93 Extended και Code 93 Τυπικοί γραμμικοί κώδικες στο Java Runtime Environment για εφαρμογές JSP/JSF και εφαρμογές επιφάνειας εργασίας.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/java/code93/recognize/
aliases:
- /el/java/recognize/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες Code 93 με Java" h2="Διαβάστε το Code 93 Extended και Code 93 Τυπικοί γραμμικοί κώδικες στο Java χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
