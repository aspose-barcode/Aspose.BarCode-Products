---
title: Σάρωση εικόνων QR Κωδικός, GS1 QR Κωδικός μέσω Java
weight: 1510
description: Πηγαίος κώδικας Java για ανάγνωση και αποκωδικοποίηση QR Κωδικός, GS1 QR Κωδικός στο Java Runtime Environment για εφαρμογές JSP/JSF και εφαρμογές επιφάνειας εργασίας.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/java/qr/recognize/
aliases:
- /el/java/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες QR με Java" h2="Διαβάστε το QR Κωδικός, GS1 QR Κωδικός στο Java χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
