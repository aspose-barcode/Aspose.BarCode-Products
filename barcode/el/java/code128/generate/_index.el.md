...
<ul><li>Δημιουργήστε ένα νέο αντικείμενο της κλάσης BarCodeGenerator</li><li>Ορίστε τον GS1 Code 128 γραμμωτός κώδικας και άλλους απαιτούμενους τύπους γραμμικού κώδικα ως την παράμετρο EncodeTypes</li><li>Καθορίστε το κείμενο εισαγωγής χρησιμοποιώντας τη μέθοδο setCodeText</li><li>Χρησιμοποιήστε τη μέθοδο BarCodeGenerator.save για να αποθηκεύσετε την εικόνα γραμμικού κώδικα που δημιουργήθηκε</li></ul>
