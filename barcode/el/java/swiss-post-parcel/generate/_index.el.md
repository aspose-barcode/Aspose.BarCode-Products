---
title: Δημιουργία εικόνων Swiss Post Parcel μέσω Java
description: Δείγμα κώδικα Java για τη γενιά Swiss Post Parcel στο Java Runtime Environment για εφαρμογές JSP/JSF και εφαρμογές επιτραπέζιου υπολογιστή.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/java/swiss-post-parcel/generate/
aliases:
- /el/java/generate/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Δημιουργήστε ετικέτες Swiss Post Parcel με Java" h2="Δημιουργήστε το Swiss Post Parcel στο Java χρησιμοποιώντας το Aspose.BarCode από τον διακομιστή για το API Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Δημιουργήστε ένα νέο αντικείμενο της κλάσης BarCodeGenerator</li><li>Ορίστε τον Swiss Post Parcel και άλλους απαιτούμενους τύπους γραμμικού κώδικα ως την παράμετρο EncodeTypes</li><li>Καθορίστε το κείμενο εισαγωγής χρησιμοποιώντας τη μέθοδο setCodeText</li><li>Χρησιμοποιήστε τη μέθοδο BarCodeGenerator.save για να αποθηκεύσετε την εικόνα γραμμικού κώδικα που δημιουργήθηκε</li></ul>
