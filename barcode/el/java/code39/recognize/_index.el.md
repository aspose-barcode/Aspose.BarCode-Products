---
title: Σάρωση εικόνων Code 39 γραμμωτός κώδικας μέσω Java
weight: 1510
description: Πηγαίος κώδικας Java για ανάγνωση και αποκωδικοποίηση Code 39 γραμμωτός κώδικας στο Java Runtime Environment για εφαρμογές JSP/JSF και εφαρμογές επιφάνειας εργασίας.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/java/code39/recognize/
aliases:
- /el/java/recognize/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες Code 39 με Java" h2="Διαβάστε το Code 39 γραμμωτός κώδικας στο Java χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
