---
title: Σάρωση εικόνων ISMN γραμμωτός κώδικας μέσω Python via Java
weight: 1510
description: Πηγαίος κώδικας Python για αναγνώριση ISMN γραμμωτός κώδικας με χρήση Java Runtime Environment.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/python-java/ismn/recognize/
aliases:
- /el/python-java/recognize/ismn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες ISMN με Python via Java" h2="Διαβάστε το ISMN γραμμωτός κώδικας στο Python χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη σάρωση του ISMN γραμμωτός κώδικας στο Python" %}}
...
<ul><li>Δημιουργήστε ένα αντικείμενο της κλάσης Aspose.BarCode.BarCodeReader</li><li>Ορίστε τη διαδρομή του αρχείου προέλευσης που περιέχει το ISMN γραμμωτός κώδικας ως παράμετρο</li><li>Προσδιορίστε τους απαιτούμενους τύπους γραμμωτών κωδίκων στο DecodeType ως δεύτερη παράμετρος</li><li>Κάντε βρόχο στα αποτελέσματα αποκωδικοποίησης</li><li>Λάβετε το κείμενο του γραμμικού κώδικα χρησιμοποιώντας την ιδιότητα CodeText</li></ul>
