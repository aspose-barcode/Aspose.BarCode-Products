---
title: Σάρωση εικόνων Code 93 Extended και Code 93 Τυπικοί γραμμικοί κώδικες μέσω Python via Java
weight: 1510
description: Πηγαίος κώδικας Python για αναγνώριση Code 93 Extended και Code 93 Τυπικοί γραμμικοί κώδικες με χρήση Java Runtime Environment.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/python-java/code93/recognize/
aliases:
- /el/python-java/recognize/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες Code 93 με Python via Java" h2="Διαβάστε το Code 93 Extended και Code 93 Τυπικοί γραμμικοί κώδικες στο Python χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 93 γραμμωτός κώδικας Using Python via Java" %}}
Για να σαρώσετε και να αποκωδικοποιήσετε το Code 93 γραμμωτός κώδικας, εγκαταστήστε το [Aspose.BarCode for Python μέσω Java](https://products.aspose.com/barcode/python-java/), ένα ευέλικτο, ισχυρό και εύκολο στη χρήση χρησιμοποιήστε τη βιβλιοθήκη γραμμωτού κώδικα για εφαρμογές που βασίζονται σε Python. Αποκτήστε την πιο πρόσφατη έκδοση απευθείας από την πύλη [Aspose releases](https://releases.aspose.com/barcode/python-java/) ή εγκαταστήστε το "aspose-barcode" από το pip εκτελώντας την ακόλουθη εντολή:
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη σάρωση του Code 93 γραμμωτός κώδικας στο Python" %}}
...
<ul><li>Δημιουργήστε ένα αντικείμενο της κλάσης Aspose.BarCode.BarCodeReader</li><li>Ορίστε τη διαδρομή του αρχείου προέλευσης που περιέχει το Code 93 γραμμωτός κώδικας ως παράμετρο</li><li>Προσδιορίστε τους απαιτούμενους τύπους γραμμωτών κωδίκων στο DecodeType ως δεύτερη παράμετρος</li><li>Κάντε βρόχο στα αποτελέσματα αποκωδικοποίησης</li><li>Λάβετε το κείμενο του γραμμικού κώδικα χρησιμοποιώντας την ιδιότητα CodeText</li></ul>
