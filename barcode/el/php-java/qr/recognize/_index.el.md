---
title: Σάρωση εικόνων QR Κωδικός, GS1 QR Κωδικός μέσω PHP via Java
weight: 1510
description: Δείγμα κώδικα PHP για ανάγνωση QR Κωδικός, GS1 QR Κωδικός σε εφαρμογές που βασίζονται σε PHP.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/php-java/qr/recognize/
aliases:
- /el/php-java/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες QR με PHP via Java" h2="Διαβάστε το QR Κωδικός, GS1 QR Κωδικός στο PHP χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη σάρωση του QR Κωδ στο PHP" %}}

{{% blocks/products/pf/agp/text %}}

Το Aspose.BarCode επιτρέπει στους προγραμματιστές να διαβάζουν γραμμικούς κώδικες QR Κωδ από ροή ή εικόνα με λίγες γραμμές κώδικα

{{% /blocks/products/pf/agp/text %}}

<ul><li>Δημιουργήστε ένα αντικείμενο της κλάσης Aspose.BarCode.BarCodeReader</li><li>Ορίστε τη διαδρομή εικόνας πηγής που περιέχει το QR Κωδ ως παράμετρο</li><li>Καθορίστε τους τύπους γραμμωτών κωδίκων στόχου στο DecodeType ως δεύτερη παράμετρος</li><li>Κάντε βρόχο στα αποτελέσματα ανάγνωσης</li><li>Λάβετε το κείμενο του γραμμικού κώδικα χρησιμοποιώντας την ιδιότητα CodeText</li></ul>
