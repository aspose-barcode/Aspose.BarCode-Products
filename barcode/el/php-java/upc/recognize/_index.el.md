---
title: Σάρωση εικόνων UPC (Καθολικός κωδικός προϊόντος) γραμμωτός κώδικας μέσω PHP via Java
weight: 1510
description: Δείγμα κώδικα PHP για ανάγνωση UPC (Καθολικός κωδικός προϊόντος) γραμμωτός κώδικας σε εφαρμογές που βασίζονται σε PHP.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/php-java/upc/recognize/
aliases:
- /el/php-java/recognize/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες UPC με PHP via Java" h2="Διαβάστε το UPC (Καθολικός κωδικός προϊόντος) γραμμωτός κώδικας στο PHP χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read UPC (Καθολικός κωδικός προϊόντος) γραμμωτός κώδικας Using PHP via Java" %}}
Διαβάστε UPC (Καθολικός κωδικός προϊόντος) γραμμωτός κώδικας γραμμικούς κώδικες σε εφαρμογές PHP χρησιμοποιώντας το Aspose.BarCode για PHP μέσω Java, μια ισχυρή, πλούσια και φιλική προς το χρήστη βιβλιοθήκη γραμμωτού κώδικα που προορίζεται για πλατφόρμες που βασίζονται σε Java. Για να δοκιμάσετε το API γραμμωτού κώδικα, πρέπει να λάβετε την πιο πρόσφατη έκδοση από την πύλη [Aspose releases](https://releases.aspose.com/barcode/php/). Μπορείτε επίσης να βρείτε το πακέτο [aspose/barcode](https://packagist.org/packages/aspose/barcode) στο Packagist και στη συνέχεια να το ενσωματώσετε στο έργο PHP μέσω του συνθέτη:
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη σάρωση του UPC (Καθολικός κωδικός προϊόντος) γραμμωτός κώδικας στο PHP" %}}

{{% blocks/products/pf/agp/text %}}

Το Aspose.BarCode επιτρέπει στους προγραμματιστές να διαβάζουν γραμμικούς κώδικες UPC (Καθολικός κωδικός προϊόντος) γραμμωτός κώδικας από ροή ή εικόνα με λίγες γραμμές κώδικα

{{% /blocks/products/pf/agp/text %}}

<ul><li>Δημιουργήστε ένα αντικείμενο της κλάσης Aspose.BarCode.BarCodeReader</li><li>Ορίστε τη διαδρομή εικόνας πηγής που περιέχει το UPC (Καθολικός κωδικός προϊόντος) γραμμωτός κώδικας ως παράμετρο</li><li>Καθορίστε τους τύπους γραμμωτών κωδίκων στόχου στο DecodeType ως δεύτερη παράμετρος</li><li>Κάντε βρόχο στα αποτελέσματα ανάγνωσης</li><li>Λάβετε το κείμενο του γραμμικού κώδικα χρησιμοποιώντας την ιδιότητα CodeText</li></ul>
...
<ul><li>Microsoft Windows, Linux ή οποιοδήποτε λειτουργικό σύστημα συμβατό με περιβάλλοντα ανάπτυξης που βασίζονται σε PHP</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/pdf417/recognize/" name="PDF417" description="PDF417 γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/qr/recognize/" name="QR" description="QR Κωδικός, GS1 QR Κωδικός" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix κωδικός" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/aztec/recognize/" name="Aztec" description="Aztec Κωδικός" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/swiss-qr/recognize/" name="Swiss QR" description="Λογαριασμός Swiss QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/dotcode/recognize/" name="DotCode" description="DotCode γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/hibc/recognize/" name="HIBC" description="HIBC (γραμμικός κώδικας βιομηχανίας υγείας)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/codablock/recognize/" name="Codablock-F" description="γραμμωτοί κώδικες Codablock-F και GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, and Truncated) γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/itf/recognize/" name="ITF" description="Διαγραμμένος γραμμωτός κώδικας 2 από 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/ean/recognize/" name="EAN" description="EAN (Διεθνής αριθμός άρθρου) γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/upc/recognize/" name="UPC" description="UPC (Καθολικός κωδικός προϊόντος) γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/code39/recognize/" name="Code 39" description="Code 39 γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/code16k/recognize/" name="Code 16K" description="Code 16K γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/code32/recognize/" name="Code 32" description="γραμμωτός κώδικας ιταλικού φαρμακείου (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/code93/recognize/" name="Code 93" description="Code 93 Extended και Code 93 Τυπικοί γραμμικοί κώδικες" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 από 5) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/isbn/recognize/" name="ISBN" description="ISBN γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/ismn/recognize/" name="ISMN" description="ISMN γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/issn/recognize/" name="ISSN" description="ISSN γραμμωτός κώδικας" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/australia-post/recognize/" name="Australia Post" description="Australia Post barcode και Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode και Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/rm4scc/recognize/" name="RM4SCC" description="Κωδικός πελάτη Royal Mail 4 State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/postnet/recognize/" name="Postnet" description="Postnet γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/royal-mail/recognize/" name="Royal Mail" description="Royal Mail γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/singapore-post/recognize/" name="Singapore Post" description="Singapore Post γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/php-java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
