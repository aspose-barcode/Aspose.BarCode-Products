---
title: Σάρωση εικόνων γραμμωτοί κώδικες Codablock-F και GS1 Codablock-F μέσω PHP via Java
weight: 1510
description: Δείγμα κώδικα PHP για ανάγνωση γραμμωτοί κώδικες Codablock-F και GS1 Codablock-F σε εφαρμογές που βασίζονται σε PHP.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/php-java/codablock/recognize/
aliases:
- /el/php-java/recognize/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες Codablock-F με PHP via Java" h2="Διαβάστε το γραμμωτοί κώδικες Codablock-F και GS1 Codablock-F στο PHP χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη σάρωση του Codablock-F γραμμωτός κώδικας στο PHP" %}}

{{% blocks/products/pf/agp/text %}}

Το Aspose.BarCode επιτρέπει στους προγραμματιστές να διαβάζουν γραμμικούς κώδικες Codablock-F γραμμωτός κώδικας από ροή ή εικόνα με λίγες γραμμές κώδικα

{{% /blocks/products/pf/agp/text %}}

<ul><li>Δημιουργήστε ένα αντικείμενο της κλάσης Aspose.BarCode.BarCodeReader</li><li>Ορίστε τη διαδρομή εικόνας πηγής που περιέχει το Codablock-F γραμμωτός κώδικας ως παράμετρο</li><li>Καθορίστε τους τύπους γραμμωτών κωδίκων στόχου στο DecodeType ως δεύτερη παράμετρος</li><li>Κάντε βρόχο στα αποτελέσματα ανάγνωσης</li><li>Λάβετε το κείμενο του γραμμικού κώδικα χρησιμοποιώντας την ιδιότητα CodeText</li></ul>
