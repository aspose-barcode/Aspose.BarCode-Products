---
title: Σάρωση εικόνων GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, and Truncated) γραμμωτός κώδικας μέσω C++
weight: 1510
description: Δείγμα κώδικα C++ για σάρωση και αποκωδικοποίηση GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, and Truncated) γραμμωτός κώδικας σε περιβάλλον χρόνου εκτέλεσης C++ για Windows 32-bit, Windows 64-bit ή Linux 64-bit.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/cpp/databar/recognize/
aliases:
- /el/cpp/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες GS1 DataBar με C++" h2="Διαβάστε το GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, and Truncated) γραμμωτός κώδικας στο C++ χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 DataBar γραμμωτός κώδικας Using C++" %}}
Για να σαρώσετε το GS1 DataBar γραμμωτός κώδικας, δοκιμάστε το [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, μια ισχυρή και εύχρηστη βιβλιοθήκη γραμμωτού κώδικα με πλούσια λειτουργικότητα για πλατφόρμες C++ . Μπορείτε να κάνετε λήψη της πιο πρόσφατης έκδοσής του απευθείας&colon; απλώς ανοίξτε τον διαχειριστή πακέτων [NuGet](https://www.nuget.org/packages/aspose.barcode), αναζητήστε **Aspose.BarCode.Cpp** και εγκαταστήστε το πακέτο. Εναλλακτικά, μπορείτε να εκτελέσετε την ακόλουθη εντολή από την Κονσόλα Package Manager.
...
<ul><li>Δημιουργήστε ένα αντικείμενο της κλάσης Aspose.BarCode.BarCodeReader</li><li>Καθορίστε τη διαδρομή εικόνας πηγής που περιέχει το GS1 DataBar γραμμωτός κώδικας ως παράμετρο</li><li>Διαβιβάστε τους απαιτούμενους τύπους γραμμωτών κωδίκων στο DecodeType ως δεύτερη παράμετρος</li><li>Κάντε βρόχο στα αποτελέσματα της αναγνώρισης</li><li>Φορτώστε το αποκωδικοποιημένο κείμενο γραμμικού κώδικα χρησιμοποιώντας την ιδιότητα CodeText</li></ul>
...
<ul><li>Microsoft Windows, Linux ή οποιοδήποτε λειτουργικό σύστημα συμβατό με C++ Runtime Environment για Windows 32-bit, Windows 64-bit και Linux 64-bit.</li><li>Αναφορά Aspose.BarCode για C++ DLL DLL. στο έργο σας.</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/pdf417/recognize/" name="PDF417" description="PDF417 γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/qr/recognize/" name="QR" description="QR Κωδικός, GS1 QR Κωδικός" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/datamatrix/recognize/" name="Data Matrix" description="Data Matrix κωδικός" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/aztec/recognize/" name="Aztec" description="Aztec Κωδικός" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/swiss-qr/recognize/" name="Swiss QR" description="Λογαριασμός Swiss QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/dotcode/recognize/" name="DotCode" description="DotCode γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/hibc/recognize/" name="HIBC" description="HIBC (γραμμικός κώδικας βιομηχανίας υγείας)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/codablock/recognize/" name="Codablock-F" description="γραμμωτοί κώδικες Codablock-F και GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, and Truncated) γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/itf/recognize/" name="ITF" description="Διαγραμμένος γραμμωτός κώδικας 2 από 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/ean/recognize/" name="EAN" description="EAN (Διεθνής αριθμός άρθρου) γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/upc/recognize/" name="UPC" description="UPC (Καθολικός κωδικός προϊόντος) γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/code39/recognize/" name="Code 39" description="Code 39 γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/code16k/recognize/" name="Code 16K" description="Code 16K γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/code32/recognize/" name="Code 32" description="γραμμωτός κώδικας ιταλικού φαρμακείου (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/code93/recognize/" name="Code 93" description="Code 93 Extended και Code 93 Τυπικοί γραμμικοί κώδικες" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/onecode/recognize/" name="USPS OneCode" description="USPS OneCode γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 από 5) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/isbn/recognize/" name="ISBN" description="ISBN γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/ismn/recognize/" name="ISMN" description="ISMN γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/issn/recognize/" name="ISSN" description="ISSN γραμμωτός κώδικας" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/australia-post/recognize/" name="Australia Post" description="Australia Post barcode και Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode και Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/rm4scc/recognize/" name="RM4SCC" description="Κωδικός πελάτη Royal Mail 4 State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/postnet/recognize/" name="Postnet" description="Postnet γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/royal-mail/recognize/" name="Royal Mail" description="Royal Mail γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/singapore-post/recognize/" name="Singapore Post" description="Singapore Post γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/cpp/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
