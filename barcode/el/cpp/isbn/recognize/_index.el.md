---
title: Σάρωση εικόνων ISBN γραμμωτός κώδικας μέσω C++
weight: 1510
description: Δείγμα κώδικα C++ για σάρωση και αποκωδικοποίηση ISBN γραμμωτός κώδικας σε περιβάλλον χρόνου εκτέλεσης C++ για Windows 32-bit, Windows 64-bit ή Linux 64-bit.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/cpp/isbn/recognize/
aliases:
- /el/cpp/recognize/isbn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες ISBN με C++" h2="Διαβάστε το ISBN γραμμωτός κώδικας στο C++ χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISBN" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Δημιουργήστε ένα αντικείμενο της κλάσης Aspose.BarCode.BarCodeReader</li><li>Καθορίστε τη διαδρομή εικόνας πηγής που περιέχει το ISBN γραμμωτός κώδικας ως παράμετρο</li><li>Διαβιβάστε τους απαιτούμενους τύπους γραμμωτών κωδίκων στο DecodeType ως δεύτερη παράμετρος</li><li>Κάντε βρόχο στα αποτελέσματα της αναγνώρισης</li><li>Φορτώστε το αποκωδικοποιημένο κείμενο γραμμικού κώδικα χρησιμοποιώντας την ιδιότητα CodeText</li></ul>
