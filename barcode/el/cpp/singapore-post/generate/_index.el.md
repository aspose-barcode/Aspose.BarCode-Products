---
title: Δημιουργία εικόνων Singapore Post γραμμωτός κώδικας μέσω C++
description: Παράδειγμα κώδικα C++ για τη δημιουργία Singapore Post γραμμωτός κώδικας σε περιβάλλον χρόνου εκτέλεσης C++ για Windows 32-bit, Windows 64-bit και Linux 64-bit.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/cpp/singapore-post/generate/
aliases:
- /el/cpp/generate/singapore-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Δημιουργήστε ετικέτες Singapore Post με C++" h2="Δημιουργήστε το Singapore Post γραμμωτός κώδικας στο C++ χρησιμοποιώντας το Aspose.BarCode από τον διακομιστή για το API C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Δημιουργήστε ένα αντικείμενο της κλάσης BarcodeGenerator</li><li>Περάστε το Singapore Post γραμμωτός κώδικας ως παράμετρο</li><li>Εισαγάγετε κείμενο εισαγωγής για κωδικοποίηση ως δεύτερη παράμετρο</li><li>Καθορίστε τις διαστάσεις της εικόνας εάν απαιτείται</li><li>Καλέστε τη μέθοδο BarcodeGenerator.Save για λήψη του γραμμικού κώδικα Singapore Post γραμμωτός κώδικας</li></ul>
