---
title: Σάρωση εικόνων γραμμωτός κώδικας ιταλικού φαρμακείου (Code 32). μέσω Node.js via Java
weight: 1510
description: Πηγαίος κώδικας Node.js για σάρωση και αποκωδικοποίηση γραμμωτός κώδικας ιταλικού φαρμακείου (Code 32). σε εφαρμογές JavaScript.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/nodejs-java/code32/recognize/
aliases:
- /el/nodejs-java/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες Code 32 με Node.js via Java" h2="Διαβάστε το γραμμωτός κώδικας ιταλικού φαρμακείου (Code 32). στο JavaScript χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API Node.js via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 32 γραμμωτός κώδικας Using Node.js via Java" %}}
Για να αναγνωρίσετε το Code 32 γραμμωτός κώδικας στις εφαρμογές Node.js, χρησιμοποιήστε το Aspose.BarCode για το Node.js μέσω Java, μια ισχυρή, ευέλικτη και φιλική προς το χρήστη βιβλιοθήκη γραμμωτού κώδικα που εισήχθη για περιβάλλοντα που βασίζονται σε Java. Μπορείτε να φορτώσετε το [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) για Javascript απευθείας από το NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη σάρωση του Code 32 γραμμωτός κώδικας στο JavaScript" %}}
...
<ul><li>Δημιουργήστε ένα αντικείμενο της κλάσης Aspose.BarCode.BarCodeReader</li><li>Διαβιβάστε τη διαδρομή του αρχείου προέλευσης που περιέχει το Code 32 γραμμωτός κώδικας ως παράμετρο</li><li>Ορίστε τους τύπους γραμμωτών κωδίκων στόχου στο DecodeType ως δεύτερη παράμετρος</li><li>Κάντε βρόχο σε όλους τους γραμμωτούς κώδικες που εντοπίστηκαν</li><li>Ανακτήστε το κείμενο του γραμμικού κώδικα που προκύπτει χρησιμοποιώντας την ιδιότητα CodeText</li></ul>
