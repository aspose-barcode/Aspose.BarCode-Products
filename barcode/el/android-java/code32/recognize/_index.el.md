---
title: Σάρωση εικόνων γραμμωτός κώδικας ιταλικού φαρμακείου (Code 32). μέσω Android via Java
weight: 1510
description: Δείγμα κώδικα Android για την αναγνώριση του γραμμωτός κώδικας ιταλικού φαρμακείου (Code 32). στο Περιβάλλον χρόνου εκτέλεσης Android.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/android-java/code32/recognize/
aliases:
- /el/android-java/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες Code 32 με Android via Java" h2="Διαβάστε το γραμμωτός κώδικας ιταλικού φαρμακείου (Code 32). στο Java χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API Android via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη σάρωση του Code 32 γραμμωτός κώδικας στο Java" %}}
