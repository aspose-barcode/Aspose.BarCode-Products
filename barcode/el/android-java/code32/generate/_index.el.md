...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη δημιουργία του Code 32 γραμμωτός κώδικας στο Java" %}}
...
<ul><li>Δημιουργήστε μια νέα παρουσία της κλάσης BarCodeGenerator</li><li>Μεταβιβάστε τον τύπο γραμμικού κώδικα Code 32 γραμμωτός κώδικας ως παράμετρο EncodeTypes</li><li>Ορίστε το κείμενο του γραμμικού κώδικα χρησιμοποιώντας τη μέθοδο setCodeText</li><li>Εκκινήστε τη μέθοδο generateBarCodeImage() για να αποθηκεύσετε την εικόνα γραμμικού κώδικα γραμμωτός κώδικας ιταλικού φαρμακείου (Code 32).</li></ul>
