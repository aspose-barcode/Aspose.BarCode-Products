---
title: Σάρωση εικόνων Standard 2 of 5 (Industrial 2 από 5) barcode μέσω Android via Java
weight: 1510
description: Δείγμα κώδικα Android για την αναγνώριση του Standard 2 of 5 (Industrial 2 από 5) barcode στο Περιβάλλον χρόνου εκτέλεσης Android.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/android-java/standard2of5/recognize/
aliases:
- /el/android-java/recognize/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες Standard 2 of 5 με Android via Java" h2="Διαβάστε το Standard 2 of 5 (Industrial 2 από 5) barcode στο Java χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API Android via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη σάρωση του γραμμωτός κώδικας Standard 2 of 5 στο Java" %}}
