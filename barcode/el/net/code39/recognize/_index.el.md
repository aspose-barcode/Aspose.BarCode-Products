---
title: Σάρωση εικόνων Code 39 γραμμωτός κώδικας μέσω .NET
weight: 1510
description: Δείγμα κώδικα C# για σάρωση και αποκωδικοποίηση τύπου γραμμικού κώδικα Code 39 γραμμωτός κώδικας σε .NET Framework, .NET Standard, COM Interloop για PHP, VBScript, Delphi ή C++.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/net/code39/recognize/
aliases:
- /el/net/recognize/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες Code 39 με .NET" h2="Διαβάστε το Code 39 γραμμωτός κώδικας στο C# χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 39 γραμμωτός κώδικας Using .NET" %}}
Για να αποκωδικοποιήσετε το Code 39 γραμμωτός κώδικας, δοκιμάστε το [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, μια πλούσια σε χαρακτηριστικά, ισχυρή και εύχρηστη βιβλιοθήκη γραμμωτού κώδικα για πλατφόρμες C#. Χρησιμοποιήστε το [NuGet](https://www.nuget.org/packages/aspose.barcode) και αναζητήστε το **Aspose.BarCode** για να εγκαταστήσετε το πακέτο. Εναλλακτικά, εκτελέστε την ακόλουθη εντολή από την κονσόλα Package Manager:
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη σάρωση του Code 39 γραμμωτός κώδικας στο C#" %}}
...
<ul><li>Δημιουργήστε μια νέα παρουσία της κλάσης Aspose.BarCode.BarCodeReader</li><li>Διαβιβάστε τη διαδρομή εικόνας πηγής που περιέχει το Code 39 γραμμωτός κώδικας ως παράμετρο</li><li>Διαβιβάστε ένα κατάλληλο DecodeType ως η δεύτερη παράμετρος</li><li>Κάντε βρόχο στα αποτελέσματα αποκωδικοποίησης</li><li>Λάβετε κείμενο γραμμικού κώδικα χρησιμοποιώντας την ιδιότητα CodeText</li></ul>
