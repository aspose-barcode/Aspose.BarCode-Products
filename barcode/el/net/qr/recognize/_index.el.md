---
title: Σάρωση εικόνων QR Κωδικός, GS1 QR Κωδικός μέσω .NET
weight: 1510
description: Δείγμα κώδικα C# για σάρωση και αποκωδικοποίηση τύπου γραμμικού κώδικα QR Κωδικός, GS1 QR Κωδικός σε .NET Framework, .NET Standard, COM Interloop για PHP, VBScript, Delphi ή C++.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/net/qr/recognize/
aliases:
- /el/net/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Διαβάστε τους γραμμωτούς κώδικες QR με .NET" h2="Διαβάστε το QR Κωδικός, GS1 QR Κωδικός στο C# χρησιμοποιώντας το Aspose.BarCode από την πλευρά του διακομιστή για το API .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read QR Κωδ Using .NET" %}}
Για να αποκωδικοποιήσετε το QR Κωδ, δοκιμάστε το [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, μια πλούσια σε χαρακτηριστικά, ισχυρή και εύχρηστη βιβλιοθήκη γραμμωτού κώδικα για πλατφόρμες C#. Χρησιμοποιήστε το [NuGet](https://www.nuget.org/packages/aspose.barcode) και αναζητήστε το **Aspose.BarCode** για να εγκαταστήσετε το πακέτο. Εναλλακτικά, εκτελέστε την ακόλουθη εντολή από την κονσόλα Package Manager:
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη σάρωση του QR Κωδ στο C#" %}}
...
<ul><li>Δημιουργήστε μια νέα παρουσία της κλάσης Aspose.BarCode.BarCodeReader</li><li>Διαβιβάστε τη διαδρομή εικόνας πηγής που περιέχει το QR Κωδ ως παράμετρο</li><li>Διαβιβάστε ένα κατάλληλο DecodeType ως η δεύτερη παράμετρος</li><li>Κάντε βρόχο στα αποτελέσματα αποκωδικοποίησης</li><li>Λάβετε κείμενο γραμμικού κώδικα χρησιμοποιώντας την ιδιότητα CodeText</li></ul>
