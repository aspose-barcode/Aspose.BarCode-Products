---
title: Δημιουργία εικόνων EAN (Διεθνής αριθμός άρθρου) γραμμωτός κώδικας μέσω .NET
description: Πηγαίος κώδικας C# για τη γενιά EAN (Διεθνής αριθμός άρθρου) γραμμωτός κώδικας σε .NET Framework, .NET Standard, COM Interloop για PHP, VBScript, Delphi και C++.
lang: el/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /el/net/ean/generate/
aliases:
- /el/net/generate/ean/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Δημιουργήστε ετικέτες EAN με .NET" h2="Δημιουργήστε το EAN (Διεθνής αριθμός άρθρου) γραμμωτός κώδικας στο C# χρησιμοποιώντας το Aspose.BarCode από τον διακομιστή για το API .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate EAN (Διεθνής αριθμός άρθρου) γραμμωτός κώδικας Using .NET" %}}
Για να δημιουργήσετε το EAN (Διεθνής αριθμός άρθρου) γραμμωτός κώδικας, δοκιμάστε το [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, μια πλούσια σε χαρακτηριστικά, ισχυρή και εύχρηστη βιβλιοθήκη γραμμωτού κώδικα για πλατφόρμες C#. Ανοίξτε τη διαχείριση πακέτων [NuGet](https://www.nuget.org/packages/aspose.barcode), αναζητήστε **Aspose.BarCode** και εγκαταστήστε το πακέτο. Μπορείτε επίσης να εκτελέσετε την ακόλουθη εντολή από την κονσόλα Package Manager:
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη δημιουργία του EAN (Διεθνής αριθμός άρθρου) γραμμωτός κώδικας στο C#" %}}
...
<ul><li>Δημιουργήστε μια παρουσία της κλάσης BarcodeGenerator</li><li>Περάστε το EAN (Διεθνής αριθμός άρθρου) γραμμωτός κώδικας ως παράμετρο</li><li>Ορίστε το κείμενο για κωδικοποίηση ως δεύτερη παράμετρο</li><li> Προσδιορίστε τις διαστάσεις του γραμμικού κώδικα εάν απαιτείται</li><li>Καλέστε τη μέθοδο BarcodeGenerator.Save για να αποκτήσετε την εικόνα EAN (Διεθνής αριθμός άρθρου) γραμμωτός κώδικας</li></ul>
