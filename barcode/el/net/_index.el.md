...
description: Aspose.BarCode για API .NET για δημιουργία και αναγνώριση γραμμωτών κωδίκων 1D 2D. Ενσωμάτωση σε εφαρμογές C# VB.NET ASP.NET για σάρωση και εκτύπωση ετικετών γραμμωτού κώδικα
lang: el/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="API δημιουργίας γραμμωτού κώδικα και ανάγνωσης" h2="Δημιουργήστε και αναγνωρίστε γραμμικούς κώδικες γραμμικών, δισδιάστατων και ταχυδρομικών τύπων σε οποιαδήποτε εφαρμογή .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" pfName="Aspose.BarCode" subTitlepfName="για .NET" downloadUrl="https://releases.aspose.com/barcode/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.BarCode" subTitlepfName="για .NET" >}}
...
<p>Το Aspose.BarCode for .NET είναι μια ισχυρή βιβλιοθήκη ανάπτυξης για τη δημιουργία και την αναγνώριση γραμμωτών κωδίκων 1D και 2D από διάφορους τύπους εικόνας σε οποιαδήποτε γωνία. Οι προγραμματιστές μπορούν εύκολα να προσθέσουν λειτουργικότητα δημιουργίας γραμμωτού κώδικα και σάρωσης στις εφαρμογές τους .NET. Αυτό το API επιτρέπει την εξαγωγή γραμμωτών κωδίκων που δημιουργούνται σε διαφορετικές μορφές εικόνας υψηλής ποιότητας.</p><p>Το Aspose.BarCode for .NET επιτρέπει την τροποποίηση της εμφάνισης των γραμμωτών κωδίκων που δημιουργούνται και των παραμέτρων τους, όπως χρώμα φόντου, χρώμα γραμμής, γωνία περιστροφής, x -διάσταση, ποιότητα εικόνας, ανάλυση, λεζάντες, μέγεθος και πολλά άλλα. Παρέχει επίσης πλούσια λειτουργία ανίχνευσης και ανάγνωσης γραμμωτού κώδικα και υποστηρίζει πάνω από 60 τύπους γραμμωτού κώδικα.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Πλατφόρμα Ανεξαρτησίας" description="Μπορείτε να χρησιμοποιήσετε τη βιβλιοθήκη για να δημιουργήσετε οποιονδήποτε τύπο εφαρμογής .NET 32-bit ή 64-bit, συμπεριλαμβανομένων των ASP.NET, WinForms, WPF, .NET Standard και άλλων." >}}
<div class='diagram1 d1-net'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Υποστηριζόμενες μορφές αρχείων" description="Το Aspose.BarCode για το .NET λειτουργεί με τις πιο συχνά χρησιμοποιούμενες μορφές αρχείων εικόνας." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/saving-barcode-image/'>Αποθηκεύστε ετικέτες barcode σε διάφορες μορφές</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/read-barcodes-with-aspose-barcode-apis/#setting-barcode-recognition-source'>Αναγνώριση από ροή ή αρχείο</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/qr-and-micro-qr-barcode/#eciencoding-mode'>Κωδικοποίηση & αποκωδικοποίηση χαρακτήρων (μη αγγλικών) σε τύπους 2D</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/image-formatting-and-display-settings/'>Περιστρέψτε τις εικόνες barcode σε οποιαδήποτε γωνία</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/how-to-read-barcode-from-multi-page-tiff-images/'>Σαρώστε γραμμικούς κώδικες από πολυσέλιδο TIFF</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/barcode-types-and-image-formats/'>Υποστήριξη για γραμμικές, 2D και ταχυδρομικές συμβολολογίες</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Το API δημιουργίας γραμμωτού κώδικα επιτρέπει στους προγραμματιστές να δημιουργούν γραμμικούς κώδικες καθορίζοντας τον απαιτούμενο τύπο γραμμικού κώδικα, ορίζοντας κείμενο εισαγωγής (τα δεδομένα που θα κωδικοποιηθούν σε μια εικόνα γραμμικού κώδικα) και προσαρμόζοντας ιδιότητες που σχετίζονται με την εμφάνιση, όπως χρώμα φόντου και προσκηνίου, γραμματοσειρά, θέση κειμένου (απόκρυψη, πάνω, ή κάτω), και ευθυγράμμιση. Δισδιάστατοι γραμμικοί κώδικες, όπως QR Code, PDF417, Data Matrix, Aztec Code κ.λπ. με τον ίδιο τρόπο όπως και των μονοδιάστατων.
                </p>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/pdf417/" name="PDF417" description="PDF417 γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/qr/" name="QR" description="QR Κωδικός, GS1 QR Κωδικός" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/datamatrix/" name="Data Matrix" description="Data Matrix κωδικός" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/aztec/" name="Aztec" description="Aztec Κωδικός" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/swiss-qr/" name="Swiss QR" description="Λογαριασμός Swiss QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/dotcode/" name="DotCode" description="DotCode γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/hibc/" name="HIBC" description="HIBC (γραμμικός κώδικας βιομηχανίας υγείας)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/codablock/" name="Codablock-F" description="γραμμωτοί κώδικες Codablock-F και GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/databar/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, and Truncated) γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/itf/" name="ITF" description="Διαγραμμένος γραμμωτός κώδικας 2 από 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/ean/" name="EAN" description="EAN (Διεθνής αριθμός άρθρου) γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/upc/" name="UPC" description="UPC (Καθολικός κωδικός προϊόντος) γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/code128/" name="GS1 Code 128" description="GS1 Code 128 γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/code39/" name="Code 39" description="Code 39 γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/code16k/" name="Code 16K" description="Code 16K γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/code32/" name="Code 32" description="γραμμωτός κώδικας ιταλικού φαρμακείου (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/code93/" name="Code 93" description="Code 93 Extended και Code 93 Τυπικοί γραμμικοί κώδικες" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/onecode/" name="USPS OneCode" description="USPS OneCode γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 από 5) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/isbn/" name="ISBN" description="ISBN γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/ismn/" name="ISMN" description="ISMN γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/issn/" name="ISSN" description="ISSN γραμμωτός κώδικας" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/australia-post/" name="Australia Post" description="Australia Post barcode και Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode και Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/rm4scc/" name="RM4SCC" description="Κωδικός πελάτη Royal Mail 4 State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/postnet/" name="Postnet" description="Postnet γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/royal-mail/" name="Royal Mail" description="Royal Mail γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/singapore-post/" name="Singapore Post" description="Singapore Post γραμμωτός κώδικας" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/el/net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
