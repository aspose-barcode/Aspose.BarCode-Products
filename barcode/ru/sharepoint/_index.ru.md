...
weight: 220
url: /ru/sharepoint/ 
description: API штрих-кода SharePoint для вставки меток штрих-кода в настраиваемые списки SharePoint. Разработчики могут использовать служебные маркеры для выбора текстовых значений кода или вставки текста вручную.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Добавить штрих-коды в списки Microsoft SharePoint" h2="Приложение Barcode SharePoint для добавления линейных, двумерных и почтовых штрих-кодов в списки Microsoft SharePoint." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/barcode/sharepoint" >}}
...
<p>
 Aspose.BarCode для SharePoint позволяет добавлять большое количество линейных, двумерных и почтовых штрих-кодов в списки Microsoft SharePoint Foundation 2010 и Microsoft Office SharePoint Server 2010 (MOSS). Вы можете добавить штрих-коды в любой список, указав текст кода и символы.
</p>
...
{{< blocks/products/pf/carousel-item h3="С одного взгляда" description="Обзор функций генерации штрих-кода." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    <li>
     Установить кодовый текст
    </li>
    <li>
     Установить символы
    </li>
    <li>
     Добавить штрих-код в список
    </li>
   </ul>
  </div>
  <!--/left-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Генератор штрих-кода SharePoint" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-sharepoint.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Поддерживаемая платформа" description="Aspose.BarCode для SharePoint поддерживает Microsoft SharePoint Foundation и SharePoint Server." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Приложение штрих-кода SharePoint" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-sharepoint.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Поддерживаемые типы штрих-кодов" description="Aspose.BarCode для SharePoint поддерживает следующие [форматы файлов](https://docs.aspose.com/barcode/sharepoint/supported-file-formats/)  :" >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
  ...
  <div class="d1-col d1-right">
   ...
   <!--<header><i class="fa fa-qrcode"> </i>Barcode Типы</header>

<ul>

<li>Типы линейных штрих-кодов</li>

<li>Типы 2D штрих-кодов</li>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <div class="col-lg-12">
    <h2 class="h2title">
     Добавить столбец типа штрих-кода в списки SharePoint
    </h2>
    <p>
     Aspose.BarCode for SharePoint упрощает добавление столбца типа штрих-кода в списки SharePoint. Этот компонент также позволяет вам устанавливать текст штрих-кода с помощью графического интерфейса пользователя или путем включения служебных маркеров.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Приложение штрих-кода SharePoint поддерживает самые популярные символы, включая:
    </p>
    <div class="col-lg-3">
     <ul class="unstyled">
      <li>
    ...
    <div class="col-lg-3">
     <ul class="unstyled">
      <li>
       DeutcheПочтовыйIdentificationCode
      </li>
      <li>
       DeutcheПочтовыйleitCode
      </li>
      <li>
       EAN128
      </li>
 ...
 <!-- Support & Образовательные ресурсы -->
   ...
   <div class="container">
    ...
    <div class="col-lg-12 mgtb55">
     <ul class="list-unstyled" id="resources">
      ...
      <!-- <li><a href="https://apireference.aspose.com/">Ссылки на API</a></li> -->
      <li>
     ...
     <ul class="list-unstyled" id="success-stories">
      <li class="resourcesheading">
       Почему Aspose.BarCode для SharePoint?
      </li>
