---
title: SharePoint Barcode API — вставка штрих-кодов в списки SharePoint
description: API штрих-кода SharePoint для вставки меток штрих-кода в настраиваемые списки SharePoint. Разработчики могут использовать служебные маркеры для выбора входных текстовых значений или вставки текста вручную.
lang: ru
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="API-интерфейсы штрих-кода SharePoint" h2="Приложение Barcode SharePoint для добавления линейных, двумерных и почтовых штрих-кодов в списки Microsoft SharePoint." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="для SharePoint" downloadUrl="https://releases.aspose.com/barcode/sharepoint/" >}}
...
<p>Aspose.BarCode for SharePoint позволяет разработчикам добавлять большое количество линейных, двумерных и почтовых штрих-кодов в списки Microsoft SharePoint Foundation 2010 и Microsoft Office SharePoint Server 2010 (MOSS). Вы можете создавать, а затем вставлять штрих-коды в любой список, указав вводимый текст и тип.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Независимость от платформы" description="Aspose.BarCode для SharePoint поддерживает Microsoft SharePoint Foundation и SharePoint Server." >}}
<div class='diagram1 d1-sharepoint'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Поддерживаемые форматы файлов" description="Aspose.BarCode для SharePoint работает с наиболее часто используемыми форматами файлов изображений." >}}
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Добавить штрих-коды в списки Sharepoint
                </h2>
                <p>
                    Aspose.BarCode для SharePoint предоставляет широкие возможности для добавления штрих-кодов в списки SharePoint. Такие списки можно использовать для хранения и организации данных в структурированном формате. Это удобный способ управления разнообразной информацией, такой как контакты, задачи, события календаря и многое другое. Они предоставляют множество функций для организации, сортировки, фильтрации и обмена данными. Может быть полезно добавить штрих-коды в списки SharePoint, чтобы облегчить доступ к информации в списке и управление ею. Если список SharePoint создается для отслеживания элементов инвентаря, разработчики могут добавлять штрих-коды для быстрого и точного сканирования и обновления информации в списке. Это могло бы облегчить отслеживание и управление запасами, а также снизить риск расхождений. Штрих-коды могут использоваться для быстрого доступа и просмотра информации в списке SharePoint, например, путем сканирования штрих-кодов для быстрого отображения определенных элементов или записей в списке.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Библиотека штрих-кодов — это мощный инструмент, который позволяет разработчикам легко создавать штрих-коды, указывая тип целевого штрих-кода, вставляя входные данные для хранения штрих-кода и настраивая свойства, связанные с внешним видом. Библиотека предоставляет множество параметров для точной настройки внешнего вида сгенерированных штрих-кодов, включая параметры для установки цветов фона и переднего плана, шрифта, размера, разрешения и текстовых заголовков.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    Barcode API включает в себя различные функции для обнаружения и считывания широкого спектра популярных одномерных и двумерных штрих-кодов. Эти функции можно легко интегрировать в ваши приложения, написав всего несколько строк кода, что обеспечивает удобный и эффективный способ добавления в ваши приложения возможностей обнаружения штрих-кодов.
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/pdf417/" name="PDF417" description="PDF417 штрих-код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/qr/" name="QR" description="Код QR, код GS1 QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/datamatrix/" name="Data Matrix" description="Data Matrix код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/aztec/" name="Aztec" description="Aztec Код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/swiss-qr/" name="Swiss QR" description="Swiss QR счет" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/dotcode/" name="DotCode" description="Штрих-код DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/hibc/" name="HIBC" description="HIBC (Штрих-код для индустрии здравоохранения)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/codablock/" name="Codablock-F" description="Штрих-коды Codablock-F и GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/databar/" name="GS1 DataBar" description="Штрих-код GS1 DataBar (всенаправленный, многонаправленный с накоплением, расширенный, расширенный с накоплением и усеченный)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/itf/" name="ITF" description="Перемежающийся штрих-код 2 из 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/ean/" name="EAN" description="Штрих-код EAN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/upc/" name="UPC" description="Штрих-код UPC" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/code128/" name="GS1 Code 128" description="Штрих-код GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/code39/" name="Code 39" description="Штрих-код Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/code16k/" name="Code 16K" description="Штрих-код Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/code32/" name="Code 32" description="Итальянский штрих-код Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/code93/" name="Code 93" description="Code 93 расширенный и Code 93 стандартный штрих-коды" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/onecode/" name="USPS OneCode" description="USPS OneCode штрих-код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/standard2of5/" name="Standard 2 of 5" description="Штрих-код Standard 2 of 5 (Промышленный 2 из 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/isbn/" name="ISBN" description="Штрих-код ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/ismn/" name="ISMN" description="Штрих-код ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/issn/" name="ISSN" description="Штрих-код ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/australia-post/" name="Australia Post" description="Штрих-код Australia Post и Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/deutsche-post/" name="Deutsche Post" description="Deutsche Post Идентификатор и Deutsche Post Лейткод" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/rm4scc/" name="RM4SCC" description="Код клиента Royal Mail из 4 штатов (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/postnet/" name="Postnet" description="Штрих-код Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/royal-mail/" name="Royal Mail" description="Штрих-код Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/singapore-post/" name="Singapore Post" description="Штрих-код Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/sharepoint/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Документация" href="https://docs.aspose.com/barcode/sharepoint/" >}}
{{< blocks/products/pf/slr-element name="Исходный код" href="https://github.com/aspose-barcode/Aspose.BarCode-for-.NET" >}}
{{< blocks/products/pf/slr-element name="Ссылки на API" href="https://reference.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/slr-element name="Примечания к выпуску" href="https://releases.aspose.com/barcode/sharepoint/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.BarCode для SharePoint?" tabId="success-stories" >}}
