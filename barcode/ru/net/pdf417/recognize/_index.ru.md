---
title: Сканировать изображения PDF417 штрих-код через .NET
description: Пример кода C# для сканирования и декодирования типа штрих-кода PDF417 штрих-код в .NET Framework, .NET Standard, COM Interloop для PHP, VBScript, Delphi или C++.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/net/pdf417/recognize/
aliases:
- /ru/net/recognize/pdf417/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение PDF417 штрих-кодов с помощью .NET" h2="Чтение PDF417 штрих-код в C# с помощью серверного API Aspose.BarCode для .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF417" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read PDF417 штрих-код Using .NET" %}}
Чтобы расшифровать PDF417 штрих-код, попробуйте [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, многофункциональную, мощную и простую в использовании библиотеку штрих-кодов. для платформ С#. Используйте [NuGet](https://www.nuget.org/packages/aspose.barcode) и найдите **Aspose.BarCode**, чтобы установить пакет. Либо выполните следующую команду из консоли диспетчера пакетов:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию PDF417 штрих-код в C#" %}}
...
<ul><li>Создайте новый экземпляр класса Aspose.BarCode.BarCodeReader</li><li>Передайте путь исходного изображения, содержащий PDF417 штрих-код, в качестве параметра</li><li>Передайте соответствующий DecodeType как второй параметр</li><li>Пройтись по результатам декодирования</li><li>Получить текст штрих-кода с помощью свойства CodeText</li></ul>
