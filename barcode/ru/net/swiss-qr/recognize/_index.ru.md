---
title: Сканировать изображения Swiss QR счет через .NET
weight: 1510
description: Пример кода C# для сканирования и декодирования типа штрих-кода Swiss QR счет в .NET Framework, .NET Standard, COM Interloop для PHP, VBScript, Delphi или C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение Swiss QR штрих-кодов с помощью .NET" h2="Чтение Swiss QR счет в C# с помощью серверного API Aspose.BarCode для .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss QR" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Swiss QR счет Using .NET" %}}
Чтобы расшифровать Swiss QR счет, попробуйте [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, многофункциональную, мощную и простую в использовании библиотеку штрих-кодов. для платформ С#. Используйте [NuGet](https://www.nuget.org/packages/aspose.barcode) и найдите **Aspose.BarCode**, чтобы установить пакет. Либо выполните следующую команду из консоли диспетчера пакетов:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию Swiss QR счет в C#" %}}
...
<ul><li>Создайте новый экземпляр класса Aspose.BarCode.BarCodeReader</li><li>Передайте путь исходного изображения, содержащий Swiss QR счет, в качестве параметра</li><li>Передайте соответствующий DecodeType как второй параметр</li><li>Пройтись по результатам декодирования</li><li>Получить текст штрих-кода с помощью свойства CodeText</li></ul>
