---
title: Сканировать изображения Перемежающийся штрих-код 2 из 5 (ITF) через .NET
description: Пример кода C# для сканирования и декодирования типа штрих-кода Перемежающийся штрих-код 2 из 5 (ITF) в .NET Framework, .NET Standard, COM Interloop для PHP, VBScript, Delphi или C++.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/net/itf/recognize/
aliases:
- /ru/net/recognize/itf/
- /ru/net/recognize/datalogic2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение ITF штрих-кодов с помощью .NET" h2="Чтение Перемежающийся штрих-код 2 из 5 (ITF) в C# с помощью серверного API Aspose.BarCode для .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Перемежающийся штрих-код 2 из 5 (ITF) Using .NET" %}}
Чтобы расшифровать Перемежающийся штрих-код 2 из 5 (ITF), попробуйте [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, многофункциональную, мощную и простую в использовании библиотеку штрих-кодов. для платформ С#. Используйте [NuGet](https://www.nuget.org/packages/aspose.barcode) и найдите **Aspose.BarCode**, чтобы установить пакет. Либо выполните следующую команду из консоли диспетчера пакетов:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию Перемежающийся штрих-код 2 из 5 (ITF) в C#" %}}
...
<ul><li>Создайте новый экземпляр класса Aspose.BarCode.BarCodeReader</li><li>Передайте путь исходного изображения, содержащий Перемежающийся штрих-код 2 из 5 (ITF), в качестве параметра</li><li>Передайте соответствующий DecodeType как второй параметр</li><li>Пройтись по результатам декодирования</li><li>Получить текст штрих-кода с помощью свойства CodeText</li></ul>
