---
title: Сканировать изображения Deutsche Post Идентификатор и Deutsche Post Лейткод через Android via Java
description: Пример кода Android для распознавания Deutsche Post Идентификатор и Deutsche Post Лейткод в среде выполнения Android.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/android-java/deutsche-post/recognize/
aliases:
- /ru/android-java/recognize/deutsche-post/
- /ru/android-java/recognize/deutschepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение Deutsche Post штрих-кодов с помощью Android via Java" h2="Чтение Deutsche Post Идентификатор и Deutsche Post Лейткод в Java с помощью серверного API Aspose.BarCode для Android via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Штрих-код Deutsche Post Using Android via Java" %}}
Попробуйте Aspose.BarCode для Android через Java, чтобы легко обнаруживать и считывать Штрих-код Deutsche Post в приложениях Android. Это богатый, масштабируемый и удобный API штрих-кода, предназначенный для приложений Android. Получите Aspose.BarCode для Java непосредственно из проекта на основе Maven, добавив следующие конфигурации в build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию Штрих-код Deutsche Post в Java" %}}
...
<ul><li>Создайте экземпляр класса BarCodeReader</li><li>Определите путь к исходному изображению, содержащему Штрих-код Deutsche Post</li><li>Определите целевые типы штрих-кодов в DecodeType в качестве второго параметра</li><li>Пройтись по результатам распознавания</li><li>Загрузить декодированный текст, выполнив метод getCodeText</li></ul>
