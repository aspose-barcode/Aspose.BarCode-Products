---
title: Сканировать изображения Код QR, код GS1 QR через Android via Java
description: Пример кода Android для распознавания Код QR, код GS1 QR в среде выполнения Android.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/android-java/qr/recognize/
aliases:
- /ru/android-java/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение QR штрих-кодов с помощью Android via Java" h2="Чтение Код QR, код GS1 QR в Java с помощью серверного API Aspose.BarCode для Android via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read QR Код Using Android via Java" %}}
Попробуйте Aspose.BarCode для Android через Java, чтобы легко обнаруживать и считывать QR Код в приложениях Android. Это богатый, масштабируемый и удобный API штрих-кода, предназначенный для приложений Android. Получите Aspose.BarCode для Java непосредственно из проекта на основе Maven, добавив следующие конфигурации в build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию QR Код в Java" %}}
