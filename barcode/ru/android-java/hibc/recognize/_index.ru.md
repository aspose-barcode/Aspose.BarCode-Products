---
title: Сканировать изображения HIBC (Штрих-код для индустрии здравоохранения) через Android via Java
weight: 1510
description: Пример кода Android для распознавания HIBC (Штрих-код для индустрии здравоохранения) в среде выполнения Android.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение HIBC штрих-кодов с помощью Android via Java" h2="Чтение HIBC (Штрих-код для индустрии здравоохранения) в Java с помощью серверного API Aspose.BarCode для Android via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HIBC" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read HIBC (Штрих-код для индустрии здравоохранения) Using Android via Java" %}}
Попробуйте Aspose.BarCode для Android через Java, чтобы легко обнаруживать и считывать HIBC (Штрих-код для индустрии здравоохранения) в приложениях Android. Это богатый, масштабируемый и удобный API штрих-кода, предназначенный для приложений Android. Получите Aspose.BarCode для Java непосредственно из проекта на основе Maven, добавив следующие конфигурации в build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию HIBC (Штрих-код для индустрии здравоохранения) в Java" %}}
...
<ul><li>Создайте экземпляр класса BarCodeReader</li><li>Определите путь к исходному изображению, содержащему HIBC (Штрих-код для индустрии здравоохранения)</li><li>Определите целевые типы штрих-кодов в DecodeType в качестве второго параметра</li ><li>Пройтись по результатам распознавания</li><li>Загрузить декодированный текст, выполнив метод getCodeText</li></ul>
...
<ul><li>Microsoft Windows, Linux или любая другая ОС, совместимая с Android Runtime Environment</li><li>Android SDK v.30</li><li>Системы Android под управлением Android OS 2.0 или более поздней версии</li> </ul>
...
{{% blocks/products/pf/agp/content h2="Об Aspose.BarCode для Android via Java API" %}}
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/pdf417/recognize/" name="PDF417" description="PDF417 штрих-код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/qr/recognize/" name="QR" description="Код QR, код GS1 QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/aztec/recognize/" name="Aztec" description="Aztec Код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR счет" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/dotcode/recognize/" name="DotCode" description="Штрих-код DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/hibc/recognize/" name="HIBC" description="HIBC (Штрих-код для индустрии здравоохранения)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/codablock/recognize/" name="Codablock-F" description="Штрих-коды Codablock-F и GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/databar/recognize/" name="GS1 DataBar" description="Штрих-код GS1 DataBar (всенаправленный, многонаправленный с накоплением, расширенный, расширенный с накоплением и усеченный)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/itf/recognize/" name="ITF" description="Перемежающийся штрих-код 2 из 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/ean/recognize/" name="EAN" description="Штрих-код EAN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/upc/recognize/" name="UPC" description="Штрих-код UPC" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/code128/recognize/" name="GS1 Code 128" description="Штрих-код GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/code39/recognize/" name="Code 39" description="Штрих-код Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/code16k/recognize/" name="Code 16K" description="Штрих-код Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/code32/recognize/" name="Code 32" description="Итальянский штрих-код Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/code93/recognize/" name="Code 93" description="Code 93 расширенный и Code 93 стандартный штрих-коды" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode штрих-код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/standard2of5/recognize/" name="Standard 2 of 5" description="Штрих-код Standard 2 of 5 (Промышленный 2 из 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/isbn/recognize/" name="ISBN" description="Штрих-код ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/ismn/recognize/" name="ISMN" description="Штрих-код ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/issn/recognize/" name="ISSN" description="Штрих-код ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/australia-post/recognize/" name="Australia Post" description="Штрих-код Australia Post и Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Идентификатор и Deutsche Post Лейткод" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/rm4scc/recognize/" name="RM4SCC" description="Код клиента Royal Mail из 4 штатов (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/postnet/recognize/" name="Postnet" description="Штрих-код Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/royal-mail/recognize/" name="Royal Mail" description="Штрих-код Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/singapore-post/recognize/" name="Singapore Post" description="Штрих-код Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/android-java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
