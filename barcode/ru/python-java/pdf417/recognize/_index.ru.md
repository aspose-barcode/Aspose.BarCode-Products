---
title: Сканировать изображения PDF417 штрих-код через Python via Java
weight: 1510
description: Исходный код Python для распознавания PDF417 штрих-код с использованием Java Runtime Environment.
lang: ru/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ru/python-java/pdf417/recognize/
aliases:
- /ru/python-java/recognize/pdf417/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение PDF417 штрих-кодов с помощью Python via Java" h2="Чтение PDF417 штрих-код в Python с помощью серверного API Aspose.BarCode для Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF417" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию PDF417 штрих-код в Python" %}}
...
<ul><li>Создайте объект класса Aspose.BarCode.BarCodeReader</li><li>Определите путь к исходному файлу, содержащий PDF417 штрих-код в качестве параметра</li><li>Определите требуемые типы штрих-кодов в DecodeType в качестве второго параметра</li><li>Пройтись по результатам декодирования</li><li>Получить текст штрих-кода с помощью свойства CodeText</li></ul>
