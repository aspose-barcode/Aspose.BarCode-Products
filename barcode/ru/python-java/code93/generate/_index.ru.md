...
{{% blocks/products/pf/agp/content h2="How to Generate Штрих-код Code 93 Using Python via Java" %}}
Чтобы создать изображения Штрих-код Code 93, получите API [Aspose.BarCode для Python через Java](https://products.aspose.com/barcode/python-java/) — многофункциональный, мощный и простой в использовании -Используйте библиотеку штрих-кодов для приложений на основе Python. Получите последнюю версию непосредственно с портала [выпусков Aspose](https://releases.aspose.com/barcode/python-java/) или установите 'aspose-barcode' из pip с помощью следующей команды:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по созданию Штрих-код Code 93 в Python" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode позволяет разработчикам легко создавать изображения Штрих-код Code 93 с помощью нескольких строк кода.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Создайте новый объект класса BarCodeGenerator</li><li>Определите нужные типы штрих-кода в качестве параметра EncodeTypes</li><li>Вставьте входной текст в качестве второго параметра</li><li>Вызовите метод BarCodeGenerator.save, чтобы получить сгенерированное изображение Code 93 расширенный и Code 93 стандартный штрих-коды</li></ul>
