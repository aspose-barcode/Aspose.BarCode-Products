---
title: Сканировать изображения Штрих-код Australia Post и Australia Post eParcel через Python via Java
description: Исходный код Python для распознавания Штрих-код Australia Post и Australia Post eParcel с использованием Java Runtime Environment.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/python-java/australia-post/recognize/
aliases:
- /ru/python-java/recognize/australia-post/
- /ru/python-java/recognize/australiapost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение Australia Post штрих-кодов с помощью Python via Java" h2="Чтение Штрих-код Australia Post и Australia Post eParcel в Python с помощью серверного API Aspose.BarCode для Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию Штрих-код Australia Post в Python" %}}
