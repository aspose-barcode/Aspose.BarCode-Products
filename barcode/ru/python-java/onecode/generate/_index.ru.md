...
{{% blocks/products/pf/agp/content h2="How to Generate USPS OneCode штрих-код Using Python via Java" %}}
Чтобы создать изображения USPS OneCode штрих-код, получите API [Aspose.BarCode для Python через Java](https://products.aspose.com/barcode/python-java/) — многофункциональный, мощный и простой в использовании -Используйте библиотеку штрих-кодов для приложений на основе Python. Получите последнюю версию непосредственно с портала [выпусков Aspose](https://releases.aspose.com/barcode/python-java/) или установите 'aspose-barcode' из pip с помощью следующей команды:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по созданию USPS OneCode штрих-код в Python" %}}
...
<ul><li>Создайте новый объект класса BarCodeGenerator</li><li>Определите нужные типы штрих-кода в качестве параметра EncodeTypes</li><li>Вставьте входной текст в качестве второго параметра</li><li>Вызовите метод BarCodeGenerator.save, чтобы получить сгенерированное изображение USPS OneCode штрих-код</li></ul>
