---
title: Создайте Deutsche Post Идентификатор и Deutsche Post Лейткод изображений с помощью Python via Java
description: Пример кода Python для создания Deutsche Post Идентификатор и Deutsche Post Лейткод с использованием Java Runtime Environment.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/python-java/deutsche-post/generate/
aliases:
- /ru/python-java/generate/deutsche-post/
- /ru/python-java/generate/deutschepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Создайте этикетки Deutsche Post с Python via Java" h2="Создайте Deutsche Post Идентификатор и Deutsche Post Лейткод в Python, используя серверный API Aspose.BarCode для Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Штрих-код Deutsche Post Using Python via Java" %}}
Чтобы создать изображения Штрих-код Deutsche Post, получите API [Aspose.BarCode для Python через Java](https://products.aspose.com/barcode/python-java/) — многофункциональный, мощный и простой в использовании -Используйте библиотеку штрих-кодов для приложений на основе Python. Получите последнюю версию непосредственно с портала [выпусков Aspose](https://releases.aspose.com/barcode/python-java/) или установите 'aspose-barcode' из pip с помощью следующей команды:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по созданию Штрих-код Deutsche Post в Python" %}}
...
<ul><li>Создайте новый объект класса BarCodeGenerator</li><li>Определите нужные типы штрих-кода в качестве параметра EncodeTypes</li><li>Вставьте входной текст в качестве второго параметра</li><li>Вызовите метод BarCodeGenerator.save, чтобы получить сгенерированное изображение Deutsche Post Идентификатор и Deutsche Post Лейткод</li></ul>
