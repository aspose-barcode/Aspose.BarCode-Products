---
title: Сканировать изображения Штрих-код GS1 Code 128 через Python via Java
description: Исходный код Python для распознавания Штрих-код GS1 Code 128 с использованием Java Runtime Environment.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/python-java/code128/recognize/
aliases:
- /ru/python-java/recognize/code128/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение GS1 Code 128 штрих-кодов с помощью Python via Java" h2="Чтение Штрих-код GS1 Code 128 в Python с помощью серверного API Aspose.BarCode для Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию Штрих-код GS1 Code 128 в Python" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode позволяет разработчикам считывать штрих-коды Штрих-код GS1 Code 128 из потока или изображения с помощью нескольких строк кода.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Создайте объект класса Aspose.BarCode.BarCodeReader</li><li>Определите путь к исходному файлу, содержащий Штрих-код GS1 Code 128 в качестве параметра</li><li>Определите требуемые типы штрих-кодов в DecodeType в качестве второго параметра</li><li>Пройтись по результатам декодирования</li><li>Получить текст штрих-кода с помощью свойства CodeText</li></ul>
