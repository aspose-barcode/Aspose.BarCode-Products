---
title: Создайте Штрих-код Australia Post и Australia Post eParcel изображений с помощью Node.js via Java
description: Образец кода Node.js для создания Штрих-код Australia Post и Australia Post eParcel в приложениях JavaScript.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/nodejs-java/australia-post/generate/
aliases:
- /ru/nodejs-java/generate/australia-post/
- /ru/nodejs-java/generate/australiapost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Создайте этикетки Australia Post с Node.js via Java" h2="Создайте Штрих-код Australia Post и Australia Post eParcel в JavaScript, используя серверный API Aspose.BarCode для Node.js via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по созданию Штрих-код Australia Post в JavaScript" %}}
