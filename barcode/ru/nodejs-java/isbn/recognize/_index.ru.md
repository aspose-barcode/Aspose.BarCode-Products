---
title: Сканировать изображения Штрих-код ISBN через Node.js via Java
weight: 1510
description: Исходный код Node.js для сканирования и декодирования Штрих-код ISBN в приложениях JavaScript.
lang: ru/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ru/nodejs-java/isbn/recognize/
aliases:
- /ru/nodejs-java/recognize/isbn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение ISBN штрих-кодов с помощью Node.js via Java" h2="Чтение Штрих-код ISBN в JavaScript с помощью серверного API Aspose.BarCode для Node.js via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISBN" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Штрих-код ISBN Using Node.js via Java" %}}
Чтобы распознавать Штрих-код ISBN в приложениях Node.js, используйте Aspose.BarCode для Node.js через Java — надежную, универсальную и удобную библиотеку штрих-кодов, представленную для сред на основе Java. Вы можете загрузить [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) для Javascript непосредственно из NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию Штрих-код ISBN в JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode позволяет разработчикам считывать штрих-коды Штрих-код ISBN из потока или изображения с помощью нескольких строк кода.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Создайте объект класса Aspose.BarCode.BarCodeReader</li><li>Передайте путь к исходному файлу, содержащему Штрих-код ISBN, в качестве параметра</li><li>Установите целевые типы штрих-кодов в DecodeType в качестве второго параметра</li><li>Пройтись по всем обнаруженным штрих-кодам</li><li>Получить результирующий текст штрих-кода с помощью свойства CodeText</li></ul>
