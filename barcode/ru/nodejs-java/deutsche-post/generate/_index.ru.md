---
title: Создайте Deutsche Post Идентификатор и Deutsche Post Лейткод изображений с помощью Node.js via Java
description: Образец кода Node.js для создания Deutsche Post Идентификатор и Deutsche Post Лейткод в приложениях JavaScript.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/nodejs-java/deutsche-post/generate/
aliases:
- /ru/nodejs-java/generate/deutsche-post/
- /ru/nodejs-java/generate/deutschepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Создайте этикетки Deutsche Post с Node.js via Java" h2="Создайте Deutsche Post Идентификатор и Deutsche Post Лейткод в JavaScript, используя серверный API Aspose.BarCode для Node.js via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по созданию Штрих-код Deutsche Post в JavaScript" %}}
