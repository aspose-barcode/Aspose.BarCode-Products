---
title: API сканера штрих-кода Nodejs, распознавания и генератора - Aspose 
weight: 660
url: /ru/nodejs-java/ 
description: Библиотека сканирования и генерации штрих-кодов Node.js для типов 1D, 2D и Почтовый. Легко интегрируйте в приложения React Angular для QR-кода maxicode Aztec Code128 EAN-128 и других
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API генератора штрих-кода и сканера Node.js" h2="Распознавайте или создавайте одномерные, двухмерные и почтовые штрих-коды, включая Code128, Code93, Code39, QR-код из разных изображений." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="https://downloads.aspose.com/barcode/nodejs" >}}

{{< blocks/products/pf/main-container pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" >}}

{{< blocks/products/pf/i18n/sub-menu logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-nodejs-java.svg" liveDemosLink="" PricingLink="https://purchase.aspose.com/pricing/barcode/nodejs-java" buyLink="https://purchase.aspose.com/buy" docsLink="https://docs.aspose.com/barcode/java/node-js-via-java-release-notes/" installationsDocsLink="" nugetLink="" nugetPackageName="" mavenRepoLink="https://repository.aspose.com/webapp/#/artifacts/browse/tree/Общий/repo/com/aspose/aspose-barcode" directDownloadLink="https://downloads.aspose.com/barcode/nodejs" >}}

{{< blocks/products/pf/i18n/tab-content >}}
<p>
 Aspose.BarCode для Node.js через Java — это легко настраиваемый API для сканирования и генерации штрих-кода. Разработчики могут интегрировать его через мост nodejs-java. Это быстрый и простой API-интерфейс декодера штрих-кода для декодирования обычных одномерных и двумерных штрих-кодов в любом месте и под любым углом от изображения. Можно легко указать область изображения для сканирования штрих-кода. API генерирует изображения штрих-кода в нескольких форматах, таких как JPG, PNG, GIF, BMP, а также поддерживает несколько функций обработки изображений, таких как управление границами и стилями, цветом, полями, вращение изображений, настройка разрешения и многое другое.
</p>
...
<div class="diagram1 d1-nodejs">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    <li>
     Управление границами изображения
    </li>
    <li>
     Управление стилями
    </li>
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    <li>
     Задайте различные символы
    </li>
    <li>
     Установить текст кода
    </li>
    <li>
     Установить стиль кода
    </li>
    <li>
     Заголовок штрих-кода
    </li>
    <li>
     Размер штрих-кода X и Y
    </li>
   </ul>
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Android-библиотека штрих-кодов" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-nodejs-java.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Независимость от платформы" description="Aspose.BarCode для Node.js через Java — это API JavaScript на стороне сервера, основанный на Node.js. Он может работать на платформах Windows, Unix/Linux и Mac с JDK 1.7 или выше." >}}
<div class="diagram1 d1-nodejs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Генератор штрих-кода Android" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-nodejs-java.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Поддерживаемые форматы файлов" description="API работает с наиболее часто используемыми форматами изображений." >}}
...
<li>WebP</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Android-интерфейс для чтения штрих-кодов" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-nodejs-java.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Укажите различные виды символов
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Установка текста и стилей кода
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Управление заголовком штрих-кода
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Настройка размеров X и Y для 2D-типов
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Распознавать различные типы штрих-кодов
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Создание нескольких типов штрих-кода
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Сканировать штрих-код, указав область
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Управление стилями границ изображения штрих-кода
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Поворачивайте изображения штрих-кода на любой градус
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Управление полями изображения штрих-кода
    </p>
   </div>
   <div class="col-lg-4">
...
<p class="col-lg-10">Switch Barcode Признание Modes as of Requirement</p>

</div>-->
   <!--<div class="col-lg-12">

<h2 class="h2title">QR Code Поколение</h2>
...
// Display or echo Status
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.BarCode для Node.js через Java поддерживает большое количество числовых, буквенно-цифровых и двумерных штрих-кодов как для кодирования, так и для декодирования.
    </p>
    <p>
     Поддерживаемые API числовые символы включают:
    </p>
    <div class="col-lg-6">
     <ul class="unstyled">
      <li>
    ...
    <p>
     Буквенно-цифровые символы, поддерживаемые API, включают:
    </p>
    <div>
     <div class="col-lg-6">
      <ul class="unstyled">
    ...
    <p>
     Поддерживаемые 2D-символики включают:
    </p>
    <div>
     <div class="col-lg-6">
      <ul class="unstyled">
...
<h2 class="h2title">визуализация, Rotation & Sizing</h2>
...
{{< blocks/products/pf/slr-element name="Ссылки на API" href="https://apireference.aspose.com/java/barcode" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.BarCode для Node.js через Java?" tabId="success-stories" >}}
