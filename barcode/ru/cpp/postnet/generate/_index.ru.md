...
<ul><li>Создайте объект класса BarcodeGenerator</li><li>Передайте Штрих-код Postnet в качестве параметра</li><li>Вставьте входной текст для кодирования в качестве второго параметра</li><li>При необходимости определите размеры изображения</li><li>Вызовите метод BarcodeGenerator.Save, чтобы загрузить штрих-код Штрих-код Postnet</li></ul>
