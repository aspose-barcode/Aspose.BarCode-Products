---
title: Создайте Штрих-код Standard 2 of 5 (Промышленный 2 из 5) изображений с помощью C++
description: Пример кода C++ для создания Штрих-код Standard 2 of 5 (Промышленный 2 из 5) в среде выполнения C++ для 32-разрядной, 64-разрядной версии Windows и 64-разрядной версии Linux.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/cpp/standard2of5/generate/
aliases:
- /ru/cpp/generate/standard2of5/
- /ru/cpp/generate/iata2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Создайте этикетки Standard 2 of 5 с C++" h2="Создайте Штрих-код Standard 2 of 5 (Промышленный 2 из 5) в C++, используя серверный API Aspose.BarCode для C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Создайте объект класса BarcodeGenerator</li><li>Передайте Штрих-код Standard 2 of 5 (Промышленный 2 из 5) в качестве параметра</li><li>Вставьте входной текст для кодирования в качестве второго параметра</li><li>При необходимости определите размеры изображения</li><li>Вызовите метод BarcodeGenerator.Save, чтобы загрузить штрих-код Штрих-код Standard 2 of 5 (Промышленный 2 из 5)</li></ul>
