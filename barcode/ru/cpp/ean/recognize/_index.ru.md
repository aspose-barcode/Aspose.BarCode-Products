---
title: Сканировать изображения Штрих-код EAN через C++
description: Пример кода C++ для сканирования и декодирования Штрих-код EAN в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows или 64-разрядной версии Linux.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/cpp/ean/recognize/
aliases:
- /ru/cpp/recognize/ean/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение EAN штрих-кодов с помощью C++" h2="Чтение Штрих-код EAN в C++ с помощью серверного API Aspose.BarCode для C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
