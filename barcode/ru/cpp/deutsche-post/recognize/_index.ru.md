---
title: Сканировать изображения Deutsche Post Идентификатор и Deutsche Post Лейткод через C++
description: Пример кода C++ для сканирования и декодирования Deutsche Post Идентификатор и Deutsche Post Лейткод в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows или 64-разрядной версии Linux.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/cpp/deutsche-post/recognize/
aliases:
- /ru/cpp/recognize/deutsche-post/
- /ru/cpp/recognize/deutschepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение Deutsche Post штрих-кодов с помощью C++" h2="Чтение Deutsche Post Идентификатор и Deutsche Post Лейткод в C++ с помощью серверного API Aspose.BarCode для C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
