---
title: Создайте Deutsche Post Идентификатор и Deutsche Post Лейткод изображений с помощью C++
description: Пример кода C++ для создания Deutsche Post Идентификатор и Deutsche Post Лейткод в среде выполнения C++ для 32-разрядной, 64-разрядной версии Windows и 64-разрядной версии Linux.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/cpp/deutsche-post/generate/
aliases:
- /ru/cpp/generate/deutsche-post/
- /ru/cpp/generate/deutschepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Создайте этикетки Deutsche Post с C++" h2="Создайте Deutsche Post Идентификатор и Deutsche Post Лейткод в C++, используя серверный API Aspose.BarCode для C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Создайте объект класса BarcodeGenerator</li><li>Передайте Deutsche Post Идентификатор и Deutsche Post Лейткод в качестве параметра</li><li>Вставьте входной текст для кодирования в качестве второго параметра</li><li>При необходимости определите размеры изображения</li><li>Вызовите метод BarcodeGenerator.Save, чтобы загрузить штрих-код Deutsche Post Идентификатор и Deutsche Post Лейткод</li></ul>
