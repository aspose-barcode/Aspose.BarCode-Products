---
title: Сканировать изображения PDF417 штрих-код через C++
description: Пример кода C++ для сканирования и декодирования PDF417 штрих-код в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows или 64-разрядной версии Linux.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/cpp/pdf417/recognize/
aliases:
- /ru/cpp/recognize/pdf417/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение PDF417 штрих-кодов с помощью C++" h2="Чтение PDF417 штрих-код в C++ с помощью серверного API Aspose.BarCode для C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF417" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Создайте объект класса Aspose.BarCode.BarCodeReader</li><li>Укажите путь к исходному изображению, содержащему PDF417 штрих-код в качестве параметра</li><li>Передайте требуемые типы штрих-кодов в DecodeType в качестве второго параметра</li><li>Пройтись по результатам распознавания</li><li>Загрузить декодированный текст штрих-кода с помощью свойства CodeText</li></ul>
