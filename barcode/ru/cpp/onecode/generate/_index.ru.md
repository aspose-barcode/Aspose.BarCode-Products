...
<ul><li>Создайте объект класса BarcodeGenerator</li><li>Передайте USPS OneCode штрих-код в качестве параметра</li><li>Вставьте входной текст для кодирования в качестве второго параметра</li><li>При необходимости определите размеры изображения</li><li>Вызовите метод BarcodeGenerator.Save, чтобы загрузить штрих-код USPS OneCode штрих-код</li></ul>
