---
title: Создайте Code 93 расширенный и Code 93 стандартный штрих-коды изображений с помощью Java
description: Пример кода Java для генерации Code 93 расширенный и Code 93 стандартный штрих-коды в среде выполнения Java для приложений JSP/JSF и настольных приложений.
lang: ru/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ru/java/code93/generate/
aliases:
- /ru/java/generate/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Создайте этикетки Code 93 с Java" h2="Создайте Code 93 расширенный и Code 93 стандартный штрих-коды в Java, используя серверный API Aspose.BarCode для Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по созданию Штрих-код Code 93 в Java" %}}
