---
title: Создайте Штрих-код Australia Post и Australia Post eParcel изображений с помощью Java
description: Пример кода Java для генерации Штрих-код Australia Post и Australia Post eParcel в среде выполнения Java для приложений JSP/JSF и настольных приложений.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/java/australia-post/generate/
aliases:
- /ru/java/generate/australia-post/
- /ru/java/generate/australiapost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Создайте этикетки Australia Post с Java" h2="Создайте Штрих-код Australia Post и Australia Post eParcel в Java, используя серверный API Aspose.BarCode для Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по созданию Штрих-код Australia Post в Java" %}}
