---
title: Сканировать изображения Итальянский штрих-код Pharmacode (Code 32) через Java
description: Исходный код Java для чтения и декодирования Итальянский штрих-код Pharmacode (Code 32) в среде выполнения Java для приложений JSP/JSF и настольных приложений.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/java/code32/recognize/
aliases:
- /ru/java/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение Code 32 штрих-кодов с помощью Java" h2="Чтение Итальянский штрих-код Pharmacode (Code 32) в Java с помощью серверного API Aspose.BarCode для Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Создайте новый объект класса BarCodeReader</li><li>Установите путь к исходному файлу, содержащему Штрих-код Code 32</li><li>Передайте требуемые типы штрих-кодов в DecodeType в качестве второго параметра</li><li>Повторить результаты декодирования</li><li>Получить текст штрих-кода с помощью метода getCodeText</li></ul>
