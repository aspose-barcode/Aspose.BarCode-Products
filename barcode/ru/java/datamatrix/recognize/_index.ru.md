---
title: Сканировать изображения Data Matrix код через Java
description: Исходный код Java для чтения и декодирования Data Matrix код в среде выполнения Java для приложений JSP/JSF и настольных приложений.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/java/datamatrix/recognize/
aliases:
- /ru/java/recognize/datamatrix/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение Data Matrix штрих-кодов с помощью Java" h2="Чтение Data Matrix код в Java с помощью серверного API Aspose.BarCode для Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Data Matrix" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Создайте новый объект класса BarCodeReader</li><li>Установите путь к исходному файлу, содержащему Data Matrix код</li><li>Передайте требуемые типы штрих-кодов в DecodeType в качестве второго параметра</li><li>Повторить результаты декодирования</li><li>Получить текст штрих-кода с помощью метода getCodeText</li></ul>
