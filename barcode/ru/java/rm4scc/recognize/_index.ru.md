---
title: Сканировать изображения Код клиента Royal Mail из 4 штатов (RM4SCC) через Java
description: Исходный код Java для чтения и декодирования Код клиента Royal Mail из 4 штатов (RM4SCC) в среде выполнения Java для приложений JSP/JSF и настольных приложений.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/java/rm4scc/recognize/
aliases:
- /ru/java/recognize/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение RM4SCC штрих-кодов с помощью Java" h2="Чтение Код клиента Royal Mail из 4 штатов (RM4SCC) в Java с помощью серверного API Aspose.BarCode для Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию Код клиента Royal Mail из 4 штатов (RM4SCC) в Java" %}}
...
<ul><li>Создайте новый объект класса BarCodeReader</li><li>Установите путь к исходному файлу, содержащему Код клиента Royal Mail из 4 штатов (RM4SCC)</li><li>Передайте требуемые типы штрих-кодов в DecodeType в качестве второго параметра</li><li>Повторить результаты декодирования</li><li>Получить текст штрих-кода с помощью метода getCodeText</li></ul>
