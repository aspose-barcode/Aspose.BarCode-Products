---
title: Создайте HIBC (Штрих-код для индустрии здравоохранения) изображений с помощью Java
weight: 1510
description: Пример кода Java для генерации HIBC (Штрих-код для индустрии здравоохранения) в среде выполнения Java для приложений JSP/JSF и настольных приложений.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Создайте этикетки HIBC с Java" h2="Создайте HIBC (Штрих-код для индустрии здравоохранения) в Java, используя серверный API Aspose.BarCode для Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HIBC" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate HIBC (Штрих-код для индустрии здравоохранения) Using Java" %}}
Чтобы сгенерировать HIBC (Штрих-код для индустрии здравоохранения), получите API [Aspose.BarCode for Java](https://products.aspose.com/barcode/java/) — многофункциональный, мощный и простой в использовании API штрих-кодов для Java. основанные платформы. Загрузите последнюю версию непосредственно с [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-barcode), а затем установите ее в свой Maven- на основе проекта, добавив следующие конфигурации в pom.xml:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по созданию HIBC (Штрих-код для индустрии здравоохранения) в Java" %}}
...
<ul><li>Создайте новый объект класса BarCodeGenerator</li><li>Определите HIBC (Штрих-код для индустрии здравоохранения) и другие требуемые типы штрих-кода в качестве параметра EncodeTypes</li><li>Укажите вводимый текст с помощью метода setCodeText< /li><li>Используйте метод BarCodeGenerator.save для сохранения сгенерированного изображения штрих-кода</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/pdf417/generate/" name="PDF417" description="PDF417 штрих-код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/qr/generate/" name="QR" description="Код QR, код GS1 QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/datamatrix/generate/" name="Data Matrix" description="Data Matrix код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/aztec/generate/" name="Aztec" description="Aztec Код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/swiss-qr/generate/" name="Swiss QR" description="Swiss QR счет" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/dotcode/generate/" name="DotCode" description="Штрих-код DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/hibc/generate/" name="HIBC" description="HIBC (Штрих-код для индустрии здравоохранения)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/codablock/generate/" name="Codablock-F" description="Штрих-коды Codablock-F и GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/databar/generate/" name="GS1 DataBar" description="Штрих-код GS1 DataBar (всенаправленный, многонаправленный с накоплением, расширенный, расширенный с накоплением и усеченный)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/itf/generate/" name="ITF" description="Перемежающийся штрих-код 2 из 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/ean/generate/" name="EAN" description="Штрих-код EAN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/upc/generate/" name="UPC" description="Штрих-код UPC" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/code128/generate/" name="GS1 Code 128" description="Штрих-код GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/code39/generate/" name="Code 39" description="Штрих-код Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/code16k/generate/" name="Code 16K" description="Штрих-код Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/code32/generate/" name="Code 32" description="Итальянский штрих-код Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/code93/generate/" name="Code 93" description="Code 93 расширенный и Code 93 стандартный штрих-коды" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/onecode/generate/" name="USPS OneCode" description="USPS OneCode штрих-код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/standard2of5/generate/" name="Standard 2 of 5" description="Штрих-код Standard 2 of 5 (Промышленный 2 из 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/isbn/generate/" name="ISBN" description="Штрих-код ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/ismn/generate/" name="ISMN" description="Штрих-код ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/issn/generate/" name="ISSN" description="Штрих-код ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/australia-post/generate/" name="Australia Post" description="Штрих-код Australia Post и Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Идентификатор и Deutsche Post Лейткод" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/rm4scc/generate/" name="RM4SCC" description="Код клиента Royal Mail из 4 штатов (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/postnet/generate/" name="Postnet" description="Штрих-код Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/royal-mail/generate/" name="Royal Mail" description="Штрих-код Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/singapore-post/generate/" name="Singapore Post" description="Штрих-код Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
