---
title: Создайте Штрих-код Standard 2 of 5 (Промышленный 2 из 5) изображений с помощью Java
description: Пример кода Java для генерации Штрих-код Standard 2 of 5 (Промышленный 2 из 5) в среде выполнения Java для приложений JSP/JSF и настольных приложений.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/java/standard2of5/generate/
aliases:
- /ru/java/generate/standard2of5/
- /ru/java/generate/iata2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Создайте этикетки Standard 2 of 5 с Java" h2="Создайте Штрих-код Standard 2 of 5 (Промышленный 2 из 5) в Java, используя серверный API Aspose.BarCode для Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по созданию Штрих-код Standard 2 of 5 в Java" %}}
