...
{{< blocks/products/pf/upper-banner h1="Чтение PDF417 штрих-кодов с помощью Java" h2="Чтение PDF417 штрих-код в Java с помощью серверного API Aspose.BarCode для Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF417" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Создайте новый объект класса BarCodeReader</li><li>Установите путь к исходному файлу, содержащему PDF417 штрих-код</li><li>Передайте требуемые типы штрих-кодов в DecodeType в качестве второго параметра</li><li>Повторить результаты декодирования</li><li>Получить текст штрих-кода с помощью метода getCodeText</li></ul>
