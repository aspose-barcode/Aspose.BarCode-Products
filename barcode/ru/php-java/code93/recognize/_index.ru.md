---
title: Сканировать изображения Code 93 расширенный и Code 93 стандартный штрих-коды через PHP via Java
weight: 1510
description: Пример кода PHP для чтения Code 93 расширенный и Code 93 стандартный штрих-коды в приложениях на основе PHP.
lang: ru/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ru/php-java/code93/recognize/
aliases:
- /ru/php-java/recognize/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение Code 93 штрих-кодов с помощью PHP via Java" h2="Чтение Code 93 расширенный и Code 93 стандартный штрих-коды в PHP с помощью серверного API Aspose.BarCode для PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Штрих-код Code 93 Using PHP via Java" %}}
Считайте штрих-коды Штрих-код Code 93 в приложениях PHP, используя Aspose.BarCode для PHP через Java, мощную, многофункциональную и удобную библиотеку штрих-кодов, предназначенную для платформ на основе Java. Чтобы попробовать API штрих-кода, вам необходимо получить последнюю версию с портала [выпусков Aspose](https://releases.aspose.com/barcode/php/). Вы также можете найти пакет [aspose/barcode](https://packagist.org/packages/aspose/barcode) в Packagist, а затем интегрировать его в свой PHP-проект через композитор:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию Штрих-код Code 93 в PHP" %}}
...
<ul><li>Создайте объект класса Aspose.BarCode.BarCodeReader</li><li>Установите путь к исходному изображению, содержащему Штрих-код Code 93, в качестве параметра</li><li>Укажите целевые типы штрих-кодов в DecodeType в качестве второго параметра</li><li>Пройтись по результатам чтения</li><li>Получить текст штрих-кода с помощью свойства CodeText</li></ul>
