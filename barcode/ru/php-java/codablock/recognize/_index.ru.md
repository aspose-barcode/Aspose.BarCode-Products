---
title: Сканировать изображения Штрих-коды Codablock-F и GS1 Codablock-F через PHP via Java
description: Пример кода PHP для чтения Штрих-коды Codablock-F и GS1 Codablock-F в приложениях на основе PHP.
lang: ru
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ru/php-java/codablock/recognize/
aliases:
- /ru/php-java/recognize/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение Codablock-F штрих-кодов с помощью PHP via Java" h2="Чтение Штрих-коды Codablock-F и GS1 Codablock-F в PHP с помощью серверного API Aspose.BarCode для PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Штрих-код Codablock-F Using PHP via Java" %}}
Считайте штрих-коды Штрих-код Codablock-F в приложениях PHP, используя Aspose.BarCode для PHP через Java, мощную, многофункциональную и удобную библиотеку штрих-кодов, предназначенную для платформ на основе Java. Чтобы попробовать API штрих-кода, вам необходимо получить последнюю версию с портала [выпусков Aspose](https://releases.aspose.com/barcode/php/). Вы также можете найти пакет [aspose/barcode](https://packagist.org/packages/aspose/barcode) в Packagist, а затем интегрировать его в свой PHP-проект через композитор:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию Штрих-код Codablock-F в PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode позволяет разработчикам считывать штрих-коды Штрих-код Codablock-F из потока или изображения с помощью нескольких строк кода.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Создайте объект класса Aspose.BarCode.BarCodeReader</li><li>Установите путь к исходному изображению, содержащему Штрих-код Codablock-F, в качестве параметра</li><li>Укажите целевые типы штрих-кодов в DecodeType в качестве второго параметра</li><li>Пройтись по результатам чтения</li><li>Получить текст штрих-кода с помощью свойства CodeText</li></ul>
