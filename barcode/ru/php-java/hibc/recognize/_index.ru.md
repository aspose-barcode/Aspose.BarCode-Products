---
title: Сканировать изображения HIBC (Штрих-код для индустрии здравоохранения) через PHP via Java
weight: 1510
description: Пример кода PHP для чтения HIBC (Штрих-код для индустрии здравоохранения) в приложениях на основе PHP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение HIBC штрих-кодов с помощью PHP via Java" h2="Чтение HIBC (Штрих-код для индустрии здравоохранения) в PHP с помощью серверного API Aspose.BarCode для PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HIBC" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read HIBC (Штрих-код для индустрии здравоохранения) Using PHP via Java" %}}
Считайте штрих-коды HIBC (Штрих-код для индустрии здравоохранения) в приложениях PHP, используя Aspose.BarCode для PHP через Java, мощную, многофункциональную и удобную библиотеку штрих-кодов, предназначенную для платформ на основе Java. Чтобы попробовать API штрих-кода, вам необходимо получить последнюю версию с портала [выпусков Aspose](https://releases.aspose.com/barcode/php/). Вы также можете найти пакет [aspose/barcode](https://packagist.org/packages/aspose/barcode) в Packagist, а затем интегрировать его в свой PHP-проект через композитор:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию HIBC (Штрих-код для индустрии здравоохранения) в PHP" %}}
...
<ul><li>Создайте объект класса Aspose.BarCode.BarCodeReader</li><li>Установите путь к исходному изображению, содержащему HIBC (Штрих-код для индустрии здравоохранения), в качестве параметра</li><li>Укажите целевые типы штрих-кодов в DecodeType в качестве второго параметра</li><li>Пройтись по результатам чтения</li><li>Получить текст штрих-кода с помощью свойства CodeText</li></ul>
...
<ul><li>Microsoft Windows, Linux или любая другая ОС, совместимая со средами разработки на основе PHP</li></ul>
...
{{% blocks/products/pf/agp/content h2="Об Aspose.BarCode для PHP via Java API" %}}
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/pdf417/recognize/" name="PDF417" description="PDF417 штрих-код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/qr/recognize/" name="QR" description="Код QR, код GS1 QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/aztec/recognize/" name="Aztec" description="Aztec Код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR счет" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/dotcode/recognize/" name="DotCode" description="Штрих-код DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/hibc/recognize/" name="HIBC" description="HIBC (Штрих-код для индустрии здравоохранения)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/codablock/recognize/" name="Codablock-F" description="Штрих-коды Codablock-F и GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/databar/recognize/" name="GS1 DataBar" description="Штрих-код GS1 DataBar (всенаправленный, многонаправленный с накоплением, расширенный, расширенный с накоплением и усеченный)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/itf/recognize/" name="ITF" description="Перемежающийся штрих-код 2 из 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/ean/recognize/" name="EAN" description="Штрих-код EAN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/upc/recognize/" name="UPC" description="Штрих-код UPC" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/code128/recognize/" name="GS1 Code 128" description="Штрих-код GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/code39/recognize/" name="Code 39" description="Штрих-код Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/code16k/recognize/" name="Code 16K" description="Штрих-код Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/code32/recognize/" name="Code 32" description="Итальянский штрих-код Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/code93/recognize/" name="Code 93" description="Code 93 расширенный и Code 93 стандартный штрих-коды" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode штрих-код" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/standard2of5/recognize/" name="Standard 2 of 5" description="Штрих-код Standard 2 of 5 (Промышленный 2 из 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/isbn/recognize/" name="ISBN" description="Штрих-код ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/ismn/recognize/" name="ISMN" description="Штрих-код ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/issn/recognize/" name="ISSN" description="Штрих-код ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/australia-post/recognize/" name="Australia Post" description="Штрих-код Australia Post и Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Идентификатор и Deutsche Post Лейткод" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/rm4scc/recognize/" name="RM4SCC" description="Код клиента Royal Mail из 4 штатов (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/postnet/recognize/" name="Postnet" description="Штрих-код Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/royal-mail/recognize/" name="Royal Mail" description="Штрих-код Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/singapore-post/recognize/" name="Singapore Post" description="Штрих-код Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ru/php-java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
