---
title: Сканировать изображения Swiss QR счет через PHP via Java
weight: 1510
description: Пример кода PHP для чтения Swiss QR счет в приложениях на основе PHP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Чтение Swiss QR штрих-кодов с помощью PHP via Java" h2="Чтение Swiss QR счет в PHP с помощью серверного API Aspose.BarCode для PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss QR" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Swiss QR счет Using PHP via Java" %}}
Считайте штрих-коды Swiss QR счет в приложениях PHP, используя Aspose.BarCode для PHP через Java, мощную, многофункциональную и удобную библиотеку штрих-кодов, предназначенную для платформ на основе Java. Чтобы попробовать API штрих-кода, вам необходимо получить последнюю версию с портала [выпусков Aspose](https://releases.aspose.com/barcode/php/). Вы также можете найти пакет [aspose/barcode](https://packagist.org/packages/aspose/barcode) в Packagist, а затем интегрировать его в свой PHP-проект через композитор:
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по сканированию Swiss QR счет в PHP" %}}
...
<ul><li>Создайте объект класса Aspose.BarCode.BarCodeReader</li><li>Установите путь к исходному изображению, содержащему Swiss QR счет, в качестве параметра</li><li>Укажите целевые типы штрих-кодов в DecodeType в качестве второго параметра</li><li>Пройтись по результатам чтения</li><li>Получить текст штрих-кода с помощью свойства CodeText</li></ul>
