---
title: Escanee imágenes de Postnet código de barras a ​​través de Java
description: Código fuente de Java para leer y decodificar Postnet código de barras en Java Runtime Environment para aplicaciones JSP/JSF y aplicaciones de escritorio.
lang: es
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /es/java/postnet/recognize/
aliases:
- /es/java/recognize/postnet/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer Postnet códigos de barras con Java" h2="Lee Postnet código de barras en Java usando Aspose.BarCode del lado del servidor para Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Postnet" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear Postnet código de barras en Java" %}}
