---
title: Escanee imágenes de Códigos de barras Codablock-F y GS1 Codablock-F a ​​través de Java
weight: 1510
description: Código fuente de Java para leer y decodificar Códigos de barras Codablock-F y GS1 Codablock-F en Java Runtime Environment para aplicaciones JSP/JSF y aplicaciones de escritorio.
lang: es/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /es/java/codablock/recognize/
aliases:
- /es/java/recognize/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer Codablock-F códigos de barras con Java" h2="Lee Códigos de barras Codablock-F y GS1 Codablock-F en Java usando Aspose.BarCode del lado del servidor para Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear Codablock-F código de barras en Java" %}}
