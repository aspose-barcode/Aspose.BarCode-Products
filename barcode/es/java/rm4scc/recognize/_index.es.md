---
title: Escanee imágenes de Código de cliente de 4 estados de Royal Mail (RM4SCC) a ​​través de Java
weight: 1510
description: Código fuente de Java para leer y decodificar Código de cliente de 4 estados de Royal Mail (RM4SCC) en Java Runtime Environment para aplicaciones JSP/JSF y aplicaciones de escritorio.
lang: es/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /es/java/rm4scc/recognize/
aliases:
- /es/java/recognize/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer RM4SCC códigos de barras con Java" h2="Lee Código de cliente de 4 estados de Royal Mail (RM4SCC) en Java usando Aspose.BarCode del lado del servidor para Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear Código de cliente de 4 estados de Royal Mail (RM4SCC) en Java" %}}
...
<ul><li>Cree un nuevo objeto de la clase BarCodeReader</li><li>Establezca la ruta del archivo de origen que contiene Código de cliente de 4 estados de Royal Mail (RM4SCC)</li><li>Pase los tipos de código de barras necesarios a DecodeType como segundo parámetro</li><li>Recorra los resultados de la decodificación</li><li>Obtenga el texto del código de barras usando el método getCodeText</li></ul>
