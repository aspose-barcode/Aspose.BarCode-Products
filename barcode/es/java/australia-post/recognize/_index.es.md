---
title: Escanee imágenes de Australia Post código de barras y Australia Post eParcel a ​​través de Java
description: Código fuente de Java para leer y decodificar Australia Post código de barras y Australia Post eParcel en Java Runtime Environment para aplicaciones JSP/JSF y aplicaciones de escritorio.
lang: es
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /es/java/australia-post/recognize/
aliases:
- /es/java/recognize/australia-post/
- /es/java/recognize/australiapost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer Australia Post códigos de barras con Java" h2="Lee Australia Post código de barras y Australia Post eParcel en Java usando Aspose.BarCode del lado del servidor para Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear Australia Post código de barras en Java" %}}
