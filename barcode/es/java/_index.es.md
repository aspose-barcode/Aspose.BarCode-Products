...
{{< blocks/products/pf/upper-banner h1="API de reconocimiento y generación de código de barras de Java" h2="Cree y reconozca códigos de barras de tipos lineales, 2D y postales dentro de cualquier aplicación Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" pfName="Aspose.BarCode" subTitlepfName="para Java" downloadUrl="https://releases.aspose.com/barcode/java/" >}}
...
<p>Aspose.BarCode para Java es una API robusta y confiable que proporciona funciones de generación y reconocimiento de códigos de barras para aplicaciones Java. Es compatible con los estándares y especificaciones más establecidos y permite a los desarrolladores leer códigos de barras 1D y 2D de diferentes archivos de imagen en cualquier ángulo. Aspose.BarCode para Java representa imágenes de códigos de barras en una variedad de formatos de imagen con opciones de imagen altamente flexibles. La biblioteca admite la codificación y decodificación de más de 60 tipos de códigos de barras y permite la impresión directa de imágenes de códigos de barras.</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="de un vistazo" description="Una descripción general de las capacidades de generación y reconocimiento de códigos de barras de la API." >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>Lineal, 2D y postal</li><li>Detectar desde flujo o imagen</li><li>Obtener orientación del código de barras</li><li>Decodificar caracteres no ingleses</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                Impresión
            </header>
            <ul><li>Imprimir código de barras directamente</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>Lineal, 2D y postal</li><li>Guardar en transmisión o imagen</li><li>Personalizar apariencia&colon; tamaño, color, ángulo</li><li>Codificar caracteres no ingleses </li></ul>
            <header>
                <i class="fa fa-qrcode">
                </i>
                Tipos
            </header>
            <ul><li>Lineal</li><li>2D</li><li>Postal</li></ul>
        </div>
        <!--/right-->
    </div>
    <!--/row-->
...
{{< blocks/products/pf/carousel-item h3="Independencia de la plataforma" description="Puede utilizar la biblioteca de códigos de barras para crear cualquier tipo de aplicación Java que tenga JRE 1.6 o superior instalado." >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo admitidos" description="Aspose.BarCode para Java funciona con los formatos de archivo de imagen más utilizados." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Funciones avanzadas de la biblioteca Java
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/control-the-appearance-of-code-text/'>Ajuste y modifique las propiedades relacionadas con la apariencia del texto del código</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-the-barcode-caption/'>Administrar subtítulos y estilos de fuente</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/use-checksum-and-supplement-data-for-barcodes/'>Compatibilidad con datos de suma de comprobación y suplementos</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#image-formats'>Genere imágenes de códigos de barras en múltiples formatos de imagen</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/advanced-barcode-recognition-features/'>Lea tipos 1D y 2D en cualquier ángulo</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/barcode-regions/'>Escanee el código de barras especificando el área</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/generate-barcode-by-specifying-custom-image-size/'>Personaliza el tamaño de las imágenes</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-x-dimension-and-y-dimension/'>Soporte de dimensión X e Y para tipo 2D</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#barcode-types'>Compatibilidad con simbologías lineales, 2D y postales</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    La API de códigos de barras permite a los desarrolladores generar fácilmente imágenes de códigos de barras de alta calidad en sus aplicaciones. Admite una amplia gama de tipos de códigos de barras, incluidos los más utilizados, como QR Code y Code 128, así como tipos más especializados, como Aztec Code y Data Matrix. La API permite a los desarrolladores personalizar la apariencia de los códigos de barras generados, incluidos los colores de primer plano y de fondo, la fuente y la alineación de los subtítulos. Con la API, los desarrolladores pueden generar fácilmente códigos de barras 2D de la misma manera que generarían códigos de barras unidimensionales.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Insertar códigos de barras en documentos PDF
                </h2>
                <p>
                    La biblioteca de códigos de barras permite a los desarrolladores no solo crear códigos de barras personalizados, sino también agregar directamente imágenes generadas en documentos PDF. Primero puede crear imágenes de código de barras utilizando uno de los formatos de trama admitidos y luego insertarlos en un archivo PDF. La API permite agregar códigos de barras sin compresión de imágenes y pérdidas de calidad. También proporciona funcionalidad para modificar los parámetros y la apariencia del código de barras antes de las inserciones o agregar la imagen generada en varias páginas del documento a la vez. La API Aspose.BarCode se puede utilizar para la impresión de alta calidad de imágenes de códigos de barras. Las imágenes rasterizadas tienen la resolución estándar de 96 dpi, que no es suficiente para este propósito. La API permite configurar una resolución de imagen de código de barras de 300 o 600 ppp para imprimir documentos PDF de alta calidad.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
                ...
                <p>
                    La biblioteca de códigos de barras de Java es una poderosa herramienta para trabajar con códigos de barras en aplicaciones Java. Una de sus características clave es la capacidad de leer códigos de barras de diferentes formatos de archivo de imagen. La clase BarCodeReader, que es la clase principal responsable del reconocimiento de códigos de barras, admite muchos formatos de imagen populares, incluidos BMP, PNG, TIFF, JPEG y GIF. Esto facilita la integración de la funcionalidad de reconocimiento de códigos de barras en una amplia gama de aplicaciones.
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
    ...
    <div class="barcode-read-lcs-controls">
        ...
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">Todos los tipos</option>
                <option value="Pdf417 ">PDF417</option>
                <option value="QR ">QR</option>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Escanear códigos de barras de documentos PDF
                </h2>
                <p>
                    Además de leer códigos de barras de archivos de imagen, la biblioteca de códigos de barras se puede utilizar para escanear códigos de barras de archivos PDF. Los desarrolladores pueden implementar una detección rápida de códigos de barras en documentos PDF con varias páginas. La API proporciona varias formas de hacerlo. La forma recomendada es convertir las páginas del documento en imágenes de trama y luego aplicar mecanismos de lectura de códigos de barras. Se sugiere convertir el contenido de la página en imágenes rasterizadas como el enfoque más fácil y eficiente. De lo contrario, las imágenes de código de barras se pueden detectar y extraer primero del documento PDF de origen. Este método facilita la lectura de códigos de barras con resolución original. La API Aspose.BarCode permite procesar archivos PDF de varias páginas para detectar y reconocer todos los códigos de barras presentados en un documento.
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/pdf417/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/qr/" name="QR" description="QR Código, GS1 QR Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/datamatrix/" name="Data Matrix" description="Data Matrix código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/aztec/" name="Aztec" description="Aztec Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/swiss-qr/" name="Swiss QR" description="Swiss QR factura" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/dotcode/" name="DotCode" description="DotCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/hibc/" name="HIBC" description="{{type.HIBC._name}} (Código de barras de la industria de la salud)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/codablock/" name="Codablock-F" description="Códigos de barras Codablock-F y GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/databar/" name="GS1 DataBar" description="Código de barras GS1 DataBar (omnidireccional, omnidireccional apilado, expandido, apilado expandido y truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/itf/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/ean/" name="EAN" description="EAN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/upc/" name="UPC" description="UPC código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/code128/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/code39/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/code16k/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/code32/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/code93/" name="Code 93" description="Códigos de barras Code 93 extendidos y Code 93 estándar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/onecode/" name="USPS OneCode" description="USPS OneCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/standard2of5/" name="Standard 2 of 5" description="Código de barras Standard 2 of 5 (Industrial 2 de 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/isbn/" name="ISBN" description="ISBN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/ismn/" name="ISMN" description="ISMN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/issn/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/australia-post/" name="Australia Post" description="Australia Post código de barras y Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode y Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/rm4scc/" name="RM4SCC" description="Código de cliente de 4 estados de Royal Mail (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/postnet/" name="Postnet" description="Postnet código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/royal-mail/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/singapore-post/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="Lo que la gente esta diciendo" subTitle="No se fíe sólo de nuestra palabra. Vea lo que los usuarios tienen que decir sobre las API." caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 Pasé muchos años desarrollando y mejorando mi producto y Aspose me ha permitido hacer que mi producto sea mucho más amigable y útil y, por lo tanto, más comercializable. <em>Kiel Diller | Soluciones KD, Polonia</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode está realmente escrito en código administrado y nos brinda una variedad de tipos de códigos de barras para manejar todo tipo de reconocimiento de documentos y procesamiento posterior. <em>Dennis Alexander Petrasc | Keil IT, Alemania</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Documentación" href="https://docs.aspose.com/barcode/java/" >}}
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="Referencias de API" href="https://reference.aspose.com/barcode/java/" >}}
...
{{< blocks/products/pf/slr-element name="Notas de lanzamiento" href="https://docs.aspose.com/barcode/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.BarCode para Java?" tabId="success-stories" >}}
{{< blocks/products/pf/slr-element name="Lista de clientes" href="https://about.aspose.com/customers" >}}
{{< blocks/products/pf/slr-element name="Historias de éxito" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Aspose.BarCode ofrece API de reconocimiento y generación de códigos de barras individuales para otros entornos de desarrollo populares, como se indica a continuación:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/barcode/es/cpp/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sdkName="C++" >}}
