...
url: /es/java/qr/recognize/
aliases:
- /es/java/recognize/qr/
---
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear QR Código en Java" %}}
