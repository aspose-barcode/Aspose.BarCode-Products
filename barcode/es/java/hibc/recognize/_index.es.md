---
title: Escanee imágenes de {{type.HIBC._name}} (Código de barras de la industria de la salud) a ​​través de Java
weight: 1510
description: Código fuente de Java para leer y decodificar {{type.HIBC._name}} (Código de barras de la industria de la salud) en Java Runtime Environment para aplicaciones JSP/JSF y aplicaciones de escritorio.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer HIBC códigos de barras con Java" h2="Lee {{type.HIBC._name}} (Código de barras de la industria de la salud) en Java usando Aspose.BarCode del lado del servidor para Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HIBC" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear {{type.HIBC._name}} (Código de barras de la industria de la salud) en Java" %}}
...
<ul><li>Cree un nuevo objeto de la clase BarCodeReader</li><li>Establezca la ruta del archivo de origen que contiene {{type.HIBC._name}} (Código de barras de la industria de la salud)</li><li>Pase los tipos de código de barras necesarios a DecodeType como segundo parámetro< /li><li>Recorra los resultados de la decodificación</li><li>Obtenga el texto del código de barras usando el método getCodeText</li></ul>
...
{{% blocks/products/pf/agp/content h2="Acerca de Aspose.BarCode para Java API" %}}
