---
title: Escanee imágenes de Código de barras Standard 2 of 5 (Industrial 2 de 5) a ​​través de Java
description: Código fuente de Java para leer y decodificar Código de barras Standard 2 of 5 (Industrial 2 de 5) en Java Runtime Environment para aplicaciones JSP/JSF y aplicaciones de escritorio.
lang: es
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /es/java/standard2of5/recognize/
aliases:
- /es/java/recognize/standard2of5/
- /es/java/recognize/iata2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer Standard 2 of 5 códigos de barras con Java" h2="Lee Código de barras Standard 2 of 5 (Industrial 2 de 5) en Java usando Aspose.BarCode del lado del servidor para Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear Standard 2 of 5 código de barras en Java" %}}
