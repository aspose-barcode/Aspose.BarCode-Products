---
title: Genere imágenes de Australia Post código de barras y Australia Post eParcel a ​​través de Android via Java
description: Código fuente de Android para crear Australia Post código de barras y Australia Post eParcel en Android Runtime Environment.
lang: es
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /es/android-java/australia-post/generate/
aliases:
- /es/android-java/generate/australia-post/
- /es/android-java/generate/australiapost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genere etiquetas Australia Post con Android via Java" h2="Cree Australia Post código de barras y Australia Post eParcel en Java usando Aspose.BarCode del lado del servidor para la API de Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Australia Post código de barras Using Android via Java" %}}
Pruebe Aspose.BarCode para Android a través de Java para crear fácilmente Australia Post código de barras dentro de las aplicaciones de Android. Es una biblioteca de códigos de barras versátil, robusta y fácil de usar diseñada específicamente para aplicaciones de Android. Puede fácilmente Aspose.BarCode para Android a través de Java directamente desde un proyecto basado en Maven insertando las siguientes configuraciones en build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar Australia Post código de barras en Java" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode facilita a los desarrolladores la creación de imágenes Australia Post código de barras con pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Cree una nueva instancia de la clase BarCodeGenerator</li><li>Pase el tipo de código de barras Australia Post código de barras como el parámetro EncodeTypes</li><li>Defina el texto del código de barras usando el método setCodeText</li><li>Inicie el método generateBarCodeImage() para guardar la imagen del código de barras Australia Post código de barras y Australia Post eParcel</li></ul>
...
<span class="hljs-type">BarcodeGenerator</span> <span class="hljs-variable">generator</span> <span class="hljs-operator">=</span> <span class="hljs-keyword">new</span> <span class="hljs-title class_">BarcodeGenerator</span>(EncodeTypes.<span class="barcode-gen-lcs-type-param">AustraliaPost</span>);
