...
{{% blocks/products/pf/agp/content h2="How to Generate Swiss QR factura Using Android via Java" %}}
Pruebe Aspose.BarCode para Android a través de Java para crear fácilmente Swiss QR factura dentro de las aplicaciones de Android. Es una biblioteca de códigos de barras versátil, robusta y fácil de usar diseñada específicamente para aplicaciones de Android. Puede fácilmente Aspose.BarCode para Android a través de Java directamente desde un proyecto basado en Maven insertando las siguientes configuraciones en build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar Swiss QR factura en Java" %}}
...
<ul><li>Cree una nueva instancia de la clase BarCodeGenerator</li><li>Pase el tipo de código de barras Swiss QR factura como el parámetro EncodeTypes</li><li>Defina el texto del código de barras usando el método setCodeText</li><li>Inicie el método generateBarCodeImage() para guardar la imagen del código de barras Swiss QR factura</li></ul>
...
<span class="hljs-type">BarcodeGenerator</span> <span class="hljs-variable">generator</span> <span class="hljs-operator">=</span> <span class="hljs-keyword">new</span> <span class="hljs-title class_">BarcodeGenerator</span>(EncodeTypes.<span class="barcode-gen-lcs-type-param"></span>);
