...
{{% blocks/products/pf/agp/content h2="How to Read Data Matrix código Using Android via Java" %}}
Pruebe Aspose.BarCode para Android a través de Java para detectar y leer fácilmente Data Matrix código dentro de las aplicaciones de Android. Es una API de código de barras rica, escalable y fácil de usar diseñada para aplicaciones de Android. Obtenga Aspose.BarCode para Java directamente desde un proyecto basado en Maven agregando las siguientes configuraciones a build.gradle:
