...
{{< blocks/products/pf/upper-banner h1="API de Android para generación y reconocimiento de códigos de barras" h2="Cree o lea códigos de barras 1D, 2D y postales a partir de imágenes en cualquier aplicación móvil Android." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" pfName="Aspose.BarCode" subTitlepfName="para Android via Java" downloadUrl="https://releases.aspose.com/barcode/androidjava/" >}}
...
<p>Aspose.BarCode para Android a través de Java es una API de generación y lectura de códigos de barras para aplicaciones de Android. Admite escanear códigos de barras 1D, 2D y postales a partir de imágenes en diferentes ángulos. La API del generador de códigos de barras puede crear fácilmente imágenes de códigos de barras y guardarlas en varios formatos. También proporciona una rica funcionalidad de imágenes, como la personalización de los bordes del código de barras, el color, el ángulo de rotación, la resolución y mucho más.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Independencia de la plataforma" description="Utilice la API en cualquier plataforma donde esté disponible el entorno de tiempo de ejecución de Android." >}}
<div class='diagram1 d1-android'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo admitidos" description="Aspose.BarCode para Android via Java funciona con los formatos de archivo de imagen más utilizados." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/qr-code-generation/'>Codificar caracteres no ingleses en códigos QR</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-color-modification/'>Modificar el esquema de color del código de barras</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-appearance-customization/'>Gire imágenes de códigos de barras en cualquier ángulo</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/working-with-barcode-types/'>Genere y reconozca códigos de barras de más de 60 tipos</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/recognition-settings/'>Leer códigos de barras de imágenes</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-image-saving/'>Exportar códigos de barras en varios formatos de imagen</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Crear códigos de barras personalizados
                </h2>
                <p>
                    La biblioteca de códigos de barras para Android via Java permite a los desarrolladores personalizar algunos parámetros comunes de códigos de barras, incluido el tipo de código de barras, los datos que se codificarán, el tamaño del código de barras, el estilo y el color de la fuente y el ángulo de orientación. Para generar un código de barras, debe seleccionar el tipo de código de barras requerido para crear, como, por ejemplo, UPC o EAN. También debe ingresar los datos que se almacenarán en el código de barras, como un número de producto o una URL. Además, puede configurar el modo de tamaño requerido y ajustar el color de los elementos del código de barras, la resolución, el estilo del borde y otros parámetros relacionados con la apariencia. Es posible modificar el ancho de las barras y el espaciado entre ellas. Estos parámetros adicionales pueden afectar la legibilidad y la calidad de los códigos de barras, por lo que es importante comprender su propósito y cómo ajustarlos correctamente.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    La API del generador de códigos de barras puede crear códigos de barras especificando el tipo requerido, configurando el texto de entrada (datos que se codificarán en un código de barras) y personalizando las propiedades relacionadas con la apariencia, como el color de fondo y de primer plano, la fuente y las leyendas de texto. Los códigos de barras bidimensionales, como PDF417, Data Matrix, Aztec Code, QR Code y Micro QR Code se pueden generar de la misma manera que los tipos 1D.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Escáner y decodificador de código de barras
                </h2>
                <p>
                    La API de código de barras permite detectar y leer códigos de barras de más de 60 tipos 1D y 2D populares. Solo requiere unas pocas líneas de código para escanear códigos de barras, lo que facilita la integración de esta funcionalidad en sus aplicaciones. Esta potente función le permite escanear y leer códigos de barras de una amplia gama de fuentes, como imágenes, documentos, etc. Puede utilizarse para automatizar procesos, reducir el riesgo de errores y mejorar la eficiencia general de las operaciones. Ya sea que necesite desarrollar aplicaciones para comercio minorista, logística, atención médica o cualquier otro campo, esta API de código de barras puede proporcionar una solución para las tareas de detección y lectura de códigos de barras.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/pdf417/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/qr/" name="QR" description="QR Código, GS1 QR Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/datamatrix/" name="Data Matrix" description="Data Matrix código" >}}
...
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/codablock/" name="Codablock-F" description="Códigos de barras Codablock-F y GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/databar/" name="GS1 DataBar" description="Código de barras GS1 DataBar (omnidireccional, omnidireccional apilado, expandido, apilado expandido y truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/itf/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/ean/" name="EAN" description="EAN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/upc/" name="UPC" description="UPC código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/code128/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/code39/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/code16k/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/code32/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/code93/" name="Code 93" description="Códigos de barras Code 93 extendidos y Code 93 estándar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/onecode/" name="USPS OneCode" description="USPS OneCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/standard2of5/" name="Standard 2 of 5" description="Código de barras Standard 2 of 5 (Industrial 2 de 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/isbn/" name="ISBN" description="ISBN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/ismn/" name="ISMN" description="ISMN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/issn/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/australia-post/" name="Australia Post" description="Australia Post código de barras y Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode y Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/rm4scc/" name="RM4SCC" description="Código de cliente de 4 estados de Royal Mail (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/postnet/" name="Postnet" description="Postnet código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/royal-mail/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/singapore-post/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/android-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Documentación" href="https://docs.aspose.com/barcode/androidjava/" >}}
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-barcode/Android-Library-Usage-Examples" >}}
{{< blocks/products/pf/slr-element name="Referencias de API" href="https://reference.aspose.com/barcode/androidjava/" >}}
...
{{< blocks/products/pf/slr-element name="Notas de lanzamiento" href="https://releases.aspose.com/barcode/androidjava/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.BarCode para Android via Java?" tabId="success-stories" >}}
