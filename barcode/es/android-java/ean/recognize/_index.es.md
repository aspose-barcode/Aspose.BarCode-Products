...
{{% blocks/products/pf/agp/content h2="How to Read EAN código de barras Using Android via Java" %}}
Pruebe Aspose.BarCode para Android a través de Java para detectar y leer fácilmente EAN código de barras dentro de las aplicaciones de Android. Es una API de código de barras rica, escalable y fácil de usar diseñada para aplicaciones de Android. Obtenga Aspose.BarCode para Java directamente desde un proyecto basado en Maven agregando las siguientes configuraciones a build.gradle:
