...
{{< blocks/products/pf/upper-banner h1="API de código de barras de SSRS" h2="Genere códigos de barras lineales y 2D desde Microsoft SQL Server Reporting Services." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-reporting-services.svg" pfName="Aspose.BarCode" subTitlepfName="para SQL Reporting Services" downloadUrl="https://releases.aspose.com/barcode/reportingservices/" >}}
...
<p>Aspose.BarCode for Reporting Services es una solución integral para generar códigos de barras lineales y 2D dentro de Microsoft SQL Server Reporting Services. Las etiquetas de código de barras se pueden codificar con caracteres no ingleses y se pueden representar en formatos BMP, JPEG, GIF y PNG.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Independencia de la plataforma" description="Es compatible con los servicios de informes de Microsoft SQL Server." >}}
<div class='diagram1 d1-rs'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo admitidos" description="Aspose.BarCode para SQL Reporting Services funciona con los formatos de archivo de imagen más utilizados." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/dynamically-display-barcodes-in-table/'>Visualización dinámica de códigos de barras en tablas</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/display-barcodes-from-dataset/'>Mostrar códigos de barras de conjuntos de datos</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/barcode-types-and-image-formats/'>Guarde códigos de barras en formatos de imagen vectorial</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    Aspose.BarCode for Reporting Services se puede integrar fácilmente en proyectos nuevos o existentes agregando Aspose.BarCode for Reporting Services a Visual Studio Toolbox. Una vez que esté disponible en la Caja de herramientas, puede arrastrarlo y soltarlo en el proyecto donde lo desee.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Esta API de código de barras permite a los desarrolladores generar códigos de barras de alta calidad configurando el tipo de código de barras, los datos de entrada para codificar y las propiedades personalizadas relacionadas con la apariencia. Proporciona una variedad de opciones para ajustar la apariencia de los códigos de barras generados, incluidos los colores de fondo y de primer plano, la fuente, el tamaño, la resolución y las leyendas de texto.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Tamaño y color de código de barras personalizado
                </h2>
                <p>
                    Aspose.BarCode para la API de SQL Reporting Services proporciona una rica funcionalidad para generar imágenes de códigos de barras con parámetros personalizados. Los desarrolladores pueden crear aplicaciones para generar códigos de barras de cualquier color o tamaño según las necesidades comerciales. Es posible personalizar la apariencia de todos los elementos del código de barras, incluidos los colores de las barras, el fondo, los bordes y las leyendas de texto, así como su posición. El código de barras se puede generar con o sin mostrar el texto de entrada, la leyenda superior o inferior, los rellenos y los bordes. El tamaño del código de barras se puede configurar automáticamente según la dimensión X o manualmente. Se puede definir en varias unidades, como milímetros, pulgadas, puntos o píxeles. Si es necesario, se pueden modificar las proporciones y la resolución de la imagen. El tamaño de la fuente del texto también se puede personalizar.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Diseñador de código de barras para Visual Studio
                </h2>
                <p>
                    El diseño de las etiquetas de código de barras se puede modificar utilizando Barcode Designer para Visual Studio totalmente integrado. Los desarrolladores pueden obtener una vista previa y ajustar las imágenes de los códigos de barras en tiempo de diseño. El diseñador también permite personalizar varias configuraciones para ajustar la apariencia de las imágenes de códigos de barras.
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/pdf417/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/qr/" name="QR" description="QR Código, GS1 QR Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/datamatrix/" name="Data Matrix" description="Data Matrix código" >}}
...
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/codablock/" name="Codablock-F" description="Códigos de barras Codablock-F y GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/databar/" name="GS1 DataBar" description="Código de barras GS1 DataBar (omnidireccional, omnidireccional apilado, expandido, apilado expandido y truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/itf/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/ean/" name="EAN" description="EAN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/upc/" name="UPC" description="UPC código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/code128/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/code39/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/code16k/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/code32/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/code93/" name="Code 93" description="Códigos de barras Code 93 extendidos y Code 93 estándar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/onecode/" name="USPS OneCode" description="USPS OneCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/standard2of5/" name="Standard 2 of 5" description="Código de barras Standard 2 of 5 (Industrial 2 de 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/isbn/" name="ISBN" description="ISBN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/ismn/" name="ISMN" description="ISMN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/issn/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/australia-post/" name="Australia Post" description="Australia Post código de barras y Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode y Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/rm4scc/" name="RM4SCC" description="Código de cliente de 4 estados de Royal Mail (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/postnet/" name="Postnet" description="Postnet código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/royal-mail/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/singapore-post/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/reporting-services/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Documentación" href="https://docs.aspose.com/barcode/reportingservices/" >}}
...
{{< blocks/products/pf/slr-element name="Notas de lanzamiento" href="https://releases.aspose.com/barcode/reportingservices/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.BarCode para SQL Reporting Services?" tabId="success-stories" >}}
