---
title: Genere imágenes de Código de cliente de 4 estados de Royal Mail (RM4SCC) a ​​través de Python via Java
description: Código de muestra de Python para generar Código de cliente de 4 estados de Royal Mail (RM4SCC) usando Java Runtime Environment.
lang: es
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /es/python-java/rm4scc/generate/
aliases:
- /es/python-java/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genere etiquetas RM4SCC con Python via Java" h2="Cree Código de cliente de 4 estados de Royal Mail (RM4SCC) en Python usando Aspose.BarCode del lado del servidor para la API de Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Código de cliente de 4 estados de Royal Mail (RM4SCC) Using Python via Java" %}}
Para crear imágenes de Código de cliente de 4 estados de Royal Mail (RM4SCC), obtenga [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, una API rica en funciones, potente y fácil de usar. -Utilice la biblioteca de códigos de barras para aplicaciones basadas en Python. Obtenga la última versión directamente desde el portal [Aspose releases](https://releases.aspose.com/barcode/python-java/) o instale 'aspose-barcode' desde pip con el siguiente comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar Código de cliente de 4 estados de Royal Mail (RM4SCC) en Python" %}}
...
<ul><li>Cree un nuevo objeto de la clase BarCodeGenerator</li><li>Determine los tipos de código de barras deseados como el parámetro EncodeTypes</li><li>Inserte el texto de entrada como el segundo parámetro</li><li>Llame al método BarCodeGenerator.save para obtener la imagen Código de cliente de 4 estados de Royal Mail (RM4SCC) generada</li></ul>
...
<span class="hljs-keyword">class</span> <span class="hljs-title class_">BarcodeGeneratorExamples</span>():
    <span class="hljs-keyword">def</span> <span class="hljs-title function_">generateBarcodeImageExample</span>(<span class="hljs-params">self</span>):
        generator = Generation.BarcodeGenerator(Generation.EncodeTypes.<span class="barcode-gen-lcs-type-param">RM4SCC</span>, <span class="hljs-string">&quot;<span class="hljs-string barcode-gen-lcs-codetext-param"></span>&quot;</span>)
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/hibc/generate/" name="HIBC" description="HIBC (Código de barras de la industria de la salud)" >}}
</div>
