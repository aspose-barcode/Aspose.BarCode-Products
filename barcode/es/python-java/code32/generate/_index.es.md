...
{{% blocks/products/pf/agp/content h2="How to Generate Code 32 código de barras Using Python via Java" %}}
Para crear imágenes de Code 32 código de barras, obtenga [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, una API rica en funciones, potente y fácil de usar. -Utilice la biblioteca de códigos de barras para aplicaciones basadas en Python. Obtenga la última versión directamente desde el portal [Aspose releases](https://releases.aspose.com/barcode/python-java/) o instale 'aspose-barcode' desde pip con el siguiente comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar Code 32 código de barras en Python" %}}
...
<ul><li>Cree un nuevo objeto de la clase BarCodeGenerator</li><li>Determine los tipos de código de barras deseados como el parámetro EncodeTypes</li><li>Inserte el texto de entrada como el segundo parámetro</li><li>Llame al método BarCodeGenerator.save para obtener la imagen Código de barras italiano Pharmacode (Code 32) generada</li></ul>
...
<span class="hljs-keyword">class</span> <span class="hljs-title class_">BarcodeGeneratorExamples</span>():
    <span class="hljs-keyword">def</span> <span class="hljs-title function_">generateBarcodeImageExample</span>(<span class="hljs-params">self</span>):
        generator = Generation.BarcodeGenerator(Generation.EncodeTypes.<span class="barcode-gen-lcs-type-param">Code32</span>, <span class="hljs-string">&quot;<span class="hljs-string barcode-gen-lcs-codetext-param"></span>&quot;</span>)
