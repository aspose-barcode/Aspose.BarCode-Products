---
title: Genere imágenes de Deutsche Post Identcode y Deutsche Post Leitcode a ​​través de Python via Java
description: Código de muestra de Python para generar Deutsche Post Identcode y Deutsche Post Leitcode usando Java Runtime Environment.
lang: es
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /es/python-java/deutsche-post/generate/
aliases:
- /es/python-java/generate/deutsche-post/
- /es/python-java/generate/deutschepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genere etiquetas Deutsche Post con Python via Java" h2="Cree Deutsche Post Identcode y Deutsche Post Leitcode en Python usando Aspose.BarCode del lado del servidor para la API de Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Deutsche Post código de barras Using Python via Java" %}}
Para crear imágenes de Deutsche Post código de barras, obtenga [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, una API rica en funciones, potente y fácil de usar. -Utilice la biblioteca de códigos de barras para aplicaciones basadas en Python. Obtenga la última versión directamente desde el portal [Aspose releases](https://releases.aspose.com/barcode/python-java/) o instale 'aspose-barcode' desde pip con el siguiente comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar Deutsche Post código de barras en Python" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode facilita a los desarrolladores la creación de imágenes Deutsche Post código de barras con pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Cree un nuevo objeto de la clase BarCodeGenerator</li><li>Determine los tipos de código de barras deseados como el parámetro EncodeTypes</li><li>Inserte el texto de entrada como el segundo parámetro</li><li>Llame al método BarCodeGenerator.save para obtener la imagen Deutsche Post Identcode y Deutsche Post Leitcode generada</li></ul>
...
<span class="hljs-keyword">class</span> <span class="hljs-title class_">BarcodeGeneratorExamples</span>():
    <span class="hljs-keyword">def</span> <span class="hljs-title function_">generateBarcodeImageExample</span>(<span class="hljs-params">self</span>):
        generator = Generation.BarcodeGenerator(Generation.EncodeTypes.<span class="barcode-gen-lcs-type-param">DeutschePost</span>, <span class="hljs-string">&quot;<span class="hljs-string barcode-gen-lcs-codetext-param"></span>&quot;</span>)
