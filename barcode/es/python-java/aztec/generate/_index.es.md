...
{{% blocks/products/pf/agp/content h2="How to Generate Aztec Código Using Python via Java" %}}
Para crear imágenes de Aztec Código, obtenga [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, una API rica en funciones, potente y fácil de usar. -Utilice la biblioteca de códigos de barras para aplicaciones basadas en Python. Obtenga la última versión directamente desde el portal [Aspose releases](https://releases.aspose.com/barcode/python-java/) o instale 'aspose-barcode' desde pip con el siguiente comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar Aztec Código en Python" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode facilita a los desarrolladores la creación de imágenes Aztec Código con pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Cree un nuevo objeto de la clase BarCodeGenerator</li><li>Determine los tipos de código de barras deseados como el parámetro EncodeTypes</li><li>Inserte el texto de entrada como el segundo parámetro</li><li>Llame al método BarCodeGenerator.save para obtener la imagen Aztec Código generada</li></ul>
