---
title: Escanee imágenes de {{type.HIBC._name}} (Código de barras de la industria de la salud) a ​​través de Python via Java
weight: 1510
description: Código fuente de Python para el reconocimiento de {{type.HIBC._name}} (Código de barras de la industria de la salud) usando Java Runtime Environment.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer HIBC códigos de barras con Python via Java" h2="Lee {{type.HIBC._name}} (Código de barras de la industria de la salud) en Python usando Aspose.BarCode del lado del servidor para Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HIBC" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read {{type.HIBC._name}} (Código de barras de la industria de la salud) Using Python via Java" %}}
Para escanear y decodificar {{type.HIBC._name}} (Código de barras de la industria de la salud), instale [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, una API versátil, potente y fácil de usar. use la biblioteca de códigos de barras para aplicaciones basadas en Python. Obtenga la última versión directamente desde el portal [Aspose releases](https://releases.aspose.com/barcode/python-java/) o instale 'aspose-barcode' desde pip ejecutando el siguiente comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear {{type.HIBC._name}} (Código de barras de la industria de la salud) en Python" %}}
...
<ul><li>Cree un objeto de la clase Aspose.BarCode.BarCodeReader</li><li>Defina la ruta del archivo de origen que contiene {{type.HIBC._name}} (Código de barras de la industria de la salud) como parámetro</li><li>Determine los tipos de códigos de barras requeridos en DecodeType como segundo parámetro</li><li>Recorra los resultados de la decodificación</li><li>Obtenga el texto del código de barras usando la propiedad CodeText</li></ul>
...
<ul><li>Microsoft Windows, Linux o cualquier sistema operativo compatible con entornos de desarrollo basados ​​en Python</li><li>Java 8 o superior</li><li>Python 3.6 o superior</li><li> PHP/Java Bridge instalado</li><li>FastCGI y Tomcat Server 8.0 o superior</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/pdf417/recognize/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/qr/recognize/" name="QR" description="QR Código, GS1 QR Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix código" >}}
...
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/codablock/recognize/" name="Codablock-F" description="Códigos de barras Codablock-F y GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/databar/recognize/" name="GS1 DataBar" description="Código de barras GS1 DataBar (omnidireccional, omnidireccional apilado, expandido, apilado expandido y truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/itf/recognize/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/ean/recognize/" name="EAN" description="EAN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/upc/recognize/" name="UPC" description="UPC código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/code39/recognize/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/code16k/recognize/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/code32/recognize/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/code93/recognize/" name="Code 93" description="Códigos de barras Code 93 extendidos y Code 93 estándar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/standard2of5/recognize/" name="Standard 2 of 5" description="Código de barras Standard 2 of 5 (Industrial 2 de 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/isbn/recognize/" name="ISBN" description="ISBN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/ismn/recognize/" name="ISMN" description="ISMN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/issn/recognize/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/australia-post/recognize/" name="Australia Post" description="Australia Post código de barras y Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode y Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/rm4scc/recognize/" name="RM4SCC" description="Código de cliente de 4 estados de Royal Mail (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/postnet/recognize/" name="Postnet" description="Postnet código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/royal-mail/recognize/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/singapore-post/recognize/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
