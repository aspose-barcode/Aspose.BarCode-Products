...
description: Biblioteca de lectores de códigos de barras de Python para reconocer y generar múltiples tipos de códigos de barras, incluidos 1D, 2D y Postal. Utilice la API en las aplicaciones de Python.
weight: 440
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="Biblioteca de código de barras de Python" h2="Reconozca o genere códigos de barras 1D, 2D y postales en cualquier aplicación de Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-net.svg" pfName="Aspose.BarCode" subTitlepfName="para Python via .NET" downloadUrl="https://releases.aspose.com/barcode/python-net" >}}
...
<p>Aspose.BarCode para Python a través de NET es un conjunto de API de generación y lectura de códigos de barras para integrarse en las aplicaciones de Python. Los desarrolladores pueden agregar fácilmente la funcionalidad de generación y reconocimiento de códigos de barras. La API de código de barras de Python crea imágenes de código de barras en varios formatos, como PNG, JPG, GIF, BMP. Además, es compatible con múltiples funciones de imágenes, como la manipulación de bordes, el color, la rotación de imágenes, la personalización de la resolución y mucho más.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Independencia de la plataforma" description="Aspose.Barcode para Python a través de NET está disponible para Python 3.6 y superior." >}}
<div class='diagram1 d1-python'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo admitidos" description="Aspose.BarCode para Python via .NET funciona con los formatos de archivo de imagen más utilizados." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Funciones avanzadas de Python a través de la API de código de barras .NET
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/swiss-qr-code/'>Código QR suizo</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/manage-barcode-appearance/'>Personalizar la apariencia del código de barras</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/barcode-text-settings/'>Administrar la configuración de texto del código de barras</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/generate-1d-barcodes/'>Parámetros especiales de tipos de códigos de barras 1D</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/generate-qr-code/'>Generar Código QR y Micro Código QR</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/barcode-reading-presets/'>Opciones y ajustes preestablecidos de calidad de lectura de códigos de barras</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Personalizar parámetros de código de barras
                </h2>
                <p>
                    Aspose.BarCode para Python a través de .NET proporciona una gran funcionalidad para crear imágenes de códigos de barras personalizadas. Permite generar códigos de barras de cualquier color o tamaño según las necesidades del negocio. Es posible personalizar la apariencia de todos los elementos del código de barras, incluidos los colores de las barras, el fondo, los bordes y las leyendas de texto, así como su posición. El código de barras se puede generar con o sin mostrar el texto de entrada, la leyenda superior o inferior, los rellenos y los bordes. El tamaño del código de barras se puede configurar automáticamente según la dimensión X o manualmente. Se puede definir en varias unidades, como milímetros, pulgadas, puntos o píxeles. Si es necesario, se pueden ajustar las proporciones y la resolución de la imagen. La fuente del texto también se puede personalizar.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
            <div class="col-lg-12">
                ...
                <p>
                    La API tiene la capacidad de generar códigos de barras 2D de los tipos más populares, como Data Matrix, Aztec Code, PDF417, etc. Estos tipos permiten codificar valores de entrada grandes o no estándar. Aquí está el código para la generación de códigos QR.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Optimice la velocidad o la calidad de lectura de códigos de barras
                </h2>
                <p>
                    La biblioteca de códigos de barras proporciona una gama de potentes funciones para optimizar la lectura de códigos de barras para satisfacer las necesidades específicas de su empresa. Los desarrolladores pueden ajustar los parámetros del motor de reconocimiento para permitir un escaneo rápido de códigos de barras o mejorar la precisión de la lectura. Según la calidad y los parámetros de las imágenes de código de barras de origen, la biblioteca permite personalizar el proceso de reconocimiento. Incluye varias configuraciones preestablecidas de dichos parámetros, que se pueden usar para escanear rápidamente imágenes de códigos de barras de alta calidad o facilitar la decodificación de códigos de barras dañados o degradados. Además, hay configuraciones especiales que pueden mejorar la lectura de códigos de barras para diferentes tipos de distorsiones, como ruido gaussiano, puntos blancos y colores invertidos. Con la capacidad de ajustar el proceso de reconocimiento, la API se puede adaptar para proporcionar la lectura de códigos de barras más eficiente para una amplia gama de aplicaciones y escenarios.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/pdf417/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/qr/" name="QR" description="QR Código, GS1 QR Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/datamatrix/" name="Data Matrix" description="Data Matrix código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/aztec/" name="Aztec" description="Aztec Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/swiss-qr/" name="Swiss QR" description="Swiss QR factura" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/dotcode/" name="DotCode" description="DotCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/hibc/" name="HIBC" description="{{type.HIBC._name}} (Código de barras de la industria de la salud)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/codablock/" name="Codablock-F" description="Códigos de barras Codablock-F y GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/databar/" name="GS1 DataBar" description="Código de barras GS1 DataBar (omnidireccional, omnidireccional apilado, expandido, apilado expandido y truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/itf/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/ean/" name="EAN" description="EAN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/upc/" name="UPC" description="UPC código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/code128/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/code39/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/code16k/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/code32/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/code93/" name="Code 93" description="Códigos de barras Code 93 extendidos y Code 93 estándar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/onecode/" name="USPS OneCode" description="USPS OneCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/standard2of5/" name="Standard 2 of 5" description="Código de barras Standard 2 of 5 (Industrial 2 de 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/isbn/" name="ISBN" description="ISBN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/ismn/" name="ISMN" description="ISMN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/issn/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/australia-post/" name="Australia Post" description="Australia Post código de barras y Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode y Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/rm4scc/" name="RM4SCC" description="Código de cliente de 4 estados de Royal Mail (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/postnet/" name="Postnet" description="Postnet código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/royal-mail/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/singapore-post/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/python-net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Documentación" href="https://docs.aspose.com/barcode/python-net/" >}}
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Python-via-.NET" >}}
{{< blocks/products/pf/slr-element name="Referencias de API" href="https://docs.aspose.com/barcode/python-net/api-reference/" >}}
...
{{< blocks/products/pf/slr-element name="Notas de lanzamiento" href="https://docs.aspose.com/barcode/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.BarCode para Python via .NET?" tabId="success-stories" >}}
