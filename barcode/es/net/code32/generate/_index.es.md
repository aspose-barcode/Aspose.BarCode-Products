...
Para crear Code 32 código de barras, pruebe [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, una biblioteca de códigos de barras rica en funciones, potente y fácil de usar. para plataformas C#. Abra el administrador de paquetes [NuGet](https://www.nuget.org/packages/aspose.barcode), busque **Aspose.BarCode** e instale el paquete. También puede ejecutar el siguiente comando desde la consola del Administrador de paquetes:
...
<ul><li>Cree una instancia de la clase BarcodeGenerator</li><li>Pase Código de barras italiano Pharmacode (Code 32) como parámetro</li><li>Establezca el texto para codificar como segundo parámetro</li><li> Especifique las dimensiones del código de barras si es necesario</li><li>Llame al método BarcodeGenerator.Save para obtener la imagen Código de barras italiano Pharmacode (Code 32)</li></ul>
