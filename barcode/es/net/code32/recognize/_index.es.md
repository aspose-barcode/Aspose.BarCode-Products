---
title: Escanee imágenes de Código de barras italiano Pharmacode (Code 32) a ​​través de .NET
weight: 1510
description: Código de muestra de C# para escanear y decodificar el tipo de código de barras Código de barras italiano Pharmacode (Code 32) en .NET Framework, .NET Standard, COM Interloop para PHP, VBScript, Delphi o C++.
lang: es/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /es/net/code32/recognize/
aliases:
- /es/net/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer Code 32 códigos de barras con .NET" h2="Lee Código de barras italiano Pharmacode (Code 32) en C# usando Aspose.BarCode del lado del servidor para .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Para decodificar Code 32 código de barras, pruebe [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, una biblioteca de códigos de barras rica en funciones, potente y fácil de usar para plataformas C#. Utilice [NuGet](https://www.nuget.org/packages/aspose.barcode) y busque **Aspose.BarCode** para instalar el paquete. Como alternativa, ejecute el siguiente comando desde la consola del Administrador de paquetes:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear Code 32 código de barras en C#" %}}
...
<ul><li>Cree una nueva instancia de la clase Aspose.BarCode.BarCodeReader</li><li>Pase la ruta de la imagen de origen que contiene Code 32 código de barras como parámetro</li><li>Pase un DecodeType apropiado como el segundo parámetro</li><li>Recorra los resultados de la decodificación</li><li>Obtenga el texto del código de barras usando la propiedad CodeText</li></ul>
