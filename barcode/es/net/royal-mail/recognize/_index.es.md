---
title: Escanee imágenes de Royal Mail código de barras a ​​través de .NET
weight: 1510
description: Código de muestra de C# para escanear y decodificar el tipo de código de barras Royal Mail código de barras en .NET Framework, .NET Standard, COM Interloop para PHP, VBScript, Delphi o C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer Royal Mail códigos de barras con .NET" h2="Lee Royal Mail código de barras en C# usando Aspose.BarCode del lado del servidor para .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Royal Mail" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Royal Mail código de barras Using .NET" %}}
Para decodificar Royal Mail código de barras, pruebe [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, una biblioteca de códigos de barras rica en funciones, potente y fácil de usar para plataformas C#. Utilice [NuGet](https://www.nuget.org/packages/aspose.barcode) y busque **Aspose.BarCode** para instalar el paquete. Como alternativa, ejecute el siguiente comando desde la consola del Administrador de paquetes:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear Royal Mail código de barras en C#" %}}
...
<ul><li>Cree una nueva instancia de la clase Aspose.BarCode.BarCodeReader</li><li>Pase la ruta de la imagen de origen que contiene Royal Mail código de barras como parámetro</li><li>Pase un DecodeType apropiado como el segundo parámetro</li><li>Recorra los resultados de la decodificación</li><li>Obtenga el texto del código de barras usando la propiedad CodeText</li></ul>
