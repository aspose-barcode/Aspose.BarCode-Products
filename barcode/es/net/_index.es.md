---
title: C# .NET Barcode API - Leer generar y reconocer códigos de barras
description: Aspose.BarCode para las API de .NET para crear y reconocer códigos de barras 1D 2D. Integre dentro de las aplicaciones C# VB.NET ASP.NET para escanear e imprimir etiquetas de código de barras
weight: 440
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="API de lector y generador de código de barras" h2="Cree y reconozca códigos de barras de tipos lineales, 2D y postales dentro de cualquier aplicación .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" pfName="Aspose.BarCode" subTitlepfName="para .NET" downloadUrl="https://releases.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/carousel-item h3="Independencia de la plataforma" description="Puede usar la biblioteca para crear cualquier tipo de aplicación .NET de 32 o 64 bits, incluidos ASP.NET, WinForms, WPF, .NET Standard y más." >}}
<div class='diagram1 d1-net'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo admitidos" description="Aspose.BarCode para .NET funciona con los formatos de archivo de imagen más utilizados." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/saving-barcode-image/'>Guarde las etiquetas de código de barras en varios formatos</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/read-barcodes-with-aspose-barcode-apis/#setting-barcode-recognition-source'>Reconocer desde flujo o archivo</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/qr-and-micro-qr-barcode/#eciencoding-mode'>Codifica y decodifica caracteres (no ingleses) en tipos 2D</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/image-formatting-and-display-settings/'>Gire imágenes de códigos de barras en cualquier ángulo</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/how-to-read-barcode-from-multi-page-tiff-images/'>Escanee códigos de barras desde TIFF de varias páginas</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/net/barcode-types-and-image-formats/'>Compatibilidad con simbologías lineales, 2D y postales</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/pdf417/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/qr/" name="QR" description="QR Código, GS1 QR Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/datamatrix/" name="Data Matrix" description="Data Matrix código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/aztec/" name="Aztec" description="Aztec Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/swiss-qr/" name="Swiss QR" description="Swiss QR factura" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/dotcode/" name="DotCode" description="DotCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/hibc/" name="HIBC" description="{{type.HIBC._name}} (Código de barras de la industria de la salud)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/codablock/" name="Codablock-F" description="Códigos de barras Codablock-F y GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/databar/" name="GS1 DataBar" description="Código de barras GS1 DataBar (omnidireccional, omnidireccional apilado, expandido, apilado expandido y truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/itf/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/ean/" name="EAN" description="EAN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/upc/" name="UPC" description="UPC código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/code128/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/code39/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/code16k/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/code32/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/code93/" name="Code 93" description="Códigos de barras Code 93 extendidos y Code 93 estándar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/onecode/" name="USPS OneCode" description="USPS OneCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/standard2of5/" name="Standard 2 of 5" description="Código de barras Standard 2 of 5 (Industrial 2 de 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/isbn/" name="ISBN" description="ISBN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/ismn/" name="ISMN" description="ISMN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/issn/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/australia-post/" name="Australia Post" description="Australia Post código de barras y Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode y Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/rm4scc/" name="RM4SCC" description="Código de cliente de 4 estados de Royal Mail (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/postnet/" name="Postnet" description="Postnet código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/royal-mail/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/singapore-post/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Documentación" href="https://docs.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/slr-element name="Notas de lanzamiento" href="https://docs.aspose.com/barcode/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.BarCode para .NET?" tabId="success-stories" >}}
