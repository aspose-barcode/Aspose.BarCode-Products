...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear Código de cliente de 4 estados de Royal Mail (RM4SCC) en PHP" %}}
...
<ul><li>Cree un objeto de la clase Aspose.BarCode.BarCodeReader</li><li>Establezca la ruta de la imagen de origen que contiene Código de cliente de 4 estados de Royal Mail (RM4SCC) como parámetro</li><li>Especifique los tipos de códigos de barras de destino en DecodeType como segundo parámetro</li><li>Recorra los resultados de la lectura</li><li>Obtenga el texto del código de barras usando la propiedad CodeText</li></ul>
