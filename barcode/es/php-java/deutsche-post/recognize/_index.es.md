---
title: Escanee imágenes de Deutsche Post Identcode y Deutsche Post Leitcode a ​​través de PHP via Java
description: Código de muestra de PHP para leer Deutsche Post Identcode y Deutsche Post Leitcode en aplicaciones basadas en PHP.
lang: es
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /es/php-java/deutsche-post/recognize/
aliases:
- /es/php-java/recognize/deutsche-post/
- /es/php-java/recognize/deutschepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer Deutsche Post códigos de barras con PHP via Java" h2="Lee Deutsche Post Identcode y Deutsche Post Leitcode en PHP usando Aspose.BarCode del lado del servidor para PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear Deutsche Post código de barras en PHP" %}}
