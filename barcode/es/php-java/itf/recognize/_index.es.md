---
title: Escanee imágenes de Código de barras intercalado 2 de 5 (ITF) a ​​través de PHP via Java
description: Código de muestra de PHP para leer Código de barras intercalado 2 de 5 (ITF) en aplicaciones basadas en PHP.
lang: es
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /es/php-java/itf/recognize/
aliases:
- /es/php-java/recognize/itf/
- /es/php-java/recognize/datalogic2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer ITF códigos de barras con PHP via Java" h2="Lee Código de barras intercalado 2 de 5 (ITF) en PHP usando Aspose.BarCode del lado del servidor para PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear Código de barras intercalado 2 de 5 (ITF) en PHP" %}}
...
<ul><li>Cree un objeto de la clase Aspose.BarCode.BarCodeReader</li><li>Establezca la ruta de la imagen de origen que contiene Código de barras intercalado 2 de 5 (ITF) como parámetro</li><li>Especifique los tipos de códigos de barras de destino en DecodeType como segundo parámetro</li><li>Recorra los resultados de la lectura</li><li>Obtenga el texto del código de barras usando la propiedad CodeText</li></ul>
