---
title: Genere imágenes de Código de barras Standard 2 of 5 (Industrial 2 de 5) a ​​través de PHP via Java
description: Código fuente de PHP para crear Código de barras Standard 2 of 5 (Industrial 2 de 5) en aplicaciones basadas en PHP.
lang: es
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /es/php-java/standard2of5/generate/
aliases:
- /es/php-java/generate/standard2of5/
- /es/php-java/generate/iata2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genere etiquetas Standard 2 of 5 con PHP via Java" h2="Cree Código de barras Standard 2 of 5 (Industrial 2 de 5) en PHP usando Aspose.BarCode del lado del servidor para la API de PHP via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar Standard 2 of 5 código de barras en PHP" %}}
