...
{{< blocks/products/pf/upper-banner h1="Generador de código de barras PHP y API de lector" h2="Escanee o genere códigos de barras 1D, 2D y postales a partir de imágenes en cualquier aplicación web PHP." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" pfName="Aspose.BarCode" subTitlepfName="para PHP via Java" downloadUrl="https://releases.aspose.com/barcode/php/" >}}
...
{{< blocks/products/pf/carousel-item h3="Independencia de la plataforma" description="Aspose.Barcode para PHP a través de Java requiere PHP 5.3 (o superior) y JavaBridge. Puede ejecutarse en cualquier plataforma en la que se cumplan estos requisitos." >}}
<div class='diagram1 d1-php-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo admitidos" description="Aspose.BarCode para PHP via Java funciona con los formatos de archivo de imagen más utilizados." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/set-barcode-parameters/'>Administrar parámetros de código de barras</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/customize-barcodes/'>Personalizar el tamaño del código de barras</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/generate-codabar/'>Generar Codabar</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/set-barcode-text/'>Personalizar subtítulos de texto</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/barcode-reading-presets/'>Valores predeterminados de lectura de códigos de barras</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/read-damaged-barcodes/'>Leer códigos de barras dañados</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/pdf417/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/qr/" name="QR" description="QR Código, GS1 QR Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/datamatrix/" name="Data Matrix" description="Data Matrix código" >}}
...
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/codablock/" name="Codablock-F" description="Códigos de barras Codablock-F y GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/databar/" name="GS1 DataBar" description="Código de barras GS1 DataBar (omnidireccional, omnidireccional apilado, expandido, apilado expandido y truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/itf/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/ean/" name="EAN" description="EAN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/upc/" name="UPC" description="UPC código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/code128/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/code39/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/code16k/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/code32/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/code93/" name="Code 93" description="Códigos de barras Code 93 extendidos y Code 93 estándar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/onecode/" name="USPS OneCode" description="USPS OneCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/standard2of5/" name="Standard 2 of 5" description="Código de barras Standard 2 of 5 (Industrial 2 de 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/isbn/" name="ISBN" description="ISBN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/ismn/" name="ISMN" description="ISMN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/issn/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/australia-post/" name="Australia Post" description="Australia Post código de barras y Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode y Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/rm4scc/" name="RM4SCC" description="Código de cliente de 4 estados de Royal Mail (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/postnet/" name="Postnet" description="Postnet código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/royal-mail/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/singapore-post/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Documentación" href="https://docs.aspose.com/barcode/phpjava/" >}}
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-barcode/Aspose.BarCode-for-PHP-via-Java" >}}
{{< blocks/products/pf/slr-element name="Referencias de API" href="https://reference.aspose.com/barcode/php/" >}}
...
{{< blocks/products/pf/slr-element name="Notas de lanzamiento" href="https://releases.aspose.com/barcode/phpjava/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.BarCode para PHP via Java?" tabId="success-stories" >}}
