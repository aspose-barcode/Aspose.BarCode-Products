---
title: Escanee imágenes de ISMN código de barras a ​​través de PHP via Java
weight: 1510
description: Código de muestra de PHP para leer ISMN código de barras en aplicaciones basadas en PHP.
lang: es/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /es/php-java/ismn/recognize/
aliases:
- /es/php-java/recognize/ismn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer ISMN códigos de barras con PHP via Java" h2="Lee ISMN código de barras en PHP usando Aspose.BarCode del lado del servidor para PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear ISMN código de barras en PHP" %}}
