...
url: /es/php-java/qr/generate/
aliases:
- /es/php-java/generate/qr/
---
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar QR Código en PHP" %}}
