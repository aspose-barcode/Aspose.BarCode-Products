...
url: /es/php-java/qr/recognize/
aliases:
- /es/php-java/recognize/qr/
---
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear QR Código en PHP" %}}
