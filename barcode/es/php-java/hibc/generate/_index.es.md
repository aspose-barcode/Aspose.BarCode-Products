---
title: Genere imágenes de {{type.HIBC._name}} (Código de barras de la industria de la salud) a ​​través de PHP via Java
weight: 1510
description: Código fuente de PHP para crear {{type.HIBC._name}} (Código de barras de la industria de la salud) en aplicaciones basadas en PHP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genere etiquetas HIBC con PHP via Java" h2="Cree {{type.HIBC._name}} (Código de barras de la industria de la salud) en PHP usando Aspose.BarCode del lado del servidor para la API de PHP via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HIBC" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate {{type.HIBC._name}} (Código de barras de la industria de la salud) Using PHP via Java" %}}
Genere códigos de barras {{type.HIBC._name}} (Código de barras de la industria de la salud) personalizados dentro de aplicaciones PHP por medio de Aspose.BarCode para PHP a través de Java, una API de código de barras eficiente, escalable y fácil de usar diseñada para plataformas basadas en Java. Para iniciar la biblioteca de códigos de barras, descargue la última versión del portal [Aspose releases](https://releases.aspose.com/barcode/php/). De lo contrario, obtenga el paquete [aspose/barcode](https://packagist.org/packages/aspose/barcode) de Packagist y luego insértelo en sus proyectos PHP usando composer:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar {{type.HIBC._name}} (Código de barras de la industria de la salud) en PHP" %}}
...
<ul><li>Cree una nueva instancia de la clase BarCodeGenerator</li><li>Especifique {{type.HIBC._name}} (Código de barras de la industria de la salud) y otros tipos de código de barras relevantes como el parámetro EncodeTypes</li><li>Establezca el código de barras texto como segundo parámetro</li><li>Especifique las dimensiones y la ubicación de la imagen si es necesario</li><li>Llame al método BarCodeGenerator.save para obtener la imagen {{type.HIBC._name}} (Código de barras de la industria de la salud) en el formato requerido</li>< /ul>
...
<ul><li>Microsoft Windows, Linux o cualquier sistema operativo compatible con los entornos de desarrollo de PHP</li><li>PHP/Java Bridge instalado</li><li>FastCGI y Tomcat Server 8.0 o superior</li> </ul>
...
<span class="hljs-variable">$generator</span> = <span class="hljs-keyword">new</span> <span class="hljs-title class_">BarcodeGenerator</span>(<span class="hljs-title class_">EncodeTypes</span>::<span class="hljs-variable constant_"><span class="barcode-gen-lcs-type-param">HIBC</span></span>, <span class="hljs-string">&quot;<span class="hljs-string barcode-gen-lcs-codetext-param"></span>&quot;</span>);
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/pdf417/generate/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/qr/generate/" name="QR" description="QR Código, GS1 QR Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/datamatrix/generate/" name="Data Matrix" description="Data Matrix código" >}}
...
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/codablock/generate/" name="Codablock-F" description="Códigos de barras Codablock-F y GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/databar/generate/" name="GS1 DataBar" description="Código de barras GS1 DataBar (omnidireccional, omnidireccional apilado, expandido, apilado expandido y truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/itf/generate/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/ean/generate/" name="EAN" description="EAN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/upc/generate/" name="UPC" description="UPC código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/code128/generate/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/code39/generate/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/code16k/generate/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/code32/generate/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/code93/generate/" name="Code 93" description="Códigos de barras Code 93 extendidos y Code 93 estándar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/onecode/generate/" name="USPS OneCode" description="USPS OneCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/standard2of5/generate/" name="Standard 2 of 5" description="Código de barras Standard 2 of 5 (Industrial 2 de 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/isbn/generate/" name="ISBN" description="ISBN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/ismn/generate/" name="ISMN" description="ISMN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/issn/generate/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/australia-post/generate/" name="Australia Post" description="Australia Post código de barras y Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Identcode y Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/rm4scc/generate/" name="RM4SCC" description="Código de cliente de 4 estados de Royal Mail (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/postnet/generate/" name="Postnet" description="Postnet código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/royal-mail/generate/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/singapore-post/generate/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/php-java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
