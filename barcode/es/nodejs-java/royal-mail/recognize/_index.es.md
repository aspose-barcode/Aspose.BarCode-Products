---
title: Escanee imágenes de Royal Mail código de barras a ​​través de Node.js via Java
weight: 1510
description: Código fuente de Node.js para escanear y decodificar Royal Mail código de barras en aplicaciones JavaScript.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer Royal Mail códigos de barras con Node.js via Java" h2="Lee Royal Mail código de barras en JavaScript usando Aspose.BarCode del lado del servidor para Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Royal Mail" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Royal Mail código de barras Using Node.js via Java" %}}
Para reconocer Royal Mail código de barras dentro de las aplicaciones de Node.js, use Aspose.BarCode para Node.js a través de Java, una biblioteca de códigos de barras robusta, versátil y fácil de usar introducida para entornos basados ​​en Java. Puede cargar [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) para Javascript directamente desde NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear Royal Mail código de barras en JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode permite a los desarrolladores leer Royal Mail código de barras códigos de barras de secuencias o imágenes con pocas líneas de código

{{% /blocks/products/pf/agp/text %}}

<ul><li>Cree un objeto de la clase Aspose.BarCode.BarCodeReader</li><li>Pase la ruta del archivo de origen que contiene Royal Mail código de barras como parámetro</li><li>Establezca los tipos de códigos de barras de destino en DecodeType como segundo parámetro</li><li>Recorra todos los códigos de barras detectados</li><li>Obtenga el texto del código de barras resultante usando la propiedad CodeText</li></ul>
...
{{< blocks/products/pf/agp/demobox sectionTitle="Escanear Royal Mail código de barras" sectionDescription="[BarCode Reader App](https://products.aspose.app/barcode/recognize/royal-mail)" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Seleccione Royal Mail código de barras de la lista desplegable" >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text="Obtén al instante los datos decodificados de Royal Mail código de barras" >}}
