...
{{% blocks/products/pf/agp/content h2="How to Read Swiss QR factura Using Node.js via Java" %}}
Para reconocer Swiss QR factura dentro de las aplicaciones de Node.js, use Aspose.BarCode para Node.js a través de Java, una biblioteca de códigos de barras robusta, versátil y fácil de usar introducida para entornos basados ​​en Java. Puede cargar [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) para Javascript directamente desde NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear Swiss QR factura en JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode permite a los desarrolladores leer Swiss QR factura códigos de barras de secuencias o imágenes con pocas líneas de código

{{% /blocks/products/pf/agp/text %}}

<ul><li>Cree un objeto de la clase Aspose.BarCode.BarCodeReader</li><li>Pase la ruta del archivo de origen que contiene Swiss QR factura como parámetro</li><li>Establezca los tipos de códigos de barras de destino en DecodeType como segundo parámetro</li><li>Recorra todos los códigos de barras detectados</li><li>Obtenga el texto del código de barras resultante usando la propiedad CodeText</li></ul>
    ...
    <script>
        ...
        async function recognizeBarcodeAsync() {
            ...
            if (barcodetypeUrl === "") {
                ...
                barcodetypeUrl = barcodetypeUrl === "" ? "" : barcodetypeUrl;
            }
            let quality = 2;
...
{{< blocks/products/pf/agp/demobox sectionTitle="Escanear Swiss QR factura" sectionDescription="[BarCode Reader App](https://products.aspose.app/barcode/recognize/swiss-qr)" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Seleccione Swiss QR factura de la lista desplegable" >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text="Obtén al instante los datos decodificados de Swiss QR factura" >}}
