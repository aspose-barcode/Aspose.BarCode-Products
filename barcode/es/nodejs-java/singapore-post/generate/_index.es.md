---
title: Genere imágenes de Singapore Post código de barras a ​​través de Node.js via Java
description: Código de muestra de Node.js para la generación de Singapore Post código de barras en aplicaciones de JavaScript.
lang: es
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /es/nodejs-java/singapore-post/generate/
aliases:
- /es/nodejs-java/generate/singapore-post/
- /es/nodejs-java/generate/singaporepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genere etiquetas Singapore Post con Node.js via Java" h2="Cree Singapore Post código de barras en JavaScript usando Aspose.BarCode del lado del servidor para la API de Node.js via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar Singapore Post código de barras en JavaScript" %}}
