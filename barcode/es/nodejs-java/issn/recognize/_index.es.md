---
title: Escanee imágenes de ISSN código de barras a ​​través de Node.js via Java
weight: 1510
description: Código fuente de Node.js para escanear y decodificar ISSN código de barras en aplicaciones JavaScript.
lang: es/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /es/nodejs-java/issn/recognize/
aliases:
- /es/nodejs-java/recognize/issn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer ISSN códigos de barras con Node.js via Java" h2="Lee ISSN código de barras en JavaScript usando Aspose.BarCode del lado del servidor para Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISSN" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read ISSN código de barras Using Node.js via Java" %}}
Para reconocer ISSN código de barras dentro de las aplicaciones de Node.js, use Aspose.BarCode para Node.js a través de Java, una biblioteca de códigos de barras robusta, versátil y fácil de usar introducida para entornos basados ​​en Java. Puede cargar [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) para Javascript directamente desde NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear ISSN código de barras en JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode permite a los desarrolladores leer ISSN código de barras códigos de barras de secuencias o imágenes con pocas líneas de código

{{% /blocks/products/pf/agp/text %}}

<ul><li>Cree un objeto de la clase Aspose.BarCode.BarCodeReader</li><li>Pase la ruta del archivo de origen que contiene ISSN código de barras como parámetro</li><li>Establezca los tipos de códigos de barras de destino en DecodeType como segundo parámetro</li><li>Recorra todos los códigos de barras detectados</li><li>Obtenga el texto del código de barras resultante usando la propiedad CodeText</li></ul>
