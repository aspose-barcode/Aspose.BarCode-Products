---
title: Escanee imágenes de {{type.HIBC._name}} (Código de barras de la industria de la salud) a ​​través de Node.js via Java
weight: 1510
description: Código fuente de Node.js para escanear y decodificar {{type.HIBC._name}} (Código de barras de la industria de la salud) en aplicaciones JavaScript.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer HIBC códigos de barras con Node.js via Java" h2="Lee {{type.HIBC._name}} (Código de barras de la industria de la salud) en JavaScript usando Aspose.BarCode del lado del servidor para Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HIBC" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read {{type.HIBC._name}} (Código de barras de la industria de la salud) Using Node.js via Java" %}}
Para reconocer {{type.HIBC._name}} (Código de barras de la industria de la salud) dentro de las aplicaciones de Node.js, use Aspose.BarCode para Node.js a través de Java, una biblioteca de códigos de barras robusta, versátil y fácil de usar introducida para entornos basados ​​en Java. Puede cargar [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) para Javascript directamente desde NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para escanear {{type.HIBC._name}} (Código de barras de la industria de la salud) en JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode permite a los desarrolladores leer {{type.HIBC._name}} (Código de barras de la industria de la salud) códigos de barras de secuencias o imágenes con pocas líneas de código

{{% /blocks/products/pf/agp/text %}}

<ul><li>Cree un objeto de la clase Aspose.BarCode.BarCodeReader</li><li>Pase la ruta del archivo de origen que contiene {{type.HIBC._name}} (Código de barras de la industria de la salud) como parámetro</li><li>Establezca los tipos de códigos de barras de destino en DecodeType como segundo parámetro</li><li>Recorra todos los códigos de barras detectados</li><li>Obtenga el texto del código de barras resultante usando la propiedad CodeText</li></ul>
...
<ul><li>Microsoft Windows, Linux o cualquier sistema operativo compatible con Node.js</li><li>Node.js y Node.js/Java Bridge instalado</li><li>Oracle JDK versión 7 o superior </li></ul>
...
reader.<span class="hljs-title function_">readBarCodes</span>().<span class="hljs-title function_">forEach</span>(<span class="hljs-keyword">function</span> (<span class="hljs-params">result, i, results</span>)
{
    ...
    <script>
        ...
        async function recognizeBarcodeAsync() {
            ...
            let barcodetypeUrl = "HIBC";
            if (barcodetypeUrl === "") {
                barcodetypeUrl = button.siblings("select").val();
                barcodetypeUrl = barcodetypeUrl === "HIBC" ? "" : barcodetypeUrl;
            }
            let quality = 2;
...
{{< blocks/products/pf/agp/demobox sectionTitle="Escanear {{type.HIBC._name}} (Código de barras de la industria de la salud)" sectionDescription="[BarCode Reader App](https://products.aspose.app/barcode/recognize/hibc)" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="No es necesario descargar la API de Aspose" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="Simplemente inserte la ruta del archivo fuente" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Seleccione {{type.HIBC._name}} (Código de barras de la industria de la salud) de la lista desplegable" >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text="Obtén al instante los datos decodificados de {{type.HIBC._name}} (Código de barras de la industria de la salud)" >}}

{{% blocks/products/pf/agp/content h2="Acerca de Aspose.BarCode para Node.js via Java API" %}}

Aspose.BarCode es un generador de código de barras y una API de escáner. Puede escanear y crear fácilmente códigos de barras lineales, 2D y postales de varios tipos. Los desarrolladores pueden integrar su funcionalidad en cualquier aplicación de escaneo y generación de códigos de barras. Además, los códigos de barras generados se pueden guardar en varios formatos de imagen de alta calidad. Es una biblioteca independiente que no requiere la instalación de ningún software adicional.

{{< /blocks/products/pf/agp/demobox >}}

<!-- aboutfile Ends -->

{{< blocks/products/pf/agp/other-symbologies-section title="Other Supported Barcode Recognition Symbologies" subTitle="Using Node.js via Java, One can also read barcode of different symbologies including the following." >}}

<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">2D:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/pdf417/recognize/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/qr/recognize/" name="QR" description="QR Código, GS1 QR Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/datamatrix/recognize/" name="Data Matrix" description="Data Matrix código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/aztec/recognize/" name="Aztec" description="Aztec Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR factura" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/dotcode/recognize/" name="DotCode" description="DotCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/hibc/recognize/" name="HIBC" description="{{type.HIBC._name}} (Código de barras de la industria de la salud)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/codablock/recognize/" name="Codablock-F" description="Códigos de barras Codablock-F y GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/databar/recognize/" name="GS1 DataBar" description="Código de barras GS1 DataBar (omnidireccional, omnidireccional apilado, expandido, apilado expandido y truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/itf/recognize/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/ean/recognize/" name="EAN" description="EAN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/upc/recognize/" name="UPC" description="UPC código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/code39/recognize/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/code16k/recognize/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/code32/recognize/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/code93/recognize/" name="Code 93" description="Códigos de barras Code 93 extendidos y Code 93 estándar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/onecode/recognize/" name="USPS OneCode" description="USPS OneCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/standard2of5/recognize/" name="Standard 2 of 5" description="Código de barras Standard 2 of 5 (Industrial 2 de 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/isbn/recognize/" name="ISBN" description="ISBN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/ismn/recognize/" name="ISMN" description="ISMN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/issn/recognize/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/australia-post/recognize/" name="Australia Post" description="Australia Post código de barras y Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode y Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/rm4scc/recognize/" name="RM4SCC" description="Código de cliente de 4 estados de Royal Mail (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/postnet/recognize/" name="Postnet" description="Postnet código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/royal-mail/recognize/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/singapore-post/recognize/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/nodejs-java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
