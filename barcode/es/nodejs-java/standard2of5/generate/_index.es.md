---
title: Genere imágenes de Código de barras Standard 2 of 5 (Industrial 2 de 5) a ​​través de Node.js via Java
description: Código de muestra de Node.js para la generación de Código de barras Standard 2 of 5 (Industrial 2 de 5) en aplicaciones de JavaScript.
lang: es
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /es/nodejs-java/standard2of5/generate/
aliases:
- /es/nodejs-java/generate/standard2of5/
- /es/nodejs-java/generate/iata2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genere etiquetas Standard 2 of 5 con Node.js via Java" h2="Cree Código de barras Standard 2 of 5 (Industrial 2 de 5) en JavaScript usando Aspose.BarCode del lado del servidor para la API de Node.js via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar Standard 2 of 5 código de barras en JavaScript" %}}
