---
title: Genere imágenes de Código de barras intercalado 2 de 5 (ITF) a ​​través de Node.js via Java
description: Código de muestra de Node.js para la generación de Código de barras intercalado 2 de 5 (ITF) en aplicaciones de JavaScript.
lang: es
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar Código de barras intercalado 2 de 5 (ITF) en JavaScript" %}}
