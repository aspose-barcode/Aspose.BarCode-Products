---
title: API de código de barras de SharePoint - Insertar códigos de barras en listas de SharePoint
description: API de código de barras de SharePoint para insertar etiquetas de código de barras en listas de SharePoint personalizadas. Los desarrolladores pueden usar marcadores de servicio para seleccionar valores de texto de entrada o insertar el texto manualmente.
weight: 440
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="API de código de barras de SharePoint" h2="Aplicación Barcode SharePoint para agregar códigos de barras lineales, 2D y postales a las listas de Microsoft SharePoint." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="para SharePoint" downloadUrl="https://releases.aspose.com/barcode/sharepoint/" >}}
...
<p>Aspose.BarCode para SharePoint permite a los desarrolladores agregar una gran variedad de códigos de barras lineales, 2D y postales a las listas de Microsoft SharePoint Foundation 2010 y Microsoft Office SharePoint Server 2010 (MOSS). Puede crear y luego insertar códigos de barras en cualquier lista especificando el texto y el tipo de entrada.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Independencia de la plataforma" description="Aspose.BarCode para SharePoint es compatible con Microsoft SharePoint Foundation y SharePoint Server." >}}
<div class='diagram1 d1-sharepoint'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo admitidos" description="Aspose.BarCode para SharePoint funciona con los formatos de archivo de imagen más utilizados." >}}
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Agregar códigos de barras a las listas de Sharepoint
                </h2>
                <p>
                    Aspose.BarCode para SharePoint proporciona una rica funcionalidad para agregar códigos de barras a las listas de SharePoint. Estas listas se pueden utilizar para almacenar y organizar datos en un formato estructurado. Es una forma conveniente de administrar una amplia gama de información, como contactos, tareas, eventos del calendario y más. Proporcionan múltiples funciones para organizar, ordenar, filtrar y compartir datos. Puede ser útil agregar códigos de barras a las listas de SharePoint para facilitar el acceso y la administración de la información de la lista. Si se crea una lista de SharePoint para realizar un seguimiento de los elementos del inventario, los desarrolladores pueden agregar códigos de barras para escanear y actualizar la información de la lista de forma rápida y precisa. Esto podría facilitar el seguimiento y la gestión del inventario, así como reducir el riesgo de discrepancias. Los códigos de barras pueden servir para acceder y ver rápidamente información en una lista de SharePoint, por ejemplo, al escanear códigos de barras para mostrar rápidamente elementos o registros específicos en la lista.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    La biblioteca de códigos de barras es una poderosa herramienta que permite a los desarrolladores generar fácilmente códigos de barras especificando el tipo de código de barras de destino, insertando los datos de entrada para almacenar el código de barras y personalizando las propiedades relacionadas con la apariencia. La biblioteca proporciona una variedad de opciones para ajustar la apariencia de los códigos de barras generados, incluidas opciones para configurar los colores de fondo y de primer plano, la fuente, el tamaño, la resolución y las leyendas de texto.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    La biblioteca de códigos de barras proporciona varias opciones para guardar códigos de barras generados no solo utilizando formatos de imagen de trama populares, sino también para transmitir o vectorizar. Los códigos de barras se pueden descargar utilizando uno de los cinco formatos de imagen más utilizados o dos formatos vectoriales. También es posible cargar códigos de barras como archivos, secuencias o mapas de bits. Los desarrolladores pueden personalizar el proceso de generación y guardado de códigos de barras de acuerdo con las necesidades comerciales específicas configurando el modo de salida requerido. La API admite los siguientes formatos de archivo&colon; BMP, PNG, GIF, JPEG y TIFF para entrada/salida; EMF y SVG para salida.<br>Los desarrolladores pueden guardar códigos de barras como imágenes vectoriales, como archivos EMF y SVG, para escalarlos sin pérdidas de resolución.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
                ...
                <p>
                    Barcode API incluye varias funciones para detectar y leer una amplia gama de códigos de barras 1D y 2D populares. Estas funciones se pueden integrar fácilmente en sus aplicaciones con solo unas pocas líneas de código, lo que brinda una manera conveniente y eficiente de agregar capacidades de detección de códigos de barras a sus aplicaciones.
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/pdf417/" name="PDF417" description="PDF417 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/qr/" name="QR" description="QR Código, GS1 QR Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/datamatrix/" name="Data Matrix" description="Data Matrix código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/aztec/" name="Aztec" description="Aztec Código" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/swiss-qr/" name="Swiss QR" description="Swiss QR factura" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/dotcode/" name="DotCode" description="DotCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/hibc/" name="HIBC" description="{{type.HIBC._name}} (Código de barras de la industria de la salud)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/codablock/" name="Codablock-F" description="Códigos de barras Codablock-F y GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/databar/" name="GS1 DataBar" description="Código de barras GS1 DataBar (omnidireccional, omnidireccional apilado, expandido, apilado expandido y truncado)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/itf/" name="ITF" description="Código de barras intercalado 2 de 5 (ITF)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/ean/" name="EAN" description="EAN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/upc/" name="UPC" description="UPC código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/code128/" name="GS1 Code 128" description="GS1 Code 128 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/code39/" name="Code 39" description="Code 39 código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/code16k/" name="Code 16K" description="Code 16K código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/code32/" name="Code 32" description="Código de barras italiano Pharmacode (Code 32)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/code93/" name="Code 93" description="Códigos de barras Code 93 extendidos y Code 93 estándar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/onecode/" name="USPS OneCode" description="USPS OneCode código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/standard2of5/" name="Standard 2 of 5" description="Código de barras Standard 2 of 5 (Industrial 2 de 5)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/isbn/" name="ISBN" description="ISBN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/ismn/" name="ISMN" description="ISMN código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/issn/" name="ISSN" description="ISSN código de barras" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/australia-post/" name="Australia Post" description="Australia Post código de barras y Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode y Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/rm4scc/" name="RM4SCC" description="Código de cliente de 4 estados de Royal Mail (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/postnet/" name="Postnet" description="Postnet código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/royal-mail/" name="Royal Mail" description="Royal Mail código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/singapore-post/" name="Singapore Post" description="Singapore Post código de barras" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/es/sharepoint/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Documentación" href="https://docs.aspose.com/barcode/sharepoint/" >}}
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-barcode/Aspose.BarCode-for-.NET" >}}
{{< blocks/products/pf/slr-element name="Referencias de API" href="https://reference.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/slr-element name="Notas de lanzamiento" href="https://docs.aspose.com/barcode/sharepoint/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.BarCode para SharePoint?" tabId="success-stories" >}}
