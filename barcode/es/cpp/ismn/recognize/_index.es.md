...
{{% blocks/products/pf/agp/content h2="How to Read ISMN código de barras Using C++" %}}
Para escanear ISMN código de barras, pruebe la API [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/), una biblioteca de códigos de barras potente y fácil de usar con una gran funcionalidad para plataformas C++ . Puede descargar su última versión directamente&colon; simplemente abra el administrador de paquetes [NuGet](https://www.nuget.org/packages/aspose.barcode), busque **Aspose.BarCode.Cpp** e instale el paquete. Como alternativa, puede ejecutar el siguiente comando desde la consola del administrador de paquetes.
