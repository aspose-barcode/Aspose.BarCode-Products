---
title: Genere imágenes de Deutsche Post Identcode y Deutsche Post Leitcode a ​​través de C++
description: Ejemplo de código de C++ para generar Deutsche Post Identcode y Deutsche Post Leitcode en C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
lang: es/
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="How to Generate Deutsche Post código de barras Using C++" %}}
Para generar Deutsche Post código de barras, instale [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, una biblioteca de códigos de barras robusta y fácil de usar con una rica funcionalidad para plataformas C++ . Descargue la última versión directamente desde el administrador de paquetes [NuGet](https://www.nuget.org/packages/aspose.barcode)&colon; busque **Aspose.BarCode.Cpp** y luego instale el paquete. Alternativamente, abra la consola del Administrador de paquetes y ejecute el siguiente comando:
