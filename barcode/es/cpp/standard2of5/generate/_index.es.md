---
title: Genere imágenes de Código de barras Standard 2 of 5 (Industrial 2 de 5) a ​​través de C++
description: Ejemplo de código de C++ para generar Código de barras Standard 2 of 5 (Industrial 2 de 5) en C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
lang: es
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /es/cpp/standard2of5/generate/
aliases:
- /es/cpp/generate/standard2of5/
- /es/cpp/generate/iata2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genere etiquetas Standard 2 of 5 con C++" h2="Cree Código de barras Standard 2 of 5 (Industrial 2 de 5) en C++ usando Aspose.BarCode del lado del servidor para la API de C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Para generar Standard 2 of 5 código de barras, instale [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, una biblioteca de códigos de barras robusta y fácil de usar con una rica funcionalidad para plataformas C++ . Descargue la última versión directamente desde el administrador de paquetes [NuGet](https://www.nuget.org/packages/aspose.barcode)&colon; busque **Aspose.BarCode.Cpp** y luego instale el paquete. Alternativamente, abra la consola del Administrador de paquetes y ejecute el siguiente comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar Standard 2 of 5 código de barras en C++" %}}
...
<ul><li>Cree un objeto de la clase BarcodeGenerator</li><li>Pase Código de barras Standard 2 of 5 (Industrial 2 de 5) como parámetro</li><li>Inserte el texto de entrada para codificar como segundo parámetro</li><li>Defina las dimensiones de la imagen si es necesario</li><li>Llame al método BarcodeGenerator.Save para descargar el código de barras Código de barras Standard 2 of 5 (Industrial 2 de 5)</li></ul>
