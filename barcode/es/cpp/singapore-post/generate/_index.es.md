...
Para generar Singapore Post código de barras, instale [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, una biblioteca de códigos de barras robusta y fácil de usar con una rica funcionalidad para plataformas C++ . Descargue la última versión directamente desde el administrador de paquetes [NuGet](https://www.nuget.org/packages/aspose.barcode)&colon; busque **Aspose.BarCode.Cpp** y luego instale el paquete. Alternativamente, abra la consola del Administrador de paquetes y ejecute el siguiente comando:
...
<ul><li>Cree un objeto de la clase BarcodeGenerator</li><li>Pase Singapore Post código de barras como parámetro</li><li>Inserte el texto de entrada para codificar como segundo parámetro</li><li>Defina las dimensiones de la imagen si es necesario</li><li>Llame al método BarcodeGenerator.Save para descargar el código de barras Singapore Post código de barras</li></ul>
