---
title: Escanee imágenes de QR Código, GS1 QR Código a ​​través de C++
weight: 1510
description: Código de muestra de C++ para escanear y decodificar QR Código, GS1 QR Código en C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits o Linux de 64 bits.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leer QR códigos de barras con C++" h2="Lee QR Código, GS1 QR Código en C++ usando Aspose.BarCode del lado del servidor para C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read {{tipo.qr._nombre}} Código Using C++" %}}
Para escanear {{tipo.qr._nombre}} Código, pruebe la API [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/), una biblioteca de códigos de barras potente y fácil de usar con una gran funcionalidad para plataformas C++ . Puede descargar su última versión directamente&colon; simplemente abra el administrador de paquetes [NuGet](https://www.nuget.org/packages/aspose.barcode), busque **Aspose.BarCode.Cpp** e instale el paquete. Como alternativa, puede ejecutar el siguiente comando desde la consola del administrador de paquetes.
