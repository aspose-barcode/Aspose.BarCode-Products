---
title: Recognize POSTNET BarCode via Java 
weight: 50
url: /java/recognize/postnet/ 
description: Java sample code to read and decode postnet barcode on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read POSTNET Code via Java" h2="Build Java apps that can detect and recognize POSTNET & many other types of barcodes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POSTNET" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="BMP" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read POSTNET Barcode Using Java" %}}
 ...
 In order to recognize POSTNET barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize POSTNET Barcode via Java" %}}
...
1.  Set image path containing postnet code
...
{{% blocks/products/pf/agp/code-block title="Recognize POSTNET Barcodes - Java‎" offSpacer="" %}}

```cs
BarCodeReader reader = new BarCodeReader("barcode.png", DecodeType.POSTNET);

for(BarCodeResult result : reader.readBarCodes()){
    // recognize code text of type POSTNET
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode POSTNET via Free App" sectionDescription="[Recognize POSTNET](https://products.aspose.app/barcode/recognize/postnet) right now by visiting our Live Demos.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing POSTNET, it will be scanned instantly." >}}
