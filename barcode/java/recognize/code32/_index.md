---
title: Recognize CODE32 BarCode via Java 
weight: 1300
url: /java/recognize/code32/ 
description: Java sample code to read and decode code32 barcode on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read CODE32 Code via Java" h2="Build Java apps that can detect and recognize ITALIAN PHARMACODE (CODE 32) & many other types of barcodes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CODE_32" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="BMP" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read CODE32 Barcode Using Java" %}}

 In order to recognize ITALIAN PHARMACODE (CODE 32) barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize CODE32 Barcode via Java" %}}
...
1.  Set image path containing code32 code
...
{{% blocks/products/pf/agp/code-block title="Recognize CODE32 Barcodes - Java‎" offSpacer="" %}}

```cs
BarCodeReader reader = new BarCodeReader("barcode.png", DecodeType.CODE_32);

for(BarCodeResult result : reader.readBarCodes()){
    // recognize code text of type CODE_32
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode CODE_32 via Free App" sectionDescription="[Recognize CODE_32](https://products.aspose.app/barcode/recognize/code32) right now by visiting our Live Demos.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing CODE_32, it will be scanned instantly." >}}
