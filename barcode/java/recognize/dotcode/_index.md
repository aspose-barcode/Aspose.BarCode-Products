...
{{% blocks/products/pf/agp/content h2="How to Read DOTCODE Barcode Using Java" %}}
 ...
 In order to recognize DOTCODE barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize DOTCODE Barcode via Java" %}}
...
1.  Set image path containing dotcode code
...
{{% blocks/products/pf/agp/code-block title="Recognize DOTCODE Barcodes - Java‎" offSpacer="" %}}

```cs
BarCodeReader reader = new BarCodeReader("barcode.png", DecodeType.DOT_CODE);

for(BarCodeResult result : reader.readBarCodes()){
    // recognize code text of type DOT_CODE
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode DOT_CODE via Free App" sectionDescription="[Recognize DOT_CODE](https://products.aspose.app/barcode/recognize/dotcode) right now by visiting our Live Demos.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing DOT_CODE, it will be scanned instantly." >}}
