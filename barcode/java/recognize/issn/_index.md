---
title: Recognize ISSN BarCode via Java 
weight: 1230
url: /java/recognize/issn/ 
description: Java sample code to read and decode issn barcode on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read ISSN Code via Java" h2="Build Java apps that can detect and recognize ISSN & many other types of barcodes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISSN" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="BMP" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read ISSN Barcode Using Java" %}}
 ...
 In order to recognize ISSN barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize ISSN Barcode via Java" %}}
...
1.  Set image path containing issn code
...
{{% blocks/products/pf/agp/code-block title="Recognize ISSN Barcodes - Java‎" offSpacer="" %}}

```cs
BarCodeReader reader = new BarCodeReader("barcode.png", DecodeType.ISSN);

for(BarCodeResult result : reader.readBarCodes()){
    // recognize code text of type ISSN
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode ISSN via Free App" sectionDescription="[Recognize ISSN](https://products.aspose.app/barcode/recognize/issn) right now by visiting our Live Demos.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing ISSN, it will be scanned instantly." >}}
