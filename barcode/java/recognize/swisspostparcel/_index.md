---
title: Recognize SWISSPOSTPARCEL BarCode via Java 
weight: 700
url: /java/recognize/swisspostparcel/ 
description: Java sample code to read and decode swisspostparcel barcode on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read SWISSPOSTPARCEL Code via Java" h2="Build Java apps that can detect and recognize SWISS POST PARCEL & many other types of barcodes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWISS_POST_PARCEL" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="BMP" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read SWISSPOSTPARCEL Barcode Using Java" %}}

 In order to recognize SWISS POST PARCEL barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize SWISSPOSTPARCEL Barcode via Java" %}}
...
1.  Set image path containing swisspostparcel code
...
{{% blocks/products/pf/agp/code-block title="Recognize SWISSPOSTPARCEL Barcodes - Java‎" offSpacer="" %}}

```cs
BarCodeReader reader = new BarCodeReader("barcode.png", DecodeType.SWISS_POST_PARCEL);

for(BarCodeResult result : reader.readBarCodes()){
    // recognize code text of type SWISS_POST_PARCEL
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode SWISS_POST_PARCEL via Free App" sectionDescription="[Recognize SWISS_POST_PARCEL](https://products.aspose.app/barcode/recognize/swisspostparcel) right now by visiting our Live Demos.The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing SWISS_POST_PARCEL, it will be scanned instantly." >}}
