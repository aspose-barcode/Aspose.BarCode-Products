...
{{% blocks/products/pf/agp/content h2="How to Read DATAMATRIX Barcode Using Java" %}}
 ...
 In order to recognize Data Matrix, GS1 Data Matrix barcode , weвЂ™ll use
...
{{% blocks/products/pf/agp/code-block title="Recognize DATAMATRIXВ Barcodes - JavaвЂЋ" offSpacer="" %}}
