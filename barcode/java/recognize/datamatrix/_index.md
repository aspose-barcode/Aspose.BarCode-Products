---
title: Recognize DATAMATRIX BarCode via Java 
weight: 1080
url: /java/recognize/datamatrix/ 
description: Java sample code to read and decode datamatrix barcode on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read DATAMATRIX Code via Java" h2="Build Java apps that can detect and recognize Data Matrix, GS1 Data Matrix & many other types of barcodes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DATA_MATRIX" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="BMP" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read DATAMATRIX Barcode Using Java" %}}

 In order to recognize Data Matrix, GS1 Data Matrix barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize DATAMATRIX Barcode via Java" %}}
...
1.  Set image path containing datamatrix code
...
for(BarCodeResult result : reader.readBarCodes()){
    // recognize code text of type DATA_MATRIX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode DATA_MATRIX via Free App" sectionDescription="[Recognize DATA_MATRIX](https://products.aspose.app/barcode/recognize/datamatrix) right now by visiting our Live Demos.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing DATA_MATRIX, it will be scanned instantly." >}}
