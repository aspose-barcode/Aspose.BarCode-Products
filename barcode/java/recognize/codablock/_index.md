...
{{% blocks/products/pf/agp/content h2="How to Read CODABLOCK Barcode Using Java" %}}
 ...
 In order to recognize CodablockF, GS1 CodablockF barcode , weвЂ™ll use
...
{{% blocks/products/pf/agp/code-block title="Recognize CODABLOCKВ Barcodes - JavaвЂЋ" offSpacer="" %}}
