---
title: Recognize QR BarCode via Java 
weight: 560
url: /java/recognize/qr/ 
description: Java sample code to read and decode qr barcode on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read QR Code via Java" h2="Build Java apps that can detect and recognize QR Code, GS1 QR Code & many other types of barcodes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="BMP" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read QR Barcode Using Java" %}}

 In order to recognize QR Code, GS1 QR Code barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize QR Barcode via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Recognize QR Barcodes - Java‎" offSpacer="" %}}
