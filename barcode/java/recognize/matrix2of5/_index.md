---
title: Recognize MATRIX2OF5 BarCode via Java 
weight: 150
url: /java/recognize/matrix2of5/ 
description: Java sample code to read and decode matrix2of5 barcode on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read MATRIX2OF5 Code via Java" h2="Build Java apps that can detect and recognize MATRIX 2 OF 5 & many other types of barcodes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MATRIX_2_OF_5" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="BMP" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read MATRIX2OF5 Barcode Using Java" %}}

 In order to recognize MATRIX 2 OF 5 barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize MATRIX2OF5 Barcode via Java" %}}
...
1.  Set image path containing matrix2of5 code
...
{{% blocks/products/pf/agp/code-block title="Recognize MATRIX2OF5 Barcodes - Java‎" offSpacer="" %}}

```cs
BarCodeReader reader = new BarCodeReader("barcode.png", DecodeType.MATRIX_2_OF_5);

for(BarCodeResult result : reader.readBarCodes()){
    // recognize code text of type MATRIX_2_OF_5
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode MATRIX_2_OF_5 via Free App" sectionDescription="[Recognize MATRIX_2_OF_5](https://products.aspose.app/barcode/recognize/matrix2of5) right now by visiting our Live Demos.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing MATRIX_2_OF_5, it will be scanned instantly." >}}
