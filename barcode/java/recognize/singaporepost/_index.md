---
title: Recognize SINGAPOREPOST BarCode via Java 
weight: 1840
url: /java/recognize/singaporepost/ 
description: Java sample code to read and decode singaporepost barcode on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read SINGAPOREPOST Code via Java" h2="Build Java apps that can detect and recognize SINGAPORE POST & many other types of barcodes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ALL_SUPPORTED_TYPES" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="BMP" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read SINGAPOREPOST Barcode Using Java" %}}

 In order to recognize SINGAPORE POST barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize SINGAPOREPOST Barcode via Java" %}}
...
1.  Set image path containing singaporepost code
...
{{% blocks/products/pf/agp/code-block title="Recognize SINGAPOREPOST Barcodes - Java‎" offSpacer="" %}}

```cs
BarCodeReader reader = new BarCodeReader("barcode.png", DecodeType.ALL_SUPPORTED_TYPES);

for(BarCodeResult result : reader.readBarCodes()){
    // recognize code text of type ALL_SUPPORTED_TYPES
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode ALL_SUPPORTED_TYPES via Free App" sectionDescription="[Recognize ALL_SUPPORTED_TYPES](https://products.aspose.app/barcode/recognize/singaporepost) right now by visiting our Live Demos.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing ALL_SUPPORTED_TYPES, it will be scanned instantly." >}}
