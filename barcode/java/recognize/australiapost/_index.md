...
{{% blocks/products/pf/agp/content h2="How to Read AUSTRALIAPOST Barcode Using Java" %}}

 In order to recognize Australia Post, Australia Poste Parcel barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize AUSTRALIAPOST Barcode via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Recognize AUSTRALIAPOST Barcodes - Java‎" offSpacer="" %}}
