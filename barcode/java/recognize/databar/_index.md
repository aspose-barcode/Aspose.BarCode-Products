---
title: Recognize DATABAR BarCode via Java 
weight: 1000
url: /java/recognize/databar/ 
description: Java sample code to read and decode databar barcode on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read DATABAR Code via Java" h2="Build Java apps that can detect and recognize GS1 Databar Expanded, GS1 Databar Expanded Stacked, GS1 DataBar Expanded, GS1 Databar OmniDirectional, GS1 DataBar Stacked, GS1 Databar Stacked OmniDirectional, GS1 DataBar Truncated & many other types of barcodes from images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DATABAR_STACKED" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="BMP" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read DATABAR Barcode Using Java" %}}
 ...
 In order to recognize GS1 Databar Expanded, GS1 Databar Expanded Stacked, GS1 DataBar Expanded, GS1 Databar OmniDirectional, GS1 DataBar Stacked, GS1 Databar Stacked OmniDirectional, GS1 DataBar Truncated barcode , we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Recognize DATABAR Barcode via Java" %}}
...
1.  Set image path containing databar code
...
{{% blocks/products/pf/agp/code-block title="Recognize DATABAR Barcodes - Java‎" offSpacer="" %}}

```cs
BarCodeReader reader = new BarCodeReader("barcode.png", DecodeType.DATABAR_STACKED);

for(BarCodeResult result : reader.readBarCodes()){
    // recognize code text of type DATABAR_STACKED
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decode DATABAR_STACKED via Free App" sectionDescription="[Recognize DATABAR_STACKED](https://products.aspose.app/barcode/recognize/databar) right now by visiting our Live Demos.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing DATABAR_STACKED, it will be scanned instantly." >}}
