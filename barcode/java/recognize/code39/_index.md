...
{{% blocks/products/pf/agp/content h2="How to Read CODE39 Barcode Using Java" %}}
 ...
 In order to recognize Code 39 Extended, Code 39 Standard barcode , weвЂ™ll use
...
{{% blocks/products/pf/agp/code-block title="Recognize CODE39В Barcodes - JavaвЂЋ" offSpacer="" %}}
