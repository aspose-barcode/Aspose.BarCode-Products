---
title: Generate CODE93 BarCode Images via Java 
weight: 490
url: /java/generate/code93/ 
description: Java sample code for code93 barcode image generation on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate CODE93 Code via Java" h2="Barcode generation API for Java developers to create all 1D & 2D barcodes including Code 93 Extended, Code 93 Standard in image formats." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CODE_93_STANDARD" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="JPG" fileiconsmall3="TIFF" fileiconsmall4="PNG" fileiconsmall5="CODE_93_STANDARD" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate CODE93 Barcode Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate CODE_93_STANDARD Code via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Create CODE93 Barcodes - Java‎" offSpacer="" %}}

```cs
BarCodeGenerator generator = new BarCodeGenerator(EncodeTypes.CODE_93_STANDARD);
...
{{< blocks/products/pf/agp/demobox sectionTitle="CODE93 Barcode Generation Live Demos" sectionDescription="[Create CODE93](https://products.aspose.app/barcode/generate/code93) Barocdes right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Set the text, CODE93 symbology and image type." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get all the generated CODE93 type barcodes." >}}
