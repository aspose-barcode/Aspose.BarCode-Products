...
description: Java sample code for onecode barcode image generation on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate ONECODE Code via Java" h2="Barcode generation API for Java developers to create all 1D & 2D barcodes including USPS ONECODE in image formats." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ONE_CODE" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="JPG" fileiconsmall3="TIFF" fileiconsmall4="PNG" fileiconsmall5="ONE_CODE" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate ONE_CODE Code via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Create ONECODE Barcodes - Java‎" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="ONECODE Barcode Generation Live Demos" sectionDescription="[Create ONECODE](https://products.aspose.app/barcode/generate/onecode) Barocdes right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Set the text, ONECODE symbology and image type." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get all the generated ONECODE type barcodes." >}}
