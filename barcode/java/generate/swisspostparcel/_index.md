---
title: Generate SWISSPOSTPARCEL BarCode Images via Java 
weight: 1950
url: /java/generate/swisspostparcel/ 
description: Java sample code for swisspostparcel barcode image generation on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate SWISSPOSTPARCEL Code via Java" h2="Barcode generation API for Java developers to create all 1D & 2D barcodes including SWISS POST PARCEL in image formats." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWISS_POST_PARCEL" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="JPG" fileiconsmall3="TIFF" fileiconsmall4="PNG" fileiconsmall5="SWISS_POST_PARCEL" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate SWISSPOSTPARCEL Barcode Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate SWISS_POST_PARCEL Code via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Create SWISSPOSTPARCEL Barcodes - Java‎" offSpacer="" %}}

```cs
BarCodeGenerator generator = new BarCodeGenerator(EncodeTypes.SWISS_POST_PARCEL);
...
{{< blocks/products/pf/agp/demobox sectionTitle="SWISSPOSTPARCEL Barcode Generation Live Demos" sectionDescription="[Create SWISSPOSTPARCEL](https://products.aspose.app/barcode/generate/swisspostparcel) Barocdes right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Set the text, SWISSPOSTPARCEL symbology and image type." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get all the generated SWISSPOSTPARCEL type barcodes." >}}
