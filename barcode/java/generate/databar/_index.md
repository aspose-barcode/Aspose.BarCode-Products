...
{{% blocks/products/pf/agp/feature-section-col title="Steps to GenerateВ DATABAR_EXPANDED Code via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="CreateВ DATABARВ Barcodes - JavaвЂЋ" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="DATABARВ Barcode Generation Live Demos" sectionDescription="[Create DATABAR](https://products.aspose.app/barcode/generate/databar)В Barocdes right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="В SetВ the text, DATABAR symbology and image type." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get all theВ generated DATABAR type barcodes." >}}
