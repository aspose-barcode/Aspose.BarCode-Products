---
title: Render Gambar Barcode Linear & 2D di Layanan Pelaporan SQL Server
description: Ekstensi rendering Layanan Pelaporan SQL Server - Mengekspor gambar Barcode Linear dan 2D dalam SSRS. Render label kode batang dalam format BMP JPEG GIF dan PNG.
lang: id
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="API Kode Batang SSRS" h2="Hasilkan barcode Linear & 2D dari dalam Layanan Pelaporan Microsoft SQL Server." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-reporting-services.svg" pfName="Aspose.BarCode" subTitlepfName="untuk SQL Reporting Services" downloadUrl="https://releases.aspose.com/barcode/reportingservices/" >}}
...
<p>Aspose.BarCode untuk Layanan Pelaporan adalah solusi komprehensif untuk merender kode batang linier dan 2D dalam Layanan Pelaporan Microsoft SQL Server. Label kode batang dapat dikodekan dengan karakter Non-Inggris dan dirender dalam format BMP, JPEG, GIF, dan PNG.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Kemandirian Platform" description="Ini mendukung Layanan Pelaporan Microsoft SQL Server." >}}
<div class='diagram1 d1-rs'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
        ...
        <div class="d1-col d1-right">
            ...
            <ul><li>2002</li><li>2005</li><li>2008</li><li>2008 R2</li><li>2012</li><li>2017</li><li>li></ul>
        </div>
        <!--/right-->
    </div>
    <!--/row-->
...
{{< blocks/products/pf/carousel-item h3="Format File yang Didukung" description="Aspose.BarCode untuk SQL Reporting Services berfungsi dengan format file gambar yang paling umum digunakan." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/dynamically-display-barcodes-in-table/'>Secara dinamis menampilkan barcode dalam tabel</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/display-barcodes-from-dataset/'>Tampilkan kode batang dari kumpulan data</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/barcode-types-and-image-formats/'>Simpan barcode dalam format gambar vektor</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Integrasi dengan Layanan Pelaporan SQL Server
                </h2>
                <p>
                    Aspose.BarCode untuk Layanan Pelaporan dapat dengan mudah diintegrasikan ke dalam proyek yang sudah ada atau baru dengan menambahkan Aspose.BarCode untuk Layanan Pelaporan ke Visual Studio Toolbox. Setelah tersedia di Kotak Alat, Anda dapat menarik dan melepaskannya ke proyek di mana pun diinginkan.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Barcode API ini memungkinkan pengembang untuk menghasilkan barcode berkualitas tinggi dengan menyetel jenis barcode, input data yang akan dikodekan, dan properti terkait tampilan kustom. Ini menyediakan berbagai opsi untuk menyempurnakan tampilan kode batang yang dihasilkan, termasuk warna latar belakang dan latar depan, font, ukuran, resolusi, dan keterangan teks.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Ukuran dan Warna Barcode Kustom
                </h2>
                <p>
                    Aspose.BarCode untuk SQL Reporting Services API menyediakan fungsionalitas yang kaya untuk menghasilkan gambar kode batang dengan parameter khusus. Pengembang dapat membuat aplikasi untuk menghasilkan kode batang dengan warna atau ukuran apa pun tergantung pada kebutuhan bisnis. Dimungkinkan untuk menyesuaikan tampilan semua elemen kode batang, termasuk warna batang, latar belakang, batas, dan keterangan teks, serta pemosisiannya. Barcode dapat dibuat dengan atau tanpa menampilkan teks input, keterangan atas dan/atau bawah, bantalan, dan batas. Ukuran barcode dapat diatur secara otomatis tergantung pada dimensi X atau secara manual. Itu dapat didefinisikan dalam berbagai unit, seperti milimeter, inci, titik, atau piksel. Jika diperlukan, proporsi dan resolusi gambar dapat dimodifikasi. Ukuran font teks juga dapat disesuaikan.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Perancang Kode Batang untuk Visual Studio
                </h2>
                <p>
                    Tata letak label barcode dapat diubah dengan menggunakan Barcode Designer yang terintegrasi penuh untuk Visual Studio. Pengembang dapat mempratinjau dan menyesuaikan gambar kode batang pada waktu desain. Perancang juga memungkinkan menyesuaikan berbagai pengaturan untuk menyesuaikan tampilan gambar barcode.
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/pdf417/" name="PDF417" description="kode batang PDF417" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/qr/" name="QR" description="QR Kode, GS1 QR Kode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/datamatrix/" name="Data Matrix" description="kode Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/aztec/" name="Aztec" description="Aztec Kode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/swiss-qr/" name="Swiss QR" description="tagihan Swiss QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/dotcode/" name="DotCode" description="kode batang DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/hibc/" name="HIBC" description="HIBC (Kode Batang Industri Kesehatan)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/codablock/" name="Codablock-F" description="Kode batang Codablock-F dan GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/databar/" name="GS1 DataBar" description="Kode batang GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, dan Truncated)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/itf/" name="ITF" description="Kode batang 2-dari-5 (ITF) yang disisipkan" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/ean/" name="EAN" description="Kode batang EAN (Nomor Artikel Internasional)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/upc/" name="UPC" description="Kode batang UPC (Kode Produk Universal)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/code128/" name="GS1 Code 128" description="kode batang GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/code39/" name="Code 39" description="kode batang Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/code16k/" name="Code 16K" description="kode batang Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/code32/" name="Code 32" description="Kode batang Pharmacode Italia (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/code93/" name="Code 93" description="Code 93 Extended dan Code 93 Barcode standar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/onecode/" name="USPS OneCode" description="kode batang USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/standard2of5/" name="Standard 2 of 5" description="Kode batang Standard 2 of 5 (Industri 2 dari 5)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/isbn/" name="ISBN" description="kode batang ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/ismn/" name="ISMN" description="kode batang ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/issn/" name="ISSN" description="kode batang ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/australia-post/" name="Australia Post" description="Kode batang Australia Post dan eParcel Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/deutsche-post/" name="Deutsche Post" description="Deutsche Post Kode Ident dan Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/rm4scc/" name="RM4SCC" description="Kode Pelanggan Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/postnet/" name="Postnet" description="kode batang Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/royal-mail/" name="Royal Mail" description="kode batang Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/singapore-post/" name="Singapore Post" description="kode batang Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/reporting-services/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentasi" href="https://docs.aspose.com/barcode/reportingservices/" >}}
{{< blocks/products/pf/slr-element name="Kode sumber" href="https://github.com/aspose-barcode/Aspose.BarCode-for-.NET" >}}
{{< blocks/products/pf/slr-element name="Referensi API" href="https://reference.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/slr-element name="Catatan Rilis" href="https://docs.aspose.com/barcode/reportingservices/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Mengapa Aspose.BarCode untuk SQL Reporting Services?" tabId="success-stories" >}}
