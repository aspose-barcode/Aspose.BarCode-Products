---
title: Pindai Gambar Aztec Kode melalui Java
weight: 1510
description: Kode sumber Java untuk membaca dan mendekode Aztec Kode di Java Runtime Environment untuk Aplikasi JSP/JSF dan Aplikasi Desktop.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/java/aztec/recognize/
aliases:
- /id/java/recognize/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang Aztec dengan Java" h2="Baca Aztec Kode di Java menggunakan Aspose.BarCode sisi server untuk Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Buat objek baru kelas BarCodeReader</li><li>Setel jalur file sumber yang berisi Aztec Kode</li><li>Teruskan jenis kode batang yang diperlukan ke DecodeType sebagai parameter kedua</li><li>Loop melalui hasil decoding</li><li>Dapatkan teks barcode menggunakan metode getCodeText</li></ul>
