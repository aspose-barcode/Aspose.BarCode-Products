---
title: Hasilkan Gambar Aztec Kode melalui Java
description: Contoh kode Java untuk pembuatan Aztec Kode di Java Runtime Environment untuk aplikasi JSP/JSF dan aplikasi desktop.
lang: id
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /id/java/aztec/generate/
aliases:
- /id/java/generate/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label Aztec dengan Java" h2="Buat Aztec Kode di Java menggunakan Aspose.BarCode sisi server untuk API Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Buat objek baru kelas BarCodeGenerator</li><li>Tentukan Aztec Kode dan jenis kode batang lain yang diperlukan sebagai parameter EncodeTypes</li><li>Tentukan teks input menggunakan metode setCodeText</li><li>Gunakan metode BarCodeGenerator.save untuk menyimpan gambar barcode yang dihasilkan</li></ul>
