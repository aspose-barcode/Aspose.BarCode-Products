---
title: Hasilkan Gambar QR Kode, GS1 QR Kode melalui Java
description: Contoh kode Java untuk pembuatan QR Kode, GS1 QR Kode di Java Runtime Environment untuk aplikasi JSP/JSF dan aplikasi desktop.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/java/qr/generate/
aliases:
- /id/java/generate/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label QR dengan Java" h2="Buat QR Kode, GS1 QR Kode di Java menggunakan Aspose.BarCode sisi server untuk API Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Buat objek baru kelas BarCodeGenerator</li><li>Tentukan QR Kode dan jenis kode batang lain yang diperlukan sebagai parameter EncodeTypes</li><li>Tentukan teks input menggunakan metode setCodeText</li><li>Gunakan metode BarCodeGenerator.save untuk menyimpan gambar barcode yang dihasilkan</li></ul>
