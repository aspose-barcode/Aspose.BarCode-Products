---
title: Hasilkan Gambar kode batang ISMN melalui C++
description: Contoh kode C++ untuk menghasilkan kode batang ISMN di C++ Runtime Environment untuk Windows 32-bit, Windows 64-bit, dan Linux 64-bit.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/cpp/ismn/generate/
aliases:
- /id/cpp/generate/ismn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label ISMN dengan C++" h2="Buat kode batang ISMN di C++ menggunakan Aspose.BarCode sisi server untuk API C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Buat objek kelas BarcodeGenerator</li><li>Luluskan kode batang ISMN sebagai parameter</li><li>Masukkan teks input untuk dikodekan sebagai parameter kedua</li><li>Tentukan dimensi gambar jika diperlukan</li><li>Panggil metode BarcodeGenerator.Save untuk mengunduh kode batang kode batang ISMN</li></ul>
