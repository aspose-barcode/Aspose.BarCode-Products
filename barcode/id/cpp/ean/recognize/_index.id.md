---
title: Pindai Gambar Kode batang EAN (Nomor Artikel Internasional). melalui C++
weight: 1510
description: Contoh kode C++ untuk memindai dan mendekode Kode batang EAN (Nomor Artikel Internasional). di C++ Runtime Environment untuk Windows 32-bit, Windows 64-bit, atau Linux 64-bit.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/cpp/ean/recognize/
aliases:
- /id/cpp/recognize/ean/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang EAN dengan C++" h2="Baca Kode batang EAN (Nomor Artikel Internasional). di C++ menggunakan Aspose.BarCode sisi server untuk C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Kode batang EAN (Nomor Artikel Internasional). Using C++" %}}
Untuk memindai Kode batang EAN (Nomor Artikel Internasional)., coba [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, library barcode yang kuat dan mudah digunakan dengan fungsionalitas yang kaya untuk platform C++ . Anda dapat mengunduh versi terbarunya secara langsung&colon; cukup buka manajer paket [NuGet](https://www.nuget.org/packages/aspose.barcode), cari **Aspose.BarCode.Cpp**, dan instal paketnya. Sebagai alternatif, Anda dapat menjalankan perintah berikut dari Package Manager Console.
...
<ul><li>Membuat objek kelas Aspose.BarCode.BarCodeReader</li><li>Menentukan jalur gambar sumber yang berisi Kode batang EAN (Nomor Artikel Internasional). sebagai parameter</li><li>Meneruskan jenis kode batang yang diperlukan di DecodeType sebagai parameter kedua</li><li>Loop melalui hasil pengenalan</li><li>Muat teks kode batang yang didekodekan menggunakan properti CodeText</li></ul>
