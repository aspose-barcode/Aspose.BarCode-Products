---
title: Pindai Gambar Swiss Post Parcel melalui C++
weight: 1510
description: Contoh kode C++ untuk memindai dan mendekode Swiss Post Parcel di C++ Runtime Environment untuk Windows 32-bit, Windows 64-bit, atau Linux 64-bit.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/cpp/swiss-post-parcel/recognize/
aliases:
- /id/cpp/recognize/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang Swiss Post Parcel dengan C++" h2="Baca Swiss Post Parcel di C++ menggunakan Aspose.BarCode sisi server untuk C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Membuat objek kelas Aspose.BarCode.BarCodeReader</li><li>Menentukan jalur gambar sumber yang berisi Swiss Post Parcel sebagai parameter</li><li>Meneruskan jenis kode batang yang diperlukan di DecodeType sebagai parameter kedua</li><li>Loop melalui hasil pengenalan</li><li>Muat teks kode batang yang didekodekan menggunakan properti CodeText</li></ul>
