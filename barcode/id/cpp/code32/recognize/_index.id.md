---
title: Pindai Gambar Kode batang Pharmacode Italia (Code 32). melalui C++
weight: 1510
description: Contoh kode C++ untuk memindai dan mendekode Kode batang Pharmacode Italia (Code 32). di C++ Runtime Environment untuk Windows 32-bit, Windows 64-bit, atau Linux 64-bit.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/cpp/code32/recognize/
aliases:
- /id/cpp/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang Code 32 dengan C++" h2="Baca Kode batang Pharmacode Italia (Code 32). di C++ menggunakan Aspose.BarCode sisi server untuk C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Membuat objek kelas Aspose.BarCode.BarCodeReader</li><li>Menentukan jalur gambar sumber yang berisi kode batang Code 32 sebagai parameter</li><li>Meneruskan jenis kode batang yang diperlukan di DecodeType sebagai parameter kedua</li><li>Loop melalui hasil pengenalan</li><li>Muat teks kode batang yang didekodekan menggunakan properti CodeText</li></ul>
