---
title: Hasilkan Gambar Kode Pelanggan Royal Mail 4-State (RM4SCC) melalui C++
description: Contoh kode C++ untuk menghasilkan Kode Pelanggan Royal Mail 4-State (RM4SCC) di C++ Runtime Environment untuk Windows 32-bit, Windows 64-bit, dan Linux 64-bit.
lang: id
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /id/cpp/rm4scc/generate/
aliases:
- /id/cpp/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label RM4SCC dengan C++" h2="Buat Kode Pelanggan Royal Mail 4-State (RM4SCC) di C++ menggunakan Aspose.BarCode sisi server untuk API C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan Kode Pelanggan Royal Mail 4-State (RM4SCC) di C++" %}}
...
<ul><li>Buat objek kelas BarcodeGenerator</li><li>Luluskan Kode Pelanggan Royal Mail 4-State (RM4SCC) sebagai parameter</li><li>Masukkan teks input untuk dikodekan sebagai parameter kedua</li><li>Tentukan dimensi gambar jika diperlukan</li><li>Panggil metode BarcodeGenerator.Save untuk mengunduh kode batang Kode Pelanggan Royal Mail 4-State (RM4SCC)</li></ul>
