...
{{< blocks/products/pf/upper-banner h1="Hasilkan & Ekspor Kode Batang di JasperReports" h2="JasperReports & JasperServer API untuk Menghasilkan, Menampilkan, dan Mengekspor kode batang 1D, 2D, & Pos." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="untuk JasperReports" downloadUrl="https://releases.aspose.com/barcode/jasperreports/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.BarCode" subTitlepfName="untuk JasperReports" >}}
...
<p>Aspose.BarCode untuk JasperReports adalah ekstensi JasperReports dan JasperServer yang fleksibel untuk membuat dan menampilkan label kode batang di aplikasi Anda. Label kode batang ini dapat dirender dalam banyak format gambar populer.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Kemandirian Platform" description="Aspose.BarCode untuk JasperReports dapat digunakan dengan JasperServer dan JasperReports." >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
        ...
        <div class="d1-col d1-right">
            <header>
                ...
                JasperReports 2.0 atau lebih tinggi
            </header>
...
{{< blocks/products/pf/carousel-item h3="Format File yang Didukung" description="Aspose.BarCode untuk JasperReports berfungsi dengan format file gambar yang paling umum digunakan." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Advanced JasperReports ke Fitur Ekspor Barcode
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Menghasilkan dan mencetak laporan dengan barcode</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Tingkatkan alur kerja aplikasi dengan menambahkan fungsionalitas barcode</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Cantumkan kode batang dalam file untuk membantu ketertelusuran</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/barcode-image-basic-features/'>Kontrol ukuran kode, warna & teks kode</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/read-barcodes-with-aspose-barcode-apis/'>Pengakuan kode batang 2D terdistorsi dan diputar 3D</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/generate-barcode-by-specifying-custom-image-size/'>Buat gambar kode batang dengan ukuran tertentu</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    Aspose.BarCode untuk JasperReports menyediakan seperangkat alat khusus untuk bekerja dengan kode batang di JasperReports. Dengan menggunakan API ini, pengembang dapat memindai kode batang yang ditempatkan di laporan yang ada atau menambahkannya ke laporan baru. Pustaka kode batang ini dikodekan murni di Java dan disediakan sebagai dokumen JAR tunggal dan dapat dengan mudah diterapkan pada mesin dengan JasperReports atau JasperServer terpasang. Untuk menginstal ekstensi kode batang JasperReports, cukup salin dokumen JAR ke lokasi folder yang tepat dan mulailah bekerja.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Pustaka pembuat kode batang memungkinkan pengembang membuat kode batang dengan mudah dengan menentukan jenis kode batang, memasukkan data untuk dikodekan, dan menyetel properti terkait tampilan khusus. Ini mencakup berbagai opsi, seperti warna latar belakang dan latar depan, font, ukuran, resolusi, dan keterangan teks. API dapat menghasilkan kode batang 1D dan 2D, termasuk PDF417, Data Matrix, Aztec Code, QR Code, dan Micro QR Code, menggunakan pendekatan dasar yang sama. Ini menjadikannya alat yang nyaman dan mudah digunakan untuk menghasilkan berbagai jenis kode batang untuk berbagai aplikasi, termasuk JasperReports.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Masukkan Barcode ke dalam JasperReports
                </h2>
                <p>
                    JasperReports memungkinkan pengembang membuat laporan menggunakan data yang disimpan di berbagai sumber, seperti database, file CSV, dan dokumen XML. Ini menyediakan berbagai fitur untuk mendesain, memformat, dan mengekspor laporan, yang dapat dengan mudah diintegrasikan ke dalam aplikasi Java. Beberapa kegunaan umum JasperReports antara lain membuat faktur, kuitansi, laporan keuangan, dan jenis laporan bisnis lainnya. Mungkin berguna untuk memasukkan kode batang ke dalam JasperReports untuk memfasilitasi akses dan pengelolaan informasi dalam laporan. Misalnya, barcode dapat digunakan untuk memindai dan memperbarui informasi dalam JasperReport dengan cepat dan akurat, yaitu dengan memindai barcode pada faktur untuk mengambil dan menampilkan data terkait. Hal ini dapat mempermudah pelacakan dan pengelolaan informasi serta mengurangi risiko kesalahan atau ketidaksesuaian. Barcode juga dapat berfungsi untuk menampilkan item atau catatan tertentu dalam laporan.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/pdf417/" name="PDF417" description="kode batang PDF417" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/qr/" name="QR" description="QR Kode, GS1 QR Kode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/datamatrix/" name="Data Matrix" description="kode Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/aztec/" name="Aztec" description="Aztec Kode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/swiss-qr/" name="Swiss QR" description="tagihan Swiss QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/dotcode/" name="DotCode" description="kode batang DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/hibc/" name="HIBC" description="HIBC (Kode Batang Industri Kesehatan)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/codablock/" name="Codablock-F" description="Kode batang Codablock-F dan GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/databar/" name="GS1 DataBar" description="Kode batang GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, dan Truncated)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/itf/" name="ITF" description="Kode batang 2-dari-5 (ITF) yang disisipkan" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/ean/" name="EAN" description="Kode batang EAN (Nomor Artikel Internasional)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/upc/" name="UPC" description="Kode batang UPC (Kode Produk Universal)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/code128/" name="GS1 Code 128" description="kode batang GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/code39/" name="Code 39" description="kode batang Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/code16k/" name="Code 16K" description="kode batang Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/code32/" name="Code 32" description="Kode batang Pharmacode Italia (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/code93/" name="Code 93" description="Code 93 Extended dan Code 93 Barcode standar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/onecode/" name="USPS OneCode" description="kode batang USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/standard2of5/" name="Standard 2 of 5" description="Kode batang Standard 2 of 5 (Industri 2 dari 5)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/isbn/" name="ISBN" description="kode batang ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/ismn/" name="ISMN" description="kode batang ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/issn/" name="ISSN" description="kode batang ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/australia-post/" name="Australia Post" description="Kode batang Australia Post dan eParcel Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/deutsche-post/" name="Deutsche Post" description="Deutsche Post Kode Ident dan Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/rm4scc/" name="RM4SCC" description="Kode Pelanggan Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/postnet/" name="Postnet" description="kode batang Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/royal-mail/" name="Royal Mail" description="kode batang Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/singapore-post/" name="Singapore Post" description="kode batang Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/jasperreports/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentasi" href="https://docs.aspose.com/barcode/jasperreports/" >}}
{{< blocks/products/pf/slr-element name="Kode sumber" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="Referensi API" href="https://reference.aspose.com/barcode/java/" >}}
...
{{< blocks/products/pf/slr-element name="Catatan Rilis" href="https://docs.aspose.com/barcode/jasperreports/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Mengapa Aspose.BarCode untuk JasperReports?" tabId="success-stories" >}}
