---
title: Pindai Gambar kode batang USPS OneCode melalui Python via Java
weight: 1510
description: Kode sumber Python untuk pengenalan kode batang USPS OneCode menggunakan Java Runtime Environment.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/python-java/onecode/recognize/
aliases:
- /id/python-java/recognize/onecode/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang USPS OneCode dengan Python via Java" h2="Baca kode batang USPS OneCode di Python menggunakan Aspose.BarCode sisi server untuk Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="USPS OneCode" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Memindai Kode batang USPS OneCode di Python" %}}
...
<ul><li>Buat objek kelas Aspose.BarCode.BarCodeReader</li><li>Tentukan path file sumber yang berisi Kode batang USPS OneCode sebagai parameter</li><li>Tentukan jenis barcode yang diperlukan di DecodeType sebagai parameter kedua</li><li>Mengulangi hasil decoding</li><li>Dapatkan teks kode batang menggunakan properti CodeText</li></ul>
