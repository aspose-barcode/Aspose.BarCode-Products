---
title: Pindai Gambar Swiss Post Parcel melalui Python via Java
weight: 1510
description: Kode sumber Python untuk pengenalan Swiss Post Parcel menggunakan Java Runtime Environment.
lang: id
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /id/python-java/swiss-post-parcel/recognize/
aliases:
- /id/python-java/recognize/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang Swiss Post Parcel dengan Python via Java" h2="Baca Swiss Post Parcel di Python menggunakan Aspose.BarCode sisi server untuk Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Memindai Swiss Post Parcel di Python" %}}
...
<ul><li>Buat objek kelas Aspose.BarCode.BarCodeReader</li><li>Tentukan path file sumber yang berisi Swiss Post Parcel sebagai parameter</li><li>Tentukan jenis barcode yang diperlukan di DecodeType sebagai parameter kedua</li><li>Mengulangi hasil decoding</li><li>Dapatkan teks kode batang menggunakan properti CodeText</li></ul>
