---
title: Pindai Gambar kode batang GS1 Code 128 melalui Python via Java
weight: 1510
description: Kode sumber Python untuk pengenalan kode batang GS1 Code 128 menggunakan Java Runtime Environment.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/python-java/code128/recognize/
aliases:
- /id/python-java/recognize/code128/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang GS1 Code 128 dengan Python via Java" h2="Baca kode batang GS1 Code 128 di Python menggunakan Aspose.BarCode sisi server untuk Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Memindai kode batang GS1 Code 128 di Python" %}}
...
<ul><li>Buat objek kelas Aspose.BarCode.BarCodeReader</li><li>Tentukan path file sumber yang berisi kode batang GS1 Code 128 sebagai parameter</li><li>Tentukan jenis barcode yang diperlukan di DecodeType sebagai parameter kedua</li><li>Mengulangi hasil decoding</li><li>Dapatkan teks kode batang menggunakan properti CodeText</li></ul>
