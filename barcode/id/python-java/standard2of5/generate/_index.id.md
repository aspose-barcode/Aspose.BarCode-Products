---
title: Hasilkan Gambar Kode batang Standard 2 of 5 (Industri 2 dari 5). melalui Python via Java
description: Contoh kode Python untuk menghasilkan Kode batang Standard 2 of 5 (Industri 2 dari 5). menggunakan Java Runtime Environment.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/python-java/standard2of5/generate/
aliases:
- /id/python-java/generate/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label Standard 2 of 5 dengan Python via Java" h2="Buat Kode batang Standard 2 of 5 (Industri 2 dari 5). di Python menggunakan Aspose.BarCode sisi server untuk API Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate kode batang Standard 2 of 5 Using Python via Java" %}}
Untuk membuat gambar kode batang Standard 2 of 5, dapatkan API [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/), kaya fitur, andal, dan mudah digunakan -gunakan perpustakaan kode batang untuk aplikasi berbasis Python. Dapatkan versi terbaru langsung dari portal [Aspose releases](https://releases.aspose.com/barcode/python-java/) atau instal 'aspose-barcode' dari pip dengan perintah berikut:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan kode batang Standard 2 of 5 di Python" %}}
...
<ul><li>Buat objek baru kelas BarCodeGenerator</li><li>Tentukan jenis kode batang yang diinginkan sebagai parameter EncodeTypes</li><li>Masukkan input teks sebagai parameter kedua</li><li> Panggil metode BarCodeGenerator.save untuk mendapatkan gambar Kode batang Standard 2 of 5 (Industri 2 dari 5). yang dihasilkan</li></ul>
