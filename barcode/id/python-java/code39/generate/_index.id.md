---
title: Hasilkan Gambar kode batang Code 39 melalui Python via Java
description: Contoh kode Python untuk menghasilkan kode batang Code 39 menggunakan Java Runtime Environment.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/python-java/code39/generate/
aliases:
- /id/python-java/generate/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label Code 39 dengan Python via Java" h2="Buat kode batang Code 39 di Python menggunakan Aspose.BarCode sisi server untuk API Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate kode batang Code 39 Using Python via Java" %}}
Untuk membuat gambar kode batang Code 39, dapatkan API [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/), kaya fitur, andal, dan mudah digunakan -gunakan perpustakaan kode batang untuk aplikasi berbasis Python. Dapatkan versi terbaru langsung dari portal [Aspose releases](https://releases.aspose.com/barcode/python-java/) atau instal 'aspose-barcode' dari pip dengan perintah berikut:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan kode batang Code 39 di Python" %}}
...
<ul><li>Buat objek baru kelas BarCodeGenerator</li><li>Tentukan jenis kode batang yang diinginkan sebagai parameter EncodeTypes</li><li>Masukkan input teks sebagai parameter kedua</li><li> Panggil metode BarCodeGenerator.save untuk mendapatkan gambar kode batang Code 39 yang dihasilkan</li></ul>
