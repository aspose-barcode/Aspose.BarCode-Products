...
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang GS1 DataBar dengan .NET" h2="Baca Kode batang GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, dan Truncated) di C# menggunakan Aspose.BarCode sisi server untuk .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read kode batang GS1 DataBar Using .NET" %}}
Untuk mendekode kode batang GS1 DataBar, coba [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, library barcode yang kaya fitur, andal, dan mudah digunakan untuk platform C#. Gunakan [NuGet](https://www.nuget.org/packages/aspose.barcode) dan cari **Aspose.BarCode** untuk menginstal paket. Atau, jalankan perintah berikut dari konsol Package Manager:
