---
title: Hasilkan Gambar Code 93 Extended dan Code 93 Barcode standar melalui .NET
description: Kode sumber C# untuk pembuatan Code 93 Extended dan Code 93 Barcode standar dalam .NET Framework, .NET Standard, COM Interloop untuk PHP, VBScript, Delphi, dan C++.
lang: id
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /id/net/code93/generate/
aliases:
- /id/net/generate/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label Code 93 dengan .NET" h2="Buat Code 93 Extended dan Code 93 Barcode standar di C# menggunakan Aspose.BarCode sisi server untuk API .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate kode batang Code 93 Using .NET" %}}
Untuk membuat kode batang Code 93, coba [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, library barcode yang kaya fitur, andal, dan mudah digunakan untuk platform C#. Buka manajer paket [NuGet](https://www.nuget.org/packages/aspose.barcode), cari **Aspose.BarCode** dan instal paket. Anda juga dapat menjalankan perintah berikut dari konsol Package Manager:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan kode batang Code 93 di C#" %}}
...
<ul><li>Buat instance kelas BarcodeGenerator</li><li>Luluskan Code 93 Extended dan Code 93 Barcode standar sebagai parameter</li><li>Setel teks untuk dikodekan sebagai parameter kedua</li><li> Tentukan dimensi kode batang jika diperlukan</li><li>Panggil metode BarcodeGenerator.Save untuk mendapatkan gambar Code 93 Extended dan Code 93 Barcode standar</li></ul>
