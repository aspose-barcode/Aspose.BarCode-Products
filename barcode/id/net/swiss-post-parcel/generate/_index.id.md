---
title: Hasilkan Gambar Swiss Post Parcel melalui .NET
description: Kode sumber C# untuk pembuatan Swiss Post Parcel dalam .NET Framework, .NET Standard, COM Interloop untuk PHP, VBScript, Delphi, dan C++.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/net/swiss-post-parcel/generate/
aliases:
- /id/net/generate/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label Swiss Post Parcel dengan .NET" h2="Buat Swiss Post Parcel di C# menggunakan Aspose.BarCode sisi server untuk API .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Untuk membuat Swiss Post Parcel, coba [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, library barcode yang kaya fitur, andal, dan mudah digunakan untuk platform C#. Buka manajer paket [NuGet](https://www.nuget.org/packages/aspose.barcode), cari **Aspose.BarCode** dan instal paket. Anda juga dapat menjalankan perintah berikut dari konsol Package Manager:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan Swiss Post Parcel di C#" %}}
...
<ul><li>Buat instance kelas BarcodeGenerator</li><li>Luluskan Swiss Post Parcel sebagai parameter</li><li>Setel teks untuk dikodekan sebagai parameter kedua</li><li> Tentukan dimensi kode batang jika diperlukan</li><li>Panggil metode BarcodeGenerator.Save untuk mendapatkan gambar Swiss Post Parcel</li></ul>
