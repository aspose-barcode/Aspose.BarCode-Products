---
title: Pindai Gambar QR Kode, GS1 QR Kode melalui .NET
weight: 1510
description: Contoh kode C# untuk memindai dan mendekode jenis kode batang QR Kode, GS1 QR Kode dalam .NET Framework, .NET Standard, COM Interloop untuk PHP, VBScript, Delphi, atau C++.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/net/qr/recognize/
aliases:
- /id/net/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang QR dengan .NET" h2="Baca QR Kode, GS1 QR Kode di C# menggunakan Aspose.BarCode sisi server untuk .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read QR Kode Using .NET" %}}
Untuk mendekode QR Kode, coba [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, library barcode yang kaya fitur, andal, dan mudah digunakan untuk platform C#. Gunakan [NuGet](https://www.nuget.org/packages/aspose.barcode) dan cari **Aspose.BarCode** untuk menginstal paket. Atau, jalankan perintah berikut dari konsol Package Manager:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Memindai QR Kode di C#" %}}
...
<ul><li>Membuat instance baru kelas Aspose.BarCode.BarCodeReader</li><li>Meneruskan jalur gambar sumber yang berisi QR Kode sebagai parameter</li><li>Meneruskan DecodeType yang sesuai sebagai parameter kedua</li><li>Loop melalui hasil decoding</li><li>Dapatkan teks barcode menggunakan properti CodeText</li></ul>
