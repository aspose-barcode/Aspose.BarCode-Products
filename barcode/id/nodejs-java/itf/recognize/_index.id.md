---
title: Pindai Gambar Kode batang 2-dari-5 (ITF) yang disisipkan melalui Node.js via Java
weight: 1510
description: Kode sumber Node.js untuk pemindaian dan decoding Kode batang 2-dari-5 (ITF) yang disisipkan dalam aplikasi JavaScript.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/nodejs-java/itf/recognize/
aliases:
- /id/nodejs-java/recognize/itf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang ITF dengan Node.js via Java" h2="Baca Kode batang 2-dari-5 (ITF) yang disisipkan di JavaScript menggunakan Aspose.BarCode sisi server untuk Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Kode batang 2-dari-5 (ITF) yang disisipkan Using Node.js via Java" %}}
Untuk mengenali Kode batang 2-dari-5 (ITF) yang disisipkan dalam aplikasi Node.js, gunakan Aspose.BarCode untuk Node.js melalui Java, pustaka kode batang yang tangguh, serbaguna, dan mudah digunakan yang diperkenalkan untuk lingkungan berbasis Java. Anda dapat memuat [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) untuk Javascript langsung dari NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Memindai Kode batang 2-dari-5 (ITF) yang disisipkan di JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode memungkinkan pengembang membaca kode batang Kode batang 2-dari-5 (ITF) yang disisipkan dari aliran atau gambar dengan beberapa baris kode

{{% /blocks/products/pf/agp/text %}}

<ul><li>Buat objek kelas Aspose.BarCode.BarCodeReader</li><li>Lewati jalur file sumber yang berisi Kode batang 2-dari-5 (ITF) yang disisipkan sebagai parameter</li><li>Tetapkan jenis kode batang target di DecodeType sebagai parameter kedua</li><li>Ulangi semua kode batang yang terdeteksi</li><li>Ambil teks kode batang yang dihasilkan menggunakan properti CodeText</li></ul>
