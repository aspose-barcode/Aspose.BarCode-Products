---
title: Pindai Gambar kode batang ISMN melalui Node.js via Java
weight: 1510
description: Kode sumber Node.js untuk pemindaian dan decoding kode batang ISMN dalam aplikasi JavaScript.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/nodejs-java/ismn/recognize/
aliases:
- /id/nodejs-java/recognize/ismn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang ISMN dengan Node.js via Java" h2="Baca kode batang ISMN di JavaScript menggunakan Aspose.BarCode sisi server untuk Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Memindai kode batang ISMN di JavaScript" %}}
...
<ul><li>Buat objek kelas Aspose.BarCode.BarCodeReader</li><li>Lewati jalur file sumber yang berisi kode batang ISMN sebagai parameter</li><li>Tetapkan jenis kode batang target di DecodeType sebagai parameter kedua</li><li>Ulangi semua kode batang yang terdeteksi</li><li>Ambil teks kode batang yang dihasilkan menggunakan properti CodeText</li></ul>
