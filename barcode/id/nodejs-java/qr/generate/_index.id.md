---
title: Hasilkan Gambar QR Kode, GS1 QR Kode melalui Node.js via Java
description: Contoh kode Node.js untuk pembuatan QR Kode, GS1 QR Kode di aplikasi JavaScript.
lang: id
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /id/nodejs-java/qr/generate/
aliases:
- /id/nodejs-java/generate/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label QR dengan Node.js via Java" h2="Buat QR Kode, GS1 QR Kode di JavaScript menggunakan Aspose.BarCode sisi server untuk API Node.js via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan QR Kode di JavaScript" %}}
...
<ul><li>Buat instance kelas BarCodeGenerator</li><li>Tetapkan QR Kode sebagai parameter EncodeTypes</li><li>Tentukan teks yang akan dikodekan sebagai parameter kedua</li><li>Tentukan dimensi dan lokasi barcode jika diperlukan</li><li>Panggil metode BarCodeGenerator.save untuk mendapatkan gambar barcode yang dihasilkan</li></ul>
