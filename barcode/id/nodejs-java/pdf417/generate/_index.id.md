---
title: Hasilkan Gambar kode batang PDF417 melalui Node.js via Java
description: Contoh kode Node.js untuk pembuatan kode batang PDF417 di aplikasi JavaScript.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/nodejs-java/pdf417/generate/
aliases:
- /id/nodejs-java/generate/pdf417/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label PDF417 dengan Node.js via Java" h2="Buat kode batang PDF417 di JavaScript menggunakan Aspose.BarCode sisi server untuk API Node.js via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF417" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan kode batang PDF417 di JavaScript" %}}
...
<ul><li>Buat instance kelas BarCodeGenerator</li><li>Tetapkan kode batang PDF417 sebagai parameter EncodeTypes</li><li>Tentukan teks yang akan dikodekan sebagai parameter kedua</li><li>Tentukan dimensi dan lokasi barcode jika diperlukan</li><li>Panggil metode BarCodeGenerator.save untuk mendapatkan gambar barcode yang dihasilkan</li></ul>
