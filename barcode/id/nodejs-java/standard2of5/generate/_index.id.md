---
title: Hasilkan Gambar Kode batang Standard 2 of 5 (Industri 2 dari 5). melalui Node.js via Java
description: Contoh kode Node.js untuk pembuatan Kode batang Standard 2 of 5 (Industri 2 dari 5). di aplikasi JavaScript.
lang: id
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /id/nodejs-java/standard2of5/generate/
aliases:
- /id/nodejs-java/generate/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label Standard 2 of 5 dengan Node.js via Java" h2="Buat Kode batang Standard 2 of 5 (Industri 2 dari 5). di JavaScript menggunakan Aspose.BarCode sisi server untuk API Node.js via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan kode batang Standard 2 of 5 di JavaScript" %}}
...
<ul><li>Buat instance kelas BarCodeGenerator</li><li>Tetapkan kode batang Standard 2 of 5 sebagai parameter EncodeTypes</li><li>Tentukan teks yang akan dikodekan sebagai parameter kedua</li><li>Tentukan dimensi dan lokasi barcode jika diperlukan</li><li>Panggil metode BarCodeGenerator.save untuk mendapatkan gambar barcode yang dihasilkan</li></ul>
