---
title: Hasilkan Gambar Kode batang EAN (Nomor Artikel Internasional). melalui Node.js via Java
description: Contoh kode Node.js untuk pembuatan Kode batang EAN (Nomor Artikel Internasional). di aplikasi JavaScript.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/nodejs-java/ean/generate/
aliases:
- /id/nodejs-java/generate/ean/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label EAN dengan Node.js via Java" h2="Buat Kode batang EAN (Nomor Artikel Internasional). di JavaScript menggunakan Aspose.BarCode sisi server untuk API Node.js via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan Kode batang EAN (Nomor Artikel Internasional). di JavaScript" %}}
...
<ul><li>Buat instance kelas BarCodeGenerator</li><li>Tetapkan Kode batang EAN (Nomor Artikel Internasional). sebagai parameter EncodeTypes</li><li>Tentukan teks yang akan dikodekan sebagai parameter kedua</li><li>Tentukan dimensi dan lokasi barcode jika diperlukan</li><li>Panggil metode BarCodeGenerator.save untuk mendapatkan gambar barcode yang dihasilkan</li></ul>
