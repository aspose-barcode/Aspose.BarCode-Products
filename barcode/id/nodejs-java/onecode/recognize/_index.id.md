---
title: Pindai Gambar kode batang USPS OneCode melalui Node.js via Java
weight: 1510
description: Kode sumber Node.js untuk pemindaian dan decoding kode batang USPS OneCode dalam aplikasi JavaScript.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/nodejs-java/onecode/recognize/
aliases:
- /id/nodejs-java/recognize/onecode/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang USPS OneCode dengan Node.js via Java" h2="Baca kode batang USPS OneCode di JavaScript menggunakan Aspose.BarCode sisi server untuk Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="USPS OneCode" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Memindai Kode batang USPS OneCode di JavaScript" %}}
...
<ul><li>Buat objek kelas Aspose.BarCode.BarCodeReader</li><li>Lewati jalur file sumber yang berisi Kode batang USPS OneCode sebagai parameter</li><li>Tetapkan jenis kode batang target di DecodeType sebagai parameter kedua</li><li>Ulangi semua kode batang yang terdeteksi</li><li>Ambil teks kode batang yang dihasilkan menggunakan properti CodeText</li></ul>
