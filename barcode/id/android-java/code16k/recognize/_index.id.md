---
title: Pindai Gambar kode batang Code 16K melalui Android via Java
weight: 1510
description: Contoh kode Android untuk mengenali kode batang Code 16K di Lingkungan Waktu Proses Android.
lang: id
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /id/android-java/code16k/recognize/
aliases:
- /id/android-java/recognize/code16k/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang Code 16K dengan Android via Java" h2="Baca kode batang Code 16K di Java menggunakan Aspose.BarCode sisi server untuk Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read kode batang Code 16K Using Android via Java" %}}
Cobalah Aspose.BarCode untuk Android melalui Java untuk mendeteksi dan membaca kode batang Code 16K dalam aplikasi Android dengan mudah. Ini adalah API kode batang yang kaya, dapat diskalakan, dan ramah pengguna yang ditujukan untuk aplikasi Android. Dapatkan Aspose.BarCode untuk Java langsung dari proyek berbasis Maven dengan menambahkan konfigurasi berikut ke build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Memindai kode batang Code 16K di Java" %}}
...
<ul><li>Buat instance kelas BarCodeReader</li><li>Tentukan jalur gambar sumber yang berisi kode batang Code 16K</li><li>Tentukan jenis kode batang target di DecodeType sebagai parameter kedua</li><li>Ulangi hasil pengenalan</li><li>Muat teks yang didekode dengan menjalankan metode getCodeText</li></ul>
