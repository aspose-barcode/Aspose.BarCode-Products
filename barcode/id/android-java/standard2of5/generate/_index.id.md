---
title: Hasilkan Gambar Kode batang Standard 2 of 5 (Industri 2 dari 5). melalui Android via Java
description: Kode sumber Android untuk membuat Kode batang Standard 2 of 5 (Industri 2 dari 5). di Lingkungan Waktu Proses Android.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/android-java/standard2of5/generate/
aliases:
- /id/android-java/generate/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label Standard 2 of 5 dengan Android via Java" h2="Buat Kode batang Standard 2 of 5 (Industri 2 dari 5). di Java menggunakan Aspose.BarCode sisi server untuk API Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate kode batang Standard 2 of 5 Using Android via Java" %}}
Cobalah Aspose.BarCode untuk Android melalui Java untuk membuat kode batang Standard 2 of 5 dalam aplikasi Android dengan mudah. Ini adalah perpustakaan kode batang serbaguna, kuat, dan ramah pengguna yang dirancang khusus untuk aplikasi Android. Anda dapat dengan mudah Aspose.BarCode untuk Android melalui Java langsung dari proyek berbasis Maven dengan memasukkan konfigurasi berikut ke dalam build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan kode batang Standard 2 of 5 di Java" %}}
...
<ul><li>Membuat instance baru kelas BarCodeGenerator</li><li>Meneruskan jenis kode batang kode batang Standard 2 of 5 sebagai parameter EncodeTypes</li><li>Menentukan teks kode batang menggunakan metode setCodeText</li><li>Luncurkan metode generateBarCodeImage() untuk menyimpan gambar kode batang Kode batang Standard 2 of 5 (Industri 2 dari 5).</li></ul>
