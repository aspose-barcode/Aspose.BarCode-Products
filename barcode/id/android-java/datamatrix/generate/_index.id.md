---
title: Hasilkan Gambar kode Data Matrix melalui Android via Java
description: Kode sumber Android untuk membuat kode Data Matrix di Lingkungan Waktu Proses Android.
lang: id
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /id/android-java/datamatrix/generate/
aliases:
- /id/android-java/generate/datamatrix/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label Data Matrix dengan Android via Java" h2="Buat kode Data Matrix di Java menggunakan Aspose.BarCode sisi server untuk API Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Data Matrix" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate kode Data Matrix Using Android via Java" %}}
Cobalah Aspose.BarCode untuk Android melalui Java untuk membuat kode Data Matrix dalam aplikasi Android dengan mudah. Ini adalah perpustakaan kode batang serbaguna, kuat, dan ramah pengguna yang dirancang khusus untuk aplikasi Android. Anda dapat dengan mudah Aspose.BarCode untuk Android melalui Java langsung dari proyek berbasis Maven dengan memasukkan konfigurasi berikut ke dalam build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan kode Data Matrix di Java" %}}
...
<ul><li>Membuat instance baru kelas BarCodeGenerator</li><li>Meneruskan jenis kode batang kode Data Matrix sebagai parameter EncodeTypes</li><li>Menentukan teks kode batang menggunakan metode setCodeText</li><li>Luncurkan metode generateBarCodeImage() untuk menyimpan gambar kode batang kode Data Matrix</li></ul>
