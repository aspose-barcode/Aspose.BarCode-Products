---
title: Hasilkan Gambar Deutsche Post Kode Ident dan Deutsche Post Leitcode melalui Android via Java
description: Kode sumber Android untuk membuat Deutsche Post Kode Ident dan Deutsche Post Leitcode di Lingkungan Waktu Proses Android.
lang: id
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /id/android-java/deutsche-post/generate/
aliases:
- /id/android-java/generate/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label Deutsche Post dengan Android via Java" h2="Buat Deutsche Post Kode Ident dan Deutsche Post Leitcode di Java menggunakan Aspose.BarCode sisi server untuk API Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate kode batang Deutsche Post Using Android via Java" %}}
Cobalah Aspose.BarCode untuk Android melalui Java untuk membuat kode batang Deutsche Post dalam aplikasi Android dengan mudah. Ini adalah perpustakaan kode batang serbaguna, kuat, dan ramah pengguna yang dirancang khusus untuk aplikasi Android. Anda dapat dengan mudah Aspose.BarCode untuk Android melalui Java langsung dari proyek berbasis Maven dengan memasukkan konfigurasi berikut ke dalam build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan kode batang Deutsche Post di Java" %}}
...
<ul><li>Membuat instance baru kelas BarCodeGenerator</li><li>Meneruskan jenis kode batang kode batang Deutsche Post sebagai parameter EncodeTypes</li><li>Menentukan teks kode batang menggunakan metode setCodeText</li><li>Luncurkan metode generateBarCodeImage() untuk menyimpan gambar kode batang Deutsche Post Kode Ident dan Deutsche Post Leitcode</li></ul>
