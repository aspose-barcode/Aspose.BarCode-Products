---
title: Pindai Gambar Kode Pelanggan Royal Mail 4-State (RM4SCC) melalui Android via Java
weight: 1510
description: Contoh kode Android untuk mengenali Kode Pelanggan Royal Mail 4-State (RM4SCC) di Lingkungan Waktu Proses Android.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/android-java/rm4scc/recognize/
aliases:
- /id/android-java/recognize/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang RM4SCC dengan Android via Java" h2="Baca Kode Pelanggan Royal Mail 4-State (RM4SCC) di Java menggunakan Aspose.BarCode sisi server untuk Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Kode Pelanggan Royal Mail 4-State (RM4SCC) Using Android via Java" %}}
Cobalah Aspose.BarCode untuk Android melalui Java untuk mendeteksi dan membaca Kode Pelanggan Royal Mail 4-State (RM4SCC) dalam aplikasi Android dengan mudah. Ini adalah API kode batang yang kaya, dapat diskalakan, dan ramah pengguna yang ditujukan untuk aplikasi Android. Dapatkan Aspose.BarCode untuk Java langsung dari proyek berbasis Maven dengan menambahkan konfigurasi berikut ke build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Memindai Kode Pelanggan Royal Mail 4-State (RM4SCC) di Java" %}}
...
<ul><li>Buat instance kelas BarCodeReader</li><li>Tentukan jalur gambar sumber yang berisi Kode Pelanggan Royal Mail 4-State (RM4SCC)</li><li>Tentukan jenis kode batang target di DecodeType sebagai parameter kedua</li><li>Ulangi hasil pengenalan</li><li>Muat teks yang didekode dengan menjalankan metode getCodeText</li></ul>
