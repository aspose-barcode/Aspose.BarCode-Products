---
title: Hasilkan Gambar Kode batang Standard 2 of 5 (Industri 2 dari 5). melalui PHP via Java
description: Kode sumber PHP untuk membuat Kode batang Standard 2 of 5 (Industri 2 dari 5). dalam aplikasi berbasis PHP.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/php-java/standard2of5/generate/
aliases:
- /id/php-java/generate/standard2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label Standard 2 of 5 dengan PHP via Java" h2="Buat Kode batang Standard 2 of 5 (Industri 2 dari 5). di PHP menggunakan Aspose.BarCode sisi server untuk API PHP via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate kode batang Standard 2 of 5 Using PHP via Java" %}}
Hasilkan kode batang kode batang Standard 2 of 5 yang disesuaikan dalam aplikasi PHP melalui Aspose.BarCode untuk PHP melalui Java, API kode batang yang efisien, dapat diskalakan, dan mudah digunakan yang ditujukan untuk platform berbasis Java. Untuk meluncurkan library barcode, download versi terbaru dari portal [Rilis Aspose](https://releases.aspose.com/barcode/php/). Jika tidak, dapatkan paket [aspose/barcode](https://packagist.org/packages/aspose/barcode) dari Packagist lalu sematkan ke proyek PHP Anda menggunakan komposer:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan kode batang Standard 2 of 5 di PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode memudahkan pengembang untuk membuat gambar kode batang Standard 2 of 5 dengan beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Buat instance baru kelas BarCodeGenerator</li><li>Tentukan kode batang Standard 2 of 5 dan jenis kode batang lain yang relevan sebagai parameter EncodeTypes</li><li>Tetapkan teks kode batang sebagai parameter kedua</li><li>Tentukan dimensi dan lokasi gambar jika diperlukan</li><li>Panggil metode BarCodeGenerator.save untuk mendapatkan gambar Kode batang Standard 2 of 5 (Industri 2 dari 5). dalam format yang diperlukan</li></ul>
