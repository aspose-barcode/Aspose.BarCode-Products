---
title: Pindai Gambar Deutsche Post Kode Ident dan Deutsche Post Leitcode melalui PHP via Java
weight: 1510
description: Contoh kode PHP untuk membaca Deutsche Post Kode Ident dan Deutsche Post Leitcode di aplikasi berbasis PHP.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/php-java/deutsche-post/recognize/
aliases:
- /id/php-java/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang Deutsche Post dengan PHP via Java" h2="Baca Deutsche Post Kode Ident dan Deutsche Post Leitcode di PHP menggunakan Aspose.BarCode sisi server untuk PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read kode batang Deutsche Post Using PHP via Java" %}}
Baca kode batang kode batang Deutsche Post dalam aplikasi PHP menggunakan Aspose.BarCode untuk PHP melalui Java, perpustakaan kode batang yang kuat, kaya, dan mudah digunakan yang ditujukan untuk platform berbasis Java. Untuk mencoba API barcode, Anda perlu mendapatkan versi terbaru dari portal [Rilis Aspose](https://releases.aspose.com/barcode/php/). Anda juga dapat menemukan paket [aspose/barcode](https://packagist.org/packages/aspose/barcode) di Packagist dan kemudian mengintegrasikannya ke dalam proyek PHP Anda melalui komposer:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Memindai kode batang Deutsche Post di PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode memungkinkan pengembang membaca kode batang kode batang Deutsche Post dari aliran atau gambar dengan beberapa baris kode

{{% /blocks/products/pf/agp/text %}}

<ul><li>Buat objek kelas Aspose.BarCode.BarCodeReader</li><li>Setel jalur gambar sumber yang berisi kode batang Deutsche Post sebagai parameter</li><li>Tentukan jenis kode batang target di DecodeType sebagai parameter kedua</li><li>Loop melalui hasil pembacaan</li><li>Dapatkan teks barcode menggunakan properti CodeText</li></ul>
...
<ul><li>Microsoft Windows, Linux, atau OS apa pun yang kompatibel dengan lingkungan pengembangan berbasis PHP</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/pdf417/recognize/" name="PDF417" description="kode batang PDF417" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/qr/recognize/" name="QR" description="QR Kode, GS1 QR Kode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/datamatrix/recognize/" name="Data Matrix" description="kode Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/aztec/recognize/" name="Aztec" description="Aztec Kode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/swiss-qr/recognize/" name="Swiss QR" description="tagihan Swiss QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/dotcode/recognize/" name="DotCode" description="kode batang DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/hibc/recognize/" name="HIBC" description="HIBC (Kode Batang Industri Kesehatan)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/codablock/recognize/" name="Codablock-F" description="Kode batang Codablock-F dan GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/databar/recognize/" name="GS1 DataBar" description="Kode batang GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, dan Truncated)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/itf/recognize/" name="ITF" description="Kode batang 2-dari-5 (ITF) yang disisipkan" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/ean/recognize/" name="EAN" description="Kode batang EAN (Nomor Artikel Internasional)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/upc/recognize/" name="UPC" description="Kode batang UPC (Kode Produk Universal)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/code128/recognize/" name="GS1 Code 128" description="kode batang GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/code39/recognize/" name="Code 39" description="kode batang Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/code16k/recognize/" name="Code 16K" description="kode batang Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/code32/recognize/" name="Code 32" description="Kode batang Pharmacode Italia (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/code93/recognize/" name="Code 93" description="Code 93 Extended dan Code 93 Barcode standar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/onecode/recognize/" name="USPS OneCode" description="kode batang USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/standard2of5/recognize/" name="Standard 2 of 5" description="Kode batang Standard 2 of 5 (Industri 2 dari 5)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/isbn/recognize/" name="ISBN" description="kode batang ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/ismn/recognize/" name="ISMN" description="kode batang ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/issn/recognize/" name="ISSN" description="kode batang ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/australia-post/recognize/" name="Australia Post" description="Kode batang Australia Post dan eParcel Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Kode Ident dan Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/rm4scc/recognize/" name="RM4SCC" description="Kode Pelanggan Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/postnet/recognize/" name="Postnet" description="kode batang Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/royal-mail/recognize/" name="Royal Mail" description="kode batang Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/singapore-post/recognize/" name="Singapore Post" description="kode batang Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
