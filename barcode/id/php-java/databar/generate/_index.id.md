---
title: Hasilkan Gambar Kode batang GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, dan Truncated) melalui PHP via Java
description: Kode sumber PHP untuk membuat Kode batang GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, dan Truncated) dalam aplikasi berbasis PHP.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/php-java/databar/generate/
aliases:
- /id/php-java/generate/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label GS1 DataBar dengan PHP via Java" h2="Buat Kode batang GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, dan Truncated) di PHP menggunakan Aspose.BarCode sisi server untuk API PHP via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate kode batang GS1 DataBar Using PHP via Java" %}}
Hasilkan kode batang kode batang GS1 DataBar yang disesuaikan dalam aplikasi PHP melalui Aspose.BarCode untuk PHP melalui Java, API kode batang yang efisien, dapat diskalakan, dan mudah digunakan yang ditujukan untuk platform berbasis Java. Untuk meluncurkan library barcode, download versi terbaru dari portal [Rilis Aspose](https://releases.aspose.com/barcode/php/). Jika tidak, dapatkan paket [aspose/barcode](https://packagist.org/packages/aspose/barcode) dari Packagist lalu sematkan ke proyek PHP Anda menggunakan komposer:
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan kode batang GS1 DataBar di PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode memudahkan pengembang untuk membuat gambar kode batang GS1 DataBar dengan beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Buat instance baru kelas BarCodeGenerator</li><li>Tentukan kode batang GS1 DataBar dan jenis kode batang lain yang relevan sebagai parameter EncodeTypes</li><li>Tetapkan teks kode batang sebagai parameter kedua</li><li>Tentukan dimensi dan lokasi gambar jika diperlukan</li><li>Panggil metode BarCodeGenerator.save untuk mendapatkan gambar Kode batang GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, dan Truncated) dalam format yang diperlukan</li></ul>
...
Aspose Barcode API didukung oleh semua platform utama dan sistem operasi. Sebelum menjalankan contoh kode di bawah ini, periksa apakah Anda telah mengaktifkan prasyarat berikut di sistem Anda.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Microsoft Windows, Linux, atau OS apa pun yang kompatibel dengan lingkungan pengembangan PHP</li><li>PHP/Java Bridge terinstal</li><li>FastCGI dan Tomcat Server 8.0 atau lebih tinggi</li> </ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/pdf417/generate/" name="PDF417" description="kode batang PDF417" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/qr/generate/" name="QR" description="QR Kode, GS1 QR Kode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/datamatrix/generate/" name="Data Matrix" description="kode Data Matrix" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/aztec/generate/" name="Aztec" description="Aztec Kode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/swiss-qr/generate/" name="Swiss QR" description="tagihan Swiss QR" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/dotcode/generate/" name="DotCode" description="kode batang DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/hibc/generate/" name="HIBC" description="HIBC (Kode Batang Industri Kesehatan)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/codablock/generate/" name="Codablock-F" description="Kode batang Codablock-F dan GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/databar/generate/" name="GS1 DataBar" description="Kode batang GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, dan Truncated)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/itf/generate/" name="ITF" description="Kode batang 2-dari-5 (ITF) yang disisipkan" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/ean/generate/" name="EAN" description="Kode batang EAN (Nomor Artikel Internasional)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/upc/generate/" name="UPC" description="Kode batang UPC (Kode Produk Universal)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/code128/generate/" name="GS1 Code 128" description="kode batang GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/code39/generate/" name="Code 39" description="kode batang Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/code16k/generate/" name="Code 16K" description="kode batang Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/code32/generate/" name="Code 32" description="Kode batang Pharmacode Italia (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/code93/generate/" name="Code 93" description="Code 93 Extended dan Code 93 Barcode standar" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/onecode/generate/" name="USPS OneCode" description="kode batang USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/standard2of5/generate/" name="Standard 2 of 5" description="Kode batang Standard 2 of 5 (Industri 2 dari 5)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/isbn/generate/" name="ISBN" description="kode batang ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/ismn/generate/" name="ISMN" description="kode batang ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/issn/generate/" name="ISSN" description="kode batang ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/australia-post/generate/" name="Australia Post" description="Kode batang Australia Post dan eParcel Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Kode Ident dan Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/rm4scc/generate/" name="RM4SCC" description="Kode Pelanggan Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/postnet/generate/" name="Postnet" description="kode batang Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/royal-mail/generate/" name="Royal Mail" description="kode batang Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/singapore-post/generate/" name="Singapore Post" description="kode batang Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/id/php-java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
