...
{{< blocks/products/pf/upper-banner h1="Hasilkan Label Australia Post dengan PHP via Java" h2="Buat Kode batang Australia Post dan eParcel Australia Post di PHP menggunakan Aspose.BarCode sisi server untuk API PHP via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan kode batang Australia Post di PHP" %}}
...
<ul><li>Buat instance baru kelas BarCodeGenerator</li><li>Tentukan kode batang Australia Post dan jenis kode batang lain yang relevan sebagai parameter EncodeTypes</li><li>Tetapkan teks kode batang sebagai parameter kedua</li><li>Tentukan dimensi dan lokasi gambar jika diperlukan</li><li>Panggil metode BarCodeGenerator.save untuk mendapatkan gambar Kode batang Australia Post dan eParcel Australia Post dalam format yang diperlukan</li></ul>
