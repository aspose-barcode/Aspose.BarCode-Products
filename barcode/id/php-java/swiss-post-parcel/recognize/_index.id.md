---
title: Pindai Gambar Swiss Post Parcel melalui PHP via Java
weight: 1510
description: Contoh kode PHP untuk membaca Swiss Post Parcel di aplikasi berbasis PHP.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/php-java/swiss-post-parcel/recognize/
aliases:
- /id/php-java/recognize/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang Swiss Post Parcel dengan PHP via Java" h2="Baca Swiss Post Parcel di PHP menggunakan Aspose.BarCode sisi server untuk PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Memindai Swiss Post Parcel di PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode memungkinkan pengembang membaca kode batang Swiss Post Parcel dari aliran atau gambar dengan beberapa baris kode

{{% /blocks/products/pf/agp/text %}}

<ul><li>Buat objek kelas Aspose.BarCode.BarCodeReader</li><li>Setel jalur gambar sumber yang berisi Swiss Post Parcel sebagai parameter</li><li>Tentukan jenis kode batang target di DecodeType sebagai parameter kedua</li><li>Loop melalui hasil pembacaan</li><li>Dapatkan teks barcode menggunakan properti CodeText</li></ul>
