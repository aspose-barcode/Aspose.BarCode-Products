---
title: Hasilkan Gambar Swiss Post Parcel melalui PHP via Java
description: Kode sumber PHP untuk membuat Swiss Post Parcel dalam aplikasi berbasis PHP.
lang: id/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /id/php-java/swiss-post-parcel/generate/
aliases:
- /id/php-java/generate/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Hasilkan Label Swiss Post Parcel dengan PHP via Java" h2="Buat Swiss Post Parcel di PHP menggunakan Aspose.BarCode sisi server untuk API PHP via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menghasilkan Swiss Post Parcel di PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode memudahkan pengembang untuk membuat gambar Swiss Post Parcel dengan beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Buat instance baru kelas BarCodeGenerator</li><li>Tentukan Swiss Post Parcel dan jenis kode batang lain yang relevan sebagai parameter EncodeTypes</li><li>Tetapkan teks kode batang sebagai parameter kedua</li><li>Tentukan dimensi dan lokasi gambar jika diperlukan</li><li>Panggil metode BarCodeGenerator.save untuk mendapatkan gambar Swiss Post Parcel dalam format yang diperlukan</li></ul>
