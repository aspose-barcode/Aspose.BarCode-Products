---
title: Pindai Gambar kode batang Code 39 melalui PHP via Java
weight: 1510
description: Contoh kode PHP untuk membaca kode batang Code 39 di aplikasi berbasis PHP.
lang: id
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /id/php-java/code39/recognize/
aliases:
- /id/php-java/recognize/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Baca Kode Batang Code 39 dengan PHP via Java" h2="Baca kode batang Code 39 di PHP menggunakan Aspose.BarCode sisi server untuk PHP via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Memindai kode batang Code 39 di PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode memungkinkan pengembang membaca kode batang kode batang Code 39 dari aliran atau gambar dengan beberapa baris kode

{{% /blocks/products/pf/agp/text %}}

<ul><li>Buat objek kelas Aspose.BarCode.BarCodeReader</li><li>Setel jalur gambar sumber yang berisi kode batang Code 39 sebagai parameter</li><li>Tentukan jenis kode batang target di DecodeType sebagai parameter kedua</li><li>Loop melalui hasil pembacaan</li><li>Dapatkan teks barcode menggunakan properti CodeText</li></ul>
