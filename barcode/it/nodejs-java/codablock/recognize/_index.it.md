---
title: Scansiona le immagini di Codici a barre Codablock-F e GS1 Codablock-F tramite Node.js via Java
description: Codice sorgente Node.js per la scansione e la decodifica di Codici a barre Codablock-F e GS1 Codablock-F nelle applicazioni JavaScript.
lang: it
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /it/nodejs-java/codablock/recognize/
aliases:
- /it/nodejs-java/recognize/codablock/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leggi i codici a barre Codablock-F con Node.js via Java" h2="Leggi Codici a barre Codablock-F e GS1 Codablock-F in JavaScript utilizzando Aspose.BarCode lato server per l'API Node.js via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per scansionare Codablock-F codice a barre in JavaScript" %}}
