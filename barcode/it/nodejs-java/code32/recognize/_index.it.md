---
title: Scansiona le immagini di Codice a barre italiano Pharmacode (Code 32). tramite Node.js via Java
weight: 1510
description: Codice sorgente Node.js per la scansione e la decodifica di Codice a barre italiano Pharmacode (Code 32). nelle applicazioni JavaScript.
lang: it/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /it/nodejs-java/code32/recognize/
aliases:
- /it/nodejs-java/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leggi i codici a barre Code 32 con Node.js via Java" h2="Leggi Codice a barre italiano Pharmacode (Code 32). in JavaScript utilizzando Aspose.BarCode lato server per l'API Node.js via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per scansionare Code 32 codice a barre in JavaScript" %}}
