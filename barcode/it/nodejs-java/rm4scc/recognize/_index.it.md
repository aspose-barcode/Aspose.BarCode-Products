---
title: Scansiona le immagini di Codice cliente Royal Mail 4-State (RM4SCC) tramite Node.js via Java
description: Codice sorgente Node.js per la scansione e la decodifica di Codice cliente Royal Mail 4-State (RM4SCC) nelle applicazioni JavaScript.
lang: it
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /it/nodejs-java/rm4scc/recognize/
aliases:
- /it/nodejs-java/recognize/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leggi i codici a barre RM4SCC con Node.js via Java" h2="Leggi Codice cliente Royal Mail 4-State (RM4SCC) in JavaScript utilizzando Aspose.BarCode lato server per l'API Node.js via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per scansionare Codice cliente Royal Mail 4-State (RM4SCC) in JavaScript" %}}
