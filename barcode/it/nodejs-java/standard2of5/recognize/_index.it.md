---
title: Scansiona le immagini di Standard 2 of 5 (Industriale 2 di 5) codice a barre tramite Node.js via Java
description: Codice sorgente Node.js per la scansione e la decodifica di Standard 2 of 5 (Industriale 2 di 5) codice a barre nelle applicazioni JavaScript.
lang: it
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /it/nodejs-java/standard2of5/recognize/
aliases:
- /it/nodejs-java/recognize/standard2of5/
- /it/nodejs-java/recognize/iata2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leggi i codici a barre Standard 2 of 5 con Node.js via Java" h2="Leggi Standard 2 of 5 (Industriale 2 di 5) codice a barre in JavaScript utilizzando Aspose.BarCode lato server per l'API Node.js via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per scansionare Standard 2 of 5 codice a barre in JavaScript" %}}
