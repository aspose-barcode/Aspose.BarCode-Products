---
title: Scansiona le immagini di Codice cliente Royal Mail 4-State (RM4SCC) tramite PHP via Java
description: Codice di esempio PHP per leggere Codice cliente Royal Mail 4-State (RM4SCC) nelle applicazioni basate su PHP.
lang: it
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /it/php-java/rm4scc/recognize/
aliases:
- /it/php-java/recognize/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leggi i codici a barre RM4SCC con PHP via Java" h2="Leggi Codice cliente Royal Mail 4-State (RM4SCC) in PHP utilizzando Aspose.BarCode lato server per l'API PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Codice cliente Royal Mail 4-State (RM4SCC) Using PHP via Java" %}}
Leggi i codici a barre Codice cliente Royal Mail 4-State (RM4SCC) all'interno delle applicazioni PHP utilizzando Aspose.BarCode per PHP tramite Java, una libreria di codici a barre potente, ricca e intuitiva destinata alle piattaforme basate su Java. Per provare l'API del codice a barre, devi ottenere l'ultima versione dal portale [Aspose releases](https://releases.aspose.com/barcode/php/). Puoi anche trovare il pacchetto [aspose/barcode](https://packagist.org/packages/aspose/barcode) in Packagist e poi integrarlo nel tuo progetto PHP tramite composer:
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per scansionare Codice cliente Royal Mail 4-State (RM4SCC) in PHP" %}}
...
<ul><li>Crea un oggetto della classe Aspose.BarCode.BarCodeReader</li><li>Imposta il percorso dell'immagine di origine contenente Codice cliente Royal Mail 4-State (RM4SCC) come parametro</li><li>Specifica i tipi di codici a barre di destinazione in DecodeType come secondo parametro</li><li>Scorri i risultati della lettura</li><li>Ottieni il testo del codice a barre utilizzando la proprietà CodeText</li></ul>
