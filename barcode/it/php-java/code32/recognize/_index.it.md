---
title: Scansiona le immagini di Codice a barre italiano Pharmacode (Code 32). tramite PHP via Java
weight: 1510
description: Codice di esempio PHP per leggere Codice a barre italiano Pharmacode (Code 32). nelle applicazioni basate su PHP.
lang: it/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /it/php-java/code32/recognize/
aliases:
- /it/php-java/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leggi i codici a barre Code 32 con PHP via Java" h2="Leggi Codice a barre italiano Pharmacode (Code 32). in PHP utilizzando Aspose.BarCode lato server per l'API PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 32 codice a barre Using PHP via Java" %}}
Leggi i codici a barre Code 32 codice a barre all'interno delle applicazioni PHP utilizzando Aspose.BarCode per PHP tramite Java, una libreria di codici a barre potente, ricca e intuitiva destinata alle piattaforme basate su Java. Per provare l'API del codice a barre, devi ottenere l'ultima versione dal portale [Aspose releases](https://releases.aspose.com/barcode/php/). Puoi anche trovare il pacchetto [aspose/barcode](https://packagist.org/packages/aspose/barcode) in Packagist e poi integrarlo nel tuo progetto PHP tramite composer:
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per scansionare Code 32 codice a barre in PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode consente agli sviluppatori di leggere i codici a barre Code 32 codice a barre dallo stream o dall'immagine con poche righe di codice

{{% /blocks/products/pf/agp/text %}}

<ul><li>Crea un oggetto della classe Aspose.BarCode.BarCodeReader</li><li>Imposta il percorso dell'immagine di origine contenente Code 32 codice a barre come parametro</li><li>Specifica i tipi di codici a barre di destinazione in DecodeType come secondo parametro</li><li>Scorri i risultati della lettura</li><li>Ottieni il testo del codice a barre utilizzando la proprietà CodeText</li></ul>
