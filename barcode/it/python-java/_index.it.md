...
description: Libreria di lettori di codici a barre Python per riconoscere e generare più tipi di codici a barre, inclusi i tipi 1D, 2D e postali. Usa l'API nelle applicazioni Python.
lang: it
langdirlevel: 2
...
{{< blocks/products/pf/carousel-item h3="Indipendenza dalla piattaforma" description="Aspose.Barcode per Python tramite Java utilizza il bridge python-java ed è disponibile per Python 3.6 e versioni successive." >}}
<div class='diagram1 d1-python'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Formati di file supportati" description="Aspose.BarCode per Python via Java funziona con i formati di file immagine più comunemente usati." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/set-barcode-parameters/'>Gestisci i parametri del codice a barre</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/manage-barcode-appearance/'>Personalizza la dimensione del codice a barre</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/generate-qr-code/'>Genera codici QR</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/barcode-text-settings/'>Personalizza i sottotitoli di testo</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/save-generated-barcodes/'>Salva i codici a barre in vari formati</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/read-barcode-properties/'>Leggi le proprietà del codice a barre</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/pdf417/" name="PDF417" description="PDF417 codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/qr/" name="QR" description="QR Codice, GS1 QR Codice" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/datamatrix/" name="Data Matrix" description="Data Matrix codice" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/aztec/" name="Aztec" description="Aztec Codice" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/swiss-qr/" name="Swiss QR" description="Swiss QR fattura" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/dotcode/" name="DotCode" description="DotCode codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/hibc/" name="HIBC" description="HIBC (codice a barre del settore sanitario)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/codablock/" name="Codablock-F" description="Codici a barre Codablock-F e GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/databar/" name="GS1 DataBar" description="Codice a barre GS1 DataBar (Omnidirezionale, Omnidirezionale in pila, Espanso, In pila espansa e Troncato)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/itf/" name="ITF" description="Codice a barre interlacciato 2 su 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/ean/" name="EAN" description="EAN codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/upc/" name="UPC" description="UPC codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/code128/" name="GS1 Code 128" description="GS1 Code 128 codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/code39/" name="Code 39" description="Code 39 codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/code16k/" name="Code 16K" description="Code 16K codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/code32/" name="Code 32" description="Codice a barre italiano Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/code93/" name="Code 93" description="Code 93 Codici a barre estesi e Code 93 Standard" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/onecode/" name="USPS OneCode" description="USPS OneCode codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriale 2 di 5) codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/isbn/" name="ISBN" description="ISBN codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/ismn/" name="ISMN" description="ISMN codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/issn/" name="ISSN" description="ISSN codice a barre" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/australia-post/" name="Australia Post" description="Australia Post codice a barre e Australia Post pacco elettronico" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode e Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/rm4scc/" name="RM4SCC" description="Codice cliente Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/postnet/" name="Postnet" description="Postnet codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/royal-mail/" name="Royal Mail" description="Royal Mail codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/singapore-post/" name="Singapore Post" description="Singapore Post codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/python-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Documentazione" href="https://docs.aspose.com/barcode/python-java/" >}}
{{< blocks/products/pf/slr-element name="Codice sorgente" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Python-via-Java" >}}
{{< blocks/products/pf/slr-element name="Riferimenti API" href="https://reference.aspose.com/barcode/python-java/" >}}
...
{{< blocks/products/pf/slr-element name="Note di rilascio" href="https://releases.aspose.com/barcode/python-java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Perché Aspose.BarCode per Python via Java?" tabId="success-stories" >}}
