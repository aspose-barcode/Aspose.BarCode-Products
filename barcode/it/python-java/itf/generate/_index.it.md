---
title: Genera immagini Codice a barre interlacciato 2 su 5 (ITF). tramite Python via Java
description: Codice di esempio Python per generare Codice a barre interlacciato 2 su 5 (ITF). utilizzando Java Runtime Environment.
lang: it
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /it/python-java/itf/generate/
aliases:
- /it/python-java/generate/itf/
- /it/python-java/generate/datalogic2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genera etichette ITF con Python via Java" h2="Crea Codice a barre interlacciato 2 su 5 (ITF). in Python utilizzando Aspose.BarCode lato server per l'API Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Codice a barre interlacciato 2 su 5 (ITF). Using Python via Java" %}}
Per creare immagini Codice a barre interlacciato 2 su 5 (ITF)., scarica l'API [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/), un'API ricca di funzionalità, potente e facile da usare -use libreria di codici a barre per applicazioni basate su Python. Ottieni l'ultima versione direttamente dal portale [Aspose releases](https://releases.aspose.com/barcode/python-java/) o installa 'aspose-barcode' da pip con il seguente comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per generare Codice a barre interlacciato 2 su 5 (ITF). in Python" %}}
