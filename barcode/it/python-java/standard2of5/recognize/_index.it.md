---
title: Scansiona le immagini di Standard 2 of 5 (Industriale 2 di 5) codice a barre tramite Python via Java
description: Codice sorgente Python per il riconoscimento di Standard 2 of 5 (Industriale 2 di 5) codice a barre utilizzando Java Runtime Environment.
lang: it
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /it/python-java/standard2of5/recognize/
aliases:
- /it/python-java/recognize/standard2of5/
- /it/python-java/recognize/iata2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leggi i codici a barre Standard 2 of 5 con Python via Java" h2="Leggi Standard 2 of 5 (Industriale 2 di 5) codice a barre in Python utilizzando Aspose.BarCode lato server per l'API Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
