---
title: Genera immagini Standard 2 of 5 (Industriale 2 di 5) codice a barre tramite Python via Java
description: Codice di esempio Python per generare Standard 2 of 5 (Industriale 2 di 5) codice a barre utilizzando Java Runtime Environment.
lang: it
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /it/python-java/standard2of5/generate/
aliases:
- /it/python-java/generate/standard2of5/
- /it/python-java/generate/iata2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genera etichette Standard 2 of 5 con Python via Java" h2="Crea Standard 2 of 5 (Industriale 2 di 5) codice a barre in Python utilizzando Aspose.BarCode lato server per l'API Python via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per generare Standard 2 of 5 codice a barre in Python" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode rende facile per gli sviluppatori creare immagini Standard 2 of 5 codice a barre con poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Crea un nuovo oggetto della classe BarCodeGenerator</li><li>Determina i tipi di codice a barre desiderati come parametro EncodeTypes</li><li>Inserisci il testo di input come secondo parametro</li><li>Richiama il metodo BarCodeGenerator.save per ottenere l'immagine Standard 2 of 5 (Industriale 2 di 5) codice a barre generata</li></ul>
