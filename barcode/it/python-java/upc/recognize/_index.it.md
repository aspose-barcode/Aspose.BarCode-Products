---
title: Scansiona le immagini di UPC codice a barre tramite Python via Java
description: Codice sorgente Python per il riconoscimento di UPC codice a barre utilizzando Java Runtime Environment.
lang: it
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /it/python-java/upc/recognize/
aliases:
- /it/python-java/recognize/upc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leggi i codici a barre UPC con Python via Java" h2="Leggi UPC codice a barre in Python utilizzando Aspose.BarCode lato server per l'API Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read UPC codice a barre Using Python via Java" %}}
Per scansionare e decodificare UPC codice a barre, installa l'API [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/), un'API versatile, potente e facile da usare utilizzare la libreria di codici a barre per le applicazioni basate su Python. Ottieni l'ultima versione direttamente dal portale [Aspose releases](https://releases.aspose.com/barcode/python-java/) o installa 'aspose-barcode' da pip eseguendo il seguente comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per scansionare UPC codice a barre in Python" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode consente agli sviluppatori di leggere i codici a barre UPC codice a barre dallo stream o dall'immagine con poche righe di codice

{{% /blocks/products/pf/agp/text %}}

<ul><li>Crea un oggetto della classe Aspose.BarCode.BarCodeReader</li><li>Definisci il percorso del file di origine contenente UPC codice a barre come parametro</li><li>Determina i tipi di codici a barre richiesti in DecodeType come secondo parametro</li><li>Scorri i risultati della decodifica</li><li>Ottieni il testo del codice a barre utilizzando la proprietà CodeText</li></ul>
