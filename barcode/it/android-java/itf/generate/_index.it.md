---
title: Genera immagini Codice a barre interlacciato 2 su 5 (ITF). tramite Android via Java
description: Codice sorgente Android per creare Codice a barre interlacciato 2 su 5 (ITF). in Android Runtime Environment.
lang: it
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /it/android-java/itf/generate/
aliases:
- /it/android-java/generate/itf/
- /it/android-java/generate/datalogic2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genera etichette ITF con Android via Java" h2="Crea Codice a barre interlacciato 2 su 5 (ITF). in Java utilizzando Aspose.BarCode lato server per l'API Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Codice a barre interlacciato 2 su 5 (ITF). Using Android via Java" %}}
Prova Aspose.BarCode per Android tramite Java per creare facilmente Codice a barre interlacciato 2 su 5 (ITF). all'interno delle applicazioni Android. È una libreria di codici a barre versatile, robusta e intuitiva progettata specificamente per le applicazioni Android. Puoi facilmente Aspose.BarCode per Android tramite Java direttamente da un progetto basato su Maven inserendo le seguenti configurazioni in build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per generare Codice a barre interlacciato 2 su 5 (ITF). in Java" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode rende facile per gli sviluppatori creare immagini Codice a barre interlacciato 2 su 5 (ITF). con poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Crea una nuova istanza della classe BarCodeGenerator</li><li>Passa il tipo di codice a barre Codice a barre interlacciato 2 su 5 (ITF). come parametro EncodeTypes</li><li>Definisci il testo del codice a barre utilizzando il metodo setCodeText</li><li>Lancia il metodo generateBarCodeImage() per salvare l'immagine del codice a barre Codice a barre interlacciato 2 su 5 (ITF).</li></ul>
