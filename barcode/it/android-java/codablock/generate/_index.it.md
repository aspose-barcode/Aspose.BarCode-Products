...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per generare Codablock-F codice a barre in Java" %}}
...
<ul><li>Crea una nuova istanza della classe BarCodeGenerator</li><li>Passa il tipo di codice a barre Codablock-F codice a barre come parametro EncodeTypes</li><li>Definisci il testo del codice a barre utilizzando il metodo setCodeText</li><li>Lancia il metodo generateBarCodeImage() per salvare l'immagine del codice a barre Codici a barre Codablock-F e GS1 Codablock-F</li></ul>
