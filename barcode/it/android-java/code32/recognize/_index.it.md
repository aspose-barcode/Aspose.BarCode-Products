---
title: Scansiona le immagini di Codice a barre italiano Pharmacode (Code 32). tramite Android via Java
description: Codice di esempio Android per riconoscere Codice a barre italiano Pharmacode (Code 32). in Android Runtime Environment.
lang: it
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /it/android-java/code32/recognize/
aliases:
- /it/android-java/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leggi i codici a barre Code 32 con Android via Java" h2="Leggi Codice a barre italiano Pharmacode (Code 32). in Java utilizzando Aspose.BarCode lato server per l'API Android via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 32 codice a barre Using Android via Java" %}}
Prova Aspose.BarCode per Android tramite Java per rilevare e leggere facilmente Code 32 codice a barre all'interno delle applicazioni Android. È un'API per codici a barre ricca, scalabile e intuitiva destinata alle applicazioni Android. Ottieni Aspose.BarCode per Java direttamente da un progetto basato su Maven aggiungendo le seguenti configurazioni a build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per scansionare Code 32 codice a barre in Java" %}}
