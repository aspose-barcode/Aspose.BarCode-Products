...
{{< blocks/products/pf/upper-banner h1="API Java per la generazione e il riconoscimento di codici a barre" h2="Crea e riconosci codici a barre di tipo lineare, 2D e postale all'interno di qualsiasi applicazione Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" pfName="Aspose.BarCode" subTitlepfName="per Java" downloadUrl="https://releases.aspose.com/barcode/java/" >}}
...
<p>Aspose.BarCode per Java è un'API robusta e affidabile che fornisce le funzionalità di generazione e riconoscimento dei codici a barre per le applicazioni Java. Supporta gli standard e le specifiche più affermati e consente agli sviluppatori di leggere codici a barre 1D e 2D da diversi file immagine da qualsiasi angolazione. Aspose.BarCode per Java esegue il rendering delle immagini dei codici a barre in una varietà di formati immagine con opzioni di imaging altamente flessibili. La libreria supporta la codifica e la decodifica di oltre 60 tipi di codici a barre e consente la stampa diretta delle immagini dei codici a barre.</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="A prima vista" description="Una panoramica delle funzionalità di riconoscimento e generazione di codici a barre dell'API." >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>Lineare, 2D e postale</li><li>Rileva da stream o immagine</li><li>Ottieni l'orientamento del codice a barre</li><li>Decodifica caratteri non inglesi</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                Stampa
            </header>
            <ul><li>Stampa direttamente il codice a barre</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>Lineare, 2D e postale</li><li>Salva in streaming o immagine</li><li>Personalizza aspetto&colon; dimensioni, colore, angolo</li><li>Codifica caratteri non inglesi </li></ul>
            <header>
                <i class="fa fa-qrcode">
                </i>
                Tipi
            </header>
            <ul><li>Lineare</li><li>2D</li><li>Postale</li></ul>
        </div>
        <!--/right-->
    </div>
    <!--/row-->
...
{{< blocks/products/pf/carousel-item h3="Indipendenza dalla piattaforma" description="È possibile utilizzare la libreria di codici a barre per creare qualsiasi tipo di applicazione Java con JRE 1.6 o superiore installato." >}}
<div class='diagram1 d1-java'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Formati di file supportati" description="Aspose.BarCode per Java funziona con i formati di file immagine più comunemente usati." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Funzionalità avanzate della libreria Java
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/control-the-appearance-of-code-text/'>Regola e modifica le proprietà relative all'aspetto del testo del codice</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-the-barcode-caption/'>Gestisci i sottotitoli e gli stili dei caratteri</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/use-checksum-and-supplement-data-for-barcodes/'>Supporto per dati Checksum & Supplement</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#image-formats'>Genera immagini di codici a barre in più formati di immagine</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/advanced-barcode-recognition-features/'>Leggi tipi 1D e 2D da qualsiasi angolazione</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/barcode-regions/'>Scansiona il codice a barre specificando l'area</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/generate-barcode-by-specifying-custom-image-size/'>Personalizza le dimensioni delle immagini</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/manage-x-dimension-and-y-dimension/'>Supporto della dimensione X e Y per il tipo 2D</a>
                </p>
            </div>
            <div class="col-lg-4">
                <em class='fa fa-book ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/supported-file-formats/#barcode-types'>Supporto per simbologie lineari, 2D e postali</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    L'API del codice a barre per Java consente agli sviluppatori di perfezionare l'aspetto dei codici a barre generati specificando il tipo di codice a barre, il testo di input, lo stile del carattere, i colori di sfondo e primo piano, l'allineamento e la posizione della didascalia e altre proprietà. Puoi modificare la didascalia impostandone la visibilità per le didascalie superiore e inferiore, il carattere, i colori e l'allineamento.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    L'API del codice a barre consente agli sviluppatori di generare facilmente immagini di codici a barre di alta qualità nelle loro applicazioni. Supporta un'ampia gamma di tipi di codici a barre, inclusi quelli ampiamente utilizzati come QR Code e Code 128, nonché tipi più specializzati come Aztec Code e Data Matrix. L'API consente agli sviluppatori di personalizzare l'aspetto dei codici a barre generati, inclusi i colori di primo piano e di sfondo, il carattere e l'allineamento delle didascalie. Utilizzando l'API, gli sviluppatori possono facilmente generare codici a barre 2D nello stesso modo in cui genererebbero codici a barre unidimensionali.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Inserisci i codici a barre nei documenti PDF
                </h2>
                <p>
                    La libreria di codici a barre consente agli sviluppatori non solo di creare codici a barre personalizzati, ma anche di aggiungere direttamente immagini generate nei documenti PDF. È possibile innanzitutto creare immagini di codici a barre utilizzando uno dei formati raster supportati e quindi inserirle in un file PDF. L'API consente di aggiungere codici a barre senza compressione delle immagini e perdite di qualità. Fornisce inoltre funzionalità per modificare i parametri e l'aspetto del codice a barre prima degli inserimenti o aggiungere l'immagine generata in più pagine del documento contemporaneamente. L'API Aspose.BarCode può essere utilizzata per la stampa di alta qualità di immagini di codici a barre. Le immagini raster hanno la risoluzione standard di 96 dpi, che non è sufficiente per questo scopo. L'API consente di impostare una risoluzione dell'immagine del codice a barre di 300 o 600 dpi per stampare documenti PDF di alta qualità.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
                ...
                <p>
                    La libreria di codici a barre Java è un potente strumento per lavorare con i codici a barre nelle applicazioni Java. Una delle sue caratteristiche principali è la capacità di leggere codici a barre da diversi formati di file immagine. La classe BarCodeReader, che è la classe principale responsabile del riconoscimento dei codici a barre, supporta molti formati immagine diffusi, tra cui BMP, PNG, TIFF, JPEG e GIF. Ciò semplifica l'integrazione della funzionalità di riconoscimento dei codici a barre in un'ampia gamma di applicazioni.
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
<div class="barcode-read-lcs" style="width: 100%;">
    ...
    <div class="barcode-read-lcs-controls">
        <div class="barcode-read-lcs-drop" onclick="BarcodeReadLcsUpload(this);" ondragover="event.preventDefault();" ondrop="BarcodeReadLcsDropped(event,this);">
            ...
            <span class="barcode-read-lcs-hint">Rilascia un file qui o fai clic per sfogliare *</span>
        </div>
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">Tutti i tipi</option>
                <option value="Pdf417 ">PDF417</option>
                <option value="QR ">QR</option>
    ...
    <p class="barcode-read-lcs-disclaimer">* Caricando i tuoi file o utilizzando il servizio accetti i nostri <a href='https://about.aspose.com/legal/terms-of-use' rel='nofollow noreferrer' target='_blank'>Termini di utilizzare</a> e <a href='https://about.aspose.com/legal/privacy-policy' rel='nofollow noreferrer' target='_blank'>Informativa sulla privacy</a>.</p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Scansiona codici a barre da documenti PDF
                </h2>
                <p>
                    Oltre a leggere codici a barre da file immagine, la libreria di codici a barre può essere utilizzata per scansionare codici a barre da file PDF. Gli sviluppatori possono implementare il rilevamento rapido dei codici a barre nei documenti PDF con più pagine. L'API fornisce diversi modi per farlo. Il modo consigliato è convertire le pagine del documento in immagini raster e quindi applicare meccanismi di lettura del codice a barre. Il rendering dei contenuti della pagina in immagini raster è suggerito come l'approccio più semplice ed efficiente. In caso contrario, le immagini dei codici a barre possono essere prima rilevate ed estratte dal documento PDF di origine. Questo metodo facilita la lettura dei codici a barre con risoluzione originale. Aspose.BarCode API consente di elaborare file PDF multipagina per rilevare e riconoscere tutti i codici a barre presentati in un documento.
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/pdf417/" name="PDF417" description="PDF417 codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/qr/" name="QR" description="QR Codice, GS1 QR Codice" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/datamatrix/" name="Data Matrix" description="Data Matrix codice" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/aztec/" name="Aztec" description="Aztec Codice" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/swiss-qr/" name="Swiss QR" description="Swiss QR fattura" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/dotcode/" name="DotCode" description="DotCode codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/hibc/" name="HIBC" description="HIBC (codice a barre del settore sanitario)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/codablock/" name="Codablock-F" description="Codici a barre Codablock-F e GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/databar/" name="GS1 DataBar" description="Codice a barre GS1 DataBar (Omnidirezionale, Omnidirezionale in pila, Espanso, In pila espansa e Troncato)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/itf/" name="ITF" description="Codice a barre interlacciato 2 su 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/ean/" name="EAN" description="EAN codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/upc/" name="UPC" description="UPC codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/code128/" name="GS1 Code 128" description="GS1 Code 128 codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/code39/" name="Code 39" description="Code 39 codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/code16k/" name="Code 16K" description="Code 16K codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/code32/" name="Code 32" description="Codice a barre italiano Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/code93/" name="Code 93" description="Code 93 Codici a barre estesi e Code 93 Standard" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/onecode/" name="USPS OneCode" description="USPS OneCode codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriale 2 di 5) codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/isbn/" name="ISBN" description="ISBN codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/ismn/" name="ISMN" description="ISMN codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/issn/" name="ISSN" description="ISSN codice a barre" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/australia-post/" name="Australia Post" description="Australia Post codice a barre e Australia Post pacco elettronico" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode e Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/rm4scc/" name="RM4SCC" description="Codice cliente Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/postnet/" name="Postnet" description="Postnet codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/royal-mail/" name="Royal Mail" description="Royal Mail codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/singapore-post/" name="Singapore Post" description="Singapore Post codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="Cosa dicono le persone" subTitle="Non limitarti a crederci sulla parola. Scopri cosa hanno da dire gli utenti sulle API." caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 Ho passato molti anni a sviluppare e migliorare il mio prodotto e Aspose mi ha permesso di rendere il mio prodotto molto più amichevole e utile, e quindi più commerciabile. <em>Kiel Diller | Soluzioni KD, Polonia</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode è veramente scritto in codice gestito e ci offre una varietà di tipi di codici a barre per gestire tutti i tipi di riconoscimento dei documenti e l'ulteriore elaborazione. <em>Dennis Alexander Petrasc | Keil IT, Germania</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Documentazione" href="https://docs.aspose.com/barcode/java/" >}}
{{< blocks/products/pf/slr-element name="Codice sorgente" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="Riferimenti API" href="https://reference.aspose.com/barcode/java/" >}}
...
{{< blocks/products/pf/slr-element name="Storie di successo" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Aspose.BarCode offre singole API di generazione e riconoscimento di codici a barre per altri ambienti di sviluppo popolari come elencato di seguito:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/barcode/it/sharepoint/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-sharepoint.svg" sdkName="SharePoint" >}}
