---
title: Genera immagini Swiss Post Parcel tramite C++
description: Esempio di codice C++ per generare Swiss Post Parcel in C++ Runtime Environment per Windows a 32 bit, Windows a 64 bit e Linux a 64 bit.
lang: it
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /it/cpp/swiss-post-parcel/generate/
aliases:
- /it/cpp/generate/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genera etichette Swiss Post Parcel con C++" h2="Crea Swiss Post Parcel in C++ utilizzando Aspose.BarCode lato server per l'API C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Per generare Swiss Post Parcel, installa l'API [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/), una libreria di codici a barre solida e facile da usare con ricche funzionalità per piattaforme C++ . Scarica l'ultima versione direttamente dal gestore pacchetti [NuGet](https://www.nuget.org/packages/aspose.barcode)&colon; cerca **Aspose.BarCode.Cpp** e installa il pacchetto. In alternativa, apri la console di Package Manager ed esegui il seguente comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per generare Swiss Post Parcel in C++" %}}
...
<ul><li>Crea un oggetto della classe BarcodeGenerator</li><li>Passa Swiss Post Parcel come parametro</li><li>Inserisci il testo di input da codificare come secondo parametro</li><li>Definisci le dimensioni dell'immagine se necessario</li><li>Chiama il metodo BarcodeGenerator.Save per scaricare il codice a barre Swiss Post Parcel</li></ul>
