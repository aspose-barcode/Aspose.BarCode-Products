---
title: Genera immagini Code 39 codice a barre tramite C++
description: Esempio di codice C++ per generare Code 39 codice a barre in C++ Runtime Environment per Windows a 32 bit, Windows a 64 bit e Linux a 64 bit.
lang: it/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /it/cpp/code39/generate/
aliases:
- /it/cpp/generate/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Genera etichette Code 39 con C++" h2="Crea Code 39 codice a barre in C++ utilizzando Aspose.BarCode lato server per l'API C++." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Code 39 codice a barre Using C++" %}}
Per generare Code 39 codice a barre, installa l'API [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/), una libreria di codici a barre solida e facile da usare con ricche funzionalità per piattaforme C++ . Scarica l'ultima versione direttamente dal gestore pacchetti [NuGet](https://www.nuget.org/packages/aspose.barcode)&colon; cerca **Aspose.BarCode.Cpp** e installa il pacchetto. In alternativa, apri la console di Package Manager ed esegui il seguente comando:
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per generare Code 39 codice a barre in C++" %}}
...
<ul><li>Crea un oggetto della classe BarcodeGenerator</li><li>Passa Code 39 codice a barre come parametro</li><li>Inserisci il testo di input da codificare come secondo parametro</li><li>Definisci le dimensioni dell'immagine se necessario</li><li>Chiama il metodo BarcodeGenerator.Save per scaricare il codice a barre Code 39 codice a barre</li></ul>
