...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per generare Standard 2 of 5 codice a barre in C++" %}}
...
<ul><li>Crea un oggetto della classe BarcodeGenerator</li><li>Passa Standard 2 of 5 (Industriale 2 di 5) codice a barre come parametro</li><li>Inserisci il testo di input da codificare come secondo parametro</li><li>Definisci le dimensioni dell'immagine se necessario</li><li>Chiama il metodo BarcodeGenerator.Save per scaricare il codice a barre Standard 2 of 5 (Industriale 2 di 5) codice a barre</li></ul>
