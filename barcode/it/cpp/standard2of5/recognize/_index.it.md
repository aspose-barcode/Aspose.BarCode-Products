---
title: Scansiona le immagini di Standard 2 of 5 (Industriale 2 di 5) codice a barre tramite C++
description: Codice di esempio C++ per scansionare e decodificare Standard 2 of 5 (Industriale 2 di 5) codice a barre in C++ Runtime Environment per Windows a 32 bit, Windows a 64 bit o Linux a 64 bit.
lang: it
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /it/cpp/standard2of5/recognize/
aliases:
- /it/cpp/recognize/standard2of5/
- /it/cpp/recognize/iata2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Leggi i codici a barre Standard 2 of 5 con C++" h2="Leggi Standard 2 of 5 (Industriale 2 di 5) codice a barre in C++ utilizzando Aspose.BarCode lato server per l'API C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per scansionare Standard 2 of 5 codice a barre in C++" %}}
