...
{{< blocks/products/pf/upper-banner h1="API per codici a barre di SharePoint" h2="Barcode SharePoint App per aggiungere codici a barre lineari, 2D e postali agli elenchi di Microsoft SharePoint." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-sharepoint.svg" pfName="Aspose.BarCode" subTitlepfName="per SharePoint" downloadUrl="https://releases.aspose.com/barcode/sharepoint/" >}}
...
<p>Aspose.BarCode per SharePoint consente agli sviluppatori di aggiungere una grande varietà di codici a barre lineari, 2D e postali agli elenchi di Microsoft SharePoint Foundation 2010 e Microsoft Office SharePoint Server 2010 (MOSS). Puoi creare e quindi inserire codici a barre in qualsiasi elenco specificando il testo e il tipo di input.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Indipendenza dalla piattaforma" description="Aspose.BarCode per SharePoint supporta Microsoft SharePoint Foundation e SharePoint Server." >}}
<div class='diagram1 d1-sharepoint'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Formati di file supportati" description="Aspose.BarCode per SharePoint funziona con i formati di file immagine più comunemente usati." >}}
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                <h2 class="h2title">
                    Aggiungi codici a barre agli elenchi di Sharepoint
                </h2>
                <p>
                    Aspose.BarCode per SharePoint offre una ricca funzionalità per aggiungere codici a barre agli elenchi di SharePoint. Tali elenchi possono essere utilizzati per archiviare e organizzare i dati in un formato strutturato. È un modo conveniente per gestire un'ampia gamma di informazioni, come contatti, attività, eventi del calendario e altro ancora. Forniscono molteplici funzionalità per l'organizzazione, l'ordinamento, il filtraggio e la condivisione dei dati. Può essere utile aggiungere codici a barre agli elenchi di SharePoint per facilitare l'accesso e la gestione delle informazioni nell'elenco. Se viene creato un elenco di SharePoint per tenere traccia degli articoli di inventario, gli sviluppatori possono aggiungere codici a barre per scansionare e aggiornare in modo rapido e accurato le informazioni nell'elenco. Ciò potrebbe facilitare il monitoraggio e la gestione dell'inventario, oltre a ridurre il rischio di discrepanze. I codici a barre possono servire per accedere e visualizzare rapidamente le informazioni in un elenco di SharePoint, ad esempio mediante la scansione dei codici a barre per visualizzare rapidamente elementi o record specifici nell'elenco.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    La libreria di codici a barre è un potente strumento che consente agli sviluppatori di generare facilmente codici a barre specificando il tipo di codice a barre di destinazione, inserendo i dati di input per memorizzare il codice a barre e personalizzando le proprietà relative all'aspetto. La libreria offre una varietà di opzioni per la messa a punto dell'aspetto dei codici a barre generati, comprese le opzioni per l'impostazione dei colori di sfondo e primo piano, carattere, dimensione, risoluzione e didascalie di testo.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    L'API Barcode include varie funzionalità per il rilevamento e la lettura di un'ampia gamma di codici a barre 1D e 2D popolari. Queste funzionalità possono essere facilmente integrate nelle tue applicazioni con poche righe di codice, fornendo un modo conveniente ed efficiente per aggiungere funzionalità di rilevamento dei codici a barre alle tue applicazioni.
                </p>
                {{< blocks/products/pf/agp/feature-section2 >}}
<!-- BEGIN LCS -->
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/pdf417/" name="PDF417" description="PDF417 codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/qr/" name="QR" description="QR Codice, GS1 QR Codice" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/datamatrix/" name="Data Matrix" description="Data Matrix codice" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/aztec/" name="Aztec" description="Aztec Codice" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/swiss-qr/" name="Swiss QR" description="Swiss QR fattura" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/dotcode/" name="DotCode" description="DotCode codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/hibc/" name="HIBC" description="HIBC (codice a barre del settore sanitario)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/codablock/" name="Codablock-F" description="Codici a barre Codablock-F e GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/databar/" name="GS1 DataBar" description="Codice a barre GS1 DataBar (Omnidirezionale, Omnidirezionale in pila, Espanso, In pila espansa e Troncato)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/itf/" name="ITF" description="Codice a barre interlacciato 2 su 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/ean/" name="EAN" description="EAN codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/upc/" name="UPC" description="UPC codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/code128/" name="GS1 Code 128" description="GS1 Code 128 codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/code39/" name="Code 39" description="Code 39 codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/code16k/" name="Code 16K" description="Code 16K codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/code32/" name="Code 32" description="Codice a barre italiano Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/code93/" name="Code 93" description="Code 93 Codici a barre estesi e Code 93 Standard" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/onecode/" name="USPS OneCode" description="USPS OneCode codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industriale 2 di 5) codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/isbn/" name="ISBN" description="ISBN codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/ismn/" name="ISMN" description="ISMN codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/issn/" name="ISSN" description="ISSN codice a barre" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/australia-post/" name="Australia Post" description="Australia Post codice a barre e Australia Post pacco elettronico" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode e Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/rm4scc/" name="RM4SCC" description="Codice cliente Royal Mail 4-State (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/postnet/" name="Postnet" description="Postnet codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/royal-mail/" name="Royal Mail" description="Royal Mail codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/singapore-post/" name="Singapore Post" description="Singapore Post codice a barre" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/it/sharepoint/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Note di rilascio" href="https://releases.aspose.com/barcode/sharepoint/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
