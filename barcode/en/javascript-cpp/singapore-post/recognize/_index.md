---
title: Scan Singapore Post barcode Images via JavaScript via C++
description: JavaScript sample code to scan and decode Singapore Post barcode in any modern browser using WebAssembly-based library.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /javascript-cpp/singapore-post/recognize/
aliases:
- /javascript-cpp/recognize/singapore-post/
- /nl/javascript-cpp/singapore-post/recognize/
- /sv/javascript-cpp/singapore-post/recognize/
- /hu/javascript-cpp/singapore-post/recognize/
- /hi/javascript-cpp/singapore-post/recognize/
- /el/javascript-cpp/singapore-post/recognize/
- /cs/javascript-cpp/singapore-post/recognize/
- /javascript-cpp/recognize/singaporepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Singapore Post Barcodes with JavaScript via C++" h2="Read Singapore Post barcode in JavaScript using server-side Aspose.BarCode for JavaScript via C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-javascript-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for JavaScript via C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Singapore Post barcode in JavaScript" %}}
...
<ul><li>Create instance of BarCode module</li><li>Create a new instance of Aspose.BarCode.BarCodeReader class</li><li>Pass the source image path containing Singapore Post barcode as a parameter</li><li>Pass an appropriate DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the CodeText property</li></ul>
...
reader.<span class="hljs-title function_">delete</span>()</code>
    ...
    <script>
        ...
        async function recognizeBarcodeAsync() {
            ...
            let barcodetypeUrl = "SingaporePost";
            if (barcodetypeUrl === "") {
                barcodetypeUrl = button.siblings("select").val();
                barcodetypeUrl = barcodetypeUrl === "SingaporePost" ? "" : barcodetypeUrl;
            }
            let quality = 2;
