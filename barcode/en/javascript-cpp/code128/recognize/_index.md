---
title: Scan GS1 Code 128 barcode Images via JavaScript via C++
description: JavaScript sample code to scan and decode GS1 Code 128 barcode in any modern browser using WebAssembly-based library.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /javascript-cpp/code128/recognize/
aliases:
- /javascript-cpp/recognize/code128/
- /nl/javascript-cpp/code128/recognize/
- /sv/javascript-cpp/code128/recognize/
- /hu/javascript-cpp/code128/recognize/
- /hi/javascript-cpp/code128/recognize/
- /el/javascript-cpp/code128/recognize/
- /cs/javascript-cpp/code128/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read GS1 Code 128 Barcodes with JavaScript via C++" h2="Read GS1 Code 128 barcode in JavaScript using server-side Aspose.BarCode for JavaScript via C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-javascript-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for JavaScript via C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning GS1 Code 128 barcode in JavaScript" %}}
...
<ul><li>Create instance of BarCode module</li><li>Create a new instance of Aspose.BarCode.BarCodeReader class</li><li>Pass the source image path containing GS1 Code 128 barcode as a parameter</li><li>Pass an appropriate DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the CodeText property</li></ul>
