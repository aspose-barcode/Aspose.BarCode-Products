---
title: Scan Deutsche Post Identcode and Deutsche Post Leitcode Images via JavaScript via C++
description: JavaScript sample code to scan and decode Deutsche Post Identcode and Deutsche Post Leitcode in any modern browser using WebAssembly-based library.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /javascript-cpp/deutsche-post/recognize/
aliases:
- /javascript-cpp/recognize/deutsche-post/
- /nl/javascript-cpp/deutsche-post/recognize/
- /sv/javascript-cpp/deutsche-post/recognize/
- /hu/javascript-cpp/deutsche-post/recognize/
- /hi/javascript-cpp/deutsche-post/recognize/
- /el/javascript-cpp/deutsche-post/recognize/
- /cs/javascript-cpp/deutsche-post/recognize/
- /javascript-cpp/recognize/deutschepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Deutsche Post Barcodes with JavaScript via C++" h2="Read Deutsche Post Identcode and Deutsche Post Leitcode in JavaScript using server-side Aspose.BarCode for JavaScript via C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-javascript-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for JavaScript via C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Deutsche Post barcode Using JavaScript via C++" %}}
To scan Deutsche Post barcode, try [Aspose.BarCode for JavaScript](https://products.aspose.com/barcode/javascript-cpp/), a potent and easy-to-use barcode library with rich functionality that works in any moder browser. Download the latest version directly from the [Releases Site](https://releases.aspose.com/barcode/javascriptcpp/) and then follow [installation instructions](https://docs-qa.aspose.com/barcode/javascript-cpp/installation/).
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Deutsche Post barcode in JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode allows developers to read Deutsche Post barcode barcodes from stream or image with few lines of code

{{% /blocks/products/pf/agp/text %}}

<ul><li>Create instance of BarCode module</li><li>Create a new instance of Aspose.BarCode.BarCodeReader class</li><li>Pass the source image path containing Deutsche Post Identcode and Deutsche Post Leitcode as a parameter</li><li>Pass an appropriate DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the CodeText property</li></ul>
...
<ul><li>Aspose.BarCode for JavaScript via C++ is independent of any specific operating system, allowing it to function on any platform that supports a compatible browser or runtime environment. This includes major operating systems such as Windows, macOS, Linux, iOS, and Android. For detailed technical requirements, see [System Requirements](https://docs.aspose.com/barcode/javascript-cpp/system-requirements/).</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section title="Other Supported Barcode Recognition Symbologies" subTitle="Using JavaScript via C++, One can also read barcode of different symbologies including the following." >}}

<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">2D:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/pdf417/recognize/" name="PDF417" description="PDF417 barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/qr/recognize/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/datamatrix/recognize/" name="Data Matrix" description="Data Matrix code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/aztec/recognize/" name="Aztec" description="Aztec Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR bill" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/dotcode/recognize/" name="DotCode" description="DotCode barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/hibc/recognize/" name="HIBC" description="HIBC (Health Industry Bar Code)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/codablock/recognize/" name="Codablock-F" description="Codablock-F and GS1 Codablock-F barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, and Truncated) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/itf/recognize/" name="ITF" description="Interleaved 2-of-5 (ITF) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/ean/recognize/" name="EAN" description="EAN (International Article Number) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/upc/recognize/" name="UPC" description="UPC (Universal Product Code) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/code39/recognize/" name="Code 39" description="Code 39 barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/code16k/recognize/" name="Code 16K" description="Code 16K barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/code32/recognize/" name="Code 32" description="Italian Pharmacode (Code 32) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/code93/recognize/" name="Code 93" description="Code 93 Extended and Code 93 Standard barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/onecode/recognize/" name="USPS OneCode" description="USPS OneCode barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 of 5) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/isbn/recognize/" name="ISBN" description="ISBN barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/ismn/recognize/" name="ISMN" description="ISMN barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/issn/recognize/" name="ISSN" description="ISSN barcode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/australia-post/recognize/" name="Australia Post" description="Australia Post barcode and Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode and Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4-State Customer Code (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/postnet/recognize/" name="Postnet" description="Postnet barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/royal-mail/recognize/" name="Royal Mail" description="Royal Mail barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/singapore-post/recognize/" name="Singapore Post" description="Singapore Post barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/javascript-cpp/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
