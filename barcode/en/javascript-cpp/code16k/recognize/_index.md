---
title: Scan Code 16K barcode Images via JavaScript via C++
description: JavaScript sample code to scan and decode Code 16K barcode in any modern browser using WebAssembly-based library.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /javascript-cpp/code16k/recognize/
aliases:
- /javascript-cpp/recognize/code16k/
- /nl/javascript-cpp/code16k/recognize/
- /sv/javascript-cpp/code16k/recognize/
- /hu/javascript-cpp/code16k/recognize/
- /hi/javascript-cpp/code16k/recognize/
- /el/javascript-cpp/code16k/recognize/
- /cs/javascript-cpp/code16k/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Code 16K Barcodes with JavaScript via C++" h2="Read Code 16K barcode in JavaScript using server-side Aspose.BarCode for JavaScript via C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-javascript-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for JavaScript via C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Code 16K barcode in JavaScript" %}}
...
<ul><li>Create instance of BarCode module</li><li>Create a new instance of Aspose.BarCode.BarCodeReader class</li><li>Pass the source image path containing Code 16K barcode as a parameter</li><li>Pass an appropriate DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the CodeText property</li></ul>
