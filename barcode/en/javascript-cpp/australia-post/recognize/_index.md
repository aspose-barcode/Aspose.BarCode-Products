---
title: Scan Australia Post barcode and Australia Post eParcel Images via JavaScript via C++
description: JavaScript sample code to scan and decode Australia Post barcode and Australia Post eParcel in any modern browser using WebAssembly-based library.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /javascript-cpp/australia-post/recognize/
aliases:
- /javascript-cpp/recognize/australia-post/
- /nl/javascript-cpp/australia-post/recognize/
- /sv/javascript-cpp/australia-post/recognize/
- /hu/javascript-cpp/australia-post/recognize/
- /hi/javascript-cpp/australia-post/recognize/
- /el/javascript-cpp/australia-post/recognize/
- /cs/javascript-cpp/australia-post/recognize/
- /javascript-cpp/recognize/australiapost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Australia Post Barcodes with JavaScript via C++" h2="Read Australia Post barcode and Australia Post eParcel in JavaScript using server-side Aspose.BarCode for JavaScript via C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-javascript-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for JavaScript via C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Australia Post barcode in JavaScript" %}}
...
<ul><li>Create instance of BarCode module</li><li>Create a new instance of Aspose.BarCode.BarCodeReader class</li><li>Pass the source image path containing Australia Post barcode and Australia Post eParcel as a parameter</li><li>Pass an appropriate DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the CodeText property</li></ul>
