---
title: Scan Swiss Post Parcel Images via JavaScript via C++
description: JavaScript sample code to scan and decode Swiss Post Parcel in any modern browser using WebAssembly-based library.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /javascript-cpp/swiss-post-parcel/recognize/
aliases:
- /javascript-cpp/recognize/swiss-post-parcel/
- /nl/javascript-cpp/swiss-post-parcel/recognize/
- /sv/javascript-cpp/swiss-post-parcel/recognize/
- /hu/javascript-cpp/swiss-post-parcel/recognize/
- /hi/javascript-cpp/swiss-post-parcel/recognize/
- /el/javascript-cpp/swiss-post-parcel/recognize/
- /cs/javascript-cpp/swiss-post-parcel/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Swiss Post Parcel Barcodes with JavaScript via C++" h2="Read Swiss Post Parcel in JavaScript using server-side Aspose.BarCode for JavaScript via C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-javascript-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for JavaScript via C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Swiss Post Parcel in JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode allows developers to read Swiss Post Parcel barcodes from stream or image with few lines of code

{{% /blocks/products/pf/agp/text %}}

<ul><li>Create instance of BarCode module</li><li>Create a new instance of Aspose.BarCode.BarCodeReader class</li><li>Pass the source image path containing Swiss Post Parcel as a parameter</li><li>Pass an appropriate DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the CodeText property</li></ul>
