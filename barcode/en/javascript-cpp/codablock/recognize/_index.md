---
title: Scan Codablock-F and GS1 Codablock-F barcodes Images via JavaScript via C++
description: JavaScript sample code to scan and decode Codablock-F and GS1 Codablock-F barcodes in any modern browser using WebAssembly-based library.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /javascript-cpp/codablock/recognize/
aliases:
- /javascript-cpp/recognize/codablock/
- /nl/javascript-cpp/codablock/recognize/
- /sv/javascript-cpp/codablock/recognize/
- /hu/javascript-cpp/codablock/recognize/
- /hi/javascript-cpp/codablock/recognize/
- /el/javascript-cpp/codablock/recognize/
- /cs/javascript-cpp/codablock/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Codablock-F Barcodes with JavaScript via C++" h2="Read Codablock-F and GS1 Codablock-F barcodes in JavaScript using server-side Aspose.BarCode for JavaScript via C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-javascript-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for JavaScript via C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Codablock-F barcode in JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode allows developers to read Codablock-F barcode barcodes from stream or image with few lines of code

{{% /blocks/products/pf/agp/text %}}

<ul><li>Create instance of BarCode module</li><li>Create a new instance of Aspose.BarCode.BarCodeReader class</li><li>Pass the source image path containing Codablock-F and GS1 Codablock-F barcodes as a parameter</li><li>Pass an appropriate DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the CodeText property</li></ul>
