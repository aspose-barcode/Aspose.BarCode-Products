---
title: Scan Standard 2 of 5 (Industrial 2 of 5) barcode Images via JavaScript via C++
description: JavaScript sample code to scan and decode Standard 2 of 5 (Industrial 2 of 5) barcode in any modern browser using WebAssembly-based library.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /javascript-cpp/standard2of5/recognize/
aliases:
- /javascript-cpp/recognize/standard2of5/
- /nl/javascript-cpp/standard2of5/recognize/
- /sv/javascript-cpp/standard2of5/recognize/
- /hu/javascript-cpp/standard2of5/recognize/
- /hi/javascript-cpp/standard2of5/recognize/
- /el/javascript-cpp/standard2of5/recognize/
- /cs/javascript-cpp/standard2of5/recognize/
- /javascript-cpp/recognize/iata2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Standard 2 of 5 Barcodes with JavaScript via C++" h2="Read Standard 2 of 5 (Industrial 2 of 5) barcode in JavaScript using server-side Aspose.BarCode for JavaScript via C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-javascript-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for JavaScript via C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Standard 2 of 5 barcode in JavaScript" %}}
...
<ul><li>Create instance of BarCode module</li><li>Create a new instance of Aspose.BarCode.BarCodeReader class</li><li>Pass the source image path containing Standard 2 of 5 (Industrial 2 of 5) barcode as a parameter</li><li>Pass an appropriate DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the CodeText property</li></ul>
...
reader.<span class="hljs-title function_">delete</span>()</code>
    ...
    <script>
        ...
        async function recognizeBarcodeAsync() {
            ...
            let barcodetypeUrl = "Standard2of5";
            if (barcodetypeUrl === "") {
                barcodetypeUrl = button.siblings("select").val();
                barcodetypeUrl = barcodetypeUrl === "Standard2of5" ? "" : barcodetypeUrl;
            }
            let quality = 2;
