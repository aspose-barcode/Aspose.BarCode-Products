---
title: Generate Standard 2 of 5 (Industrial 2 of 5) barcode Images via JavaScript via C++
description: JavaScript example of code to generate Standard 2 of 5 (Industrial 2 of 5) barcode in any modern browser using WebAssembly-based library.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /javascript-cpp/standard2of5/generate/
aliases:
- /javascript-cpp/generate/standard2of5/
- /nl/javascript-cpp/standard2of5/generate/
- /sv/javascript-cpp/standard2of5/generate/
- /hu/javascript-cpp/standard2of5/generate/
- /hi/javascript-cpp/standard2of5/generate/
- /el/javascript-cpp/standard2of5/generate/
- /cs/javascript-cpp/standard2of5/generate/
- /javascript-cpp/generate/iata2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Standard 2 of 5 Labels with JavaScript via C++" h2="Create Standard 2 of 5 (Industrial 2 of 5) barcode in JavaScript using server-side Aspose.BarCode for JavaScript via C++ API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-javascript-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Standard 2 of 5" pfName="Aspose.BarCode" subTitlepfName="for JavaScript via C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Create instance of BarCode module</li><li>Create an instance of BarcodeGenerator class</li><li>Pass Standard 2 of 5 (Industrial 2 of 5) barcode type as a parameter</li><li>Set text to encode as the second parameter</li><li>Specify barcode dimensions if required</li><li>Call the BarcodeGenerator.GenerateBarCodeImage method to obtain the Standard 2 of 5 (Industrial 2 of 5) barcode image</li></ul>
...
<span class="hljs-keyword">var</span> generator = <span class="hljs-keyword">new</span> <span class="hljs-title class_">BarCodeInstance</span>.<span class="hljs-title class_">BarcodeGenerator</span>(<span class="hljs-string">"<span class="barcode-gen-lcs-type-param">Standard2of5</span>"</span>, <span class="hljs-string">"<span class="hljs-string barcode-gen-lcs-codetext-param"></span>"</span>);
