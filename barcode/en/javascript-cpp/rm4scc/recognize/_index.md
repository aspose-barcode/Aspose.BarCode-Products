---
title: Scan Royal Mail 4-State Customer Code (RM4SCC) Images via JavaScript via C++
description: JavaScript sample code to scan and decode Royal Mail 4-State Customer Code (RM4SCC) in any modern browser using WebAssembly-based library.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /javascript-cpp/rm4scc/recognize/
aliases:
- /javascript-cpp/recognize/rm4scc/
- /nl/javascript-cpp/rm4scc/recognize/
- /sv/javascript-cpp/rm4scc/recognize/
- /hu/javascript-cpp/rm4scc/recognize/
- /hi/javascript-cpp/rm4scc/recognize/
- /el/javascript-cpp/rm4scc/recognize/
- /cs/javascript-cpp/rm4scc/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read RM4SCC Barcodes with JavaScript via C++" h2="Read Royal Mail 4-State Customer Code (RM4SCC) in JavaScript using server-side Aspose.BarCode for JavaScript via C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-javascript-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for JavaScript via C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Royal Mail 4-State Customer Code (RM4SCC) in JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode allows developers to read Royal Mail 4-State Customer Code (RM4SCC) barcodes from stream or image with few lines of code

{{% /blocks/products/pf/agp/text %}}

<ul><li>Create instance of BarCode module</li><li>Create a new instance of Aspose.BarCode.BarCodeReader class</li><li>Pass the source image path containing Royal Mail 4-State Customer Code (RM4SCC) as a parameter</li><li>Pass an appropriate DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the CodeText property</li></ul>
...
reader.<span class="hljs-title function_">delete</span>()</code>
    ...
    <script>
        ...
        async function recognizeBarcodeAsync() {
            ...
            let barcodetypeUrl = "RM4SCC";
            if (barcodetypeUrl === "") {
                barcodetypeUrl = button.siblings("select").val();
                barcodetypeUrl = barcodetypeUrl === "RM4SCC" ? "" : barcodetypeUrl;
            }
            let quality = 2;
