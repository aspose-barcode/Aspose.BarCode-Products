---
title: Scan USPS OneCode barcode Images via JavaScript via C++
description: JavaScript sample code to scan and decode USPS OneCode barcode in any modern browser using WebAssembly-based library.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /javascript-cpp/onecode/recognize/
aliases:
- /javascript-cpp/recognize/onecode/
- /nl/javascript-cpp/onecode/recognize/
- /sv/javascript-cpp/onecode/recognize/
- /hu/javascript-cpp/onecode/recognize/
- /hi/javascript-cpp/onecode/recognize/
- /el/javascript-cpp/onecode/recognize/
- /cs/javascript-cpp/onecode/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read USPS OneCode Barcodes with JavaScript via C++" h2="Read USPS OneCode barcode in JavaScript using server-side Aspose.BarCode for JavaScript via C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-javascript-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="USPS OneCode" pfName="Aspose.BarCode" subTitlepfName="for JavaScript via C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning USPS OneCode barcocde in JavaScript" %}}
...
<ul><li>Create instance of BarCode module</li><li>Create a new instance of Aspose.BarCode.BarCodeReader class</li><li>Pass the source image path containing USPS OneCode barcode as a parameter</li><li>Pass an appropriate DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the CodeText property</li></ul>
...
reader.<span class="hljs-title function_">delete</span>()</code>
    ...
    <script>
        ...
        async function recognizeBarcodeAsync() {
            ...
            let barcodetypeUrl = "OneCode";
            if (barcodetypeUrl === "") {
                barcodetypeUrl = button.siblings("select").val();
                barcodetypeUrl = barcodetypeUrl === "OneCode" ? "" : barcodetypeUrl;
            }
            let quality = 2;
