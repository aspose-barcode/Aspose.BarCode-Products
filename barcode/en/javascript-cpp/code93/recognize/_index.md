---
title: Scan Code 93 Extended and Code 93 Standard barcodes Images via JavaScript via C++
description: JavaScript sample code to scan and decode Code 93 Extended and Code 93 Standard barcodes in any modern browser using WebAssembly-based library.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /javascript-cpp/code93/recognize/
aliases:
- /javascript-cpp/recognize/code93/
- /nl/javascript-cpp/code93/recognize/
- /sv/javascript-cpp/code93/recognize/
- /hu/javascript-cpp/code93/recognize/
- /hi/javascript-cpp/code93/recognize/
- /el/javascript-cpp/code93/recognize/
- /cs/javascript-cpp/code93/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Code 93 Barcodes with JavaScript via C++" h2="Read Code 93 Extended and Code 93 Standard barcodes in JavaScript using server-side Aspose.BarCode for JavaScript via C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-javascript-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for JavaScript via C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Code 93 barcode in JavaScript" %}}
...
<ul><li>Create instance of BarCode module</li><li>Create a new instance of Aspose.BarCode.BarCodeReader class</li><li>Pass the source image path containing Code 93 Extended and Code 93 Standard barcodes as a parameter</li><li>Pass an appropriate DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the CodeText property</li></ul>
...
reader.<span class="hljs-title function_">delete</span>()</code>
    ...
    <script>
        ...
        async function recognizeBarcodeAsync() {
            ...
            let barcodetypeUrl = "Code93";
            if (barcodetypeUrl === "") {
                barcodetypeUrl = button.siblings("select").val();
                barcodetypeUrl = barcodetypeUrl === "Code93" ? "" : barcodetypeUrl;
            }
            let quality = 2;
