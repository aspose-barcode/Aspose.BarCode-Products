---
title: Scan Deutsche Post Identcode and Deutsche Post Leitcode Images via .NET
description: C# sample code to scan and decode Deutsche Post Identcode and Deutsche Post Leitcode barcode type in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, or C++.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /net/deutsche-post/recognize/
aliases:
- /net/recognize/deutsche-post/
- /nl/net/deutsche-post/recognize/
- /sv/net/deutsche-post/recognize/
- /hu/net/deutsche-post/recognize/
...
{{< blocks/products/pf/upper-banner h1="Read Deutsche Post Barcodes with .NET" h2="Read Deutsche Post Identcode and Deutsche Post Leitcode in C# using server-side Aspose.BarCode for .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Create a new instance of Aspose.BarCode.BarCodeReader class</li><li>Pass the source image path containing Deutsche Post barcode as a parameter</li><li>Pass an appropriate DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the CodeText property</li></ul>
