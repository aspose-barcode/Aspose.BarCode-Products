---
title: Generate QR Code Images via .NET
weight: 1510
url: /net/generate/qr/
description: C# source code for QR Code generation in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, and C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate QR Labels with .NET" h2="Create QR Code in C# using server-side Aspose.BarCode for .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate QR Code Using .NET" %}}
To create QR Code, try [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, a feature-rich, powerful, and easy-to-use barcode library for C# platforms. Open the [NuGet](https://www.nuget.org/packages/aspose.barcode) package manager, search for **Aspose.BarCode** and install the package. You may also run the following command from the Package Manager console:
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate QR Code in C#" %}}
...
<ul><li>Create an instance of BarcodeGenerator class</li><li>Pass QR Code as a parameter</li><li>Set text to encode as the second parameter</li><li>Specify barcode dimensions if required</li><li>Call the BarcodeGenerator.Save method to obtain the QR Code image</li></ul>
