...
{{% blocks/products/pf/agp/content h2="How to Generate EAN barcode Using .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate EAN barcode in C#" %}}
...
<ul><li>Create an instance of BarcodeGenerator class</li><li>Pass EAN barcode as a parameter</li><li>Set text to encode as the second parameter</li><li>Specify barcode dimensions if required</li><li>Call the BarcodeGenerator.Save method to obtain the EAN barcode image</li></ul>
...
<span class="hljs-keyword">using</span> (<span class="hljs-keyword">var</span> generator = <span class="hljs-keyword">new</span> Aspose.BarCode.Generation.BarcodeGenerator(EncodeTypes.<span class="barcode-gen-lcs-type-param">EAN</span>, &quot;<span class="hljs-string barcode-gen-lcs-codetext-param"></span>&quot;))
{
