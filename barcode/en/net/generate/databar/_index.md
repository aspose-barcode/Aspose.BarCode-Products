---
title: Generate DataBar barcode Images via .NET
weight: 1510
url: /net/generate/databar/
description: C# source code for DataBar barcode generation in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, and C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate DataBar Labels with .NET" h2="Create DataBar barcode in C# using server-side Aspose.BarCode for .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DataBar" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate DataBar barcode Using .NET" %}}
To create DataBar barcode, try [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, a feature-rich, powerful, and easy-to-use barcode library for C# platforms. Open the [NuGet](https://www.nuget.org/packages/aspose.barcode) package manager, search for **Aspose.BarCode** and install the package. You may also run the following command from the Package Manager console:
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate DataBar barcode in C#" %}}
...
<ul><li>Create an instance of BarcodeGenerator class</li><li>Pass DataBar barcode as a parameter</li><li>Set text to encode as the second parameter</li><li>Specify barcode dimensions if required</li><li>Call the BarcodeGenerator.Save method to obtain the DataBar barcode image</li></ul>
...
<span class="hljs-keyword">using</span> (<span class="hljs-keyword">var</span> generator = <span class="hljs-keyword">new</span> Aspose.BarCode.Generation.BarcodeGenerator(EncodeTypes.<span class="barcode-gen-lcs-type-param">DataBar</span>, &quot;<span class="hljs-string barcode-gen-lcs-codetext-param"></span>&quot;))
{
