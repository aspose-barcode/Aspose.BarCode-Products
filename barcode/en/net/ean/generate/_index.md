---
title: Generate EAN (International Article Number) barcode Images via .NET
description: C# source code for EAN (International Article Number) barcode generation in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, and C++.
lang: 
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="How to Generate EAN (International Article Number) barcode Using .NET" %}}
To create EAN (International Article Number) barcode, try [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, a feature-rich, powerful, and easy-to-use barcode library for C# platforms. Open the [NuGet](https://www.nuget.org/packages/aspose.barcode) package manager, search for **Aspose.BarCode** and install the package. You may also run the following command from the Package Manager console:
...
<ul><li>Create an instance of BarcodeGenerator class</li><li>Pass EAN (International Article Number) barcode as a parameter</li><li>Set text to encode as the second parameter</li><li>Specify barcode dimensions if required</li><li>Call the BarcodeGenerator.Save method to obtain the EAN (International Article Number) barcode image</li></ul>
