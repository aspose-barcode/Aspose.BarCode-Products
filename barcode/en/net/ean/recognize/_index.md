---
title: Scan EAN (International Article Number) barcode Images via .NET
weight: 1510
description: C# sample code to scan and decode EAN (International Article Number) barcode barcode type in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, or C++.
lang: 
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Read EAN Barcodes with .NET" h2="Read EAN (International Article Number) barcode in C# using server-side Aspose.BarCode for .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read EAN (International Article Number) barcode Using .NET" %}}
To decode EAN (International Article Number) barcode, try [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, a feature-rich, powerful, and easy-to-use barcode library for C# platforms. Usen [NuGet](https://www.nuget.org/packages/aspose.barcode) and search for **Aspose.BarCode** to install the package. Alternatively, run the following command from the Package Manager console:
