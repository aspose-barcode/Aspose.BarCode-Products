...
description: C# source code for ISBN barcode generation in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, and C++.
lang: en
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate ISBN barcode in C#" %}}
...
<ul><li>Create an instance of BarcodeGenerator class</li><li>Pass ISBN barcode as a parameter</li><li>Set text to encode as the second parameter</li><li>Specify barcode dimensions if required</li><li>Call the BarcodeGenerator.Save method to obtain the ISBN barcode image</li></ul>
