---
title: Scan Aztec Code Images via .NET
weight: 1510
url: /net/recognize/aztec/
description: C# sample code to scan and decode Aztec Code barcode type in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, or C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Aztec Barcodes with .NET" h2="Read Aztec Code in C# using server-side Aspose.BarCode for .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Aztec Code Using .NET" %}}
To decode Aztec Code, try [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, a feature-rich, powerful, and easy-to-use barcode library for C# platforms. Usen [NuGet](https://www.nuget.org/packages/aspose.barcode) and search for **Aspose.BarCode** to install the package. Alternatively, run the following command from the Package Manager console:
...
<ul><li>Create a new instance of Aspose.BarCode.BarCodeReader class</li><li>Pass the source image path containing Aztec Code as a parameter</li><li>Pass an appropriate DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the CodeText property</li></ul>
