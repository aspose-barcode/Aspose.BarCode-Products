---
title: Generate UPC (Universal Product Code) barcode Images via .NET
description: C# source code for UPC (Universal Product Code) barcode generation in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, and C++.
lang: 
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate UPC (Universal Product Code) barcode in C#" %}}
