---
title: Scan UPC (Universal Product Code) barcode Images via .NET
description: C# sample code to scan and decode UPC (Universal Product Code) barcode barcode type in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, or C++.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /net/upc/recognize/
aliases:
- /net/recognize/upc/
- /nl/net/upc/recognize/
- /sv/net/upc/recognize/
- /hu/net/upc/recognize/
- /hi/net/upc/recognize/
- /el/net/upc/recognize/
- /cs/net/upc/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read UPC Barcodes with .NET" h2="Read UPC (Universal Product Code) barcode in C# using server-side Aspose.BarCode for .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="UPC" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
