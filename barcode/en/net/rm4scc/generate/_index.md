---
title: Generate Royal Mail 4-State Customer Code (RM4SCC) Images via .NET
weight: 1510
description: C# source code for Royal Mail 4-State Customer Code (RM4SCC) generation in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, and C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate RM4SCC Labels with .NET" h2="Create Royal Mail 4-State Customer Code (RM4SCC) in C# using server-side Aspose.BarCode for .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Royal Mail 4-State Customer Code (RM4SCC) in C#" %}}
...
<ul><li>Create an instance of BarcodeGenerator class</li><li>Pass Royal Mail 4-State Customer Code (RM4SCC) as a parameter</li><li>Set text to encode as the second parameter</li><li>Specify barcode dimensions if required</li><li>Call the BarcodeGenerator.Save method to obtain the Royal Mail 4-State Customer Code (RM4SCC) image</li></ul>
