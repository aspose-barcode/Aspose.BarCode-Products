---
title: Generate Australia Post barcode and Australia Post eParcel Images via .NET
description: C# source code for Australia Post barcode and Australia Post eParcel generation in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, and C++.
lang: en
langdirlevel: 2
...
- /net/generate/australiapost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Australia Post Labels with .NET" h2="Create Australia Post barcode and Australia Post eParcel in C# using server-side Aspose.BarCode for .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Australia Post barcode in C#" %}}
...
<ul><li>Create an instance of BarcodeGenerator class</li><li>Pass Australia Post barcode and Australia Post eParcel as a parameter</li><li>Set text to encode as the second parameter</li><li>Specify barcode dimensions if required</li><li>Call the BarcodeGenerator.Save method to obtain the Australia Post barcode and Australia Post eParcel image</li></ul>
