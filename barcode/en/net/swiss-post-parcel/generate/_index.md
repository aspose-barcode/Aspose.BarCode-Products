---
title: Generate Swiss Post Parcel Images via .NET
description: C# source code for Swiss Post Parcel generation in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, and C++.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /net/swiss-post-parcel/generate/
aliases:
- /net/generate/swiss-post-parcel/
- /nl/net/swiss-post-parcel/generate/
- /sv/net/swiss-post-parcel/generate/
- /hu/net/swiss-post-parcel/generate/
- /hi/net/swiss-post-parcel/generate/
- /el/net/swiss-post-parcel/generate/
- /cs/net/swiss-post-parcel/generate/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Swiss Post Parcel Labels with .NET" h2="Create Swiss Post Parcel in C# using server-side Aspose.BarCode for .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Swiss Post Parcel in C#" %}}
...
<ul><li>Create an instance of BarcodeGenerator class</li><li>Pass Swiss Post Parcel as a parameter</li><li>Set text to encode as the second parameter</li><li>Specify barcode dimensions if required</li><li>Call the BarcodeGenerator.Save method to obtain the Swiss Post Parcel image</li></ul>
