---
title: Generate Code 93 Extended and Code 93 Standard barcodes Images via .NET
description: C# source code for Code 93 Extended and Code 93 Standard barcodes generation in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, and C++.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /net/code93/generate/
aliases:
- /net/generate/code93/
- /nl/net/code93/generate/
- /sv/net/code93/generate/
- /hu/net/code93/generate/
- /hi/net/code93/generate/
- /el/net/code93/generate/
- /cs/net/code93/generate/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Code 93 Labels with .NET" h2="Create Code 93 Extended and Code 93 Standard barcodes in C# using server-side Aspose.BarCode for .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Code 93 barcode in C#" %}}
...
<ul><li>Create an instance of BarcodeGenerator class</li><li>Pass Code 93 Extended and Code 93 Standard barcodes as a parameter</li><li>Set text to encode as the second parameter</li><li>Specify barcode dimensions if required</li><li>Call the BarcodeGenerator.Save method to obtain the Code 93 Extended and Code 93 Standard barcodes image</li></ul>
