...
{{< blocks/products/pf/upper-banner h1="Generate Codablock-F Labels with .NET" h2="Create Codablock-F and GS1 Codablock-F barcodes in C# using server-side Aspose.BarCode for .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Create an instance of BarcodeGenerator class</li><li>Pass Codablock-F and GS1 Codablock-F barcodes as a parameter</li><li>Set text to encode as the second parameter</li><li>Specify barcode dimensions if required</li><li>Call the BarcodeGenerator.Save method to obtain the Codablock-F and GS1 Codablock-F barcodes image</li></ul>
