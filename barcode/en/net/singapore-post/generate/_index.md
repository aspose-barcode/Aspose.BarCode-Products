---
title: Generate Singapore Post barcode Images via .NET
description: C# source code for Singapore Post barcode generation in .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, and C++.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /net/singapore-post/generate/
aliases:
- /net/generate/singapore-post/
- /nl/net/singapore-post/generate/
- /sv/net/singapore-post/generate/
- /hu/net/singapore-post/generate/
- /hi/net/singapore-post/generate/
- /el/net/singapore-post/generate/
- /cs/net/singapore-post/generate/
- /net/generate/singaporepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Singapore Post Labels with .NET" h2="Create Singapore Post barcode in C# using server-side Aspose.BarCode for .NET API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Singapore Post barcode in C#" %}}
...
<ul><li>Create an instance of BarcodeGenerator class</li><li>Pass Singapore Post barcode as a parameter</li><li>Set text to encode as the second parameter</li><li>Specify barcode dimensions if required</li><li>Call the BarcodeGenerator.Save method to obtain the Singapore Post barcode image</li></ul>
