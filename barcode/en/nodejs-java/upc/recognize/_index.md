---
title: Scan UPC (Universal Product Code) barcode Images via Node.js via Java
weight: 1510
description: Node.js source code for UPC (Universal Product Code) barcode scanning and decoding in JavaScript applications.
lang: 
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning UPC (Universal Product Code) barcode in JavaScript" %}}
