...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Standard 2 of 5 barcode in JavaScript" %}}
...
<ul><li>Create an instance of BarCodeGenerator class</li><li>Set Standard 2 of 5 barcode as the EncodeTypes parameter</li><li>Define text to encode as the second parameter</li><li>Determine barcode dimensions and location if needed</li><li>Call the BarCodeGenerator.save method to get the generated barcode image</li></ul>
