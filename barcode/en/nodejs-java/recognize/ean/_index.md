...
{{% blocks/products/pf/agp/content h2="How to Read EAN barcode Using Node.js via Java" %}}
To recognize EAN barcode within Node.js applications, use Aspose.BarCode for Node.js via Java, a robust, versatile, and user-friendly barcode library introduced for Java-based environments. You can load [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) for Javascript directly from NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning EAN barcode in JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode allows developers to read EAN barcode barcodes from stream or image with few lines of code

{{% /blocks/products/pf/agp/text %}}

<ul><li>Create an object of Aspose.BarCode.BarCodeReader class</li><li>Pass the source file path containing EAN barcode as a parameter</li><li>Set target barcodes types in DecodeType as the second parameter</li><li>Loop through all detected barcodes</li><li>Fetch the resulting barcode text using the CodeText property</li></ul>
...
reader.<span class="hljs-title function_">readBarCodes</span>().<span class="hljs-title function_">forEach</span>(<span class="hljs-keyword">function</span> (<span class="hljs-params">result, i, results</span>)
{
    ...
    <script>
        ...
        async function recognizeBarcodeAsync() {
            ...
            let barcodetypeUrl = "EAN";
            if (barcodetypeUrl === "") {
                barcodetypeUrl = button.siblings("select").val();
                barcodetypeUrl = barcodetypeUrl === "EAN" ? "" : barcodetypeUrl;
            }
            let quality = 2;
...
{{< blocks/products/pf/agp/demobox sectionTitle="Scan EAN barcode" sectionDescription="[BarCode Reader App](https://products.aspose.app/barcode/recognize/ean)" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="No need to download Aspose API" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="Just insert the source file path" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Select EAN barcode from the dropdown list" >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text="Instantly get the EAN barcode decoded data" >}}
