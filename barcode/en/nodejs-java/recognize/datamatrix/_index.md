...
{{% blocks/products/pf/agp/content h2="How to Read Data Matrix code Using Node.js via Java" %}}
To recognize Data Matrix code within Node.js applications, use Aspose.BarCode for Node.js via Java, a robust, versatile, and user-friendly barcode library introduced for Java-based environments. You can load [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) for Javascript directly from NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Data Matrix code in JavaScript" %}}
