---
title: Scan Code 128 barcode Images via Node.js via Java
weight: 1510
url: /nodejs-java/recognize/code128/
description: Node.js source code for Code 128 barcode scanning and decoding in JavaScript applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Code 128 Barcodes with Node.js via Java" h2="Read Code 128 barcode in JavaScript using server-side Aspose.BarCode for Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 128" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 128 barcode Using Node.js via Java" %}}
To recognize Code 128 barcode within Node.js applications, use Aspose.BarCode for Node.js via Java, a robust, versatile, and user-friendly barcode library introduced for Java-based environments. You can load [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) for Javascript directly from NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Code 128 barcode in JavaScript" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode allows developers to read Code 128 barcode barcodes from stream or image with few lines of code

{{% /blocks/products/pf/agp/text %}}

<ul><li>Create an object of Aspose.BarCode.BarCodeReader class</li><li>Pass the source file path containing Code 128 barcode as a parameter</li><li>Set target barcodes types in DecodeType as the second parameter</li><li>Loop through all detected barcodes</li><li>Fetch the resulting barcode text using the CodeText property</li></ul>
...
{{< blocks/products/pf/agp/demobox sectionTitle="Scan Code 128 barcode" sectionDescription="[BarCode Reader App](https://products.aspose.app/barcode/recognize/code128)" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text="Instantly get the Code 128 barcode decoded data" >}}
