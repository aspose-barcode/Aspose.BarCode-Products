---
title: Scan Royal Mail 4-State Customer Code (RM4SCC) Images via Node.js via Java
description: Node.js source code for Royal Mail 4-State Customer Code (RM4SCC) scanning and decoding in JavaScript applications.
lang: en
langdirlevel: 2
