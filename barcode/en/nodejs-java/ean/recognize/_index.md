---
title: Scan EAN (International Article Number) barcode Images via Node.js via Java
description: Node.js source code for EAN (International Article Number) barcode scanning and decoding in JavaScript applications.
lang: en
langdirlevel: 2
