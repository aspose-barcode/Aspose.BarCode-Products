---
title: Generate EAN (International Article Number) barcode Images via Node.js via Java
description: Node.js sample code for EAN (International Article Number) barcode generation in JavaScript applications.
lang: 
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate EAN (International Article Number) barcode in JavaScript" %}}
...
<ul><li>Create an instance of BarCodeGenerator class</li><li>Set EAN (International Article Number) barcode as the EncodeTypes parameter</li><li>Define text to encode as the second parameter</li><li>Determine barcode dimensions and location if needed</li><li>Call the BarCodeGenerator.save method to get the generated barcode image</li></ul>
