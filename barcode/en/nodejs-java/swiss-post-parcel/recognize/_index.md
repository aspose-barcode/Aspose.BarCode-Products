---
title: Scan Swiss Post Parcel Images via Node.js via Java
description: Node.js source code for Swiss Post Parcel scanning and decoding in JavaScript applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /nodejs-java/swiss-post-parcel/recognize/
aliases:
- /nodejs-java/recognize/swiss-post-parcel/
- /nl/nodejs-java/swiss-post-parcel/recognize/
- /sv/nodejs-java/swiss-post-parcel/recognize/
- /hu/nodejs-java/swiss-post-parcel/recognize/
- /hi/nodejs-java/swiss-post-parcel/recognize/
- /el/nodejs-java/swiss-post-parcel/recognize/
- /cs/nodejs-java/swiss-post-parcel/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Swiss Post Parcel Barcodes with Node.js via Java" h2="Read Swiss Post Parcel in JavaScript using server-side Aspose.BarCode for Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
To recognize Swiss Post Parcel within Node.js applications, use Aspose.BarCode for Node.js via Java, a robust, versatile, and user-friendly barcode library introduced for Java-based environments. You can load [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) for Javascript directly from NPM:
