---
title: Generate Swiss Post Parcel Images via Node.js via Java
description: Node.js sample code for Swiss Post Parcel generation in JavaScript applications.
lang: en
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Swiss Post Parcel in JavaScript" %}}
...
<ul><li>Create an instance of BarCodeGenerator class</li><li>Set Swiss Post Parcel as the EncodeTypes parameter</li><li>Define text to encode as the second parameter</li><li>Determine barcode dimensions and location if needed</li><li>Call the BarCodeGenerator.save method to get the generated barcode image</li></ul>
