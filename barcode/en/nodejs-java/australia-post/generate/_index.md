---
title: Generate Australia Post barcode and Australia Post eParcel Images via Node.js via Java
description: Node.js sample code for Australia Post barcode and Australia Post eParcel generation in JavaScript applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /nodejs-java/australia-post/generate/
aliases:
- /nodejs-java/generate/australia-post/
- /nl/nodejs-java/australia-post/generate/
- /sv/nodejs-java/australia-post/generate/
- /hu/nodejs-java/australia-post/generate/
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Australia Post barcode in JavaScript" %}}
...
<ul><li>Create an instance of BarCodeGenerator class</li><li>Set Australia Post barcode as the EncodeTypes parameter</li><li>Define text to encode as the second parameter</li><li>Determine barcode dimensions and location if needed</li><li>Call the BarCodeGenerator.save method to get the generated barcode image</li></ul>
