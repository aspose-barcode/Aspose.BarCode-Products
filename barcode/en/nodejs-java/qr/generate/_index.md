---
title: Generate QR Code, GS1 QR Code Images via Node.js via Java
description: Node.js sample code for QR Code, GS1 QR Code generation in JavaScript applications.
lang: en
langdirlevel: 2
