---
title: Scan Code 93 Extended and Code 93 Standard barcodes Images via Node.js via Java
description: Node.js source code for Code 93 Extended and Code 93 Standard barcodes scanning and decoding in JavaScript applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /nodejs-java/code93/recognize/
aliases:
- /nodejs-java/recognize/code93/
- /nl/nodejs-java/code93/recognize/
- /sv/nodejs-java/code93/recognize/
- /hu/nodejs-java/code93/recognize/
- /hi/nodejs-java/code93/recognize/
- /el/nodejs-java/code93/recognize/
- /cs/nodejs-java/code93/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Code 93 Barcodes with Node.js via Java" h2="Read Code 93 Extended and Code 93 Standard barcodes in JavaScript using server-side Aspose.BarCode for Node.js via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
To recognize Code 93 barcode within Node.js applications, use Aspose.BarCode for Node.js via Java, a robust, versatile, and user-friendly barcode library introduced for Java-based environments. You can load [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) for Javascript directly from NPM:
