---
title: Scan Standard 2 of 5 (Industrial 2 of 5) barcode Images via Python via Java
description: Python source code for Standard 2 of 5 (Industrial 2 of 5) barcode recognition using Java Runtime Environment.
lang: en
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Standard 2 of 5 barcode in Python" %}}
...
<ul><li>Create an object of Aspose.BarCode.BarCodeReader class</li><li>Define the source file path containing Standard 2 of 5 barcode as a parameter</li><li>Determine the required barcodes types in DecodeType as the second parameter</li><li>Loop through the decoding outcomes</li><li>Get the barcode text using the CodeText property</li></ul>
