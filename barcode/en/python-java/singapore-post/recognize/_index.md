---
title: Scan Singapore Post barcode Images via Python via Java
description: Python source code for Singapore Post barcode recognition using Java Runtime Environment.
lang: en
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Read Singapore Post Barcodes with Python via Java" h2="Read Singapore Post barcode in Python using server-side Aspose.BarCode for Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Singapore Post barcode in Python" %}}
...
<ul><li>Create an object of Aspose.BarCode.BarCodeReader class</li><li>Define the source file path containing Singapore Post barcode as a parameter</li><li>Determine the required barcodes types in DecodeType as the second parameter</li><li>Loop through the decoding outcomes</li><li>Get the barcode text using the CodeText property</li></ul>
