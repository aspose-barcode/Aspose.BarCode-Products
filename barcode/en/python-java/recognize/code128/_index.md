---
title: Scan Code 128 barcode Images via Python via Java
weight: 1510
url: /python-java/recognize/code128/
description: Python source code for Code 128 barcode recognition using Java Runtime Environment.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Code 128 Barcodes with Python via Java" h2="Read Code 128 barcode in Python using server-side Aspose.BarCode for Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 128" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 128 barcode Using Python via Java" %}}
To scan and decode Code 128 barcode, install [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, a versatile, powerful, and easy-to-use barcode library for Python-based applications. Get the latest version directly from the [Aspose releases](https://releases.aspose.com/barcode/python-java/) portal or install 'aspose-barcode' from pip by running the following command:
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Code 128 barcode in Python" %}}
...
<ul><li>Create an object of Aspose.BarCode.BarCodeReader class</li><li>Define the source file path containing Code 128 barcode as a parameter</li><li>Determine the required barcodes types in DecodeType as the second parameter</li><li>Loop through the decoding outcomes</li><li>Get the barcode text using the CodeText property</li></ul>
...
<span class="hljs-keyword">class</span> <span class="hljs-title class_">BarcodeReaderExamples</span>():
    <span class="hljs-keyword">def</span> <span class="hljs-title function_">readBarcodeImage</span>(<span class="hljs-params">self</span>):
        ...
        reader = Recognition.BarcodeReader(image_data_base64, <span class="hljs-literal">None</span>, Recognition.DecodeType.<span class="barcode-read-lcs-type">Code128</span>)
