---
title: Generate USPS OneCode barcode Images via Python via Java
description: Python sample code to generate USPS OneCode barcode using Java Runtime Environment.
lang: en
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate USPS OneCode barcocde in Python" %}}
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Determine the desired barcode types as the EncodeTypes parameter</li><li>Insert input text as the second parameter</li><li>Call the BarCodeGenerator.save method to get the generated USPS OneCode barcode image</li></ul>
