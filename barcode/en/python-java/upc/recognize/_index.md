---
title: Scan UPC (Universal Product Code) barcode Images via Python via Java
weight: 1510
description: Python source code for UPC (Universal Product Code) barcode recognition using Java Runtime Environment.
lang: 
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning UPC (Universal Product Code) barcode in Python" %}}
...
<ul><li>Create an object of Aspose.BarCode.BarCodeReader class</li><li>Define the source file path containing UPC (Universal Product Code) barcode as a parameter</li><li>Determine the required barcodes types in DecodeType as the second parameter</li><li>Loop through the decoding outcomes</li><li>Get the barcode text using the CodeText property</li></ul>
