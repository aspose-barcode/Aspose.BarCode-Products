---
title: Generate HIBC (Health Industry Bar Code) Images via Python via Java
weight: 1510
description: Python sample code to generate HIBC (Health Industry Bar Code) using Java Runtime Environment.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate HIBC Labels with Python via Java" h2="Create HIBC (Health Industry Bar Code) in Python using server-side Aspose.BarCode for Python via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HIBC" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate HIBC (Health Industry Bar Code) Using Python via Java" %}}
To make HIBC (Health Industry Bar Code) images, get [Aspose.BarCode for Python via Java](https://products.aspose.com/barcode/python-java/) API, a feature-rich, powerful, and easy-to-use barcode library for Python-based applications. Get the latest version directly from the [Aspose releases](https://releases.aspose.com/barcode/python-java/) portal or install 'aspose-barcode' from pip with the following command:
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate HIBC (Health Industry Bar Code) in Python" %}}
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Determine the desired barcode types as the EncodeTypes parameter</li><li>Insert input text as the second parameter</li><li>Call the BarCodeGenerator.save method to get the generated HIBC (Health Industry Bar Code) image</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/pdf417/generate/" name="PDF417" description="PDF417 barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/qr/generate/" name="QR" description="QR Code, GS1 QR Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/datamatrix/generate/" name="Data Matrix" description="Data Matrix code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/aztec/generate/" name="Aztec" description="Aztec Code" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/swiss-qr/generate/" name="Swiss QR" description="Swiss QR bill" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/dotcode/generate/" name="DotCode" description="DotCode barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/hibc/generate/" name="HIBC" description="HIBC (Health Industry Bar Code)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/codablock/generate/" name="Codablock-F" description="Codablock-F and GS1 Codablock-F barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/databar/generate/" name="GS1 DataBar" description="GS1 DataBar (Omnidirectional, Stacked Omnidirectional, Expanded, Expanded Stacked, and Truncated) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/itf/generate/" name="ITF" description="Interleaved 2-of-5 (ITF) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/ean/generate/" name="EAN" description="EAN barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/upc/generate/" name="UPC" description="UPC barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/code128/generate/" name="GS1 Code 128" description="GS1 Code 128 barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/code39/generate/" name="Code 39" description="Code 39 barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/code16k/generate/" name="Code 16K" description="Code 16K barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/code32/generate/" name="Code 32" description="Italian Pharmacode (Code 32) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/code93/generate/" name="Code 93" description="Code 93 Extended and Code 93 Standard barcodes" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/onecode/generate/" name="USPS OneCode" description="USPS OneCode barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/standard2of5/generate/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 of 5) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/isbn/generate/" name="ISBN" description="ISBN barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/ismn/generate/" name="ISMN" description="ISMN barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/issn/generate/" name="ISSN" description="ISSN barcode" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/australia-post/generate/" name="Australia Post" description="Australia Post barcode and Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Identcode and Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/rm4scc/generate/" name="RM4SCC" description="Royal Mail 4-State Customer Code (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/postnet/generate/" name="Postnet" description="Postnet barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/royal-mail/generate/" name="Royal Mail" description="Royal Mail barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/singapore-post/generate/" name="Singapore Post" description="Singapore Post barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/python-java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
