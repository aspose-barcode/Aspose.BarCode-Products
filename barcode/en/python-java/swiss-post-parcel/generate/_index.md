---
title: Generate Swiss Post Parcel Images via Python via Java
description: Python sample code to generate Swiss Post Parcel using Java Runtime Environment.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /python-java/swiss-post-parcel/generate/
aliases:
- /python-java/generate/swiss-post-parcel/
- /nl/python-java/swiss-post-parcel/generate/
- /sv/python-java/swiss-post-parcel/generate/
- /hu/python-java/swiss-post-parcel/generate/
- /hi/python-java/swiss-post-parcel/generate/
- /el/python-java/swiss-post-parcel/generate/
- /cs/python-java/swiss-post-parcel/generate/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Swiss Post Parcel Labels with Python via Java" h2="Create Swiss Post Parcel in Python using server-side Aspose.BarCode for Python via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Swiss Post Parcel in Python" %}}
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Determine the desired barcode types as the EncodeTypes parameter</li><li>Insert input text as the second parameter</li><li>Call the BarCodeGenerator.save method to get the generated Swiss Post Parcel image</li></ul>
