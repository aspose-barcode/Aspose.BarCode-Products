---
title: Generate Postnet barcode Images via Python via Java
description: Python sample code to generate Postnet barcode using Java Runtime Environment.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /python-java/postnet/generate/
aliases:
- /python-java/generate/postnet/
- /nl/python-java/postnet/generate/
- /sv/python-java/postnet/generate/
- /hu/python-java/postnet/generate/
- /hi/python-java/postnet/generate/
- /el/python-java/postnet/generate/
- /cs/python-java/postnet/generate/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Postnet Labels with Python via Java" h2="Create Postnet barcode in Python using server-side Aspose.BarCode for Python via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Postnet" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Postnet barcode in Python" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode makes it easy for developers to create Postnet barcode images with few lines of code.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Create a new object of BarCodeGenerator class</li><li>Determine the desired barcode types as the EncodeTypes parameter</li><li>Insert input text as the second parameter</li><li>Call the BarCodeGenerator.save method to get the generated Postnet barcode image</li></ul>
