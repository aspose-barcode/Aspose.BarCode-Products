---
title: Generate Australia Post barcode and Australia Post eParcel Images via Python via Java
description: Python sample code to generate Australia Post barcode and Australia Post eParcel using Java Runtime Environment.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /python-java/australia-post/generate/
aliases:
- /python-java/generate/australia-post/
- /nl/python-java/australia-post/generate/
- /sv/python-java/australia-post/generate/
- /hu/python-java/australia-post/generate/
...
{{< blocks/products/pf/upper-banner h1="Generate Australia Post Labels with Python via Java" h2="Create Australia Post barcode and Australia Post eParcel in Python using server-side Aspose.BarCode for Python via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Australia Post barcode in Python" %}}
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Determine the desired barcode types as the EncodeTypes parameter</li><li>Insert input text as the second parameter</li><li>Call the BarCodeGenerator.save method to get the generated Australia Post barcode and Australia Post eParcel image</li></ul>
