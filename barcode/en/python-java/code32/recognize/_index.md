---
title: Scan Italian Pharmacode (Code 32) barcode Images via Python via Java
description: Python source code for Italian Pharmacode (Code 32) barcode recognition using Java Runtime Environment.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /python-java/code32/recognize/
aliases:
- /python-java/recognize/code32/
- /nl/python-java/code32/recognize/
- /sv/python-java/code32/recognize/
- /hu/python-java/code32/recognize/
- /hi/python-java/code32/recognize/
- /el/python-java/code32/recognize/
- /cs/python-java/code32/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Code 32 Barcodes with Python via Java" h2="Read Italian Pharmacode (Code 32) barcode in Python using server-side Aspose.BarCode for Python via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Code 32 barcode in Python" %}}
...
<ul><li>Create an object of Aspose.BarCode.BarCodeReader class</li><li>Define the source file path containing Code 32 barcode as a parameter</li><li>Determine the required barcodes types in DecodeType as the second parameter</li><li>Loop through the decoding outcomes</li><li>Get the barcode text using the CodeText property</li></ul>
