...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Define Code 128 barcode and other required barcode types as the EncodeTypes parameter</li><li>Specify input text using the setCodeText method</li><li>Use the BarCodeGenerator.save method to save the generated barcode image</li></ul>
