---
title: Scan Singapore Post barcode Images via Java
description: Java source code to read and decode Singapore Post barcode in Java Runtime Environment for JSP/JSF Application and Desktop Applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /java/singapore-post/recognize/
aliases:
- /java/recognize/singapore-post/
- /nl/java/singapore-post/recognize/
- /sv/java/singapore-post/recognize/
- /hu/java/singapore-post/recognize/
- /hi/java/singapore-post/recognize/
- /el/java/singapore-post/recognize/
- /cs/java/singapore-post/recognize/
- /java/recognize/singaporepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Singapore Post Barcodes with Java" h2="Read Singapore Post barcode in Java using server-side Aspose.BarCode for Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Singapore Post barcode in Java" %}}
...
<ul><li>Create a new object of BarCodeReader class</li><li>Set the source file path containing Singapore Post barcode</li><li>Pass the required barcode types to DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the getCodeText method</li></ul>
