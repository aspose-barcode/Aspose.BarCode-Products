...
aliases:
- /java/generate/ean/
- /nl/java/ean/generate/
- /sv/java/ean/generate/
- /hu/java/ean/generate/
- /hi/java/ean/generate/
- /el/java/ean/generate/
- /cs/java/ean/generate/
---
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Define EAN barcode and other required barcode types as the EncodeTypes parameter</li><li>Specify input text using the setCodeText method</li><li>Use the BarCodeGenerator.save method to save the generated barcode image</li></ul>
