---
title: Scan Australia Post barcode and Australia Post eParcel Images via Java
description: Java source code to read and decode Australia Post barcode and Australia Post eParcel in Java Runtime Environment for JSP/JSF Application and Desktop Applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /java/australia-post/recognize/
aliases:
- /java/recognize/australia-post/
- /nl/java/australia-post/recognize/
- /sv/java/australia-post/recognize/
- /hu/java/australia-post/recognize/
- /hi/java/australia-post/recognize/
- /el/java/australia-post/recognize/
- /cs/java/australia-post/recognize/
- /java/recognize/australiapost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Australia Post Barcodes with Java" h2="Read Australia Post barcode and Australia Post eParcel in Java using server-side Aspose.BarCode for Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Australia Post barcode in Java" %}}
...
<ul><li>Create a new object of BarCodeReader class</li><li>Set the source file path containing Australia Post barcode</li><li>Pass the required barcode types to DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the getCodeText method</li></ul>
