---
title: Generate Australia Post barcode and Australia Post eParcel Images via Java
description: Java sample code for Australia Post barcode and Australia Post eParcel generation in Java Runtime Environment for JSP/JSF applications and desktop applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /java/australia-post/generate/
aliases:
- /java/generate/australia-post/
- /nl/java/australia-post/generate/
- /sv/java/australia-post/generate/
- /hu/java/australia-post/generate/
- /hi/java/australia-post/generate/
- /el/java/australia-post/generate/
- /cs/java/australia-post/generate/
- /java/generate/australiapost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Australia Post Labels with Java" h2="Create Australia Post barcode and Australia Post eParcel in Java using server-side Aspose.BarCode for Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Australia Post barcode in Java" %}}
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Define Australia Post barcode and other required barcode types as the EncodeTypes parameter</li><li>Specify input text using the setCodeText method</li><li>Use the BarCodeGenerator.save method to save the generated barcode image</li></ul>
