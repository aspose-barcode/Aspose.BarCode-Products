---
title: Scan Code 16K barcode Images via Java
description: Java source code to read and decode Code 16K barcode in Java Runtime Environment for JSP/JSF Application and Desktop Applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /java/code16k/recognize/
aliases:
- /java/recognize/code16k/
- /nl/java/code16k/recognize/
- /sv/java/code16k/recognize/
- /hu/java/code16k/recognize/
- /hi/java/code16k/recognize/
- /el/java/code16k/recognize/
- /cs/java/code16k/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Code 16K Barcodes with Java" h2="Read Code 16K barcode in Java using server-side Aspose.BarCode for Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Code 16K barcode in Java" %}}
...
<ul><li>Create a new object of BarCodeReader class</li><li>Set the source file path containing Code 16K barcode</li><li>Pass the required barcode types to DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the getCodeText method</li></ul>
