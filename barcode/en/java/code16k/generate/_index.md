---
title: Generate Code 16K barcode Images via Java
description: Java sample code for Code 16K barcode generation in Java Runtime Environment for JSP/JSF applications and desktop applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /java/code16k/generate/
aliases:
- /java/generate/code16k/
- /nl/java/code16k/generate/
- /sv/java/code16k/generate/
- /hu/java/code16k/generate/
- /hi/java/code16k/generate/
- /el/java/code16k/generate/
- /cs/java/code16k/generate/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Code 16K Labels with Java" h2="Create Code 16K barcode in Java using server-side Aspose.BarCode for Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Code 16K barcode in Java" %}}
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Define Code 16K barcode and other required barcode types as the EncodeTypes parameter</li><li>Specify input text using the setCodeText method</li><li>Use the BarCodeGenerator.save method to save the generated barcode image</li></ul>
