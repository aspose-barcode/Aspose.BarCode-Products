---
title: Generate ISSN barcode Images via Java
description: Java sample code for ISSN barcode generation in Java Runtime Environment for JSP/JSF applications and desktop applications.
lang: en
langdirlevel: 2
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Define ISSN barcode and other required barcode types as the EncodeTypes parameter</li><li>Specify input text using the setCodeText method</li><li>Use the BarCodeGenerator.save method to save the generated barcode image</li></ul>
