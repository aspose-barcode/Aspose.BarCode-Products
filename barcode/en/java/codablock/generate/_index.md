---
title: Generate Codablock-F and GS1 Codablock-F barcodes Images via Java
description: Java sample code for Codablock-F and GS1 Codablock-F barcodes generation in Java Runtime Environment for JSP/JSF applications and desktop applications.
lang: en
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Codablock-F barcode in Java" %}}
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Define Codablock-F barcode and other required barcode types as the EncodeTypes parameter</li><li>Specify input text using the setCodeText method</li><li>Use the BarCodeGenerator.save method to save the generated barcode image</li></ul>
