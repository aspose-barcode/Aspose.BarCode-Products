---
title: Generate Deutsche Post Identcode and Deutsche Post Leitcode Images via Java
description: Java sample code for Deutsche Post Identcode and Deutsche Post Leitcode generation in Java Runtime Environment for JSP/JSF applications and desktop applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /java/deutsche-post/generate/
aliases:
- /java/generate/deutsche-post/
- /nl/java/deutsche-post/generate/
- /sv/java/deutsche-post/generate/
- /hu/java/deutsche-post/generate/
- /hi/java/deutsche-post/generate/
- /el/java/deutsche-post/generate/
- /cs/java/deutsche-post/generate/
- /java/generate/deutschepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Deutsche Post Labels with Java" h2="Create Deutsche Post Identcode and Deutsche Post Leitcode in Java using server-side Aspose.BarCode for Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Deutsche Post barcode in Java" %}}
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Define Deutsche Post barcode and other required barcode types as the EncodeTypes parameter</li><li>Specify input text using the setCodeText method</li><li>Use the BarCodeGenerator.save method to save the generated barcode image</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/java/ean/generate/" name="EAN" description="EAN (International Article Number) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/java/upc/generate/" name="UPC" description="UPC (Universal Product Code) barcode" >}}
