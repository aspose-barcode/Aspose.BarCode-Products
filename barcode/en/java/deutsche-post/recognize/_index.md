---
title: Scan Deutsche Post Identcode and Deutsche Post Leitcode Images via Java
description: Java source code to read and decode Deutsche Post Identcode and Deutsche Post Leitcode in Java Runtime Environment for JSP/JSF Application and Desktop Applications.
lang: en
langdirlevel: 2
...
<ul><li>Create a new object of BarCodeReader class</li><li>Set the source file path containing Deutsche Post barcode</li><li>Pass the required barcode types to DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the getCodeText method</li></ul>
