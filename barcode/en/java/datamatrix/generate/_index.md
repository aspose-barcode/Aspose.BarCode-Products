---
title: Generate Data Matrix code Images via Java
description: Java sample code for Data Matrix code generation in Java Runtime Environment for JSP/JSF applications and desktop applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /java/datamatrix/generate/
aliases:
- /java/generate/datamatrix/
- /nl/java/datamatrix/generate/
- /sv/java/datamatrix/generate/
- /hu/java/datamatrix/generate/
- /hi/java/datamatrix/generate/
- /el/java/datamatrix/generate/
- /cs/java/datamatrix/generate/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Data Matrix Labels with Java" h2="Create Data Matrix code in Java using server-side Aspose.BarCode for Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Data Matrix" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Define Data Matrix code and other required barcode types as the EncodeTypes parameter</li><li>Specify input text using the setCodeText method</li><li>Use the BarCodeGenerator.save method to save the generated barcode image</li></ul>
