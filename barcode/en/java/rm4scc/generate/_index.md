---
title: Generate Royal Mail 4-State Customer Code (RM4SCC) Images via Java
description: Java sample code for Royal Mail 4-State Customer Code (RM4SCC) generation in Java Runtime Environment for JSP/JSF applications and desktop applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /java/rm4scc/generate/
aliases:
- /java/generate/rm4scc/
- /nl/java/rm4scc/generate/
- /sv/java/rm4scc/generate/
- /hu/java/rm4scc/generate/
- /hi/java/rm4scc/generate/
- /el/java/rm4scc/generate/
- /cs/java/rm4scc/generate/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate RM4SCC Labels with Java" h2="Create Royal Mail 4-State Customer Code (RM4SCC) in Java using server-side Aspose.BarCode for Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Royal Mail 4-State Customer Code (RM4SCC) in Java" %}}
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Define Royal Mail 4-State Customer Code (RM4SCC) and other required barcode types as the EncodeTypes parameter</li><li>Specify input text using the setCodeText method</li><li>Use the BarCodeGenerator.save method to save the generated barcode image</li></ul>
