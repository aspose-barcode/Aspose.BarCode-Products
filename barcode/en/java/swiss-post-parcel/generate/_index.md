---
title: Generate Swiss Post Parcel Images via Java
description: Java sample code for Swiss Post Parcel generation in Java Runtime Environment for JSP/JSF applications and desktop applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /java/swiss-post-parcel/generate/
aliases:
- /java/generate/swiss-post-parcel/
- /nl/java/swiss-post-parcel/generate/
- /sv/java/swiss-post-parcel/generate/
- /hu/java/swiss-post-parcel/generate/
- /hi/java/swiss-post-parcel/generate/
- /el/java/swiss-post-parcel/generate/
- /cs/java/swiss-post-parcel/generate/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Swiss Post Parcel Labels with Java" h2="Create Swiss Post Parcel in Java using server-side Aspose.BarCode for Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Swiss Post Parcel in Java" %}}
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Define Swiss Post Parcel and other required barcode types as the EncodeTypes parameter</li><li>Specify input text using the setCodeText method</li><li>Use the BarCodeGenerator.save method to save the generated barcode image</li></ul>
