---
title: Scan Swiss Post Parcel Images via Java
description: Java source code to read and decode Swiss Post Parcel in Java Runtime Environment for JSP/JSF Application and Desktop Applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /java/swiss-post-parcel/recognize/
aliases:
- /java/recognize/swiss-post-parcel/
- /nl/java/swiss-post-parcel/recognize/
- /sv/java/swiss-post-parcel/recognize/
- /hu/java/swiss-post-parcel/recognize/
- /hi/java/swiss-post-parcel/recognize/
- /el/java/swiss-post-parcel/recognize/
- /cs/java/swiss-post-parcel/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Swiss Post Parcel Barcodes with Java" h2="Read Swiss Post Parcel in Java using server-side Aspose.BarCode for Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Swiss Post Parcel in Java" %}}
...
<ul><li>Create a new object of BarCodeReader class</li><li>Set the source file path containing Swiss Post Parcel</li><li>Pass the required barcode types to DecodeType as the second parameter</li><li>Loop through the decoding results</li><li>Get barcode text using the getCodeText method</li></ul>
