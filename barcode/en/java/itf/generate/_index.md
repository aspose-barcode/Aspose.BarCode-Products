---
title: Generate Interleaved 2-of-5 (ITF) barcode Images via Java
description: Java sample code for Interleaved 2-of-5 (ITF) barcode generation in Java Runtime Environment for JSP/JSF applications and desktop applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /java/itf/generate/
aliases:
- /java/generate/itf/
- /nl/java/itf/generate/
- /sv/java/itf/generate/
- /hu/java/itf/generate/
- /hi/java/itf/generate/
- /el/java/itf/generate/
- /cs/java/itf/generate/
- /java/generate/datalogic2of5/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate ITF Labels with Java" h2="Create Interleaved 2-of-5 (ITF) barcode in Java using server-side Aspose.BarCode for Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Interleaved 2-of-5 (ITF) barcode in Java" %}}
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Define Interleaved 2-of-5 (ITF) barcode and other required barcode types as the EncodeTypes parameter</li><li>Specify input text using the setCodeText method</li><li>Use the BarCodeGenerator.save method to save the generated barcode image</li></ul>
