---
title: Generate Italian Pharmacode (Code 32) barcode Images via Java
description: Java sample code for Italian Pharmacode (Code 32) barcode generation in Java Runtime Environment for JSP/JSF applications and desktop applications.
lang: en
langdirlevel: 2
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Define Code 32 barcode and other required barcode types as the EncodeTypes parameter</li><li>Specify input text using the setCodeText method</li><li>Use the BarCodeGenerator.save method to save the generated barcode image</li></ul>
