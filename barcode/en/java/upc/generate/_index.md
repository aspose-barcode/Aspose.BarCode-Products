---
title: Generate UPC (Universal Product Code) barcode Images via Java
description: Java sample code for UPC (Universal Product Code) barcode generation in Java Runtime Environment for JSP/JSF applications and desktop applications.
lang: 
langdirlevel: 2
...
<ul><li>Create a new object of BarCodeGenerator class</li><li>Define UPC (Universal Product Code) barcode and other required barcode types as the EncodeTypes parameter</li><li>Specify input text using the setCodeText method</li><li>Use the BarCodeGenerator.save method to save the generated barcode image</li></ul>
