---
title: Generate Italian Pharmacode (Code 32) barcode Images via PHP via Java
description: PHP source code to create Italian Pharmacode (Code 32) barcode in PHP-based applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /php-java/code32/generate/
aliases:
- /php-java/generate/code32/
- /nl/php-java/code32/generate/
- /sv/php-java/code32/generate/
- /hu/php-java/code32/generate/
- /hi/php-java/code32/generate/
- /el/php-java/code32/generate/
- /cs/php-java/code32/generate/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Code 32 Labels with PHP via Java" h2="Create Italian Pharmacode (Code 32) barcode in PHP using server-side Aspose.BarCode for PHP via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Code 32 barcode in PHP" %}}
...
<ul><li>Create a new instance of BarCodeGenerator class</li><li>Specify Code 32 barcode and other relevant barcode types as the EncodeTypes parameter</li><li>Set barcode text as the second parameter</li><li>Specify image dimensions and location if needed</li><li>Call the BarCodeGenerator.save method to obtain the Italian Pharmacode (Code 32) barcode image in the required format</li></ul>
