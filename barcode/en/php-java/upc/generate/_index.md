---
title: Generate UPC (Universal Product Code) barcode Images via PHP via Java
description: PHP source code to create UPC (Universal Product Code) barcode in PHP-based applications.
lang: 
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate UPC (Universal Product Code) barcode in PHP" %}}
