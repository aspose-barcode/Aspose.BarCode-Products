---
title: Generate Codablock-F and GS1 Codablock-F barcodes Images via PHP via Java
description: PHP source code to create Codablock-F and GS1 Codablock-F barcodes in PHP-based applications.
lang: en
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Generate Codablock-F Labels with PHP via Java" h2="Create Codablock-F and GS1 Codablock-F barcodes in PHP using server-side Aspose.BarCode for PHP via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Codablock-F barcode in PHP" %}}
...
<ul><li>Create a new instance of BarCodeGenerator class</li><li>Specify Codablock-F barcode and other relevant barcode types as the EncodeTypes parameter</li><li>Set barcode text as the second parameter</li><li>Specify image dimensions and location if needed</li><li>Call the BarCodeGenerator.save method to obtain the Codablock-F and GS1 Codablock-F barcodes image in the required format</li></ul>
