---
title: Generate EAN (International Article Number) barcode Images via PHP via Java
description: PHP source code to create EAN (International Article Number) barcode in PHP-based applications.
lang: 
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate EAN (International Article Number) barcode in PHP" %}}
...
<ul><li>Create a new instance of BarCodeGenerator class</li><li>Specify EAN (International Article Number) barcode and other relevant barcode types as the EncodeTypes parameter</li><li>Set barcode text as the second parameter</li><li>Specify image dimensions and location if needed</li><li>Call the BarCodeGenerator.save method to obtain the EAN (International Article Number) barcode image in the required format</li></ul>
