---
title: Generate GS1 Code 128 barcode Images via PHP via Java
description: PHP source code to create GS1 Code 128 barcode in PHP-based applications.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /php-java/code128/generate/
aliases:
- /php-java/generate/code128/
- /nl/php-java/code128/generate/
- /sv/php-java/code128/generate/
- /hu/php-java/code128/generate/
- /hi/php-java/code128/generate/
- /el/php-java/code128/generate/
- /cs/php-java/code128/generate/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate GS1 Code 128 Labels with PHP via Java" h2="Create GS1 Code 128 barcode in PHP using server-side Aspose.BarCode for PHP via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 Code 128" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate GS1 Code 128 barcode in PHP" %}}
