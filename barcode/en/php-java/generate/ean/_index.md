---
title: Generate EAN barcode Images via PHP via Java
weight: 1510
url: /php-java/generate/ean/
description: PHP source code to create EAN barcode in PHP-based applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate EAN Labels with PHP via Java" h2="Create EAN barcode in PHP using server-side Aspose.BarCode for PHP via Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate EAN barcode in PHP" %}}
...
<ul><li><ul><li>Create a new instance of BarCodeGenerator class</li><li>Specify EAN barcode and other relevant barcode types as the EncodeTypes parameter</li><li>Set barcode text as the second parameter</li><li>Specify image dimensions and location if needed</li><li>Call the BarCodeGenerator.save method to obtain the EAN barcode image in the required format</li></ul>
...
<span class="hljs-variable">$generator</span> = <span class="hljs-keyword">new</span> <span class="hljs-title class_">BarcodeGenerator</span>(<span class="hljs-title class_">EncodeTypes</span>::<span class="hljs-variable constant_"><span class="barcode-gen-lcs-type-param">EAN</span></span>, <span class="hljs-string">&quot;<span class="hljs-string barcode-gen-lcs-codetext-param"></span>&quot;</span>);
...
{{< blocks/products/pf/agp/demobox sectionTitle="Create EAN barcode" sectionDescription="[BarCode Generator App](https://products.aspose.app/barcode/generate/ean)" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text="Instantly get the EAN barcode label" >}}
