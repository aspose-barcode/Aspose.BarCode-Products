---
title: Generate EAN (International Article Number) barcode Images via C++
description: C++ example of code to generate EAN (International Article Number) barcode in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, and Linux 64-bit.
lang: 
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate EAN (International Article Number) barcode in C++" %}}
...
<ul><li>Create an object of BarcodeGenerator class</li><li>Pass EAN (International Article Number) barcode as a parameter</li><li>Insert input text to encode as the second parameter</li><li>Define image dimensions if required</li><li>Call the BarcodeGenerator.Save method to download the EAN (International Article Number) barcode barcode</li></ul>
