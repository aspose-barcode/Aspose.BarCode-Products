---
title: Generate EAN barcode Images via C++
weight: 1510
description: C++ example of code to generate EAN barcode in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, and Linux 64-bit.
---
...
<ul><li>Create an object of BarcodeGenerator class</li><li>Pass EAN barcode as a parameter</li><li>Insert input text to encode as the second parameter</li><li>Define image dimensions if required</li><li>Call the BarcodeGenerator.Save method to download the EAN barcode barcode</li></ul>
