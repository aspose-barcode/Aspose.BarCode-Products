---
title: Scan UPC (Universal Product Code) barcode Images via C++
weight: 1510
description: C++ sample code to scan and decode UPC (Universal Product Code) barcode in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, or Linux 64-bit.
lang: 
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning UPC (Universal Product Code) barcode in C++" %}}
