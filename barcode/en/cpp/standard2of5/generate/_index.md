---
title: Generate Standard 2 of 5 (Industrial 2 of 5) barcode Images via C++
description: C++ example of code to generate Standard 2 of 5 (Industrial 2 of 5) barcode in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, and Linux 64-bit.
lang: en
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Standard 2 of 5 barcode in C++" %}}
...
<ul><li>Create an object of BarcodeGenerator class</li><li>Pass Standard 2 of 5 (Industrial 2 of 5) barcode as a parameter</li><li>Insert input text to encode as the second parameter</li><li>Define image dimensions if required</li><li>Call the BarcodeGenerator.Save method to generate and save the Standard 2 of 5 (Industrial 2 of 5) barcode barcode</li></ul>
