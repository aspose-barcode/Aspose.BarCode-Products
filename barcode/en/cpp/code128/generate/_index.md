...
<ul><li>Create an object of BarcodeGenerator class</li><li>Pass GS1 Code 128 barcode as a parameter</li><li>Insert input text to encode as the second parameter</li><li>Define image dimensions if required</li><li>Call the BarcodeGenerator.Save method to download the GS1 Code 128 barcode barcode</li></ul>
