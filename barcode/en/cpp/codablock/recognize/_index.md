---
title: Scan Codablock-F and GS1 Codablock-F barcodes Images via C++
description: C++ sample code to scan and decode Codablock-F and GS1 Codablock-F barcodes in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, or Linux 64-bit.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /cpp/codablock/recognize/
aliases:
- /cpp/recognize/codablock/
- /nl/cpp/codablock/recognize/
- /sv/cpp/codablock/recognize/
- /hu/cpp/codablock/recognize/
- /hi/cpp/codablock/recognize/
- /el/cpp/codablock/recognize/
- /cs/cpp/codablock/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Codablock-F Barcodes with C++" h2="Read Codablock-F and GS1 Codablock-F barcodes in C++ using server-side Aspose.BarCode for C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Codablock-F" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Codablock-F barcode in C++" %}}
