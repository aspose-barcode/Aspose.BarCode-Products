---
title: Generate Royal Mail 4-State Customer Code (RM4SCC) Images via C++
description: C++ example of code to generate Royal Mail 4-State Customer Code (RM4SCC) in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, and Linux 64-bit.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /cpp/rm4scc/generate/
aliases:
- /cpp/generate/rm4scc/
- /nl/cpp/rm4scc/generate/
- /sv/cpp/rm4scc/generate/
- /hu/cpp/rm4scc/generate/
- /hi/cpp/rm4scc/generate/
- /el/cpp/rm4scc/generate/
- /cs/cpp/rm4scc/generate/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate RM4SCC Labels with C++" h2="Create Royal Mail 4-State Customer Code (RM4SCC) in C++ using server-side Aspose.BarCode for C++ API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
