---
title: Generate Deutsche Post Identcode and Deutsche Post Leitcode Images via C++
description: C++ example of code to generate Deutsche Post Identcode and Deutsche Post Leitcode in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, and Linux 64-bit.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /cpp/deutsche-post/generate/
aliases:
- /cpp/generate/deutsche-post/
- /nl/cpp/deutsche-post/generate/
- /sv/cpp/deutsche-post/generate/
- /hu/cpp/deutsche-post/generate/
...
{{< blocks/products/pf/upper-banner h1="Generate Deutsche Post Labels with C++" h2="Create Deutsche Post Identcode and Deutsche Post Leitcode in C++ using server-side Aspose.BarCode for C++ API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Deutsche Post barcode in C++" %}}
...
<ul><li>Create an object of BarcodeGenerator class</li><li>Pass Deutsche Post Identcode and Deutsche Post Leitcode as a parameter</li><li>Insert input text to encode as the second parameter</li><li>Define image dimensions if required</li><li>Call the BarcodeGenerator.Save method to generate and save the Deutsche Post Identcode and Deutsche Post Leitcode barcode</li></ul>
