---
title: Scan Singapore Post barcode Images via C++
description: C++ sample code to scan and decode Singapore Post barcode in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, or Linux 64-bit.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /cpp/singapore-post/recognize/
aliases:
- /cpp/recognize/singapore-post/
- /nl/cpp/singapore-post/recognize/
- /sv/cpp/singapore-post/recognize/
- /hu/cpp/singapore-post/recognize/
- /hi/cpp/singapore-post/recognize/
- /el/cpp/singapore-post/recognize/
- /cs/cpp/singapore-post/recognize/
- /cpp/recognize/singaporepost/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Singapore Post Barcodes with C++" h2="Read Singapore Post barcode in C++ using server-side Aspose.BarCode for C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Singapore Post" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Singapore Post barcode in C++" %}}
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cpp/ean/recognize/" name="EAN" description="EAN (International Article Number) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cpp/upc/recognize/" name="UPC" description="UPC (Universal Product Code) barcode" >}}
