...
description: C++ example code to read and decode databar barcode on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="DatabarExpanded Code Reader for C++" h2="Build C++ barcode scanning apps that can detect & read DatabarExpanded codes from images." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DatabarExpanded" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="TIFF" fileiconsmall4="BMP" fileiconsmall5="DatabarExpanded" >}}
