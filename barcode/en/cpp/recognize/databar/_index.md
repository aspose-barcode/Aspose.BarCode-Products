---
title: Scan DataBar barcode Images via C++
weight: 1510
url: /cpp/recognize/databar/
description: C++ sample code to scan and decode DataBar barcode in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, or Linux 64-bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read DataBar Barcodes with C++" h2="Read DataBar barcode in C++ using server-side Aspose.BarCode for C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DataBar" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}

{{< blocks/products/pf/main-container pfName="Aspose.BarCode " subTitlepfName="for C++" >}}
{{< blocks/products/pf/sub-menu autoRecognizedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-barcode" liveDemosLink="https://products.aspose.app/barcode/family" docsLink="https://docs.aspose.com/barcode/cpp/" installationsDocsLink="https://docs.aspose.com/barcode/cpp/installation" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/barcode/cpp/" learnAsLink="https://docs.aspose.com/barcode/cpp/" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="How to Read DataBar barcode Using C++" %}}
To scan DataBar barcode, try [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, a potent and easy-to-use barcode library with rich functionality for C++ platforms. You can download its latest version directly: just open [NuGet](https://www.nuget.org/packages/aspose.barcode) package manager, search for **Aspose.BarCode.Cpp**, and install the package. Alternatively, you can run the following command from the Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning DataBar barcode in C++" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="Other Supported Barcode Recognition Symbologies" subTitle="Using C++, One can also read barcode of different symbologies including." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/barcode/cpp/recognize/codeblock/" name="CODEBLOCK" description="CodablockF, GS1 CodablockF" >}}
