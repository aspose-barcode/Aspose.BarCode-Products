---
title: Generate DotCode barcode Images via C++
description: C++ example of code to generate DotCode barcode in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, and Linux 64-bit.
lang: en
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate DotCode barcode in C++" %}}
...
<ul><li>Create an object of BarcodeGenerator class</li><li>Pass DotCode barcode as a parameter</li><li>Insert input text to encode as the second parameter</li><li>Define image dimensions if required</li><li>Call the BarcodeGenerator.Save method to generate and save the DotCode barcode barcode</li></ul>
