---
title: Scan Postnet barcode Images via C++
description: C++ sample code to scan and decode Postnet barcode in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, or Linux 64-bit.
lang: en
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Postnet barcode in C++" %}}
