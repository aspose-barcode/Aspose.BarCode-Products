---
title: Generate Postnet barcode Images via C++
description: C++ example of code to generate Postnet barcode in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, and Linux 64-bit.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /cpp/postnet/generate/
aliases:
- /cpp/generate/postnet/
- /nl/cpp/postnet/generate/
- /sv/cpp/postnet/generate/
- /hu/cpp/postnet/generate/
- /hi/cpp/postnet/generate/
- /el/cpp/postnet/generate/
- /cs/cpp/postnet/generate/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Generate Postnet Labels with C++" h2="Create Postnet barcode in C++ using server-side Aspose.BarCode for C++ API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Postnet" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate Postnet barcode in C++" %}}
...
<ul><li>Create an object of BarcodeGenerator class</li><li>Pass Postnet barcode as a parameter</li><li>Insert input text to encode as the second parameter</li><li>Define image dimensions if required</li><li>Call the BarcodeGenerator.Save method to generate and save the Postnet barcode barcode</li></ul>
