---
title: Scan Swiss Post Parcel Images via C++
description: C++ sample code to scan and decode Swiss Post Parcel in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, or Linux 64-bit.
lang: en
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /cpp/swiss-post-parcel/recognize/
aliases:
- /cpp/recognize/swiss-post-parcel/
- /nl/cpp/swiss-post-parcel/recognize/
- /sv/cpp/swiss-post-parcel/recognize/
- /hu/cpp/swiss-post-parcel/recognize/
- /hi/cpp/swiss-post-parcel/recognize/
- /el/cpp/swiss-post-parcel/recognize/
- /cs/cpp/swiss-post-parcel/recognize/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Swiss Post Parcel Barcodes with C++" h2="Read Swiss Post Parcel in C++ using server-side Aspose.BarCode for C++ API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Swiss Post Parcel in C++" %}}
