...
<ul><li>Create an object of BarcodeGenerator class</li><li>Pass Swiss Post Parcel as a parameter</li><li>Insert input text to encode as the second parameter</li><li>Define image dimensions if required</li><li>Call the BarcodeGenerator.Save method to download the Swiss Post Parcel barcode</li></ul>
