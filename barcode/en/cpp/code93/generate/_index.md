---
title: Generate Code 93 Extended and Code 93 Standard barcodes Images via C++
description: C++ example of code to generate Code 93 Extended and Code 93 Standard barcodes in C++ Runtime Environment for Windows 32-bit, Windows 64-bit, and Linux 64-bit.
lang: en
langdirlevel: 2
...
<ul><li>Create an object of BarcodeGenerator class</li><li>Pass Code 93 Extended and Code 93 Standard barcodes as a parameter</li><li>Insert input text to encode as the second parameter</li><li>Define image dimensions if required</li><li>Call the BarcodeGenerator.Save method to generate and save the Code 93 Extended and Code 93 Standard barcodes barcode</li></ul>
