---
title: Scan Interleaved 2-of-5 (ITF) barcode Images via Android via Java
description: Android sample code to recognize Interleaved 2-of-5 (ITF) barcode in Android Runtime Environment.
lang: en
langdirlevel: 2
...
Try Aspose.BarCode for Android via Java to detect and read Interleaved 2-of-5 (ITF) barcode within Android applications easily. It is a rich, scalable, and user-friendly barcode API intended for Android applications. Get Aspose.BarCode for Java directly from a Maven-based project by adding the following configurations to the build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Interleaved 2-of-5 (ITF) barcode in Java" %}}
