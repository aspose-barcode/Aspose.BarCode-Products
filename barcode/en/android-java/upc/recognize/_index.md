---
title: Scan UPC (Universal Product Code) barcode Images via Android via Java
weight: 1510
description: Android sample code to recognize UPC (Universal Product Code) barcode in Android Runtime Environment.
lang: 
langdirlevel: 2
...
Try Aspose.BarCode for Android via Java to detect and read UPC (Universal Product Code) barcode within Android applications easily. It is a rich, scalable, and user-friendly barcode API intended for Android applications. Get Aspose.BarCode for Java directly from a Maven-based project by adding the following configurations to the build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning UPC (Universal Product Code) barcode in Java" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode allows developers to read UPC (Universal Product Code) barcode barcodes from stream or image with few lines of code

{{% /blocks/products/pf/agp/text %}}

<ul><li>Create an instance of BarCodeReader class</li><li>Determine the source image path containing UPC (Universal Product Code) barcode</li><li>Define target barcodes types in DecodeType as the second parameter</li><li>Loop through the recognition results</li><li>Load the decoded text running the getCodeText method</li></ul>
