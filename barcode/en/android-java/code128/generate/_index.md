---
title: Generate GS1 Code 128 barcode Images via Android via Java
description: Android source code to create GS1 Code 128 barcode in Android Runtime Environment.
lang: en
langdirlevel: 2
...
<ul><li>Create a new instance of BarCodeGenerator class</li><li>Pass the GS1 Code 128 barcode barcode type as the EncodeTypes parameter</li><li>Define barcode text using the setCodeText method</li><li>Launch the generateBarCodeImage() method to save the GS1 Code 128 barcode barcode image</li></ul>
