---
title: Scan ISBN barcode Images via Android via Java
description: Android sample code to recognize ISBN barcode in Android Runtime Environment.
lang: en
langdirlevel: 2
...
<ul><li>Create an instance of BarCodeReader class</li><li>Determine the source image path containing ISBN barcode</li><li>Define target barcodes types in DecodeType as the second parameter</li><li>Loop through the recognition results</li><li>Load the decoded text running the getCodeText method</li></ul>
