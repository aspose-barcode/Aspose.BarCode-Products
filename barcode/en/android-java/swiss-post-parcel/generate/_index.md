---
title: Generate Swiss Post Parcel Images via Android via Java
description: Android source code to create Swiss Post Parcel in Android Runtime Environment.
lang: en
langdirlevel: 2
...
Try Aspose.BarCode for Android via Java to create Swiss Post Parcel within Android applications easily. It is a versatile, robust, and user-friendly barcode library specifically designed for Android applications. You can easily Aspose.BarCode for Android via Java directly from a Maven-based project by inserting the following configurations into build.gradle:
...
<ul><li>Create a new instance of BarCodeGenerator class</li><li>Pass the Swiss Post Parcel barcode type as the EncodeTypes parameter</li><li>Define barcode text using the setCodeText method</li><li>Launch the generateBarCodeImage() method to save the Swiss Post Parcel barcode image</li></ul>
