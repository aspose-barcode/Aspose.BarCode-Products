---
title: Generate QR Code, GS1 QR Code Images via Android via Java
description: Android source code to create QR Code, GS1 QR Code in Android Runtime Environment.
lang: en
langdirlevel: 2
...
<ul><li>Create a new instance of BarCodeGenerator class</li><li>Pass the QR Code barcode type as the EncodeTypes parameter</li><li>Define barcode text using the setCodeText method</li><li>Launch the generateBarCodeImage() method to save the QR Code, GS1 QR Code barcode image</li></ul>
