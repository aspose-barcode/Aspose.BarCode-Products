...
<ul><li>Create a new instance of BarCodeGenerator class</li><li>Pass the Royal Mail barcode barcode type as the EncodeTypes parameter</li><li>Define barcode text using the setCodeText method</li><li>Launch the generateBarCodeImage() method to save the Royal Mail barcode barcode image</li></ul>
