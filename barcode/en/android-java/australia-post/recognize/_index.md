---
title: Scan Australia Post barcode and Australia Post eParcel Images via Android via Java
description: Android sample code to recognize Australia Post barcode and Australia Post eParcel in Android Runtime Environment.
lang: en
langdirlevel: 2
...
Try Aspose.BarCode for Android via Java to detect and read Australia Post barcode within Android applications easily. It is a rich, scalable, and user-friendly barcode API intended for Android applications. Get Aspose.BarCode for Java directly from a Maven-based project by adding the following configurations to the build.gradle:
...
<ul><li>Create an instance of BarCodeReader class</li><li>Determine the source image path containing Australia Post barcode</li><li>Define target barcodes types in DecodeType as the second parameter</li><li>Loop through the recognition results</li><li>Load the decoded text running the getCodeText method</li></ul>
