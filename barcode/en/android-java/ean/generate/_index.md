---
title: Generate EAN (International Article Number) barcode Images via Android via Java
description: Android source code to create EAN (International Article Number) barcode in Android Runtime Environment.
lang: 
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="How to Generate EAN (International Article Number) barcode Using Android via Java" %}}
Try Aspose.BarCode for Android via Java to create EAN (International Article Number) barcode within Android applications easily. It is a versatile, robust, and user-friendly barcode library specifically designed for Android applications. You can easily Aspose.BarCode for Android via Java directly from a Maven-based project by inserting the following configurations into build.gradle:
...
<ul><li>Create a new instance of BarCodeGenerator class</li><li>Pass the EAN (International Article Number) barcode barcode type as the EncodeTypes parameter</li><li>Define barcode text using the setCodeText method</li><li>Launch the generateBarCodeImage() method to save the EAN (International Article Number) barcode barcode image</li></ul>
