---
title: Generate Royal Mail 4-State Customer Code (RM4SCC) Images via Android via Java
description: Android source code to create Royal Mail 4-State Customer Code (RM4SCC) in Android Runtime Environment.
lang: en
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="How to Generate Royal Mail 4-State Customer Code (RM4SCC) Using Android via Java" %}}
Try Aspose.BarCode for Android via Java to create Royal Mail 4-State Customer Code (RM4SCC) within Android applications easily. It is a versatile, robust, and user-friendly barcode library specifically designed for Android applications. You can easily Aspose.BarCode for Android via Java directly from a Maven-based project by inserting the following configurations into build.gradle:
...
<ul><li>Create a new instance of BarCodeGenerator class</li><li>Pass the Royal Mail 4-State Customer Code (RM4SCC) barcode type as the EncodeTypes parameter</li><li>Define barcode text using the setCodeText method</li><li>Launch the generateBarCodeImage() method to save the Royal Mail 4-State Customer Code (RM4SCC) barcode image</li></ul>
