---
title: Scan Royal Mail 4-State Customer Code (RM4SCC) Images via Android via Java
description: Android sample code to recognize Royal Mail 4-State Customer Code (RM4SCC) in Android Runtime Environment.
lang: en
langdirlevel: 2
...
Try Aspose.BarCode for Android via Java to detect and read Royal Mail 4-State Customer Code (RM4SCC) within Android applications easily. It is a rich, scalable, and user-friendly barcode API intended for Android applications. Get Aspose.BarCode for Java directly from a Maven-based project by adding the following configurations to the build.gradle:
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/android-java/ean/recognize/" name="EAN" description="EAN (International Article Number) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/android-java/upc/recognize/" name="UPC" description="UPC (Universal Product Code) barcode" >}}
