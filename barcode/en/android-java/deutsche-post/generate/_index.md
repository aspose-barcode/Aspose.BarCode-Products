---
title: Generate Deutsche Post Identcode and Deutsche Post Leitcode Images via Android via Java
description: Android source code to create Deutsche Post Identcode and Deutsche Post Leitcode in Android Runtime Environment.
lang: en
langdirlevel: 2
...
Try Aspose.BarCode for Android via Java to create Deutsche Post barcode within Android applications easily. It is a versatile, robust, and user-friendly barcode library specifically designed for Android applications. You can easily Aspose.BarCode for Android via Java directly from a Maven-based project by inserting the following configurations into build.gradle:
...
<ul><li>Create a new instance of BarCodeGenerator class</li><li>Pass the Deutsche Post barcode barcode type as the EncodeTypes parameter</li><li>Define barcode text using the setCodeText method</li><li>Launch the generateBarCodeImage() method to save the Deutsche Post Identcode and Deutsche Post Leitcode barcode image</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/android-java/ean/generate/" name="EAN" description="EAN (International Article Number) barcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/android-java/upc/generate/" name="UPC" description="UPC (Universal Product Code) barcode" >}}
