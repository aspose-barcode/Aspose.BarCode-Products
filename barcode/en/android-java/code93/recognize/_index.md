---
title: Scan Code 93 Extended and Code 93 Standard barcodes Images via Android via Java
description: Android sample code to recognize Code 93 Extended and Code 93 Standard barcodes in Android Runtime Environment.
lang: en
langdirlevel: 2
...
<ul><li>Create an instance of BarCodeReader class</li><li>Determine the source image path containing Code 93 barcode</li><li>Define target barcodes types in DecodeType as the second parameter</li><li>Loop through the recognition results</li><li>Load the decoded text running the getCodeText method</li></ul>
