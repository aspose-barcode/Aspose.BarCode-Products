---
title: Generate Standard 2 of 5 (Industrial 2 of 5) barcode Images via Android via Java
description: Android source code to create Standard 2 of 5 (Industrial 2 of 5) barcode in Android Runtime Environment.
lang: en
langdirlevel: 2
...
<ul><li>Create a new instance of BarCodeGenerator class</li><li>Pass the Standard 2 of 5 barcode barcode type as the EncodeTypes parameter</li><li>Define barcode text using the setCodeText method</li><li>Launch the generateBarCodeImage() method to save the Standard 2 of 5 (Industrial 2 of 5) barcode barcode image</li></ul>
