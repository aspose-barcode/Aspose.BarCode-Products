...
{{% blocks/products/pf/agp/content h2="How to Read Data Matrix code Using Android via Java" %}}
Try Aspose.BarCode for Android via Java to detect and read Data Matrix code within Android applications easily. It is a rich, scalable, and user-friendly barcode API intended for Android applications. Get Aspose.BarCode for Java directly from a Maven-based project by adding the following configurations to the build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Data Matrix code in Java" %}}
...
<ul><li>Create an instance of BarCodeReader class</li><li>Determine the source image path containing Data Matrix code</li><li>Define target barcodes types in DecodeType as the second parameter</li><li>Loop through the recognition results</li><li>Load the decoded text running the getCodeText method</li></ul>
