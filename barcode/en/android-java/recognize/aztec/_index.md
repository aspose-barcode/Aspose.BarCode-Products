---
title: Scan Aztec Code Images via Android via Java
weight: 1510
url: /android-java/recognize/aztec/
description: Android sample code to recognize Aztec Code in Android Runtime Environment.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read Aztec Barcodes with Android via Java" h2="Read Aztec Code in Java using server-side Aspose.BarCode for Android via Java API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Aztec Code Using Android via Java" %}}
Try Aspose.BarCode for Android via Java to detect and read Aztec Code within Android applications easily. It is a rich, scalable, and user-friendly barcode API intended for Android applications. Get Aspose.BarCode for Java directly from a Maven-based project by adding the following configurations to the build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning Aztec Code in Java" %}}
...
<ul><li>Create an instance of BarCodeReader class</li><li>Determine the source image path containing Aztec Code</li><li>Define target barcodes types in DecodeType as the second parameter</li><li>Loop through the recognition results</li><li>Load the decoded text running the getCodeText method</li></ul>
...
<span class="hljs-keyword">while</span> (reader.read()) {
    ...
    <script>
        ...
        async function recognizeBarcodeAsync() {
            ...
            let barcodetypeUrl = "Aztec";
            if (barcodetypeUrl === "") {
                barcodetypeUrl = button.siblings("select").val();
                barcodetypeUrl = barcodetypeUrl === "Aztec" ? "" : barcodetypeUrl;
            }
            let quality = 2;
...
{{< blocks/products/pf/agp/demobox sectionTitle="Scan Aztec Code" sectionDescription="[BarCode Reader App](https://products.aspose.app/barcode/recognize/aztec)" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text="Instantly get the Aztec Code decoded data" >}}
