...
{{% blocks/products/pf/agp/content h2="How to Read PDF417 barcode Using Android via Java" %}}
Try Aspose.BarCode for Android via Java to detect and read PDF417 barcode within Android applications easily. It is a rich, scalable, and user-friendly barcode API intended for Android applications. Get Aspose.BarCode for Java directly from a Maven-based project by adding the following configurations to the build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning PDF417 barcode in Java" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode allows developers to read PDF417 barcode barcodes from stream or image with few lines of code

{{% /blocks/products/pf/agp/text %}}

<ul><li>Create an instance of BarCodeReader class</li><li>Determine the source image path containing PDF417 barcode</li><li>Define target barcodes types in DecodeType as the second parameter</li><li>Loop through the recognition results</li><li>Load the decoded text running the getCodeText method</li></ul>
...
{{< blocks/products/pf/agp/demobox sectionTitle="Scan PDF417 barcode" sectionDescription="[BarCode Reader App](https://products.aspose.app/barcode/recognize/pdf417)" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text="Instantly get the PDF417 barcode decoded data" >}}
