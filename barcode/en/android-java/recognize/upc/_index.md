...
{{% blocks/products/pf/agp/content h2="How to Read UPC barcode Using Android via Java" %}}
Try Aspose.BarCode for Android via Java to detect and read UPC barcode within Android applications easily. It is a rich, scalable, and user-friendly barcode API intended for Android applications. Get Aspose.BarCode for Java directly from a Maven-based project by adding the following configurations to the build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Scanning UPC barcode in Java" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode allows developers to read UPC barcode barcodes from stream or image with few lines of code

{{% /blocks/products/pf/agp/text %}}

<ul><li>Create an instance of BarCodeReader class</li><li>Determine the source image path containing UPC barcode</li><li>Define target barcodes types in DecodeType as the second parameter</li><li>Loop through the recognition results</li><li>Load the decoded text running the getCodeText method</li></ul>
...
<span class="hljs-keyword">while</span> (reader.read()) {
    ...
    <script>
        ...
        async function recognizeBarcodeAsync() {
            ...
            let barcodetypeUrl = "UPC";
            if (barcodetypeUrl === "") {
                barcodetypeUrl = button.siblings("select").val();
                barcodetypeUrl = barcodetypeUrl === "UPC" ? "" : barcodetypeUrl;
            }
            let quality = 2;
...
<!-- END LCS -->
{{< /blocks/products/pf/agp/feature-section2 >}}
{{% blocks/products/pf/agp/feature-section-row title="About UPC barcode" %}}
<p>
UPC (Universal Product Code) is a machine-readable code consisting of a series of black and white bars used to identify specific products. UPC barcode are usually placed on the packaging of retail products and serve to identify the product and facilitate the checkout process in stores. Each UPC barcode stores a series of 12 numerical digits. The first six digits represent the manufacturer or brand of the product, while the last six ones identify the specific product within that product line.<br>For more information about this barcode type, see our information article:
</p>
<p>
...
{{< blocks/products/pf/agp/demobox sectionTitle="Scan UPC barcode" sectionDescription="[BarCode Reader App](https://products.aspose.app/barcode/recognize/upc)" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="No need to download Aspose API" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="Just insert the source file path" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Select UPC barcode from the dropdown list" >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text="Instantly get the UPC barcode decoded data" >}}
