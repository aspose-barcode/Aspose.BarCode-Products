...
description: Try our On-Premise AUSTRALIAPOST Barcode Reader and Decoder APIs on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read AUSTRALIAPOST Code in C#" h2="Decode Australia Post, Australia Poste Parcel barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="AustraliaPost" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="AustraliaPost" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read AustraliaPost in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding AUSTRALIAPOST barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
{{% blocks/products/pf/agp/code-block title="Recognize AUSTRALIAPOST Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.AustraliaPost)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding AUSTRALIAPOST BarCodes Live Demos" sectionDescription="Read AUSTRALIAPOST Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/australiapost) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing AUSTRALIAPOST barcodes, it will be scanned instantly." >}}
