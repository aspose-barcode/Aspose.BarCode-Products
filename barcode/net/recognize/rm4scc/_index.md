---
title: Read RM4SCC BarCode via .NET 
weight: 1360
url: /net/recognize/rm4scc/ 
description: C# source code to read and decode rm4scc barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read RM4SCC Code in C#" h2="Decode ROYALMAIL (RM4SCC) barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="RM4SCC" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read RM4SCC in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding RM4SCC barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing RM4SCC barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize RM4SCC Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.RM4SCC)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding RM4SCC BarCodes Live Demos" sectionDescription="Read RM4SCC Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/rm4scc) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing RM4SCC barcodes, it will be scanned instantly." >}}
