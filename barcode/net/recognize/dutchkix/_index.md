---
title: Read DUTCHKIX BarCode via .NET 
weight: 1520
url: /net/recognize/dutchkix/ 
description: C# source code to read and decode dutchkix barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read DUTCHKIX Code in C#" h2="Decode KIX-CODE barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DutchKIX" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="DutchKIX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Recognize DUTCHKIX Barcode Using C#" %}}

 In order to read KIX-CODE barcode, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Read DutchKIX in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding DUTCHKIX barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing DutchKIX barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize DUTCHKIX Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.DutchKIX)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding DUTCHKIX BarCodes Live Demos" sectionDescription="Read DUTCHKIX Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/dutchkix) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing DUTCHKIX barcodes, it will be scanned instantly." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get all the recognized DUTCHKIX types." >}}
