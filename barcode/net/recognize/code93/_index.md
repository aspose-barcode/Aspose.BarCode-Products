---
title: Read CODE93 BarCode via .NET 
weight: 820
url: /net/recognize/code93/ 
description: C# source code to read and decode code93 barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read CODE93 Code in C#" h2="Decode Code 93 Extended, Code 93 Standard barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code93Standard" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="Code93Standard" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read Code93Standard in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding CODE93 barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing Code93Standard barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize CODE93 Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.Code93Standard)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding CODE93 BarCodes Live Demos" sectionDescription="Read CODE93 Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/code93) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing CODE93 barcodes, it will be scanned instantly." >}}
