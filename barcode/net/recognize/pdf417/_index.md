---
title: Read PDF417 BarCode via .NET 
weight: 2070
url: /net/recognize/pdf417/ 
description: C# source code to read and decode pdf417 barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read PDF417 Code in C#" h2="Decode PDF 417, Micro Pdf417, Macro PDF417 barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Pdf417" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="Pdf417" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read Pdf417 in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding PDF417 barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing Pdf417 barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize PDF417 Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.Pdf417)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding PDF417 BarCodes Live Demos" sectionDescription="Read PDF417 Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/pdf417) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing PDF417 barcodes, it will be scanned instantly." >}}
