---
title: Read CODABLOCK BarCode via .NET 
weight: 1350
url: /net/recognize/codablock/ 
description: C# source code to read and decode codablock barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read CODABLOCK Code in C#" h2="Decode CodablockF, GS1 CodablockF barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CodablockF" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="CodablockF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read CodablockF in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding CODABLOCK barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing CodablockF barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize CODABLOCK Barcodes - C#‎" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding CODABLOCK BarCodes Live Demos" sectionDescription="Read CODABLOCK Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/codablock) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing CODABLOCK barcodes, it will be scanned instantly." >}}
