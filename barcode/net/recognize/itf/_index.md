---
title: Read ITF BarCode via .NET 
weight: 420
url: /net/recognize/itf/ 
description: C# source code to read and decode itf barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read ITF Code in C#" h2="Decode ITF-6, ITF-14 barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ITF14" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="ITF14" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read ITF14 in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding ITF barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing ITF14 barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize ITF Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.ITF14)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding ITF BarCodes Live Demos" sectionDescription="Read ITF Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/itf) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing ITF barcodes, it will be scanned instantly." >}}
