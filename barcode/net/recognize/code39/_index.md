---
title: Read CODE39 BarCode via .NET 
weight: 800
url: /net/recognize/code39/ 
description: C# source code to read and decode code39 barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read CODE39 Code in C#" h2="Decode Code 39 Extended, Code 39 Standard barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code39Standard" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="Code39Standard" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read Code39Standard in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Recognize CODE39 Barcodes - C#‎" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding CODE39 BarCodes Live Demos" sectionDescription="Read CODE39 Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/code39) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing CODE39 barcodes, it will be scanned instantly." >}}
