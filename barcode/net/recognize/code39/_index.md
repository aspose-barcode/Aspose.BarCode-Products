...
{{< blocks/products/pf/upper-banner h1="ReadВ CODE39 Code in C#" h2="Decode Code 39 Extended, Code 39 Standard barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/barcode/272x272/aspose_barcode-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="Code39Standard" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="Code39Standard" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Reading and DecodingВ CODE39 barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing Code39Standard barcodeВ as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize CODE39В Barcodes - C#вЂЋ" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding CODE39 BarCodes Live Demos" sectionDescription="Read CODE39 BarcodesВ right now by visiting ourВ OnlineВ [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/code39) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload yourВ image containing CODE39 barcodes, it will be scanned instantly." >}}
