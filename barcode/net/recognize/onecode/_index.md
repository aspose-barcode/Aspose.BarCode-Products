---
title: Read ONECODE BarCode via .NET 
weight: 70
url: /net/recognize/onecode/ 
description: C# source code to read and decode onecode barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read ONECODE Code in C#" h2="Decode USPS ONECODE barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OneCode" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="OneCode" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read OneCode in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding ONECODE barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing OneCode barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize ONECODE Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.OneCode)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding ONECODE BarCodes Live Demos" sectionDescription="Read ONECODE Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/onecode) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing ONECODE barcodes, it will be scanned instantly." >}}
