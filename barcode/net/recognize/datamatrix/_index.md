---
title: Read DATAMATRIX BarCode via .NET 
weight: 350
url: /net/recognize/datamatrix/ 
description: C# source code to read and decode datamatrix barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read DATAMATRIX Code in C#" h2="Decode Data Matrix, GS1 Data Matrix barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DataMatrix" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="DataMatrix" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read DataMatrix in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding DATAMATRIX barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing DataMatrix barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize DATAMATRIX Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.DataMatrix)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding DATAMATRIX BarCodes Live Demos" sectionDescription="Read DATAMATRIX Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/datamatrix) website. The live demo has the following benefits" >}}
