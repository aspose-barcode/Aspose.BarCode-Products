---
title: Read ISSN BarCode via .NET 
weight: 1340
url: /net/recognize/issn/ 
description: C# source code to read and decode issn barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read ISSN Code in C#" h2="Decode ISSN barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISSN" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="ISSN" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read ISSN in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding ISSN barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing ISSN barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize ISSN Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.ISSN)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding ISSN BarCodes Live Demos" sectionDescription="Read ISSN Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/issn) website. The live demo has the following benefits" >}}
