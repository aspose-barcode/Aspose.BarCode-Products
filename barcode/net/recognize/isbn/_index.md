---
title: Read ISBN BarCode via .NET 
weight: 1020
url: /net/recognize/isbn/ 
description: C# source code to read and decode isbn barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read ISBN Code in C#" h2="Decode ISBN barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISBN" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="ISBN" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read ISBN in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding ISBN barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing ISBN barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize ISBN Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.ISBN)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding ISBN BarCodes Live Demos" sectionDescription="Read ISBN Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/isbn) website. The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will get all the recognized ISBN types." >}}
