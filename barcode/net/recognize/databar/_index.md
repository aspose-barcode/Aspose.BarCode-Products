---
title: Read DATABAR BarCode via .NET 
weight: 1140
url: /net/recognize/databar/ 
description: C# source code to read and decode databar barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read DATABAR Code in C#" h2="Decode GS1 Databar Expanded, GS1 Databar Expanded Stacked, GS1 DataBar Expanded, GS1 Databar OmniDirectional, GS1 DataBar Stacked, GS1 Databar Stacked OmniDirectional, GS1 DataBar Truncated barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DatabarStacked" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="DatabarStacked" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read DatabarStacked in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding DATABAR barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing DatabarStacked barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize DATABAR Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.DatabarStacked)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding DATABAR BarCodes Live Demos" sectionDescription="Read DATABAR Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/databar) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing DATABAR barcodes, it will be scanned instantly." >}}
