---
title: Read DEUTSCHEPOST BarCode via .NET 
weight: 590
url: /net/recognize/deutschepost/ 
description: C# source code to read and decode deutschepost barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read DEUTSCHEPOST Code in C#" h2="Decode Deutsche Post Identcode, Deutsche Post Leitcode barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DeutschePostIdentcode" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="DeutschePostIdentcode" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read DeutschePostIdentcode in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding DEUTSCHEPOST barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing DeutschePostIdentcode barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize DEUTSCHEPOST Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.DeutschePostIdentcode)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding DEUTSCHEPOST BarCodes Live Demos" sectionDescription="Read DEUTSCHEPOST Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/deutschepost) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing DEUTSCHEPOST barcodes, it will be scanned instantly." >}}
