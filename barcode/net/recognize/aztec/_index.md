---
title: Read AZTEC BarCode via .NET 
weight: 1310
url: /net/recognize/aztec/ 
description: C# source code to read and decode aztec barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read AZTEC Code in C#" h2="Decode AZTEC barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="Aztec" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read Aztec in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding AZTEC barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing Aztec barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize AZTEC Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.Aztec)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding AZTEC BarCodes Live Demos" sectionDescription="Read AZTEC Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/aztec) website. The live demo has the following benefits" >}}
