---
title: Read ISMN BarCode via .NET 
weight: 380
url: /net/recognize/ismn/ 
description: C# source code to read and decode ismn barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read ISMN Code in C#" h2="Decode ISMN barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="ISMN" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read ISMN in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding ISMN barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing ISMN barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize ISMN Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.ISMN)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding ISMN BarCodes Live Demos" sectionDescription="Read ISMN Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/ismn) website. The live demo has the following benefits" >}}
