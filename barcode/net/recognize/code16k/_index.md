---
title: Read CODE16K BarCode via .NET 
weight: 280
url: /net/recognize/code16k/ 
description: C# source code to read and decode code16k barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read CODE16K Code in C#" h2="Decode CODE 16K barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code16K" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="Code16K" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read Code16K in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding CODE16K barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing Code16K barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize CODE16K Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.Code16K)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding CODE16K BarCodes Live Demos" sectionDescription="Read CODE16K Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/code16k) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing CODE16K barcodes, it will be scanned instantly." >}}
