---
title: Read PLANET BarCode via .NET 
weight: 20
url: /net/recognize/planet/ 
description: C# source code to read and decode planet barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read PLANET Code in C#" h2="Decode PLANET barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Planet" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="Planet" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read Planet in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding PLANET barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing Planet barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize PLANET Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.Planet)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding PLANET BarCodes Live Demos" sectionDescription="Read PLANET Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/planet) website. The live demo has the following benefits" >}}
