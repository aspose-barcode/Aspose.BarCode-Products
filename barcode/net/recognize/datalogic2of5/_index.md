---
title: Read DATALOGIC2OF5 BarCode via .NET 
weight: 1470
url: /net/recognize/datalogic2of5/ 
description: C# source code to read and decode datalogic2of5 barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read DATALOGIC2OF5 Code in C#" h2="Decode DATALOGIC 2 OF 5 barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DataLogic2of5" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="DataLogic2of5" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read DataLogic2of5 in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Recognize DATALOGIC2OF5 Barcodes - C#‎" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding DATALOGIC2OF5 BarCodes Live Demos" sectionDescription="Read DATALOGIC2OF5 Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/datalogic2of5) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your image containing DATALOGIC2OF5 barcodes, it will be scanned instantly." >}}
