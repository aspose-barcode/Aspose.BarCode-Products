...
description: C# source code to read and decode postnet barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read POSTNET Code in C#" h2="Decode POSTNET barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Postnet" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="Postnet" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Reading and Decoding POSTNET barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing Postnet barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize POSTNET Barcodes - C#‎" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding POSTNET BarCodes Live Demos" sectionDescription="Read POSTNET Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/postnet) website. The live demo has the following benefits" >}}
