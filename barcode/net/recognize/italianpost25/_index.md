---
title: Read ITALIANPOST25 BarCode via .NET 
weight: 520
url: /net/recognize/italianpost25/ 
description: C# source code to read and decode italianpost25 barcode symbology on .NET Framework, .NET Standard, COM Interloop for PHP, VBScript, Delphi, C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Read ITALIANPOST25 Code in C#" h2="Decode ITALIAN POST 25 barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ItalianPost25" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="ItalianPost25" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Read ItalianPost25 in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Reading and Decoding ITALIANPOST25 barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing ItalianPost25 barcode as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize ITALIANPOST25 Barcodes - C#‎" offSpacer="" %}}

```cs
using (BarCodeReader reader = new BarCodeReader("template.jpg", DecodeType.ItalianPost25)){
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding ITALIANPOST25 BarCodes Live Demos" sectionDescription="Read ITALIANPOST25 Barcodes right now by visiting our Online [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/italianpost25) website. The live demo has the following benefits" >}}
