...
{{< blocks/products/pf/upper-banner h1="ReadВ INTERLEAVED2OF5 Code in C#" h2="Decode INTERLEAVED 2 OF 5 barcodes in any .NET application via BarCodeReader class." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/barcode/272x272/aspose_barcode-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="Interleaved2of5" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="BMP" fileiconsmall2="TIFF" fileiconsmall3="PNG" fileiconsmall4="JPEG" fileiconsmall5="Interleaved2of5" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Reading and DecodingВ INTERLEAVED2OF5 barcodes with
 [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net) 
...
+  Pass image path containing Interleaved2of5 barcodeВ as parameter
...
{{% blocks/products/pf/agp/code-block title="Recognize INTERLEAVED2OF5В Barcodes - C#вЂЋ" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Decoding INTERLEAVED2OF5 BarCodes Live Demos" sectionDescription="Read INTERLEAVED2OF5 BarcodesВ right now by visiting ourВ OnlineВ [BarCode Reader and Decoder](https://products.aspose.app/barcode/recognize/interleaved2of5) website. The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload yourВ image containing INTERLEAVED2OF5 barcodes, it will be scanned instantly." >}}
