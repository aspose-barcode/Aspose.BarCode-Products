...
<div class="diagram1 d1-php-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <!--<header><i class="fa fa-print"> </i>印刷</header>
...
--&gt; <!--<div class="col-lg-12"><!-- <h2 class="h2title">郵政 Symbologies Include:</h2> -->
   <!--<p>郵政 types include:</p>
...
<h2 class="h2title">成像, Rotation & Sizing</h2>
