---
title: 在 JasperReports 中生成條形碼並在 BMP JPG GIF 和 PNG 中呈現 
weight: 1900
url: /zh-hant/jasperreports/ 
description: 為 JasperReports 使用 Aspose.BarCode - 開發人員可以在 Jasper Reports 中生成條形碼，這些條形碼可以進一步以 BMP JPG GIF 和 PNG 格式呈現
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 JasperReports 中生成和導出條形碼" h2="JasperReports 和 JasperServer API 用於生成、顯示和導出線性、二維和郵政條碼為多種格式。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/barcode/jasperreports" >}}
...
<p>
 Aspose.BarCode for JasperReports 是一個靈活的 JasperReports 和 JasperServer 擴展，用於在您的應用程序中創建和顯示條形碼標籤。這些條形碼標籤可以以許多流行的圖像格式呈現。
</p>
...
<div class="diagram1 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Jasper 報告條碼生成器" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Platform Independence" description="JasperReports 的 Aspose.BarCode 可以與 JasperServer 和 JasperReports 一起使用。" >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="在 Jasper 報告中生成條形碼" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="JasperReports 條碼擴展支持流行 [圖像格式](https://docs.aspose.com/barcode/jasperreports/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="條碼生成 in Jasper Report" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     JasperReports 的 Aspose.BarCode 支持超過 25 種最流行的線性、二維和郵政條碼符號，包括：
    </p>
    <div class="col-lg-6">
     <ul class="unstyled">
      <li>
    ...
    <div class="col-lg-6">
     <ul class="unstyled">
      ...
      <li>
       Supplement Code +2 （對於 EAN 和 UPC 代碼）
      </li>
      <li>
       Supplement Code +5 （對於 EAN 和 UPC 代碼）
      </li>
      <li>
       UPC A
      </li>
    ...
    <div class="col-lg-12">
     ...
     <p>
      Aspose.BarCode for JasperReports 允許通過指定各種選項來自定義條形碼，例如符號類型、文本（將編碼為條形碼圖像的代碼數據）以及調整外觀的屬性，例如字體、背景和前景顏色。
     </p>
     <p>
      您還可以自定義條碼標題，例如標題字體、背景/前景色、對齊和位置（隱藏、上方、下方）等。
     </p>
    </div>
    <div class="col-lg-12">
     <h2 class="h2title">
     ...
     <p>
      JasperReports 的 Aspose.BarCode 完全用 Java 編碼，並以單個 JAR 文檔的形式提供，並可輕鬆部署到運行 JasperReports 或 JasperServer 的機器上。為了安裝 JasperReports Barcode 擴展，只需將 JAR 文檔複製到正確的文件夾位置，就可以開始了。
     </p>
    </div>
   </div>
  </div>
...
{{< blocks/products/pf/slr-element name="文檔" href="https://docs.aspose.com/barcode/jasperreports/" >}}
{{< blocks/products/pf/slr-element name="源代碼" href="https://github.com/aspose-barcode?tab=repositories" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼為 JasperReports 使用 Aspose.BarCode？" tabId="success-stories" >}}
