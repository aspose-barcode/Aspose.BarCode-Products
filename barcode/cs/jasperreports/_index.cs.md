---
title: Generujte čárové kódy v JasperReports a vykreslujte v BMP JPG GIF a PNG
description: Pomocí Aspose.BarCode pro JasperReports mohou vývojáři generovat čárové kódy v Jasper Reports, které se dále vykreslují ve formátech BMP JPG GIF a PNG.
lang: cs/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Generujte a exportujte čárové kódy v JasperReports" h2="JasperReports & JasperServer API pro generování, zobrazení a export 1D, 2D a poštovních čárových kódů." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="pro JasperReports" downloadUrl="https://releases.aspose.com/barcode/jasperreports/" >}}
...
<p>Aspose.BarCode for JasperReports je flexibilní rozšíření JasperReports a JasperServer pro vytváření a zobrazování štítků s čárovými kódy ve vašich aplikacích. Tyto štítky s čárovými kódy lze vykreslit v mnoha oblíbených obrázkových formátech.</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="Na první pohled" description="Přehled možností rozpoznávání a generování čárových kódů API." >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>Lineární, 2D a poštovní</li><li>Detekce ze streamu nebo obrázku</li><li>Získání orientace čárového kódu</li><li>Dekódování neanglických znaků</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                Tisk
            </header>
            <ul><li>Přímý tisk čárového kódu</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>Lineární, 2D a poštovní</li><li>Uložení do streamu nebo obrázku</li><li>Přizpůsobení vzhledu&colon; Velikost, Barva, Úhel</li><li>Kódování neanglických znaků </li></ul>
            <header>
                <i class="fa fa-qrcode">
                </i>
                Typy
            </header>
            <ul><li>Lineární</li><li>2D</li><li>Poštovní</li></ul>
        </div>
        <!--/right-->
    </div>
    <!--/row-->
...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="Aspose.BarCode pro JasperReports lze použít s JasperServer a JasperReports." >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="Aspose.BarCode pro JasperReports funguje s většinou běžně používaných formátů souborů obrázků." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Pokročilé funkce JasperReports pro export čárových kódů
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Vytvářejte a tiskněte sestavy s čárovými kódy</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Zvyšte pracovní tok aplikace přidáním funkce čárových kódů</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>Vkládejte čárové kódy do souborů pro usnadnění sledovatelnosti</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/barcode-image-basic-features/'>Velikost kontrolního kódu, barva a text kódu</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/read-barcodes-with-aspose-barcode-apis/'>Rozpoznání 3D zkreslených a otočených 2D čárových kódů</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/generate-barcode-by-specifying-custom-image-size/'>Vytvářejte obrázky čárových kódů konkrétní velikosti</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    Aspose.BarCode for JasperReports poskytuje speciální sadu nástrojů pro práci s čárovými kódy v JasperReports. Pomocí tohoto rozhraní API mohou vývojáři skenovat čárové kódy umístěné ve stávajících sestavách nebo je přidávat do nových sestav. Tato knihovna čárových kódů je kódována čistě v Javě a je poskytována jako jeden dokument JAR a lze ji snadno nasadit na počítačích s nainstalovanými JasperReports nebo JasperServer. Chcete-li nainstalovat rozšíření čárového kódu JasperReports, jednoduše zkopírujte dokument JAR do správného umístění složky a začněte pracovat.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Knihovna generátoru čárových kódů umožňuje vývojářům snadno vytvářet čárové kódy zadáním typu čárového kódu, zadáním dat ke kódování a nastavením vlastních vlastností souvisejících se vzhledem. To zahrnuje různé možnosti, jako je barva pozadí a popředí, písmo, velikost, rozlišení a textové popisky. Rozhraní API může generovat 1D i 2D čárové kódy, včetně PDF417, Data Matrix, Aztec kódu, QR kódu a mikro QR kódu, pomocí stejného základního přístupu. To z něj činí pohodlný a uživatelsky přívětivý nástroj pro generování široké škály typů čárových kódů pro různé aplikace, včetně JasperReports.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Vložte čárové kódy do JasperReports
                </h2>
                <p>
                    JasperReports umožňuje vývojářům vytvářet sestavy pomocí dat uložených v různých zdrojích, jako jsou databáze, soubory CSV a dokumenty XML. Poskytuje širokou škálu funkcí pro navrhování, formátování a export sestav, které lze snadno integrovat do aplikací Java. Některá běžná použití JasperReports zahrnují generování faktur, účtenek, finančních výkazů a dalších typů obchodních sestav. Může být užitečné vložit do JasperReports čárové kódy pro usnadnění přístupu a správy informací v reportech. Čárové kódy lze například použít k rychlému a přesnému naskenování a aktualizaci informací v JasperReportu, a to naskenováním čárového kódu na faktuře za účelem získání a zobrazení souvisejících dat. To by mohlo usnadnit sledování a správu informací a snížit riziko chyb nebo nesrovnalostí. Čárový kód může také sloužit k zobrazení konkrétních položek nebo záznamů v sestavě.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
<div class="barcode-read-lcs" style="width: 100%;">
    ...
    <div class="barcode-read-lcs-controls">
        <div class="barcode-read-lcs-drop" onclick="BarcodeReadLcsUpload(this);" ondragover="event.preventDefault();" ondrop="BarcodeReadLcsDropped(event,this);">
            ...
            <span class="barcode-read-lcs-recognizing">Rozpoznávání<span></span></span>
            <span class="barcode-read-lcs-hint">Sem přetáhněte soubor nebo kliknutím procházejte *</span>
        </div>
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">Všechny typy</option>
                <option value="Pdf417 ">PDF417</option>
                <option value="QR ">QR</option>
    ...
    <p class="barcode-read-lcs-disclaimer">* Nahráním souborů nebo používáním služby souhlasíte s našimi <a href='https://about.aspose.com/legal/terms-of-use' rel='nofollow noreferrer' target='_blank'>Podmínkami použijte</a> a <a href='https://about.aspose.com/legal/privacy-policy' rel='nofollow noreferrer' target='_blank'>zásady ochrany soukromí</a>.</p>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/pdf417/" name="PDF417" description="čárový kód PDF417" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/qr/" name="QR" description="QR kód, GS1 QR kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/datamatrix/" name="Data Matrix" description="Data Matrix kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/aztec/" name="Aztec" description="Kód Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/swiss-qr/" name="Swiss QR" description="Swiss QR účet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/dotcode/" name="DotCode" description="čárový kód DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/hibc/" name="HIBC" description="HIBC (čárový kód zdravotnictví)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/codablock/" name="Codablock-F" description="Čárové kódy Codablock-F a GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/databar/" name="GS1 DataBar" description="Čárový kód GS1 DataBar (všesměrový, skládaný všesměrový, rozšířený, rozšířený skládaný a zkrácený)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/itf/" name="ITF" description="Prokládaný čárový kód 2 z 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/ean/" name="EAN" description="Čárový kód EAN (International Article Number)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/upc/" name="UPC" description="Čárový kód UPC (Universal Product Code)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/code128/" name="GS1 Code 128" description="čárový kód GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/code39/" name="Code 39" description="čárový kód Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/code16k/" name="Code 16K" description="čárový kód Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/code32/" name="Code 32" description="Italský čárový kód Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/code93/" name="Code 93" description="Code 93 Rozšířené a Code 93 Standardní čárové kódy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/onecode/" name="USPS OneCode" description="čárový kód USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/standard2of5/" name="Standard 2 of 5" description="Čárový kód Standard 2 of 5 (Industrial 2 of 5)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/isbn/" name="ISBN" description="čárový kód ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/ismn/" name="ISMN" description="čárový kód ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/issn/" name="ISSN" description="čárový kód ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/australia-post/" name="Australia Post" description="Čárový kód Australia Post a eParcel Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode a Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/rm4scc/" name="RM4SCC" description="Kód zákazníka Royal Mail pro 4 státy (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/postnet/" name="Postnet" description="čárový kód Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/royal-mail/" name="Royal Mail" description="čárový kód Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/singapore-post/" name="Singapore Post" description="čárový kód Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/jasperreports/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="Co lidé říkají" subTitle="Neberte nás za slovo. Podívejte se, co uživatelé říkají o API." caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 Strávil jsem mnoho let vývojem a vylepšováním svého produktu a Aspose mi umožnil udělat můj produkt mnohem přátelštějším a užitečnějším, a tedy i prodejnějším. <em>Kiel Diller | KD Solutions, Polsko</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode je skutečně napsán ve spravovaném kódu a poskytuje nám různé typy čárových kódů, které nám umožňují zvládnout všechny druhy rozpoznávání a dalšího zpracování dokumentů. <em>Dennis Alexander Petrasc | Keil IT, Německo</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Dokumentace" href="https://docs.aspose.com/barcode/jasperreports/" >}}
{{< blocks/products/pf/slr-element name="Zdrojový kód" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Java" >}}
{{< blocks/products/pf/slr-element name="Reference API" href="https://reference.aspose.com/barcode/java/" >}}
...
{{< blocks/products/pf/slr-element name="Poznámky k vydání" href="https://docs.aspose.com/barcode/jasperreports/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.BarCode pro JasperReports?" tabId="success-stories" >}}
{{< blocks/products/pf/slr-element name="Seznam zákazníků" href="https://about.aspose.com/customers" >}}
{{< blocks/products/pf/slr-element name="Příběhy úspěchu" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Aspose.BarCode nabízí individuální rozhraní API pro generování a rozpoznávání čárových kódů pro další populární vývojová prostředí, jak je uvedeno níže:" >}}

    {{< blocks/products/pf/offers-section-item link="/barcode/cs/net/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-net.svg" sdkName=".NET" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/cs/java/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-java.svg" sdkName="Java" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/cs/cpp/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg" sdkName="C++" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/cs/android-java/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-android-java.svg" sdkName="Android via Java" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/cs/sharepoint/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-sharepoint.svg" sdkName="SharePoint" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/cs/reporting-services/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-reporting-services.svg" sdkName="Reporting Services" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/cs/php-java/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-php-java.svg" sdkName="PHP via Java" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/cs/nodejs-java/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-nodejs-java.svg" sdkName="Node.js via Java" >}}
    {{< blocks/products/pf/offers-section-item link="/barcode/cs/python-java/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-python-java.svg" sdkName="Python via Java" >}}
