---
title: Naskenujte obrázky Kód Aztec prostřednictvím služby Python via Java
weight: 1510
description: Zdrojový kód Pythonu pro rozpoznávání Kód Aztec pomocí prostředí Java Runtime Environment.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/python-java/aztec/recognize/
aliases:
- /cs/python-java/recognize/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Čtení čárových kódů Aztec pomocí Python via Java" h2="Přečtěte si Kód Aztec v Python pomocí Aspose.BarCode na straně serveru API pro Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Kód Aztec Using Python via Java" %}}
Chcete-li skenovat a dekódovat Kód Aztec, nainstalujte [Aspose.BarCode for Python přes Java](https://products.aspose.com/barcode/python-java/) API, všestranné, výkonné a snadno použitelné používat knihovnu čárových kódů pro aplikace založené na Pythonu. Získejte nejnovější verzi přímo z portálu [Aspose releases](https://releases.aspose.com/barcode/python-java/) nebo nainstalujte 'aspose-barcode' z pip spuštěním následujícího příkazu:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro skenování Kód Aztec v Python" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode umožňuje vývojářům číst čárové kódy Kód Aztec ze streamu nebo obrázku pomocí několika řádků kódu

{{% /blocks/products/pf/agp/text %}}

<ul><li>Vytvořte objekt třídy Aspose.BarCode.BarCodeReader</li><li>Definujte cestu ke zdrojovému souboru obsahující Kód Aztec jako parametr</li><li>Určete požadované typy čárových kódů v DecodeType jako druhý parametr</li><li>Procházet výsledky dekódování</li><li>Získat text čárového kódu pomocí vlastnosti CodeText</li></ul>
