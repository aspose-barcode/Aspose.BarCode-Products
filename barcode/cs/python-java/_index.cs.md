...
description: Knihovna čtečky čárových kódů Python pro rozpoznávání a generování více typů čárových kódů, včetně 1D, 2D a poštovních typů. Používejte API v aplikacích Pythonu.
lang: cs/
langdirlevel: 2
...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="Aspose.Barcode pro Python přes Javu používá python-java bridge a je dostupný pro Python 3.6 a vyšší." >}}
<div class='diagram1 d1-python'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="Aspose.BarCode pro Python via Java funguje s většinou běžně používaných formátů souborů obrázků." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/set-barcode-parameters/'>Správa parametrů čárových kódů</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/manage-barcode-appearance/'>Přizpůsobte velikost čárového kódu</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/generate-qr-code/'>Generování QR kódů</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/barcode-text-settings/'>Přizpůsobte textové titulky</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/save-generated-barcodes/'>Ukládejte čárové kódy v různých formátech</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-java/read-barcode-properties/'>Přečtěte si Vlastnosti čárového kódu</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/pdf417/" name="PDF417" description="čárový kód PDF417" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/qr/" name="QR" description="QR kód, GS1 QR kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/datamatrix/" name="Data Matrix" description="Data Matrix kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/aztec/" name="Aztec" description="Kód Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/swiss-qr/" name="Swiss QR" description="Swiss QR účet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/dotcode/" name="DotCode" description="čárový kód DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/hibc/" name="HIBC" description="HIBC (čárový kód zdravotnictví)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/codablock/" name="Codablock-F" description="Čárové kódy Codablock-F a GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/databar/" name="GS1 DataBar" description="Čárový kód GS1 DataBar (všesměrový, skládaný všesměrový, rozšířený, rozšířený skládaný a zkrácený)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/itf/" name="ITF" description="Prokládaný čárový kód 2 z 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/ean/" name="EAN" description="Čárový kód EAN (International Article Number)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/upc/" name="UPC" description="Čárový kód UPC (Universal Product Code)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/code128/" name="GS1 Code 128" description="čárový kód GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/code39/" name="Code 39" description="čárový kód Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/code16k/" name="Code 16K" description="čárový kód Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/code32/" name="Code 32" description="Italský čárový kód Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/code93/" name="Code 93" description="Code 93 Rozšířené a Code 93 Standardní čárové kódy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/onecode/" name="USPS OneCode" description="čárový kód USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/standard2of5/" name="Standard 2 of 5" description="Čárový kód Standard 2 of 5 (Industrial 2 of 5)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/isbn/" name="ISBN" description="čárový kód ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/ismn/" name="ISMN" description="čárový kód ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/issn/" name="ISSN" description="čárový kód ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/australia-post/" name="Australia Post" description="Čárový kód Australia Post a eParcel Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode a Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/rm4scc/" name="RM4SCC" description="Kód zákazníka Royal Mail pro 4 státy (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/postnet/" name="Postnet" description="čárový kód Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/royal-mail/" name="Royal Mail" description="čárový kód Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/singapore-post/" name="Singapore Post" description="čárový kód Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentace" href="https://docs.aspose.com/barcode/python-java/" >}}
{{< blocks/products/pf/slr-element name="Zdrojový kód" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Python-via-Java" >}}
{{< blocks/products/pf/slr-element name="Reference API" href="https://reference.aspose.com/barcode/python-java/" >}}
...
{{< blocks/products/pf/slr-element name="Poznámky k vydání" href="https://docs.aspose.com/barcode/python-java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.BarCode pro Python via Java?" tabId="success-stories" >}}
