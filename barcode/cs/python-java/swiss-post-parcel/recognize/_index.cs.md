---
title: Naskenujte obrázky Swiss Post Parcel prostřednictvím služby Python via Java
weight: 1510
description: Zdrojový kód Pythonu pro rozpoznávání Swiss Post Parcel pomocí prostředí Java Runtime Environment.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/python-java/swiss-post-parcel/recognize/
aliases:
- /cs/python-java/recognize/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Čtení čárových kódů Swiss Post Parcel pomocí Python via Java" h2="Přečtěte si Swiss Post Parcel v Python pomocí Aspose.BarCode na straně serveru API pro Python via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Chcete-li skenovat a dekódovat Swiss Post Parcel, nainstalujte [Aspose.BarCode for Python přes Java](https://products.aspose.com/barcode/python-java/) API, všestranné, výkonné a snadno použitelné používat knihovnu čárových kódů pro aplikace založené na Pythonu. Získejte nejnovější verzi přímo z portálu [Aspose releases](https://releases.aspose.com/barcode/python-java/) nebo nainstalujte 'aspose-barcode' z pip spuštěním následujícího příkazu:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro skenování Swiss Post Parcel v Python" %}}
...
<ul><li>Vytvořte objekt třídy Aspose.BarCode.BarCodeReader</li><li>Definujte cestu ke zdrojovému souboru obsahující Swiss Post Parcel jako parametr</li><li>Určete požadované typy čárových kódů v DecodeType jako druhý parametr</li><li>Procházet výsledky dekódování</li><li>Získat text čárového kódu pomocí vlastnosti CodeText</li></ul>
