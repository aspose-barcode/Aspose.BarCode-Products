---
title: Naskenujte obrázky Čárový kód GS1 DataBar (všesměrový, skládaný všesměrový, rozšířený, rozšířený skládaný a zkrácený) prostřednictvím služby .NET
weight: 1510
description: Ukázkový kód C# pro skenování a dekódování typu čárového kódu Čárový kód GS1 DataBar (všesměrový, skládaný všesměrový, rozšířený, rozšířený skládaný a zkrácený) v .NET Framework, .NET Standard, COM Interloop pro PHP, VBScript, Delphi nebo C++.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/net/databar/recognize/
aliases:
- /cs/net/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Čtení čárových kódů GS1 DataBar pomocí .NET" h2="Přečtěte si Čárový kód GS1 DataBar (všesměrový, skládaný všesměrový, rozšířený, rozšířený skládaný a zkrácený) v C# pomocí Aspose.BarCode na straně serveru API pro .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read čárový kód GS1 DataBar Using .NET" %}}
Chcete-li dekódovat čárový kód GS1 DataBar, vyzkoušejte [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, funkčně bohatou, výkonnou a snadno použitelnou knihovnu čárových kódů pro platformy C#. K instalaci balíčku použijte [NuGet](https://www.nuget.org/packages/aspose.barcode) a vyhledejte **Aspose.BarCode**. Případně spusťte následující příkaz z konzoly Správce balíčků:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro skenování čárový kód GS1 DataBar v C#" %}}
