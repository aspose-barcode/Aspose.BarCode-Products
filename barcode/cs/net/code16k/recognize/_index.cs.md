---
title: Naskenujte obrázky čárový kód Code 16K prostřednictvím služby .NET
weight: 1510
description: Ukázkový kód C# pro skenování a dekódování typu čárového kódu čárový kód Code 16K v .NET Framework, .NET Standard, COM Interloop pro PHP, VBScript, Delphi nebo C++.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/net/code16k/recognize/
aliases:
- /cs/net/recognize/code16k/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Čtení čárových kódů Code 16K pomocí .NET" h2="Přečtěte si čárový kód Code 16K v C# pomocí Aspose.BarCode na straně serveru API pro .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read čárový kód Code 16K Using .NET" %}}
Chcete-li dekódovat čárový kód Code 16K, vyzkoušejte [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API, funkčně bohatou, výkonnou a snadno použitelnou knihovnu čárových kódů pro platformy C#. K instalaci balíčku použijte [NuGet](https://www.nuget.org/packages/aspose.barcode) a vyhledejte **Aspose.BarCode**. Případně spusťte následující příkaz z konzoly Správce balíčků:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro skenování čárový kód Code 16K v C#" %}}
