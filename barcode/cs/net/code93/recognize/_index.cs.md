---
title: Naskenujte obrázky Code 93 Rozšířené a Code 93 Standardní čárové kódy prostřednictvím služby .NET
weight: 1510
description: Ukázkový kód C# pro skenování a dekódování typu čárového kódu Code 93 Rozšířené a Code 93 Standardní čárové kódy v .NET Framework, .NET Standard, COM Interloop pro PHP, VBScript, Delphi nebo C++.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/net/code93/recognize/
aliases:
- /cs/net/recognize/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Čtení čárových kódů Code 93 pomocí .NET" h2="Přečtěte si Code 93 Rozšířené a Code 93 Standardní čárové kódy v C# pomocí Aspose.BarCode na straně serveru API pro .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro skenování čárový kód Code 93 v C#" %}}
