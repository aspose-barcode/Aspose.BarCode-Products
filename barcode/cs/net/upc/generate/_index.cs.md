...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke generování Čárový kód UPC (Universal Product Code). v C#" %}}
...
<ul><li>Vytvořte instanci třídy BarcodeGenerator</li><li>Předejte Čárový kód UPC (Universal Product Code). jako parametr</li><li>Nastavte text pro kódování jako druhý parametr</li><li> V případě potřeby zadejte rozměry čárového kódu</li><li>Zavolejte BarcodeGenerator.Uložte metodu a získejte obrázek Čárový kód UPC (Universal Product Code).</li></ul>
