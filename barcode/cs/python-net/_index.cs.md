---
title: Python Barcode Generator a Scanner API
description: Knihovna čtečky čárových kódů Python pro rozpoznání a generování více typů čárových kódů včetně 1D, 2D a poštovních. Používejte API v aplikacích Pythonu.
lang: cs/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Knihovna čárových kódů Python" h2="Rozpoznejte nebo vygenerujte 1D, 2D a poštovní čárové kódy v jakékoli aplikaci Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-net.svg" pfName="Aspose.BarCode" subTitlepfName="pro Python via .NET" downloadUrl="https://releases.aspose.com/barcode/python-net" >}}
...
<p>Aspose.BarCode pro Python přes NET je sada rozhraní API pro generování a čtení čárových kódů, která mají být integrována do aplikací Pythonu. Vývojáři mohou snadno přidat funkci generování a rozpoznávání čárových kódů. Python barcode API vytváří obrázky čárových kódů v různých formátech, jako jsou PNG, JPG, GIF, BMP. Kromě toho podporuje více zobrazovacích funkcí, jako je manipulace s okraji, barvy, otáčení obrázků, přizpůsobení rozlišení a mnoho dalšího.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="Aspose.Barcode pro Python přes NET je k dispozici pro Python 3.6 a vyšší." >}}
<div class='diagram1 d1-python'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="Aspose.BarCode pro Python via .NET funguje s většinou běžně používaných formátů souborů obrázků." >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                Pokročilé funkce Pythonu prostřednictvím rozhraní .NET Barcode API
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/swiss-qr-code/'>Švýcarský QR kód</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/manage-barcode-appearance/'>Přizpůsobte vzhled čárového kódu</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/barcode-text-settings/'>Správa nastavení textu čárového kódu</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/generate-1d-barcodes/'>Speciální parametry typů 1D čárových kódů</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/generate-qr-code/'>Vygenerujte QR kód a mikro QR kód</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/python-net/barcode-reading-presets/'>Možnosti a předvolby kvality čtení čárových kódů</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    Aspose.BarCode pro Python prostřednictvím .NET poskytuje bohaté funkce pro vytváření přizpůsobených obrázků čárových kódů. Umožňuje generování čárových kódů libovolné barvy nebo velikosti v závislosti na obchodních potřebách. Je možné přizpůsobit vzhled všech prvků čárového kódu, včetně barev pruhů, pozadí, ohraničení a textových popisků, stejně jako jejich umístění. Čárový kód lze generovat s nebo bez zobrazení vstupního textu, horního a/nebo spodního titulku, výplní a ohraničení. Velikost čárového kódu lze nastavit automaticky v závislosti na rozměru X nebo ručně. Může být definován v různých jednotkách, jako jsou milimetry, palce, body nebo pixely. V případě potřeby lze upravit proporce obrazu a rozlišení. Písmo textu lze také přizpůsobit.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
            <div class="col-lg-12">
                ...
                <p>
                    API má schopnost generovat 2D čárové kódy nejoblíbenějších typů, jako je Data Matrix, Aztec Code, PDF417 atd. Tyto typy umožňují kódování velkých nebo nestandardních vstupních hodnot. Zde je kód pro generování QR kódu.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Optimalizujte rychlost nebo kvalitu čtení čárových kódů
                </h2>
                <p>
                    Knihovna čárových kódů poskytuje řadu výkonných funkcí pro optimalizaci čtení čárových kódů tak, aby vyhovovaly specifickým potřebám vašeho podnikání. Vývojáři mohou upravit parametry rozpoznávacího motoru, aby umožnili rychlé skenování čárových kódů nebo zlepšili přesnost čtení. V závislosti na kvalitě a parametrech obrázků zdrojového čárového kódu umožňuje knihovna přizpůsobení procesu rozpoznávání. Zahrnuje několik přednastavených konfigurací takových parametrů, které lze použít k rychlému skenování vysoce kvalitních obrázků čárových kódů nebo k usnadnění dekódování poškozených nebo degradovaných čárových kódů. Navíc existují speciální nastavení, která mohou zlepšit čtení čárových kódů pro různé typy zkreslení, jako je gaussovský šum, bílé skvrny a inverzní barvy. Díky schopnosti doladit proces rozpoznávání lze rozhraní API přizpůsobit tak, aby poskytovalo nejúčinnější čtení čárových kódů pro širokou škálu aplikací a scénářů.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/pdf417/" name="PDF417" description="čárový kód PDF417" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/qr/" name="QR" description="QR kód, GS1 QR kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/datamatrix/" name="Data Matrix" description="Data Matrix kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/aztec/" name="Aztec" description="Kód Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/swiss-qr/" name="Swiss QR" description="Swiss QR účet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/dotcode/" name="DotCode" description="čárový kód DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/hibc/" name="HIBC" description="HIBC (čárový kód zdravotnictví)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/codablock/" name="Codablock-F" description="Čárové kódy Codablock-F a GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/databar/" name="GS1 DataBar" description="Čárový kód GS1 DataBar (všesměrový, skládaný všesměrový, rozšířený, rozšířený skládaný a zkrácený)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/itf/" name="ITF" description="Prokládaný čárový kód 2 z 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/ean/" name="EAN" description="Čárový kód EAN (International Article Number)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/upc/" name="UPC" description="Čárový kód UPC (Universal Product Code)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/code128/" name="GS1 Code 128" description="čárový kód GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/code39/" name="Code 39" description="čárový kód Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/code16k/" name="Code 16K" description="čárový kód Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/code32/" name="Code 32" description="Italský čárový kód Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/code93/" name="Code 93" description="Code 93 Rozšířené a Code 93 Standardní čárové kódy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/onecode/" name="USPS OneCode" description="čárový kód USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/standard2of5/" name="Standard 2 of 5" description="Čárový kód Standard 2 of 5 (Industrial 2 of 5)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/isbn/" name="ISBN" description="čárový kód ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/ismn/" name="ISMN" description="čárový kód ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/issn/" name="ISSN" description="čárový kód ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/australia-post/" name="Australia Post" description="Čárový kód Australia Post a eParcel Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode a Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/rm4scc/" name="RM4SCC" description="Kód zákazníka Royal Mail pro 4 státy (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/postnet/" name="Postnet" description="čárový kód Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/royal-mail/" name="Royal Mail" description="čárový kód Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/singapore-post/" name="Singapore Post" description="čárový kód Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/python-net/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentace" href="https://docs.aspose.com/barcode/python-net/" >}}
{{< blocks/products/pf/slr-element name="Zdrojový kód" href="https://github.com/aspose-barcode/Aspose.BarCode-for-Python-via-.NET" >}}
{{< blocks/products/pf/slr-element name="Reference API" href="https://docs.aspose.com/barcode/python-net/api-reference/" >}}
...
{{< blocks/products/pf/slr-element name="Poznámky k vydání" href="https://docs.aspose.com/barcode/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.BarCode pro Python via .NET?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Aspose.BarCode nabízí individuální rozhraní API pro generování a rozpoznávání čárových kódů pro další populární vývojová prostředí, jak je uvedeno níže:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/barcode/cs/jasperreports/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-jasperreports.svg" sdkName="JasperReports" >}}
