---
title: Naskenujte obrázky čárový kód PDF417 prostřednictvím služby Java
weight: 1510
description: Zdrojový kód Java pro čtení a dekódování čárový kód PDF417 v prostředí Java Runtime Environment pro aplikace a desktopové aplikace JSP/JSF.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/java/pdf417/recognize/
aliases:
- /cs/java/recognize/pdf417/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Čtení čárových kódů PDF417 pomocí Java" h2="Přečtěte si čárový kód PDF417 v Java pomocí Aspose.BarCode na straně serveru API pro Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF417" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Vytvořte nový objekt třídy BarCodeReader</li><li>Nastavte cestu ke zdrojovému souboru obsahující čárový kód PDF417</li><li>Předejte požadované typy čárových kódů do DecodeType jako druhý parametr</li><li>Procházet výsledky dekódování</li><li>Získat text čárového kódu pomocí metody getCodeText</li></ul>
