...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke generování Čárový kód UPC (Universal Product Code). v Java" %}}
...
<ul><li>Vytvořit nový objekt třídy BarCodeGenerator</li><li>Definovat Čárový kód UPC (Universal Product Code). a ​​další požadované typy čárových kódů jako parametr EncodeTypes</li><li>Určit vstupní text pomocí metody setCodeText</li><li>K uložení vygenerovaného obrázku čárového kódu použijte metodu BarCodeGenerator.save</li></ul>
