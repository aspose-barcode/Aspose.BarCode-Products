---
title: Naskenujte obrázky čárový kód Code 16K prostřednictvím služby Java
weight: 1510
description: Zdrojový kód Java pro čtení a dekódování čárový kód Code 16K v prostředí Java Runtime Environment pro aplikace a desktopové aplikace JSP/JSF.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/java/code16k/recognize/
aliases:
- /cs/java/recognize/code16k/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Čtení čárových kódů Code 16K pomocí Java" h2="Přečtěte si čárový kód Code 16K v Java pomocí Aspose.BarCode na straně serveru API pro Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
<ul><li>Vytvořte nový objekt třídy BarCodeReader</li><li>Nastavte cestu ke zdrojovému souboru obsahující čárový kód Code 16K</li><li>Předejte požadované typy čárových kódů do DecodeType jako druhý parametr</li><li>Procházet výsledky dekódování</li><li>Získat text čárového kódu pomocí metody getCodeText</li></ul>
