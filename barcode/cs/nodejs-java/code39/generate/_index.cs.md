---
title: Generovat obrázky čárový kód Code 39 prostřednictvím Node.js via Java
description: Ukázkový kód Node.js pro generování čárový kód Code 39 v aplikacích JavaScript.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/nodejs-java/code39/generate/
aliases:
- /cs/nodejs-java/generate/code39/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Vygenerujte štítky Code 39 pomocí Node.js via Java" h2="Vytvořte čárový kód Code 39 v JavaScript pomocí Aspose.BarCode na straně serveru API pro Node.js via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 39" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate čárový kód Code 39 Using Node.js via Java" %}}
Chcete-li vytvořit čárové kódy čárový kód Code 39 v aplikacích Node.js, pořiďte si Aspose.BarCode pro Node.js prostřednictvím Javy, pokročilého, účinného a uživatelsky přívětivého rozhraní API pro čárové kódy navržené pro platformy orientované na Javu. Můžete snadno nainstalovat [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) pro Javascript z NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke generování čárový kód Code 39 v JavaScript" %}}
...
<ul><li>Vytvořte instanci třídy BarCodeGenerator</li><li>Nastavte čárový kód Code 39 jako parametr EncodeTypes</li><li>Definujte text pro kódování jako druhý parametr</li><li>V případě potřeby určete rozměry a umístění čárového kódu</li><li>Zavolejte metodu BarCodeGenerator.save a získejte vygenerovaný obrázek čárového kódu</li></ul>
