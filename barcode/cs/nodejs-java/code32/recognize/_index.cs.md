---
title: Naskenujte obrázky Italský čárový kód Pharmacode (Code 32). prostřednictvím služby Node.js via Java
weight: 1510
description: Zdrojový kód Node.js pro skenování a dekódování Italský čárový kód Pharmacode (Code 32). v aplikacích JavaScript.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/nodejs-java/code32/recognize/
aliases:
- /cs/nodejs-java/recognize/code32/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Čtení čárových kódů Code 32 pomocí Node.js via Java" h2="Přečtěte si Italský čárový kód Pharmacode (Code 32). v JavaScript pomocí Aspose.BarCode na straně serveru API pro Node.js via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 32" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read čárový kód Code 32 Using Node.js via Java" %}}
Chcete-li rozpoznat čárový kód Code 32 v aplikacích Node.js, použijte Aspose.BarCode pro Node.js prostřednictvím Javy, robustní, univerzální a uživatelsky přívětivou knihovnu čárových kódů zavedenou pro prostředí založená na Javě. Můžete načíst [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) pro Javascript přímo z NPM:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro skenování čárový kód Code 32 v JavaScript" %}}
...
<ul><li>Vytvořte objekt třídy Aspose.BarCode.BarCodeReader</li><li>Předejte cestu ke zdrojovému souboru obsahující čárový kód Code 32 jako parametr</li><li>Nastavte cílové typy čárových kódů v DecodeType jako druhý parametr</li><li>Procházet všechny detekované čárové kódy</li><li>Načíst výsledný text čárového kódu pomocí vlastnosti CodeText</li></ul>
