---
title: Vykreslování lineárních a 2D čárových kódů v SQL Server Reporting Services
description: Rozšíření vykreslování SQL Server Reporting Services - Export lineárních a 2D čárových kódů v SSRS. Vykreslování štítků s čárovými kódy ve formátech BMP JPEG GIF a PNG.
lang: cs/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Rozhraní API čárových kódů SSRS" h2="Generujte lineární a 2D čárové kódy v rámci Microsoft SQL Server Reporting Services." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-reporting-services.svg" pfName="Aspose.BarCode" subTitlepfName="pro SQL Reporting Services" downloadUrl="https://releases.aspose.com/barcode/reportingservices/" >}}
...
<p>Aspose.BarCode for Reporting Services je komplexní řešení pro vykreslování lineárních a 2D čárových kódů v rámci Microsoft SQL Server Reporting Services. Štítky s čárovými kódy lze zakódovat neanglickými znaky a vykreslit je ve formátech BMP, JPEG, GIF a PNG.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="Podporuje Microsoft SQL Server Reporting Services." >}}
<div class='diagram1 d1-rs'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="Aspose.BarCode pro SQL Reporting Services funguje s většinou běžně používaných formátů souborů obrázků." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/dynamically-display-barcodes-in-table/'>Dynamicky zobrazujte čárové kódy v tabulkách</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/display-barcodes-from-dataset/'>Zobrazení čárových kódů z datových sad</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/reportingservices/barcode-types-and-image-formats/'>Uložte čárové kódy ve formátech vektorových obrázků</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    Aspose.BarCode for Reporting Services lze snadno integrovat do stávajících nebo nových projektů přidáním Aspose.BarCode for Reporting Services do sady nástrojů Visual Studio. Jakmile je k dispozici v panelu nástrojů, můžete jej přetáhnout do projektu, kdekoli budete chtít.
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    Toto rozhraní API pro čárové kódy umožňuje vývojářům generovat vysoce kvalitní čárové kódy nastavením typu čárového kódu, vstupních dat pro kódování a vlastních vlastností souvisejících se vzhledem. Poskytuje řadu možností pro jemné doladění vzhledu generovaných čárových kódů, včetně barev pozadí a popředí, písma, velikosti, rozlišení a textových popisků.
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    Vlastní velikost a barva čárového kódu
                </h2>
                <p>
                    Aspose.BarCode pro SQL Reporting Services API poskytuje bohaté funkce pro generování obrázků čárových kódů s vlastními parametry. Vývojáři mohou vytvářet aplikace pro generování čárových kódů libovolné barvy nebo velikosti v závislosti na obchodních potřebách. Je možné přizpůsobit vzhled všech prvků čárového kódu, včetně barev pruhů, pozadí, ohraničení a textových popisků, stejně jako jejich umístění. Čárový kód lze generovat s nebo bez zobrazení vstupního textu, horního a/nebo spodního titulku, výplní a ohraničení. Velikost čárového kódu lze nastavit automaticky v závislosti na rozměru X nebo ručně. Může být definován v různých jednotkách, jako jsou milimetry, palce, body nebo pixely. V případě potřeby lze upravit proporce obrazu a rozlišení. Velikost písma textu lze také přizpůsobit.
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                ...
                <p>
                    Rozvržení štítků s čárovým kódem lze změnit pomocí plně integrovaného Návrháře čárových kódů pro Visual Studio. Vývojáři mohou zobrazit náhled a upravit obrázky čárových kódů v době návrhu. Návrhář také umožňuje přizpůsobení různých nastavení pro úpravu vzhledu obrázků čárových kódů.
                </p>
            </div>
<!--supportedSymbologiesSection-->
{{< blocks/products/pf/agp/other-symbologies-section title="Supported Barcode Types" subTitle="Using SQL Reporting Services, developers can read and generate barcodes of differen types, including the following." >}}

<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">2D:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/pdf417/" name="PDF417" description="čárový kód PDF417" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/qr/" name="QR" description="QR kód, GS1 QR kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/datamatrix/" name="Data Matrix" description="Data Matrix kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/aztec/" name="Aztec" description="Kód Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/swiss-qr/" name="Swiss QR" description="Swiss QR účet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/dotcode/" name="DotCode" description="čárový kód DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/hibc/" name="HIBC" description="HIBC (čárový kód zdravotnictví)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/codablock/" name="Codablock-F" description="Čárové kódy Codablock-F a GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/databar/" name="GS1 DataBar" description="Čárový kód GS1 DataBar (všesměrový, skládaný všesměrový, rozšířený, rozšířený skládaný a zkrácený)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/itf/" name="ITF" description="Prokládaný čárový kód 2 z 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/ean/" name="EAN" description="Čárový kód EAN (International Article Number)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/upc/" name="UPC" description="Čárový kód UPC (Universal Product Code)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/code128/" name="GS1 Code 128" description="čárový kód GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/code39/" name="Code 39" description="čárový kód Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/code16k/" name="Code 16K" description="čárový kód Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/code32/" name="Code 32" description="Italský čárový kód Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/code93/" name="Code 93" description="Code 93 Rozšířené a Code 93 Standardní čárové kódy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/onecode/" name="USPS OneCode" description="čárový kód USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/standard2of5/" name="Standard 2 of 5" description="Čárový kód Standard 2 of 5 (Industrial 2 of 5)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/isbn/" name="ISBN" description="čárový kód ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/ismn/" name="ISMN" description="čárový kód ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/issn/" name="ISSN" description="čárový kód ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/australia-post/" name="Australia Post" description="Čárový kód Australia Post a eParcel Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode a Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/rm4scc/" name="RM4SCC" description="Kód zákazníka Royal Mail pro 4 státy (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/postnet/" name="Postnet" description="čárový kód Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/royal-mail/" name="Royal Mail" description="čárový kód Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/singapore-post/" name="Singapore Post" description="čárový kód Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/reporting-services/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentace" href="https://docs.aspose.com/barcode/reportingservices/" >}}
{{< blocks/products/pf/slr-element name="Zdrojový kód" href="https://github.com/aspose-barcode/Aspose.BarCode-for-.NET" >}}
{{< blocks/products/pf/slr-element name="Reference API" href="https://reference.aspose.com/barcode/net/" >}}
...
{{< blocks/products/pf/slr-element name="Poznámky k vydání" href="https://docs.aspose.com/barcode/reportingservices/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.BarCode pro SQL Reporting Services?" tabId="success-stories" >}}
