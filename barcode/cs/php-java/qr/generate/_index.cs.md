...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke generování Kód QR v PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode usnadňuje vývojářům vytvářet obrázky Kód QR pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Vytvořte novou instanci třídy BarCodeGenerator</li><li>Uveďte Kód QR a ​​další relevantní typy čárových kódů jako parametr EncodeTypes</li><li>Nastavte text čárového kódu jako druhý parametr</li><li>V případě potřeby zadejte rozměry a umístění obrázku</li><li>Zavolejte metodu BarCodeGenerator.save a získejte obrázek QR kód, GS1 QR kód v požadovaném formátu</li></ul>
