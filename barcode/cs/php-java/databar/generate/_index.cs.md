---
title: Generovat obrázky Čárový kód GS1 DataBar (všesměrový, skládaný všesměrový, rozšířený, rozšířený skládaný a zkrácený) prostřednictvím PHP via Java
description: Zdrojový kód PHP pro vytvoření Čárový kód GS1 DataBar (všesměrový, skládaný všesměrový, rozšířený, rozšířený skládaný a zkrácený) v aplikacích založených na PHP.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/php-java/databar/generate/
aliases:
- /cs/php-java/generate/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Vygenerujte štítky GS1 DataBar pomocí PHP via Java" h2="Vytvořte Čárový kód GS1 DataBar (všesměrový, skládaný všesměrový, rozšířený, rozšířený skládaný a zkrácený) v PHP pomocí Aspose.BarCode na straně serveru API pro PHP via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate čárový kód GS1 DataBar Using PHP via Java" %}}
Vytvářejte přizpůsobené čárové kódy čárový kód GS1 DataBar v aplikacích PHP pomocí Aspose.BarCode for PHP prostřednictvím Java, efektivního, škálovatelného a uživatelsky přívětivého API pro čárové kódy určeného pro platformy založené na Javě. Chcete-li spustit knihovnu čárových kódů, stáhněte si nejnovější verzi z portálu [Aspose releases](https://releases.aspose.com/barcode/php/). V opačném případě získejte balíček [aspose/barcode](https://packagist.org/packages/aspose/barcode) od Packagist a poté jej vložte do svých projektů PHP pomocí skladatele:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke generování čárový kód GS1 DataBar v PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode usnadňuje vývojářům vytvářet obrázky čárový kód GS1 DataBar pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Vytvořte novou instanci třídy BarCodeGenerator</li><li>Uveďte čárový kód GS1 DataBar a ​​další relevantní typy čárových kódů jako parametr EncodeTypes</li><li>Nastavte text čárového kódu jako druhý parametr</li><li>V případě potřeby zadejte rozměry a umístění obrázku</li><li>Zavolejte metodu BarCodeGenerator.save a získejte obrázek Čárový kód GS1 DataBar (všesměrový, skládaný všesměrový, rozšířený, rozšířený skládaný a zkrácený) v požadovaném formátu</li></ul>
...
<ul><li>Microsoft Windows, Linux nebo jakýkoli operační systém kompatibilní s vývojovým prostředím PHP</li><li>Nainstalovaný PHP/Java Bridge</li><li>FastCGI a Tomcat Server 8.0 nebo vyšší</li> </ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/pdf417/generate/" name="PDF417" description="čárový kód PDF417" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/qr/generate/" name="QR" description="QR kód, GS1 QR kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/datamatrix/generate/" name="Data Matrix" description="Data Matrix kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/aztec/generate/" name="Aztec" description="Kód Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/swiss-qr/generate/" name="Swiss QR" description="Swiss QR účet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/dotcode/generate/" name="DotCode" description="čárový kód DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/hibc/generate/" name="HIBC" description="HIBC (čárový kód zdravotnictví)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/codablock/generate/" name="Codablock-F" description="Čárové kódy Codablock-F a GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/databar/generate/" name="GS1 DataBar" description="Čárový kód GS1 DataBar (všesměrový, skládaný všesměrový, rozšířený, rozšířený skládaný a zkrácený)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/itf/generate/" name="ITF" description="Prokládaný čárový kód 2 z 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/ean/generate/" name="EAN" description="Čárový kód EAN (International Article Number)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/upc/generate/" name="UPC" description="Čárový kód UPC (Universal Product Code)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/code128/generate/" name="GS1 Code 128" description="čárový kód GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/code39/generate/" name="Code 39" description="čárový kód Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/code16k/generate/" name="Code 16K" description="čárový kód Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/code32/generate/" name="Code 32" description="Italský čárový kód Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/code93/generate/" name="Code 93" description="Code 93 Rozšířené a Code 93 Standardní čárové kódy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/onecode/generate/" name="USPS OneCode" description="čárový kód USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/standard2of5/generate/" name="Standard 2 of 5" description="Čárový kód Standard 2 of 5 (Industrial 2 of 5)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/isbn/generate/" name="ISBN" description="čárový kód ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/ismn/generate/" name="ISMN" description="čárový kód ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/issn/generate/" name="ISSN" description="čárový kód ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/australia-post/generate/" name="Australia Post" description="Čárový kód Australia Post a eParcel Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Identcode a Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/rm4scc/generate/" name="RM4SCC" description="Kód zákazníka Royal Mail pro 4 státy (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/postnet/generate/" name="Postnet" description="čárový kód Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/royal-mail/generate/" name="Royal Mail" description="čárový kód Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/singapore-post/generate/" name="Singapore Post" description="čárový kód Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/php-java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
