---
title: Generovat obrázky Kód zákazníka Royal Mail pro 4 státy (RM4SCC) prostřednictvím PHP via Java
description: Zdrojový kód PHP pro vytvoření Kód zákazníka Royal Mail pro 4 státy (RM4SCC) v aplikacích založených na PHP.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/php-java/rm4scc/generate/
aliases:
- /cs/php-java/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Vygenerujte štítky RM4SCC pomocí PHP via Java" h2="Vytvořte Kód zákazníka Royal Mail pro 4 státy (RM4SCC) v PHP pomocí Aspose.BarCode na straně serveru API pro PHP via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke generování Kód zákazníka Royal Mail pro 4 státy (RM4SCC) v PHP" %}}
...
<ul><li>Vytvořte novou instanci třídy BarCodeGenerator</li><li>Uveďte Kód zákazníka Royal Mail pro 4 státy (RM4SCC) a ​​další relevantní typy čárových kódů jako parametr EncodeTypes</li><li>Nastavte text čárového kódu jako druhý parametr</li><li>V případě potřeby zadejte rozměry a umístění obrázku</li><li>Zavolejte metodu BarCodeGenerator.save a získejte obrázek Kód zákazníka Royal Mail pro 4 státy (RM4SCC) v požadovaném formátu</li></ul>
