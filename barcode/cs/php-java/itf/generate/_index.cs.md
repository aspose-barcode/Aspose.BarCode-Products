...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke generování Prokládaný čárový kód 2 z 5 (ITF). v PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode usnadňuje vývojářům vytvářet obrázky Prokládaný čárový kód 2 z 5 (ITF). pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Vytvořte novou instanci třídy BarCodeGenerator</li><li>Uveďte Prokládaný čárový kód 2 z 5 (ITF). a ​​další relevantní typy čárových kódů jako parametr EncodeTypes</li><li>Nastavte text čárového kódu jako druhý parametr</li><li>V případě potřeby zadejte rozměry a umístění obrázku</li><li>Zavolejte metodu BarCodeGenerator.save a získejte obrázek Prokládaný čárový kód 2 z 5 (ITF). v požadovaném formátu</li></ul>
