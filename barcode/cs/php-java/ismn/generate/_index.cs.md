...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke generování čárový kód ISMN v PHP" %}}
...
<ul><li>Vytvořte novou instanci třídy BarCodeGenerator</li><li>Uveďte čárový kód ISMN a ​​další relevantní typy čárových kódů jako parametr EncodeTypes</li><li>Nastavte text čárového kódu jako druhý parametr</li><li>V případě potřeby zadejte rozměry a umístění obrázku</li><li>Zavolejte metodu BarCodeGenerator.save a získejte obrázek čárový kód ISMN v požadovaném formátu</li></ul>
