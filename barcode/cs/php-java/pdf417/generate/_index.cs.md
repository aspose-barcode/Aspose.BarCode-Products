...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke generování čárový kód PDF417 v PHP" %}}
...
<ul><li>Vytvořte novou instanci třídy BarCodeGenerator</li><li>Uveďte čárový kód PDF417 a ​​další relevantní typy čárových kódů jako parametr EncodeTypes</li><li>Nastavte text čárového kódu jako druhý parametr</li><li>V případě potřeby zadejte rozměry a umístění obrázku</li><li>Zavolejte metodu BarCodeGenerator.save a získejte obrázek čárový kód PDF417 v požadovaném formátu</li></ul>
