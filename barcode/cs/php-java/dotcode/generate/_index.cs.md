...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke generování čárový kód DotCode v PHP" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode usnadňuje vývojářům vytvářet obrázky čárový kód DotCode pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

<ul><li>Vytvořte novou instanci třídy BarCodeGenerator</li><li>Uveďte čárový kód DotCode a ​​další relevantní typy čárových kódů jako parametr EncodeTypes</li><li>Nastavte text čárového kódu jako druhý parametr</li><li>V případě potřeby zadejte rozměry a umístění obrázku</li><li>Zavolejte metodu BarCodeGenerator.save a získejte obrázek čárový kód DotCode v požadovaném formátu</li></ul>
