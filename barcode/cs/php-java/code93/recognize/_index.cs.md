---
title: Naskenujte obrázky Code 93 Rozšířené a Code 93 Standardní čárové kódy prostřednictvím služby PHP via Java
weight: 1510
description: Ukázkový kód PHP pro čtení Code 93 Rozšířené a Code 93 Standardní čárové kódy v aplikacích založených na PHP.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/php-java/code93/recognize/
aliases:
- /cs/php-java/recognize/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Čtení čárových kódů Code 93 pomocí PHP via Java" h2="Přečtěte si Code 93 Rozšířené a Code 93 Standardní čárové kódy v PHP pomocí Aspose.BarCode na straně serveru API pro PHP via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for PHP via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro skenování čárový kód Code 93 v PHP" %}}
...
<ul><li>Vytvořte objekt třídy Aspose.BarCode.BarCodeReader</li><li>Nastavte cestu ke zdrojovému obrázku obsahující čárový kód Code 93 jako parametr</li><li>Určete cílové typy čárových kódů v DecodeType jako druhý parametr</li><li>Procházet výsledky čtení</li><li>Získat text čárového kódu pomocí vlastnosti CodeText</li></ul>
