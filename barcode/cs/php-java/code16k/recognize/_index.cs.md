...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro skenování čárový kód Code 16K v PHP" %}}
...
<ul><li>Vytvořte objekt třídy Aspose.BarCode.BarCodeReader</li><li>Nastavte cestu ke zdrojovému obrázku obsahující čárový kód Code 16K jako parametr</li><li>Určete cílové typy čárových kódů v DecodeType jako druhý parametr</li><li>Procházet výsledky čtení</li><li>Získat text čárového kódu pomocí vlastnosti CodeText</li></ul>
