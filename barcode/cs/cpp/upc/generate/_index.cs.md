...
<ul><li>Vytvořte objekt třídy BarcodeGenerator</li><li>Předejte Čárový kód UPC (Universal Product Code). jako parametr</li><li>Vložte vstupní text pro kódování jako druhý parametr</li><li>V případě potřeby definujte rozměry obrázku</li><li>Zavolejte BarcodeGenerator.Save metodu a stáhněte si čárový kód Čárový kód UPC (Universal Product Code).</li></ul>
