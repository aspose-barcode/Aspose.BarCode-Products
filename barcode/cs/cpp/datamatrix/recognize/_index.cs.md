---
title: Naskenujte obrázky Data Matrix kód prostřednictvím služby C++
weight: 1510
description: Ukázkový kód C++ pro skenování a dekódování Data Matrix kód v C++ Runtime Environment pro Windows 32-bit, Windows 64-bit nebo Linux 64-bit.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/cpp/datamatrix/recognize/
aliases:
- /cs/cpp/recognize/datamatrix/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Čtení čárových kódů Data Matrix pomocí C++" h2="Přečtěte si Data Matrix kód v C++ pomocí Aspose.BarCode na straně serveru API pro C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Data Matrix" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Data Matrix kód Using C++" %}}
Chcete-li naskenovat Data Matrix kód, vyzkoušejte [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, výkonnou a snadno použitelnou knihovnu čárových kódů s bohatými funkcemi pro platformy C++ . Jeho nejnovější verzi si můžete stáhnout přímo&colon; stačí otevřít správce balíčků [NuGet](https://www.nuget.org/packages/aspose.barcode), vyhledat **Aspose.BarCode.Cpp** a balíček nainstalovat. Případně můžete spustit následující příkaz z konzoly Správce balíčků.
