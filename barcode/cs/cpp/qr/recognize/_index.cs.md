---
title: Naskenujte obrázky QR kód, GS1 QR kód prostřednictvím služby C++
weight: 1510
description: Ukázkový kód C++ pro skenování a dekódování QR kód, GS1 QR kód v C++ Runtime Environment pro Windows 32-bit, Windows 64-bit nebo Linux 64-bit.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/cpp/qr/recognize/
aliases:
- /cs/cpp/recognize/qr/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Čtení čárových kódů QR pomocí C++" h2="Přečtěte si QR kód, GS1 QR kód v C++ pomocí Aspose.BarCode na straně serveru API pro C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="QR" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Kód QR Using C++" %}}
Chcete-li naskenovat Kód QR, vyzkoušejte [Aspose.BarCode for C++](https://products.aspose.com/barcode/cpp/) API, výkonnou a snadno použitelnou knihovnu čárových kódů s bohatými funkcemi pro platformy C++ . Jeho nejnovější verzi si můžete stáhnout přímo&colon; stačí otevřít správce balíčků [NuGet](https://www.nuget.org/packages/aspose.barcode), vyhledat **Aspose.BarCode.Cpp** a balíček nainstalovat. Případně můžete spustit následující příkaz z konzoly Správce balíčků.
