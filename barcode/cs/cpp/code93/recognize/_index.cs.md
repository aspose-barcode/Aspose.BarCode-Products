---
title: Naskenujte obrázky Code 93 Rozšířené a Code 93 Standardní čárové kódy prostřednictvím služby C++
weight: 1510
description: Ukázkový kód C++ pro skenování a dekódování Code 93 Rozšířené a Code 93 Standardní čárové kódy v C++ Runtime Environment pro Windows 32-bit, Windows 64-bit nebo Linux 64-bit.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/cpp/code93/recognize/
aliases:
- /cs/cpp/recognize/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Čtení čárových kódů Code 93 pomocí C++" h2="Přečtěte si Code 93 Rozšířené a Code 93 Standardní čárové kódy v C++ pomocí Aspose.BarCode na straně serveru API pro C++" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
