---
title: Naskenujte obrázky čárový kód ISMN prostřednictvím služby Android via Java
weight: 1510
description: Ukázkový kód pro Android pro rozpoznání čárový kód ISMN v běhovém prostředí Android.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/android-java/ismn/recognize/
aliases:
- /cs/android-java/recognize/ismn/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Čtení čárových kódů ISMN pomocí Android via Java" h2="Přečtěte si čárový kód ISMN v Java pomocí Aspose.BarCode na straně serveru API pro Android via Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ISMN" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read čárový kód ISMN Using Android via Java" %}}
Vyzkoušejte Aspose.BarCode pro Android přes Javu, abyste mohli snadno detekovat a číst čárový kód ISMN v aplikacích pro Android. Jedná se o bohaté, škálovatelné a uživatelsky přívětivé API pro čárové kódy určené pro aplikace Android. Získejte Aspose.BarCode pro Java přímo z projektu založeného na Maven přidáním následujících konfigurací do build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro skenování čárový kód ISMN v Java" %}}
...
<ul><li>Vytvořte instanci třídy BarCodeReader</li><li>Určete cestu ke zdrojovému obrázku obsahující čárový kód ISMN</li><li>Definujte cílové typy čárových kódů v DecodeType jako druhý parametr</li><li>Procházet výsledky rozpoznávání</li><li>Načíst dekódovaný text pomocí metody getCodeText</li></ul>
