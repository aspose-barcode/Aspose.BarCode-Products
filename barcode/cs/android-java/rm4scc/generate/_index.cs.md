---
title: Generovat obrázky Kód zákazníka Royal Mail pro 4 státy (RM4SCC) prostřednictvím Android via Java
description: Zdrojový kód Android k vytvoření Kód zákazníka Royal Mail pro 4 státy (RM4SCC) v prostředí Android Runtime Environment.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/android-java/rm4scc/generate/
aliases:
- /cs/android-java/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Vygenerujte štítky RM4SCC pomocí Android via Java" h2="Vytvořte Kód zákazníka Royal Mail pro 4 státy (RM4SCC) v Java pomocí Aspose.BarCode na straně serveru API pro Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Kód zákazníka Royal Mail pro 4 státy (RM4SCC) Using Android via Java" %}}
...
<ul><li>Vytvořte novou instanci třídy BarCodeGenerator</li><li>Předejte typ čárového kódu Kód zákazníka Royal Mail pro 4 státy (RM4SCC) jako parametr EncodeTypes</li><li>Definujte text čárového kódu pomocí metody setCodeText</li><li>Spusťte metodu createBarCodeImage() a uložte obrázek čárového kódu Kód zákazníka Royal Mail pro 4 státy (RM4SCC)</li></ul>
