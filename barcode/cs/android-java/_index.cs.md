---
title: Barcode Android API | Skenování nebo generování čárových kódů
description: Knihovna čtečky čárových kódů Android pro rozpoznání různých druhů 1D, 2D a poštovních čárových kódů. Skenujte čárové kódy z libovolného úhlu v aplikacích pro Android.
lang: cs/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Android API pro generování a rozpoznávání čárových kódů" h2="Vytvářejte nebo čtěte 1D, 2D a poštovní čárové kódy z obrázků v jakékoli mobilní aplikaci pro Android." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" pfName="Aspose.BarCode" subTitlepfName="pro Android via Java" downloadUrl="https://releases.aspose.com/barcode/androidjava/" >}}
...
<p>Aspose.BarCode pro Android přes Java je rozhraní API pro generování a čtení čárových kódů pro aplikace Android. Podporuje skenování 1D, 2D a poštovních čárových kódů z obrázků pod různými úhly. API generátoru čárových kódů může snadno vytvářet obrázky čárových kódů a ukládat je v různých formátech. Poskytuje také bohaté zobrazovací funkce, jako je přizpůsobení okrajů čárových kódů, barvy, úhlu natočení, rozlišení a mnoho dalšího.</p>
{{< /blocks/products/pf/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="Používejte API na jakékoli platformě, kde je k dispozici běhové prostředí Android." >}}
<div class='diagram1 d1-android'>
    <div class="d1-row">
        <div class="d1-col d1-left">
        </div>
...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="Aspose.BarCode pro Android via Java funguje s většinou běžně používaných formátů souborů obrázků." >}}
...
<!--advancedFeaturesSection-->
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/qr-code-generation/'>Kódujte neanglické znaky do QR kódů</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-color-modification/'>Upravit barevné schéma čárového kódu</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-appearance-customization/'>Otočte obrázky čárových kódů v libovolném úhlu</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/working-with-barcode-types/'>Generujte a rozpoznávejte čárové kódy více než 60 typů</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/recognition-settings/'>Čtení čárových kódů z obrázků</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/androidjava/barcode-image-saving/'>Export čárových kódů v různých formátech obrázků</a>
                </p>
            </div>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/pdf417/" name="PDF417" description="čárový kód PDF417" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/qr/" name="QR" description="QR kód, GS1 QR kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/datamatrix/" name="Data Matrix" description="Data Matrix kód" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/aztec/" name="Aztec" description="Kód Aztec" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/swiss-qr/" name="Swiss QR" description="Swiss QR účet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/dotcode/" name="DotCode" description="čárový kód DotCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/hibc/" name="HIBC" description="HIBC (čárový kód zdravotnictví)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/codablock/" name="Codablock-F" description="Čárové kódy Codablock-F a GS1 Codablock-F" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/databar/" name="GS1 DataBar" description="Čárový kód GS1 DataBar (všesměrový, skládaný všesměrový, rozšířený, rozšířený skládaný a zkrácený)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/itf/" name="ITF" description="Prokládaný čárový kód 2 z 5 (ITF)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/ean/" name="EAN" description="Čárový kód EAN (International Article Number)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/upc/" name="UPC" description="Čárový kód UPC (Universal Product Code)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/code128/" name="GS1 Code 128" description="čárový kód GS1 Code 128" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/code39/" name="Code 39" description="čárový kód Code 39" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/code16k/" name="Code 16K" description="čárový kód Code 16K" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/code32/" name="Code 32" description="Italský čárový kód Pharmacode (Code 32)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/code93/" name="Code 93" description="Code 93 Rozšířené a Code 93 Standardní čárové kódy" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/onecode/" name="USPS OneCode" description="čárový kód USPS OneCode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/standard2of5/" name="Standard 2 of 5" description="Čárový kód Standard 2 of 5 (Industrial 2 of 5)." >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/isbn/" name="ISBN" description="čárový kód ISBN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/ismn/" name="ISMN" description="čárový kód ISMN" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/issn/" name="ISSN" description="čárový kód ISSN" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/australia-post/" name="Australia Post" description="Čárový kód Australia Post a eParcel Australia Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode a Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/rm4scc/" name="RM4SCC" description="Kód zákazníka Royal Mail pro 4 státy (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/postnet/" name="Postnet" description="čárový kód Postnet" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/royal-mail/" name="Royal Mail" description="čárový kód Royal Mail" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/singapore-post/" name="Singapore Post" description="čárový kód Singapore Post" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/cs/android-java/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/slr-element name="Zdrojový kód" href="https://github.com/aspose-barcode/Android-Library-Usage-Examples" >}}
{{< blocks/products/pf/slr-element name="Reference API" href="https://reference.aspose.com/barcode/androidjava/" >}}
...
{{< blocks/products/pf/slr-element name="Poznámky k vydání" href="https://docs.aspose.com/barcode/java/android-via-java-release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.BarCode pro Android via Java?" tabId="success-stories" >}}
