---
title: Generovat obrázky Code 93 Rozšířené a Code 93 Standardní čárové kódy prostřednictvím Android via Java
description: Zdrojový kód Android k vytvoření Code 93 Rozšířené a Code 93 Standardní čárové kódy v prostředí Android Runtime Environment.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/android-java/code93/generate/
aliases:
- /cs/android-java/generate/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Vygenerujte štítky Code 93 pomocí Android via Java" h2="Vytvořte Code 93 Rozšířené a Code 93 Standardní čárové kódy v Java pomocí Aspose.BarCode na straně serveru API pro Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate čárový kód Code 93 Using Android via Java" %}}
Vyzkoušejte Aspose.BarCode pro Android prostřednictvím Javy a snadno vytvořte čárový kód Code 93 v aplikacích pro Android. Je to všestranná, robustní a uživatelsky přívětivá knihovna čárových kódů speciálně navržená pro aplikace Android. Aspose.BarCode pro Android můžete snadno přes Java přímo z projektu založeného na Maven vložením následujících konfigurací do build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke generování čárový kód Code 93 v Java" %}}
...
<ul><li>Vytvořte novou instanci třídy BarCodeGenerator</li><li>Předejte typ čárového kódu čárový kód Code 93 jako parametr EncodeTypes</li><li>Definujte text čárového kódu pomocí metody setCodeText</li><li>Spusťte metodu createBarCodeImage() a uložte obrázek čárového kódu Code 93 Rozšířené a Code 93 Standardní čárové kódy</li></ul>
