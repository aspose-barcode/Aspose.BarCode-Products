...
{{% blocks/products/pf/agp/content h2="How to Generate čárový kód GS1 Code 128 Using Android via Java" %}}
Vyzkoušejte Aspose.BarCode pro Android prostřednictvím Javy a snadno vytvořte čárový kód GS1 Code 128 v aplikacích pro Android. Je to všestranná, robustní a uživatelsky přívětivá knihovna čárových kódů speciálně navržená pro aplikace Android. Aspose.BarCode pro Android můžete snadno přes Java přímo z projektu založeného na Maven vložením následujících konfigurací do build.gradle:
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke generování čárový kód GS1 Code 128 v Java" %}}
...
<ul><li>Vytvořte novou instanci třídy BarCodeGenerator</li><li>Předejte typ čárového kódu čárový kód GS1 Code 128 jako parametr EncodeTypes</li><li>Definujte text čárového kódu pomocí metody setCodeText</li><li>Spusťte metodu createBarCodeImage() a uložte obrázek čárového kódu čárový kód GS1 Code 128</li></ul>
