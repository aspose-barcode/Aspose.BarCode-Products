---
title: Generovat obrázky čárový kód Code 16K prostřednictvím Android via Java
description: Zdrojový kód Android k vytvoření čárový kód Code 16K v prostředí Android Runtime Environment.
lang: cs/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /cs/android-java/code16k/generate/
aliases:
- /cs/android-java/generate/code16k/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Vygenerujte štítky Code 16K pomocí Android via Java" h2="Vytvořte čárový kód Code 16K v Java pomocí Aspose.BarCode na straně serveru API pro Android via Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 16K" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate čárový kód Code 16K Using Android via Java" %}}
Vyzkoušejte Aspose.BarCode pro Android prostřednictvím Javy a snadno vytvořte čárový kód Code 16K v aplikacích pro Android. Je to všestranná, robustní a uživatelsky přívětivá knihovna čárových kódů speciálně navržená pro aplikace Android. Aspose.BarCode pro Android můžete snadno přes Java přímo z projektu založeného na Maven vložením následujících konfigurací do build.gradle:
...
<ul><li>Vytvořte novou instanci třídy BarCodeGenerator</li><li>Předejte typ čárového kódu čárový kód Code 16K jako parametr EncodeTypes</li><li>Definujte text čárového kódu pomocí metody setCodeText</li><li>Spusťte metodu createBarCodeImage() a uložte obrázek čárového kódu čárový kód Code 16K</li></ul>
