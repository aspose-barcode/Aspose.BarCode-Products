...
<ul><li>BarcodeGenerator クラスのオブジェクトを作成する</li><li>パラメータとして DotCode バーコード を渡す</li><li>2 番目のパラメータとしてエンコードする入力テキストを挿入する</li><li>必要に応じて画像の寸法を定義します</li><li>BarcodeGenerator.Save メソッドを呼び出して、DotCode バーコード バーコードをダウンロードします</li></ul>
