...
<ul><li>BarcodeGenerator クラスのオブジェクトを作成する</li><li>パラメータとして Royal Mail 4-State 顧客コード (RM4SCC) を渡す</li><li>2 番目のパラメータとしてエンコードする入力テキストを挿入する</li><li>必要に応じて画像の寸法を定義します</li><li>BarcodeGenerator.Save メソッドを呼び出して、Royal Mail 4-State 顧客コード (RM4SCC) バーコードをダウンロードします</li></ul>
