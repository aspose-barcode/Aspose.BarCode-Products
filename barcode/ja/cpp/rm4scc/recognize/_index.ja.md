...
<ul><li>Aspose.BarCode.BarCodeReader クラスのオブジェクトを作成します</li><li>パラメータとして Royal Mail 4-State 顧客コード (RM4SCC) を含むソース画像パスを指定します</li><li>必要なバーコード タイプを渡します2 番目のパラメータとして DecodeType を指定します</li><li>認識結果をループします</li><li>CodeText プロパティを使用してデコードされたバーコード テキストをロードします</li></ul>
