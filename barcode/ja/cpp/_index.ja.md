---
title: バーコード用のC++ライブラリ|仮定する 
weight: 1610
url: /ja/cpp/ 
description: 1Dおよび2Dバーコード用のC++バーコードスキャナーおよびジェネレーターライブラリ。 Data Matrix PDF 417 UPCEANGS1インターリーブなどの複数のバーコードの読み取りと書き込みを検出します
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++バーコード処理API" h2="1Dおよび2Dタイプを作成または認識し、生成されたバーコードをC++アプリケーション内の複数の画像形式にエクスポートします。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-cpp.svg" pfName="Aspose.BarCode" subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/barcode/cpp" >}}
...
{{< blocks/products/pf/carousel-item h3="一目で" description="汎用APIの概要。" >}}
<div class="diagram1 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="バーコードC++ライブラリ" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
<div class="diagram1 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++のバーコードジェネレータ" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
<div class="diagram1 d2 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++バーコードリーダーライブラリ" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-cpp.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray">
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    <!-- <h2 class="h2title">郵便 Symbologies Include:</h2> -->
    <p>
     郵便の種類は次のとおりです。
    </p>
    <div class="col-lg-6">
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="cpp">//バーコードジェネレータを作成します
...
barcodeGenerator-&gt;Save(u"outputImage.jpg");</code></pre>
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="cpp">//予想されるコードタイプを指定しながら、ディスクからイメージをロードします
...
{{< blocks/products/pf/slr-element name="APIリファレンス" href="https://apireference.aspose.com/cpp/barcode" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="なぜC++用のAspose.BarCodeなのか？" tabId="success-stories" >}}
