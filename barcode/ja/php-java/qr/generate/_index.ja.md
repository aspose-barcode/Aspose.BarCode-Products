...
{{% blocks/products/pf/agp/content h2="How to Generate QR コード Using PHP via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="PHP で QR コード を生成する手順" %}}
...
<ul><li>BarCodeGenerator クラスの新しいインスタンスを作成します</li><li>QR コード およびその他の関連するバーコード タイプを EncodeTypes パラメータとして指定します</li><li>バーコード テキストを 2 番目のパラメータとして設定します</li><li>必要に応じて画像のサイズと場所を指定します</li><li>BarCodeGenerator.save メソッドを呼び出して、必要な形式で QR コード、GS1 QR コード 画像を取得します</li></ul>
