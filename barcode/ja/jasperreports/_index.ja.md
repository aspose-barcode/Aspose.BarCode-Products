---
title: JasperReports でバーコードを生成し、BMP JPG GIF および PNG でレンダリングする
description: Aspose.BarCode for JasperReports を使用すると、開発者は Jasper Reports でバーコードを生成し、さらに BMP JPG GIF および PNG 形式でレンダリングできます。
lang: ja/
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="JasperReports でバーコードを生成してエクスポートする" h2="1D、2D、および郵便バーコードを生成、表示、エクスポートするための JasperReports および JasperServer API。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-jasperreports.svg" pfName="Aspose.BarCode" subTitlepfName="JasperReports 用" downloadUrl="https://releases.aspose.com/barcode/jasperreports/" >}}
...
<p>Aspose.BarCode for JasperReports は、アプリケーションでバーコード ラベルを作成および表示するための柔軟な JasperReports および JasperServer 拡張機能です。これらのバーコード ラベルは、多くの一般的な画像形式でレンダリングできます。</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="一目でわかる" description="API のバーコード認識および生成機能の概要。" >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            ...
            <ul><li>リニア、2D、郵便</li><li>ストリームまたは画像から検出</li><li>バーコードの方向を取得</li><li>英語以外の文字をデコード</li> </ul>
            <header>
                <i class="fa fa-print">
                </i>
                印刷
            </header>
            <ul><li>バーコードを直接印刷する</li></ul>
        </div>
        <!--/left-->
        <div class="d1-col d1-right">
            ...
            <ul><li>リニア、2D、郵便</li><li>ストリームまたは画像に保存</li><li>外観のカスタマイズ&colon; サイズ、色、角度</li><li>英語以外の文字をエンコード</li></ul>
            <header>
                <i class="fa fa-qrcode">
                </i>
                種類
            </header>
            <ul><li>リニア</li><li>2D</li><li>郵便</li></ul>
        </div>
        <!--/right-->
    </div>
    <!--/row-->
...
{{< blocks/products/pf/carousel-item h3="プラットフォームの独立性" description="Aspose.BarCode for JasperReports は、JasperServer および JasperReports で使用できます。" >}}
<div class='diagram1 d1-jasper'>
    <div class="d1-row">
        <div class="d1-col d1-left">
            <header>
...
{{< blocks/products/pf/carousel-item h3="サポートされているファイル形式" description="JasperReports の Aspose.BarCode は、最も一般的に使用される画像ファイル形式で動作します。" >}}
...
<!--advancedFeaturesSection-->
            <h2 class="pr-ft">
                高度な JasperReports からバーコードへのエクスポート機能
            </h2>
            <p>
            </p>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>バーコードを含むレポートを生成および印刷する</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>バーコード機能を追加してアプリケーションのワークフローを向上</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/quickstart-tutorial/'>追跡可能性を高めるためにファイルにバーコードを埋め込む</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/barcode-image-basic-features/'>コードのサイズ、色、コードテキストを制御します</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/java/read-barcodes-with-aspose-barcode-apis/'>3D 歪みおよび回転した 2D バーコードの認識</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/jasperreports/generate-barcode-by-specifying-custom-image-size/'>特定のサイズのバーコード画像を作成する</a>
                </p>
            </div>
...
<!--simpleHeaderDescriptionSection1-->
            <div class="col-lg-12">
                ...
                <p>
                    Aspose.BarCode for JasperReports は、JasperReports でバーコードを操作するための特別なツール セットを提供します。この API を使用すると、開発者は既存のレポートに配置されたバーコードをスキャンしたり、新しいレポートにバーコードを追加したりできます。このバーコード ライブラリは純粋に Java でコーディングされており、単一の JAR ドキュメントとして提供され、JasperReports または JasperServer がインストールされているマシンに簡単に展開できます。 JasperReports バーコード拡張機能をインストールするには、JAR ドキュメントを適切なフォルダーの場所にコピーして作業を開始するだけです。
                </p>
            </div>
<!--simpleHeaderDescriptionSection1 End-->
                ...
                <p>
                    バーコード ジェネレーター ライブラリを使用すると、開発者はバーコードの種類を指定し、エンコードするデータを入力し、外観関連のカスタム プロパティを設定することで、バーコードを簡単に作成できます。これには、背景色と前景色、フォント、サイズ、解像度、テキスト キャプションなどのさまざまなオプションが含まれます。 API は、同じ基本アプローチを使用して、PDF417、Data Matrix、Aztec コード、QR コード、マイクロ QR コードを含む 1D バーコードと 2D バーコードの両方を生成できます。これにより、JasperReports を含むさまざまなアプリケーション向けに幅広い種類のバーコードを生成するための便利でユーザーフレンドリーなツールになります。
                </p>
...
{{< /blocks/products/pf/agp/feature-section2 >}}
            ...
            <div class="col-lg-12">
                <h2 class="h2title">
                    JasperReports にバーコードを挿入する
                </h2>
                <p>
                    JasperReports を使用すると、開発者はデータベース、CSV ファイル、XML ドキュメントなどのさまざまなソースに保存されたデータを使用してレポートを作成できます。レポートの設計、書式設定、エクスポートのための幅広い機能を提供しており、これらの機能は Java アプリケーションに簡単に統合できます。 JasperReports の一般的な用途には、請求書、領収書、財務諸表、その他の種類のビジネス レポートの生成が含まれます。レポート内の情報へのアクセスと管理を容易にするために、JasperReports にバーコードを挿入すると便利な場合があります。たとえば、バーコードを使用すると、JasperReport 内の情報を迅速かつ正確にスキャンして更新できます。つまり、請求書のバーコードをスキャンして、関連データを取得して表示します。これにより、情報の追跡と管理が容易になり、エラーや不一致のリスクが軽減されます。バーコードは、レポート内の特定の項目やレコードを表示するためにも使用できます。
                </p>
            </div>
            <div class="col-lg-12">
                <h2 class="h2title">
...
<div class="barcode-read-lcs" style="width: 100%;">
    ...
    <div class="barcode-read-lcs-controls">
        ...
        <div class="barcode-read-lcs-mods">
            <select name=type onchange="selectType(this)">
                <option value="AllSupportedTypes">いろんなタイプ</option>
                <option value="Pdf417 ">PDF417</option>
                <option value="QR ">QR</option>
    ...
    <p class="barcode-read-lcs-disclaimer">* ファイルをアップロードするかサービスを使用すると、<a href='https://about.aspose.com/legal/terms-of-use' rel='nofollow noreferrer' target='_blank'>利用規約に同意したことになります。使用</a>と<a href='https://about.aspose.com/legal/privacy-policy' rel='nofollow noreferrer' target='_blank'>プライバシー ポリシー</a>。</p>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/pdf417/" name="PDF417" description="PDF417 バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/qr/" name="QR" description="QR コード、GS1 QR コード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/datamatrix/" name="Data Matrix" description="Data Matrix コード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/aztec/" name="Aztec" description="Aztec コード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/swiss-qr/" name="Swiss QR" description="Swiss QR 請求書" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/dotcode/" name="DotCode" description="DotCode バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/hibc/" name="HIBC" description="HIBC (医療産業バーコード)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/codablock/" name="Codablock-F" description="Codablock-F および GS1 Codablock-F バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/databar/" name="GS1 DataBar" description="GS1 DataBar (全方向、スタック全方向、拡張、拡張スタック、および切り詰め) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/itf/" name="ITF" description="インターリーブ 2-of-5 (ITF) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/ean/" name="EAN" description="EAN (国際商品番号) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/upc/" name="UPC" description="UPC (ユニバーサル製品コード) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/code128/" name="GS1 Code 128" description="GS1 Code 128 バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/code39/" name="Code 39" description="Code 39 バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/code16k/" name="Code 16K" description="Code 16K バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/code32/" name="Code 32" description="イタリアのファーマコード (Code 32) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/code93/" name="Code 93" description="Code 93 拡張バーコードおよび Code 93 標準バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/onecode/" name="USPS OneCode" description="USPS OneCode バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/standard2of5/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 of 5) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/isbn/" name="ISBN" description="ISBN バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/ismn/" name="ISMN" description="ISMN バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/issn/" name="ISSN" description="ISSN バーコード" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/australia-post/" name="Australia Post" description="Australia Post バーコードと Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/deutsche-post/" name="Deutsche Post" description="Deutsche Post Identcode と Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/rm4scc/" name="RM4SCC" description="Royal Mail 4-State 顧客コード (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/postnet/" name="Postnet" description="Postnet バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/royal-mail/" name="Royal Mail" description="Royal Mail バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/singapore-post/" name="Singapore Post" description="Singapore Post バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/jasperreports/swiss-post-parcel/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
...
{{< blocks/products/pf/testimonials title="人々の意見" subTitle="私たちの言葉をそのまま鵜呑みにしないでください。 API についてのユーザーの意見をご覧ください。" caseStudiesLink="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 私は製品の開発と強化に何年も費やしてきましたが、Aspose のおかげで製品をよりフレンドリーで便利なものにし、より市場性の高いものにすることができました。 <em>キール・ディラー | KD ソリューションズ、ポーランド</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Aspose.BarCode はまさにマネージド コードで記述されており、あらゆる種類のドキュメント認識とさらなる処理を処理するためのさまざまなバーコード タイプを提供します。 <em>デニス・アレクサンダー・ペトラスク | Keil IT、ドイツ</em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="APIリファレンス" href="https://reference.aspose.com/barcode/java/" >}}
...
{{< blocks/products/pf/slr-element name="リリースノート" href="https://docs.aspose.com/barcode/jasperreports/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="JasperReports に Aspose.BarCode を使用する理由" tabId="success-stories" >}}
{{< blocks/products/pf/slr-element name="顧客リスト" href="https://about.aspose.com/customers" >}}
{{< blocks/products/pf/slr-element name="成功事例" href="https://downloads.aspose.com/corporate/case-studies/aspose.barcode/" >}}
{{< /blocks/products/pf/slr-tab >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.BarCode" description="Aspose.BarCode は、以下に示す他の一般的な開発環境向けに個別のバーコード生成および認識 API を提供します。" >}}
