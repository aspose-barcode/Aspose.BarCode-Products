---
title: .NET 経由で Deutsche Post Identcode と Deutsche Post Leitcode 画像をスキャンします
weight: 1510
description: .NET Framework、.NET Standard、COM Interloop for PHP、VBScript、Delphi、または C++ で Deutsche Post Identcode と Deutsche Post Leitcode バーコード タイプをスキャンしてデコードするための C# サンプル コード。
lang: ja
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ja/net/deutsche-post/recognize/
aliases:
- /ja/net/recognize/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET で Deutsche Post バーコードを読み取ります" h2=".NET API のサーバー側 Aspose.BarCode を使用して、C# で Deutsche Post Identcode と Deutsche Post Leitcode を読み取ります" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Deutsche Post バーコード Using .NET" %}}
Deutsche Post バーコード をデコードするには、機能が豊富で強力で使いやすいバーコード ライブラリである [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API を試してください。 C# プラットフォーム用。 [NuGet](https://www.nuget.org/packages/aspose.barcode) を使用し、**Aspose.BarCode** を検索してパッケージをインストールします。あるいは、パッケージ マネージャー コンソールから次のコマンドを実行します。
...
{{% blocks/products/pf/agp/feature-section-col title="C# で Deutsche Post バーコード をスキャンする手順" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode を使用すると、開発者は数行のコードでストリームまたは画像から Deutsche Post バーコード バーコードを読み取ることができます

{{% /blocks/products/pf/agp/text %}}

<ul><li>Aspose.BarCode.BarCodeReader クラスの新しいインスタンスを作成します</li><li>パラメータとして Deutsche Post バーコード を含むソース画像パスを渡します</li><li>適切な DecodeType を渡します2 番目のパラメータ</li><li>デコード結果をループします</li><li>CodeText プロパティを使用してバーコード テキストを取得します</li></ul>
...
<ul><li>Microsoft Windows、Linux、または .NET Framework、.NET Standard、COM Interloop for PHP、VBScript、Delphi、または C++ と互換性のある OS</li><li>Microsoft Visual Studio などの開発環境.</li><li>プロジェクトで参照されている .NET ライブラリ DLL 用の Aspose.BarCode - [ダウンロード] ボタンを使用して NuGet からインストールします</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/pdf417/recognize/" name="PDF417" description="PDF417 バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/qr/recognize/" name="QR" description="QR コード、GS1 QR コード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/datamatrix/recognize/" name="Data Matrix" description="Data Matrix コード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/aztec/recognize/" name="Aztec" description="Aztec コード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/swiss-qr/recognize/" name="Swiss QR" description="Swiss QR 請求書" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/dotcode/recognize/" name="DotCode" description="DotCode バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/hibc/recognize/" name="HIBC" description="HIBC (医療産業バーコード)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/codablock/recognize/" name="Codablock-F" description="Codablock-F および GS1 Codablock-F バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/databar/recognize/" name="GS1 DataBar" description="GS1 DataBar (全方向、スタック全方向、拡張、拡張スタック、および切り詰め) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/itf/recognize/" name="ITF" description="インターリーブ 2-of-5 (ITF) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/ean/recognize/" name="EAN" description="EAN (国際商品番号) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/upc/recognize/" name="UPC" description="UPC (ユニバーサル製品コード) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/code128/recognize/" name="GS1 Code 128" description="GS1 Code 128 バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/code39/recognize/" name="Code 39" description="Code 39 バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/code16k/recognize/" name="Code 16K" description="Code 16K バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/code32/recognize/" name="Code 32" description="イタリアのファーマコード (Code 32) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/code93/recognize/" name="Code 93" description="Code 93 拡張バーコードおよび Code 93 標準バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/onecode/recognize/" name="USPS OneCode" description="USPS OneCode バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/standard2of5/recognize/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 of 5) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/isbn/recognize/" name="ISBN" description="ISBN バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/ismn/recognize/" name="ISMN" description="ISMN バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/issn/recognize/" name="ISSN" description="ISSN バーコード" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/australia-post/recognize/" name="Australia Post" description="Australia Post バーコードと Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/deutsche-post/recognize/" name="Deutsche Post" description="Deutsche Post Identcode と Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/rm4scc/recognize/" name="RM4SCC" description="Royal Mail 4-State 顧客コード (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/postnet/recognize/" name="Postnet" description="Postnet バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/royal-mail/recognize/" name="Royal Mail" description="Royal Mail バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/singapore-post/recognize/" name="Singapore Post" description="Singapore Post バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/net/swiss-post-parcel/recognize/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
