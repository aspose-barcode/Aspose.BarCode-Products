...
{{< blocks/products/pf/upper-banner h1=".NET で Australia Post バーコードを読み取ります" h2=".NET API のサーバー側 Aspose.BarCode を使用して、C# で Australia Post バーコードと Australia Post eParcel を読み取ります" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Australia Post" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Australia Post バーコード Using .NET" %}}
Australia Post バーコード をデコードするには、機能が豊富で強力で使いやすいバーコード ライブラリである [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API を試してください。 C# プラットフォーム用。 [NuGet](https://www.nuget.org/packages/aspose.barcode) を使用し、**Aspose.BarCode** を検索してパッケージをインストールします。あるいは、パッケージ マネージャー コンソールから次のコマンドを実行します。
...
{{% blocks/products/pf/agp/feature-section-col title="C# で Australia Post バーコード をスキャンする手順" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader クラスの新しいインスタンスを作成します</li><li>パラメータとして Australia Post バーコード を含むソース画像パスを渡します</li><li>適切な DecodeType を渡します2 番目のパラメータ</li><li>デコード結果をループします</li><li>CodeText プロパティを使用してバーコード テキストを取得します</li></ul>
