---
title: .NET 経由で EAN (国際商品番号) バーコード 画像をスキャンします
weight: 1510
description: .NET Framework、.NET Standard、COM Interloop for PHP、VBScript、Delphi、または C++ で EAN (国際商品番号) バーコード バーコード タイプをスキャンしてデコードするための C# サンプル コード。
lang: ja/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ja/net/ean/recognize/
aliases:
- /ja/net/recognize/ean/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET で EAN バーコードを読み取ります" h2=".NET API のサーバー側 Aspose.BarCode を使用して、C# で EAN (国際商品番号) バーコード を読み取ります" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EAN" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read EAN (国際商品番号) バーコード Using .NET" %}}
EAN (国際商品番号) バーコード をデコードするには、機能が豊富で強力で使いやすいバーコード ライブラリである [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API を試してください。 C# プラットフォーム用。 [NuGet](https://www.nuget.org/packages/aspose.barcode) を使用し、**Aspose.BarCode** を検索してパッケージをインストールします。あるいは、パッケージ マネージャー コンソールから次のコマンドを実行します。
...
{{% blocks/products/pf/agp/feature-section-col title="C# で EAN (国際商品番号) バーコード をスキャンする手順" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader クラスの新しいインスタンスを作成します</li><li>パラメータとして EAN (国際商品番号) バーコード を含むソース画像パスを渡します</li><li>適切な DecodeType を渡します2 番目のパラメータ</li><li>デコード結果をループします</li><li>CodeText プロパティを使用してバーコード テキストを取得します</li></ul>
