---
title: .NET 経由で GS1 DataBar (全方向、スタック全方向、拡張、拡張スタック、および切り詰め) バーコード 画像をスキャンします
weight: 1510
description: .NET Framework、.NET Standard、COM Interloop for PHP、VBScript、Delphi、または C++ で GS1 DataBar (全方向、スタック全方向、拡張、拡張スタック、および切り詰め) バーコード バーコード タイプをスキャンしてデコードするための C# サンプル コード。
lang: ja
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ja/net/databar/recognize/
aliases:
- /ja/net/recognize/databar/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET で GS1 DataBar バーコードを読み取ります" h2=".NET API のサーバー側 Aspose.BarCode を使用して、C# で GS1 DataBar (全方向、スタック全方向、拡張、拡張スタック、および切り詰め) バーコード を読み取ります" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GS1 DataBar" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read GS1 DataBar バーコード Using .NET" %}}
GS1 DataBar バーコード をデコードするには、機能が豊富で強力で使いやすいバーコード ライブラリである [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API を試してください。 C# プラットフォーム用。 [NuGet](https://www.nuget.org/packages/aspose.barcode) を使用し、**Aspose.BarCode** を検索してパッケージをインストールします。あるいは、パッケージ マネージャー コンソールから次のコマンドを実行します。
...
{{% blocks/products/pf/agp/feature-section-col title="C# で GS1 DataBar バーコード をスキャンする手順" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader クラスの新しいインスタンスを作成します</li><li>パラメータとして GS1 DataBar バーコード を含むソース画像パスを渡します</li><li>適切な DecodeType を渡します2 番目のパラメータ</li><li>デコード結果をループします</li><li>CodeText プロパティを使用してバーコード テキストを取得します</li></ul>
