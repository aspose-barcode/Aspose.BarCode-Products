---
title: .NET 経由で Postnet バーコード 画像をスキャンします
weight: 1510
description: .NET Framework、.NET Standard、COM Interloop for PHP、VBScript、Delphi、または C++ で Postnet バーコード バーコード タイプをスキャンしてデコードするための C# サンプル コード。
lang: ja/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ja/net/postnet/recognize/
aliases:
- /ja/net/recognize/postnet/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=".NET で Postnet バーコードを読み取ります" h2=".NET API のサーバー側 Aspose.BarCode を使用して、C# で Postnet バーコード を読み取ります" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Postnet" pfName="Aspose.BarCode" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Postnet バーコード Using .NET" %}}
Postnet バーコード をデコードするには、機能が豊富で強力で使いやすいバーコード ライブラリである [Aspose.BarCode for .NET](https://products.aspose.com/barcode/net/) API を試してください。 C# プラットフォーム用。 [NuGet](https://www.nuget.org/packages/aspose.barcode) を使用し、**Aspose.BarCode** を検索してパッケージをインストールします。あるいは、パッケージ マネージャー コンソールから次のコマンドを実行します。
...
{{% blocks/products/pf/agp/feature-section-col title="C# で Postnet バーコード をスキャンする手順" %}}
...
<ul><li>Aspose.BarCode.BarCodeReader クラスの新しいインスタンスを作成します</li><li>パラメータとして Postnet バーコード を含むソース画像パスを渡します</li><li>適切な DecodeType を渡します2 番目のパラメータ</li><li>デコード結果をループします</li><li>CodeText プロパティを使用してバーコード テキストを取得します</li></ul>
