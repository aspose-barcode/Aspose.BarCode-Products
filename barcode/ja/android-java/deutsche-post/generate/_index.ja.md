---
title: Android via Java 経由で Deutsche Post Identcode と Deutsche Post Leitcode イメージを生成
description: Android ランタイム環境で Deutsche Post Identcode と Deutsche Post Leitcode を作成するための Android ソースコード。
lang: ja/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ja/android-java/deutsche-post/generate/
aliases:
- /ja/android-java/generate/deutsche-post/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Android via Java で Deutsche Post ラベルを生成します" h2="Android via Java API のサーバー側 Aspose.BarCode を使用して、Java に Deutsche Post Identcode と Deutsche Post Leitcode を作成します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Deutsche Post" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Deutsche Post バーコード Using Android via Java" %}}
Java 経由で Aspose.BarCode for Android を試して、Android アプリケーション内に Deutsche Post バーコード を簡単に作成してください。これは、Android アプリケーション用に特別に設計された、多用途で堅牢かつユーザーフレンドリーなバーコード ライブラリです。次の構成を build.gradle に挿入することで、Maven ベースのプロジェクトから Java 経由で Android 用の Aspose.BarCode を直接簡単に作成できます。
...
{{% blocks/products/pf/agp/feature-section-col title="Java で Deutsche Post バーコード を生成する手順" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode を使用すると、開発者は数行のコードで Deutsche Post バーコード 画像を簡単に作成できます。

{{% /blocks/products/pf/agp/text %}}

<ul><li>BarCodeGenerator クラスの新しいインスタンスを作成する</li><li>Deutsche Post バーコード バーコード タイプを EncodeTypes パラメータとして渡す</li><li>setCodeText メソッドを使用してバーコード テキストを定義する</li><li>generateBarCodeImage() メソッドを起動して、Deutsche Post Identcode と Deutsche Post Leitcode バーコード画像を保存します</li></ul>
...
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/pdf417/generate/" name="PDF417" description="PDF417 バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/qr/generate/" name="QR" description="QR コード、GS1 QR コード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/datamatrix/generate/" name="Data Matrix" description="Data Matrix コード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/aztec/generate/" name="Aztec" description="Aztec コード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/swiss-qr/generate/" name="Swiss QR" description="Swiss QR 請求書" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/dotcode/generate/" name="DotCode" description="DotCode バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/hibc/generate/" name="HIBC" description="HIBC (医療産業バーコード)" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Linear:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/codablock/generate/" name="Codablock-F" description="Codablock-F および GS1 Codablock-F バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/databar/generate/" name="GS1 DataBar" description="GS1 DataBar (全方向、スタック全方向、拡張、拡張スタック、および切り詰め) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/itf/generate/" name="ITF" description="インターリーブ 2-of-5 (ITF) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/ean/generate/" name="EAN" description="EAN (国際商品番号) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/upc/generate/" name="UPC" description="UPC (ユニバーサル製品コード) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/code128/generate/" name="GS1 Code 128" description="GS1 Code 128 バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/code39/generate/" name="Code 39" description="Code 39 バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/code16k/generate/" name="Code 16K" description="Code 16K バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/code32/generate/" name="Code 32" description="イタリアのファーマコード (Code 32) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/code93/generate/" name="Code 93" description="Code 93 拡張バーコードおよび Code 93 標準バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/onecode/generate/" name="USPS OneCode" description="USPS OneCode バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/standard2of5/generate/" name="Standard 2 of 5" description="Standard 2 of 5 (Industrial 2 of 5) バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/isbn/generate/" name="ISBN" description="ISBN バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/ismn/generate/" name="ISMN" description="ISMN バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/issn/generate/" name="ISSN" description="ISSN バーコード" >}}
</div>
<p class="tl d-block" style="margin: 15px 0 7px 0 !important;">Postal:</p>
<div class="row other-converters">
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/australia-post/generate/" name="Australia Post" description="Australia Post バーコードと Australia Post eParcel" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/deutsche-post/generate/" name="Deutsche Post" description="Deutsche Post Identcode と Deutsche Post Leitcode" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/rm4scc/generate/" name="RM4SCC" description="Royal Mail 4-State 顧客コード (RM4SCC)" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/postnet/generate/" name="Postnet" description="Postnet バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/royal-mail/generate/" name="Royal Mail" description="Royal Mail バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/singapore-post/generate/" name="Singapore Post" description="Singapore Post バーコード" >}}
{{< blocks/products/pf/agp/other-symbologies-section-item href="/barcode/ja/android-java/swiss-post-parcel/generate/" name="Swiss Post Parcel" description="Swiss Post Parcel" >}}
</div>
