---
title: Android via Java 経由で Postnet バーコード 画像をスキャンします
weight: 1510
description: Android ランタイム環境で Postnet バーコード を認識するための Android サンプル コード。
lang: ja/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ja/android-java/postnet/recognize/
aliases:
- /ja/android-java/recognize/postnet/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Android via Java で Postnet バーコードを読み取ります" h2="Android via Java API のサーバー側 Aspose.BarCode を使用して、Java で Postnet バーコード を読み取ります" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-android-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Postnet" pfName="Aspose.BarCode" subTitlepfName="for Android via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Postnet バーコード Using Android via Java" %}}
Java 経由で Aspose.BarCode for Android を試して、Android アプリケーション内の Postnet バーコード を簡単に検出して読み取ります。これは、Android アプリケーションを対象とした、機能が豊富でスケーラブルで使いやすいバーコード API です。次の構成を build.gradle に追加して、Maven ベースのプロジェクトから Aspose.BarCode for Java を直接取得します。
...
{{% blocks/products/pf/agp/feature-section-col title="Java で Postnet バーコード をスキャンする手順" %}}
...
<ul><li>BarCodeReader クラスのインスタンスを作成する</li><li>Postnet バーコード を含むソース画像パスを決定する</li><li>2 番目のパラメータとして DecodeType でターゲット バーコード タイプを定義する</li><li>認識結果をループします</li><li>getCodeText メソッドを実行してデコードされたテキストをロードします</li></ul>
