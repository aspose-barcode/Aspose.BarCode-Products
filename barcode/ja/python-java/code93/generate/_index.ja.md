---
title: Python via Java 経由で Code 93 拡張バーコードおよび Code 93 標準バーコード イメージを生成
description: Java ランタイム環境を使用して Code 93 拡張バーコードおよび Code 93 標準バーコード を生成する Python サンプル コード。
lang: ja
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ja/python-java/code93/generate/
aliases:
- /ja/python-java/generate/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Python via Java で Code 93 ラベルを生成します" h2="Python via Java API のサーバー側 Aspose.BarCode を使用して、Python に Code 93 拡張バーコードおよび Code 93 標準バーコード を作成します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python で Code 93 バーコード を生成する手順" %}}
...
<ul><li>BarCodeGenerator クラスの新しいオブジェクトを作成します</li><li>EncodeTypes パラメータとして目的のバーコード タイプを決定します</li><li>2 番目のパラメータとして入力テキストを挿入します</li><li> BarCodeGenerator.save メソッドを呼び出して、生成された Code 93 拡張バーコードおよび Code 93 標準バーコード 画像を取得します</li></ul>
