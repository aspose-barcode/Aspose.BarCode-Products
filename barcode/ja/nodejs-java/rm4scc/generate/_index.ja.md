---
title: Node.js via Java 経由で Royal Mail 4-State 顧客コード (RM4SCC) イメージを生成
description: JavaScript アプリケーションでの Royal Mail 4-State 顧客コード (RM4SCC) 生成用の Node.js サンプル コード。
lang: ja
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ja/nodejs-java/rm4scc/generate/
aliases:
- /ja/nodejs-java/generate/rm4scc/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js via Java で RM4SCC ラベルを生成します" h2="Node.js via Java API のサーバー側 Aspose.BarCode を使用して、JavaScript に Royal Mail 4-State 顧客コード (RM4SCC) を作成します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RM4SCC" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate Royal Mail 4-State 顧客コード (RM4SCC) Using Node.js via Java" %}}
Node.js アプリケーション内で Royal Mail 4-State 顧客コード (RM4SCC) バーコードを作成するには、Java 経由で Aspose.BarCode for Node.js を取得します。これは、Java 指向のプラットフォーム向けに設計された、高度で強力で使いやすいバーコード API です。 NPM から Javascript 用の [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) を簡単にインストールできます。
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript で Royal Mail 4-State 顧客コード (RM4SCC) を生成する手順" %}}
...
<ul><li>BarCodeGenerator クラスのインスタンスを作成する</li><li>Royal Mail 4-State 顧客コード (RM4SCC) を EncodeTypes パラメータとして設定する</li><li>2 番目のパラメータとしてエンコードするテキストを定義する</li><li>必要に応じてバーコードの寸法と位置を決定します</li><li>BarCodeGenerator.save メソッドを呼び出して、生成されたバーコード画像を取得します</li></ul>
