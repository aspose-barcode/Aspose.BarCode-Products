---
title: Node.js via Java 経由で Code 93 拡張バーコードおよび Code 93 標準バーコード 画像をスキャンします
weight: 1510
description: JavaScript アプリケーションでの Code 93 拡張バーコードおよび Code 93 標準バーコード のスキャンとデコード用の Node.js ソース コード。
lang: ja
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ja/nodejs-java/code93/recognize/
aliases:
- /ja/nodejs-java/recognize/code93/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js via Java で Code 93 バーコードを読み取ります" h2="Node.js via Java API のサーバー側 Aspose.BarCode を使用して、JavaScript で Code 93 拡張バーコードおよび Code 93 標準バーコード を読み取ります" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Code 93" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Code 93 バーコード Using Node.js via Java" %}}
Node.js アプリケーション内で Code 93 バーコード を認識するには、Java ベースの環境向けに導入された堅牢で多用途で使いやすいバーコード ライブラリである Aspose.BarCode for Node.js via Java を使用します。 Javascript の [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) を NPM から直接ロードできます。
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript で Code 93 バーコード をスキャンする手順" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode を使用すると、開発者は数行のコードでストリームまたは画像から Code 93 バーコード バーコードを読み取ることができます

{{% /blocks/products/pf/agp/text %}}

<ul><li>Aspose.BarCode.BarCodeReader クラスのオブジェクトを作成する</li><li>パラメータとして Code 93 バーコード を含むソース ファイル パスを渡す</li><li>DecodeType でターゲット バーコード タイプを設定する2 番目のパラメータとして</li><li>検出されたすべてのバーコードをループします</li><li>CodeText プロパティを使用して結果のバーコード テキストを取得します</li></ul>
