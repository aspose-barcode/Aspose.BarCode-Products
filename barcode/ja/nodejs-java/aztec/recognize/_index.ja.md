---
title: Node.js via Java 経由で Aztec コード 画像をスキャンします
weight: 1510
description: JavaScript アプリケーションでの Aztec コード のスキャンとデコード用の Node.js ソース コード。
lang: ja
langdirlevel: 2
locales: ar,de,es,fr,id,it,ja,ko,pl,pt,ru,th,tr,vi,zh,zh-hant
url: /ja/nodejs-java/aztec/recognize/
aliases:
- /ja/nodejs-java/recognize/aztec/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js via Java で Aztec バーコードを読み取ります" h2="Node.js via Java API のサーバー側 Aspose.BarCode を使用して、JavaScript で Aztec コード を読み取ります" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Aztec" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Read Aztec コード Using Node.js via Java" %}}
Node.js アプリケーション内で Aztec コード を認識するには、Java ベースの環境向けに導入された堅牢で多用途で使いやすいバーコード ライブラリである Aspose.BarCode for Node.js via Java を使用します。 Javascript の [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) を NPM から直接ロードできます。
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript で Aztec コード をスキャンする手順" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode を使用すると、開発者は数行のコードでストリームまたは画像から Aztec コード バーコードを読み取ることができます

{{% /blocks/products/pf/agp/text %}}

<ul><li>Aspose.BarCode.BarCodeReader クラスのオブジェクトを作成する</li><li>パラメータとして Aztec コード を含むソース ファイル パスを渡す</li><li>DecodeType でターゲット バーコード タイプを設定する2 番目のパラメータとして</li><li>検出されたすべてのバーコードをループします</li><li>CodeText プロパティを使用して結果のバーコード テキストを取得します</li></ul>
