---
title: Node.js via Java 経由で Swiss Post Parcel 画像をスキャンします
weight: 1510
description: JavaScript アプリケーションでの Swiss Post Parcel のスキャンとデコード用の Node.js ソース コード。
lang: ja/
langdirlevel: 2
locales: ar,cs,de,el,es,fr,hi,hu,id,it,ja,ko,nl,pl,pt,ru,sv,th,tr,vi,zh,zh-hant
url: /ja/nodejs-java/swiss-post-parcel/recognize/
aliases:
- /ja/nodejs-java/recognize/swiss-post-parcel/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Node.js via Java で Swiss Post Parcel バーコードを読み取ります" h2="Node.js via Java API のサーバー側 Aspose.BarCode を使用して、JavaScript で Swiss Post Parcel を読み取ります" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-nodejs-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="Swiss Post Parcel" pfName="Aspose.BarCode" subTitlepfName="for Node.js via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SVG" >}}
...
Node.js アプリケーション内で Swiss Post Parcel を認識するには、Java ベースの環境向けに導入された堅牢で多用途で使いやすいバーコード ライブラリである Aspose.BarCode for Node.js via Java を使用します。 Javascript の [aspose.barcode](https://releases.aspose.com/barcode/nodejs/) を NPM から直接ロードできます。
...
{{% blocks/products/pf/agp/feature-section-col title="JavaScript で Swiss Post Parcel をスキャンする手順" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.BarCode を使用すると、開発者は数行のコードでストリームまたは画像から Swiss Post Parcel バーコードを読み取ることができます

{{% /blocks/products/pf/agp/text %}}

<ul><li>Aspose.BarCode.BarCodeReader クラスのオブジェクトを作成する</li><li>パラメータとして Swiss Post Parcel を含むソース ファイル パスを渡す</li><li>DecodeType でターゲット バーコード タイプを設定する2 番目のパラメータとして</li><li>検出されたすべてのバーコードをループします</li><li>CodeText プロパティを使用して結果のバーコード テキストを取得します</li></ul>
