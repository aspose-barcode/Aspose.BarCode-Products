...
<ul><li>BarCodeReader クラスの新しいオブジェクトを作成します</li><li>Royal Mail 4-State 顧客コード (RM4SCC) を含むソース ファイル パスを設定します</li><li>必要なバーコード タイプを 2 番目のパラメータとして DecodeType に渡します</li><li>デコード結果をループする</li><li>getCodeText メソッドを使用してバーコード テキストを取得する</li></ul>
