---
title: SQL ServerReportingServicesで線形および2Dバーコード画像をレンダリングする 
weight: 790
url: /ja/reporting-services/ 
description: SQL ServerReportingServicesレンダリング拡張機能-SSRSで線形および2次元バーコード画像をエクスポートします。バーコードラベルをBMPJPEGGIFおよびPNG形式でレンダリングする
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="SSRSレポートでバーコードをレンダリングする" h2="Microsoft SQL ServerReportingServices内から線形および2Dバーコードを生成します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/headers/aspose_barcode-for-reporting-services.svg" pfName="Aspose.BarCode" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/barcode/reportingservices" >}}
...
{{< blocks/products/pf/carousel-item h3="一目で" description="バーコードReportingServicesAPIの概要。" >}}
<div class="diagram1 d1-rs">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="SSRS用のバーコードAPI" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-reporting-services.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="プラットフォームの独立性" description="Microsoft SQL ServierReportingServicesをサポートしています。" >}}
<div class="diagram1 d1-rs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="バーコードSSRSAPI" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-reporting-services.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="サポートされているファイル形式" description="Reporting Services BarCode APIは、最も人気のある画像をサポートしています 【ファイル形式】(https://docs.aspose.com/barcode/reportingservices/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-rs">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="ReportingServices用のバーコードジェネレータ" src="https://cms.admin.containerize.com/templates/aspose/img/products/barcode/aspose_barcode-for-reporting-services.svg"/>
  <header>
   Aspose.BarCode
  </header>
  <footer>
...
{{< blocks/products/pf/slr-tab tabTitle="レポートサービスにAspose.BarCodeを使用する理由" tabId="success-stories" >}}
